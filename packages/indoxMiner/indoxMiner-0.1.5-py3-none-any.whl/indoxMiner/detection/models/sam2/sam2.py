...
class SAM2:
    ...
    def detect_objects(self, image_path):
        ...
        Returns:
            dict: A dictionary containing the input image (BGR format), detections, and the SAM2 result.
        """
    ...
    def visualize_results(self, packed_results):
        ...
        Args:
            packed_results (dict): Packed results containing the input image, detections, and SAM2 result.
    ...
    def visualize_masks(self, packed_results):
        """
        Visualize masks generated by SAM2.

        Args:
            packed_results (dict): Packed results containing the SAM2 result.

        Displays the individual masks in a grid.
        """
        sam2_result = packed_results["sam2_result"]
