...
from .ArtifactFileChecksum import ArtifactFileChecksum
from .RequestStatus import RequestStatus

# Unused import over optimization prevention
str(repr(PaginationInfo))
str(repr(RequestStatus))
str(repr(ArtifactFileChecksum))
...
class ArtifactFilesChecksumExistsResponse(object):
    ...
    def files(self, value):
        ...
        if (value is None) or isinstance(value, list):
            ...
            raise TypeError(
                'Property "files" of type "list<ArtifactFileChecksum>" set to'
                ' wrong type'
            )
