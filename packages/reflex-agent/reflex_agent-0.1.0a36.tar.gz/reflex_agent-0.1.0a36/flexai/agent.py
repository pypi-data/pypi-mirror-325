...
class Agent:
    ...
    async def step(
        ...
        if (
            ...
            and any(response.content[0].name == tool.__name__ for tool in self.terminating_tools)
        ):
    ...
    async def run(
        ...
        while True:
            ...
            if (
                ...
                and any(last_tool_call.name == tool.__name__ for tool in self.terminating_tools)
            ):
                break
