...
class ProjectIdLitregistryBody(object):
    ...
    def __init__(self, lit_reg_project_name: 'str' =None):  # noqa: E501
        """ProjectIdLitregistryBody - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self) -> dict:
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProjectIdLitregistryBody, dict):
    ...
    def __eq__(self, other: 'ProjectIdLitregistryBody') -> bool:
        """Returns true if both objects are equal"""
        if not isinstance(other, ProjectIdLitregistryBody):
            return False

        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'ProjectIdLitregistryBody') -> bool:
