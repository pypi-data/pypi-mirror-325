            ...
            for key, value in include_dict.items():
                ...
                if isinstance(thing, list):
                    ...
                    if values and empty:
                        ...
                        raise AssertionError()
                    # mapeia os itens da lista adicionando ao dicionário de
                    # retorno apenas as entidades ativas
                    d[key] = [part.to_dict(value)
                              for part in thing if part.is_active() is True]
                else:
                    try:
