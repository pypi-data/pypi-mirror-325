...
from pulpcore.client.pulp_ostree.api.distributions_ostree_api import DistributionsOstreeApi  # noqa: E501
...
class TestDistributionsOstreeApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pulpcore.client.pulp_ostree.api.distributions_ostree_api.DistributionsOstreeApi()  # noqa: E501
