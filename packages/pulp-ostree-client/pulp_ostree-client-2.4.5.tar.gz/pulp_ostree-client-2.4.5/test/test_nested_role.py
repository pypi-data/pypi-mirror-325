...
from pulpcore.client.pulp_ostree.models.nested_role import NestedRole  # noqa: E501
...
class TestNestedRole(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pulpcore.client.pulp_ostree.models.nested_role.NestedRole()  # noqa: E501
        if include_optional :
            return NestedRole(
                users = [
                    '0'
