...
class ContentRefsApi(object):
    ...
    def list_with_http_info(self,  **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginatedostreeOstreeRefResponseList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/ostree/refs/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='PaginatedostreeOstreeRefResponseList',  # noqa: E501
    ...
    def read(self, ostree_ostree_ref_href,  **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str ostree_ostree_ref_href: (required)
        :param list[str] fields: A list of fields to include in the response.
        :param list[str] exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def read_with_http_info(self, ostree_ostree_ref_href,  **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(OstreeOstreeRefResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('ostree_ostree_ref_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['ostree_ostree_ref_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ostree_ostree_ref_href` when calling `read`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'ostree_ostree_ref_href' in local_var_params:
            path_params['ostree_ostree_ref_href'] = local_var_params['ostree_ostree_ref_href']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='OstreeOstreeRefResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
