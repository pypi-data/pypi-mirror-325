...
class ContentContentApi(object):
    ...
    def create(self, ostree_ostree_content,  **kwargs):  # noqa: E501
        ...
        >>> thread = api.create(ostree_ostree_content, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param OstreeOstreeContent ostree_ostree_content: (required)
        ...
        return self.create_with_http_info(ostree_ostree_content,  **kwargs)  # noqa: E501

    def create_with_http_info(self, ostree_ostree_content,  **kwargs):  # noqa: E501
        """Create an ostree content  # noqa: E501

        Trigger an asynchronous task to create content,optionally create new repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(ostree_ostree_content, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('ostree_ostree_content' not in local_var_params or  # noqa: E501
                                                        local_var_params['ostree_ostree_content'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `ostree_ostree_content` when calling `create`")  # noqa: E501
        ...
        body_params = None
        if 'ostree_ostree_content' in local_var_params:
            body_params = local_var_params['ostree_ostree_content']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/ostree/content/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
