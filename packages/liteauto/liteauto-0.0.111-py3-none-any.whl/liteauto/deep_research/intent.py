...
class QStepper:
    ...
    def _get_understanding_and_doubts(self, query, num_of_doubts=None) -> UnderstandAndDoubts:
        ...
        Then, list {num_of_doubts} questions that will help clarify any doubts or uncertainties in the user's query.
        """
    ...
    def _get_node_with_search_questions(self, understandings, current_doubt, num_questions) -> DoubtNode:
        ...
        Current Doubt: {current_doubt}

        Generate {num_questions} questions that will help clarify the current doubt.
        """
