...
from dc_conversations.agents.pydantic_ai_utils import get_model
...
from ..conversation_models import TranslateDTO, TranslationDTO
...
async def translate_convenversation_card(conversation_card: dict, current_lang: str, target_lang: str):
