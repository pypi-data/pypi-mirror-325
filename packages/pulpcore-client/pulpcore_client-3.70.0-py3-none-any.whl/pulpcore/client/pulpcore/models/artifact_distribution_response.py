...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_url", "no_content_change_since", "pulp_labels", "pulp_last_updated", "base_path", "content_guard", "pulp_created", "pulp_href", "prn", "name", "hidden"]
