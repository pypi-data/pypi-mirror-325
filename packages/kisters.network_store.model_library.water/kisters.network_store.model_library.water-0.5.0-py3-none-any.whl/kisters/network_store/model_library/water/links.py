...
from kisters.network_store.model_library.base import BaseLink, Location, Model
...
class Polygon(Model):  # type: ignore
    vertices: Annotated[
...
class _Link(BaseLink):  # type: ignore
...
class HydraulicCrossSectionStation(Model):  # type: ignore
    lr: float = Field(
...
class HydraulicLongitudinalStation(Model):  # type: ignore
    roughness: float = Field(..., gt=0.0, description="Friction coefficient")
...
class LongitudinalDelimitedStation(Model):  # type: ignore
...
class HydraulicRouting(Model):  # type: ignore
...
class MuskingumLongitudinalStation(Model):  # type: ignore
...
class MuskingumCungeLongitudinalStation(Model):  # type: ignore
...
class ReservoirLongitudinalStation(Model):  # type: ignore
...
class HydrologicRouting(Model):  # type: ignore
...
class Channel(_Link):
    ...
    hydraulic_routing: Annotated[
        Optional[HydraulicRouting], Field(description="Hydraulic routing model")
    ] = None
...
class PumpTurbineSpeedPoint(Model):  # type: ignore
    flow: float = Field(..., ge=0.0)
    head: float = Field(..., ge=0.0)
    speed: float = Field(1.0, ge=0.0)


class PumpTurbineEfficiencyPoint(Model):  # type: ignore
    flow: float = Field(..., ge=0.0)
    head: float = Field(..., ge=0.0)
...
class PumpTurbineHeadTWCorrection(Model):  # type: ignore
    link_uid: str = Field(..., pattern="^[a-zA-Z]\\w*$")
    power: int = Field(..., ge=0)
    value: float


class PumpTurbineOtherConstraints(Model):  # type: ignore
    flow_power: int = Field(..., ge=0)
    head_power: int = Field(..., ge=0)
    value: float
