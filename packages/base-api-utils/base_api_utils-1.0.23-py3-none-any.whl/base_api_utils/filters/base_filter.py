...
class BaseFilter(filters.FilterSet):
    ...
    def parse_filter(self, filter_str):
        try:
            ...
            field_name = parts[0]
            if field_name in active_filters:
                field_name = active_filters[field_name].field_name
    ...
    def filter_queryset(self, queryset):
        ...
        for and_filter in filter_category[and_filter_key]:
            ...
            if filter_name in active_filters:
                queryset = self.filter_field(queryset, active_filters[filter_name].field_name, filter_op, filter_value)
