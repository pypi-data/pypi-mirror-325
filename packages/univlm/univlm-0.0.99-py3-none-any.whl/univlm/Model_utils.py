...
class appledepth:
    ...
    def download_checkpoints():
        ...
        checkpoint_dir = "checkpoints"  # Directory where checkpoints should be downloaded
        repo_id = "apple/DepthPro"

        try:
            # Check if the checkpoints directory exists and is not empty
            if os.path.exists(checkpoint_dir) and any(os.listdir(checkpoint_dir)): #Check if the directory exists and is not empty.
    ...
    def env_setup():
        ...
        script_path = "scripts\download_src.sh"
        target_dir = "depthProSrc"  # The directory created by the script
    ...
    def load_model(self):
        ...
        """
        try:
            from depthProSrc.src import depth_pro
