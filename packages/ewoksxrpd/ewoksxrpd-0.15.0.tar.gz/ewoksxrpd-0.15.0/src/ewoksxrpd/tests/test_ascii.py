...
from ewoksxrpd.tasks.ascii import SaveAsciiMultiPattern1D, SaveNexusPatternsAsAscii
...
def test_SaveNexusPatternsAsAscii_multi_patterns(tmp_path):
...
def test_SaveNexusPatternsAsAscii_zip(tmp_path):
