...
class TestCountrylanguagesAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = CountrylanguagesAPIClient(self.api_key)

    @patch('apiverve_countrylanguages.apiClient.requests.get')
