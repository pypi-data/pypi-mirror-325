def hm2of3d(input_file, output_file):
    ...
    with open(output_file, 'w') as out_file:
        ...
        for element in element_data:
            ...
            element_id = parts[0]
            nodes = parts[1:]
            mat_id = 2 if element_id in elset_steel else 1  # Assign mat 2 to steel elements
            nodes_str = ' '.join(map(str, nodes))
            out_file.write(f"lspace {element_id} nodes {len(nodes)} {nodes_str} mat {mat_id} crossSect 1\n")
