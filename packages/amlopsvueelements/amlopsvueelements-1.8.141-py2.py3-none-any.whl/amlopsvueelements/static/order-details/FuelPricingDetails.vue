      ...
      >
        ...
        <div class="pricing-step-content-element-wrap flex w-4/12 py-[0.5rem] pl-[0.75rem]">
          <div class="pricing-step-content-element-el flex w-full justify-start items-center">
            <div class="input-wrap flex pr-[0.75rem]">
              ...
              <SelectField
                ...
                :is-half="true"
                placeholder=" "
                :options="[(fee as ISupplierClientFee).unit_price_pricing_unit]"
                label="description_short"
                :model-value="(fee as ISupplierClientFee).unit_price_pricing_unit"
                :disabled="true"
              />
            </div>
          </div>
          ...
          >
            ...
            >
              <template #suffix>{{
                (fee as ISupplierClientFee).unit_price_pricing_unit?.currency?.code
              }}</template>
            </InputField>
          </div>
        </div>
