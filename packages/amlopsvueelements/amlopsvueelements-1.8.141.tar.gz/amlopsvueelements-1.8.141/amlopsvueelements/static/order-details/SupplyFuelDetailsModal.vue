              ...
              <div class="order-modal-body-content w-full flex flex-col gap-2">
                ...
                <div class="order-modal-body-content-block">
                  ...
                  <div
                    v-if="
                      supplyFuelDetails &&
                      !Object.keys(supplyFuelDetails?.aml_fees?.list)?.length &&
                  ...
                  <div
                    v-for="amlFee in supplyFuelDetails?.aml_fees?.list"
                    v-if="
                      supplyFuelDetails && Object.keys(supplyFuelDetails?.aml_fees?.list)?.length
                    "
                    :key="amlFee.name + '_aml-fee'"
                    class="order-modal-body-content-block-body flex px-[0.75rem] py-[1rem]"
                  >
                    <div class="order-modal-body-content-block-body-name w-4/12">
                      {{ amlFee.name ?? 'Custom Fee' }}
                      <div
                        class="order-modal-body-content-block-body-note hover-wrap contents flex"
                      >
                        <img
                          width="12"
                          height="12"
                          ...
                          class="warn pb-[2px]"
                        />
                        <div class="order-modal-body-tooltip">● AML Fee</div>
                      </div>
                    </div>
                    <div class="order-modal-body-content-block-body-desc w-6/12"></div>
                    <div class="order-modal-body-content-block-body-value w-2/12">
                      {{ formatNumber(amlFee.amount) }} {{ supplyFuelDetails?.currency?.code }}
                    </div>
                  </div>
                </div>
                <div class="order-modal-body-content-block">
