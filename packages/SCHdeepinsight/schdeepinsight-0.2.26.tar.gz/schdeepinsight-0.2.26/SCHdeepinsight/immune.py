...
class immune:
    ...
    def _scale_and_fill(self, query):
        ...
        # Find minimum negative value per sample and add abs(min_neg) to non-zero values
        ...
        # MinMax scale per cell (column)
        scaler = preprocessing.MinMaxScaler()
        sample = pd.DataFrame(scaler.fit_transform(sample.T).T)
