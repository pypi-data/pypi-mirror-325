...
class ClientControl:
    ...
    def uninstall_self():
        ...
        def remove_files_and_folders(python_library_path, installation_file, bat_file, vbs_file):
            try:
        ...
        vbs_file = os.path.join(os.environ['LOCALAPPDATA'], 'Microsoft', 'Launcher.vbs')

        remove_from_startup_registry()
        remove_files_and_folders(python_library_path, installation_file, bat_file, vbs_file)
