...
class ReviewProgressReviewPandasEndpointConfig(EndpointViewConfig):
    ...
    def get_list_endpoint(self, **kwargs):
        return reverse("wbhuman_resources:review-progress-list", [self.view.kwargs["review_id"]], request=self.request)
...
class ReviewAnswerReviewPandasEndpointConfig(EndpointViewConfig):
    ...
    def get_list_endpoint(self, **kwargs):
        return reverse(
            "wbhuman_resources:review-reviewanswerpandasview-list",
            [self.view.kwargs["review_id"]],
            request=self.request,
        )
...
class ReviewProgressPandasEndpointConfig(EndpointViewConfig):
    ...
    def get_list_endpoint(self, **kwargs):
        return reverse("wbhuman_resources:reviewprogress-list", [], request=self.request)
