...
class AbsenceRequestPeriodsAbsenceRequestEndpointConfig(EndpointViewConfig):
    def get_list_endpoint(self, **kwargs):
        return reverse(
            "wbhuman_resources:request-periods-list", args=[self.view.kwargs["request_id"]], request=self.request
        )
...
class AbsenceRequestPlannerEndpointConfig(EndpointViewConfig):
    ...
    def get_list_endpoint(self, **kwargs):
        return reverse("wbhuman_resources:absenceplanner-list", args=[], request=self.request)
...
class AbsenceTablePandasEndpointConfig(EndpointViewConfig):
    ...
    def get_list_endpoint(self, **kwargs):
        return reverse("wbhuman_resources:absencetable-list", args=[], request=self.request)
