                ...
                def _parse_app_configuration_items_item(
                    ...
                    if discriminator_value is not None:
                        ...
                        if discriminator_value == "aa_sequence":
                            app_config_item_bulk_update = AppConfigItemGenericBulkUpdate.from_dict(
                                data, strict=False
                            )

                            return app_config_item_bulk_update
                        if discriminator_value == "boolean":
                            app_config_item_bulk_update = AppConfigItemBooleanBulkUpdate.from_dict(
                                data, strict=False
                            )
                        ...
                        if discriminator_value == "date":
                            app_config_item_bulk_update = AppConfigItemDateBulkUpdate.from_dict(
                                data, strict=False
                            )

                            return app_config_item_bulk_update
                        if discriminator_value == "datetime":
                            app_config_item_bulk_update = AppConfigItemDatetimeBulkUpdate.from_dict(
                                data, strict=False
                            )
                        ...
                        if discriminator_value == "float":
                            app_config_item_bulk_update = AppConfigItemFloatBulkUpdate.from_dict(
                                data, strict=False
                            )
                        ...
                        if discriminator_value == "integer":
                            app_config_item_bulk_update = AppConfigItemIntegerBulkUpdate.from_dict(
                                data, strict=False
                            )

                            return app_config_item_bulk_update
                        if discriminator_value == "json":
                            app_config_item_bulk_update = AppConfigItemJsonBulkUpdate.from_dict(
                                data, strict=False
                            )
