...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1941, _1946
...
class LinearBearing(_2195.BearingDesign):
    """LinearBearing
    ...
    @property
    def stiffness_options(self: "Self") -> "_1946.BearingStiffnessMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1946", "BearingStiffnessMatrixOption"
        )(value)

    @stiffness_options.setter
    @enforce_parameter_types
    def stiffness_options(
        self: "Self", value: "_1946.BearingStiffnessMatrixOption"
    ) -> None:
