...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling.xml_import import _2246
...
class _Cast_AbstractXmlVariableAssignment:
    ...
    @property
    def xml_variable_assignment(self: "CastSelf") -> "_2246.XMLVariableAssignment":
        from mastapy._private.bearings.bearing_designs.rolling.xml_import import _2246

        return self.__parent__._cast(_2246.XMLVariableAssignment)
