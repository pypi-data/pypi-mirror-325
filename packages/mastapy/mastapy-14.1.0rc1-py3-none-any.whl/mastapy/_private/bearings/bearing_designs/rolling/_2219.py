...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling import _2205, _2218, _2230
...
class FourPointContactBallBearing(_2224.MultiPointContactBallBearing):
    """FourPointContactBallBearing
    ...
    def contact_angle_and_internal_clearance_definition(
        self: "Self",
    ) -> "_2218.FourPointContactAngleDefinition":
    ...
    def contact_angle_and_internal_clearance_definition(
        self: "Self", value: "_2218.FourPointContactAngleDefinition"
    ) -> None:
