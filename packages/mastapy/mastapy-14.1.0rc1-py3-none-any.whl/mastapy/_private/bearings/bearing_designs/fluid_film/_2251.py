...
class _Cast_CylindricalHousingJournalBearing:
    ...
    @property
    def plain_journal_housing(self: "CastSelf") -> "_2258.PlainJournalHousing":
        return self.__parent__._cast(_2258.PlainJournalHousing)
...
class CylindricalHousingJournalBearing(_2258.PlainJournalHousing):
    """CylindricalHousingJournalBearing
