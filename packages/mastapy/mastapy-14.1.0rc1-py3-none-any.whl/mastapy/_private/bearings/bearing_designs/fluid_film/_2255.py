...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2256, _2258
...
class PlainGreaseFilledJournalBearing(_2257.PlainJournalBearing):
    """PlainGreaseFilledJournalBearing
    ...
    def housing_type(
        self: "Self",
    ) -> "_2256.PlainGreaseFilledJournalBearingHousingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_designs.fluid_film._2256",
    ...
    def housing_type(
        self: "Self", value: "_2256.PlainGreaseFilledJournalBearingHousingType"
    ) -> None:
    ...
    @property
    def housing_detail(self: "Self") -> "_2258.PlainJournalHousing":
