...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1941, _1964
...
class TiltingPadThrustBearing(_2253.PadFluidFilmBearing):
    """TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self: "Self") -> "_1964.TiltingPadTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1964", "TiltingPadTypes"
        )(value)

    @tilting_pad_type.setter
    @enforce_parameter_types
    def tilting_pad_type(self: "Self", value: "_1964.TiltingPadTypes") -> None:
