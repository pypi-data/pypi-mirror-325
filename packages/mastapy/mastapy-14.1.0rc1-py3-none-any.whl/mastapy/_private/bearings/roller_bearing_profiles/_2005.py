...
class _Cast_UserSpecifiedRollerRaceProfilePoint:
    ...
    @property
    def roller_race_profile_point(self: "CastSelf") -> "_2003.RollerRaceProfilePoint":
        return self.__parent__._cast(_2003.RollerRaceProfilePoint)
...
class UserSpecifiedRollerRaceProfilePoint(_2003.RollerRaceProfilePoint):
    """UserSpecifiedRollerRaceProfilePoint
