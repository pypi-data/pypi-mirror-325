...
from mastapy._private.bearings.tolerances import _1973, _1974, _1987
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.tolerances import _1965, _1971, _1977
...
class SupportTolerance(_1973.InterferenceTolerance):
    """SupportTolerance
    ...
    def tolerance_band_designation(self: "Self", value: "_1974.ITDesignation") -> None:
    ...
    @enforce_parameter_types
    def tolerance_deviation_class(
        self: "Self", value: "_1987.SupportToleranceLocationDesignation"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
