...
class _Cast_BearingConnectionComponent:
    ...
    @property
    def inner_ring_tolerance(self: "CastSelf") -> "_1970.InnerRingTolerance":
        from mastapy._private.bearings.tolerances import _1970

        return self.__parent__._cast(_1970.InnerRingTolerance)

    @property
    def inner_support_tolerance(self: "CastSelf") -> "_1971.InnerSupportTolerance":
        from mastapy._private.bearings.tolerances import _1971

        return self.__parent__._cast(_1971.InnerSupportTolerance)

    @property
    def interference_detail(self: "CastSelf") -> "_1972.InterferenceDetail":
        from mastapy._private.bearings.tolerances import _1972

        return self.__parent__._cast(_1972.InterferenceDetail)

    @property
    def interference_tolerance(self: "CastSelf") -> "_1973.InterferenceTolerance":
        from mastapy._private.bearings.tolerances import _1973

        return self.__parent__._cast(_1973.InterferenceTolerance)

    @property
    def mounting_sleeve_diameter_detail(
        self: "CastSelf",
    ) -> "_1975.MountingSleeveDiameterDetail":
        from mastapy._private.bearings.tolerances import _1975

        return self.__parent__._cast(_1975.MountingSleeveDiameterDetail)

    @property
    def outer_ring_tolerance(self: "CastSelf") -> "_1976.OuterRingTolerance":
        from mastapy._private.bearings.tolerances import _1976

        return self.__parent__._cast(_1976.OuterRingTolerance)

    @property
    def outer_support_tolerance(self: "CastSelf") -> "_1977.OuterSupportTolerance":
        from mastapy._private.bearings.tolerances import _1977

        return self.__parent__._cast(_1977.OuterSupportTolerance)

    @property
    def ring_detail(self: "CastSelf") -> "_1980.RingDetail":
        from mastapy._private.bearings.tolerances import _1980

        return self.__parent__._cast(_1980.RingDetail)

    @property
    def ring_tolerance(self: "CastSelf") -> "_1981.RingTolerance":
        from mastapy._private.bearings.tolerances import _1981

        return self.__parent__._cast(_1981.RingTolerance)

    @property
    def support_detail(self: "CastSelf") -> "_1984.SupportDetail":
        from mastapy._private.bearings.tolerances import _1984

        return self.__parent__._cast(_1984.SupportDetail)

    @property
    def support_tolerance(self: "CastSelf") -> "_1986.SupportTolerance":
        from mastapy._private.bearings.tolerances import _1986

        return self.__parent__._cast(_1986.SupportTolerance)
