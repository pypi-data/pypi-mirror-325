...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.fluid_film import _2192, _2193
...
class LoadedPadFluidFilmBearingResults(_2184.LoadedFluidFilmBearingResults):
    """LoadedPadFluidFilmBearingResults
