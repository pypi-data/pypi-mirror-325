...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.fluid_film import _2185, _2188, _2189
...
class LoadedPlainJournalBearingResults(_2184.LoadedFluidFilmBearingResults):
    """LoadedPlainJournalBearingResults
    ...
    def journal_bearing_rows(
        self: "Self",
    ) -> "List[_2188.LoadedPlainJournalBearingRow]":
