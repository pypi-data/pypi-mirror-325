...
class _Cast_LoadedTiltingJournalPad:
    ...
    def loaded_fluid_film_bearing_pad(
        self: "CastSelf",
    ) -> "_2183.LoadedFluidFilmBearingPad":
        return self.__parent__._cast(_2183.LoadedFluidFilmBearingPad)
...
class LoadedTiltingJournalPad(_2183.LoadedFluidFilmBearingPad):
    """LoadedTiltingJournalPad
