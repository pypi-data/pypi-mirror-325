...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2079, _2080, _2115
...
class LoadedMultiPointContactBallBearingElement(_2065.LoadedBallBearingElement):
    """LoadedMultiPointContactBallBearingElement
