...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2125, _2126
...
class _Cast_MaximumStaticContactStressResultsAbstract:
    ...
    def maximum_static_contact_stress(
        ...
        return self.__parent__._cast(_2125.MaximumStaticContactStress)
    ...
    def maximum_static_contact_stress_duty_cycle(
        ...
        return self.__parent__._cast(_2126.MaximumStaticContactStressDutyCycle)
