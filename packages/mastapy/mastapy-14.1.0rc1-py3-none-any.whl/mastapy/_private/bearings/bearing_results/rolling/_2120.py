...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2099, _2119
...
class LoadedThrustBallBearingRow(_2068.LoadedBallBearingRow):
    """LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2119.LoadedThrustBallBearingResults":
