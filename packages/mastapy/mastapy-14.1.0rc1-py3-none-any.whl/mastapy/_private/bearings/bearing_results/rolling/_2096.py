...
class _Cast_LoadedRollerStripLoadResults:
    ...
    def loaded_abstract_spherical_roller_bearing_strip_load_results(
        self: "CastSelf",
    ) -> "_2046.LoadedAbstractSphericalRollerBearingStripLoadResults":
    ...
    def loaded_asymmetric_spherical_roller_bearing_strip_load_results(
        self: "CastSelf",
    ) -> "_2056.LoadedAsymmetricSphericalRollerBearingStripLoadResults":
    ...
    def loaded_non_barrel_roller_bearing_strip_load_results(
        self: "CastSelf",
    ) -> "_2091.LoadedNonBarrelRollerBearingStripLoadResults":
        from mastapy._private.bearings.bearing_results.rolling import _2091

        return self.__parent__._cast(_2091.LoadedNonBarrelRollerBearingStripLoadResults)

    @property
    def loaded_spherical_roller_radial_bearing_strip_load_results(
        self: "CastSelf",
    ) -> "_2107.LoadedSphericalRollerRadialBearingStripLoadResults":
    ...
    def loaded_toroidal_roller_bearing_strip_load_results(
        self: "CastSelf",
    ) -> "_2124.LoadedToroidalRollerBearingStripLoadResults":
        from mastapy._private.bearings.bearing_results.rolling import _2124

        return self.__parent__._cast(_2124.LoadedToroidalRollerBearingStripLoadResults)
