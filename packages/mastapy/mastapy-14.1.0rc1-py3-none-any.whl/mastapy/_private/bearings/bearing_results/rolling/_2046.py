...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2056, _2107, _2124
...
class _Cast_LoadedAbstractSphericalRollerBearingStripLoadResults:
    ...
    def loaded_roller_strip_load_results(
        self: "CastSelf",
    ) -> "_2096.LoadedRollerStripLoadResults":
        return self.__parent__._cast(_2096.LoadedRollerStripLoadResults)
