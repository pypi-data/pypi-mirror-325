...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2079, _2085, _2093
...
class LoadedCylindricalRollerBearingElement(_2092.LoadedNonBarrelRollerElement):
    """LoadedCylindricalRollerBearingElement
