...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2099, _2122
...
class LoadedToroidalRollerBearingRow(_2095.LoadedRollerBearingRow):
    """LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2122.LoadedToroidalRollerBearingResults":
