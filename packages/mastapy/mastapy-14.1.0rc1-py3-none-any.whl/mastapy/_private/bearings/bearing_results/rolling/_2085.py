...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2079, _2092, _2093
...
class LoadedNeedleRollerBearingElement(_2073.LoadedCylindricalRollerBearingElement):
    """LoadedNeedleRollerBearingElement
