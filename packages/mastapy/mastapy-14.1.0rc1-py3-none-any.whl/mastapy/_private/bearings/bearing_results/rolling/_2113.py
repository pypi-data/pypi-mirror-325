...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2094, _2098
...
class LoadedTaperRollerBearingResults(_2089.LoadedNonBarrelRollerBearingResults):
    """LoadedTaperRollerBearingResults
