...
class _Cast_ThreePointContactInternalClearance:
    ...
    @property
    def internal_clearance(self: "CastSelf") -> "_2038.InternalClearance":
        return self.__parent__._cast(_2038.InternalClearance)
...
class ThreePointContactInternalClearance(_2038.InternalClearance):
    """ThreePointContactInternalClearance
