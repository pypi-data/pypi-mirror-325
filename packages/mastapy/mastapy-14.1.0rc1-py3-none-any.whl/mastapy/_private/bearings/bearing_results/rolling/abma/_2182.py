...
from mastapy._private.bearings.bearing_results.rolling.iso_rating_results import _2170
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling.abma import _2180, _2181
...
class _Cast_ANSIABMAResults:
    ...
    @property
    def iso_results(self: "CastSelf") -> "_2170.ISOResults":
        return self.__parent__._cast(_2170.ISOResults)
...
class ANSIABMAResults(_2170.ISOResults):
    """ANSIABMAResults
