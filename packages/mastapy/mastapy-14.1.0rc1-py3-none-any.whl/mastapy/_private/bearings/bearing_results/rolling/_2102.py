...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2099, _2101
...
class LoadedSelfAligningBallBearingRow(_2068.LoadedBallBearingRow):
    """LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2101.LoadedSelfAligningBallBearingResults":
