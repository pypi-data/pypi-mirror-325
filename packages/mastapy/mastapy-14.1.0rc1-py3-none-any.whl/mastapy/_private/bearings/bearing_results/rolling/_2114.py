...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2095, _2099, _2113
...
class LoadedTaperRollerBearingRow(_2090.LoadedNonBarrelRollerBearingRow):
    """LoadedTaperRollerBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2113.LoadedTaperRollerBearingResults":
