...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results import _2014, _2021, _2024
...
class LoadedBearingDutyCycle(_0.APIBase):
    ...
    @property
    def bearing_design(self: "Self") -> "_2195.BearingDesign":
    ...
    @property
    def bearing_load_case_results(self: "Self") -> "List[_2014.LoadedBearingResults]":
