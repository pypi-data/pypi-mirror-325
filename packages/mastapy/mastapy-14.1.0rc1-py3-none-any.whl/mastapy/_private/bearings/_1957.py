...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1933, _1949, _1960
...
class RollingBearingDatabase(
    _1895.SQLDatabase[_1958.RollingBearingKey, _2230.RollingBearing]
):
    """RollingBearingDatabase
    ...
    def add_to_database(self: "Self", bearing: "_2230.RollingBearing") -> None:
    ...
    @enforce_parameter_types
    def create_bearing(
        self: "Self", type_: "_1960.RollingBearingType", designation: "str" = "None"
    ) -> "_2230.RollingBearing":
    ...
    @enforce_parameter_types
    def remove_from_database(self: "Self", bearing: "_2230.RollingBearing") -> None:
        """Method does not return.
    ...
    def search_for_rolling_bearing_with_catalog(
        self: "Self", catalog: "_1933.BearingCatalog"
    ) -> "List[_2230.RollingBearing]":
    ...
    def search_for_rolling_bearing_with_name_and_catalog(
        self: "Self", designation: "str", catalog: "_1933.BearingCatalog"
    ) -> "_2230.RollingBearing":
        """mastapy.bearings.bearing_designs.rolling.RollingBearing
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(
        self: "Self",
        designation: "str",
        catalog: "_1933.BearingCatalog",
        type_: "_1960.RollingBearingType",
    ) -> "List[_2230.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
    ...
    def search_for_rolling_bearing(
        ...
        number_of_rows: "int",
        material_type: "_1949.HybridSteelAll",
    ) -> "List[_2230.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
