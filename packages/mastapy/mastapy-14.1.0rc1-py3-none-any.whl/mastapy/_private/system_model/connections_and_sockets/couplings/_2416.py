...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2267, _2269
...
class SpringDamperConnection(_2412.CouplingConnection):
    """SpringDamperConnection
    ...
    @property
    def damping_option(self: "Self") -> "_2267.ComponentDampingOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2267", "ComponentDampingOption"
        )(value)

    @damping_option.setter
    @enforce_parameter_types
    def damping_option(self: "Self", value: "_2267.ComponentDampingOption") -> None:
