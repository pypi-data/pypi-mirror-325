...
class CVTCompoundCriticalSpeedAnalysis(_6822.BeltDriveCompoundCriticalSpeedAnalysis):
    """CVTCompoundCriticalSpeedAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6722.CVTCriticalSpeedAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_6722.CVTCriticalSpeedAnalysis]":
        """List[mastapy.system_model.analyses_and_results.critical_speed_analyses.CVTCriticalSpeedAnalysis]
