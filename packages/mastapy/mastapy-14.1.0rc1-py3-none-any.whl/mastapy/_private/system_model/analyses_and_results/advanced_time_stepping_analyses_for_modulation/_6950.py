...
class AdvancedTimeSteppingAnalysisForModulationOptions(_0.APIBase):
    ...
    def advanced_time_stepping_analysis_method(
        self: "Self",
    ) -> "_7500.AdvancedTimeSteppingAnalysisForModulationType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7500",
    ...
    def advanced_time_stepping_analysis_method(
        self: "Self", value: "_7500.AdvancedTimeSteppingAnalysisForModulationType"
    ) -> None:
    ...
    @property
    def time_options(self: "Self") -> "_2759.TimeOptions":
