...
class WormGearSetCompoundDynamicAnalysis(_6601.GearSetCompoundDynamicAnalysis):
    """WormGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6537.WormGearSetDynamicAnalysis]":
    ...
    def worm_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6666.WormGearCompoundDynamicAnalysis]":
    ...
    def worm_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6667.WormGearMeshCompoundDynamicAnalysis]":
