...
class CouplingCompoundDynamicAnalysis(_6641.SpecialisedAssemblyCompoundDynamicAnalysis):
    """CouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_6446.CouplingDynamicAnalysis]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6446.CouplingDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.CouplingDynamicAnalysis]
