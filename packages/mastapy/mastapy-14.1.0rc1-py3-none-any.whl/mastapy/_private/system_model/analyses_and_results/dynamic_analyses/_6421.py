...
class BevelDifferentialGearSetDynamicAnalysis(_6426.BevelGearSetDynamicAnalysis):
    """BevelDifferentialGearSetDynamicAnalysis
    ...
    def bevel_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6419.BevelDifferentialGearDynamicAnalysis]":
    ...
    def bevel_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6420.BevelDifferentialGearMeshDynamicAnalysis]":
