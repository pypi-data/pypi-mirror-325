...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.static_loads import _7526
...
class ConceptCouplingConnectionDynamicAnalysis(_6445.CouplingConnectionDynamicAnalysis):
    """ConceptCouplingConnectionDynamicAnalysis
    ...
    @property
    def connection_load_case(self: "Self") -> "_7526.ConceptCouplingConnectionLoadCase":
