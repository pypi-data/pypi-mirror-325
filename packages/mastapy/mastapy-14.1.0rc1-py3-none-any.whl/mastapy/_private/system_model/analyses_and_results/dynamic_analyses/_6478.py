...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6442
...
class KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis(
    ...
    def conical_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6477.KlingelnbergCycloPalloidConicalGearMeshDynamicAnalysis]":
