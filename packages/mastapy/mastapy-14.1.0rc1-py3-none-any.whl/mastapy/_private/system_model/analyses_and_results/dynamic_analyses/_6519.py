...
class StraightBevelDiffGearSetDynamicAnalysis(_6426.BevelGearSetDynamicAnalysis):
    """StraightBevelDiffGearSetDynamicAnalysis
    ...
    def bevel_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6517.StraightBevelDiffGearDynamicAnalysis]":
    ...
    def bevel_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6518.StraightBevelDiffGearMeshDynamicAnalysis]":
