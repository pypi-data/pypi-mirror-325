...
class ZerolBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3458.ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def zerol_bevel_gears_compound_steady_state_synchronous_response_on_a_shaft(
        self: "Self",
    ) -> "List[_3588.ZerolBevelGearCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def zerol_bevel_meshes_compound_steady_state_synchronous_response_on_a_shaft(
        self: "Self",
    ) -> "List[_3589.ZerolBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft]":
