...
class RollingRingConnectionCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    @property
    def component_design(self: "Self") -> "_2358.RollingRingConnection":
    ...
    @property
    def connection_design(self: "Self") -> "_2358.RollingRingConnection":
        """mastapy.system_model.connections_and_sockets.RollingRingConnection
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3422.RollingRingConnectionSteadyStateSynchronousResponseOnAShaft]":
