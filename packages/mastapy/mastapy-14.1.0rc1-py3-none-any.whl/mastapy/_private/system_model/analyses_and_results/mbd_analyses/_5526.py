...
class ConceptGearSetMultibodyDynamicsAnalysis(_5556.GearSetMultibodyDynamicsAnalysis):
    """ConceptGearSetMultibodyDynamicsAnalysis
    ...
    def gears_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5525.ConceptGearMultibodyDynamicsAnalysis]":
    ...
    def meshes_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5524.ConceptGearMeshMultibodyDynamicsAnalysis]":
