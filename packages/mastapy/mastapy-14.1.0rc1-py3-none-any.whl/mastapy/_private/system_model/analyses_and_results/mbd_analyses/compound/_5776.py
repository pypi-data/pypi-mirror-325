...
class WormGearSetCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5638.WormGearSetMultibodyDynamicsAnalysis]":
    ...
    def worm_gears_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5774.WormGearCompoundMultibodyDynamicsAnalysis]":
    ...
    def worm_meshes_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5775.WormGearMeshCompoundMultibodyDynamicsAnalysis]":
