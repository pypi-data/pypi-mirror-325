...
class _Cast_AssemblyCompoundMultibodyDynamicsAnalysis:
    ...
    def root_assembly_compound_multibody_dynamics_analysis(
        self: "CastSelf",
    ) -> "_5745.RootAssemblyCompoundMultibodyDynamicsAnalysis":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses.compound import (
            _5745,
        )
...
class AssemblyCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5499.AssemblyMultibodyDynamicsAnalysis]":
    ...
    def bearings(
        self: "Self",
    ) -> "List[_5657.BearingCompoundMultibodyDynamicsAnalysis]":
    ...
    def belt_drives(
        self: "Self",
    ) -> "List[_5659.BeltDriveCompoundMultibodyDynamicsAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_5662.BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_5669.BoltedJointCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_5668.BoltCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_5690.CVTCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    def clutches(self: "Self") -> "List[_5670.ClutchCompoundMultibodyDynamicsAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_5675.ConceptCouplingCompoundMultibodyDynamicsAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_5680.ConceptGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5692.CycloidalAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_5694.CycloidalDiscCompoundMultibodyDynamicsAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5698.CylindricalGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_5705.FEPartCompoundMultibodyDynamicsAnalysis]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_5704.FaceGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_5706.FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5713.HypoidGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5720.KlingelnbergCycloPalloidHypoidGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5723.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def mass_discs(
        self: "Self",
    ) -> "List[_5724.MassDiscCompoundMultibodyDynamicsAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_5725.MeasurementComponentCompoundMultibodyDynamicsAnalysis]":
    ...
    def microphones(
        self: "Self",
    ) -> "List[_5727.MicrophoneCompoundMultibodyDynamicsAnalysis]":
    ...
    def oil_seals(
        self: "Self",
    ) -> "List[_5729.OilSealCompoundMultibodyDynamicsAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_5731.PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_5736.PlanetCarrierCompoundMultibodyDynamicsAnalysis]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_5737.PointLoadCompoundMultibodyDynamicsAnalysis]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_5738.PowerLoadCompoundMultibodyDynamicsAnalysis]":
    ...
    def ring_pins(
        self: "Self",
    ) -> "List[_5740.RingPinsCompoundMultibodyDynamicsAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_5742.RollingRingAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_5747.ShaftHubConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_5746.ShaftCompoundMultibodyDynamicsAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5752.SpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_5753.SpringDamperCompoundMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_5758.StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5761.StraightBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_5764.SynchroniserCompoundMultibodyDynamicsAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_5768.TorqueConverterCompoundMultibodyDynamicsAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_5772.UnbalancedMassCompoundMultibodyDynamicsAnalysis]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_5776.WormGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5779.ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis]":
