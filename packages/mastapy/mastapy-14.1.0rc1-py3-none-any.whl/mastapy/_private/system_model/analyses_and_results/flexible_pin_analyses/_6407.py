...
class WindTurbineCertificationReport(_6399.CombinationAnalysis):
    """WindTurbineCertificationReport
    ...
    def extreme_load_case(self: "Self", value: "_7493.StaticLoadCase") -> None:
        wrapper_type = (
    ...
    @ldd.setter
    @enforce_parameter_types
    def ldd(self: "Self", value: "_5786.DutyCycle") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def nominal_load_case(self: "Self", value: "_7493.StaticLoadCase") -> None:
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_StaticLoadCase.wrapper_type()
        )
        enclosed_type = (
    ...
    @property
    def design(self: "Self") -> "_2544.RootAssembly":
