...
class AssemblyPowerFlow(_4127.AbstractAssemblyPowerFlow):
    """AssemblyPowerFlow
    ...
    @property
    def bearings(self: "Self") -> "List[_4135.BearingPowerFlow]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_4137.BeltDrivePowerFlow]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_4146.BoltedJointPowerFlow]":
    ...
    @property
    def bolts(self: "Self") -> "List[_4147.BoltPowerFlow]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_4168.CVTPowerFlow]":
    ...
    @property
    def clutches(self: "Self") -> "List[_4150.ClutchPowerFlow]":
    ...
    @property
    def concept_couplings(self: "Self") -> "List[_4155.ConceptCouplingPowerFlow]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_4158.ConceptGearSetPowerFlow]":
    ...
    @property
    def cycloidal_assemblies(self: "Self") -> "List[_4170.CycloidalAssemblyPowerFlow]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_4173.CycloidalDiscPowerFlow]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_4186.FEPartPowerFlow]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_4183.FaceGearSetPowerFlow]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_4194.HypoidGearSetPowerFlow]":
    ...
    @property
    def loaded_gear_sets(self: "Self") -> "List[_4190.GearSetPowerFlow]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_4205.MassDiscPowerFlow]":
    ...
    @property
    def microphones(self: "Self") -> "List[_4208.MicrophonePowerFlow]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_4210.OilSealPowerFlow]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_4217.PlanetCarrierPowerFlow]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_4218.PointLoadPowerFlow]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_4221.PowerLoadPowerFlow]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_4223.RingPinsPowerFlow]":
    ...
    @property
    def shafts(self: "Self") -> "List[_4230.ShaftPowerFlow]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_4238.SpringDamperPowerFlow]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4244.StraightBevelGearSetPowerFlow]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_4249.SynchroniserPowerFlow]":
    ...
    @property
    def torque_converters(self: "Self") -> "List[_4253.TorqueConverterPowerFlow]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_4256.UnbalancedMassPowerFlow]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_4260.WormGearSetPowerFlow]":
    ...
    @property
    def zerol_bevel_gear_sets(self: "Self") -> "List[_4263.ZerolBevelGearSetPowerFlow]":
