...
class FaceGearSetPowerFlow(_4190.GearSetPowerFlow):
    """FaceGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4182.FaceGearPowerFlow]":
    ...
    @property
    def face_gears_power_flow(self: "Self") -> "List[_4182.FaceGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4181.FaceGearMeshPowerFlow]":
    ...
    @property
    def face_meshes_power_flow(self: "Self") -> "List[_4181.FaceGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearMeshPowerFlow]
