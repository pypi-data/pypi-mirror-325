...
class PowerFlow(_7711.StaticLoadAnalysisCase):
    """PowerFlow
    ...
    @property
    def torsional_system_deflection(self: "Self") -> "_2909.TorsionalSystemDeflection":
