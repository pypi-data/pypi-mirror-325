...
class BevelGearSetPowerFlow(_4133.AGMAGleasonConicalGearSetPowerFlow):
    """BevelGearSetPowerFlow
    ...
    @property
    def bevel_gears_power_flow(self: "Self") -> "List[_4144.BevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BevelGearPowerFlow]
    ...
    @property
    def bevel_meshes_power_flow(self: "Self") -> "List[_4143.BevelGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BevelGearMeshPowerFlow]
