...
class CylindricalGearSetPowerFlow(_4190.GearSetPowerFlow):
    """CylindricalGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4176.CylindricalGearPowerFlow]":
    ...
    def cylindrical_gears_power_flow(
        self: "Self",
    ) -> "List[_4176.CylindricalGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CylindricalGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4175.CylindricalGearMeshPowerFlow]":
    ...
    def cylindrical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4175.CylindricalGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CylindricalGearMeshPowerFlow]
