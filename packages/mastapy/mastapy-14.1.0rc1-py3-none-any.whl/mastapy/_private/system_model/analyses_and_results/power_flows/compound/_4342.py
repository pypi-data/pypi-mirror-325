...
class MicrophoneCompoundPowerFlow(_4289.ComponentCompoundPowerFlow):
    """MicrophoneCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4208.MicrophonePowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4208.MicrophonePowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.MicrophonePowerFlow]
