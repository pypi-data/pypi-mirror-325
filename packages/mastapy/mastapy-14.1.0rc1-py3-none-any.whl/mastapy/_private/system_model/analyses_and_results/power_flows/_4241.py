...
class StraightBevelDiffGearSetPowerFlow(_4145.BevelGearSetPowerFlow):
    """StraightBevelDiffGearSetPowerFlow
    ...
    def bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4240.StraightBevelDiffGearPowerFlow]":
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4239.StraightBevelDiffGearMeshPowerFlow]":
