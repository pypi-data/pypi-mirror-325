...
class GuideDxfModelCompoundPowerFlow(_4289.ComponentCompoundPowerFlow):
    """GuideDxfModelCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4191.GuideDxfModelPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4191.GuideDxfModelPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.GuideDxfModelPowerFlow]
