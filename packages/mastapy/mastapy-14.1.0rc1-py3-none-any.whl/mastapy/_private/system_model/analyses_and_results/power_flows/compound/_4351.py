...
class PlanetCarrierCompoundPowerFlow(_4343.MountableComponentCompoundPowerFlow):
    """PlanetCarrierCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4217.PlanetCarrierPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4217.PlanetCarrierPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PlanetCarrierPowerFlow]
