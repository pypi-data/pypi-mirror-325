...
class ConceptGearSetPowerFlow(_4190.GearSetPowerFlow):
    """ConceptGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4157.ConceptGearPowerFlow]":
    ...
    @property
    def concept_gears_power_flow(self: "Self") -> "List[_4157.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4156.ConceptGearMeshPowerFlow]":
    ...
    def concept_meshes_power_flow(
        self: "Self",
    ) -> "List[_4156.ConceptGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearMeshPowerFlow]
