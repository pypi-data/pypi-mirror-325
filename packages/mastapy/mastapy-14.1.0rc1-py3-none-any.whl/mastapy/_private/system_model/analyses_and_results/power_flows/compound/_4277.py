...
class BevelDifferentialGearSetCompoundPowerFlow(_4282.BevelGearSetCompoundPowerFlow):
    """BevelDifferentialGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4140.BevelDifferentialGearSetPowerFlow]":
    ...
    def bevel_differential_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4275.BevelDifferentialGearCompoundPowerFlow]":
    ...
    def bevel_differential_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4276.BevelDifferentialGearMeshCompoundPowerFlow]":
