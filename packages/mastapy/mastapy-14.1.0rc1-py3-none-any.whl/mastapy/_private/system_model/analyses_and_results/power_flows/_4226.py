...
class RollingRingConnectionPowerFlow(_4195.InterMountableComponentConnectionPowerFlow):
    """RollingRingConnectionPowerFlow
    ...
    @property
    def connection_load_case(self: "Self") -> "_7636.RollingRingConnectionLoadCase":
