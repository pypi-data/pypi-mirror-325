...
class FaceGearSetCompoundPowerFlow(_4324.GearSetCompoundPowerFlow):
    """FaceGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4183.FaceGearSetPowerFlow]":
    ...
    def face_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4317.FaceGearCompoundPowerFlow]":
    ...
    def face_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4318.FaceGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4183.FaceGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearSetPowerFlow]
