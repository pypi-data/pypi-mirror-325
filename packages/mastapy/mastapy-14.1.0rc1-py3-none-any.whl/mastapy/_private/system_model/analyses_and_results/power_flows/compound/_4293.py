...
class ConceptGearCompoundPowerFlow(_4322.GearCompoundPowerFlow):
    """ConceptGearCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4157.ConceptGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4157.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]
