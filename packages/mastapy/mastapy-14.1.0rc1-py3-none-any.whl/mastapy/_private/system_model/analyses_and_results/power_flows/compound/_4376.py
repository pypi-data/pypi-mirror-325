...
class StraightBevelGearSetCompoundPowerFlow(_4282.BevelGearSetCompoundPowerFlow):
    """StraightBevelGearSetCompoundPowerFlow
    ...
    def straight_bevel_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4374.StraightBevelGearCompoundPowerFlow]":
    ...
    def straight_bevel_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4375.StraightBevelGearMeshCompoundPowerFlow]":
