...
class WormGearSetCompoundPowerFlow(_4324.GearSetCompoundPowerFlow):
    """WormGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4260.WormGearSetPowerFlow]":
    ...
    def worm_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4389.WormGearCompoundPowerFlow]":
    ...
    def worm_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4390.WormGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4260.WormGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearSetPowerFlow]
