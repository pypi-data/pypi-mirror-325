...
class RollingRingAssemblyCompoundPowerFlow(_4364.SpecialisedAssemblyCompoundPowerFlow):
    """RollingRingAssemblyCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2673.RollingRingAssembly":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4225.RollingRingAssemblyPowerFlow]":
