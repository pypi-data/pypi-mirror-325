...
class CycloidalDiscCompoundPowerFlow(_4265.AbstractShaftCompoundPowerFlow):
    """CycloidalDiscCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4173.CycloidalDiscPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4173.CycloidalDiscPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CycloidalDiscPowerFlow]
