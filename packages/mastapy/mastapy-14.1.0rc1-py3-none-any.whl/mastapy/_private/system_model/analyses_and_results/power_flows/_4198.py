...
class KlingelnbergCycloPalloidConicalGearSetPowerFlow(_4161.ConicalGearSetPowerFlow):
    """KlingelnbergCycloPalloidConicalGearSetPowerFlow
    ...
    def conical_gears_power_flow(
        self: "Self",
    ) -> "List[_4197.KlingelnbergCycloPalloidConicalGearPowerFlow]":
    ...
    def conical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4196.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]":
