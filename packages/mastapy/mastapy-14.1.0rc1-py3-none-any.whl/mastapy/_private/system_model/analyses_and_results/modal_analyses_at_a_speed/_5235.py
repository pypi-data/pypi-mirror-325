...
class AssemblyModalAnalysisAtASpeed(_5228.AbstractAssemblyModalAnalysisAtASpeed):
    """AssemblyModalAnalysisAtASpeed
    ...
    @property
    def bearings(self: "Self") -> "List[_5236.BearingModalAnalysisAtASpeed]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_5238.BeltDriveModalAnalysisAtASpeed]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_5247.BoltedJointModalAnalysisAtASpeed]":
    ...
    @property
    def bolts(self: "Self") -> "List[_5248.BoltModalAnalysisAtASpeed]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_5269.CVTModalAnalysisAtASpeed]":
    ...
    @property
    def clutches(self: "Self") -> "List[_5251.ClutchModalAnalysisAtASpeed]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_5284.FEPartModalAnalysisAtASpeed]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_5283.FaceGearSetModalAnalysisAtASpeed]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_5303.MassDiscModalAnalysisAtASpeed]":
    ...
    @property
    def microphones(self: "Self") -> "List[_5306.MicrophoneModalAnalysisAtASpeed]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_5309.OilSealModalAnalysisAtASpeed]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_5317.PointLoadModalAnalysisAtASpeed]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_5318.PowerLoadModalAnalysisAtASpeed]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_5320.RingPinsModalAnalysisAtASpeed]":
    ...
    @property
    def shafts(self: "Self") -> "List[_5327.ShaftModalAnalysisAtASpeed]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_5335.SpringDamperModalAnalysisAtASpeed]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_5345.SynchroniserModalAnalysisAtASpeed]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_5356.WormGearSetModalAnalysisAtASpeed]":
