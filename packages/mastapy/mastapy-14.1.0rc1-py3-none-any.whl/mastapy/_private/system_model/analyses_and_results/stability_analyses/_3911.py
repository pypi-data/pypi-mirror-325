...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _3916
...
class FaceGearStabilityAnalysis(_3916.GearStabilityAnalysis):
    """FaceGearStabilityAnalysis
    ...
    @property
    def component_design(self: "Self") -> "_2600.FaceGear":
    ...
    @property
    def component_load_case(self: "Self") -> "_7572.FaceGearLoadCase":
