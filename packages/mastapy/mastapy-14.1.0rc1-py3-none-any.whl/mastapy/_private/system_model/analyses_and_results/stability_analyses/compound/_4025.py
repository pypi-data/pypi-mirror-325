...
class _Cast_ConnectionCompoundStabilityAnalysis:
    ...
    def abstract_shaft_to_mountable_component_connection_compound_stability_analysis(
        self: "CastSelf",
    ) -> "_3993.AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results.stability_analyses.compound import (
            _3993,
        )
    ...
    def coupling_connection_compound_stability_analysis(
        self: "CastSelf",
    ) -> "_4028.CouplingConnectionCompoundStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results.stability_analyses.compound import (
            _4028,
        )

        return self.__parent__._cast(_4028.CouplingConnectionCompoundStabilityAnalysis)

    @property
    def cvt_belt_connection_compound_stability_analysis(
        self: "CastSelf",
    ) -> "_4030.CVTBeltConnectionCompoundStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results.stability_analyses.compound import (
            _4030,
        )

        return self.__parent__._cast(_4030.CVTBeltConnectionCompoundStabilityAnalysis)
    ...
    def ring_pins_to_disc_connection_compound_stability_analysis(
        self: "CastSelf",
    ) -> "_4082.RingPinsToDiscConnectionCompoundStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results.stability_analyses.compound import (
            _4082,
        )
    ...
    def rolling_ring_connection_compound_stability_analysis(
        self: "CastSelf",
    ) -> "_4085.RollingRingConnectionCompoundStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results.stability_analyses.compound import (
            _4085,
        )
...
class ConnectionCompoundStabilityAnalysis(_7700.ConnectionCompoundAnalysis):
    """ConnectionCompoundStabilityAnalysis
    ...
    def connection_analysis_cases(
        self: "Self",
    ) -> "List[_3889.ConnectionStabilityAnalysis]":
