...
class ShaftCompoundStabilityAnalysis(_3991.AbstractShaftCompoundStabilityAnalysis):
    """ShaftCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3954.ShaftStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_3954.ShaftStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.ShaftStabilityAnalysis]
