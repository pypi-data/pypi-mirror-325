...
class StraightBevelDiffGearSetStabilityAnalysis(_3871.BevelGearSetStabilityAnalysis):
    """StraightBevelDiffGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_3968.StraightBevelDiffGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3966.StraightBevelDiffGearMeshStabilityAnalysis]":
