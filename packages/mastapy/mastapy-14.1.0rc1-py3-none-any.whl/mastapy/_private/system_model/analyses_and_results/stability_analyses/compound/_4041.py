...
class DatumCompoundStabilityAnalysis(_4015.ComponentCompoundStabilityAnalysis):
    """DatumCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3906.DatumStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_3906.DatumStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.DatumStabilityAnalysis]
