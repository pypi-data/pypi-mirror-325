...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _3975
...
class SynchroniserHalfStabilityAnalysis(_3975.SynchroniserPartStabilityAnalysis):
    """SynchroniserHalfStabilityAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7657.SynchroniserHalfLoadCase":
