...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2425
...
class FEPartLoadCase(_7496.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self: "Self") -> "_2425.AngleSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2425", "AngleSource"
        )(value)
    ...
    @enforce_parameter_types
    def fe_substructure(self: "Self", value: "_2450.FESubstructure") -> None:
        wrapper_type = (
    ...
    def surfaces_for_data_logging(
        self: "Self",
    ) -> "List[_7523.CMSElementFaceGroupWithSelectionOption]":
