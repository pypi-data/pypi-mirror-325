...
from mastapy._private.system_model.analyses_and_results.static_loads import _7589
...
T = TypeVar("T", bound="_7568.ElectricMachineHarmonicLoadImportOptionsBase")
...
class _Cast_HarmonicLoadDataImportFromMotorPackages:
    ...
    def harmonic_load_data_import_base(
        self: "CastSelf",
    ) -> "_7589.HarmonicLoadDataImportBase":
        return self.__parent__._cast(_7589.HarmonicLoadDataImportBase)

    @property
    def harmonic_load_data_csv_import(
        self: "CastSelf",
    ) -> "_7586.HarmonicLoadDataCSVImport":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7586,
        )

        return self.__parent__._cast(_7586.HarmonicLoadDataCSVImport)

    @property
    def harmonic_load_data_flux_import(
        self: "CastSelf",
    ) -> "_7588.HarmonicLoadDataFluxImport":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7588,
        )

        return self.__parent__._cast(_7588.HarmonicLoadDataFluxImport)

    @property
    def harmonic_load_data_jmag_import(
        self: "CastSelf",
    ) -> "_7591.HarmonicLoadDataJMAGImport":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7591,
        )

        return self.__parent__._cast(_7591.HarmonicLoadDataJMAGImport)

    @property
    def harmonic_load_data_motor_cad_import(
        self: "CastSelf",
    ) -> "_7592.HarmonicLoadDataMotorCADImport":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7592,
        )

        return self.__parent__._cast(_7592.HarmonicLoadDataMotorCADImport)
...
class HarmonicLoadDataImportFromMotorPackages(_7589.HarmonicLoadDataImportBase[T]):
    """HarmonicLoadDataImportFromMotorPackages
