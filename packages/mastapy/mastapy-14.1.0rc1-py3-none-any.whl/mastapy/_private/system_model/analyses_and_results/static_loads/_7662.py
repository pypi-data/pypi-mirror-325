...
class TimeSeriesLoadCase(_7492.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self: "Self") -> "_5577.MBDAnalysisOptions":
    ...
    @property
    def time_series_load_case_group(self: "Self") -> "_5793.TimeSeriesLoadCaseGroup":
    ...
    def duplicate(
        self: "Self",
        new_load_case_group: "_5793.TimeSeriesLoadCaseGroup",
        name: "str" = "None",
    ) -> "TimeSeriesLoadCase":
