...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2268
...
class ConceptCouplingLoadCase(_7541.CouplingLoadCase):
    """ConceptCouplingLoadCase
    ...
    @enforce_parameter_types
    def power_load_for_reference_speed(self: "Self", value: "_2541.PowerLoad") -> None:
        wrapper_type = (
    ...
    def speed_ratio_specification_method(
        self: "Self",
    ) -> "_2268.ConceptCouplingSpeedRatioSpecificationMethod":
    ...
    @enforce_parameter_types
    def speed_ratio_specification_method(
        self: "Self", value: "_2268.ConceptCouplingSpeedRatioSpecificationMethod"
    ) -> None:
