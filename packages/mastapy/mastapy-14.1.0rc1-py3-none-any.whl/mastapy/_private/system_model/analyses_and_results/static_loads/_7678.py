...
class ZerolBevelGearSetLoadCase(_7517.BevelGearSetLoadCase):
    """ZerolBevelGearSetLoadCase
    ...
    @property
    def bevel_gears_load_case(self: "Self") -> "List[_7676.ZerolBevelGearLoadCase]":
    ...
    def zerol_bevel_gears_load_case(
        self: "Self",
    ) -> "List[_7676.ZerolBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ZerolBevelGearLoadCase]
    ...
    def bevel_meshes_load_case(
        self: "Self",
    ) -> "List[_7677.ZerolBevelGearMeshLoadCase]":
