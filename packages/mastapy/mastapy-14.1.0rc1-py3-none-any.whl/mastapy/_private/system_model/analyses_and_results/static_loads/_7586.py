...
from mastapy._private.system_model.analyses_and_results.static_loads import _7590
...
class _Cast_HarmonicLoadDataCSVImport:
    ...
    def harmonic_load_data_import_from_motor_packages(
        self: "CastSelf",
    ) -> "_7590.HarmonicLoadDataImportFromMotorPackages":
        return self.__parent__._cast(_7590.HarmonicLoadDataImportFromMotorPackages)
...
class HarmonicLoadDataCSVImport(_7590.HarmonicLoadDataImportFromMotorPackages[T]):
    """HarmonicLoadDataCSVImport
    ...
    def electric_machine_data_per_speed(
        self: "Self",
    ) -> "List[_7556.DataFromMotorPackagePerSpeed]":
