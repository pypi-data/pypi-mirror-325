...
class BevelGearSetLoadCase(_7503.AGMAGleasonConicalGearSetLoadCase):
    """BevelGearSetLoadCase
    ...
    @property
    def bevel_gears_load_case(self: "Self") -> "List[_7515.BevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.BevelGearLoadCase]
    ...
    def agma_gleason_conical_meshes_load_case(
        self: "Self",
    ) -> "List[_7516.BevelGearMeshLoadCase]":
    ...
    @property
    def bevel_meshes_load_case(self: "Self") -> "List[_7516.BevelGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.BevelGearMeshLoadCase]
