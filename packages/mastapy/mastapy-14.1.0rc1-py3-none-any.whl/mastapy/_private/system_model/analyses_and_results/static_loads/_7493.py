...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2725, _2758
...
class StaticLoadCase(_7492.LoadCase):
    """StaticLoadCase
    ...
    def unbalanced_mass_inclusion(
        self: "Self",
        value: "Union[_2548.UnbalancedMassInclusionOption, Tuple[_2548.UnbalancedMassInclusionOption, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    def advanced_system_deflection_options(
        self: "Self",
    ) -> "_7216.AdvancedSystemDeflectionOptions":
    ...
    def te_set_up_for_dynamic_analyses_options(
        self: "Self",
    ) -> "_2758.TESetUpForDynamicAnalysisOptions":
    ...
    @property
    def clutch_engagements(self: "Self") -> "List[_5783.ClutchEngagementStatus]":
    ...
    def concept_clutch_engagements(
        self: "Self",
    ) -> "List[_5784.ConceptSynchroGearEngagementStatus]":
    ...
    @property
    def design_state_load_case_group(self: "Self") -> "_5785.DesignState":
    ...
    @enforce_parameter_types
    def duplicate(
        self: "Self", new_design_state_group: "_5785.DesignState", name: "str" = "None"
    ) -> "StaticLoadCase":
