...
class StraightBevelDiffGearSetSystemDeflection(_2782.BevelGearSetSystemDeflection):
    """StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4241.StraightBevelDiffGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_2892.StraightBevelDiffGearSystemDeflection]":
