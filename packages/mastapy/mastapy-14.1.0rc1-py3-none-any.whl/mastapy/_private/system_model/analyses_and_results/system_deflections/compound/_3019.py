...
class PulleyCompoundSystemDeflection(_2967.CouplingHalfCompoundSystemDeflection):
    """PulleyCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2870.PulleySystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2870.PulleySystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.PulleySystemDeflection]
