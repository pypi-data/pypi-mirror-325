...
class BearingDynamicResultsUIWrapper(_0.APIBase):
    ...
    @property
    def bearing_system_deflection(self: "Self") -> "_2773.BearingSystemDeflection":
    ...
    def bearing_results(
        self: "Self",
    ) -> "List[_2771.BearingDynamicResultsPropertyWrapper]":
    ...
    def element_results(
        self: "Self",
    ) -> "List[_2769.BearingDynamicElementPropertyWrapper]":
    ...
    def post_analysis_results(
        self: "Self",
    ) -> "List[_2770.BearingDynamicPostAnalysisResultWrapper]":
