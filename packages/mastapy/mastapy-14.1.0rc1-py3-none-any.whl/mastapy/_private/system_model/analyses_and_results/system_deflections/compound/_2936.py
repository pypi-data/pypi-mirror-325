...
class BearingCompoundSystemDeflection(_2964.ConnectorCompoundSystemDeflection):
    """BearingCompoundSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_2013.LoadedBearingDutyCycle":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2773.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
