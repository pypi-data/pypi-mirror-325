...
class ClutchCompoundSystemDeflection(_2965.CouplingCompoundSystemDeflection):
    """ClutchCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2788.ClutchSystemDeflection]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_2788.ClutchSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.ClutchSystemDeflection]
