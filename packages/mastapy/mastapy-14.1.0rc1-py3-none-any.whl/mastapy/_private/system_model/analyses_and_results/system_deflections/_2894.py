...
class StraightBevelGearSetSystemDeflection(_2782.BevelGearSetSystemDeflection):
    """StraightBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4244.StraightBevelGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_2895.StraightBevelGearSystemDeflection]":
