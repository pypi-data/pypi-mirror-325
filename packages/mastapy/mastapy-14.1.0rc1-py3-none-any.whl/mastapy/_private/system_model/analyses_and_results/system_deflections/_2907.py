...
class TorqueConverterSystemDeflection(_2806.CouplingSystemDeflection):
    """TorqueConverterSystemDeflection
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7664.TorqueConverterLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4253.TorqueConverterPowerFlow":
