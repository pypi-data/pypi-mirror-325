...
class PartSystemDeflection(_7708.PartFEAnalysis):
    """PartSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4211.PartPowerFlow":
    ...
    def create_viewable(self: "Self") -> "_2326.SystemDeflectionViewable":
