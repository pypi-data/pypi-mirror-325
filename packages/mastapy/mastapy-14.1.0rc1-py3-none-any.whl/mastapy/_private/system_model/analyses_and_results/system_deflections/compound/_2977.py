...
class CylindricalGearSetCompoundSystemDeflection(_2989.GearSetCompoundSystemDeflection):
    """CylindricalGearSetCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2819.CylindricalGearSetSystemDeflectionWithLTCAResults]":
    ...
    def cylindrical_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_2975.CylindricalGearCompoundSystemDeflection]":
    ...
    def cylindrical_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_2976.CylindricalGearMeshCompoundSystemDeflection]":
