...
class TorqueConverterPumpSystemDeflection(_2805.CouplingHalfSystemDeflection):
    """TorqueConverterPumpSystemDeflection
    ...
    @property
    def component_design(self: "Self") -> "_2688.TorqueConverterPump":
    ...
    @property
    def component_load_case(self: "Self") -> "_7665.TorqueConverterPumpLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4254.TorqueConverterPumpPowerFlow":
