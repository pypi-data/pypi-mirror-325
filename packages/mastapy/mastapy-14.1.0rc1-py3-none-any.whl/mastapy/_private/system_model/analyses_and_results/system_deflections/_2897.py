...
class StraightBevelSunGearSystemDeflection(_2892.StraightBevelDiffGearSystemDeflection):
    """StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4246.StraightBevelSunGearPowerFlow":
