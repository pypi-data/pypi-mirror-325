...
class RollingRingAssemblySystemDeflection(_2883.SpecialisedAssemblySystemDeflection):
    """RollingRingAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4225.RollingRingAssemblyPowerFlow":
