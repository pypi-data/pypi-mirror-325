...
class ConnectorSystemDeflection(_2859.MountableComponentSystemDeflection):
    """ConnectorSystemDeflection
    ...
    @property
    def outer_fe_part(self: "Self") -> "_2832.FEPartSystemDeflection":
    ...
    @property
    def outer_fe_substructure_nodes(self: "Self") -> "List[_2452.FESubstructureNode]":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4163.ConnectorPowerFlow":
