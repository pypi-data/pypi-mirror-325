...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2760
...
class AssemblySystemDeflection(_2760.AbstractAssemblySystemDeflection):
    """AssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4134.AssemblyPowerFlow":
    ...
    @property
    def bearings(self: "Self") -> "List[_2773.BearingSystemDeflection]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_2775.BeltDriveSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_2777.BevelDifferentialGearSetSystemDeflection]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_2784.BoltedJointSystemDeflection]":
    ...
    @property
    def bolts(self: "Self") -> "List[_2785.BoltSystemDeflection]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_2809.CVTSystemDeflection]":
    ...
    @property
    def clutches(self: "Self") -> "List[_2788.ClutchSystemDeflection]":
    ...
    @property
    def component_details(self: "Self") -> "List[_2790.ComponentSystemDeflection]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_2794.ConceptCouplingSystemDeflection]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_2796.ConceptGearSetSystemDeflection]":
    ...
    @property
    def connection_details(self: "Self") -> "List[_2802.ConnectionSystemDeflection]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_2813.CycloidalDiscSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_2817.CylindricalGearSetSystemDeflection]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_2832.FEPartSystemDeflection]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_2830.FaceGearSetSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_2833.FlexiblePinAssemblySystemDeflection]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_2839.HypoidGearSetSystemDeflection]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_2854.MassDiscSystemDeflection]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_2855.MeasurementComponentSystemDeflection]":
    ...
    @property
    def microphones(self: "Self") -> "List[_2858.MicrophoneSystemDeflection]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_2861.OilSealSystemDeflection]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_2867.PlanetCarrierSystemDeflection]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_2868.PointLoadSystemDeflection]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_2869.PowerLoadSystemDeflection]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_2871.RingPinsSystemDeflection]":
    ...
    @property
    def rolling_bearings(self: "Self") -> "List[_2773.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_2874.RollingRingAssemblySystemDeflection]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_2878.ShaftHubConnectionSystemDeflection]":
    ...
    @property
    def shafts(self: "Self") -> "List[_2881.ShaftSystemDeflection]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_2889.SpringDamperSystemDeflection]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_2901.SynchroniserSystemDeflection]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_2907.TorqueConverterSystemDeflection]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_2911.UnbalancedMassSystemDeflection]":
    ...
    def unconverged_bearings_sorted_by_load(
        self: "Self",
    ) -> "List[_2773.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_2914.WormGearSetSystemDeflection]":
