...
class HypoidGearMeshSystemDeflection(_2764.AGMAGleasonConicalGearMeshSystemDeflection):
    """HypoidGearMeshSystemDeflection
    ...
    @property
    def connection_load_case(self: "Self") -> "_7594.HypoidGearMeshLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4192.HypoidGearMeshPowerFlow":
