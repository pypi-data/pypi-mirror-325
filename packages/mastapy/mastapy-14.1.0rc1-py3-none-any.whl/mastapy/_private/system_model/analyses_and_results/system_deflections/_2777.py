...
class BevelDifferentialGearSetSystemDeflection(_2782.BevelGearSetSystemDeflection):
    """BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4140.BevelDifferentialGearSetPowerFlow":
    ...
    def bevel_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2776.BevelDifferentialGearMeshSystemDeflection]":
