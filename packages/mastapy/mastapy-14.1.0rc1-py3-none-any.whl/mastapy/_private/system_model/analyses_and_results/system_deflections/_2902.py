...
class SystemDeflection(_7705.FEAnalysis):
    """SystemDeflection
    ...
    @property
    def analysis_options(self: "Self") -> "_2904.SystemDeflectionOptions":
    ...
    def overall_efficiency_results(
        self: "Self",
    ) -> "_2852.LoadCaseOverallEfficiencyResult":
    ...
    @property
    def bearing_race_f_es(self: "Self") -> "List[_2474.RaceBearingFESystemDeflection]":
