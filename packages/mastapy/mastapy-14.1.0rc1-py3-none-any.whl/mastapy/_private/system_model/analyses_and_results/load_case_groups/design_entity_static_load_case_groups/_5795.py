...
TReal = TypeVar("TReal", bound="_2511.Component")
TComponentStaticLoad = TypeVar("TComponentStaticLoad", bound="_7525.ComponentLoadCase")
...
class ComponentStaticLoadCaseGroup(
    _5799.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]
):
    """ComponentStaticLoadCaseGroup
