...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5782
...
class _Cast_DutyCycle:
    ...
    def abstract_static_load_case_group(
        self: "CastSelf",
    ) -> "_5782.AbstractStaticLoadCaseGroup":
        return self.__parent__._cast(_5782.AbstractStaticLoadCaseGroup)
...
class DutyCycle(_5782.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    def duty_cycle_design_states(
        self: "Self",
    ) -> "List[_5789.SubGroupInSingleDesignState]":
    ...
    @property
    def time_series_importer(self: "Self") -> "_7692.TimeSeriesImporter":
    ...
    def add_static_load(self: "Self", static_load: "_7493.StaticLoadCase") -> None:
        """Method does not return.
    ...
    def remove_design_state_sub_group(
        self: "Self", sub_group: "_5789.SubGroupInSingleDesignState"
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_static_load(self: "Self", static_load: "_7493.StaticLoadCase") -> None:
        """Method does not return.
