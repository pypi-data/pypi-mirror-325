...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2602, _2604
...
TGearSet = TypeVar("TGearSet", bound="_2604.GearSet")
TGear = TypeVar("TGear", bound="_2602.Gear")
TGearStaticLoad = TypeVar("TGearStaticLoad", bound="_7578.GearLoadCase")
TGearMesh = TypeVar("TGearMesh", bound="_2379.GearMesh")
TGearMeshStaticLoad = TypeVar("TGearMeshStaticLoad", bound="_7580.GearMeshLoadCase")
TGearSetStaticLoad = TypeVar("TGearSetStaticLoad", bound="_7583.GearSetLoadCase")
...
class _Cast_GearSetStaticLoadCaseGroup:
    ...
    def part_static_load_case_group(
        self: "CastSelf",
    ) -> "_5799.PartStaticLoadCaseGroup":
        return self.__parent__._cast(_5799.PartStaticLoadCaseGroup)

    @property
    def design_entity_static_load_case_group(
        self: "CastSelf",
    ) -> "_5797.DesignEntityStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import (
            _5797,
        )

        return self.__parent__._cast(_5797.DesignEntityStaticLoadCaseGroup)
...
class GearSetStaticLoadCaseGroup(
    ...
    def gears_load_cases(
        self: "Self",
    ) -> "List[_5795.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]":
    ...
    def meshes_load_cases(
        self: "Self",
    ) -> "List[_5796.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]":
