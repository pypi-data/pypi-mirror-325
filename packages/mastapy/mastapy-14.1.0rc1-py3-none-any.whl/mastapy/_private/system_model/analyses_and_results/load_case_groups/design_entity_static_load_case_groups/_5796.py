...
TConnection = TypeVar("TConnection", bound="_2338.Connection")
TConnectionStaticLoad = TypeVar(
    "TConnectionStaticLoad", bound="_7537.ConnectionLoadCase"
)
...
class ConnectionStaticLoadCaseGroup(
    _5797.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]
):
    """ConnectionStaticLoadCaseGroup
