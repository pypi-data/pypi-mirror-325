...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2722, _2750
...
class TimeSeriesLoadCaseGroup(_5781.AbstractLoadCaseGroup):
    """TimeSeriesLoadCaseGroup
    ...
    @property
    def load_cases(self: "Self") -> "List[_7662.TimeSeriesLoadCase]":
