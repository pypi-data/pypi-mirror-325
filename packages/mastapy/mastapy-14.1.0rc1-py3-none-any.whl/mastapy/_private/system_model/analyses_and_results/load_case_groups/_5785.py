...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5780
...
class DesignState(_5780.AbstractDesignStateLoadCaseGroup):
    """DesignState
    ...
    @property
    def clutches(self: "Self") -> "List[_5783.ClutchEngagementStatus]":
    ...
    def clutch_engagement_status_for(
        self: "Self", clutch_connection: "_2408.ClutchConnection"
    ) -> "_5783.ClutchEngagementStatus":
    ...
    def concept_synchro_gear_engagement_status_for(
        self: "Self", gear: "_2597.CylindricalGear"
    ) -> "_5784.ConceptSynchroGearEngagementStatus":
