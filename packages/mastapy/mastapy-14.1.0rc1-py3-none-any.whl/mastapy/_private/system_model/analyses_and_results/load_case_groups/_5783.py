...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5787
...
class _Cast_ClutchEngagementStatus:
    ...
    def generic_clutch_engagement_status(
        self: "CastSelf",
    ) -> "_5787.GenericClutchEngagementStatus":
        return self.__parent__._cast(_5787.GenericClutchEngagementStatus)
...
class ClutchEngagementStatus(
    _5787.GenericClutchEngagementStatus[_2408.ClutchConnection]
):
    """ClutchEngagementStatus
