...
class ClutchHalfCompoundModalAnalysis(_4872.CouplingHalfCompoundModalAnalysis):
    """ClutchHalfCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4697.ClutchHalfModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4697.ClutchHalfModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ClutchHalfModalAnalysis]
