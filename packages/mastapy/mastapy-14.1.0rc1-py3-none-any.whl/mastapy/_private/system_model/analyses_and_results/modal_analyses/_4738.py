...
class GearMeshModalAnalysis(_4745.InterMountableComponentConnectionModalAnalysis):
    """GearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2834.GearMeshSystemDeflection":
