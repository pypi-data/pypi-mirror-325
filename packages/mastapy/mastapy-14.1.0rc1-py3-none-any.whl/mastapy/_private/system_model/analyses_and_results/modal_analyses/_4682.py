...
class AssemblyModalAnalysis(_4675.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2767.AssemblySystemDeflection":
    ...
    @property
    def bearings(self: "Self") -> "List[_4683.BearingModalAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_4685.BeltDriveModalAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_4688.BevelDifferentialGearSetModalAnalysis]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_4694.BoltedJointModalAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_4695.BoltModalAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_4717.CVTModalAnalysis]":
    ...
    def calculate_full_fe_results_by_mode(
        self: "Self",
    ) -> "List[_4821.CalculateFullFEResultsForMode]":
    ...
    @property
    def clutches(self: "Self") -> "List[_4698.ClutchModalAnalysis]":
    ...
    @property
    def concept_couplings(self: "Self") -> "List[_4703.ConceptCouplingModalAnalysis]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_4706.ConceptGearSetModalAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_4719.CycloidalAssemblyModalAnalysis]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_4721.CycloidalDiscModalAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_4725.CylindricalGearSetModalAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_4735.FEPartModalAnalysis]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_4734.FaceGearSetModalAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_4736.FlexiblePinAssemblyModalAnalysis]":
    ...
    def full_fe_meshes_for_calculating_modes(
        self: "Self",
    ) -> "List[_4735.FEPartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FEPartModalAnalysis]
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_4744.HypoidGearSetModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_4751.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_4755.MassDiscModalAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_4756.MeasurementComponentModalAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_4758.MicrophoneModalAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_4765.OilSealModalAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_4770.PartToPartShearCouplingModalAnalysis]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_4773.PlanetCarrierModalAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_4774.PointLoadModalAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_4775.PowerLoadModalAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_4777.RingPinsModalAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_4779.RollingRingAssemblyModalAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_4783.ShaftHubConnectionModalAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_4784.ShaftModalAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4790.SpiralBevelGearSetModalAnalysis]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_4793.SpringDamperModalAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_4796.StraightBevelDiffGearSetModalAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4799.StraightBevelGearSetModalAnalysis]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_4803.SynchroniserModalAnalysis]":
    ...
    @property
    def torque_converters(self: "Self") -> "List[_4807.TorqueConverterModalAnalysis]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_4810.UnbalancedMassModalAnalysis]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_4817.WormGearSetModalAnalysis]":
