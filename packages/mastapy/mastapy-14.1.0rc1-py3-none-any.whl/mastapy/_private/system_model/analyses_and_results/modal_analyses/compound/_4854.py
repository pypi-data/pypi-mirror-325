...
class ClutchCompoundModalAnalysis(_4870.CouplingCompoundModalAnalysis):
    """ClutchCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4698.ClutchModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4698.ClutchModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ClutchModalAnalysis]
