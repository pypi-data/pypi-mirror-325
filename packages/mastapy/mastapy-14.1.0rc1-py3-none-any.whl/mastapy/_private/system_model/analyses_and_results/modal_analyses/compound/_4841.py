...
class BearingCompoundModalAnalysis(_4869.ConnectorCompoundModalAnalysis):
    """BearingCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4683.BearingModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4683.BearingModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BearingModalAnalysis]
