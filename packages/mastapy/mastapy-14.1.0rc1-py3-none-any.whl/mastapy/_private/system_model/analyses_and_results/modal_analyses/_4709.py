...
class ConicalGearSetModalAnalysis(_4740.GearSetModalAnalysis):
    """ConicalGearSetModalAnalysis
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4708.ConicalGearModalAnalysis]":
    ...
    def conical_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4708.ConicalGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ConicalGearModalAnalysis]
    ...
    def meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4707.ConicalGearMeshModalAnalysis]":
