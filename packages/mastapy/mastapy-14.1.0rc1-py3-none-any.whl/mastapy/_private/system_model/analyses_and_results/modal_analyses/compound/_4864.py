...
class ConceptGearSetCompoundModalAnalysis(_4893.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4706.ConceptGearSetModalAnalysis]":
    ...
    def concept_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4862.ConceptGearCompoundModalAnalysis]":
    ...
    def concept_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4863.ConceptGearMeshCompoundModalAnalysis]":
