...
class AbstractAssemblyModalAnalysis(_4767.PartModalAnalysis):
    """AbstractAssemblyModalAnalysis
    ...
    @property
    def gear_meshes(self: "Self") -> "List[_4738.GearMeshModalAnalysis]":
    ...
    @property
    def rigidly_connected_groups(self: "Self") -> "List[_4700.ComponentModalAnalysis]":
