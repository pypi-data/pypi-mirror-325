...
class WormGearSetModalAnalysis(_4740.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2914.WormGearSetSystemDeflection":
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4816.WormGearModalAnalysis]":
    ...
    @property
    def worm_gears_modal_analysis(self: "Self") -> "List[_4816.WormGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearModalAnalysis]
    ...
    @property
    def meshes_modal_analysis(self: "Self") -> "List[_4815.WormGearMeshModalAnalysis]":
    ...
    def worm_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4815.WormGearMeshModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearMeshModalAnalysis]
