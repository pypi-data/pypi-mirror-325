...
class ModalAnalysis(_7711.StaticLoadAnalysisCase):
    """ModalAnalysis
    ...
    @property
    def analysis_settings(self: "Self") -> "_4762.ModalAnalysisOptions":
    ...
    @property
    def bar_model_export(self: "Self") -> "_4760.ModalAnalysisBarModelFEExportOptions":
    ...
    @property
    def modal_analysis_results(self: "Self") -> "_6460.DynamicAnalysis":
