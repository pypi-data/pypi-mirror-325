...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        ...
        "List[_7290.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection]"
    ):
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7421.KlingelnbergCycloPalloidSpiralBevelGearCompoundAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7422.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundAdvancedSystemDeflection]":
