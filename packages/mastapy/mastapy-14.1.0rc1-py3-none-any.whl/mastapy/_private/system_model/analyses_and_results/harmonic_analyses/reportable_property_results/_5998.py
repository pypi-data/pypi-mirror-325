...
class ResultsForResponseOfAComponentOrSurfaceInAHarmonic(_0.APIBase):
    ...
    def magnitude(
        self: "Self",
    ) -> "_6000.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic":
    ...
    def result_at_reference_speed(
        self: "Self",
    ) -> "_5980.DataPointForResponseOfAComponentOrSurfaceAtAFrequencyToAHarmonic":
    ...
    def data_points(
        self: "Self",
    ) -> "List[_5980.DataPointForResponseOfAComponentOrSurfaceAtAFrequencyToAHarmonic]":
