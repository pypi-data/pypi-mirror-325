...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2136
...
class BearingHarmonicAnalysis(_5838.ConnectorHarmonicAnalysis):
    """BearingHarmonicAnalysis
    ...
    def rolling_bearing_speed_results(
        self: "Self",
    ) -> "_2136.RollingBearingSpeedResults":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2773.BearingSystemDeflection":
