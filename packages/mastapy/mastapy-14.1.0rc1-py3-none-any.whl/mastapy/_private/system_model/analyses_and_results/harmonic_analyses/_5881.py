...
class GearSetHarmonicAnalysis(_5935.SpecialisedAssemblyHarmonicAnalysis):
    """GearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self: "Self") -> "List[_5876.GearHarmonicAnalysis]":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2835.GearSetSystemDeflection":
