...
class _Cast_ResultsForMultipleOrdersForFESurface:
    ...
    def results_for_multiple_orders(
        self: "CastSelf",
    ) -> "_5991.ResultsForMultipleOrders":
        return self.__parent__._cast(_5991.ResultsForMultipleOrders)
...
class ResultsForMultipleOrdersForFESurface(_5991.ResultsForMultipleOrders):
    """ResultsForMultipleOrdersForFESurface
