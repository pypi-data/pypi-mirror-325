...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5962
...
class PointLoadHarmonicAnalysis(_5962.VirtualComponentHarmonicAnalysis):
    """PointLoadHarmonicAnalysis
    ...
    @property
    def component_design(self: "Self") -> "_2540.PointLoad":
    ...
    @property
    def component_load_case(self: "Self") -> "_7628.PointLoadLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2868.PointLoadSystemDeflection":
