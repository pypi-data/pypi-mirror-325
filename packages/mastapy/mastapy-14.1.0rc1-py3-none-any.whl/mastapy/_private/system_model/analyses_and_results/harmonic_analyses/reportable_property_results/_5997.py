...
class _Cast_ResultsForOrderIncludingSurfaces:
    ...
    @property
    def results_for_order(self: "CastSelf") -> "_5994.ResultsForOrder":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _5994,
        )

        return self.__parent__._cast(_5994.ResultsForOrder)
...
class ResultsForOrderIncludingSurfaces(_5996.ResultsForOrderIncludingNodes):
    """ResultsForOrderIncludingSurfaces
    ...
    def fe_surfaces(
        self: "Self",
    ) -> "List[_5989.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]":
