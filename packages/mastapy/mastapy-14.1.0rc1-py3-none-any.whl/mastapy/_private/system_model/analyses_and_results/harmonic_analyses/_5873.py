...
class FEPartHarmonicAnalysis(
    _5803.AbstractShaftOrHousingHarmonicAnalysis,
    _2729.IHaveFEPartHarmonicAnalysisResults,
):
    """FEPartHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4735.FEPartModalAnalysis":
    ...
    @property
    def export(self: "Self") -> "_5887.HarmonicAnalysisFEExportOptions":
    ...
    @property
    def results(self: "Self") -> "_5982.FEPartHarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2832.FEPartSystemDeflection":
