...
class BevelDifferentialGearSetCompoundHarmonicAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5814.BevelDifferentialGearSetHarmonicAnalysis]":
    ...
    def bevel_differential_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6015.BevelDifferentialGearCompoundHarmonicAnalysis]":
    ...
    def bevel_differential_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6016.BevelDifferentialGearMeshCompoundHarmonicAnalysis]":
