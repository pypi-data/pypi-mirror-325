...
class _Cast_ExcitationSourceSelectionGroup:
    ...
    def excitation_source_selection_base(
        self: "CastSelf",
    ) -> "_5971.ExcitationSourceSelectionBase":
        return self.__parent__._cast(_5971.ExcitationSourceSelectionBase)
...
class ExcitationSourceSelectionGroup(_5971.ExcitationSourceSelectionBase):
    """ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self: "Self") -> "List[_5971.ExcitationSourceSelectionBase]":
