...
class ShaftHarmonicAnalysis(
    _5802.AbstractShaftHarmonicAnalysis, _2731.IHaveShaftHarmonicResults
):
    """ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4784.ShaftModalAnalysis":
    ...
    @property
    def export(self: "Self") -> "_5891.HarmonicAnalysisShaftExportOptions":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2881.ShaftSystemDeflection":
