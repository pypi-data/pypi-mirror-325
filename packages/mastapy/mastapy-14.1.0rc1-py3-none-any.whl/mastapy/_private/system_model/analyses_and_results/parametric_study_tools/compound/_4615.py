...
class KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4473.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4613.KlingelnbergCycloPalloidHypoidGearCompoundParametricStudyTool]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_parametric_study_tool(
        ...
        "List[_4614.KlingelnbergCycloPalloidHypoidGearMeshCompoundParametricStudyTool]"
    ):
