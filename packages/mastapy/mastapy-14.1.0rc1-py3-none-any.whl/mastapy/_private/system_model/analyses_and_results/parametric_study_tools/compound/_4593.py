...
class CylindricalGearSetCompoundParametricStudyTool(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4444.CylindricalGearSetParametricStudyTool]":
    ...
    def cylindrical_gears_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4591.CylindricalGearCompoundParametricStudyTool]":
    ...
    def cylindrical_meshes_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4592.CylindricalGearMeshCompoundParametricStudyTool]":
