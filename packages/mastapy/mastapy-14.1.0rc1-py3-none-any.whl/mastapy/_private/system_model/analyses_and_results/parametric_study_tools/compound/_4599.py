...
class FaceGearSetCompoundParametricStudyTool(_4604.GearSetCompoundParametricStudyTool):
    """FaceGearSetCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7574.FaceGearSetLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4457.FaceGearSetParametricStudyTool]":
    ...
    def face_gears_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4597.FaceGearCompoundParametricStudyTool]":
    ...
    def face_meshes_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4598.FaceGearMeshCompoundParametricStudyTool]":
