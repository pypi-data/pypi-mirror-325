...
class DutyCycleResultsForAllComponents(_0.APIBase):
    ...
    def results_for_all_gear_sets(
        self: "Self",
    ) -> "_4450.DutyCycleResultsForAllGearSets":
    ...
    def results_for_root_assembly(
        self: "Self",
    ) -> "_4451.DutyCycleResultsForRootAssembly":
    ...
    def results_for_all_bearings(
        self: "Self",
    ) -> "List[_4452.DutyCycleResultsForSingleBearing]":
    ...
    def results_for_all_shafts(
        self: "Self",
    ) -> "List[_4453.DutyCycleResultsForSingleShaft]":
