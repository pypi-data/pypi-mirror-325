...
class RollingRingCompoundParametricStudyTool(
    ...
    @property
    def component_design(self: "Self") -> "_2672.RollingRing":
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7637.RollingRingLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4508.RollingRingParametricStudyTool]":
