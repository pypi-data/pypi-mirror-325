...
class ShaftCompoundParametricStudyTool(_4545.AbstractShaftCompoundParametricStudyTool):
    """ShaftCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7640.ShaftLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4511.ShaftParametricStudyTool]":
