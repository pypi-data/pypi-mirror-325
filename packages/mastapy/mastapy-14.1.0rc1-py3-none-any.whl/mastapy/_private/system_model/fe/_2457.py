...
class _Cast_FESubstructureWithSelection:
    ...
    def fe_substructure_with_selection_components(
        ...
        return self.__parent__._cast(_2458.FESubstructureWithSelectionComponents)
    ...
    def fe_substructure_with_selection_for_modal_analysis(
        ...
        return self.__parent__._cast(_2460.FESubstructureWithSelectionForModalAnalysis)
    ...
    def fe_substructure_with_selection_for_static_analysis(
        ...
        return self.__parent__._cast(_2461.FESubstructureWithSelectionForStaticAnalysis)
...
class FESubstructureWithSelection(_2426.BaseFEWithSelection):
    """FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self: "Self") -> "_2450.FESubstructure":
    ...
    def element_face_groups(
        self: "Self",
    ) -> "List[_2442.ElementFaceGroupWithSelection]":
    ...
    @property
    def node_groups(self: "Self") -> "List[_2468.NodeGroupWithSelection]":
