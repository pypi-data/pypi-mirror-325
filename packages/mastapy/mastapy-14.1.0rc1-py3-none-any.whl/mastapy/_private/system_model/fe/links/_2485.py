...
from mastapy._private.system_model.fe import _2429, _2452, _2465, _2469
...
class _Cast_FELink:
    ...
    @property
    def single_node_fe_link(self: "CastSelf") -> "_2499.SingleNodeFELink":
        from mastapy._private.system_model.fe.links import _2499

        return self.__parent__._cast(_2499.SingleNodeFELink)
...
class FELink(_0.APIBase):
    ...
    @enforce_parameter_types
    def bearing_node_link_option(
        self: "Self", value: "_2429.BearingNodeOption"
    ) -> None:
    ...
    @enforce_parameter_types
    def link_node_source(self: "Self", value: "_2465.LinkNodeSource") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def node_selection_depth(
        self: "Self",
        value: "Union[_2469.NodeSelectionDepthOption, Tuple[_2469.NodeSelectionDepthOption, bool]]",
    ) -> None:
    ...
    def alignment_in_component_coordinate_system(
        self: "Self",
    ) -> "_2464.LinkComponentAxialPositionErrorReporter":
    ...
    @property
    def component(self: "Self") -> "_2533.MountableComponent":
    ...
    @property
    def socket(self: "Self") -> "_2362.Socket":
    ...
    def nodes_grouped_by_angle(
        self: "Self",
    ) -> "OrderedDict[float, List[_2452.FESubstructureNode]]":
    ...
    @enforce_parameter_types
    def add_or_replace_node(self: "Self", node: "_2452.FESubstructureNode") -> None:
