...
class _Cast_NodeGroupWithSelection:
    ...
    def fe_entity_group_with_selection(
        self: "CastSelf",
    ) -> "_2444.FEEntityGroupWithSelection":
        return self.__parent__._cast(_2444.FEEntityGroupWithSelection)
...
class NodeGroupWithSelection(_2444.FEEntityGroupWithSelection[_246.CMSNodeGroup, int]):
    """NodeGroupWithSelection
