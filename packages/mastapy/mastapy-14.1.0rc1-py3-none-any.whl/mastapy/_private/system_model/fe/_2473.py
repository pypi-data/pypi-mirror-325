...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2423, _2430
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self: "Self") -> "_2423.AlignmentMethodForRaceBearing":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2423", "AlignmentMethodForRaceBearing"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(
        self: "Self", value: "_2423.AlignmentMethodForRaceBearing"
    ) -> None:
    ...
    @property
    def links(self: "Self") -> "List[_2430.BearingRaceNodeLink]":
