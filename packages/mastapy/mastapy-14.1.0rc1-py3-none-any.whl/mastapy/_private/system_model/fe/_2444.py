...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2442, _2468
...
class _Cast_FEEntityGroupWithSelection:
    ...
    def element_face_group_with_selection(
        self: "CastSelf",
    ) -> "_2442.ElementFaceGroupWithSelection":
        from mastapy._private.system_model.fe import _2442

        return self.__parent__._cast(_2442.ElementFaceGroupWithSelection)

    @property
    def node_group_with_selection(self: "CastSelf") -> "_2468.NodeGroupWithSelection":
        from mastapy._private.system_model.fe import _2468

        return self.__parent__._cast(_2468.NodeGroupWithSelection)
