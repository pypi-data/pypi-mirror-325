...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2471, _2472
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def links(self: "Self") -> "List[_2471.PerLinkExportOptions]":
    ...
    @property
    def nodes(self: "Self") -> "List[_2472.PerNodeExportOptions]":
