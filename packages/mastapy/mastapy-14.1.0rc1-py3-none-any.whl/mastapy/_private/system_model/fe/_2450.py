...
from mastapy._private.system_model.fe import _2455, _2478
from mastapy._private.system_model.part_model import _2511, _2515
...
class FESubstructure(_69.FEStiffness):
    ...
    @property
    def alignment_method(self: "Self") -> "_2422.AlignmentMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2422", "AlignmentMethod"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(self: "Self", value: "_2422.AlignmentMethod") -> None:
    ...
    @property
    def bearing_node_alignment(self: "Self") -> "_2428.BearingNodeAlignmentOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2428", "BearingNodeAlignmentOption"
        )(value)

    @bearing_node_alignment.setter
    @enforce_parameter_types
    def bearing_node_alignment(
        self: "Self", value: "_2428.BearingNodeAlignmentOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def component_to_align_to(self: "Self", value: "_2511.Component") -> None:
        wrapper_type = (
    ...
    @datum.setter
    @enforce_parameter_types
    def datum(self: "Self", value: "_2515.Datum") -> None:
    ...
    @enforce_parameter_types
    def thermal_expansion_option(
        self: "Self", value: "_2478.ThermalExpansionOption"
    ) -> None:
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: "Self", value: "_2455.FESubstructureType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def alignment_using_axial_node_positions(
        self: "Self",
    ) -> "_2424.AlignmentUsingAxialNodePositions":
    ...
    def alignment_to_component(
        self: "Self",
    ) -> "_2286.RelativeComponentAlignment[_2511.Component]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2511.Component](temp)
    ...
    @property
    def export(self: "Self") -> "_2451.FESubstructureExportOptions":
    ...
    @property
    def fe_part(self: "Self") -> "_2520.FEPart":
    ...
    @property
    def gear_meshing_options(self: "Self") -> "List[_2462.GearMeshingOptions]":
    ...
    @property
    def geometries(self: "Self") -> "List[_2448.FEStiffnessGeometry]":
    ...
    def independent_masta_created_condensation_nodes(
        self: "Self",
    ) -> "List[_2463.IndependentMASTACreatedCondensationNode]":
    ...
    @property
    def links(self: "Self") -> "List[_2485.FELink]":
    ...
    @property
    def nodes(self: "Self") -> "List[_2452.FESubstructureNode]":
    ...
    @property
    def replaced_shafts(self: "Self") -> "List[_2552.Shaft]":
    ...
    def shafts_that_can_be_replaced(
        self: "Self",
    ) -> "List[_2476.ReplacedShaftSelectionHelper]":
    ...
    def create_fe_substructure_with_selection_components(
        self: "Self",
    ) -> "_2458.FESubstructureWithSelectionComponents":
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(
        self: "Self",
    ) -> "_2459.FESubstructureWithSelectionForHarmonicAnalysis":
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(
        self: "Self",
    ) -> "_2460.FESubstructureWithSelectionForModalAnalysis":
    ...
    def create_fe_substructure_with_selection_for_static_analysis(
        self: "Self",
    ) -> "_2461.FESubstructureWithSelectionForStaticAnalysis":
    ...
    def import_fe_mesh(
        ...
        progress: Optional["_7720.TaskProgress"] = None,
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def links_for(
        self: "Self", node: "_2452.FESubstructureNode"
    ) -> "List[_2485.FELink]":
        """List[mastapy.system_model.fe.links.FELink]
    ...
    def load_existing_masta_fe_file_with_progress(
        self: "Self", file_name: "str", progress: "_7720.TaskProgress"
    ) -> None:
        """Method does not return.
