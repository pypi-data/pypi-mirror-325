...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2426, _2467
...
class FESubstructureWithSelectionForStaticAnalysis(_2457.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    @enforce_parameter_types
    def contour_option(self: "Self", value: "_1885.ThreeDViewContourOption") -> None:
    ...
    def boundary_conditions_all_nodes(
        self: "Self",
    ) -> "List[_2467.NodeBoundaryConditionStaticAnalysis]":
