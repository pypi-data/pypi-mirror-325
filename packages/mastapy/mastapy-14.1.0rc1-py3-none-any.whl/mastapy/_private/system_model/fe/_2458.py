...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2426, _2433, _2434, _2443, _2466
...
class _Cast_FESubstructureWithSelectionComponents:
    ...
    def fe_substructure_with_selection(
        self: "CastSelf",
    ) -> "_2457.FESubstructureWithSelection":
        return self.__parent__._cast(_2457.FESubstructureWithSelection)

    @property
    def base_fe_with_selection(self: "CastSelf") -> "_2426.BaseFEWithSelection":
        from mastapy._private.system_model.fe import _2426

        return self.__parent__._cast(_2426.BaseFEWithSelection)
...
class FESubstructureWithSelectionComponents(_2457.FESubstructureWithSelection):
    """FESubstructureWithSelectionComponents
    ...
    def beam_element_properties(
        self: "Self",
    ) -> "List[_2443.ElementPropertiesWithSelection[_228.ElementPropertiesBeam]]":
    ...
    @property
    def component_links(self: "Self") -> "List[_2487.FELinkWithSelection]":
    ...
    @property
    def contact_pairs(self: "Self") -> "List[_2433.ContactPairWithSelection]":
    ...
    @property
    def coordinate_systems(self: "Self") -> "List[_2434.CoordinateSystemWithSelection]":
    ...
    def interface_element_properties(
        self: "Self",
    ) -> "List[_2443.ElementPropertiesWithSelection[_229.ElementPropertiesInterface]]":
    ...
    @property
    def links_for_electric_machine(self: "Self") -> "List[_2487.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    @property
    def links_for_selected_component(self: "Self") -> "List[_2487.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    def mass_element_properties(
        self: "Self",
    ) -> "List[_2443.ElementPropertiesWithSelection[_230.ElementPropertiesMass]]":
    ...
    @property
    def materials(self: "Self") -> "List[_2466.MaterialPropertiesWithSelection]":
    ...
    def other_element_properties(
        self: "Self",
    ) -> "List[_2443.ElementPropertiesWithSelection[_227.ElementPropertiesBase]]":
    ...
    def rigid_element_properties(
        self: "Self",
    ) -> "List[_2443.ElementPropertiesWithSelection[_231.ElementPropertiesRigid]]":
    ...
    def shell_element_properties(
        self: "Self",
    ) -> "List[_2443.ElementPropertiesWithSelection[_232.ElementPropertiesShell]]":
    ...
    def solid_element_properties(
        self: "Self",
    ) -> "List[_2443.ElementPropertiesWithSelection[_233.ElementPropertiesSolid]]":
    ...
    def spring_dashpot_element_properties(
        self: "Self",
    ) -> "List[_2443.ElementPropertiesWithSelection[_234.ElementPropertiesSpringDashpot]]":
