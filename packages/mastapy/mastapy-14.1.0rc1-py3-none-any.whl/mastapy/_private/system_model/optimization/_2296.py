...
class _Cast_CylindricalGearOptimizationStep:
    ...
    @property
    def optimization_step(self: "CastSelf") -> "_2299.OptimizationStep":
        return self.__parent__._cast(_2299.OptimizationStep)
...
class CylindricalGearOptimizationStep(_2299.OptimizationStep):
    """CylindricalGearOptimizationStep
