...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5786
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2598, _2604
...
class SystemOptimiser(_0.APIBase):
    ...
    def selected_duty_cycle_for_system_optimiser(
        self: "Self", value: "_5786.DutyCycle"
    ) -> None:
        wrapper_type = (
    ...
    @property
    def design(self: "Self") -> "_2266.Design":
    ...
    @property
    def details(self: "Self") -> "_2306.SystemOptimiserDetails":
    ...
    @property
    def tooth_number_finder(self: "Self") -> "_2307.ToothNumberFinder":
    ...
    def system_optimisation_gear_sets(
        self: "Self",
    ) -> "List[_5790.SystemOptimisationGearSet]":
    ...
    @property
    def target_ratios(self: "Self") -> "List[_2303.DesignStateTargetRatio]":
    ...
    @property
    def system_optimiser_duty_cycle(self: "Self") -> "_5786.DutyCycle":
    ...
    @enforce_parameter_types
    def system_optimiser_duty_cycle(self: "Self", value: "_5786.DutyCycle") -> None:
