...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2293, _2296, _2298
...
class _Cast_OptimizationStep:
    ...
    def conical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2293.ConicalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2293

        return self.__parent__._cast(_2293.ConicalGearOptimizationStep)

    @property
    def cylindrical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2296.CylindricalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2296

        return self.__parent__._cast(_2296.CylindricalGearOptimizationStep)
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self: "Self") -> "_2298.MicroGeometryOptimisationTarget":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.optimization._2298",
    ...
    def optimisation_target(
        self: "Self", value: "_2298.MicroGeometryOptimisationTarget"
    ) -> None:
