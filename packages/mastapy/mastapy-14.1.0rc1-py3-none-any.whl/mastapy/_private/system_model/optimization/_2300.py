...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2292, _2295, _2299
...
TStep = TypeVar("TStep", bound="_2299.OptimizationStep")
...
class OptimizationStrategy(_2301.OptimizationStrategyBase, Generic[TStep]):
    """OptimizationStrategy
