...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1933, _1960
    ...
    T_get_part_named = TypeVar("T_get_part_named", bound="_2537.Part")
    T_all_parts = TypeVar("T_all_parts", bound="_2537.Part")
...
class Assembly(_2501.AbstractAssembly):
    """Assembly
    ...
    @property
    def oil_level_specification(self: "Self") -> "_2534.OilLevelSpecification":
    ...
    @property
    def bearings(self: "Self") -> "List[_2506.Bearing]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_2510.BoltedJoint]":
    ...
    @property
    def component_details(self: "Self") -> "List[_2511.Component]":
    ...
    @property
    def components_with_unknown_scalar_mass(self: "Self") -> "List[_2511.Component]":
        """List[mastapy.system_model.part_model.Component]
    ...
    @property
    def conical_gear_sets(self: "Self") -> "List[_2596.ConicalGearSet]":
    ...
    @property
    def cylindrical_gear_sets(self: "Self") -> "List[_2598.CylindricalGearSet]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_2520.FEPart]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_2601.FaceGearSet]":
    ...
    @property
    def gear_sets(self: "Self") -> "List[_2604.GearSet]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_2607.HypoidGearSet]":
    ...
    def klingelnberg_cyclo_palloid_gear_sets(
        self: "Self",
    ) -> "List[_2609.KlingelnbergCycloPalloidConicalGearSet]":
    ...
    @property
    def microphone_arrays(self: "Self") -> "List[_2532.MicrophoneArray]":
    ...
    @property
    def microphones(self: "Self") -> "List[_2531.Microphone]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_2535.OilSeal]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_2540.PointLoad]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_2541.PowerLoad]":
    ...
    @property
    def shaft_hub_connections(self: "Self") -> "List[_2674.ShaftHubConnection]":
    ...
    @property
    def shafts(self: "Self") -> "List[_2552.Shaft]":
    ...
    @property
    def spiral_bevel_gear_sets(self: "Self") -> "List[_2616.SpiralBevelGearSet]":
    ...
    @property
    def straight_bevel_gear_sets(self: "Self") -> "List[_2620.StraightBevelGearSet]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_2624.WormGearSet]":
    ...
    def get_part_named(self: "Self", name: "str") -> "_2537.Part":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_bearing(self: "Self", name: "str") -> "_2506.Bearing":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_bolt(self: "Self", name: "str") -> "_2509.Bolt":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_datum(self: "Self", name: "str") -> "_2515.Datum":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_fe_part(self: "Self", name: "str") -> "_2520.FEPart":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_mass_disc(self: "Self", name: "str") -> "_2529.MassDisc":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_oil_seal(self: "Self", name: "str") -> "_2535.OilSeal":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_shaft(self: "Self", name: "str") -> "_2552.Shaft":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_face_gear(self: "Self", name: "str") -> "_2600.FaceGear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_gear(self: "Self", name: "str") -> "_2602.Gear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_gear_set(self: "Self", name: "str") -> "_2604.GearSet":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_worm_gear(self: "Self", name: "str") -> "_2623.WormGear":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_ring_pins(self: "Self", name: "str") -> "_2642.RingPins":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_clutch(self: "Self", name: "str") -> "_2651.Clutch":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_coupling(self: "Self", name: "str") -> "_2657.Coupling":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_cvt(self: "Self", name: "str") -> "_2660.CVT":
        """T_get_part_named
    ...
    @enforce_parameter_types
    def get_part_named_of_type_pulley(self: "Self", name: "str") -> "_2665.Pulley":
        """T_get_part_named
    ...
    def all_parts(self: "Self") -> "List[_2537.Part]":
    ...
    def all_parts_of_type_abstract_shaft(self: "Self") -> "List[_2502.AbstractShaft]":
    ...
    def all_parts_of_type_abstract_shaft_or_housing(
        self: "Self",
    ) -> "List[_2503.AbstractShaftOrHousing]":
    ...
    def all_parts_of_type_bearing(self: "Self") -> "List[_2506.Bearing]":
        """List[mastapy.system_model.part_model.Bearing]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "Bearing")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_bolt(self: "Self") -> "List[_2509.Bolt]":
    ...
    def all_parts_of_type_bolted_joint(self: "Self") -> "List[_2510.BoltedJoint]":
        """List[mastapy.system_model.part_model.BoltedJoint]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel", "BoltedJoint"
        )
    ...
    def all_parts_of_type_component(self: "Self") -> "List[_2511.Component]":
        """List[mastapy.system_model.part_model.Component]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "Component")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_connector(self: "Self") -> "List[_2514.Connector]":
    ...
    def all_parts_of_type_datum(self: "Self") -> "List[_2515.Datum]":
    ...
    def all_parts_of_type_fe_part(self: "Self") -> "List[_2520.FEPart]":
        """List[mastapy.system_model.part_model.FEPart]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "FEPart")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_flexible_pin_assembly(
        self: "Self",
    ) -> "List[_2521.FlexiblePinAssembly]":
    ...
    def all_parts_of_type_guide_dxf_model(self: "Self") -> "List[_2522.GuideDxfModel]":
    ...
    def all_parts_of_type_mass_disc(self: "Self") -> "List[_2529.MassDisc]":
    ...
    def all_parts_of_type_measurement_component(
        self: "Self",
    ) -> "List[_2530.MeasurementComponent]":
    ...
    def all_parts_of_type_microphone(self: "Self") -> "List[_2531.Microphone]":
        """List[mastapy.system_model.part_model.Microphone]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel", "Microphone"
        )
    ...
    def all_parts_of_type_oil_seal(self: "Self") -> "List[_2535.OilSeal]":
        """List[mastapy.system_model.part_model.OilSeal]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "OilSeal")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_planet_carrier(self: "Self") -> "List[_2538.PlanetCarrier]":
    ...
    def all_parts_of_type_point_load(self: "Self") -> "List[_2540.PointLoad]":
        """List[mastapy.system_model.part_model.PointLoad]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "PointLoad")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_power_load(self: "Self") -> "List[_2541.PowerLoad]":
        """List[mastapy.system_model.part_model.PowerLoad]"""
        cast_type = python_net_import("SMT.MastaAPI.SystemModel.PartModel", "PowerLoad")
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call_generic(self.wrapped, "AllParts", cast_type)
    ...
    def all_parts_of_type_root_assembly(self: "Self") -> "List[_2544.RootAssembly]":
    ...
    def all_parts_of_type_specialised_assembly(
        self: "Self",
    ) -> "List[_2546.SpecialisedAssembly]":
    ...
    def all_parts_of_type_unbalanced_mass(self: "Self") -> "List[_2547.UnbalancedMass]":
    ...
    def all_parts_of_type_shaft(self: "Self") -> "List[_2552.Shaft]":
        """List[mastapy.system_model.part_model.shaft_model.Shaft]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.ShaftModel", "Shaft"
        )
    ...
    def all_parts_of_type_agma_gleason_conical_gear(
        self: "Self",
    ) -> "List[_2585.AGMAGleasonConicalGear]":
    ...
    def all_parts_of_type_agma_gleason_conical_gear_set(
        self: "Self",
    ) -> "List[_2586.AGMAGleasonConicalGearSet]":
    ...
    def all_parts_of_type_bevel_differential_gear(
        self: "Self",
    ) -> "List[_2587.BevelDifferentialGear]":
    ...
    def all_parts_of_type_bevel_differential_gear_set(
        self: "Self",
    ) -> "List[_2588.BevelDifferentialGearSet]":
    ...
    def all_parts_of_type_bevel_differential_planet_gear(
        self: "Self",
    ) -> "List[_2589.BevelDifferentialPlanetGear]":
    ...
    def all_parts_of_type_bevel_differential_sun_gear(
        self: "Self",
    ) -> "List[_2590.BevelDifferentialSunGear]":
    ...
    def all_parts_of_type_bevel_gear(self: "Self") -> "List[_2591.BevelGear]":
    ...
    def all_parts_of_type_bevel_gear_set(self: "Self") -> "List[_2592.BevelGearSet]":
    ...
    def all_parts_of_type_concept_gear(self: "Self") -> "List[_2593.ConceptGear]":
    ...
    def all_parts_of_type_conical_gear(self: "Self") -> "List[_2595.ConicalGear]":
    ...
    def all_parts_of_type_cylindrical_planet_gear(
        self: "Self",
    ) -> "List[_2599.CylindricalPlanetGear]":
    ...
    def all_parts_of_type_face_gear(self: "Self") -> "List[_2600.FaceGear]":
    ...
    def all_parts_of_type_face_gear_set(self: "Self") -> "List[_2601.FaceGearSet]":
        """List[mastapy.system_model.part_model.gears.FaceGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "FaceGearSet"
        )
    ...
    def all_parts_of_type_gear(self: "Self") -> "List[_2602.Gear]":
    ...
    def all_parts_of_type_gear_set(self: "Self") -> "List[_2604.GearSet]":
        """List[mastapy.system_model.part_model.gears.GearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "GearSet"
        )
    ...
    def all_parts_of_type_hypoid_gear(self: "Self") -> "List[_2606.HypoidGear]":
    ...
    def all_parts_of_type_hypoid_gear_set(self: "Self") -> "List[_2607.HypoidGearSet]":
        """List[mastapy.system_model.part_model.gears.HypoidGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "HypoidGearSet"
        )
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear(
        self: "Self",
    ) -> "List[_2608.KlingelnbergCycloPalloidConicalGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear(
        self: "Self",
    ) -> "List[_2610.KlingelnbergCycloPalloidHypoidGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(
        self: "Self",
    ) -> "List[_2611.KlingelnbergCycloPalloidHypoidGearSet]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(
        self: "Self",
    ) -> "List[_2612.KlingelnbergCycloPalloidSpiralBevelGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(
        self: "Self",
    ) -> "List[_2613.KlingelnbergCycloPalloidSpiralBevelGearSet]":
    ...
    def all_parts_of_type_straight_bevel_diff_gear(
        self: "Self",
    ) -> "List[_2617.StraightBevelDiffGear]":
    ...
    def all_parts_of_type_straight_bevel_diff_gear_set(
        self: "Self",
    ) -> "List[_2618.StraightBevelDiffGearSet]":
    ...
    def all_parts_of_type_straight_bevel_gear_set(
        self: "Self",
    ) -> "List[_2620.StraightBevelGearSet]":
        """List[mastapy.system_model.part_model.gears.StraightBevelGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "StraightBevelGearSet"
        )
    ...
    def all_parts_of_type_straight_bevel_planet_gear(
        self: "Self",
    ) -> "List[_2621.StraightBevelPlanetGear]":
    ...
    def all_parts_of_type_straight_bevel_sun_gear(
        self: "Self",
    ) -> "List[_2622.StraightBevelSunGear]":
    ...
    def all_parts_of_type_worm_gear(self: "Self") -> "List[_2623.WormGear]":
    ...
    def all_parts_of_type_worm_gear_set(self: "Self") -> "List[_2624.WormGearSet]":
        """List[mastapy.system_model.part_model.gears.WormGearSet]"""
        cast_type = python_net_import(
            "SMT.MastaAPI.SystemModel.PartModel.Gears", "WormGearSet"
        )
    ...
    def all_parts_of_type_cycloidal_disc(self: "Self") -> "List[_2641.CycloidalDisc]":
    ...
    def all_parts_of_type_ring_pins(self: "Self") -> "List[_2642.RingPins]":
    ...
    def all_parts_of_type_belt_drive(self: "Self") -> "List[_2649.BeltDrive]":
    ...
    def all_parts_of_type_clutch(self: "Self") -> "List[_2651.Clutch]":
    ...
    def all_parts_of_type_clutch_half(self: "Self") -> "List[_2652.ClutchHalf]":
    ...
    def all_parts_of_type_concept_coupling_half(
        self: "Self",
    ) -> "List[_2655.ConceptCouplingHalf]":
    ...
    def all_parts_of_type_coupling(self: "Self") -> "List[_2657.Coupling]":
    ...
    def all_parts_of_type_coupling_half(self: "Self") -> "List[_2658.CouplingHalf]":
    ...
    def all_parts_of_type_cvt(self: "Self") -> "List[_2660.CVT]":
    ...
    def all_parts_of_type_cvt_pulley(self: "Self") -> "List[_2661.CVTPulley]":
    ...
    def all_parts_of_type_part_to_part_shear_coupling(
        self: "Self",
    ) -> "List[_2662.PartToPartShearCoupling]":
    ...
    def all_parts_of_type_part_to_part_shear_coupling_half(
        self: "Self",
    ) -> "List[_2663.PartToPartShearCouplingHalf]":
    ...
    def all_parts_of_type_pulley(self: "Self") -> "List[_2665.Pulley]":
    ...
    def all_parts_of_type_rolling_ring(self: "Self") -> "List[_2672.RollingRing]":
    ...
    def all_parts_of_type_rolling_ring_assembly(
        self: "Self",
    ) -> "List[_2673.RollingRingAssembly]":
    ...
    def all_parts_of_type_spring_damper(self: "Self") -> "List[_2680.SpringDamper]":
    ...
    def all_parts_of_type_synchroniser(self: "Self") -> "List[_2682.Synchroniser]":
    ...
    def all_parts_of_type_torque_converter_pump(
        self: "Self",
    ) -> "List[_2688.TorqueConverterPump]":
    ...
    def all_parts_of_type_torque_converter_turbine(
        self: "Self",
    ) -> "List[_2690.TorqueConverterTurbine]":
    ...
    @enforce_parameter_types
    def add_bearing(self: "Self", name: "str") -> "_2506.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_bearing_with_name_and_rolling_bearing_type(
        self: "Self", name: "str", type_: "_1960.RollingBearingType"
    ) -> "_2506.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_bearing_with_name_rolling_bearing_type_and_designation(
        self: "Self", name: "str", type_: "_1960.RollingBearingType", designation: "str"
    ) -> "_2506.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_belt_drive_with_options(
        self: "Self",
        belt_creation_options: Optional["_2643.BeltCreationOptions"] = None,
    ) -> "_2649.BeltDrive":
    ...
    @enforce_parameter_types
    def add_cvt(self: "Self", name: "str" = "CVT") -> "_2660.CVT":
    ...
    @enforce_parameter_types
    def add_clutch(self: "Self", name: "str" = "Clutch") -> "_2651.Clutch":
    ...
    def add_cycloidal_assembly_with_options(
        ...
        cycloidal_assembly_creation_options: Optional[
            "_2644.CycloidalAssemblyCreationOptions"
        ] = None,
    ) -> "_2640.CycloidalAssembly":
    ...
    def add_cylindrical_gear_set_with_options(
        ...
        cylindrical_gear_linear_train_creation_options: Optional[
            "_2645.CylindricalGearLinearTrainCreationOptions"
        ] = None,
    ) -> "_2598.CylindricalGearSet":
        """mastapy.system_model.part_model.gears.CylindricalGearSet
    ...
    @enforce_parameter_types
    def add_datum(self: "Self", name: "str" = "Datum") -> "_2515.Datum":
    ...
    @enforce_parameter_types
    def add_fe_part(self: "Self", name: "str" = "FE Part") -> "_2520.FEPart":
    ...
    @enforce_parameter_types
    def add_mass_disc(self: "Self", name: "str" = "Mass Disc") -> "_2529.MassDisc":
    ...
    @enforce_parameter_types
    def add_oil_seal(self: "Self", name: "str" = "Oil Seal") -> "_2535.OilSeal":
    ...
    def add_planet_carrier_with_options(
        ...
        planet_carrier_creation_options: Optional[
            "_2647.PlanetCarrierCreationOptions"
        ] = None,
    ) -> "_2538.PlanetCarrier":
    ...
    @enforce_parameter_types
    def add_point_load(self: "Self", name: "str" = "Point Load") -> "_2540.PointLoad":
    ...
    @enforce_parameter_types
    def add_power_load(self: "Self", name: "str" = "Power Load") -> "_2541.PowerLoad":
    ...
    def add_rolling_bearing_from_catalogue(
        self: "Self", catalogue: "_1933.BearingCatalog", designation: "str", name: "str"
    ) -> "_2506.Bearing":
        """mastapy.system_model.part_model.Bearing
    ...
    def add_shaft_with_options(
        self: "Self", shaft_creation_options: "_2648.ShaftCreationOptions"
    ) -> "_2552.Shaft":
