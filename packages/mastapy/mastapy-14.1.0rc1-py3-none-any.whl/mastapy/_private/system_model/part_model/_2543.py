...
class _Cast_RollingBearingElementLoadCase:
    ...
    @property
    def rolling_bearing_element(self: "CastSelf") -> "_2231.RollingBearingElement":
        return self.__parent__._cast(_2231.RollingBearingElement)
...
class RollingBearingElementLoadCase(_2231.RollingBearingElement):
    """RollingBearingElementLoadCase
