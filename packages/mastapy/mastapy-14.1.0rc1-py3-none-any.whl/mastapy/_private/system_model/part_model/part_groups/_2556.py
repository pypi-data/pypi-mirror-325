...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2557, _2560, _2561
...
class _Cast_ConcentricOrParallelPartGroup:
    ...
    @property
    def concentric_part_group(self: "CastSelf") -> "_2557.ConcentricPartGroup":
        from mastapy._private.system_model.part_model.part_groups import _2557

        return self.__parent__._cast(_2557.ConcentricPartGroup)

    @property
    def parallel_part_group(self: "CastSelf") -> "_2560.ParallelPartGroup":
        from mastapy._private.system_model.part_model.part_groups import _2560

        return self.__parent__._cast(_2560.ParallelPartGroup)
...
class ConcentricOrParallelPartGroup(_2562.PartGroup):
    """ConcentricOrParallelPartGroup
