...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2511, _2528, _2537
...
class PlanetCarrier(_2533.MountableComponent):
    """PlanetCarrier
    ...
    @property
    def planetary_sockets(self: "Self") -> "List[_2354.PlanetarySocket]":
