...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2707, _2709
...
class AcousticInputSurfaceOptions(_0.APIBase):
    ...
    @property
    def fe_part_options(self: "Self") -> "List[_2707.FEPartInputSurfaceOptions]":
    ...
    @property
    def hole_meshes(self: "Self") -> "List[_2709.HoleInFaceGroup]":
