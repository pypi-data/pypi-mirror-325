...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2710, _2711, _2712
...
class _Cast_MeshedResultSurfaceBase:
    ...
    @property
    def meshed_result_surface(self: "CastSelf") -> "_2712.MeshedResultSurface":
        from mastapy._private.system_model.part_model.acoustics import _2712

        return self.__parent__._cast(_2712.MeshedResultSurface)
