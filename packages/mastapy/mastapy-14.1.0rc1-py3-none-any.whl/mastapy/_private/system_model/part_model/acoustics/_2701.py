...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2700, _2702, _2705
...
class AcousticAnalysisSetup(_0.APIBase):
    ...
    @property
    def analysis_options(self: "Self") -> "_2700.AcousticAnalysisOptions":
    ...
    @property
    def cache_reporting(self: "Self") -> "_2702.AcousticAnalysisSetupCacheReporting":
    ...
    @property
    def input_surface_options(self: "Self") -> "_2705.AcousticInputSurfaceOptions":
