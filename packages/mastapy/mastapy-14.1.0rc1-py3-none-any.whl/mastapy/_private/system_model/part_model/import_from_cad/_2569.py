...
from mastapy._private.system_model.part_model.gears import _2597, _2598
...
class CylindricalGearFromCAD(_2575.MountableComponentFromCAD):
    """CylindricalGearFromCAD
    ...
    @enforce_parameter_types
    def existing_gear_set(self: "Self", value: "_2598.CylindricalGearSet") -> None:
    ...
    @meshing_gear.setter
    @enforce_parameter_types
    def meshing_gear(self: "Self", value: "_2597.CylindricalGear") -> None:
        wrapper_type = (
