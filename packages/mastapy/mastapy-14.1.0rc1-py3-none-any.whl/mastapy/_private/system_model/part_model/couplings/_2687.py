...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2688, _2690
...
class TorqueConverter(_2657.Coupling):
    """TorqueConverter
    ...
    @property
    def pump(self: "Self") -> "_2688.TorqueConverterPump":
    ...
    @property
    def turbine(self: "Self") -> "_2690.TorqueConverterTurbine":
