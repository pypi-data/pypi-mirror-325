...
class ConceptCoupling(_2657.Coupling):
    """ConceptCoupling
    ...
    @property
    def half_positioning(self: "Self") -> "_2656.ConceptCouplingHalfPositioning":
    ...
    def half_positioning(
        self: "Self", value: "_2656.ConceptCouplingHalfPositioning"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.ConceptCouplingHalfPositioning",
