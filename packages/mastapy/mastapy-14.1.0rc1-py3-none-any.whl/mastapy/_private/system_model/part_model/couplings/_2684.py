...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2658, _2683
...
class SynchroniserHalf(_2685.SynchroniserPart):
    """SynchroniserHalf
    ...
    @property
    def cones(self: "Self") -> "List[_2683.SynchroniserCone]":
