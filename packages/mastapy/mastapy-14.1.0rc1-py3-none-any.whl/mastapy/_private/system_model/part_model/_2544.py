...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.projections import _2555
...
class RootAssembly(_2500.Assembly):
    """RootAssembly
    ...
    @property
    def parallel_part_groups(self: "Self") -> "List[_2560.ParallelPartGroup]":
    ...
    def parallel_part_groups_drawing_order(
        self: "Self",
    ) -> "List[_2555.SpecifiedParallelPartGroupDrawingOrder]":
