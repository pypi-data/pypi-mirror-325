...
class _Cast_RadialInternalClearanceTolerance:
    ...
    def internal_clearance_tolerance(
        self: "CastSelf",
    ) -> "_2526.InternalClearanceTolerance":
        return self.__parent__._cast(_2526.InternalClearanceTolerance)
...
class RadialInternalClearanceTolerance(_2526.InternalClearanceTolerance):
    """RadialInternalClearanceTolerance
