...
from mastapy._private.system_model import _2285
...
class PowerLoad(_2549.VirtualComponent):
    """PowerLoad
    ...
    def electric_machine_search_region_specification_method(
        self: "Self",
    ) -> "_2516.ElectricMachineSearchRegionSpecificationMethod":
    ...
    @enforce_parameter_types
    def electric_machine_search_region_specification_method(
        self: "Self", value: "_2516.ElectricMachineSearchRegionSpecificationMethod"
    ) -> None:
    ...
    @enforce_parameter_types
    def power_load_type(self: "Self", value: "_2285.PowerLoadType") -> None:
    ...
    @property
    def single_blade_details(self: "Self") -> "_2551.WindTurbineSingleBladeDetails":
