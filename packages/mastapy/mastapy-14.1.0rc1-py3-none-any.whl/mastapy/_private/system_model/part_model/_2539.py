...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2281
...
class PlanetCarrierSettings(_1654.PerMachineSettings):
    ...
    def planet_pin_manufacturing_errors_coordinate_system(
        self: "Self",
    ) -> "_2281.PlanetPinManufacturingErrorsCoordinateSystem":
    ...
    def planet_pin_manufacturing_errors_coordinate_system(
        self: "Self", value: "_2281.PlanetPinManufacturingErrorsCoordinateSystem"
    ) -> None:
