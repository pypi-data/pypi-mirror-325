...
class _Cast_SteadyStateSynchronousResponseViewable:
    ...
    @property
    def rotor_dynamics_viewable(self: "CastSelf") -> "_2321.RotorDynamicsViewable":
        return self.__parent__._cast(_2321.RotorDynamicsViewable)
...
class SteadyStateSynchronousResponseViewable(_2321.RotorDynamicsViewable):
    """SteadyStateSynchronousResponseViewable
