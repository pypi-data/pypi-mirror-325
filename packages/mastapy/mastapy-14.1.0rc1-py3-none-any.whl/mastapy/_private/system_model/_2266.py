...
from mastapy._private.system_model.part_model import _2541, _2545
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2271, _2277, _2278, _2288, _2289, _2290
    ...
    from mastapy._private.system_model.database_access import _2330
    from mastapy._private.system_model.fe import _2427
    from mastapy._private.system_model.optimization.system_optimiser import _2305, _2306
    ...
    from mastapy._private.system_model_gui import _1910
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self: "Self") -> "_1910.MASTAGUI":
    ...
    @enforce_parameter_types
    def gear_set_configuration(
        self: "Self", value: "_2584.ActiveGearSetDesignSelectionGroup"
    ) -> None:
    ...
    @enforce_parameter_types
    def input_power_load(self: "Self", value: "_2541.PowerLoad") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def output_power_load(self: "Self", value: "_2541.PowerLoad") -> None:
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_PowerLoad.wrapper_type()
        )
        enclosed_type = (
    ...
    @enforce_parameter_types
    def shaft_diameter_modification_due_to_rolling_bearing_rings(
        self: "Self", value: "_2545.ShaftDiameterModificationDueToRollingBearingRing"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def thermal_expansion_for_grounded_nodes(
        self: "Self",
    ) -> "_2289.ThermalExpansionOptionForGroundedNodes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2289",
    ...
    @enforce_parameter_types
    def thermal_expansion_for_grounded_nodes(
        self: "Self", value: "_2289.ThermalExpansionOptionForGroundedNodes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def unbalanced_mass_inclusion(
        self: "Self",
    ) -> "_2548.UnbalancedMassInclusionOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model._2548",
    ...
    @enforce_parameter_types
    def unbalanced_mass_inclusion(
        self: "Self", value: "_2548.UnbalancedMassInclusionOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def acoustic_analysis_setups(
        self: "Self",
    ) -> "_2703.AcousticAnalysisSetupCollection":
    ...
    @property
    def default_system_temperatures(self: "Self") -> "_2290.TransmissionTemperatureSet":
    ...
    @property
    def electric_machine_group(self: "Self") -> "_2277.MAAElectricMachineGroup":
    ...
    @property
    def fe_batch_operations(self: "Self") -> "_2427.BatchOperations":
    ...
    def selected_gear_set_selection_group(
        self: "Self",
    ) -> "_2584.ActiveGearSetDesignSelectionGroup":
    ...
    @property
    def settings(self: "Self") -> "_2271.DesignSettings":
    ...
    @property
    def system(self: "Self") -> "_2288.SystemReporting":
    ...
    @property
    def system_optimiser_details(self: "Self") -> "_2306.SystemOptimiserDetails":
    ...
    def bearing_detail_configurations(
        self: "Self",
    ) -> "List[_2695.BearingDetailConfiguration]":
    ...
    @property
    def design_configurations(self: "Self") -> "List[_2697.DesignConfiguration]":
    ...
    def fe_substructure_configurations(
        self: "Self",
    ) -> "List[_2692.ActiveFESubstructureSelectionGroup]":
    ...
    def gear_set_configurations(
        self: "Self",
    ) -> "List[_2584.ActiveGearSetDesignSelectionGroup]":
    ...
    def iso14179_settings_per_bearing_type(
        self: "Self",
    ) -> "List[_2041.ISO14179SettingsPerBearingType]":
    ...
    def shaft_detail_configurations(
        self: "Self",
    ) -> "List[_2694.ActiveShaftDesignSelectionGroup]":
    ...
    @property
    def databases(self: "Self") -> "_2330.Databases":
    ...
    @property
    def design_states(self: "Self") -> "List[_5785.DesignState]":
    ...
    @property
    def duty_cycles(self: "Self") -> "List[_5786.DutyCycle]":
    ...
    @property
    def gear_set_config(self: "Self") -> "_2605.GearSetConfiguration":
    ...
    @enforce_parameter_types
    def gear_set_config(self: "Self", value: "_2605.GearSetConfiguration") -> None:
        pythonnet_property_set(self.wrapped, "GearSetConfig", value.wrapped)

    @property
    def masta_settings(self: "Self") -> "_2278.MASTASettings":
    ...
    @property
    def root_assembly(self: "Self") -> "_2544.RootAssembly":
    ...
    @property
    def system_optimiser(self: "Self") -> "_2305.SystemOptimiser":
    ...
    def time_series_load_case_groups(
        self: "Self",
    ) -> "List[_5793.TimeSeriesLoadCaseGroup]":
    ...
    def add_synchroniser_shift_empty(self: "Self") -> "_3061.SynchroniserShift":
    ...
    @enforce_parameter_types
    def add_synchroniser_shift(self: "Self", name: "str") -> "_3061.SynchroniserShift":
        """mastapy.system_model.analyses_and_results.synchroniser_analysis.SynchroniserShift
    ...
    @enforce_parameter_types
    def design_state_named(self: "Self", name: "str") -> "_5785.DesignState":
        """mastapy.system_model.analyses_and_results.load_case_groups.DesignState
    ...
    @enforce_parameter_types
    def duty_cycle_named(self: "Self", name: "str") -> "_5786.DutyCycle":
        """mastapy.system_model.analyses_and_results.load_case_groups.DutyCycle
    ...
    def remove_bearing_from_database(
        self: "Self", rolling_bearing: "_2230.RollingBearing"
    ) -> None:
        """Method does not return.
    ...
    def remove_design_configuration(
        self: "Self", config: "_2697.DesignConfiguration"
    ) -> None:
        """Method does not return.
    ...
    def remove_gear_set_selection_group(
        self: "Self", group: "_2584.ActiveGearSetDesignSelectionGroup"
    ) -> None:
        """Method does not return.
    ...
    def remove_synchroniser_shift(
        self: "Self", shift: "_3061.SynchroniserShift"
    ) -> None:
        """Method does not return.
    ...
    def save_load_case_results(
        self: "Self", file_name: "str", load_cases: "List[_7492.LoadCase]"
    ) -> None:
        """Method does not return.
    ...
    def all_parts_of_type_assembly(self: "Self") -> "List[_2500.Assembly]":
