...
class EnumWithSelectedValue_TorqueSpecificationForSystemDeflection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueSpecificationForSystemDeflection]",
    ) -> "_7668.TorqueSpecificationForSystemDeflection":
        ...
        Returns:
            _7668.TorqueSpecificationForSystemDeflection
        """
        return _7668.TorqueSpecificationForSystemDeflection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7668.TorqueSpecificationForSystemDeflection.type_()

    @property
    def selected_value(self: "Self") -> "_7668.TorqueSpecificationForSystemDeflection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_7668.TorqueSpecificationForSystemDeflection]":
