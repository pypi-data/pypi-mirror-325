...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DoeValueSpecificationOption]",
    ) -> "_4448.DoeValueSpecificationOption":
        ...
        Returns:
            _4448.DoeValueSpecificationOption
        """
        return _4448.DoeValueSpecificationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _4448.DoeValueSpecificationOption.type_()

    @property
    def selected_value(self: "Self") -> "_4448.DoeValueSpecificationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_4448.DoeValueSpecificationOption]":
