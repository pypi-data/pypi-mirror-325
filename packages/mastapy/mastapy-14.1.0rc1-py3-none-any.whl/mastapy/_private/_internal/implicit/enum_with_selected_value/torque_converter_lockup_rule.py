...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueConverterLockupRule]",
    ) -> "_5628.TorqueConverterLockupRule":
        ...
        Returns:
            _5628.TorqueConverterLockupRule
        """
        return _5628.TorqueConverterLockupRule
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5628.TorqueConverterLockupRule.type_()

    @property
    def selected_value(self: "Self") -> "_5628.TorqueConverterLockupRule":
    ...
    @property
    def available_values(self: "Self") -> "List[_5628.TorqueConverterLockupRule]":
