...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7585.HarmonicExcitationType
        """
        return _7585.HarmonicExcitationType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7585.HarmonicExcitationType.type_()

    @property
    def selected_value(self: "Self") -> "_7585.HarmonicExcitationType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7585.HarmonicExcitationType]":
