...
class EnumWithSelectedValue_ComponentOrientationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ComponentOrientationOption]",
    ) -> "_2432.ComponentOrientationOption":
        ...
        Returns:
            _2432.ComponentOrientationOption
        """
        return _2432.ComponentOrientationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2432.ComponentOrientationOption.type_()

    @property
    def selected_value(self: "Self") -> "_2432.ComponentOrientationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2432.ComponentOrientationOption]":
