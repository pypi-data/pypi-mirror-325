...
class EnumWithSelectedValue_RollerBearingProfileTypes(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RollerBearingProfileTypes]",
    ) -> "_1955.RollerBearingProfileTypes":
        ...
        Returns:
            _1955.RollerBearingProfileTypes
        """
        return _1955.RollerBearingProfileTypes
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1955.RollerBearingProfileTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1955.RollerBearingProfileTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1955.RollerBearingProfileTypes]":
