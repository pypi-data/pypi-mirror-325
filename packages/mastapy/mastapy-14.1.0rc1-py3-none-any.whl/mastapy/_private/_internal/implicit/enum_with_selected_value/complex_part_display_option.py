...
class EnumWithSelectedValue_ComplexPartDisplayOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ComplexPartDisplayOption]",
    ) -> "_1554.ComplexPartDisplayOption":
        ...
        Returns:
            _1554.ComplexPartDisplayOption
        """
        return _1554.ComplexPartDisplayOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1554.ComplexPartDisplayOption.type_()

    @property
    def selected_value(self: "Self") -> "_1554.ComplexPartDisplayOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1554.ComplexPartDisplayOption]":
