...
class EnumWithSelectedValue_BearingNodeOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2429.BearingNodeOption
        """
        return _2429.BearingNodeOption
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_BearingNodeOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2429.BearingNodeOption.type_()

    @property
    def selected_value(self: "Self") -> "_2429.BearingNodeOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2429.BearingNodeOption]":
