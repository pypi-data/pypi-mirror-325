...
class EnumWithSelectedValue_LoadCaseOverrideOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _1649.LoadCaseOverrideOption
        """
        return _1649.LoadCaseOverrideOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1649.LoadCaseOverrideOption.type_()

    @property
    def selected_value(self: "Self") -> "_1649.LoadCaseOverrideOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1649.LoadCaseOverrideOption]":
