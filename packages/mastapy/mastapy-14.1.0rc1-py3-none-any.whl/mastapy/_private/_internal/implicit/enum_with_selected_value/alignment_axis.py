...
class EnumWithSelectedValue_AlignmentAxis(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_AlignmentAxis]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1550.AlignmentAxis.type_()

    @property
    def selected_value(self: "Self") -> "_1550.AlignmentAxis":
    ...
    @property
    def available_values(self: "Self") -> "List[_1550.AlignmentAxis]":
