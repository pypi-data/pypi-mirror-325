...
class EnumWithSelectedValue_Severity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[EnumWithSelectedValue_Severity]") -> "_1854.Severity":
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_Severity]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1854.Severity.type_()

    @property
    def selected_value(self: "Self") -> "_1854.Severity":
    ...
    @property
    def available_values(self: "Self") -> "List[_1854.Severity]":
