...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _2478.ThermalExpansionOption
        """
        return _2478.ThermalExpansionOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2478.ThermalExpansionOption.type_()

    @property
    def selected_value(self: "Self") -> "_2478.ThermalExpansionOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2478.ThermalExpansionOption]":
