...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorToothSpacingType]",
    ) -> "_2670.RigidConnectorToothSpacingType":
        ...
        Returns:
            _2670.RigidConnectorToothSpacingType
        """
        return _2670.RigidConnectorToothSpacingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2670.RigidConnectorToothSpacingType.type_()

    @property
    def selected_value(self: "Self") -> "_2670.RigidConnectorToothSpacingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2670.RigidConnectorToothSpacingType]":
