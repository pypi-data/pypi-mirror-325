...
class EnumWithSelectedValue_BallBearingAnalysisMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BallBearingAnalysisMethod]",
    ) -> "_2031.BallBearingAnalysisMethod":
        ...
        Returns:
            _2031.BallBearingAnalysisMethod
        """
        return _2031.BallBearingAnalysisMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2031.BallBearingAnalysisMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2031.BallBearingAnalysisMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_2031.BallBearingAnalysisMethod]":
