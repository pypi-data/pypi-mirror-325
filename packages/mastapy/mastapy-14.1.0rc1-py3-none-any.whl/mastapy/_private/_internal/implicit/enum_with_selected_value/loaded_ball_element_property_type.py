...
class EnumWithSelectedValue_LoadedBallElementPropertyType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LoadedBallElementPropertyType]",
    ) -> "_2027.LoadedBallElementPropertyType":
        ...
        Returns:
            _2027.LoadedBallElementPropertyType
        """
        return _2027.LoadedBallElementPropertyType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2027.LoadedBallElementPropertyType.type_()

    @property
    def selected_value(self: "Self") -> "_2027.LoadedBallElementPropertyType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2027.LoadedBallElementPropertyType]":
