...
class EnumWithSelectedValue_InternalClearanceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1966.InternalClearanceClass
        """
        return _1966.InternalClearanceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1966.InternalClearanceClass.type_()

    @property
    def selected_value(self: "Self") -> "_1966.InternalClearanceClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1966.InternalClearanceClass]":
