...
class EnumWithSelectedValue_StressConcentrationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_StressConcentrationMethod]",
    ) -> "_2174.StressConcentrationMethod":
        ...
        Returns:
            _2174.StressConcentrationMethod
        """
        return _2174.StressConcentrationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2174.StressConcentrationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2174.StressConcentrationMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_2174.StressConcentrationMethod]":
