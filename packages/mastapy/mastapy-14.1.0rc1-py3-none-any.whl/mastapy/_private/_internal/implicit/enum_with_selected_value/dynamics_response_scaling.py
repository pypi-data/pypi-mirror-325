...
class EnumWithSelectedValue_DynamicsResponseScaling(
    ...
    def wrapped_type(
        ...
        Returns:
            _1565.DynamicsResponseScaling
        """
        return _1565.DynamicsResponseScaling
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1565.DynamicsResponseScaling.type_()

    @property
    def selected_value(self: "Self") -> "_1565.DynamicsResponseScaling":
    ...
    @property
    def available_values(self: "Self") -> "List[_1565.DynamicsResponseScaling]":
