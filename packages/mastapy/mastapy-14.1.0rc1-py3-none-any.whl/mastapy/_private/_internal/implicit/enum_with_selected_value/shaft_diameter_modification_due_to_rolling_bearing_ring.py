...
class EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing]",
    ) -> "_2545.ShaftDiameterModificationDueToRollingBearingRing":
        ...
        Returns:
            _2545.ShaftDiameterModificationDueToRollingBearingRing
        """
        return _2545.ShaftDiameterModificationDueToRollingBearingRing
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2545.ShaftDiameterModificationDueToRollingBearingRing.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2545.ShaftDiameterModificationDueToRollingBearingRing]":
