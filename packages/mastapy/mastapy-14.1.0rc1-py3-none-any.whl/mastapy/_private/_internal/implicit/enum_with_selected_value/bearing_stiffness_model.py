...
class EnumWithSelectedValue_BearingStiffnessModel(
    ...
    def wrapped_type(
        ...
        Returns:
            _5502.BearingStiffnessModel
        """
        return _5502.BearingStiffnessModel
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5502.BearingStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_5502.BearingStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_5502.BearingStiffnessModel]":
