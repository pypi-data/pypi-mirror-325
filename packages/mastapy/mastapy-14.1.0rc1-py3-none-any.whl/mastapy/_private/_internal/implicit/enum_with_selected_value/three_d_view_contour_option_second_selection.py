...
class EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection]",
    ) -> "_1887.ThreeDViewContourOptionSecondSelection":
        ...
        Returns:
            _1887.ThreeDViewContourOptionSecondSelection
        """
        return _1887.ThreeDViewContourOptionSecondSelection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1887.ThreeDViewContourOptionSecondSelection.type_()

    @property
    def selected_value(self: "Self") -> "_1887.ThreeDViewContourOptionSecondSelection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1887.ThreeDViewContourOptionSecondSelection]":
