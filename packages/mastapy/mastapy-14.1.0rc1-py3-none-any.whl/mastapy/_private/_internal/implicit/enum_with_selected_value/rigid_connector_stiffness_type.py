...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorStiffnessType]",
    ) -> "_2667.RigidConnectorStiffnessType":
        ...
        Returns:
            _2667.RigidConnectorStiffnessType
        """
        return _2667.RigidConnectorStiffnessType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2667.RigidConnectorStiffnessType.type_()

    @property
    def selected_value(self: "Self") -> "_2667.RigidConnectorStiffnessType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2667.RigidConnectorStiffnessType]":
