...
class EnumWithSelectedValue_RollingBearingArrangement(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RollingBearingArrangement]",
    ) -> "_1956.RollingBearingArrangement":
        ...
        Returns:
            _1956.RollingBearingArrangement
        """
        return _1956.RollingBearingArrangement
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1956.RollingBearingArrangement.type_()

    @property
    def selected_value(self: "Self") -> "_1956.RollingBearingArrangement":
    ...
    @property
    def available_values(self: "Self") -> "List[_1956.RollingBearingArrangement]":
