...
class EnumWithSelectedValue_SupportToleranceLocationDesignation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_SupportToleranceLocationDesignation]",
    ) -> "_1987.SupportToleranceLocationDesignation":
        ...
        Returns:
            _1987.SupportToleranceLocationDesignation
        """
        return _1987.SupportToleranceLocationDesignation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1987.SupportToleranceLocationDesignation.type_()

    @property
    def selected_value(self: "Self") -> "_1987.SupportToleranceLocationDesignation":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1987.SupportToleranceLocationDesignation]":
