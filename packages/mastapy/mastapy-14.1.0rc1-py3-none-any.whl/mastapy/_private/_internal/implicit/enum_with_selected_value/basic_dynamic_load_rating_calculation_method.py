...
from mastapy._private.bearings import _1934
...
class EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod]",
    ) -> "_1934.BasicDynamicLoadRatingCalculationMethod":
        ...
        Returns:
            _1934.BasicDynamicLoadRatingCalculationMethod
        """
        return _1934.BasicDynamicLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1934.BasicDynamicLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1934.BasicDynamicLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1934.BasicDynamicLoadRatingCalculationMethod]":
