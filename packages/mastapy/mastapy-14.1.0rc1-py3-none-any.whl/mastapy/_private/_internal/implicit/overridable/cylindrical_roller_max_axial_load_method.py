...
class Overridable_CylindricalRollerMaxAxialLoadMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        cls: "Type[Overridable_CylindricalRollerMaxAxialLoadMethod]",
    ) -> "_2007.CylindricalRollerMaxAxialLoadMethod":
        ...
        Returns:
            _2007.CylindricalRollerMaxAxialLoadMethod
        """
        return _2007.CylindricalRollerMaxAxialLoadMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2007.CylindricalRollerMaxAxialLoadMethod.type_()

    @property
    def value(self: "Self") -> "_2007.CylindricalRollerMaxAxialLoadMethod":
    ...
    @property
    def override_value(self: "Self") -> "_2007.CylindricalRollerMaxAxialLoadMethod":
        """mastapy.bearings.bearing_results.CylindricalRollerMaxAxialLoadMethod
    ...
    @property
    def calculated_value(self: "Self") -> "_2007.CylindricalRollerMaxAxialLoadMethod":
        """mastapy.bearings.bearing_results.CylindricalRollerMaxAxialLoadMethod
