...
class Overridable_FrictionModelForGyroscopicMoment(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2037.FrictionModelForGyroscopicMoment
        """
        return _2037.FrictionModelForGyroscopicMoment
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2037.FrictionModelForGyroscopicMoment.type_()

    @property
    def value(self: "Self") -> "_2037.FrictionModelForGyroscopicMoment":
    ...
    @property
    def override_value(self: "Self") -> "_2037.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
    ...
    @property
    def calculated_value(self: "Self") -> "_2037.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
