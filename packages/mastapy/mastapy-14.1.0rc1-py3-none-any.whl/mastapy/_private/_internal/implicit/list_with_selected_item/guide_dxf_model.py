...
class ListWithSelectedItem_GuideDxfModel(
    _2522.GuideDxfModel, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_GuideDxfModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2522.GuideDxfModel.TYPE

    @property
    def selected_value(self: "Self") -> "_2522.GuideDxfModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_2522.GuideDxfModel]":
