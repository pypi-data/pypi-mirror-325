...
class ListWithSelectedItem_ConcentricPartGroup(
    _2557.ConcentricPartGroup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ConcentricPartGroup]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2557.ConcentricPartGroup.TYPE

    @property
    def selected_value(self: "Self") -> "_2557.ConcentricPartGroup":
    ...
    @property
    def available_values(self: "Self") -> "List[_2557.ConcentricPartGroup]":
