...
class ListWithSelectedItem_ShaftHubConnection(
    _2674.ShaftHubConnection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ShaftHubConnection]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2674.ShaftHubConnection.TYPE

    @property
    def selected_value(self: "Self") -> "_2674.ShaftHubConnection":
    ...
    @property
    def available_values(self: "Self") -> "List[_2674.ShaftHubConnection]":
