...
class ListWithSelectedItem_StaticLoadCase(
    _7493.StaticLoadCase, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_StaticLoadCase]") -> "Any":
        ...
        Returns:
            Any
        """
        return _7493.StaticLoadCase.TYPE

    @property
    def selected_value(self: "Self") -> "_7493.StaticLoadCase":
    ...
    @property
    def available_values(self: "Self") -> "List[_7493.StaticLoadCase]":
