...
class ListWithSelectedItem_AbstractPeriodicExcitationDetail(
    _5801.AbstractPeriodicExcitationDetail, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5801.AbstractPeriodicExcitationDetail.TYPE

    @property
    def selected_value(self: "Self") -> "_5801.AbstractPeriodicExcitationDetail":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5801.AbstractPeriodicExcitationDetail]":
