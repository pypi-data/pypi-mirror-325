...
class ListWithSelectedItem_DesignState(
    _5785.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_DesignState]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5785.DesignState.TYPE

    @property
    def selected_value(self: "Self") -> "_5785.DesignState":
    ...
    @property
    def available_values(self: "Self") -> "List[_5785.DesignState]":
