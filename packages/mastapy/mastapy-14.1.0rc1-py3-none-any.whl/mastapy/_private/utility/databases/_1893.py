...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2292, _2295, _2300, _2301
...
class _Cast_NamedDatabaseItem:
    ...
    @property
    def bearing_settings_item(self: "CastSelf") -> "_1945.BearingSettingsItem":
        from mastapy._private.bearings import _1945

        return self.__parent__._cast(_1945.BearingSettingsItem)

    @property
    def iso14179_settings(self: "CastSelf") -> "_2039.ISO14179Settings":
        from mastapy._private.bearings.bearing_results.rolling import _2039

        return self.__parent__._cast(_2039.ISO14179Settings)
    ...
    def optimization_strategy_base(
        self: "CastSelf",
    ) -> "_2301.OptimizationStrategyBase":
        from mastapy._private.system_model.optimization import _2301

        return self.__parent__._cast(_2301.OptimizationStrategyBase)

    @property
    def supercharger_rotor_set(self: "CastSelf") -> "_2635.SuperchargerRotorSet":
        from mastapy._private.system_model.part_model.gears.supercharger_rotor_set import (
            _2635,
        )

        return self.__parent__._cast(_2635.SuperchargerRotorSet)
...
class NamedDatabaseItem(_0.APIBase):
    ...
    @property
    def database_key(self: "Self") -> "_1894.NamedKey":
    ...
    @database_key.setter
    @enforce_parameter_types
    def database_key(self: "Self", value: "_1894.NamedKey") -> None:
