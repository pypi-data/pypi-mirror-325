...
class _Cast_DatabaseKey:
    ...
    @property
    def named_key(self: "CastSelf") -> "_1894.NamedKey":
        from mastapy._private.utility.databases import _1894

        return self.__parent__._cast(_1894.NamedKey)

    @property
    def rolling_bearing_key(self: "CastSelf") -> "_1958.RollingBearingKey":
        from mastapy._private.bearings import _1958

        return self.__parent__._cast(_1958.RollingBearingKey)
