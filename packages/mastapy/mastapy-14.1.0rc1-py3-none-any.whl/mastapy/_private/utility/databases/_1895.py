...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1944, _1957
...
class _Cast_SQLDatabase:
    ...
    @property
    def database(self: "CastSelf") -> "_1888.Database":
        return self.__parent__._cast(_1888.Database)
    ...
    @property
    def named_database(self: "CastSelf") -> "_1892.NamedDatabase":
        from mastapy._private.utility.databases import _1892

        return self.__parent__._cast(_1892.NamedDatabase)

    @property
    def bearing_settings_database(self: "CastSelf") -> "_1944.BearingSettingsDatabase":
        from mastapy._private.bearings import _1944

        return self.__parent__._cast(_1944.BearingSettingsDatabase)

    @property
    def rolling_bearing_database(self: "CastSelf") -> "_1957.RollingBearingDatabase":
        from mastapy._private.bearings import _1957

        return self.__parent__._cast(_1957.RollingBearingDatabase)

    @property
    def iso14179_settings_database(
        self: "CastSelf",
    ) -> "_2040.ISO14179SettingsDatabase":
        from mastapy._private.bearings.bearing_results.rolling import _2040

        return self.__parent__._cast(_2040.ISO14179SettingsDatabase)

    @property
    def conical_gear_optimization_strategy_database(
        self: "CastSelf",
    ) -> "_2294.ConicalGearOptimizationStrategyDatabase":
        from mastapy._private.system_model.optimization import _2294

        return self.__parent__._cast(_2294.ConicalGearOptimizationStrategyDatabase)

    @property
    def optimization_strategy_database(
        self: "CastSelf",
    ) -> "_2302.OptimizationStrategyDatabase":
        from mastapy._private.system_model.optimization import _2302

        return self.__parent__._cast(_2302.OptimizationStrategyDatabase)

    @property
    def supercharger_rotor_set_database(
        self: "CastSelf",
    ) -> "_2636.SuperchargerRotorSetDatabase":
        from mastapy._private.system_model.part_model.gears.supercharger_rotor_set import (
            _2636,
        )

        return self.__parent__._cast(_2636.SuperchargerRotorSetDatabase)
...
class SQLDatabase(_1888.Database[TKey, TValue]):
    """SQLDatabase
