...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.cad_export import _1897
...
class CustomReportCadDrawing(_1833.CustomReportNameableItem):
    ...
    @property
    def stock_drawing(self: "Self") -> "_1897.StockDrawings":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.cad_export._1897", "StockDrawings"
        )(value)

    @stock_drawing.setter
    @enforce_parameter_types
    def stock_drawing(self: "Self", value: "_1897.StockDrawings") -> None:
