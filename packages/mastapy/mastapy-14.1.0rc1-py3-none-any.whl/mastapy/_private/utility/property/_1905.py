...
from mastapy._private.utility.property import _1901
...
class _Cast_DutyCyclePropertySummaryStress:
    ...
    def duty_cycle_property_summary(
        self: "CastSelf",
    ) -> "_1901.DutyCyclePropertySummary":
        return self.__parent__._cast(_1901.DutyCyclePropertySummary)
...
class DutyCyclePropertySummaryStress(_1901.DutyCyclePropertySummary[_1776.Stress, T]):
    """DutyCyclePropertySummaryStress
