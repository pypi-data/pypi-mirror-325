...
if __tc:
    ...
    from mastapy._private.bearings.bearing_results.rolling.fitting._2176 import (
        InterferenceComponents,
    )
    from mastapy._private.bearings.bearing_results.rolling.fitting._2177 import (
    ...
    __import_structure = {
        ...
        "_private.bearings.bearing_results.rolling.fitting._2176": [
            "InterferenceComponents"
        ],
        "_private.bearings.bearing_results.rolling.fitting._2177": [
            "OuterRingFittingThermalResults"
        ],
