...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1943, _1944, _1957, _1963
...
class MASTASettings(_0.APIBase):
    ...
    @property
    def iso14179_settings_database(self: "Self") -> "_2040.ISO14179SettingsDatabase":
    ...
    @property
    def bearing_settings(self: "Self") -> "_1943.BearingSettings":
    ...
    @property
    def bearing_settings_database(self: "Self") -> "_1944.BearingSettingsDatabase":
    ...
    @property
    def rolling_bearing_database(self: "Self") -> "_1957.RollingBearingDatabase":
    ...
    @property
    def skf_settings(self: "Self") -> "_1963.SKFSettings":
    ...
    @property
    def harmonic_analysis_draw_style(self: "Self") -> "_5885.HarmonicAnalysisDrawStyle":
    ...
    @property
    def mbd_analysis_draw_style(self: "Self") -> "_5576.MBDAnalysisDrawStyle":
    ...
    @property
    def modal_analysis_draw_style(self: "Self") -> "_4761.ModalAnalysisDrawStyle":
    ...
    @property
    def power_flow_draw_style(self: "Self") -> "_4220.PowerFlowDrawStyle":
    ...
    @property
    def system_deflection_draw_style(self: "Self") -> "_2903.SystemDeflectionDrawStyle":
    ...
    @property
    def planet_carrier_settings(self: "Self") -> "_2539.PlanetCarrierSettings":
    ...
    @property
    def cad_export_settings(self: "Self") -> "_1896.CADExportSettings":
    ...
    @property
    def database_settings(self: "Self") -> "_1891.DatabaseSettings":
