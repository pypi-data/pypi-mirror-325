...
class StraightBevelGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7329.StraightBevelGearSetAdvancedSystemDeflection]":
    ...
    def straight_bevel_gears_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7459.StraightBevelGearCompoundAdvancedSystemDeflection]":
    ...
    def straight_bevel_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7460.StraightBevelGearMeshCompoundAdvancedSystemDeflection]":
