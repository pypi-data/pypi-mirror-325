...
class HypoidGearSetCompoundPowerFlow(_4270.AGMAGleasonConicalGearSetCompoundPowerFlow):
    """HypoidGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4194.HypoidGearSetPowerFlow]":
    ...
    def hypoid_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4326.HypoidGearCompoundPowerFlow]":
    ...
    def hypoid_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4327.HypoidGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4194.HypoidGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearSetPowerFlow]
