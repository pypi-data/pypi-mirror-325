...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self: "Self") -> "_6674.ExcelFileDetails":
    ...
    @property
    def masta_file_details(self: "Self") -> "_6677.MASTAFileDetails":
    ...
    def excel_sheet_design_state_selection(
        self: "Self",
    ) -> "List[_6676.ExcelSheetDesignStateSelector]":
