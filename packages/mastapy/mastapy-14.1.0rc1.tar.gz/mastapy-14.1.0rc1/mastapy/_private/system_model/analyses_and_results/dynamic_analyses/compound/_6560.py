...
class BoltCompoundDynamicAnalysis(_6566.ComponentCompoundDynamicAnalysis):
    """BoltCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6427.BoltDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6427.BoltDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.BoltDynamicAnalysis]
