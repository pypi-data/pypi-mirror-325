...
class AssemblyHarmonicAnalysis(_5800.AbstractAssemblyHarmonicAnalysis):
    """AssemblyHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4682.AssemblyModalAnalysis":
    ...
    @property
    def bearings(self: "Self") -> "List[_5809.BearingHarmonicAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_5811.BeltDriveHarmonicAnalysis]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_5820.BoltedJointHarmonicAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_5821.BoltHarmonicAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_5843.CVTHarmonicAnalysis]":
    ...
    @property
    def clutches(self: "Self") -> "List[_5824.ClutchHarmonicAnalysis]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_5833.ConceptGearSetHarmonicAnalysis]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_5847.CycloidalDiscHarmonicAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_5873.FEPartHarmonicAnalysis]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_5872.FaceGearSetHarmonicAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_5896.HypoidGearSetHarmonicAnalysis]":
    ...
    @property
    def loaded_gear_sets(self: "Self") -> "List[_5881.GearSetHarmonicAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_5907.MassDiscHarmonicAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_5910.MicrophoneHarmonicAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_5912.OilSealHarmonicAnalysis]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_5920.PlanetCarrierHarmonicAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_5921.PointLoadHarmonicAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_5922.PowerLoadHarmonicAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_5925.RingPinsHarmonicAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_5931.ShaftHarmonicAnalysis]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_5942.SpringDamperHarmonicAnalysis]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_5953.SynchroniserHarmonicAnalysis]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_5961.UnbalancedMassHarmonicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_5965.WormGearSetHarmonicAnalysis]":
