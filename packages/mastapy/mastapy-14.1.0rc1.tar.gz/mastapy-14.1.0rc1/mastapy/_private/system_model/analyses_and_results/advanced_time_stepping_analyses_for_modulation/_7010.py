...
class _Cast_HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation:
    ...
    @property
    def harmonic_analysis_options(self: "CastSelf") -> "_5889.HarmonicAnalysisOptions":
        return self.__parent__._cast(_5889.HarmonicAnalysisOptions)
