...
class ConicalGearSetAdvancedSystemDeflection(_7276.GearSetAdvancedSystemDeflection):
    """ConicalGearSetAdvancedSystemDeflection
    ...
    def gears_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7246.ConicalGearAdvancedSystemDeflection]":
    ...
    def meshes_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7247.ConicalGearMeshAdvancedSystemDeflection]":
