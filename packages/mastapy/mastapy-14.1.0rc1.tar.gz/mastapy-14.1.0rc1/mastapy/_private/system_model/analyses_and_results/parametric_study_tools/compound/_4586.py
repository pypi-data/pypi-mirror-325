...
class CVTPulleyCompoundParametricStudyTool(_4634.PulleyCompoundParametricStudyTool):
    """CVTPulleyCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7544.CVTPulleyLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4437.CVTPulleyParametricStudyTool]":
