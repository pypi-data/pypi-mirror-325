...
class ConceptGearCompoundParametricStudyTool(_4602.GearCompoundParametricStudyTool):
    """ConceptGearCompoundParametricStudyTool
    ...
    @property
    def component_design(self: "Self") -> "_2593.ConceptGear":
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7529.ConceptGearLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4425.ConceptGearParametricStudyTool]":
