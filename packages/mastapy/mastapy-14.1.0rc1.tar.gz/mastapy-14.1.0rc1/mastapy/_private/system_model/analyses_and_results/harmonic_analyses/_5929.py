...
class RollingRingHarmonicAnalysis(_5840.CouplingHalfHarmonicAnalysis):
    """RollingRingHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7637.RollingRingLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2876.RollingRingSystemDeflection":
