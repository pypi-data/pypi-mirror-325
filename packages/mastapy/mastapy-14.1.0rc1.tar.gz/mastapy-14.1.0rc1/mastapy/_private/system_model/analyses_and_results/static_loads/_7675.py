...
class WormGearSetLoadCase(_7583.GearSetLoadCase):
    """WormGearSetLoadCase
    ...
    @property
    def gears_load_case(self: "Self") -> "List[_7673.WormGearLoadCase]":
    ...
    @property
    def worm_gears_load_case(self: "Self") -> "List[_7673.WormGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.WormGearLoadCase]
    ...
    @property
    def meshes_load_case(self: "Self") -> "List[_7674.WormGearMeshLoadCase]":
    ...
    @property
    def worm_meshes_load_case(self: "Self") -> "List[_7674.WormGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.WormGearMeshLoadCase]
