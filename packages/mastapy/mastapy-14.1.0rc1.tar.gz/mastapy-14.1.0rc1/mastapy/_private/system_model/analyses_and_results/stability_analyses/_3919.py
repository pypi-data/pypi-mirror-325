...
class HypoidGearSetStabilityAnalysis(_3859.AGMAGleasonConicalGearSetStabilityAnalysis):
    """HypoidGearSetStabilityAnalysis
    ...
    def agma_gleason_conical_gears_stability_analysis(
        self: "Self",
    ) -> "List[_3920.HypoidGearStabilityAnalysis]":
    ...
    def agma_gleason_conical_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3918.HypoidGearMeshStabilityAnalysis]":
