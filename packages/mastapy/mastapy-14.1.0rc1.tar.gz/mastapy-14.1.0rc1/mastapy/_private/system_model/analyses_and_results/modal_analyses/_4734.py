...
class FaceGearSetModalAnalysis(_4740.GearSetModalAnalysis):
    """FaceGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2830.FaceGearSetSystemDeflection":
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4733.FaceGearModalAnalysis]":
    ...
    @property
    def face_gears_modal_analysis(self: "Self") -> "List[_4733.FaceGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearModalAnalysis]
    ...
    @property
    def meshes_modal_analysis(self: "Self") -> "List[_4732.FaceGearMeshModalAnalysis]":
    ...
    def face_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4732.FaceGearMeshModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearMeshModalAnalysis]
