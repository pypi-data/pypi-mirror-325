...
class GearMeshSystemDeflection(_2842.InterMountableComponentConnectionSystemDeflection):
    """GearMeshSystemDeflection
    ...
    @property
    def gear_a(self: "Self") -> "_2836.GearSystemDeflection":
    ...
    @property
    def gear_b(self: "Self") -> "_2836.GearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.GearSystemDeflection
    ...
    @property
    def mesh_separations(self: "Self") -> "List[_2856.MeshSeparationsAtFaceWidth]":
    ...
    @property
    def gear_set(self: "Self") -> "_2835.GearSetSystemDeflection":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4188.GearMeshPowerFlow":
