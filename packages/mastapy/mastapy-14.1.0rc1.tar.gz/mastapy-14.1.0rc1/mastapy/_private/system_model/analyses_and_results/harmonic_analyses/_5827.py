...
class ComponentHarmonicAnalysis(_5913.PartHarmonicAnalysis):
    """ComponentHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4700.ComponentModalAnalysis":
    ...
    @property
    def results(self: "Self") -> "_5990.HarmonicAnalysisResultsPropertyAccessor":
