...
from mastapy._private.system_model.part_model.acoustics import _2701
...
class _Cast_HarmonicAnalysisOptions:
    ...
    def harmonic_analysis_options_for_advanced_time_stepping_analysis_for_modulation(
        self: "CastSelf",
    ) -> "_7010.HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation":
        from mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import (
            _7010,
        )
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    def acoustic_analysis_setup(
        self: "Self", value: "_2701.AcousticAnalysisSetup"
    ) -> None:
    ...
    @enforce_parameter_types
    def damping_specification(
        self: "Self", value: "_5853.DampingSpecification"
    ) -> None:
    ...
    @property
    def response_cache_level(self: "Self") -> "_5924.ResponseCacheLevel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses._5924",
            "ResponseCacheLevel",
        )(value)

    @response_cache_level.setter
    @enforce_parameter_types
    def response_cache_level(self: "Self", value: "_5924.ResponseCacheLevel") -> None:
    ...
    @property
    def excitation_selection(self: "Self") -> "_5972.ExcitationSourceSelectionGroup":
    ...
    @property
    def modal_analysis_options(self: "Self") -> "_4762.ModalAnalysisOptions":
    ...
    @property
    def stiffness_options(self: "Self") -> "_5943.StiffnessOptionsForHarmonicAnalysis":
