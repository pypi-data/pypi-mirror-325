...
from mastapy._private.system_model import _2280
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2032, _2134
    from mastapy._private.system_model import _2275, _2290
...
class LoadCase(_2725.Context):
    ...
    def ball_bearing_contact_calculation(
        self: "Self",
    ) -> "_2032.BallBearingContactCalculation":
    ...
    @enforce_parameter_types
    def ball_bearing_contact_calculation(
        self: "Self", value: "_2032.BallBearingContactCalculation"
    ) -> None:
    ...
    @enforce_parameter_types
    def ball_bearing_friction_model_for_gyroscopic_moment(
        self: "Self", value: "_2037.FrictionModelForGyroscopicMoment"
    ) -> None:
    ...
    @property
    def bearing_element_orbit_model(self: "Self") -> "_5500.BearingElementOrbitModel":
    ...
    def bearing_element_orbit_model(
        self: "Self", value: "_5500.BearingElementOrbitModel"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.BearingElementOrbitModel",
    ...
    def hypoid_gear_wind_up_removal_method_for_misalignments(
        self: "Self",
    ) -> "_2275.HypoidWindUpRemovalMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2275", "HypoidWindUpRemovalMethod"
        )(value)

    @hypoid_gear_wind_up_removal_method_for_misalignments.setter
    @enforce_parameter_types
    def hypoid_gear_wind_up_removal_method_for_misalignments(
        self: "Self", value: "_2275.HypoidWindUpRemovalMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def mesh_stiffness_model(self: "Self", value: "_2280.MeshStiffnessModel") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def roller_analysis_method(self: "Self") -> "_2134.RollerAnalysisMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_results.rolling._2134",
    ...
    def roller_analysis_method(
        self: "Self", value: "_2134.RollerAnalysisMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def stress_concentration_method_for_rating(
        self: "Self", value: "_2174.StressConcentrationMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def additional_acceleration(self: "Self") -> "_7498.AdditionalAccelerationOptions":
    ...
    @property
    def input_power_load(self: "Self") -> "_7629.PowerLoadLoadCase":
    ...
    @property
    def output_power_load(self: "Self") -> "_7629.PowerLoadLoadCase":
        """mastapy.system_model.analyses_and_results.static_loads.PowerLoadLoadCase
    ...
    def parametric_study_tool_options(
        self: "Self",
    ) -> "_4490.ParametricStudyToolOptions":
    ...
    @property
    def temperatures(self: "Self") -> "_2290.TransmissionTemperatureSet":
    ...
    def transmission_efficiency_settings(
        self: "Self",
    ) -> "_7669.TransmissionEfficiencySettings":
    ...
    @property
    def power_loads(self: "Self") -> "List[_7629.PowerLoadLoadCase]":
    ...
    @enforce_parameter_types
    def inputs_for_cvt(self: "Self", design_entity: "_2660.CVT") -> "_7543.CVTLoadCase":
