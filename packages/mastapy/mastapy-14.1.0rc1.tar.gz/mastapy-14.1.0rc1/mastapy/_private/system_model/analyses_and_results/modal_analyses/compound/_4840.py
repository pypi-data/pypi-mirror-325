...
class AssemblyCompoundModalAnalysis(_4833.AbstractAssemblyCompoundModalAnalysis):
    """AssemblyCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4682.AssemblyModalAnalysis]":
    ...
    @property
    def bearings(self: "Self") -> "List[_4841.BearingCompoundModalAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_4843.BeltDriveCompoundModalAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_4846.BevelDifferentialGearSetCompoundModalAnalysis]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_4853.BoltedJointCompoundModalAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_4852.BoltCompoundModalAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_4874.CVTCompoundModalAnalysis]":
    ...
    @property
    def clutches(self: "Self") -> "List[_4854.ClutchCompoundModalAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_4859.ConceptCouplingCompoundModalAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_4864.ConceptGearSetCompoundModalAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_4876.CycloidalAssemblyCompoundModalAnalysis]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_4878.CycloidalDiscCompoundModalAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_4882.CylindricalGearSetCompoundModalAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_4889.FEPartCompoundModalAnalysis]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_4888.FaceGearSetCompoundModalAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_4890.FlexiblePinAssemblyCompoundModalAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_4897.HypoidGearSetCompoundModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_4904.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4907.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_4908.MassDiscCompoundModalAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_4909.MeasurementComponentCompoundModalAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_4911.MicrophoneCompoundModalAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_4913.OilSealCompoundModalAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_4915.PartToPartShearCouplingCompoundModalAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_4920.PlanetCarrierCompoundModalAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_4921.PointLoadCompoundModalAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_4922.PowerLoadCompoundModalAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_4924.RingPinsCompoundModalAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_4926.RollingRingAssemblyCompoundModalAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_4931.ShaftHubConnectionCompoundModalAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_4930.ShaftCompoundModalAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4936.SpiralBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_4937.SpringDamperCompoundModalAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_4942.StraightBevelDiffGearSetCompoundModalAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4945.StraightBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_4948.SynchroniserCompoundModalAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_4952.TorqueConverterCompoundModalAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_4956.UnbalancedMassCompoundModalAnalysis]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_4960.WormGearSetCompoundModalAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4963.ZerolBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4682.AssemblyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.AssemblyModalAnalysis]
