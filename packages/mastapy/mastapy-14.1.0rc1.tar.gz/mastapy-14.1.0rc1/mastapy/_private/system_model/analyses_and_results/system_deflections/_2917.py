...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2782
...
class ZerolBevelGearSetSystemDeflection(_2782.BevelGearSetSystemDeflection):
    """ZerolBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4263.ZerolBevelGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_2918.ZerolBevelGearSystemDeflection]":
    ...
    def bevel_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2916.ZerolBevelGearMeshSystemDeflection]":
