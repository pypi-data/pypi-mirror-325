...
class ConicalGearSetSystemDeflection(_2835.GearSetSystemDeflection):
    """ConicalGearSetSystemDeflection
    ...
    def gears_system_deflection(
        self: "Self",
    ) -> "List[_2801.ConicalGearSystemDeflection]":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4161.ConicalGearSetPowerFlow":
