...
class HypoidGearSetSystemDeflection(_2765.AGMAGleasonConicalGearSetSystemDeflection):
    """HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4194.HypoidGearSetPowerFlow":
    ...
    def agma_gleason_conical_gears_system_deflection(
        self: "Self",
    ) -> "List[_2840.HypoidGearSystemDeflection]":
    ...
    def agma_gleason_conical_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2838.HypoidGearMeshSystemDeflection]":
