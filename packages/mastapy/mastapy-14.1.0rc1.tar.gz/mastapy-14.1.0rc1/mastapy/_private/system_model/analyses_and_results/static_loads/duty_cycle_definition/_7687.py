...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.file_access_helpers import _1882
...
class _Cast_MultiTimeSeriesDataInputFileOptions:
    ...
    @property
    def data_input_file_options(self: "CastSelf") -> "_1912.DataInputFileOptions":
        return self.__parent__._cast(_1912.DataInputFileOptions)
...
class MultiTimeSeriesDataInputFileOptions(_1912.DataInputFileOptions):
    """MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self: "Self") -> "_1882.TextFileDelimiterOptions":
