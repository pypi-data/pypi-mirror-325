...
class ShaftCompoundSystemDeflection(_2929.AbstractShaftCompoundSystemDeflection):
    """ShaftCompoundSystemDeflection
    ...
    def shaft_duty_cycle_damage_results(
        self: "Self",
    ) -> "_3027.ShaftDutyCycleSystemDeflection":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2881.ShaftSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection]
