...
class FlexiblePinAnalysisStopStartAnalysis(_6400.FlexiblePinAnalysis):
    """FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_extreme_load_case(self: "Self") -> "_2881.ShaftSystemDeflection":
    ...
    @property
    def shaft_nominal_load_case(self: "Self") -> "_2881.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
