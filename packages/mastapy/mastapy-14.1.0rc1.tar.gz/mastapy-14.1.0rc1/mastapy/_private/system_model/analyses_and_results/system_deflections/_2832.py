...
class FEPartSystemDeflection(_2761.AbstractShaftOrHousingSystemDeflection):
    """FEPartSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4186.FEPartPowerFlow":
    ...
    @property
    def export(self: "Self") -> "_2477.SystemDeflectionFEExportOptions":
