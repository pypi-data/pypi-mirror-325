...
class WormGearCompoundParametricStudyTool(_4602.GearCompoundParametricStudyTool):
    """WormGearCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7673.WormGearLoadCase":
