...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2783
...
class BevelDifferentialGearSystemDeflection(_2783.BevelGearSystemDeflection):
    """BevelDifferentialGearSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7510.BevelDifferentialGearLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4139.BevelDifferentialGearPowerFlow":
