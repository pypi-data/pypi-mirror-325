...
class GearSetPowerFlow(_4232.SpecialisedAssemblyPowerFlow):
    """GearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4189.GearPowerFlow]":
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4188.GearMeshPowerFlow]":
