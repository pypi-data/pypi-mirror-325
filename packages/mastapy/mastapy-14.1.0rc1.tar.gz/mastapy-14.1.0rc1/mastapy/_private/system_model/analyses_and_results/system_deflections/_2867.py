...
class PlanetCarrierSystemDeflection(_2859.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def component_design(self: "Self") -> "_2538.PlanetCarrier":
    ...
    @property
    def component_load_case(self: "Self") -> "_7625.PlanetCarrierLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4217.PlanetCarrierPowerFlow":
    ...
    @property
    def windup(self: "Self") -> "List[_2923.PlanetCarrierWindup]":
