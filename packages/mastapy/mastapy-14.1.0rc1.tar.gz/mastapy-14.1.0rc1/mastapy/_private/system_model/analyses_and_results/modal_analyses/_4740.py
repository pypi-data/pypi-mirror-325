...
class GearSetModalAnalysis(_4787.SpecialisedAssemblyModalAnalysis):
    """GearSetModalAnalysis
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4739.GearModalAnalysis]":
    ...
    @property
    def meshes_modal_analysis(self: "Self") -> "List[_4738.GearMeshModalAnalysis]":
