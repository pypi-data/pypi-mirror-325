...
class BearingCompoundDynamicAnalysis(_6577.ConnectorCompoundDynamicAnalysis):
    """BearingCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6416.BearingDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6416.BearingDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.BearingDynamicAnalysis]
