...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results import _2006, _2014
    ...
    from mastapy._private.system_model.part_model import _2506, _2508
...
class BearingSystemDeflection(_2803.ConnectorSystemDeflection):
    """BearingSystemDeflection
    ...
    @property
    def spring_preload_chart(self: "Self") -> "_1931.TwoDChartDefinition":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_2014.LoadedBearingResults":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4135.BearingPowerFlow":
    ...
    @property
    def stiffness_between_rings(self: "Self") -> "_2006.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    @property
    def stiffness_matrix(self: "Self") -> "_2006.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    def race_mounting_options_for_analysis(
        self: "Self",
    ) -> "List[_2508.BearingRaceMountingOptions]":
    ...
    def stiffness_between_each_ring(
        self: "Self",
    ) -> "List[_2006.BearingStiffnessMatrixReporter]":
