...
class SynchroniserSystemDeflection(_2883.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4249.SynchroniserPowerFlow":
    ...
    @property
    def cones(self: "Self") -> "List[_2898.SynchroniserHalfSystemDeflection]":
