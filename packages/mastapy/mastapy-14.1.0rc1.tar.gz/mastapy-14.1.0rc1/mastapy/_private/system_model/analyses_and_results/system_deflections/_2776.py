...
class BevelDifferentialGearMeshSystemDeflection(_2781.BevelGearMeshSystemDeflection):
    """BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4138.BevelDifferentialGearMeshPowerFlow":
