...
class RootAssemblyParametricStudyTool(_4402.AssemblyParametricStudyTool):
    """RootAssemblyParametricStudyTool
    ...
    @property
    def parametric_study_tool_inputs(self: "Self") -> "_4489.ParametricStudyTool":
    ...
    def results_for_reporting(
        self: "Self",
    ) -> "_4491.ParametricStudyToolResultsForReporting":
    ...
    def root_assembly_duty_cycle_results(
        self: "Self",
    ) -> "List[_2980.DutyCycleEfficiencyResults]":
