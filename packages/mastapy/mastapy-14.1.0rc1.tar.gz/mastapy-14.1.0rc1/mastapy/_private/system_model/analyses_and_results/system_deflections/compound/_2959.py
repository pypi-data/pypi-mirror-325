...
class ConceptGearSetCompoundSystemDeflection(_2989.GearSetCompoundSystemDeflection):
    """ConceptGearSetCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2796.ConceptGearSetSystemDeflection]":
    ...
    def concept_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_2957.ConceptGearCompoundSystemDeflection]":
    ...
    def concept_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_2958.ConceptGearMeshCompoundSystemDeflection]":
