...
class SpiralBevelGearSetParametricStudyTool(_4413.BevelGearSetParametricStudyTool):
    """SpiralBevelGearSetParametricStudyTool
    ...
    def bevel_gears_parametric_study_tool(
        self: "Self",
    ) -> "List[_4515.SpiralBevelGearParametricStudyTool]":
    ...
    def bevel_meshes_parametric_study_tool(
        self: "Self",
    ) -> "List[_4514.SpiralBevelGearMeshParametricStudyTool]":
