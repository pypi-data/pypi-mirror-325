...
class AGMAGleasonConicalGearSetLoadCase(_7536.ConicalGearSetLoadCase):
    """AGMAGleasonConicalGearSetLoadCase
    ...
    def conical_gears_load_case(
        self: "Self",
    ) -> "List[_7501.AGMAGleasonConicalGearLoadCase]":
    ...
    def conical_meshes_load_case(
        self: "Self",
    ) -> "List[_7502.AGMAGleasonConicalGearMeshLoadCase]":
