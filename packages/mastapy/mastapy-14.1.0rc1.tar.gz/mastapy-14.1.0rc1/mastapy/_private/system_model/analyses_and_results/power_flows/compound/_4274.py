...
class BeltDriveCompoundPowerFlow(_4364.SpecialisedAssemblyCompoundPowerFlow):
    """BeltDriveCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2649.BeltDrive":
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4137.BeltDrivePowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4137.BeltDrivePowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BeltDrivePowerFlow]
