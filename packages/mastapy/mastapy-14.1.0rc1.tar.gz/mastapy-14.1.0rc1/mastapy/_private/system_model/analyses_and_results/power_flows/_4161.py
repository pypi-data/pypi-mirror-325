...
class ConicalGearSetPowerFlow(_4190.GearSetPowerFlow):
    """ConicalGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4160.ConicalGearPowerFlow]":
    ...
    @property
    def conical_gears_power_flow(self: "Self") -> "List[_4160.ConicalGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConicalGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4159.ConicalGearMeshPowerFlow]":
    ...
    def conical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4159.ConicalGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConicalGearMeshPowerFlow]
