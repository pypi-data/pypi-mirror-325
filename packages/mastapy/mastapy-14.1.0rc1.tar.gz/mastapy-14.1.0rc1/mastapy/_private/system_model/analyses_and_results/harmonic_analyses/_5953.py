...
class SynchroniserHarmonicAnalysis(_5935.SpecialisedAssemblyHarmonicAnalysis):
    """SynchroniserHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2901.SynchroniserSystemDeflection":
