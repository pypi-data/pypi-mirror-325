...
class PowerLoadSystemDeflection(_2912.VirtualComponentSystemDeflection):
    """PowerLoadSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4221.PowerLoadPowerFlow":
    ...
    def transmission_error_to_other_power_loads(
        self: "Self",
    ) -> "List[_2910.TransmissionErrorResult]":
