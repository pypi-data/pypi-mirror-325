...
class BoltedJointCompoundModalAnalysis(_4933.SpecialisedAssemblyCompoundModalAnalysis):
    """BoltedJointCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4694.BoltedJointModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4694.BoltedJointModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BoltedJointModalAnalysis]
