...
class AssemblyCriticalSpeedAnalysis(_6678.AbstractAssemblyCriticalSpeedAnalysis):
    """AssemblyCriticalSpeedAnalysis
    ...
    @property
    def bearings(self: "Self") -> "List[_6686.BearingCriticalSpeedAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_6688.BeltDriveCriticalSpeedAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_6691.BevelDifferentialGearSetCriticalSpeedAnalysis]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_6698.BoltedJointCriticalSpeedAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_6697.BoltCriticalSpeedAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_6722.CVTCriticalSpeedAnalysis]":
    ...
    @property
    def clutches(self: "Self") -> "List[_6700.ClutchCriticalSpeedAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_6705.ConceptCouplingCriticalSpeedAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_6724.CycloidalAssemblyCriticalSpeedAnalysis]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_6726.CycloidalDiscCriticalSpeedAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_6730.CylindricalGearSetCriticalSpeedAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_6737.FEPartCriticalSpeedAnalysis]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_6736.FaceGearSetCriticalSpeedAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_6738.FlexiblePinAssemblyCriticalSpeedAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_6745.HypoidGearSetCriticalSpeedAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_6752.KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6755.KlingelnbergCycloPalloidSpiralBevelGearSetCriticalSpeedAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_6756.MassDiscCriticalSpeedAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_6757.MeasurementComponentCriticalSpeedAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_6759.MicrophoneCriticalSpeedAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_6761.OilSealCriticalSpeedAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_6764.PartToPartShearCouplingCriticalSpeedAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_6768.PlanetCarrierCriticalSpeedAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_6769.PointLoadCriticalSpeedAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_6770.PowerLoadCriticalSpeedAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_6772.RingPinsCriticalSpeedAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_6774.RollingRingAssemblyCriticalSpeedAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_6779.ShaftHubConnectionCriticalSpeedAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_6778.ShaftCriticalSpeedAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6784.SpiralBevelGearSetCriticalSpeedAnalysis]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_6786.SpringDamperCriticalSpeedAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_6790.StraightBevelDiffGearSetCriticalSpeedAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6793.StraightBevelGearSetCriticalSpeedAnalysis]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_6796.SynchroniserCriticalSpeedAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_6801.TorqueConverterCriticalSpeedAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_6804.UnbalancedMassCriticalSpeedAnalysis]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_6808.WormGearSetCriticalSpeedAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6811.ZerolBevelGearSetCriticalSpeedAnalysis]":
