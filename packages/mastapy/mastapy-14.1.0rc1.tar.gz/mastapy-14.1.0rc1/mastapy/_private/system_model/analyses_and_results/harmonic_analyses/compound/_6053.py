...
class CylindricalGearSetCompoundHarmonicAnalysis(_6064.GearSetCompoundHarmonicAnalysis):
    """CylindricalGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5851.CylindricalGearSetHarmonicAnalysis]":
    ...
    def cylindrical_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6051.CylindricalGearCompoundHarmonicAnalysis]":
    ...
    def cylindrical_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6052.CylindricalGearMeshCompoundHarmonicAnalysis]":
