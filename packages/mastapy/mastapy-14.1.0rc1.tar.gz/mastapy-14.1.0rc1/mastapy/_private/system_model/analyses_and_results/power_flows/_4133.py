...
class AGMAGleasonConicalGearSetPowerFlow(_4161.ConicalGearSetPowerFlow):
    """AGMAGleasonConicalGearSetPowerFlow
    ...
    def conical_gears_power_flow(
        self: "Self",
    ) -> "List[_4132.AGMAGleasonConicalGearPowerFlow]":
    ...
    def conical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4131.AGMAGleasonConicalGearMeshPowerFlow]":
