...
class FlexiblePinAssemblyCompoundPowerFlow(_4364.SpecialisedAssemblyCompoundPowerFlow):
    """FlexiblePinAssemblyCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2521.FlexiblePinAssembly":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4187.FlexiblePinAssemblyPowerFlow]":
