...
class RootAssemblyHarmonicAnalysis(
    _5808.AssemblyHarmonicAnalysis, _2730.IHaveRootHarmonicAnalysisResults
):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self: "Self") -> "_5890.HarmonicAnalysisRootAssemblyExportOptions":
    ...
    @property
    def harmonic_analysis_inputs(self: "Self") -> "_5884.HarmonicAnalysis":
    ...
    def results(
        self: "Self",
    ) -> "_6001.RootAssemblyHarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2877.RootAssemblySystemDeflection":
