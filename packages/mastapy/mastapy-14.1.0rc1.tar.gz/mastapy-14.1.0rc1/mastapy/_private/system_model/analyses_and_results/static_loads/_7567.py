...
from mastapy._private.system_model.analyses_and_results.static_loads import _7568
...
class _Cast_ElectricMachineHarmonicLoadFluxImportOptions:
    ...
    def electric_machine_harmonic_load_import_options_base(
        self: "CastSelf",
    ) -> "_7568.ElectricMachineHarmonicLoadImportOptionsBase":
        return self.__parent__._cast(_7568.ElectricMachineHarmonicLoadImportOptionsBase)
