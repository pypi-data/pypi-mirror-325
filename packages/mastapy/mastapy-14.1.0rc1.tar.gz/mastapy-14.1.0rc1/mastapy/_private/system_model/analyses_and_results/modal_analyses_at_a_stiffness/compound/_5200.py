...
class SpiralBevelGearSetCompoundModalAnalysisAtAStiffness(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5069.SpiralBevelGearSetModalAnalysisAtAStiffness]":
    ...
    def spiral_bevel_gears_compound_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_5198.SpiralBevelGearCompoundModalAnalysisAtAStiffness]":
    ...
    def spiral_bevel_meshes_compound_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_5199.SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness]":
