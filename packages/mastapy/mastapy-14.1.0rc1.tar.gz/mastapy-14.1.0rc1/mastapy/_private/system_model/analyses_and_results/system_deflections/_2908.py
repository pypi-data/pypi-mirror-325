...
class TorqueConverterTurbineSystemDeflection(_2805.CouplingHalfSystemDeflection):
    """TorqueConverterTurbineSystemDeflection
    ...
    @property
    def component_design(self: "Self") -> "_2690.TorqueConverterTurbine":
    ...
    @property
    def component_load_case(self: "Self") -> "_7666.TorqueConverterTurbineLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4255.TorqueConverterTurbinePowerFlow":
