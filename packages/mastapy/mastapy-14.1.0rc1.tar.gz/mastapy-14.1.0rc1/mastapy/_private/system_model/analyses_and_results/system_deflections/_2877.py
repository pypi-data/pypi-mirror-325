...
class RootAssemblySystemDeflection(_2767.AssemblySystemDeflection):
    """RootAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4228.RootAssemblyPowerFlow":
    ...
    @property
    def system_deflection_inputs(self: "Self") -> "_2902.SystemDeflection":
    ...
    def shaft_deflection_results(
        self: "Self",
    ) -> "List[_2791.ConcentricPartGroupCombinationSystemDeflectionResults]":
