...
class CylindricalGearMeshSystemDeflection(_2834.GearMeshSystemDeflection):
    """CylindricalGearMeshSystemDeflection
    ...
    @property
    def gear_a(self: "Self") -> "_2820.CylindricalGearSystemDeflection":
    ...
    @property
    def gear_b(self: "Self") -> "_2820.CylindricalGearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4175.CylindricalGearMeshPowerFlow":
    ...
    def cylindrical_meshed_gear_system_deflections(
        self: "Self",
    ) -> "List[_2824.CylindricalMeshedGearSystemDeflection]":
    ...
    def mesh_deflections_left_flank(
        self: "Self",
    ) -> "List[_2922.MeshDeflectionResults]":
    ...
    @property
    def gear_set(self: "Self") -> "_2817.CylindricalGearSetSystemDeflection":
