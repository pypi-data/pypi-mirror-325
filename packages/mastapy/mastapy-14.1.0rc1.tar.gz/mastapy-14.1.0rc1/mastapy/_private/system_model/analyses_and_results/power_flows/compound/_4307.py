...
class CycloidalAssemblyCompoundPowerFlow(_4364.SpecialisedAssemblyCompoundPowerFlow):
    """CycloidalAssemblyCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2640.CycloidalAssembly":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4170.CycloidalAssemblyPowerFlow]":
