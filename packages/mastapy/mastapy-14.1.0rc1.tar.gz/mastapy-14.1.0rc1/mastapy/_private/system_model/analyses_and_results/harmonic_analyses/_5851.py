...
class CylindricalGearSetHarmonicAnalysis(_5881.GearSetHarmonicAnalysis):
    """CylindricalGearSetHarmonicAnalysis
    ...
    def gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5849.CylindricalGearHarmonicAnalysis]":
    ...
    def meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5850.CylindricalGearMeshHarmonicAnalysis]":
