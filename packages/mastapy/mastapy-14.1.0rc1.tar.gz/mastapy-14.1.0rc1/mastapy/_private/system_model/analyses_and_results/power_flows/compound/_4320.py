...
class FEPartCompoundPowerFlow(_4266.AbstractShaftOrHousingCompoundPowerFlow):
    """FEPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4186.FEPartPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4186.FEPartPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FEPartPowerFlow]
