...
class AssemblyLoadCase(_7494.AbstractAssemblyLoadCase):
    """AssemblyLoadCase
    ...
    @property
    def bearings(self: "Self") -> "List[_7507.BearingLoadCase]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_7509.BeltDriveLoadCase]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_7512.BevelDifferentialGearSetLoadCase]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_7518.BoltedJointLoadCase]":
    ...
    @property
    def bolts(self: "Self") -> "List[_7519.BoltLoadCase]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_7543.CVTLoadCase]":
    ...
    @property
    def clutch_connections(self: "Self") -> "List[_7520.ClutchConnectionLoadCase]":
    ...
    @property
    def clutches(self: "Self") -> "List[_7522.ClutchLoadCase]":
    ...
    @property
    def concept_couplings(self: "Self") -> "List[_7528.ConceptCouplingLoadCase]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_7531.ConceptGearSetLoadCase]":
    ...
    @property
    def cycloidal_assemblies(self: "Self") -> "List[_7545.CycloidalAssemblyLoadCase]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_7547.CycloidalDiscLoadCase]":
    ...
    @property
    def cylindrical_gear_sets(self: "Self") -> "List[_7553.CylindricalGearSetLoadCase]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_7575.FEPartLoadCase]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_7574.FaceGearSetLoadCase]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_7576.FlexiblePinAssemblyLoadCase]":
    ...
    @property
    def gear_meshes(self: "Self") -> "List[_7580.GearMeshLoadCase]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_7595.HypoidGearSetLoadCase]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_7605.KlingelnbergCycloPalloidHypoidGearSetLoadCase]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7608.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_7609.MassDiscLoadCase]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_7610.MeasurementComponentLoadCase]":
    ...
    @property
    def microphones(self: "Self") -> "List[_7613.MicrophoneLoadCase]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_7616.OilSealLoadCase]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_7621.PartToPartShearCouplingLoadCase]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_7625.PlanetCarrierLoadCase]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_7628.PointLoadLoadCase]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_7633.RingPinsLoadCase]":
    ...
    def ring_pins_to_cycloidal_disc_connections(
        self: "Self",
    ) -> "List[_7634.RingPinsToDiscConnectionLoadCase]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_7635.RollingRingAssemblyLoadCase]":
    ...
    @property
    def shaft_hub_connections(self: "Self") -> "List[_7639.ShaftHubConnectionLoadCase]":
    ...
    @property
    def shafts(self: "Self") -> "List[_7640.ShaftLoadCase]":
    ...
    def shafts_and_housings(
        self: "Self",
    ) -> "List[_7496.AbstractShaftOrHousingLoadCase]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7645.SpiralBevelGearSetLoadCase]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_7648.SpringDamperLoadCase]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_7651.StraightBevelDiffGearSetLoadCase]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7654.StraightBevelGearSetLoadCase]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_7658.SynchroniserLoadCase]":
    ...
    @property
    def torque_converters(self: "Self") -> "List[_7664.TorqueConverterLoadCase]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_7671.UnbalancedMassLoadCase]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_7675.WormGearSetLoadCase]":
    ...
    @property
    def zerol_bevel_gear_sets(self: "Self") -> "List[_7678.ZerolBevelGearSetLoadCase]":
