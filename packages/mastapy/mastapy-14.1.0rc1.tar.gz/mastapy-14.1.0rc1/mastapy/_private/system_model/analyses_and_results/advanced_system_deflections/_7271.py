...
class FaceGearSetAdvancedSystemDeflection(_7276.GearSetAdvancedSystemDeflection):
    """FaceGearSetAdvancedSystemDeflection
    ...
    def assembly_system_deflection_results(
        self: "Self",
    ) -> "List[_2830.FaceGearSetSystemDeflection]":
    ...
    def gears_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7269.FaceGearAdvancedSystemDeflection]":
    ...
    def meshes_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7270.FaceGearMeshAdvancedSystemDeflection]":
