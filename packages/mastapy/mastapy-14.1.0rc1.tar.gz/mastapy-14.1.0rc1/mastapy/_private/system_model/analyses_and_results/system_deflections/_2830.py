...
class FaceGearSetSystemDeflection(_2835.GearSetSystemDeflection):
    """FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4183.FaceGearSetPowerFlow":
    ...
    @property
    def gears_system_deflection(self: "Self") -> "List[_2831.FaceGearSystemDeflection]":
    ...
    def face_gears_system_deflection(
        self: "Self",
    ) -> "List[_2831.FaceGearSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.FaceGearSystemDeflection]
    ...
    def meshes_system_deflection(
        self: "Self",
    ) -> "List[_2829.FaceGearMeshSystemDeflection]":
