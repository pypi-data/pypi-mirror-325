...
from mastapy._private.system_model.analyses_and_results.static_loads import _7668, _7672
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2282, _2284
...
class PowerLoadLoadCase(_7672.VirtualComponentLoadCase):
    """PowerLoadLoadCase
    ...
    def drag_torque_specification_method(
        self: "Self",
    ) -> "_2282.PowerLoadDragTorqueSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2282",
    ...
    @enforce_parameter_types
    def drag_torque_specification_method(
        self: "Self", value: "_2282.PowerLoadDragTorqueSpecificationMethod"
    ) -> None:
    ...
    @enforce_parameter_types
    def electric_machine_data_set_selector(
        self: "Self", value: "_2440.ElectricMachineDataSet"
    ) -> None:
    ...
    @enforce_parameter_types
    def system_deflection_torque_method(
        self: "Self", value: "_7668.TorqueSpecificationForSystemDeflection"
    ) -> None:
    ...
    def target_speed_input_type(
        self: "Self",
    ) -> "_2284.PowerLoadPIDControlSpeedInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2284", "PowerLoadPIDControlSpeedInputType"
        )(value)

    @target_speed_input_type.setter
    @enforce_parameter_types
    def target_speed_input_type(
        self: "Self", value: "_2284.PowerLoadPIDControlSpeedInputType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def torque_input_method(
        self: "Self", value: "_2283.PowerLoadInputTorqueSpecificationMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def wheel_slip_model(self: "Self") -> "_5635.WheelSlipType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5635",
            "WheelSlipType",
        )(value)

    @wheel_slip_model.setter
    @enforce_parameter_types
    def wheel_slip_model(self: "Self", value: "_5635.WheelSlipType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.WheelSlipType",
        )
