...
class StraightBevelDiffGearMeshSystemDeflection(_2781.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4239.StraightBevelDiffGearMeshPowerFlow":
