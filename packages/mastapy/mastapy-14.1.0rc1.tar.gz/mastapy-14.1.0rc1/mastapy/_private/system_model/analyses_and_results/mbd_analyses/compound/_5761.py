...
class StraightBevelGearSetCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5620.StraightBevelGearSetMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_gears_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5759.StraightBevelGearCompoundMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_meshes_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5760.StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis]":
