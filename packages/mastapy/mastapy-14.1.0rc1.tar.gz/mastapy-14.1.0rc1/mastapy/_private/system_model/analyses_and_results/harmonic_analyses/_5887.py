...
class _Cast_HarmonicAnalysisFEExportOptions:
    ...
    def harmonic_analysis_export_options(
        self: "CastSelf",
    ) -> "_5886.HarmonicAnalysisExportOptions":
        return self.__parent__._cast(_5886.HarmonicAnalysisExportOptions)
...
class HarmonicAnalysisFEExportOptions(
    _5886.HarmonicAnalysisExportOptions[
        _2729.IHaveFEPartHarmonicAnalysisResults, _2520.FEPart
    ]
):
    """HarmonicAnalysisFEExportOptions
