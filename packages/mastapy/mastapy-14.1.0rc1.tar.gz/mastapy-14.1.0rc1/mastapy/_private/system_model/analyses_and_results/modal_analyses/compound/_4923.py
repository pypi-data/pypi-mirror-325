...
class PulleyCompoundModalAnalysis(_4872.CouplingHalfCompoundModalAnalysis):
    """PulleyCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4776.PulleyModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4776.PulleyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PulleyModalAnalysis]
