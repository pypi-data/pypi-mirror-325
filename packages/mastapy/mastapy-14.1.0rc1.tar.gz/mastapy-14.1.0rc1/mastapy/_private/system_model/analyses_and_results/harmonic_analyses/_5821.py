...
class BoltHarmonicAnalysis(_5827.ComponentHarmonicAnalysis):
    """BoltHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7519.BoltLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2785.BoltSystemDeflection":
