...
class BeltDriveSystemDeflection(_2883.SpecialisedAssemblySystemDeflection):
    """BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4137.BeltDrivePowerFlow":
    ...
    @property
    def belts(self: "Self") -> "List[_2774.BeltConnectionSystemDeflection]":
