...
class ConceptGearSetCompoundHarmonicAnalysis(_6064.GearSetCompoundHarmonicAnalysis):
    """ConceptGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5833.ConceptGearSetHarmonicAnalysis]":
    ...
    def concept_gears_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6033.ConceptGearCompoundHarmonicAnalysis]":
    ...
    def concept_meshes_compound_harmonic_analysis(
        self: "Self",
    ) -> "List[_6034.ConceptGearMeshCompoundHarmonicAnalysis]":
