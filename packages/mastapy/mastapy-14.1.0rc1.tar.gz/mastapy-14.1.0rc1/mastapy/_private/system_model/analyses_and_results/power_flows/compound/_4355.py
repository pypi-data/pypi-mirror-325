...
class RingPinsCompoundPowerFlow(_4343.MountableComponentCompoundPowerFlow):
    """RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4223.RingPinsPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4223.RingPinsPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.RingPinsPowerFlow]
