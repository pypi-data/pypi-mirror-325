...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.connections_and_sockets.couplings import _2410
...
class _Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed:
    ...
    def coupling_connection_compound_steady_state_synchronous_response_at_a_speed(
        self: "CastSelf",
    ) -> "_3761.CouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed":
...
class ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    @property
    def component_design(self: "Self") -> "_2410.ConceptCouplingConnection":
    ...
    @property
    def connection_design(self: "Self") -> "_2410.ConceptCouplingConnection":
        """mastapy.system_model.connections_and_sockets.couplings.ConceptCouplingConnection
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3617.ConceptCouplingConnectionSteadyStateSynchronousResponseAtASpeed]":
