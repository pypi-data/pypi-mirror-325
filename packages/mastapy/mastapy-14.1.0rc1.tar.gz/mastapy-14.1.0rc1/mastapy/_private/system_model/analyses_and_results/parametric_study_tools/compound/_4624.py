...
class OilSealCompoundParametricStudyTool(_4580.ConnectorCompoundParametricStudyTool):
    """OilSealCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7616.OilSealLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4483.OilSealParametricStudyTool]":
