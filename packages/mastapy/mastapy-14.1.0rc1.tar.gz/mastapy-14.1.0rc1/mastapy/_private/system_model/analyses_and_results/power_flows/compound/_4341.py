...
class MicrophoneArrayCompoundPowerFlow(_4364.SpecialisedAssemblyCompoundPowerFlow):
    """MicrophoneArrayCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2532.MicrophoneArray":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4207.MicrophoneArrayPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4207.MicrophoneArrayPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.MicrophoneArrayPowerFlow]
