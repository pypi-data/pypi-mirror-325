...
class BevelGearSetSystemDeflection(_2765.AGMAGleasonConicalGearSetSystemDeflection):
    """BevelGearSetSystemDeflection
    ...
    def agma_gleason_conical_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2781.BevelGearMeshSystemDeflection]":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4145.BevelGearSetPowerFlow":
