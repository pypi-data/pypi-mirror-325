...
class WormGearSetCompoundModalAnalysisAtASpeed(
    ...
    @property
    def component_design(self: "Self") -> "_2624.WormGearSet":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5356.WormGearSetModalAnalysisAtASpeed]":
    ...
    def worm_gears_compound_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5485.WormGearCompoundModalAnalysisAtASpeed]":
    ...
    def worm_meshes_compound_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5486.WormGearMeshCompoundModalAnalysisAtASpeed]":
