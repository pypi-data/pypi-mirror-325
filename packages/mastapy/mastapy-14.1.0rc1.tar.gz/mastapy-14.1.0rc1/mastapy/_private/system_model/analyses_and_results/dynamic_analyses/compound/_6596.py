...
class FaceGearSetCompoundDynamicAnalysis(_6601.GearSetCompoundDynamicAnalysis):
    """FaceGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6465.FaceGearSetDynamicAnalysis]":
    ...
    def face_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6594.FaceGearCompoundDynamicAnalysis]":
    ...
    def face_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6595.FaceGearMeshCompoundDynamicAnalysis]":
