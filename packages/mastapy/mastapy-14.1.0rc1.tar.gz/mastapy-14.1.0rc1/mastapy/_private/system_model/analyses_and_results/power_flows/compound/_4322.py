...
class GearCompoundPowerFlow(_4343.MountableComponentCompoundPowerFlow):
    """GearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4189.GearPowerFlow]":
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4189.GearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.GearPowerFlow]
