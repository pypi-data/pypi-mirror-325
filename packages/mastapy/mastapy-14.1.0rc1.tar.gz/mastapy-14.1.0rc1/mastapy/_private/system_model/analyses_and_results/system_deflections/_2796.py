...
class ConceptGearSetSystemDeflection(_2835.GearSetSystemDeflection):
    """ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4158.ConceptGearSetPowerFlow":
    ...
    def meshes_system_deflection(
        self: "Self",
    ) -> "List[_2795.ConceptGearMeshSystemDeflection]":
