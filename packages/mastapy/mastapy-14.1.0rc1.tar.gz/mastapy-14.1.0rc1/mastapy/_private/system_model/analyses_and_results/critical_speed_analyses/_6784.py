...
class SpiralBevelGearSetCriticalSpeedAnalysis(_6696.BevelGearSetCriticalSpeedAnalysis):
    """SpiralBevelGearSetCriticalSpeedAnalysis
    ...
    def bevel_gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6782.SpiralBevelGearCriticalSpeedAnalysis]":
    ...
    def bevel_meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6783.SpiralBevelGearMeshCriticalSpeedAnalysis]":
