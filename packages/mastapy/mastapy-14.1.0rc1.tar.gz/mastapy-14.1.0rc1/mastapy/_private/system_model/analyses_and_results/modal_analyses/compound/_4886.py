...
class FaceGearCompoundModalAnalysis(_4891.GearCompoundModalAnalysis):
    """FaceGearCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4733.FaceGearModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4733.FaceGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearModalAnalysis]
