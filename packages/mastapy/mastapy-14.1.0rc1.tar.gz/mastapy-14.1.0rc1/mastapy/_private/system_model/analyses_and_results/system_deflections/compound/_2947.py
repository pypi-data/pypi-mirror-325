...
class BoltCompoundSystemDeflection(_2953.ComponentCompoundSystemDeflection):
    """BoltCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2785.BoltSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2785.BoltSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BoltSystemDeflection]
