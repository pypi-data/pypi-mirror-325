...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.static_loads import _7584
...
class GuideDxfModelSystemDeflection(_2790.ComponentSystemDeflection):
    """GuideDxfModelSystemDeflection
    ...
    @property
    def component_design(self: "Self") -> "_2522.GuideDxfModel":
    ...
    @property
    def component_load_case(self: "Self") -> "_7584.GuideDxfModelLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4191.GuideDxfModelPowerFlow":
