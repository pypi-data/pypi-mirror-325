...
class CylindricalGearSetCompoundPowerFlow(_4324.GearSetCompoundPowerFlow):
    """CylindricalGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4177.CylindricalGearSetPowerFlow]":
    ...
    def cylindrical_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4311.CylindricalGearCompoundPowerFlow]":
    ...
    def cylindrical_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4312.CylindricalGearMeshCompoundPowerFlow]":
