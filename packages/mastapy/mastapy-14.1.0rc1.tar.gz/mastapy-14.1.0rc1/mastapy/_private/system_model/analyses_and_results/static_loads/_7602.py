...
class KlingelnbergCycloPalloidConicalGearSetLoadCase(_7536.ConicalGearSetLoadCase):
    """KlingelnbergCycloPalloidConicalGearSetLoadCase
    ...
    def conical_gears_load_case(
        self: "Self",
    ) -> "List[_7600.KlingelnbergCycloPalloidConicalGearLoadCase]":
    ...
    def conical_meshes_load_case(
        self: "Self",
    ) -> "List[_7601.KlingelnbergCycloPalloidConicalGearMeshLoadCase]":
