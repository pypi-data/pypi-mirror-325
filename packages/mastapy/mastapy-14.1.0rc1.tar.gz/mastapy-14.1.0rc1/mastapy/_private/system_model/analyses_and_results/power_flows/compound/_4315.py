...
class DatumCompoundPowerFlow(_4289.ComponentCompoundPowerFlow):
    """DatumCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4179.DatumPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4179.DatumPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.DatumPowerFlow]
