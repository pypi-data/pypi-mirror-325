...
class ConceptGearHarmonicAnalysis(_5876.GearHarmonicAnalysis):
    """ConceptGearHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7529.ConceptGearLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2797.ConceptGearSystemDeflection":
