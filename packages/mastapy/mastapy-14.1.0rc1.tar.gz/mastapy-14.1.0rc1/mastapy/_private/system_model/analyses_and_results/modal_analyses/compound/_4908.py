...
class MassDiscCompoundModalAnalysis(_4957.VirtualComponentCompoundModalAnalysis):
    """MassDiscCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4755.MassDiscModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4755.MassDiscModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.MassDiscModalAnalysis]
