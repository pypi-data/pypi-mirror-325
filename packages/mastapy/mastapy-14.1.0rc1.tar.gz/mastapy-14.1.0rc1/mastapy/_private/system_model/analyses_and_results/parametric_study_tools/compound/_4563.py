...
class BoltCompoundParametricStudyTool(_4569.ComponentCompoundParametricStudyTool):
    """BoltCompoundParametricStudyTool
    ...
    @property
    def component_design(self: "Self") -> "_2509.Bolt":
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7519.BoltLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4415.BoltParametricStudyTool]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4415.BoltParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.BoltParametricStudyTool]
