...
class RootAssemblyCompoundSystemDeflection(_2935.AssemblyCompoundSystemDeflection):
    """RootAssemblyCompoundSystemDeflection
    ...
    def duty_cycle_efficiency_results(
        self: "Self",
    ) -> "_2980.DutyCycleEfficiencyResults":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2877.RootAssemblySystemDeflection]":
