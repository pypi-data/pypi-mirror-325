...
class CycloidalAssemblySystemDeflection(_2883.SpecialisedAssemblySystemDeflection):
    """CycloidalAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4170.CycloidalAssemblyPowerFlow":
    ...
    def ring_pins_to_disc_connections(
        self: "Self",
    ) -> "List[_2872.RingPinsToDiscConnectionSystemDeflection]":
