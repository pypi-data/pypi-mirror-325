...
class ComponentCompoundPowerFlow(_4345.PartCompoundPowerFlow):
    """ComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4152.ComponentPowerFlow]":
