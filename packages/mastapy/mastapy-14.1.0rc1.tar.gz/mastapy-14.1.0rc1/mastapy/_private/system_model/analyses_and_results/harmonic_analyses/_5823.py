...
class ClutchHalfHarmonicAnalysis(_5840.CouplingHalfHarmonicAnalysis):
    """ClutchHalfHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7521.ClutchHalfLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2787.ClutchHalfSystemDeflection":
