...
class _Cast_PointLoadInputOptions:
    ...
    @property
    def column_input_options(self: "CastSelf") -> "_1911.ColumnInputOptions":
        return self.__parent__._cast(_1911.ColumnInputOptions)
...
class PointLoadInputOptions(_1911.ColumnInputOptions):
    """PointLoadInputOptions
    ...
    @property
    def conversion_to_load_case(self: "Self") -> "_7679.AdditionalForcesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads.duty_cycle_definition._7679",
    ...
    def conversion_to_load_case(
        self: "Self", value: "_7679.AdditionalForcesObtainedFrom"
    ) -> None:
    ...
    @point_load.setter
    @enforce_parameter_types
    def point_load(self: "Self", value: "_2540.PointLoad") -> None:
        wrapper_type = (
