...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing.options import _2327, _2329
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @chart_type.setter
    @enforce_parameter_types
    def chart_type(self: "Self", value: "_4729.DynamicsResponse3DChartType") -> None:
    ...
    @property
    def connected_component_type(self: "Self") -> "_5969.ConnectedComponentType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses.results._5969",
    ...
    def connected_component_type(
        self: "Self", value: "_5969.ConnectedComponentType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ConnectedComponentType",
    ...
    @property
    def coordinate_system(self: "Self") -> "_4712.CoordinateSystemForWhine":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4712",
    ...
    def coordinate_system(
        self: "Self", value: "_4712.CoordinateSystemForWhine"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.CoordinateSystemForWhine",
    ...
    @enforce_parameter_types
    def response_type(self: "Self", value: "_4730.DynamicsResponseType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def speed_range_for_combining_excitations(
        self: "Self",
    ) -> "_4764.MultipleExcitationsSpeedRangeOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4764",
    ...
    @enforce_parameter_types
    def speed_range_for_combining_excitations(
        self: "Self", value: "_4764.MultipleExcitationsSpeedRangeOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.MultipleExcitationsSpeedRangeOption",
    ...
    def whine_waterfall_export_option(
        self: "Self",
    ) -> "_4813.WhineWaterfallExportOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4813",
    ...
    @enforce_parameter_types
    def whine_waterfall_export_option(
        self: "Self", value: "_4813.WhineWaterfallExportOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.WhineWaterfallExportOption",
    ...
    def frequency_options(
        self: "Self",
    ) -> "_5875.FrequencyOptionsForHarmonicAnalysisResults":
    ...
    def modal_contribution_view_options(
        self: "Self",
    ) -> "_2329.ModalContributionViewOptions":
    ...
    def mode_view_options(
        self: "Self",
    ) -> "_2327.AdvancedTimeSteppingAnalysisForModulationModeViewOptions":
    ...
    @property
    def order_cuts_chart_settings(self: "Self") -> "_4766.OrderCutsChartSettings":
    ...
    def reference_speed_options(
        self: "Self",
    ) -> "_5936.SpeedOptionsForHarmonicAnalysisResults":
    ...
    def result_location_selection_groups(
        self: "Self",
    ) -> "_5977.ResultLocationSelectionGroups":
    ...
    @property
    def selected_excitations(self: "Self") -> "_5972.ExcitationSourceSelectionGroup":
    ...
    @property
    def waterfall_chart_settings(self: "Self") -> "_4812.WaterfallChartSettings":
    ...
    @property
    def active_result_locations(self: "Self") -> "List[_5978.ResultNodeSelection]":
    ...
    def degrees_of_freedom(
        self: "Self",
    ) -> "List[_1907.EnumWithBoolean[_1586.ResultOptionsFor3DVector]]":
