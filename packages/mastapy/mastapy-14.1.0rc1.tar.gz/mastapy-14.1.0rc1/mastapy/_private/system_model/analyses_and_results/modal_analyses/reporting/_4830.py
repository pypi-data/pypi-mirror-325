...
class _Cast_ShaftPerModeResult:
    ...
    @property
    def component_per_mode_result(self: "CastSelf") -> "_4823.ComponentPerModeResult":
        return self.__parent__._cast(_4823.ComponentPerModeResult)
...
class ShaftPerModeResult(_4823.ComponentPerModeResult):
    """ShaftPerModeResult
