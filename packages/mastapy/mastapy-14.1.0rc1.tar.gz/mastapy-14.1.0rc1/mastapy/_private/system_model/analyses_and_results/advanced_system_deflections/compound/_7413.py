...
class HypoidGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7280.HypoidGearSetAdvancedSystemDeflection]":
    ...
    def hypoid_gears_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7411.HypoidGearCompoundAdvancedSystemDeflection]":
    ...
    def hypoid_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7412.HypoidGearMeshCompoundAdvancedSystemDeflection]":
