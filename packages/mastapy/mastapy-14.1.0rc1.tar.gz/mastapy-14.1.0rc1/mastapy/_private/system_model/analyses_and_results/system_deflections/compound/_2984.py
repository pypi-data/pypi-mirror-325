...
class FaceGearSetCompoundSystemDeflection(_2989.GearSetCompoundSystemDeflection):
    """FaceGearSetCompoundSystemDeflection
    ...
    def face_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_2982.FaceGearCompoundSystemDeflection]":
    ...
    def face_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_2983.FaceGearMeshCompoundSystemDeflection]":
