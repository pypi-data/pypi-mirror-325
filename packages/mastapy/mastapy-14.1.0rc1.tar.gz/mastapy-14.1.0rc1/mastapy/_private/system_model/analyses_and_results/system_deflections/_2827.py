...
class ExternalCADModelSystemDeflection(_2790.ComponentSystemDeflection):
    """ExternalCADModelSystemDeflection
    ...
    @property
    def component_design(self: "Self") -> "_2519.ExternalCADModel":
    ...
    @property
    def component_load_case(self: "Self") -> "_7571.ExternalCADModelLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4180.ExternalCADModelPowerFlow":
