...
class _Cast_RigidlyConnectedComponentGroupSystemDeflection:
    ...
    def design_entity_group_analysis(
        self: "CastSelf",
    ) -> "_2727.DesignEntityGroupAnalysis":
        return self.__parent__._cast(_2727.DesignEntityGroupAnalysis)
...
class RigidlyConnectedComponentGroupSystemDeflection(_2727.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def components(self: "Self") -> "List[_2790.ComponentSystemDeflection]":
