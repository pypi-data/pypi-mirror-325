...
class FlexiblePinAssemblySystemDeflection(_2883.SpecialisedAssemblySystemDeflection):
    """FlexiblePinAssemblySystemDeflection
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7576.FlexiblePinAssemblyLoadCase":
    ...
    @property
    def flexible_pin_shaft_details(self: "Self") -> "_2881.ShaftSystemDeflection":
    ...
    @property
    def pin_analysis(self: "Self") -> "_2881.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4187.FlexiblePinAssemblyPowerFlow":
    ...
    @property
    def spindle_analyses(self: "Self") -> "_2881.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def bearing_static_analyses(self: "Self") -> "List[_2773.BearingSystemDeflection]":
    ...
    def load_sharing_factor_reporters(
        self: "Self",
    ) -> "List[_2853.LoadSharingFactorReporter]":
    ...
    def observed_pin_stiffness_reporters(
        self: "Self",
    ) -> "List[_2860.ObservedPinStiffnessReporter]":
    ...
    def planet_gear_system_deflections(
        self: "Self",
    ) -> "List[_2820.CylindricalGearSystemDeflection]":
