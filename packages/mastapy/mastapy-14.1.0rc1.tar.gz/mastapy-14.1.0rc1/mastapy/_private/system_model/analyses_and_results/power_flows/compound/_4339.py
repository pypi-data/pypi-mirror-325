...
class MassDiscCompoundPowerFlow(_4388.VirtualComponentCompoundPowerFlow):
    """MassDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4205.MassDiscPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4205.MassDiscPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.MassDiscPowerFlow]
