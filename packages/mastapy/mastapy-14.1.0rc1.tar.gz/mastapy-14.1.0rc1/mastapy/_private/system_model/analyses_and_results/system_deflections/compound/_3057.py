...
class WormGearSetCompoundSystemDeflection(_2989.GearSetCompoundSystemDeflection):
    """WormGearSetCompoundSystemDeflection
    ...
    def worm_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_3055.WormGearCompoundSystemDeflection]":
    ...
    def worm_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_3056.WormGearMeshCompoundSystemDeflection]":
