...
class _Cast_ComponentConnection:
    ...
    @property
    def component_measurer(self: "CastSelf") -> "_2337.ComponentMeasurer":
        return self.__parent__._cast(_2337.ComponentMeasurer)
...
class ComponentConnection(_2337.ComponentMeasurer):
    """ComponentConnection
    ...
    @property
    def connected_component(self: "Self") -> "_2511.Component":
