...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.connections_and_sockets.cycloidal import _2405
    from mastapy._private.system_model.part_model import _2503, _2511, _2528, _2537
...
class CycloidalDisc(_2502.AbstractShaft):
    """CycloidalDisc
    ...
    @property
    def load_sharing_settings(self: "Self") -> "_2528.LoadSharingSettings":
    ...
    def planetary_bearing_sockets(
        self: "Self",
    ) -> "List[_2405.CycloidalDiscPlanetaryBearingSocket]":
