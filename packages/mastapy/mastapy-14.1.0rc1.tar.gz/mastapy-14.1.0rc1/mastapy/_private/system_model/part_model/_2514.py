...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.connections_and_sockets import _2338, _2342
...
class Connector(_2533.MountableComponent):
    """Connector
    ...
    @property
    def outer_component(self: "Self") -> "_2502.AbstractShaft":
    ...
    @property
    def outer_connection(self: "Self") -> "_2338.Connection":
    ...
    @property
    def outer_socket(self: "Self") -> "_2342.CylindricalSocket":
