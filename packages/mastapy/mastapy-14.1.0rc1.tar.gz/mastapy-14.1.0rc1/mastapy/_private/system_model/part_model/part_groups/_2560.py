...
from mastapy._private.system_model.part_model.part_groups import _2556
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2557, _2561, _2562
...
class _Cast_ParallelPartGroup:
    ...
    def concentric_or_parallel_part_group(
        self: "CastSelf",
    ) -> "_2556.ConcentricOrParallelPartGroup":
        return self.__parent__._cast(_2556.ConcentricOrParallelPartGroup)

    @property
    def part_group(self: "CastSelf") -> "_2562.PartGroup":
        from mastapy._private.system_model.part_model.part_groups import _2562

        return self.__parent__._cast(_2562.PartGroup)

    @property
    def parallel_part_group_selection(
        self: "CastSelf",
    ) -> "_2561.ParallelPartGroupSelection":
        from mastapy._private.system_model.part_model.part_groups import _2561

        return self.__parent__._cast(_2561.ParallelPartGroupSelection)
...
class ParallelPartGroup(_2556.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self: "Self") -> "List[_2557.ConcentricPartGroup]":
