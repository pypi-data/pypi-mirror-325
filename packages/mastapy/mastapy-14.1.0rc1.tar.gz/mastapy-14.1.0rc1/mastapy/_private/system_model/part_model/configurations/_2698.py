...
class _Cast_PartDetailConfiguration:
    ...
    def active_gear_set_design_selection_group(
        ...
        return self.__parent__._cast(_2584.ActiveGearSetDesignSelectionGroup)

    @property
    def active_fe_substructure_selection_group(
        self: "CastSelf",
    ) -> "_2692.ActiveFESubstructureSelectionGroup":
        from mastapy._private.system_model.part_model.configurations import _2692

        return self.__parent__._cast(_2692.ActiveFESubstructureSelectionGroup)

    @property
    def active_shaft_design_selection_group(
        self: "CastSelf",
    ) -> "_2694.ActiveShaftDesignSelectionGroup":
        from mastapy._private.system_model.part_model.configurations import _2694

        return self.__parent__._cast(_2694.ActiveShaftDesignSelectionGroup)

    @property
    def bearing_detail_configuration(
        self: "CastSelf",
    ) -> "_2695.BearingDetailConfiguration":
        from mastapy._private.system_model.part_model.configurations import _2695

        return self.__parent__._cast(_2695.BearingDetailConfiguration)
