...
from mastapy._private.system_model.part_model import _2502, _2522
...
class Shaft(_2502.AbstractShaft):
    """Shaft
    ...
    @cad_model.setter
    @enforce_parameter_types
    def cad_model(self: "Self", value: "_2522.GuideDxfModel") -> None:
        wrapper_type = (
    ...
    @property
    def guide_image(self: "Self") -> "_2523.GuideImage":
    ...
    @property
    def fe_substructure_replacing_this(self: "Self") -> "_2450.FESubstructure":
    ...
    @enforce_parameter_types
    def mount_component(
        self: "Self", component: "_2533.MountableComponent", offset: "float"
    ) -> None:
        """Method does not return.
