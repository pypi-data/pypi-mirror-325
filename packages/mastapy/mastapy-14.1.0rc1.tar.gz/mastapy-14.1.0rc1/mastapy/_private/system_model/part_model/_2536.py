...
class _Cast_OuterBearingRaceMountingOptions:
    ...
    def bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2508.BearingRaceMountingOptions":
        return self.__parent__._cast(_2508.BearingRaceMountingOptions)
...
class OuterBearingRaceMountingOptions(_2508.BearingRaceMountingOptions):
    """OuterBearingRaceMountingOptions
