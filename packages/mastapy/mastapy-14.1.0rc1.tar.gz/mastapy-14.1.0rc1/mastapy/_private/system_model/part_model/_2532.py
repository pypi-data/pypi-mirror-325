...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2501, _2531, _2537
...
class MicrophoneArray(_2546.SpecialisedAssembly):
    """MicrophoneArray
    ...
    @property
    def array_design(self: "Self") -> "_2714.MicrophoneArrayDesign":
