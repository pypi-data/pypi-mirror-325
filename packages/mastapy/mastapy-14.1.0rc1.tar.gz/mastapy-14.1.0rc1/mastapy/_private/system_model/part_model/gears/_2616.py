...
class SpiralBevelGearSet(_2592.BevelGearSet):
    """SpiralBevelGearSet
    ...
    @property
    def spiral_bevel_gears(self: "Self") -> "List[_2615.SpiralBevelGear]":
    ...
    @property
    def spiral_bevel_meshes(self: "Self") -> "List[_2389.SpiralBevelGearMesh]":
