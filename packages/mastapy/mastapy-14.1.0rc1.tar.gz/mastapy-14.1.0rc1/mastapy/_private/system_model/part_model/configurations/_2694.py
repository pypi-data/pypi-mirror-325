...
from mastapy._private.system_model.part_model.configurations import _2693, _2698
...
class _Cast_ActiveShaftDesignSelectionGroup:
    ...
    @property
    def part_detail_configuration(self: "CastSelf") -> "_2698.PartDetailConfiguration":
        return self.__parent__._cast(_2698.PartDetailConfiguration)
...
class ActiveShaftDesignSelectionGroup(
    _2698.PartDetailConfiguration[
        _2693.ActiveShaftDesignSelection, _2552.Shaft, _46.SimpleShaftDefinition
    ]
):
    """ActiveShaftDesignSelectionGroup
