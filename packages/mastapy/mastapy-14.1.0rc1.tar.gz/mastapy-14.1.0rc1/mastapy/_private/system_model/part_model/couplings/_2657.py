...
class Coupling(_2546.SpecialisedAssembly):
    """Coupling
    ...
    @property
    def halves(self: "Self") -> "List[_2658.CouplingHalf]":
    ...
    @property
    def half_a(self: "Self") -> "_2658.CouplingHalf":
    ...
    @property
    def half_b(self: "Self") -> "_2658.CouplingHalf":
        """mastapy.system_model.part_model.couplings.CouplingHalf
