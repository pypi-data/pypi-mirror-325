...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2596, _2604, _2606
...
class HypoidGearSet(_2586.AGMAGleasonConicalGearSet):
    """HypoidGearSet
    ...
    @property
    def hypoid_gears(self: "Self") -> "List[_2606.HypoidGear]":
    ...
    @property
    def hypoid_meshes(self: "Self") -> "List[_2381.HypoidGearMesh]":
