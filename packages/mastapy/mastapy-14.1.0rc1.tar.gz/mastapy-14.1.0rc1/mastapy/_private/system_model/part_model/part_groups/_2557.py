...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2558, _2562
...
class ConcentricPartGroup(_2556.ConcentricOrParallelPartGroup):
    """ConcentricPartGroup
    ...
    def parallel_groups(
        self: "Self",
    ) -> "List[_2558.ConcentricPartGroupParallelToThis]":
