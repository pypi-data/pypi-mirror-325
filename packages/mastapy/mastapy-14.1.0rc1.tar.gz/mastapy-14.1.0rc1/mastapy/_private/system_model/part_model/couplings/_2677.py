...
class _Cast_SplineLeadRelief:
    ...
    @property
    def rigid_connector_settings(self: "CastSelf") -> "_2666.RigidConnectorSettings":
        return self.__parent__._cast(_2666.RigidConnectorSettings)
...
class SplineLeadRelief(_2666.RigidConnectorSettings):
    """SplineLeadRelief
    ...
    @property
    def microgeometry_clearance_chart(self: "Self") -> "_1931.TwoDChartDefinition":
    ...
    @property
    def crowning(self: "Self") -> "_2659.CrowningSpecification":
