...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2597, _2614
...
class CylindricalGearSet(_2604.GearSet):
    """CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self: "Self") -> "_2635.SuperchargerRotorSet":
    ...
    @property
    def cylindrical_gears(self: "Self") -> "List[_2597.CylindricalGear]":
    ...
    @property
    def cylindrical_meshes(self: "Self") -> "List[_2375.CylindricalGearMesh]":
    ...
    def add_gear(self: "Self") -> "_2597.CylindricalGear":
