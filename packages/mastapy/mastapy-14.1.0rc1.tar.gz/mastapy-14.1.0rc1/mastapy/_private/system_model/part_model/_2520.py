...
class FEPart(_2503.AbstractShaftOrHousing):
    """FEPart
    ...
    @enforce_parameter_types
    def default_fe_substructure(self: "Self", value: "_2450.FESubstructure") -> None:
        wrapper_type = (
    ...
    def create_fe_substructure(self: "Self") -> "_2450.FESubstructure":
    ...
    def remove_fe_substructure(
        self: "Self", fe_substructure: "_2450.FESubstructure"
    ) -> "bool":
        """bool
