...
class _Cast_ResultSphereOptions:
    ...
    @property
    def result_surface_options(self: "CastSelf") -> "_2719.ResultSurfaceOptions":
        return self.__parent__._cast(_2719.ResultSurfaceOptions)
...
class ResultSphereOptions(_2719.ResultSurfaceOptions):
    """ResultSphereOptions
