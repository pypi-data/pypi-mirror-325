...
class SuperchargerRotorSet(_1893.NamedDatabaseItem):
    """SuperchargerRotorSet
    ...
    @property
    def supercharger_map_chart(self: "Self") -> "_1929.ThreeDChartDefinition":
    ...
    @property
    def y_variable_for_imported_data(self: "Self") -> "_2637.YVariableForImportedData":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.gears.supercharger_rotor_set._2637",
    ...
    def y_variable_for_imported_data(
        self: "Self", value: "_2637.YVariableForImportedData"
    ) -> None:
    ...
    @property
    def boost_pressure(self: "Self") -> "_2627.BoostPressureInputOptions":
    ...
    @property
    def file(self: "Self") -> "_2630.RotorSetDataInputFileOptions":
    ...
    @property
    def input_power(self: "Self") -> "_2628.InputPowerInputOptions":
    ...
    @property
    def pressure_ratio(self: "Self") -> "_2629.PressureRatioInputOptions":
    ...
    @property
    def rotor_speed(self: "Self") -> "_2632.RotorSpeedInputOptions":
    ...
    @property
    def measured_points(self: "Self") -> "List[_2631.RotorSetMeasuredPoint]":
