...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2716, _2717
...
class _Cast_ResultSurfaceOptions:
    ...
    @property
    def result_plane_options(self: "CastSelf") -> "_2716.ResultPlaneOptions":
        from mastapy._private.system_model.part_model.acoustics import _2716

        return self.__parent__._cast(_2716.ResultPlaneOptions)

    @property
    def result_sphere_options(self: "CastSelf") -> "_2717.ResultSphereOptions":
        from mastapy._private.system_model.part_model.acoustics import _2717

        return self.__parent__._cast(_2717.ResultSphereOptions)
...
class ResultSurfaceOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def reference_component(self: "Self", value: "_2511.Component") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def reference_component_type(self: "Self", value: "_2270.DesignEntityId") -> None:
