...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2287
...
T = TypeVar("T", bound="_2511.Component")
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def axial_offset(self: "Self") -> "_2287.RelativeOffsetOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2287", "RelativeOffsetOption"
        )(value)

    @axial_offset.setter
    @enforce_parameter_types
    def axial_offset(self: "Self", value: "_2287.RelativeOffsetOption") -> None:
        value = conversion.mp_to_pn_enum(
