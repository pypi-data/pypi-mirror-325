...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe.links import _2485, _2492
...
class GearMeshFELink(_2490.MultiAngleConnectionFELink):
    """GearMeshFELink
    ...
    def reference_fe_substructure_node_for_misalignments(
        self: "Self", value: "_2452.FESubstructureNode"
    ) -> None:
