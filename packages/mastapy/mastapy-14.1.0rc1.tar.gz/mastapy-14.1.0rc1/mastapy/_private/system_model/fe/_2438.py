...
class _Cast_DegreeOfFreedomBoundaryConditionAngular:
    ...
    def degree_of_freedom_boundary_condition(
        self: "CastSelf",
    ) -> "_2437.DegreeOfFreedomBoundaryCondition":
        return self.__parent__._cast(_2437.DegreeOfFreedomBoundaryCondition)
...
class DegreeOfFreedomBoundaryConditionAngular(_2437.DegreeOfFreedomBoundaryCondition):
    """DegreeOfFreedomBoundaryConditionAngular
