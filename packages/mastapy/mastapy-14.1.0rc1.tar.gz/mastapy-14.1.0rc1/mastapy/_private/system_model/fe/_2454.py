...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2452, _2453
...
class FESubstructureNodeModeShapes(_0.APIBase):
    ...
    @property
    def condensation_node(self: "Self") -> "_2452.FESubstructureNode":
    ...
    def mode_shapes_at_condensation_node(
        self: "Self",
    ) -> "List[_2453.FESubstructureNodeModeShape]":
