...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2438, _2439
...
class _Cast_DegreeOfFreedomBoundaryCondition:
    ...
    def degree_of_freedom_boundary_condition_angular(
        self: "CastSelf",
    ) -> "_2438.DegreeOfFreedomBoundaryConditionAngular":
        from mastapy._private.system_model.fe import _2438

        return self.__parent__._cast(_2438.DegreeOfFreedomBoundaryConditionAngular)

    @property
    def degree_of_freedom_boundary_condition_linear(
        self: "CastSelf",
    ) -> "_2439.DegreeOfFreedomBoundaryConditionLinear":
        from mastapy._private.system_model.fe import _2439

        return self.__parent__._cast(_2439.DegreeOfFreedomBoundaryConditionLinear)
