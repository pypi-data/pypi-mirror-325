...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2473
...
class RaceBearingFEWithSelection(_2426.BaseFEWithSelection):
    """RaceBearingFEWithSelection
    ...
    @property
    def race_bearing(self: "Self") -> "_2473.RaceBearingFE":
