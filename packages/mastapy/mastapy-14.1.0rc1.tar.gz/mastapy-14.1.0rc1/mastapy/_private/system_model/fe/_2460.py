...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2426, _2454
...
class FESubstructureWithSelectionForModalAnalysis(_2457.FESubstructureWithSelection):
    """FESubstructureWithSelectionForModalAnalysis
    ...
    def full_fe_mode_shapes_at_condensation_nodes(
        self: "Self",
    ) -> "List[_2454.FESubstructureNodeModeShapes]":
