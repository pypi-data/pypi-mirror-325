...
from mastapy._private.utility.enums import _1886, _1887
...
class _Cast_PartAnalysisCaseWithContourViewable:
    ...
    def abstract_system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2309.AbstractSystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2309

        return self.__parent__._cast(_2309.AbstractSystemDeflectionViewable)

    @property
    def advanced_system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2310.AdvancedSystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2310

        return self.__parent__._cast(_2310.AdvancedSystemDeflectionViewable)

    @property
    def dynamic_analysis_viewable(self: "CastSelf") -> "_2314.DynamicAnalysisViewable":
        from mastapy._private.system_model.drawing import _2314

        return self.__parent__._cast(_2314.DynamicAnalysisViewable)

    @property
    def harmonic_analysis_viewable(
        self: "CastSelf",
    ) -> "_2315.HarmonicAnalysisViewable":
        from mastapy._private.system_model.drawing import _2315

        return self.__parent__._cast(_2315.HarmonicAnalysisViewable)

    @property
    def modal_analysis_viewable(self: "CastSelf") -> "_2317.ModalAnalysisViewable":
        from mastapy._private.system_model.drawing import _2317

        return self.__parent__._cast(_2317.ModalAnalysisViewable)

    @property
    def system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2326.SystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2326

        return self.__parent__._cast(_2326.SystemDeflectionViewable)
...
class PartAnalysisCaseWithContourViewable(_0.APIBase):
    ...
    def contour(
        self: "Self", value: "_1886.ThreeDViewContourOptionFirstSelection"
    ) -> None:
    ...
    @enforce_parameter_types
    def contour_secondary(
        self: "Self", value: "_1887.ThreeDViewContourOptionSecondSelection"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def contour_draw_style(self: "Self") -> "_2312.ContourDrawStyle":
