...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing import _2313, _2323, _2324
...
class _Cast_RotorDynamicsViewable:
    ...
    def critical_speed_analysis_viewable(
        self: "CastSelf",
    ) -> "_2313.CriticalSpeedAnalysisViewable":
        from mastapy._private.system_model.drawing import _2313

        return self.__parent__._cast(_2313.CriticalSpeedAnalysisViewable)

    @property
    def stability_analysis_viewable(
        self: "CastSelf",
    ) -> "_2323.StabilityAnalysisViewable":
        from mastapy._private.system_model.drawing import _2323

        return self.__parent__._cast(_2323.StabilityAnalysisViewable)

    @property
    def steady_state_synchronous_response_viewable(
        self: "CastSelf",
    ) -> "_2324.SteadyStateSynchronousResponseViewable":
        from mastapy._private.system_model.drawing import _2324

        return self.__parent__._cast(_2324.SteadyStateSynchronousResponseViewable)
...
class RotorDynamicsViewable(_0.APIBase):
    ...
    @property
    def rotor_dynamics(self: "Self") -> "_4121.RotorDynamicsDrawStyle":
