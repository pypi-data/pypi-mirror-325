...
class ListWithSelectedItem_CylindricalGearSet(
    _2598.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGearSet]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2598.CylindricalGearSet.TYPE

    @property
    def selected_value(self: "Self") -> "_2598.CylindricalGearSet":
    ...
    @property
    def available_values(self: "Self") -> "List[_2598.CylindricalGearSet]":
