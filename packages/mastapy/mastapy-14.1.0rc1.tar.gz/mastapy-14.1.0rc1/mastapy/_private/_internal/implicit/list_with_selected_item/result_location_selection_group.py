...
class ListWithSelectedItem_ResultLocationSelectionGroup(
    _5976.ResultLocationSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5976.ResultLocationSelectionGroup.TYPE

    @property
    def selected_value(self: "Self") -> "_5976.ResultLocationSelectionGroup":
    ...
    @property
    def available_values(self: "Self") -> "List[_5976.ResultLocationSelectionGroup]":
