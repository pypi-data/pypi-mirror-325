...
class ListWithSelectedItem_FEPart(_2520.FEPart, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FEPart]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2520.FEPart.TYPE

    @property
    def selected_value(self: "Self") -> "_2520.FEPart":
    ...
    @property
    def available_values(self: "Self") -> "List[_2520.FEPart]":
