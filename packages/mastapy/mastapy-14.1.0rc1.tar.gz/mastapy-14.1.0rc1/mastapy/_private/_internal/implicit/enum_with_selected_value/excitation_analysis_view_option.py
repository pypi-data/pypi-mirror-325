...
class EnumWithSelectedValue_ExcitationAnalysisViewOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ExcitationAnalysisViewOption]",
    ) -> "_2328.ExcitationAnalysisViewOption":
        ...
        Returns:
            _2328.ExcitationAnalysisViewOption
        """
        return _2328.ExcitationAnalysisViewOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2328.ExcitationAnalysisViewOption.type_()

    @property
    def selected_value(self: "Self") -> "_2328.ExcitationAnalysisViewOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2328.ExcitationAnalysisViewOption]":
