...
class EnumWithSelectedValue_TorqueRippleInputType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7667.TorqueRippleInputType
        """
        return _7667.TorqueRippleInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7667.TorqueRippleInputType.type_()

    @property
    def selected_value(self: "Self") -> "_7667.TorqueRippleInputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7667.TorqueRippleInputType]":
