...
class EnumWithSelectedValue_FluidFilmTemperatureOptions(
    ...
    def wrapped_type(
        ...
        Returns:
            _1948.FluidFilmTemperatureOptions
        """
        return _1948.FluidFilmTemperatureOptions
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1948.FluidFilmTemperatureOptions.type_()

    @property
    def selected_value(self: "Self") -> "_1948.FluidFilmTemperatureOptions":
    ...
    @property
    def available_values(self: "Self") -> "List[_1948.FluidFilmTemperatureOptions]":
