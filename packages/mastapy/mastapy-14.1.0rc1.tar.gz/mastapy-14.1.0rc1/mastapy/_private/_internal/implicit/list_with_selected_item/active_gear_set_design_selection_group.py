...
class ListWithSelectedItem_ActiveGearSetDesignSelectionGroup(
    _2584.ActiveGearSetDesignSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2584.ActiveGearSetDesignSelectionGroup.TYPE

    @property
    def selected_value(self: "Self") -> "_2584.ActiveGearSetDesignSelectionGroup":
