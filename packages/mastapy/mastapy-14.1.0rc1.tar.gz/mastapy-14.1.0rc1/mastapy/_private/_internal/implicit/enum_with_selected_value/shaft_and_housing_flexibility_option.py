...
class EnumWithSelectedValue_ShaftAndHousingFlexibilityOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ShaftAndHousingFlexibilityOption]",
    ) -> "_5602.ShaftAndHousingFlexibilityOption":
        ...
        Returns:
            _5602.ShaftAndHousingFlexibilityOption
        """
        return _5602.ShaftAndHousingFlexibilityOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5602.ShaftAndHousingFlexibilityOption.type_()

    @property
    def selected_value(self: "Self") -> "_5602.ShaftAndHousingFlexibilityOption":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5602.ShaftAndHousingFlexibilityOption]":
