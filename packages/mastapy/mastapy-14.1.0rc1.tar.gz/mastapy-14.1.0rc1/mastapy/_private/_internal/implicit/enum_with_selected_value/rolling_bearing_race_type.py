...
class EnumWithSelectedValue_RollingBearingRaceType(
    ...
    def wrapped_type(
        ...
        Returns:
            _1959.RollingBearingRaceType
        """
        return _1959.RollingBearingRaceType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1959.RollingBearingRaceType.type_()

    @property
    def selected_value(self: "Self") -> "_1959.RollingBearingRaceType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1959.RollingBearingRaceType]":
