...
class EnumWithSelectedValue_BearingToleranceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1967.BearingToleranceClass
        """
        return _1967.BearingToleranceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1967.BearingToleranceClass.type_()

    @property
    def selected_value(self: "Self") -> "_1967.BearingToleranceClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1967.BearingToleranceClass]":
