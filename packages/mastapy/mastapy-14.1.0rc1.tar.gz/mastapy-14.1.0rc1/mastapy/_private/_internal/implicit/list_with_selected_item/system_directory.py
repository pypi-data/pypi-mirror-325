...
class ListWithSelectedItem_SystemDirectory(
    _1661.SystemDirectory, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_SystemDirectory]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1661.SystemDirectory.TYPE

    @property
    def selected_value(self: "Self") -> "_1661.SystemDirectory":
    ...
    @property
    def available_values(self: "Self") -> "List[_1661.SystemDirectory]":
