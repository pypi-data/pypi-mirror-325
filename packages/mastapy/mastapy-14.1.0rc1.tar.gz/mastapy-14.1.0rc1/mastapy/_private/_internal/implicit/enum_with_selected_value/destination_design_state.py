...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    def wrapped_type(
        ...
        Returns:
            _7682.DestinationDesignState
        """
        return _7682.DestinationDesignState
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7682.DestinationDesignState.type_()

    @property
    def selected_value(self: "Self") -> "_7682.DestinationDesignState":
    ...
    @property
    def available_values(self: "Self") -> "List[_7682.DestinationDesignState]":
