...
class EnumWithSelectedValue_ThreeDViewContourOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _1885.ThreeDViewContourOption
        """
        return _1885.ThreeDViewContourOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1885.ThreeDViewContourOption.type_()

    @property
    def selected_value(self: "Self") -> "_1885.ThreeDViewContourOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1885.ThreeDViewContourOption]":
