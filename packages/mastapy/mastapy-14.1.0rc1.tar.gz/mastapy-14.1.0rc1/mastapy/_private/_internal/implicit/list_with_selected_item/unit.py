...
class ListWithSelectedItem_Unit(_1671.Unit, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_Unit]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1671.Unit.TYPE

    @property
    def selected_value(self: "Self") -> "_1671.Unit":
    ...
    @property
    def available_values(self: "Self") -> "List[_1671.Unit]":
