...
class EnumWithSelectedValue_DampingSpecification(
    ...
    def wrapped_type(
        ...
        Returns:
            _5853.DampingSpecification
        """
        return _5853.DampingSpecification
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DampingSpecification]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5853.DampingSpecification.type_()

    @property
    def selected_value(self: "Self") -> "_5853.DampingSpecification":
    ...
    @property
    def available_values(self: "Self") -> "List[_5853.DampingSpecification]":
