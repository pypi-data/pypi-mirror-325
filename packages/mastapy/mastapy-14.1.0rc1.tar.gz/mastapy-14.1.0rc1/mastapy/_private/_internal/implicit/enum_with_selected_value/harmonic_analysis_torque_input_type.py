...
class EnumWithSelectedValue_HarmonicAnalysisTorqueInputType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HarmonicAnalysisTorqueInputType]",
    ) -> "_5892.HarmonicAnalysisTorqueInputType":
        ...
        Returns:
            _5892.HarmonicAnalysisTorqueInputType
        """
        return _5892.HarmonicAnalysisTorqueInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5892.HarmonicAnalysisTorqueInputType.type_()

    @property
    def selected_value(self: "Self") -> "_5892.HarmonicAnalysisTorqueInputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_5892.HarmonicAnalysisTorqueInputType]":
