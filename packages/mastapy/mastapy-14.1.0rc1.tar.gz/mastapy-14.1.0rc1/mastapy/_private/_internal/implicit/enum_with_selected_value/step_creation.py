...
class EnumWithSelectedValue_StiffnessOptionsForHarmonicAnalysis_StepCreation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_StiffnessOptionsForHarmonicAnalysis_StepCreation]",
    ) -> "_5943.StiffnessOptionsForHarmonicAnalysis.StepCreation":
        ...
        Returns:
            _5943.StiffnessOptionsForHarmonicAnalysis.StepCreation
        """
        return _5943.StiffnessOptionsForHarmonicAnalysis.StepCreation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5943.StiffnessOptionsForHarmonicAnalysis.StepCreation.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5943.StiffnessOptionsForHarmonicAnalysis.StepCreation]":
