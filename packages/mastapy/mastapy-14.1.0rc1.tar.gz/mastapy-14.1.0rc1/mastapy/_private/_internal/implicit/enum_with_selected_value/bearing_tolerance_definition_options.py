...
class EnumWithSelectedValue_BearingToleranceDefinitionOptions(
    ...
    def wrapped_type(
        ...
        Returns:
            _1968.BearingToleranceDefinitionOptions
        """
        return _1968.BearingToleranceDefinitionOptions
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1968.BearingToleranceDefinitionOptions.type_()

    @property
    def selected_value(self: "Self") -> "_1968.BearingToleranceDefinitionOptions":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1968.BearingToleranceDefinitionOptions]":
