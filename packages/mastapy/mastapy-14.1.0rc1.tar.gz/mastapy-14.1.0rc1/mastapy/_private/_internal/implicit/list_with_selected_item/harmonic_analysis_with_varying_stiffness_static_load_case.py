...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5893
...
class ListWithSelectedItem_HarmonicAnalysisWithVaryingStiffnessStaticLoadCase(
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5893.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase.TYPE
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5893.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase]":
