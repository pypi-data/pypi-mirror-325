...
class EnumWithSelectedValue_StatusItemSeverity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1857.StatusItemSeverity
        """
        return _1857.StatusItemSeverity
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_StatusItemSeverity]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1857.StatusItemSeverity.type_()

    @property
    def selected_value(self: "Self") -> "_1857.StatusItemSeverity":
    ...
    @property
    def available_values(self: "Self") -> "List[_1857.StatusItemSeverity]":
