...
class ListWithSelectedItem_MeasurementBase(
    _1666.MeasurementBase, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_MeasurementBase]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1666.MeasurementBase.TYPE

    @property
    def selected_value(self: "Self") -> "_1666.MeasurementBase":
    ...
    @property
    def available_values(self: "Self") -> "List[_1666.MeasurementBase]":
