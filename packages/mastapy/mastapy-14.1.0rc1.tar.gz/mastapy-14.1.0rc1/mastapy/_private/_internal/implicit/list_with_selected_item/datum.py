...
class ListWithSelectedItem_Datum(_2515.Datum, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_Datum]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2515.Datum.TYPE

    @property
    def selected_value(self: "Self") -> "_2515.Datum":
    ...
    @property
    def available_values(self: "Self") -> "List[_2515.Datum]":
