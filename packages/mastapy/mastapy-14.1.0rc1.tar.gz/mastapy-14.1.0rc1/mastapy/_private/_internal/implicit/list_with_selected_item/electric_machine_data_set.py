...
class ListWithSelectedItem_ElectricMachineDataSet(
    _2440.ElectricMachineDataSet, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2440.ElectricMachineDataSet.TYPE

    @property
    def selected_value(self: "Self") -> "_2440.ElectricMachineDataSet":
    ...
    @property
    def available_values(self: "Self") -> "List[_2440.ElectricMachineDataSet]":
