...
class ListWithSelectedItem_GearMeshSystemDeflection(
    _2834.GearMeshSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2834.GearMeshSystemDeflection.TYPE

    @property
    def selected_value(self: "Self") -> "_2834.GearMeshSystemDeflection":
    ...
    @property
    def available_values(self: "Self") -> "List[_2834.GearMeshSystemDeflection]":
