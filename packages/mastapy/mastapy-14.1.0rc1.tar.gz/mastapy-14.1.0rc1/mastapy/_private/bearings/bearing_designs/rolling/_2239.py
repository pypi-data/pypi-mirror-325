...
class ThrustBallBearing(_2205.BallBearing):
    """ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self: "Self") -> "_1953.OuterRingMounting":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1953", "OuterRingMounting"
        )(value)

    @outer_ring_mounting.setter
    @enforce_parameter_types
    def outer_ring_mounting(self: "Self", value: "_1953.OuterRingMounting") -> None:
