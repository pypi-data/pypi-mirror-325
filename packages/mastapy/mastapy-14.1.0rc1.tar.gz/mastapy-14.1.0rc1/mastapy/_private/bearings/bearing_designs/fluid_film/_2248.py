...
class _Cast_AxialGrooveJournalBearing:
    ...
    @property
    def axial_feed_journal_bearing(self: "CastSelf") -> "_2247.AxialFeedJournalBearing":
        return self.__parent__._cast(_2247.AxialFeedJournalBearing)
...
class AxialGrooveJournalBearing(_2247.AxialFeedJournalBearing):
    """AxialGrooveJournalBearing
