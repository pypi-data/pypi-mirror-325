...
class TaperRollerBearing(_2226.NonBarrelRollerBearing):
    """TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self: "Self") -> "_1940.BearingMeasurementType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1940", "BearingMeasurementType"
        )(value)

    @bearing_measurement_type.setter
    @enforce_parameter_types
    def bearing_measurement_type(
        self: "Self", value: "_1940.BearingMeasurementType"
    ) -> None:
