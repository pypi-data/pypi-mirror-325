...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling import _2225, _2227, _2230
...
class CylindricalRollerBearing(_2226.NonBarrelRollerBearing):
    """CylindricalRollerBearing
    ...
    @enforce_parameter_types
    def permissible_axial_load_default_calculation_method(
        self: "Self", value: "_2007.CylindricalRollerMaxAxialLoadMethod"
    ) -> None:
