...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2260, _2261
...
class PadFluidFilmBearing(_2196.DetailedBearing):
    """PadFluidFilmBearing
    ...
    @enforce_parameter_types
    def rotational_direction(self: "Self", value: "_1961.RotationalDirections") -> None:
