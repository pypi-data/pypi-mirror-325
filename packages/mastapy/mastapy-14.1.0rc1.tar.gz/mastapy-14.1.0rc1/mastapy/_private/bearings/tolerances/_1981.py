...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.tolerances import _1965, _1970, _1976, _1982
...
class RingTolerance(_1973.InterferenceTolerance):
    """RingTolerance
    ...
    @property
    def roundness_specification(self: "Self") -> "_1982.RoundnessSpecification":
