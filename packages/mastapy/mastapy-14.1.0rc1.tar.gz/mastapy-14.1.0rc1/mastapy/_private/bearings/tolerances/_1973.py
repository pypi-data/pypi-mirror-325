...
class _Cast_InterferenceTolerance:
    ...
    def bearing_connection_component(
        self: "CastSelf",
    ) -> "_1965.BearingConnectionComponent":
        return self.__parent__._cast(_1965.BearingConnectionComponent)
...
class InterferenceTolerance(_1965.BearingConnectionComponent):
    """InterferenceTolerance
    ...
    @property
    def definition_option(self: "Self") -> "_1968.BearingToleranceDefinitionOptions":
    ...
    def mounting_point_surface_finish(
        self: "Self",
    ) -> "_1952.MountingPointSurfaceFinishes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1952", "MountingPointSurfaceFinishes"
        )(value)

    @mounting_point_surface_finish.setter
    @enforce_parameter_types
    def mounting_point_surface_finish(
        self: "Self", value: "_1952.MountingPointSurfaceFinishes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
