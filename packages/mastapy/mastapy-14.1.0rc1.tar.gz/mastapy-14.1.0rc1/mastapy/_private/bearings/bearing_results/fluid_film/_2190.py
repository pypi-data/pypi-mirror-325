...
class _Cast_LoadedPlainOilFedJournalBearingRow:
    ...
    def loaded_plain_journal_bearing_row(
        self: "CastSelf",
    ) -> "_2188.LoadedPlainJournalBearingRow":
        return self.__parent__._cast(_2188.LoadedPlainJournalBearingRow)
...
class LoadedPlainOilFedJournalBearingRow(_2188.LoadedPlainJournalBearingRow):
    """LoadedPlainOilFedJournalBearingRow
