...
class Frequencies(_2161.SKFCalculationResult):
    """Frequencies
    ...
    @property
    def frequency_of_over_rolling(self: "Self") -> "_2147.FrequencyOfOverRolling":
    ...
    @property
    def rotational_frequency(self: "Self") -> "_2159.RotationalFrequency":
