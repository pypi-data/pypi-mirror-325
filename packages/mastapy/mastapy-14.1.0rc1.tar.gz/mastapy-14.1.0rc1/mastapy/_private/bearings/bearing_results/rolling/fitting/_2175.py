...
class _Cast_InnerRingFittingThermalResults:
    ...
    def ring_fitting_thermal_results(
        self: "CastSelf",
    ) -> "_2178.RingFittingThermalResults":
        return self.__parent__._cast(_2178.RingFittingThermalResults)
...
class InnerRingFittingThermalResults(_2178.RingFittingThermalResults):
    """InnerRingFittingThermalResults
