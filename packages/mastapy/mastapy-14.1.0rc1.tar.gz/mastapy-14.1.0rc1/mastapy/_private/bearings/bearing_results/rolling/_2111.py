...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results import _2013, _2021, _2024
...
class LoadedTaperRollerBearingDutyCycle(_2088.LoadedNonBarrelRollerBearingDutyCycle):
    """LoadedTaperRollerBearingDutyCycle
