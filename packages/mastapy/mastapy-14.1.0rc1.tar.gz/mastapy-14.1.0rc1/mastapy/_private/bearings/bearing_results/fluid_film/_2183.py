...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.fluid_film import _2191, _2194
...
class _Cast_LoadedFluidFilmBearingPad:
    ...
    @property
    def loaded_tilting_journal_pad(self: "CastSelf") -> "_2191.LoadedTiltingJournalPad":
        from mastapy._private.bearings.bearing_results.fluid_film import _2191

        return self.__parent__._cast(_2191.LoadedTiltingJournalPad)

    @property
    def loaded_tilting_thrust_pad(self: "CastSelf") -> "_2194.LoadedTiltingThrustPad":
        from mastapy._private.bearings.bearing_results.fluid_film import _2194

        return self.__parent__._cast(_2194.LoadedTiltingThrustPad)
