...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2077, _2099
...
class LoadedDeepGrooveBallBearingRow(_2068.LoadedBallBearingRow):
    """LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2077.LoadedDeepGrooveBallBearingResults":
