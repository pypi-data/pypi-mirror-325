...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.vectors import _1898, _1899
...
class LoadedBallBearingElement(_2079.LoadedElement):
    """LoadedBallBearingElement
    ...
    @property
    def contact_patch_sliding_speed_inner(self: "Self") -> "_1899.PlaneScalarFieldData":
        """mastapy.utility.vectors.PlaneScalarFieldData
    ...
    @property
    def contact_patch_sliding_speed_outer(self: "Self") -> "_1899.PlaneScalarFieldData":
        """mastapy.utility.vectors.PlaneScalarFieldData
    ...
    def inner_race_contact_geometries(
        self: "Self",
    ) -> "List[_2033.BallBearingRaceContactGeometry]":
