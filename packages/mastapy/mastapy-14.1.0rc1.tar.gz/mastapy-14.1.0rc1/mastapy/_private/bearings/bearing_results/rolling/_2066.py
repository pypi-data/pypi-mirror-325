...
class _Cast_LoadedBallBearingRaceResults:
    ...
    def loaded_rolling_bearing_race_results(
        self: "CastSelf",
    ) -> "_2097.LoadedRollingBearingRaceResults":
        return self.__parent__._cast(_2097.LoadedRollingBearingRaceResults)

    @property
    def loaded_four_point_contact_ball_bearing_race_results(
        self: "CastSelf",
    ) -> "_2081.LoadedFourPointContactBallBearingRaceResults":
        from mastapy._private.bearings.bearing_results.rolling import _2081

        return self.__parent__._cast(_2081.LoadedFourPointContactBallBearingRaceResults)
...
class LoadedBallBearingRaceResults(_2097.LoadedRollingBearingRaceResults):
    """LoadedBallBearingRaceResults
