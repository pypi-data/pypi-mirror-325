...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2048, _2052, _2099
...
class LoadedAngularContactBallBearingRow(_2068.LoadedBallBearingRow):
    """LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2048.LoadedAngularContactBallBearingResults":
