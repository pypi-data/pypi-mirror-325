...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2066, _2081
...
class _Cast_LoadedRollingBearingRaceResults:
    ...
    def loaded_ball_bearing_race_results(
        self: "CastSelf",
    ) -> "_2066.LoadedBallBearingRaceResults":
        from mastapy._private.bearings.bearing_results.rolling import _2066

        return self.__parent__._cast(_2066.LoadedBallBearingRaceResults)
