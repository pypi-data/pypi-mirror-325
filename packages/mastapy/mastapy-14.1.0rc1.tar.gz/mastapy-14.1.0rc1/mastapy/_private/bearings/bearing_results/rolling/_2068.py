...
class LoadedBallBearingRow(_2099.LoadedRollingBearingRow):
    """LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2067.LoadedBallBearingResults":
    ...
    @property
    def race_results(self: "Self") -> "List[_2066.LoadedBallBearingRaceResults]":
