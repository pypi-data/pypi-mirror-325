...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2037, _2098
...
class LoadedFourPointContactBallBearingResults(_2067.LoadedBallBearingResults):
    """LoadedFourPointContactBallBearingResults
    ...
    @property
    def raceway_control(self: "Self") -> "_2037.FrictionModelForGyroscopicMoment":
