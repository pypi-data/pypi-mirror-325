...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2079, _2103, _2110
...
class LoadedSphericalRollerBearingElement(_2093.LoadedRollerBearingElement):
    """LoadedSphericalRollerBearingElement
