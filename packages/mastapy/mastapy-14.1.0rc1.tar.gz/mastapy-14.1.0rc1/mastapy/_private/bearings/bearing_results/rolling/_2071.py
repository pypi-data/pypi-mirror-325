...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2070, _2099
...
class LoadedCrossedRollerBearingRow(_2095.LoadedRollerBearingRow):
    """LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2070.LoadedCrossedRollerBearingResults":
