...
class SKFModuleResults(_0.APIBase):
    ...
    @property
    def adjusted_speed(self: "Self") -> "_2141.AdjustedSpeed":
    ...
    @property
    def bearing_loads(self: "Self") -> "_2143.BearingLoads":
    ...
    @property
    def bearing_rating_life(self: "Self") -> "_2144.BearingRatingLife":
    ...
    @property
    def frequencies(self: "Self") -> "_2146.Frequencies":
    ...
    @property
    def friction(self: "Self") -> "_2148.Friction":
    ...
    @property
    def minimum_load(self: "Self") -> "_2156.MinimumLoad":
    ...
    @property
    def static_safety_factors(self: "Self") -> "_2164.StaticSafetyFactors":
    ...
    @property
    def viscosities(self: "Self") -> "_2165.Viscosities":
