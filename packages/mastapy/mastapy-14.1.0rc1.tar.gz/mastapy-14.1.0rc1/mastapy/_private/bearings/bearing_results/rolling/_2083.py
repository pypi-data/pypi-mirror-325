...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2081, _2082, _2099
...
class LoadedFourPointContactBallBearingRow(_2068.LoadedBallBearingRow):
    """LoadedFourPointContactBallBearingRow
    ...
    def race_results(
        self: "Self",
    ) -> "List[_2081.LoadedFourPointContactBallBearingRaceResults]":
