...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2043, _2045
...
class _Cast_ISOTR141792001Results:
    ...
    @property
    def isotr1417912001_results(self: "CastSelf") -> "_2043.ISOTR1417912001Results":
        from mastapy._private.bearings.bearing_results.rolling import _2043

        return self.__parent__._cast(_2043.ISOTR1417912001Results)

    @property
    def isotr1417922001_results(self: "CastSelf") -> "_2045.ISOTR1417922001Results":
        from mastapy._private.bearings.bearing_results.rolling import _2045

        return self.__parent__._cast(_2045.ISOTR1417922001Results)
