...
class _Cast_GreaseLifeAndRelubricationInterval:
    ...
    @property
    def skf_calculation_result(self: "CastSelf") -> "_2161.SKFCalculationResult":
        return self.__parent__._cast(_2161.SKFCalculationResult)
...
class GreaseLifeAndRelubricationInterval(_2161.SKFCalculationResult):
    """GreaseLifeAndRelubricationInterval
    ...
    @property
    def grease(self: "Self") -> "_2151.Grease":
    ...
    @property
    def grease_quantity(self: "Self") -> "_2153.GreaseQuantity":
    ...
    @property
    def initial_fill(self: "Self") -> "_2154.InitialFill":
