...
class ProfileSet(_0.APIBase):
    ...
    @property
    def active_profile_type(self: "Self") -> "_1955.RollerBearingProfileTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1955", "RollerBearingProfileTypes"
        )(value)

    @active_profile_type.setter
    @enforce_parameter_types
    def active_profile_type(
        self: "Self", value: "_1955.RollerBearingProfileTypes"
    ) -> None:
    ...
    @property
    def active_profile(self: "Self") -> "_2000.RollerBearingProfile":
