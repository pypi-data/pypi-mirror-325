...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.roller_bearing_profiles import _1991, _1993, _2004
...
class _Cast_RollerBearingUserSpecifiedProfile:
    ...
    @property
    def roller_bearing_profile(self: "CastSelf") -> "_2000.RollerBearingProfile":
        return self.__parent__._cast(_2000.RollerBearingProfile)
...
class RollerBearingUserSpecifiedProfile(_2000.RollerBearingProfile):
    """RollerBearingUserSpecifiedProfile
    ...
    @property
    def data_to_use(self: "Self") -> "_1991.ProfileDataToUse":
    ...
    def data_to_use(self: "Self", value: "_1991.ProfileDataToUse") -> None:
    ...
    @property
    def profile_to_fit(self: "Self") -> "_1993.ProfileToFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.roller_bearing_profiles._1993", "ProfileToFit"
        )(value)

    @profile_to_fit.setter
    @enforce_parameter_types
    def profile_to_fit(self: "Self", value: "_1993.ProfileToFit") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def points(self: "Self") -> "List[_2004.UserSpecifiedProfilePoint]":
