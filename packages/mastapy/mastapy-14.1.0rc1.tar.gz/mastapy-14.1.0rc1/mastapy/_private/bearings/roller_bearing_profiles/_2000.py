...
class _Cast_RollerBearingProfile:
    ...
    def roller_bearing_conical_profile(
        self: "CastSelf",
    ) -> "_1994.RollerBearingConicalProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1994

        return self.__parent__._cast(_1994.RollerBearingConicalProfile)

    @property
    def roller_bearing_crowned_profile(
        self: "CastSelf",
    ) -> "_1995.RollerBearingCrownedProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1995

        return self.__parent__._cast(_1995.RollerBearingCrownedProfile)

    @property
    def roller_bearing_din_lundberg_profile(
        self: "CastSelf",
    ) -> "_1996.RollerBearingDinLundbergProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1996

        return self.__parent__._cast(_1996.RollerBearingDinLundbergProfile)

    @property
    def roller_bearing_flat_profile(
        self: "CastSelf",
    ) -> "_1997.RollerBearingFlatProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1997

        return self.__parent__._cast(_1997.RollerBearingFlatProfile)

    @property
    def roller_bearing_johns_gohar_profile(
        self: "CastSelf",
    ) -> "_1998.RollerBearingJohnsGoharProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1998

        return self.__parent__._cast(_1998.RollerBearingJohnsGoharProfile)

    @property
    def roller_bearing_lundberg_profile(
        self: "CastSelf",
    ) -> "_1999.RollerBearingLundbergProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1999

        return self.__parent__._cast(_1999.RollerBearingLundbergProfile)

    @property
    def roller_bearing_tangential_crowned_profile(
        self: "CastSelf",
    ) -> "_2001.RollerBearingTangentialCrownedProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _2001

        return self.__parent__._cast(_2001.RollerBearingTangentialCrownedProfile)

    @property
    def roller_bearing_user_specified_profile(
        self: "CastSelf",
    ) -> "_2002.RollerBearingUserSpecifiedProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _2002

        return self.__parent__._cast(_2002.RollerBearingUserSpecifiedProfile)
