...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.property import _1902, _1903, _1904, _1905, _1906
...
class _Cast_DutyCyclePropertySummary:
    ...
    def duty_cycle_property_summary_force(
        self: "CastSelf",
    ) -> "_1902.DutyCyclePropertySummaryForce":
        from mastapy._private.utility.property import _1902

        return self.__parent__._cast(_1902.DutyCyclePropertySummaryForce)

    @property
    def duty_cycle_property_summary_percentage(
        self: "CastSelf",
    ) -> "_1903.DutyCyclePropertySummaryPercentage":
        from mastapy._private.utility.property import _1903

        return self.__parent__._cast(_1903.DutyCyclePropertySummaryPercentage)

    @property
    def duty_cycle_property_summary_small_angle(
        self: "CastSelf",
    ) -> "_1904.DutyCyclePropertySummarySmallAngle":
        from mastapy._private.utility.property import _1904

        return self.__parent__._cast(_1904.DutyCyclePropertySummarySmallAngle)

    @property
    def duty_cycle_property_summary_stress(
        self: "CastSelf",
    ) -> "_1905.DutyCyclePropertySummaryStress":
        from mastapy._private.utility.property import _1905

        return self.__parent__._cast(_1905.DutyCyclePropertySummaryStress)

    @property
    def duty_cycle_property_summary_very_short_length(
        self: "CastSelf",
    ) -> "_1906.DutyCyclePropertySummaryVeryShortLength":
        from mastapy._private.utility.property import _1906

        return self.__parent__._cast(_1906.DutyCyclePropertySummaryVeryShortLength)
