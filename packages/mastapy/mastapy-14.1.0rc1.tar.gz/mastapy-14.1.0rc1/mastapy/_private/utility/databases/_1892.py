...
from mastapy._private.utility.databases import _1894, _1895
...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.databases import _1888, _1893

    Self = TypeVar("Self", bound="NamedDatabase")
    CastSelf = TypeVar("CastSelf", bound="NamedDatabase._Cast_NamedDatabase")

TValue = TypeVar("TValue", bound="_1893.NamedDatabaseItem")
...
class _Cast_NamedDatabase:
    ...
    @property
    def sql_database(self: "CastSelf") -> "_1895.SQLDatabase":
        return self.__parent__._cast(_1895.SQLDatabase)
...
class NamedDatabase(_1895.SQLDatabase[_1894.NamedKey, TValue]):
    """NamedDatabase
    ...
    @enforce_parameter_types
    def duplicate(
        self: "Self", new_name: "str", item: "_1893.NamedDatabaseItem"
    ) -> "_1893.NamedDatabaseItem":
    ...
    @enforce_parameter_types
    def rename(
        self: "Self", item: "_1893.NamedDatabaseItem", new_name: "str"
    ) -> "bool":
        """bool
