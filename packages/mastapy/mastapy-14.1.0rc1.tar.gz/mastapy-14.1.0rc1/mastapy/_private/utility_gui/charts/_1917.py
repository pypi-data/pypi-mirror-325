...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility_gui.charts import _1922, _1928
...
class _Cast_ConstantLine:
    ...
    @property
    def mode_constant_line(self: "CastSelf") -> "_1922.ModeConstantLine":
        from mastapy._private.utility_gui.charts import _1922

        return self.__parent__._cast(_1922.ModeConstantLine)
...
class ConstantLine(_0.APIBase):
    ...
    @property
    def axis(self: "Self") -> "_1928.SMTAxis":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility_gui.charts._1928", "SMTAxis"
        )(value)
