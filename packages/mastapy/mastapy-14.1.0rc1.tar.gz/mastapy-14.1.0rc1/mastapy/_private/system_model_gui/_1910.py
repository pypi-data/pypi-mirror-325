...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2266, _2269
...
class MASTAGUI(_0.APIBase):
    ...
    @property
    def active_design(self: "Self") -> "_2266.Design":
    ...
    @enforce_parameter_types
    def active_design(self: "Self", value: "_2266.Design") -> None:
    ...
    @property
    def open_designs(self: "Self") -> "List[_2266.Design]":
    ...
    @property
    def selected_design_entity(self: "Self") -> "_2269.DesignEntity":
    ...
    @enforce_parameter_types
    def selected_design_entity(self: "Self", value: "_2269.DesignEntity") -> None:
    ...
    @enforce_parameter_types
    def open_design_in_new_tab(self: "Self", design: "_2266.Design") -> None:
        """Method does not return.
