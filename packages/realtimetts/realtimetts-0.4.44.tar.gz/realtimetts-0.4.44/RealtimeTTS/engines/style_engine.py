...
class StyleTTSEngine(BaseEngine):
    def __init__(self, 
        ...
        Args:
            ...
            weights_only (bool): Whether to load only the weights of the model checkpoint.
    ...
    def load_model(self):
        ...
        params_whole = torch.load(self.model_checkpoint_path, map_location='cpu', weights_only=self.weights_only)
