...
class DataTypeDefinition:
    ...
    def __init__(self, data_type_name: str, data_type_id: int, display_name: str,
                 plural_display_name: str, description: Optional[str] = None,
...
class DataTypeParser:
    ...
    def parse_data_type_hierarchy(json_dct: Dict[str, Any]) -> DataTypeHierarchy:
        ...
        is_under_many: bool = json_dct.get('isUnderMany')
        is_single_child: bool = json_dct.get('isSingleChild')
