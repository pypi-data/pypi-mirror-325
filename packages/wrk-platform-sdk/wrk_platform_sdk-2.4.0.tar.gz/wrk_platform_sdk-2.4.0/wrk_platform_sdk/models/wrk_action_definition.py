...
from wrk_platform_sdk.models.wrk_action_qualified_id import WrkActionQualifiedId
from typing import Optional, Set
from typing_extensions import Self

class WrkActionDefinition(BaseModel):
    """
    Represents a Wrk Action configured with input values and references.
    """ # noqa: E501
    wrk_action_ref: WrkActionQualifiedId = Field(alias="wrkActionRef")
    input_values: Dict[str, Any] = Field(description="A dictionary of input values passed into the Wrk Action.", alias="inputValues")
    __properties: ClassVar[List[str]] = ["wrkActionRef", "inputValues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "wrkActionRef": WrkActionQualifiedId.from_dict(obj["wrkActionRef"]) if obj.get("wrkActionRef") is not None else None,
