...
class WrkflowDefinition(BaseModel):
    """
    Object for defining a new Wrkflow
    """ # noqa: E501
    ...
    input_schema: Dict[str, Any] = Field(description="A JSON object with properties containing the launch parameters required to launch the Wrkflow. The property required contains the minimum required properties to launch the Wrkflow.", alias="inputSchema")
    entry_action_index: Union[StrictFloat, StrictInt] = Field(description="The index of the first action in the Wrkflow", alias="entryActionIndex")
    actions: List[WrkActionDefinition] = Field(description="A list of Wrk Actions that make up the Wrkflow")
    links: List[WrkActionLink] = Field(description="A list of WrkActionLink objects describing how actions connect")
    __properties: ClassVar[List[str]] = ["uuid", "name", "inputSchema", "entryActionIndex", "actions", "links"]
