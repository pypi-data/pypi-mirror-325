...
class GetLaunchActivities200Response(BaseModel):
    """
    GetLaunchActivities200Response
    """ # noqa: E501
    launch_id: StrictStr
    activities: List[LaunchActivity]
    page_token: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetLaunchActivities200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetLaunchActivities200Response from a dict"""
        if obj is None:
            return None
