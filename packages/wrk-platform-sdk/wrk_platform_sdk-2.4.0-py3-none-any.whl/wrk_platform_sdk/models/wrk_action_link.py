...
from wrk_platform_sdk.models.outcome_qualified_id import OutcomeQualifiedId
...
class WrkActionLink(BaseModel):
    ...
    WrkActionLink
    """ # noqa: E501
    var_from: Union[StrictFloat, StrictInt] = Field(description="The index of the Wrk Action from which this link originates", alias="from")
    to: Union[StrictFloat, StrictInt] = Field(description="The index of the Wrk Action to which this link leads")
    outcome_ref: OutcomeQualifiedId = Field(alias="outcomeRef")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "from": obj.get("from"),
            "to": obj.get("to"),
            "outcomeRef": OutcomeQualifiedId.from_dict(obj["outcomeRef"]) if obj.get("outcomeRef") is not None else None
        })
        return _obj
