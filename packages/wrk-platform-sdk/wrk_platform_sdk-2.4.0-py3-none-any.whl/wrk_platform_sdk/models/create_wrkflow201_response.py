...
class CreateWrkflow201Response(BaseModel):
    """
    CreateWrkflow201Response
    """ # noqa: E501
    wrkflow_uuid: StrictStr = Field(description="the id of the wrkflow")
    __properties: ClassVar[List[str]] = ["wrkflow_uuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateWrkflow201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateWrkflow201Response from a dict"""
        if obj is None:
            return None
