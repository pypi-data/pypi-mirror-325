...
class ProteinFeatureClient:
    ...
    def __init__(self, genome_version, error_logfile=None):
        ...
        self.info_lines= conf_reader.protein_features_info_lines
        self.url_pattern = conf_reader.protein_features_src
        self.srv_prefix = conf_reader.protein_features_srv_prefix
        self.response_keys = conf_reader.protein_features_response_keys
        self.extract_keys = conf_reader.protein_features_keys
            ...
            for var in qid_list0:
                ...
                if "UTA_Adapter" in biomarker_data[var_orig]:
                    if "gene_name" in biomarker_data[var_orig]["UTA_Adapter"]:
                        ...
                        #qid_list.append(var)
                        qid_gene_name_dc[biomarker_data[var_orig]["UTA_Adapter"]["gene_name"] + ':' + biomarker_data[var_orig]["UTA_Adapter"][
                            "variant_exchange"]] = var_orig
                        qid_list.append(biomarker_data[var_orig]["UTA_Adapter"]["gene_name"] + ':' + biomarker_data[var_orig]["UTA_Adapter"]["variant_exchange"])
                    else:
                        pass
                    ...
                    #qid_list.append(var)
                    qid_gene_name_dc[
                        biomarker_data[var_orig]["UTA_Adapter_gene_name"] + ':' + biomarker_data[var_orig]["UTA_Adapter_variant_exchange"]] = var_orig
                    qid_list.append(
                        biomarker_data[var_orig]["UTA_Adapter_gene_name"] + ':' + biomarker_data[var_orig]["UTA_Adapter_variant_exchange"])
                    ...
                    #qid_list.append(var)
                    qid_gene_name_dc[
                        biomarker_data[var_orig]["hgnc_gene_symbol"] + ':' + biomarker_data[var_orig]["aa_exchange"]] = var_orig
                    qid_list.append(
                        biomarker_data[var_orig]["hgnc_gene_symbol"] + ':' + biomarker_data[var_orig]["aa_exchange"])
                ...
                #    pass
                    ...
                    if "UTA_Adapter_gene_name" in biomarker_data[var_orig]["info_features"]:
                        ...
                        #qid_list.append(var)
                        qid_gene_name_dc[
                            biomarker_data[var_orig]["info_features"]["UTA_Adapter_gene_name"] + ':' + biomarker_data[var_orig]["info_features"]["UTA_Adapter_variant_exchange"]] = var_orig
                        qid_list.append(
                            biomarker_data[var_orig]["info_features"]["UTA_Adapter_gene_name"] + ':' + biomarker_data[var_orig]["info_features"]["UTA_Adapter_variant_exchange"])
