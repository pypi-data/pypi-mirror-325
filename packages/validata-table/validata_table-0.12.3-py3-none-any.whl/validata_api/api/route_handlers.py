...
def get_args(request) -> Dict[str, str]:
    ...
    args["ignore_header_case"] = params.get("ignore_header_case")
    args["include_resource_data"] = params.get("include_resource_data")
...
def validate():
    ...
    if (
        args["include_resource_data"] is not None
        and args["include_resource_data"].lower() == "true"
    ):
        formatted_validation_report["resource_data"] = (
            validata_resource.to_inline_data()
        )
