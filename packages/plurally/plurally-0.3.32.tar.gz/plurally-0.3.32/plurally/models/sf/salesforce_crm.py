...
SALESFORCE_ICONS = {
    ...
    SalesforceObjectType.EVENT.value: "https://dev.tryplurally.com/public/salesforce/event.png",
    SalesforceObjectType.EVENT_RELATION.value: "https://dev.tryplurally.com/public/salesforce/event.png",
...
for s_object_type in list(SalesforceObjectType):
    def create_getter(s_object_type):
        def getter(self):
            return self.properties if SalesforceObjectType(self.s_object_type) == s_object_type else DEFAULT_PROPERTIES.get(s_object_type, "")
        return getter
