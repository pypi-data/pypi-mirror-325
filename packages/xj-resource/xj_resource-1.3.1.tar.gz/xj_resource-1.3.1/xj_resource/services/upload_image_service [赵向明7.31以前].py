...
class UploadImageService(object):
    ...
    folder_path = config.IMAGE_UPLOAD_DIR  # 存放路径，不含文件名
    ...
    def __init__(self, input_file):
        ...
        self.file_code = self.input_file.read()
    ...
    def validate(self):
        ...
        if not self.suffix in config.img_format_list:
    ...
    def write_disk(self):
        try:
            ...
            self.__set_error('write_disk' + str(e))
    ...
    def save_to_db(self, save_data):
        ...
        try:
            if not self.__is_valid:
                return False
            serializer = UploadImageSerializer(data=save_data, context={})
            if not serializer.is_valid():
                return [], serializer.errors
            image_instance = serializer.save()
            return image_instance
        except Exception as e:
            self.__set_error('save_to_db:' + str(e))
            return False
    ...
    def info_detail(self):
        try:
            ...
            self.__set_error("info_detail:" + str(e))
            return {}
