...
function GetOciCommandsToLongParams_jms() {
    $ociCommandsToLongParams = @{
        ...
        'jms jms-plugin list' = 'agent-id all availability-status compartment-id compartment-id-in-subtree fleet-id from-json help hostname-contains id lifecycle-state limit page page-size sort-by sort-order time-last-seen-less-than-or-equal-to time-registered-less-than-or-equal-to'
        ...
        'jms performance-tuning-analysis-result list' = 'all application-id fleet-id from-json help host-name limit managed-instance-id page page-size sort-by sort-order time-end time-start'
