...
@pytest.mark.parametrize(
    ...
    [
        param(
            ls.literal(1, type=dt.int8),
            id="int8",
        ),
        param(
            ls.literal(1, type=dt.int16),
            id="int16",
        ),
        param(
            ls.literal(1, type=dt.int32),
            id="int32",
        ),
        param(
            ls.literal(1, type=dt.int64),
            id="int64",
        ),
        param(
            ls.literal(1, type=dt.uint8),
            id="uint8",
        ),
        param(
            ls.literal(1, type=dt.uint16),
            id="uint16",
        ),
        param(
            ls.literal(1, type=dt.uint32),
            id="uint32",
        ),
        param(
            ls.literal(1, type=dt.uint64),
            id="uint64",
        ),
        param(
            ls.literal(1, type=dt.float32),
            id="float32",
        ),
        param(
            ls.literal(1, type=dt.float64),
            id="float64",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        param(
            ls.literal(decimal.Decimal("1.1"), type=dt.decimal),
            decimal.Decimal("1.1"),
            id="default",
        ),
        param(
            ls.literal(decimal.Decimal("1.1"), type=dt.Decimal(38, 9)),
            decimal.Decimal("1.1"),
            id="decimal-small",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        param(
            lambda t: ls.literal(1.3),
            lambda t: 1.3,
            id="float-literal",
        ),
        param(
            lambda t: ls.literal(np.nan),
            lambda t: np.nan,
            id="nan-literal",
        ),
        param(
            lambda t: ls.literal(np.inf),
            lambda t: np.inf,
            id="inf-literal",
        ),
        param(
