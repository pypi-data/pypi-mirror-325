...
class ConformanceUavStatus(genpy.Message):
  _md5sum = "02a1e5b210083d1d2b43e07f30622a9b"
...
"""
  ...
  __slots__ = ['uav_id','conformance_state','is_inside_MAS','position']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       uav_id,conformance_state,is_inside_MAS,position
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_QIB3d().pack(_x.uav_id, _x.conformance_state, _x.is_inside_MAS, _x.position.x, _x.position.y, _x.position.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.uav_id, _x.conformance_state, _x.is_inside_MAS, _x.position.x, _x.position.y, _x.position.z,) = _get_struct_QIB3d().unpack(str[start:end])
