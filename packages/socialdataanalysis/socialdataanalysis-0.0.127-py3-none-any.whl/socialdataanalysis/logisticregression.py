...
# Importação para formatação e exibição de tabelas
from tabulate import tabulate

# Importações para modelos estatísticos
...
# Importações para métricas de avaliação de modelos
from sklearn.metrics import confusion_matrix, roc_curve, roc_auc_score, auc

# Importações para visualização interativa
