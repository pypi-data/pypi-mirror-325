...
from dhisana.schemas.sales import ContentGenerationContext, MessageItem, MessageResponse
...
async def generate_inbound_email_response_copy(
    ...
    if cleaned_context.external_known_data and cleaned_context.external_known_data.external_openai_vector_store_id:
    ...
    response_item = MessageItem(
        ...
        subject="",  # or you can set some triage subject if needed
