...
from dhisana.schemas.sales import CampaingContext, ContentGenerationContext, ConversationContext, Lead, MessageGenerationInstructions, PromptEngineeringGuidance, SenderInfo
...
async def generate_personalized_email_copy(
    ...
    campaign_data = cleaned_context.campaing_context or CampaingContext()
    ...
    for i in range(number_of_variations):
        try:
            ...
            email_copy = await generate_personalized_email_copy(
                ...
                tool_config=tool_config,
                force_skip_refinement=user_instructions_exist
            )
