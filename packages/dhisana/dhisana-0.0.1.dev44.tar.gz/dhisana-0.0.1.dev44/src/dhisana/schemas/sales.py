...
class CampaingContext(BaseModel):
    """
...
class ConversationContext(BaseModel):
    ...
    """
    current_email_thread: Optional[str] = None
    current_linkedin_thread: Optional[str] = None
...
class ContentGenerationContext(BaseModel):
    ...
    Consolidates all relevant data needed for generating content:
      1) campaing_context: Details about the current campaign or marketing approach.
    ...
    """
    campaing_context: Optional[CampaingContext] = None
