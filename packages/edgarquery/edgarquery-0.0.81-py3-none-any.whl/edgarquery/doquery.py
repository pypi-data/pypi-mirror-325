...
class EDGARquery():
    ...
    def companyconcept(self, cik=None, frame='us-gaap', fact=None,
        ...
        if resp == None:
            print('companyconcept: no content', file=sys.stderr)
            return
    ...
    def companyfacts(self, cik=None, file=None, directory=None):
        ...
        resp = self.uq.query(url, self.hdr)
        if resp == None:
            print('companyfacts: no content', file=sys.stderr)
            return
        self.uq.storequery(resp, file)
        # resp = self.query(url)
        # self.storequery(resp, file)
    ...
    def xbrlframes(self, frame='us-gaap', fact=None,
        ...
        resp = self.uq.query(url, self.hdr)
        if resp == None:
            print('xbrlframes: no content', file=sys.stderr)
            return
        self.uq.storequery(resp, file)
        # resp = self.query(url)
        # self.storequery(resp, file)
    ...
    def companyfactsarchivezip(self, file=None, directory=None):
        ...
        if resp == None:
            print('companyfactsarchivezip: no content', file=sys.stderr)
            return
        self.uq.storequery(resp, file)
    ...
    def submissionszip(self, file=None, directory=None):
        ...
        if resp == None:
            print('submissionszip: no content', file=sys.stderr)
            return
        self.uq.storequery(resp, file)
    ...
    def financialstatementandnotesdataset(self, cy=None,
        ...
        resp = self.uq.query(url, self.hdr)
        if resp == None:
            print('financialstatementandnotesdataset: no content', file=sys.stderr)
            return
        self.uq.storequery(resp, file)
        # resp=self.query(url)
        # self.storequery(resp, file)
