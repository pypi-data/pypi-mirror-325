...
def mock_qubits_couplers():
    with patch("pennylane_calculquebec.API.adapter.ApiAdapter.get_qubits_and_couplers") as mock:
        yield mock
...
def test_get_readout_fidelities(mock_qubits_couplers):
    mock_qubits_couplers.return_value = qubits_couplers((0.9, 0.1), (0.8, 0.2), (0.7, 0.3), (0.6, 0.4))
...
def test_tensor_product_calibration(mock_qubits_couplers):
    ...
    expected = np.array([[0.378, 0.378, 0.378, 0.378, 0.378, 0.378, 0.378, 0.378],
