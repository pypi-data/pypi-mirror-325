...
class ExperimentManager:
    def __init__(self, experiment_id: str, num_workers: int):
        ...
        self.connected_workers: dict[str, ServiceState] = {}
    ...
    def state_tracking_thread(self):
        while self.running:
            ...
            if (
                ...
                raise ValueError(f"Accept more workers than expected")
            elif (
    ...
    def wait_for_end_of_workers(
        ...
        self.state_cond.wait_for(
            lambda: all(
                ...
                and self.connected_workers[worker_ids] >= ServiceState.DONE
                for worker_id, state in worker_ids
            ),
            timeout,
        )
        self.state_cond.release()
