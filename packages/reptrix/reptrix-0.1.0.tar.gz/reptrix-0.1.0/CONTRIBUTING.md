...
If you experience bugs or general issues with `reptrix`, please have a look
...
You can help improve `reptrix` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`reptrix` documentation uses [Sphinx] as its main documentation compiler.
...
```
conda create -n reptrix python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/reptrix.git
   cd reptrix
   ```
...
5. Install [pre-commit]:
   ...
   `reptrix` comes with a lot of hooks configured to automatically help the
