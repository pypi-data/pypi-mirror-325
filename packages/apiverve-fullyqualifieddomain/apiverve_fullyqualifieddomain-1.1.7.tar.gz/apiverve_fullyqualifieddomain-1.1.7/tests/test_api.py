...
class TestFullyqualifieddomainAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = FullyqualifieddomainAPIClient(self.api_key)

    @patch('apiverve_fullyqualifieddomain.apiClient.requests.get')
