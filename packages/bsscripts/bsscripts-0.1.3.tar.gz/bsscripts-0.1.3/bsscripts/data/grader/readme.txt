...
The API wrapper is included as a .whl file, which can be installed using pip, e.g. `python3 -m pip install file.whl`.
Any .whl file found in the data/dependencies/ folder should be installed, or updated if it contains a newer version.
...
- Install all these .whl dependencies.
