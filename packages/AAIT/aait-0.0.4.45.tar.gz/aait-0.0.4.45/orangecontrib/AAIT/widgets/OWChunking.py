...
class OWChunker(widget.OWWidget):
    ...
    # overlap: int = Setting(default=125)
    ...
    def __init__(self):
        ...
        self.edit_overlap = self.findChild(QLineEdit, 'overlap')
        ...
        self.autorun = True
        self.result=None
        self.chunk_size = int(self.edit_chunkSize.text()) if self.edit_chunkSize.text().isdigit() else 500
        self.overlap = int(self.edit_overlap.text()) if self.edit_overlap.text().isdigit() else 125
