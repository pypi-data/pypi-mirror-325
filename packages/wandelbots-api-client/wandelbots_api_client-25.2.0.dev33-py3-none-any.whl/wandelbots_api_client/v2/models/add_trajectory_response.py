...
class AddTrajectoryResponse(BaseModel):
    ...
    """ # noqa: E501
    trajectory: Optional[StrictStr] = Field(default=None, description="The unique identifier of the trajectory. Use this identifier to execute the trajectory with the [executeTrajectory](executeTrajectory) endpoint. If trajectory is not executable, this field is not present. ")
