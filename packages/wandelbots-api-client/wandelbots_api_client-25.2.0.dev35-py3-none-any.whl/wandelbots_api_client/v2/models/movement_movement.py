...
class MovementMovement(BaseModel):
    ...
    current_location: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Current location of motion group on the trajectory.")
    state: Optional[RobotControllerState] = Field(default=None, description="Current state of the robot controller and moving motion group.")
