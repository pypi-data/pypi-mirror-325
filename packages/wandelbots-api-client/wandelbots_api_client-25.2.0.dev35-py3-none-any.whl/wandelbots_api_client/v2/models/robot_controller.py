...
class RobotController(BaseModel):
    ...
    def name_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^(?!kube-system$|default$|wandelbots$)[a-z][a-z0-9-]{0,61}[a-z0-9]$", value):
            raise ValueError(r"must validate the regular expression /^(?!kube-system$|default$|wandelbots$)[a-z][a-z0-9-]{0,61}[a-z0-9]$/")
        return value
