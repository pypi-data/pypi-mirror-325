...
class ProgramOperatorApi:
    ...
    async def create_program_run(
        ...
        # EXPERIMENTAL > **Note:** This endpoint is experimental and might experience functional changes in the future. This endpoint initiates the execution of a program stored in the program library. A program is started with the a specific program id that exists in the program library. 
    ...
    async def create_trigger(
        ...
        # EXPERIMENTAL > **Note:** This endpoint is experimental and might experience functional changes in the future. Creates a new trigger that automatically runs a program when certain conditions are met. Each trigger has a different configuration, and the configuration must be valid for the provided trigger type. 
    ...
    async def delete_trigger(
        ...
        # EXPERIMENTAL > **Note:** This endpoint is experimental and might experience functional changes in the future. Delete an existing trigger. 
    ...
    async def get_all_program_runs(
        ...
        # EXPERIMENTAL > **Note:** This endpoint is experimental and might experience functional changes in the future. Retrieves all program runs, including past and current executions. Use the optional `state` parameter to filter the results by their status. 
    ...
    async def get_all_triggers(
        ...
        # EXPERIMENTAL > **Note:** This endpoint is experimental and might experience functional changes in the future. Returns all triggers in the system with the program runs caused by each trigger. You can use the program run id to get more details about a specific program run. 
    ...
    async def get_program_run(
        ...
        # EXPERIMENTAL > **Note:** This endpoint is experimental and might experience functional changes in the future. Retrieves detailed information about a specific program run. 
    ...
    async def get_trigger(
        ...
        # EXPERIMENTAL > **Note:** This endpoint is experimental and might experience functional changes in the future. Retrieves detailed information about a specific trigger. 
    ...
    async def update_trigger(
        ...
        # EXPERIMENTAL > **Note:** This endpoint is experimental and might experience functional changes in the future. Updates the details of an existing trigger The exact behavior of switching a trigger from active to inactive or vice versa is not defined yet. 
