...
class MotionGroupsList(BaseModel):
    """
    A list of motion groups.
    """ # noqa: E501
    motion_groups: List[MotionGroup]
    __properties: ClassVar[List[str]] = ["motion_groups"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MotionGroupsList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MotionGroupsList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "motion_groups": [
                ...
                MotionGroup.from_dict(_item) if hasattr(MotionGroup, 'from_dict') else _item
                # <<< End modification
