...
class IODescription(BaseModel):
    ...
    IODescription
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier defined by the controller. Identifiers are only defined uniquely per controller, e.g. Inputs/Outputs for two different robots on the same controller can have the same identifier. ")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "group", "direction", "value_type", "unit", "min", "max"]
