...
PBI.add_csv(dashboard_path, os.path.join(report_location, "PBI_dashboard_creator/examples/data/colony.csv" ))
PBI.add_csv(dashboard_path, os.path.join(report_location, "PBI_dashboard_creator/examples/data/wa_bigfoot_by_county.csv" ))
