...
class Field(BaseField):
    ...
    def validate(self, attr_name: str, value: Any, attr_type: type | UnionType = None) -> None:
        ...
        if value is not None and value is not Undefined and self.choices and value not in self.choices:
            raise FieldValueError(
...
class StrField(Field):
    ...
    Args:
        ...
        min_size (int, optional):
            The minimum allowed length for the string. Defaults to 0.
        max_size (int, optional):
            The maximum allowed length for the string. Defaults to the maximum integer value.
        regex (str, optional):
            The regular expression pattern to match against the string value. Defaults to None.
        readonly (bool, optional):
            Whether the field is read-only. Defaults to False.
        required (bool, optional):
            Whether the field is required. Defaults to False.
        required_lazy (bool, optional):
            Whether the field is lazily required. Defaults to False.
        empty_is_none (bool, optional):
            Whether an empty string should be treated as None. Defaults to False.
