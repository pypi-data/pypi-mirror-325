...
class SerializeDumpsTestCase(TestCase):
    ...
    @mock.patch('os.environ', {'EVERYSK_SIGNING_KEY': 'c90d39a0e065d56672393fc0102ac8e8680cc274744ce60fa269e6ab08d86673'})
    def test_protocol_pickle(self):
        self.assertEqual(
            dumps(1, protocol='pickle'),
            b'b7c7c1b332324630949b0c72c3aad8abc5bed9be:\x80\x04K\x01.'
        )
...
class SerializeLoadsTestCase(TestCase):
    ...
    def test_protocol_pickle(self):
        self.assertEqual(
            loads(b'b7c7c1b332324630949b0c72c3aad8abc5bed9be:\x80\x04K\x01.', protocol='pickle'),
            1
        )
    ...
    def test_protocol_pickle_invalid(self):
        with self.assertRaisesRegex(SigningError, 'Error trying to unsign data.'):
            loads(b'a7c7c1b332324630949b0c72c3aad8abc5bed9be:\x80\x04K\x01.', protocol='pickle')
