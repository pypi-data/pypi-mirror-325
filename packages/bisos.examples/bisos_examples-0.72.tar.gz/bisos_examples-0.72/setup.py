...
# ./pypiUploadVer EXISTED -- forPypiVersion=0.72 -- forSysVersion=0.7 -- constant=NA
def pkgVersion():
        return '0.72'
...
'bin/exmpl-conv-sameInstance.py',
'bin/exmpl-mu-many.cs',
]
####+END:
...
setuptools.setup(
    name='bisos.examples',  # 'bisos.examples'
    version=pkgVersion(),
