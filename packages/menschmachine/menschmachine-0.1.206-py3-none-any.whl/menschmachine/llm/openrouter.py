...
MODEL_REGISTRY.register("anthropic/claude-3-haiku:beta", ["haiku", "claude-haiku"], 0.25, 1.25)
MODEL_REGISTRY.register("anthropic/claude-3.5-sonnet:beta", ["sonnet", "claude-sonnet"], 3, 15)
MODEL_REGISTRY.register("anthropic/claude-3-opus:beta", ["opus", "claude-opus"], 15, 75)
MODEL_REGISTRY.register("openai/gpt-4o-2024-11-20", ["gpt4o", "gpt4", "gpt-4o"], 2.5, 10)
MODEL_REGISTRY.register("openai/o1-mini-2024-09-12", ["gpt4o-mini", "gpt4-mini"], 3, 12)
MODEL_REGISTRY.register("deepseek/deepseek-chat", ["deepseek-chat"], 0.14, 0.28)
MODEL_REGISTRY.register("deepseek/deepseek-r1", ["deepseek", "r1"], 0.55, 2.19)
MODEL_REGISTRY.register("google/gemini-pro-1.5", ["gemini-pro"], 1.25, 5)
MODEL_REGISTRY.register("google/gemini-flash-1.5", ["gemini-flash"], 0.075, 0.3)
MODEL_REGISTRY.register("openai/o1-preview-2024-09-12", ["o1", "gpt-o1", "o1-preview"], 15, 60)
MODEL_REGISTRY.register("anthropic/claude-3-5-haiku:beta",
                        ["haiku-3.5", "claude-haiku-3.5",
                         "haiku-35", "claude-haiku-35",
                         "haiku-3-5", "claude-haiku-3-5"], 1., 5.)
...
class OpenRouterApi(ApiInterface):
    ...
    def ask(self,
        ...
        completion_tokens, prompt_tokens = token_counts_from_response(response)
