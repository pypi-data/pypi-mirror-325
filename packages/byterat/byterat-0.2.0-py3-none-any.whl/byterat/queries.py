...
GET_FILTERED_OBSERVATION_DATA = {
  ...
  'query': """
    query($filters: [API_Filter!]!, $continuation_token: String) {
        get_filtered_observation_data(filters: $filters, continuation_token: $continuation_token) {
            data
            continuation_token
        }
    }
...
GET_FILTERED_DATASET_CYCLE_DATA = {
  ...
  'query': """
    query($filters: [API_Filter!]!, $continuation_token: String) {
        get_filtered_dataset_cycle_data(filters: $filters, continuation_token: $continuation_token) {
            data
            continuation_token
        }
    }
...
GET_FILTERED_METADATA = {
  ...
  'query': """
    query($filters: [API_Filter!]!, $continuation_token: String) {
        get_filtered_metadata(filters: $filters, continuation_token: $continuation_token) {
            data
            continuation_token
        }
    }
