...
class PromptUpdateSchema(BaseModel):
    ...
    prompt_text: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    settings: Optional[Dict[str, Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["description", "name", "prompt_text", "settings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PromptUpdateSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PromptUpdateSchema from a dict"""
        if obj is None:
            return None
