...
def config(command='show',type=_O):
	...
	except Exception as e:console.print(f"[red]Error showing configuration: {str(e)}[/]");sys.exit(1)
def create(config_path=_A):
	...
	except Exception as e:console.print(f"[red]Error creating packages: {str(e)}[/]");sys.exit(1)
def main():
	'Main entry point.'
