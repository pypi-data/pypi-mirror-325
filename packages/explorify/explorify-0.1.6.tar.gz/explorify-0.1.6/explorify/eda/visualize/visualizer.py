...
# Modified   : Tuesday February 4th 2025 04:36:04 am                                               #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
class SeabornCanvas(Canvas):
    ...
    palettes: Optional[Palettes] = field(default=None)

    def __post_init__(self) -> None:
        self.color = Colors().dark_blue
        self.palette = Palettes().blues_r
        self.colors = Colors()
...
class Visualizer(VisualizerABC):  # pragma: no cover
    ...
    def corrplot(self,*args, data: pd.DataFrame, title: str, figsize: tuple = (12, 10), ax: plt.Axes = None,**kwargs) -> plt.Axes:
        ...
        ax = sns.heatmap(corr, mask=mask, cmap=cmap, vmax=.3, center=0, ax=ax,
