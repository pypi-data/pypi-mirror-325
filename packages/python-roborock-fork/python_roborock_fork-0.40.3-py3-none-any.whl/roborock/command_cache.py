...
cache_map: Mapping[CacheableAttribute, RoborockAttribute] = {
    ...
    CacheableAttribute.water_box_mode: RoborockAttribute(
        attribute="water_box_mode",
        get_command=RoborockCommand.GET_WATER_BOX_CUSTOM_MODE,
        set_command=RoborockCommand.SET_WATER_BOX_CUSTOM_MODE,
    ),
}
