...
class FlatFileIntegration(ScannerIntegration):
    ...
    def __init__(self, plan_id: int, asset_identifier_field: str = "name", **kwargs: Any):
        """
...
class FlatFileImporter(ABC):
    ...
    def __init__(self, **kwargs: dict):
        ...
        flat_int = FlatFileIntegration(
            plan_id=self.attributes.parent_id, asset_identifier_field=self.asset_identifier_field
        )
