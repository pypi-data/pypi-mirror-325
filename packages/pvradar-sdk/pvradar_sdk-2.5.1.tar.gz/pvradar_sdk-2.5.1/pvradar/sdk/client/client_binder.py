...
class PvradarClientBinder(AbstractBinder):
    ...
    def bind(
        ...
        *,
        ...
        # objects such as PvradarProject have a location attribute
        #  but we want this binder to work also with any context, hence no import and simple check
        if name == 'location' and hasattr(context, 'location'):
            return getattr(context, 'location')
