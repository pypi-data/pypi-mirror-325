...
pvradar_resource_annotations: dict[PvradarResourceType, Any] = {
    ...
    'completeness': A[float, Field(ge=0, le=1), S(unit='1')],
    'coverage': A[float, Field(ge=0, le=1), S(unit='1')],
    'distance': A[float, Field(ge=0), S(unit='m')],
    ...
    'snow_depth': A[float, Field(ge=0), S(unit='mm')],
    'snowfall': A[pd.Series, Field(ge=0, description='The amount of snowfall in height over a certain period'), S(unit='mm')],
