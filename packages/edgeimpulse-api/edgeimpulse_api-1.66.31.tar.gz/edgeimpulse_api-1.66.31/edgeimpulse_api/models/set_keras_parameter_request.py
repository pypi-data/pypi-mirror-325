...
class SetKerasParameterRequest(BaseModel):
    ...
    minimum_confidence_rating: Optional[float] = Field(None, alias="minimumConfidenceRating", description="Minimum confidence score, if the neural network scores a sample below this threshold it will be flagged as uncertain.")
