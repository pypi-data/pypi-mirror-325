...
class OrganizationUser(BaseModel):
    ...
    __properties = ["id", "username", "name", "email", "photo", "created", "lastSeen", "staffInfo", "pending", "lastTosAcceptanceDate", "jobTitle", "permissions", "companyName", "activated", "mfaConfigured", "stripeCustomerId", "hasPendingPayments", "tier", "added", "role", "projectCount", "datasets", "lastAccessToOrganization", "lastOrganizationProjectAccessed"]
