...
class AdminApiUser(BaseModel):
    ...
    __properties = ["id", "username", "name", "email", "photo", "created", "lastSeen", "staffInfo", "pending", "lastTosAcceptanceDate", "jobTitle", "permissions", "companyName", "activated", "mfaConfigured", "stripeCustomerId", "hasPendingPayments", "tier", "organizations", "projects", "experiments", "evaluation", "ambassador", "suspended", "trials", "dailyMetrics"]
