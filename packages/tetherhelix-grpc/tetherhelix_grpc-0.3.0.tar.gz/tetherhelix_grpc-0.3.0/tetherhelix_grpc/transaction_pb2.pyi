...
class TransactionData(_message.Message):
    __slots__ = ("bid_uuid", "bid_created_at", "bid_price", "bid_krw", "bid_fee", "bid_failed", "ask_failed", "order_status", "tether_volume", "bid_filled_at", "ask_uuid", "ask_created_at", "ask_filled_at", "ask_price", "ask_fee", "revenue", "bot_id")
...
class TransactionRequest(_message.Message):
    ...
    bot_id: str
    order_by: str
    def __init__(self, db_auth: _Optional[str] = ..., bot_id: _Optional[str] = ..., order_by: _Optional[str] = ...) -> None: ...

class ScopedTransactionRequest(_message.Message):
    __slots__ = ("db_auth", "bot_id", "start_time", "end_time", "order_by")
    DB_AUTH_FIELD_NUMBER: _ClassVar[int]
    BOT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    end_time: int
    order_by: str
    def __init__(self, db_auth: _Optional[str] = ..., bot_id: _Optional[str] = ..., start_time: _Optional[int] = ..., end_time: _Optional[int] = ..., order_by: _Optional[str] = ...) -> None: ...
