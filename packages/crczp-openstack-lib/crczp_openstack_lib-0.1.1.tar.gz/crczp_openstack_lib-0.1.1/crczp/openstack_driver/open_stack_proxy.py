...
class OpenStackProxy:
    ...
    def get_keypair(self, keypair_name: str) -> novaclient.v2.keypairs.Keypair:
        ...
        try:
            ...
            raise KypoException("Failed to get keypair '{0}': {1}".format(keypair_name, e)) from e
    ...
    def create_keypair(self, name: str, public_key: str, key_type: str) -> novaclient.v2.keypairs.Keypair:
        ...
        try:
            ...
            raise KypoException("Failed to create keypair '{0}' with public key '{1}': {2}".format(name, public_key, e)) from e
    ...
    def delete_keypair(self, name: str) -> TupleWithMeta:
        ...
        try:
            ...
            raise KypoException("Failed to delete keypair '{0}': {1}".format(name, e)) from e
    ...
    def resume_instance(self, node_id: str) -> None:
        ...
        try:
            ...
            raise KypoException(f"Failed to resume instance with id={node_id}: {e}.") from e
    ...
    def start_instance(self, node_id: str) -> None:
        ...
        try:
            ...
            raise KypoException(f"Failed to start instance with id={node_id}: {e}.") from e
    ...
    def reboot_instance(self, node_id: str) -> None:
        ...
        try:
            ...
            raise KypoException(f"Failed to reboot instance with id={node_id}: {e}.") from e
