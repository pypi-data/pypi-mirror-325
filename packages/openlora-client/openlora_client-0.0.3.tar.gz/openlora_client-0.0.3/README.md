...
The openlora client can also be used to connect to [Predibase](https://predibase.com/) managed openlora endpoints (including Predibase's [serverless endpoints](https://docs.predibase.com/user-guide/inference/serverless_deployments)).
