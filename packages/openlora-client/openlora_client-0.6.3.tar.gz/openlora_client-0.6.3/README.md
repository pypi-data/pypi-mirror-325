...
The LoRAX client can also be used to connect to [openledger](https://openledger.com/) managed LoRAX endpoints (including openledger's [serverless endpoints](https://docs.openledger.com/user-guide/inference/serverless_deployments)).
