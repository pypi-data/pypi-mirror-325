...
mental_health_questionnaires = pd.DataFrame([], columns=['category_name', 'questionnaire_name', 'questionnaire_task', 'question'])
...
mental_health_questionnaires = QuestionnaireData(mental_health_questionnaires)