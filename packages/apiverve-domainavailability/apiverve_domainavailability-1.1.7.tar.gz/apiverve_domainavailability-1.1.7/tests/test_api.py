...
class TestDomainavailabilityAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = DomainavailabilityAPIClient(self.api_key)

    @patch('apiverve_domainavailability.apiClient.requests.get')
