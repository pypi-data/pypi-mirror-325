from youtubeenhanced.enums import Quality
...
class YoutubeVideo:
    ...
    def get_subtitles(
        ...
        format: SubtitleFileExtension = SubtitleFileExtension.JSON3
    ):
        """
        ...
        format = SubtitleFileExtension.to_enum(format)
    ...
    def _load_ideas_and_summary(self):
        ...
        subtitles_filename = self.download_automatic_subtitles(language = Language.SPANISH, format = SubtitleFileExtension.JSON3)
