...
#define mir_HAVE_ATLAS 0
#define mir_HAVE_ECKIT_GEO 0
...
constexpr bool HAVE_ATLAS     = _to_bool(0);
constexpr bool HAVE_ECKIT_GEO = _to_bool(0);
constexpr bool HAVE_NETCDF    = _to_bool(0);
constexpr bool HAVE_PNG       = _to_bool(0);
constexpr bool HAVE_OMP       = _to_bool(0);

constexpr bool HAVE_TESSELATION = _to_bool();
