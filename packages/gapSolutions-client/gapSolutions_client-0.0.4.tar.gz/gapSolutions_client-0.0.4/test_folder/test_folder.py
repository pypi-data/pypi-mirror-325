...
from gapSolutions_client.folder import folder_list, folder_create, folder_delete, folder_update, list_files_in_folder
from gapSolutions_client.utils import ApiErrorResponse,make_request
from gapSolutions_client.folder_type import Folder
...
@patch('gap_client.folder.make_request')
