...
from gapSolutions_client.folder_type import Folder, from_int, from_str, from_datetime, from_union, from_list, from_none, folder_from_dict, folder_to_dict,from_bool
