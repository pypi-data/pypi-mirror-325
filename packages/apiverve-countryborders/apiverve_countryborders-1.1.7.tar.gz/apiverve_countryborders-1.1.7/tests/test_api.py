...
class TestCountrybordersAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = CountrybordersAPIClient(self.api_key)

    @patch('apiverve_countryborders.apiClient.requests.get')
