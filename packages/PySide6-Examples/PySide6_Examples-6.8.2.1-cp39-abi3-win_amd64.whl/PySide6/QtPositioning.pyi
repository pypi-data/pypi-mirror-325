...
class QGeoPath(PySide6.QtPositioning.QGeoShape):
    ...
    @typing.overload
    def __init__(self, other: PySide6.QtPositioning.QGeoPath, /, *, path: typing.Sequence[typing.Any] | None= ..., width: float | None= ...) -> None: ...
    @typing.overload
    def __init__(self, other: PySide6.QtPositioning.QGeoShape, /, *, path: typing.Sequence[typing.Any] | None= ..., width: float | None= ...) -> None: ...
    @typing.overload
    def __init__(self, path: typing.Sequence[typing.Any], /, width: float = ...) -> None: ...
    @typing.overload
    def __init__(self, /, *, path: typing.Sequence[typing.Any] | None= ..., width: float | None= ...) -> None: ...
...
class QGeoPolygon(PySide6.QtPositioning.QGeoShape):
    ...
    @typing.overload
    def __init__(self, other: PySide6.QtPositioning.QGeoPolygon, /, *, perimeter: typing.Sequence[PySide6.QtPositioning.QGeoCoordinate] | None= ...) -> None: ...
    @typing.overload
    def __init__(self, other: PySide6.QtPositioning.QGeoShape, /, *, perimeter: typing.Sequence[PySide6.QtPositioning.QGeoCoordinate] | None= ...) -> None: ...
    @typing.overload
    def __init__(self, path: typing.Sequence[PySide6.QtPositioning.QGeoCoordinate], /, *, perimeter: typing.Sequence[PySide6.QtPositioning.QGeoCoordinate] | None= ...) -> None: ...
    @typing.overload
    def __init__(self, /, *, perimeter: typing.Sequence[PySide6.QtPositioning.QGeoCoordinate] | None= ...) -> None: ...
...
class QGeoRectangle(PySide6.QtPositioning.QGeoShape):
    ...
    @typing.overload
    def __init__(self, coordinates: typing.Sequence[PySide6.QtPositioning.QGeoCoordinate], /, *, bottomLeft: PySide6.QtPositioning.QGeoCoordinate | None= ..., bottomRight: PySide6.QtPositioning.QGeoCoordinate | None= ..., topLeft: PySide6.QtPositioning.QGeoCoordinate | None= ..., topRight: PySide6.QtPositioning.QGeoCoordinate | None= ..., center: PySide6.QtPositioning.QGeoCoordinate | None= ..., height: float | None= ..., width: float | None= ...) -> None: ...
    @typing.overload
