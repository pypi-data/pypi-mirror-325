...
class VideoAudioCombinator:
    ...
    def process_audio(self, main_video: Clip, added_video: Clip):
        """
        ...
        return {
            VideoCombinatorAudioMode.BOTH_CLIPS_AUDIO: CompositeAudioClip([
                added_video_audio, 
                main_video_audio
            ]),
            VideoCombinatorAudioMode.ONLY_MAIN_CLIP_AUDIO: main_video_audio,
            VideoCombinatorAudioMode.ONLY_ADDED_CLIP_AUDIO: added_video_audio
        }[self._audio_mode]
