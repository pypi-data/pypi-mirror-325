...
class PositionMovement:
    ...
    the 'final_position'
    """
    def __init__(self, initial_position: tuple[int, int], final_position: tuple[int, int]):
    ...
    @abstractmethod
    def get_position(self, n: float, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        """
