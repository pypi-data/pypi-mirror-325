...
class ZoomOutOnVideoPositionEffect(Effect):
    ...
    """
    def apply(self, video: Clip, video_position: Union[tuple, Coordinate, Position], zoom_start_region_size: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        """
        ...
        # work
        MAX_SCENE_SIZE = MOVIEPY_SCENE_DEFAULT_SIZE
