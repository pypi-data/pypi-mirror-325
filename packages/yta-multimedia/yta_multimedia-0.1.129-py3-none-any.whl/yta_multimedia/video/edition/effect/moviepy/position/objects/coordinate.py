from yta_multimedia.video.consts import MOVIEPY_SCENE_DEFAULT_SIZE, MANIM_SCENE_DEFAULT_SIZE, DEFAULT_SCENE_SIZE
...
class Coordinate(BaseCoordinate):
    ...
    def as_moviepy_tuple(self):
        ...
        if self.engine == VideoEngine.MANIM:
            ...
            # would be -
            x, y = self.on_scene_size(MOVIEPY_SCENE_DEFAULT_SIZE)
    ...
    def __init__(self, x: float, y: float, is_normalized: bool = False, engine: Union[VideoEngine, str] = VideoEngine.MOVIEPY, scene_size: tuple = MOVIEPY_SCENE_DEFAULT_SIZE):
    ...
    def to_moviepy(self):
        ...
        if self.engine == VideoEngine.MANIM:
            ...
            self.scene_size = MOVIEPY_SCENE_DEFAULT_SIZE
    ...
    def update_scene_size(self, scene_size: tuple = MOVIEPY_SCENE_DEFAULT_SIZE):
        """
    ...
    def on_scene_size(self, scene_size: tuple = MOVIEPY_SCENE_DEFAULT_SIZE):
        """
    ...
    @staticmethod
    def to_moviepy_upper_left_corner_tuple(coordinate: Union[tuple, 'Coordinate'], video_size: Union[tuple, 'Coordinate'], scene_size: Union[tuple, 'Coordinate'] = MOVIEPY_SCENE_DEFAULT_SIZE):
        """
    ...
    def moviepy_coordinate_to_manim_coordinate(coordinate: tuple):
        ...
        x_scale = MANIM_SCENE_DEFAULT_SIZE[0] / DEFAULT_SCENE_SIZE[0]
        y_scale = MANIM_SCENE_DEFAULT_SIZE[1] / DEFAULT_SCENE_SIZE[1]
    ...
    def manim_coordinate_to_moviepy_coordinate(coordinate: tuple):
        ...
        x_scale = DEFAULT_SCENE_SIZE[0] / MANIM_SCENE_DEFAULT_SIZE[0]
        y_scale = DEFAULT_SCENE_SIZE[1] / MANIM_SCENE_DEFAULT_SIZE[1]
        
        x = (coordinate[0] * x_scale) + MANIM_SCENE_DEFAULT_SIZE[0] / 2
        y = MANIM_SCENE_DEFAULT_SIZE[1] / 2 - (coordinate[1] * y_scale)
