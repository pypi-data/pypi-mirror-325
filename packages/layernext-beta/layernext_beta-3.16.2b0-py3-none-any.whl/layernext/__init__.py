...
class LayerNextClient:
    ...
    def submit_user_feedback(self, user_question: str, ai_answer: str, feedback_comment: str):
        """
        ...
        response = _datalake_client.submit_user_feedback( user_question, ai_answer, feedback_comment)
        return response
