...
class TranslateFletPage:
    ...
    def __init__(self,
        ...
        self.mode = mode
        if self.mode == 0:
            self.from_language = MymemoryTranslateLanguage(from_language.name)
            self.into_language = MymemoryTranslateLanguage(into_language.name)
        else:
            self.from_language = GoogleTranslateLanguage(from_language.name)
            self.into_language = GoogleTranslateLanguage(into_language.name)
