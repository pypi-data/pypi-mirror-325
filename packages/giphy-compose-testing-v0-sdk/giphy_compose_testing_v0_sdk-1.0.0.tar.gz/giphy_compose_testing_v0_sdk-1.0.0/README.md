...
```python
import giphy_compose_testing_v0_sdk
```
...
import giphy_compose_testing_v0_sdk
from giphy_compose_testing_v0_sdk.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to https://api.giphy.com/v1
# See configuration.py for a list of all supported configuration parameters.
configuration = giphy_compose_testing_v0_sdk.Configuration(
...
with giphy_compose_testing_v0_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = giphy_compose_testing_v0_sdk.GifsApi(api_client)
