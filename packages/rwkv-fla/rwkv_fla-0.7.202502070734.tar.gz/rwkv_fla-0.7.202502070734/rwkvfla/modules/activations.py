...
from rwkvfla.utils import (autocast_custom_bwd, autocast_custom_fwd,
                       contiguous, device)
from rwkvfla.modules.activations_triton import (logsigmoid_fwd,
                                            logsigmoid_bwd)

if device == 'cuda':
    from rwkvfla.modules.activations_cuda import (sigmoid, swish, swiglu_fwd,
                                              swiglu_bwd, swiglu_fwdbwd)
else:
    sigmoid = F.sigmoid
    swish = F.silu
    from rwkvfla.modules.activations_triton import (swiglu_fwd, swiglu_bwd,
                                                swiglu_fwdbwd)
