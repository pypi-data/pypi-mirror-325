...
#+END_SRC
#+RESULTS:
| bisos.b.cs.ro | blee.icmPlayer.bleep | bisos.bpo.bpo | bisos.bpo.bpoRepo |
#+end_org """
...
csuList = [ 'bisos.b.cs.ro', 'blee.icmPlayer.bleep', 'bisos.bpo.bpo', 'bisos.bpo.bpoRepo', ]
...
"""
        ...
        bpoRepo.examples_csu(sectionTitle="default")
