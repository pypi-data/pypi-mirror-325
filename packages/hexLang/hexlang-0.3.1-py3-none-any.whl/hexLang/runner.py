"""
# hexLang python runner.
The hexLang runner exposes the hexLang interpreter
to python scripts.
"""
...
class RppRunner:
    """
    The RppRunner handles the execution of hexLang code.
    """
    ...
    def __init__(self) -> None:
        ...
        with warnings.catch_warnings():
            ...
            logger.warning(
                "LineParser supports only a subset of hexLang features."
            )
    ...
    def tokenize(self, code: str):
        ...
        Args:
            code (str): the hexLang code to tokenize.
    ...
    def exec(self, code: str, log_level: str = "INFO"):
        """
        exec executes a complete hexLang program.

        Args:
            code (str): the hexLang program to execute.
    ...
    def eval(self, code_line: str):
        """
        eval evaluates a hexLang statement.

        **NOTE**: eval supports only a subset of hexLang features.

        Args:
            code_line (str): hexLang statement to evaluate.
