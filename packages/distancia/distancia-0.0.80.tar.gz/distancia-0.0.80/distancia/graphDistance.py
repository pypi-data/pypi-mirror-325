...
class GraphBetweennessDistance:
    """
...
class ClosenessCentralityDistance:
    """
...
class BetweennessCentralityDistance:
    """
...
class EigenvectorCentralityDistance:
    """
...
class EdgeBetweennessDistance:
    ...
    def calculate_distance(self) -> Tuple[Dict[Tuple[str, str], float], 
...
class EdgeWeightDistance:
    ...
    def calculate_distance(self) -> Tuple[Dict[str, float], Dict[str, float], Dict[str, float]]:
        """
...
class GraphDensity:
    ...
    def compare_densities(self, graph1: Dict[str, Dict[str, float]], 
...
class GraphDiameter:
    ...
    def compare_diameters(self, graph1: Dict[str, Dict[str, float]], 
...
class AveragePathLength:
    ...
    def compare_average_paths(self, graph1: Dict[str, Dict[str, float]], 
                            graph2: Dict[str, Dict[str, float]]) -> Dict[str, float]:
        """
...
class GraphAssortativity:
    ...
    def compare_assortativity(self, graph1: Dict[str, Dict[str, float]], 
                            graph2: Dict[str, Dict[str, float]], 
                            weighted: bool = True) -> Dict[str, float]:
        """
...
class GlobalEfficiency:
    ...
    def compare_efficiency(self, graph1: Dict[str, Dict[str, float]], 
                         graph2: Dict[str, Dict[str, float]]) -> Dict[str, float]:
        """
...
class GraphModularity:
    ...
    def compare_modularity(self, graph1: Dict[str, Dict[str, float]], 
                          graph2: Dict[str, Dict[str, float]]) -> Dict[str, float]:
        """
...
class ConductanceCalculator:
    ...
    def calculate_conductance_distance(self, graph1: Dict[str, Dict[str, float]], 
                                    graph2: Dict[str, Dict[str, float]],
...
class NormalizedCutCalculator:
    ...
    def calculate_distance(self, graph1: Dict[str, Dict[str, float]], 
                         graph2: Dict[str, Dict[str, float]],
                         communities1: Dict[str, int],
                         communities2: Dict[str, int]) -> float:
        """
...
class GraphLaplacianCalculator:
    """
...
class TemporalReachabilityAnalyzer:
    """
    ...
    def calculate_temporal_distance(self,
...
class GraphDistanceCalculatorV2:
    """
...
class TemporalClusteringCalculator:
    """
...
class ResistanceDistanceCalculator:
    """
...
class AverageClusteringCoefficients:
    """
    ...
    def calculate_graph_distance(self, graph1: Dict[str, Dict[str, float]], 
                               graph2: Dict[str, Dict[str, float]]) -> float:
        """
