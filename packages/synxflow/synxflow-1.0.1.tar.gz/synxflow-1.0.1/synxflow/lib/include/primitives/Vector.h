...
namespace GC{
  ...
  HEMI_DEV_CALLABLE_INLINE Vector2 operator* (const float& lhs, const Vector2& rhs){	//multiplying
    return Vector2(lhs*rhs.x, lhs*rhs.y);
  }

  HEMI_DEV_CALLABLE_INLINE Vector2 operator* (const Vector2& lhs, const float& rhs){	//multiplying
    return Vector2(lhs.x*rhs, lhs.y*rhs);
  }

  HEMI_DEV_CALLABLE_INLINE Vector2 operator* (const double& lhs, const Vector2& rhs){	//multiplying
    return Vector2(lhs*rhs.x, lhs*rhs.y);
  }

  HEMI_DEV_CALLABLE_INLINE Vector2 operator* (const Vector2& lhs, const double& rhs){	//multiplying
    return Vector2(lhs.x*rhs, lhs.y*rhs);
  }
  ...
  HEMI_DEV_CALLABLE_INLINE Vector2 operator/ (const Vector2& lhs, const float& rhs){	//dividing
    return Vector2(lhs.x/rhs, lhs.y/rhs);
  }

  HEMI_DEV_CALLABLE_INLINE Vector2 operator/ (const Vector2& lhs, const double& rhs){	//dividing
    return Vector2(lhs.x/rhs, lhs.y/rhs);
  }
