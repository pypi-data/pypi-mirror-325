...
class Client:
    ...
    def future_trade_orderstatus(
        self, account_id="", order_id="", isdataframe=True, **kwargs
    ):
        params = self._merge_two_dicts(
            {"account": account_id, "order_id": order_id, "isdataframe": isdataframe},
            kwargs,
        )
    ...
    def future_trade_accountinfo(self, account_id="", isdataframe=True, **kwargs):
        params = self._merge_two_dicts(
            {"account": account_id, "isdataframe": isdataframe}, kwargs
        )
        r = self._get("/future/china/trade/accountinfo", params=params)
        return r

    def future_trade_position(
        self, account_id="", planning_id="", isdataframe=True, **kwargs
    ):
        params = self._merge_two_dicts(
            {
                "account": account_id,
