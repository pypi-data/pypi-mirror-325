...
class ThermalMapFile(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["csvExcelFile",b"csvExcelFile","fileData",b"fileData","imageFile",b"imageFile"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cca",b"cca","csvExcelFile",b"csvExcelFile","fileComment",b"fileComment","fileData",b"fileData","fileName",b"fileName","fileType",b"fileType","imageFile",b"imageFile","thermalBoardSide",b"thermalBoardSide","thermalProfiles",b"thermalProfiles"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["fileData",b"fileData"]) -> typing.Optional[typing_extensions.Literal["csvExcelFile","imageFile"]]: ...
