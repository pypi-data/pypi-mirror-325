# -*- coding: utf-8 -*-
# @Time :2022/6/21 13:02
# @Auther :Yuwenchao
# @Software : PyCharm
'''
my_packages:
    convert_to_peaks
    sqrt_normalize_spectrum
    find_match_peaks_efficient
    find_match_peaks
    alignment_to_match
    score_alignment
    score_alignment_matched_peaks
'''
import math
import bisect
...
def sqrt_normalize_spectrum(spectrum):
    '''
    Normalizing
    :param spectrum: output of convert_to_peaks
    :return: [Peak(mz=x, intensity=normalized_y),...,]
    '''
    output_spectrum = []
...
def score_alignment(spec1,spec2,pm1,pm2,tolerance,max_charge_consideration=1):
    ...
    :param pm2: pepmass2
    :param tolerance:Da
    :param max_charge_consideration:
    :return:total,score
    '''
