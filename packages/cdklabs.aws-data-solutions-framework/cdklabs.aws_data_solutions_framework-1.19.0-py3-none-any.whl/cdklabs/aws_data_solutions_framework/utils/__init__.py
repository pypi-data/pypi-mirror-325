...
class CICDStage(
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdklabs/aws-data-solutions-framework.utils.CICDStage",
):
    '''The list of CICD Stages used in CICD Pipelines.'''

    @jsii.member(jsii_name="of")
    @builtins.classmethod
    def of(cls, stage: builtins.str) -> "CICDStage":
        '''Custom stage.

        :param stage: the stage inside the pipeline.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__361cc678f3a73f59ee9d7b94d36102ce600e6e18df17ccd55141dd2280f0bfa3)
            check_type(argname="argument stage", value=stage, expected_type=type_hints["stage"])
        return typing.cast("CICDStage", jsii.sinvoke(cls, "of", [stage]))

    @jsii.python.classproperty
    @jsii.member(jsii_name="PROD")
    def PROD(cls) -> "CICDStage":
        '''Prod stage.'''
        return typing.cast("CICDStage", jsii.sget(cls, "PROD"))

    @jsii.python.classproperty
    @jsii.member(jsii_name="STAGING")
    def STAGING(cls) -> "CICDStage":
        '''Staging stage.'''
        return typing.cast("CICDStage", jsii.sget(cls, "STAGING"))
...
def _typecheckingstub__361cc678f3a73f59ee9d7b94d36102ce600e6e18df17ccd55141dd2280f0bfa3(
    stage: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
