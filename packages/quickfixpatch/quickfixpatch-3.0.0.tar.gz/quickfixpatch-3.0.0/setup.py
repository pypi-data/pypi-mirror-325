...
setup(name='quickfixpatch',
      ...
      ext_modules=[Extension('_quickfix', glob.glob('C++/*.cpp'), extra_compile_args=['-std=c++0x', '-Wno-deprecated', '-Wno-unused-variable', '-Wno-deprecated-declarations', '-Wno-maybe-uninitialized', '-Wno-unused-label', '-IC++/swig'], libraries=["ssl", "crypto"])],
)
