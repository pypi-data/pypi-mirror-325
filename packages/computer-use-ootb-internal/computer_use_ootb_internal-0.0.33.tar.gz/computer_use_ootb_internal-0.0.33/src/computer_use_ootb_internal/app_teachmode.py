...
def process_input(user_input, state):
    state['chatbot_messages'].append((None, user_input))
    ...
    for loop_msg in sampling_loop:
        ...
        state['chatbot_messages'].append((loop_msg, None))
        time.sleep(1)
        yield state['chatbot_messages']
...
def main():
    ...
    parser.add_argument(
        "--server_url",
        default="http://ec2-35-81-81-242.us-west-2.compute.amazonaws.com:5000/generate_action",
