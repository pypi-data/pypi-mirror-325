...
class TagsApi:
    ...
    @validate_call
    def list_documents_for_tag(
        self,
        tag_name: Annotated[StrictStr, Field(description="Name of a tag to return documents for")],
        ...
        :param tag_name: Name of a tag to return documents for (required)
        :type tag_name: str
        ...
        _param = self._list_documents_for_tag_serialize(
            tag_name=tag_name,
    ...
    @validate_call
    def list_documents_for_tag_with_http_info(
        self,
        tag_name: Annotated[StrictStr, Field(description="Name of a tag to return documents for")],
        collection_id: Annotated[StrictStr, Field(description="Id of a collection containing the documents")],
        _request_timeout: Union[
    ...
    @validate_call
    def list_documents_for_tag_without_preload_content(
        self,
        tag_name: Annotated[StrictStr, Field(description="Name of a tag to return documents for")],
        collection_id: Annotated[StrictStr, Field(description="Id of a collection containing the documents")],
        _request_timeout: Union[
    ...
    def _list_documents_for_tag_serialize(
        self,
        tag_name,
        collection_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tags/{tag_name}/documents',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
