...
class H2OGPTE:
    ...
    def create_collection(
        ...
        collection_id = _to_id(
            self._db(
                ...
                json.dumps(chat_settings or {}),
            )
        )
        if prompt_template_id is not None:
            self.set_collection_prompt_template(collection_id, prompt_template_id)
        if thumbnail is not None:
            self.set_collection_thumbnail(collection_id, thumbnail)
    ...
    def set_collection_thumbnail(
        ...
        return self._wait(
            self._job(
                "crawl_quick.UpdateCollectionThumbnailJob",
    ...
    def remove_collection_thumbnail(
        ...
        return self._wait(
            self._job(
                "crawl_quick.DeleteCollectionThumbnailJob", collection_id=collection_id
            ),
            timeout=timeout,
        )
    ...
    def create_topic_model(
        ...
        return self._wait(
            self._job("crawl.CreateTopicModelJob", collection_id=collection_id),
            timeout=timeout,
        )
    ...
    def delete_chat_sessions(
        ...
        return self._wait(
            self._job(
                "crawl_quick.DeleteChatSessionsJob", chat_session_ids=chat_session_ids
            ),
            timeout=timeout,
        )
