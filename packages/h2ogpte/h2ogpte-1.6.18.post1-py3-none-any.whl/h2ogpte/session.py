...
class Session:
    ...
    def connect(self):
        ...
        auth_headers["x-h2ogpte-chat-session-id"] = self._chat_connection_id
    ...
    def query(
        ...
        request = ChatRequest(
            chat_connection_id=self._chat_connection_id,  # how the backend knows where to send the message back
            t="cq",
            mode="s",
