...
class TestCurrencyconverterAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = CurrencyconverterAPIClient(self.api_key)

    @patch('apiverve_currencyconverter.apiClient.requests.get')
