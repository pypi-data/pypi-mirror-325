...
class Context(object):
    ...
    def setJsonValue(self, variable: str, key: str, value: Any, address=None):
        try:
            self.bpm.exec(script=f"${{_____context_____.setJsonValue('{variable}','{key}',_____variable_____)}}",
                          context={"_____variable_____": value},
                          address=address)
        except ValueError as x:
            if str(x) == 'No address supplied':
    ...
    def setDictValue(self, variable: str, key: str, value: Any, address=None):
        try:
            self.bpm.exec(script=f"${{{variable}[\"{key}\"=_____variable_____}}",
                          context={"_____variable_____": value},
                          address=address)
        except ValueError as x:
            if str(x) == 'No address supplied':
    ...
    def getDictValue(self, variable: str, key: str, address=None):
        return self.bpm.exec(script=f"${{{variable}[\"{key}\"]}}", address=address)
