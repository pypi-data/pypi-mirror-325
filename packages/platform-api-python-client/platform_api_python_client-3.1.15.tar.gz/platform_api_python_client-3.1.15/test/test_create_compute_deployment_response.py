...
class TestCreateComputeDeploymentResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateComputeDeploymentResponse:
        """Test CreateComputeDeploymentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateComputeDeploymentResponse`
        """
        model = CreateComputeDeploymentResponse()
        if include_optional:
    ...
    def testCreateComputeDeploymentResponse(self):
        """Test CreateComputeDeploymentResponse"""
