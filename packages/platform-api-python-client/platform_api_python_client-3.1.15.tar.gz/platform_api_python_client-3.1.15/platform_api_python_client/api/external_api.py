...
class EXTERNALApi:
    ...
    def _add_user_request_support_user_requests_post_serialize(
        ...
        if user_support_email_request is not None:
            _body_params = user_support_email_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/support/user-requests',
    ...
    @validate_call
    def create_cserve_deployment_deployments_cserve_post(
        self,
    ...
    def _create_cserve_deployment_deployments_cserve_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if create_c_serve_deployment_request is not None:
            _body_params = create_c_serve_deployment_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/deployments/cserve',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_cserve_deployment_deployments_cserve_deployment_id_get(
        self,
        deployment_id: StrictInt,
        _request_timeout: Union[
            None,
