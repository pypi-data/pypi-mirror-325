...
#define ${proto.namespace.upper()}_SERVICE_HASH 0x${proto.hash}
...
HandlerStatus_e ${proto.namespace}_${packet.camel(True)}_handler(${proto.namespace}_packet_t* ${packet.name}, ${proto.namespace}_packet_t* ${packet.response.name});
%else:
/*@brief Handler for ${packet.name} packets */
