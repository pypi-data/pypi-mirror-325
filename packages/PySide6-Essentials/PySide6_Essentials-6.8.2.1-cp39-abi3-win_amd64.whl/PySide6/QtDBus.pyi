...
class QDBusServiceWatcher(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, service: str, connection: PySide6.QtDBus.QDBusConnection, /, watchMode: PySide6.QtDBus.QDBusServiceWatcher.WatchModeFlag = ..., parent: PySide6.QtCore.QObject | None= ..., *, watchedServices: typing.Sequence[str] | None= ...) -> None: ...
    @typing.overload
    def __init__(self, /, parent: PySide6.QtCore.QObject | None= ..., *, watchedServices: typing.Sequence[str] | None= ..., watchMode: PySide6.QtDBus.QDBusServiceWatcher.WatchModeFlag | None= ...) -> None: ...
