...
def copy_data( output_directory, name_appendage_1, name_appendage_2 ):
    ...
    for path in glob.glob( output_directory + "TT/Condensed_Data/*" ):
        ...
        if pattern.search( path ):
            ...
            shutil.copy( path, output_directory + "TT/Condensed_Data/Resin" + str( resin ) + "_" + str( specimen ) + "_" + name_appendage_2 + ".csv" )

    shutil.copy( output_directory + "TT/File_Data/file_data" + name_appendage_1 + ".csv", output_directory + "TT/File_Data/file_data" + name_appendage_2 + ".csv" )
