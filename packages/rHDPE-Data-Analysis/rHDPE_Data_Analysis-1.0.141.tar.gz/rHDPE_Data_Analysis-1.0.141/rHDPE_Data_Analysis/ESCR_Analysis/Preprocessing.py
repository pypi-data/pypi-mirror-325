...
def copy_data( output_directory, name_appendage_1, name_appendage_2 ):
    ...
    shutil.copy( output_directory + "ESCR/Condensed_Data/escr_data" + name_appendage_1 + ".csv", output_directory + "ESCR/Condensed_Data/escr_data" + name_appendage_2 + ".csv" )

    shutil.copy( output_directory + "ESCR/Condensed_Data/file_data" + name_appendage_1 + ".csv", output_directory + "ESCR/Condensed_Data/file_data" + name_appendage_2 + ".csv" )
