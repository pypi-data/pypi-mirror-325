...
T = TypeVar("T", bound="CreateGlobalAppConfigurationBody")


@_attrs_define
class CreateGlobalAppConfigurationBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_global_app_configuration_body = cls(
            property_=property_,
            value=value,
        )

        create_global_app_configuration_body.additional_properties = d
        return create_global_app_configuration_body
