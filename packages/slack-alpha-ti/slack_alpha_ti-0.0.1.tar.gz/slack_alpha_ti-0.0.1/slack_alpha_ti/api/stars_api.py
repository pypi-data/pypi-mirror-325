...
class StarsApi:
    ...
    def stars_add(
        self,
        token: Annotated[StrictStr, Field(description="Authentication token. Requires scope: `stars:write`")],
        channel: Annotated[Optional[StrictStr], Field(description="Channel to add star to, or channel where the message to add star to was posted (used with `timestamp`).")] = None,
        file: Annotated[Optional[StrictStr], Field(description="File to add star to.")] = None,
        file_comment: Annotated[Optional[StrictStr], Field(description="File comment to add star to.")] = None,
        timestamp: Annotated[Optional[StrictStr], Field(description="Timestamp of the message to add star to.")] = None,
        ...
        _param = self._stars_add_serialize(
            token=token,
            channel=channel,
            file=file,
    ...
    @validate_call
    def stars_add_without_preload_content(
        self,
        token: Annotated[StrictStr, Field(description="Authentication token. Requires scope: `stars:write`")],
        channel: Annotated[Optional[StrictStr], Field(description="Channel to add star to, or channel where the message to add star to was posted (used with `timestamp`).")] = None,
        file: Annotated[Optional[StrictStr], Field(description="File to add star to.")] = None,
    ...
    def stars_list(
        self,
        token: Annotated[Optional[StrictStr], Field(description="Authentication token. Requires scope: `stars:read`")] = None,
        ...
        _param = self._stars_list_serialize(
            token=token,
            count=count,
            page=page,
            cursor=cursor,
    ...
    @validate_call
    def stars_list_without_preload_content(
        self,
        token: Annotated[Optional[StrictStr], Field(description="Authentication token. Requires scope: `stars:read`")] = None,
        count: Optional[StrictStr] = None,
        page: Optional[StrictStr] = None,
    ...
    def stars_remove(
        self,
        token: Annotated[StrictStr, Field(description="Authentication token. Requires scope: `stars:write`")],
        channel: Annotated[Optional[StrictStr], Field(description="Channel to remove star from, or channel where the message to remove star from was posted (used with `timestamp`).")] = None,
        file: Annotated[Optional[StrictStr], Field(description="File to remove star from.")] = None,
        file_comment: Annotated[Optional[StrictStr], Field(description="File comment to remove star from.")] = None,
        timestamp: Annotated[Optional[StrictStr], Field(description="Timestamp of the message to remove star from.")] = None,
        request_timeout__: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._stars_remove_serialize(
            token=token,
            channel=channel,
            file=file,
            file_comment=file_comment,
    ...
    @validate_call
    def stars_remove_with_http_info(
        self,
        token: Annotated[StrictStr, Field(description="Authentication token. Requires scope: `stars:write`")],
        channel: Annotated[Optional[StrictStr], Field(description="Channel to remove star from, or channel where the message to remove star from was posted (used with `timestamp`).")] = None,
        file: Annotated[Optional[StrictStr], Field(description="File to remove star from.")] = None,
    ...
    @validate_call
    def stars_remove_without_preload_content(
        self,
        token: Annotated[StrictStr, Field(description="Authentication token. Requires scope: `stars:write`")],
        channel: Annotated[Optional[StrictStr], Field(description="Channel to remove star from, or channel where the message to remove star from was posted (used with `timestamp`).")] = None,
        file: Annotated[Optional[StrictStr], Field(description="File to remove star from.")] = None,
