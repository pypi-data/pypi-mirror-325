...
class ObjsTeam(BaseModel):
    ...
    discoverable: Optional[Dict[str, Any]] = None
    domain: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["archived", "avatar_base_url", "created", "date_create", "deleted", "discoverable", "domain", "email_domain", "enterprise_id", "enterprise_name", "external_org_migrations", "has_compliance_export", "icon", "id", "is_assigned", "is_enterprise", "is_over_storage_limit", "limit_ts", "locale", "messages_count", "msg_edit_window_mins", "name", "over_integrations_limit", "over_storage_limit", "pay_prod_cur", "plan", "primary_owner", "sso_provider"]
