...
class ObjsMessage(BaseModel):
    ...
    ObjsMessage
    """ # noqa: E501
    attachments: Optional[Annotated[List[Dict[str, Any]], Field(min_length=1)]] = None
    blocks: Optional[List[Dict[str, Any]]] = Field(default=None, description="This is a very loose definition, in the future, we'll populate this with deeper schema in this definition namespace.")
    bot_id: Optional[Dict[str, Any]] = None
