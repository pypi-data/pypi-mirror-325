...
class AdminConversationsSearchSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["channels", "next_cursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "channels": [ObjsChannel.from_dict(_item) for _item in obj["channels"]] if obj.get("channels") is not None else None,
