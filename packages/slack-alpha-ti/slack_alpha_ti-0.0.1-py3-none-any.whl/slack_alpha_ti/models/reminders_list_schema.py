...
class RemindersListSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ok", "reminders"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ok": obj.get("ok"),
            "reminders": [ObjsReminder.from_dict(_item) for _item in obj["reminders"]] if obj.get("reminders") is not None else None
        })
        return _obj
