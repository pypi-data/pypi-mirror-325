...
class BotsApi:
    ...
    def bots_info(
        ...
        bot: Annotated[Optional[StrictStr], Field(description="Bot user to get info on")] = None,
        ...
        _param = self._bots_info_serialize(
            token=token,
            bot=bot,
    ...
    @validate_call
    def bots_info_without_preload_content(
        self,
        token: Annotated[StrictStr, Field(description="Authentication token. Requires scope: `users:read`")],
        bot: Annotated[Optional[StrictStr], Field(description="Bot user to get info on")] = None,
        request_timeout__: Union[
