...
class Hauptprogramm(tk.Tk):
    ...
    def baueWidgets(self):
        ...
        with Form() as form:
            ...
            self.frmRaumEinzelDaten.pack(side=tk.LEFT, fill=tk.Y, expand=True)
            ttk.Separator(self.frmRaumEinzelInhalt, orient=tk.VERTICAL).pack(
                      side=tk.LEFT, fill=tk.BOTH, expand=True)
            self.frmRaumEinzelUnterformulare.pack(side=tk.LEFT, fill=tk.Y, expand=True)
            ...
            ttk.Label(self.frmRaumEinzelUnterformulare, text='Belegung').pack(
                  side=tk.TOP,
                  anchor=tk.W)
            self.sfrRaumEinzelBelegung.pack(side=tk.TOP, fill=tk.BOTH)
            ...
            def FactoryFormRaumEinzelBelegung():
                ...
                uform.addWidget(
                    'veranstaltung_id',
                    ComboboxValueLabel(self.frmRaumEinzelBelegung, width=20),
                    'int',
                    label='VA')
                uform.addWidget(
                    'datum',
    ...
    def baueLayout(self):
        ...
        self.frmNbkRaeume = ttk.Frame(self.frmMain)
        self.nbkMain.add(self.frmNbkRaeume, text='Räume')
        self.nbkRaeume = ttk.Notebook(self.frmNbkRaeume)
        self.nbkRaeume.pack(expand=tk.YES, fill=tk.BOTH)
        ...
        self.frmRaeumeEinzel = ttk.PanedWindow(
            self.frmNbkRaeume,
            orient=tk.HORIZONTAL)
