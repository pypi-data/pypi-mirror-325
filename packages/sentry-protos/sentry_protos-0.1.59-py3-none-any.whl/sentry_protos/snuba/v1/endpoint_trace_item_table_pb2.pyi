...
class TraceItemTableRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["aggregation_filter", b"aggregation_filter", "columns", b"columns", "filter", b"filter", "group_by", b"group_by", "limit", b"limit", "meta", b"meta", "order_by", b"order_by", "page_token", b"page_token", "virtual_column_contexts", b"virtual_column_contexts"]) -> None: ...
...
class AggregationComparisonFilter(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["aggregation", b"aggregation", "column", b"column", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["aggregation", b"aggregation", "column", b"column", "op", b"op", "val", b"val", "value", b"value"]) -> None: ...
...
class Column(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["aggregation", b"aggregation", "column", b"column", "formula", b"formula", "key", b"key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["aggregation", b"aggregation", "column", b"column", "formula", b"formula", "key", b"key", "label", b"label"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["column", b"column"]) -> typing.Literal["key", "aggregation", "formula"] | None: ...
