...
class ServiceManagement:
    ...
    Example:
      >>> _service = ServiceManagement(service_type=SeasonSyncService, model_type=Season, db_session=session)
...
class RepositoryManagement:
    ...
    Example:
      >>> _repository = RepositoryManagement(repository_type=SeasonSyncRepository, db_session=session)
