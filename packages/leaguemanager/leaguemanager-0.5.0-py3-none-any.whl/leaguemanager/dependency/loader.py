...
class DynamicObjectLoader:
    ...
    def load_objects(
        self, search_dir: Path, compare: callable | bool, local_only: bool = False
    ) -> Iterable[ModuleType]:
    ...
    def collect_matching_objects(
        self, modules: list[str | Path], compare: callable | bool, is_dotted_path: bool = True
    ) -> Iterable[ModuleType]:
    ...
    def dotted_paths(self, search_path: Path) -> Generator[str]:
    ...
    def full_paths(self, search_path: Path) -> Generator[Path]:
