...
class WebBrowserTool(BaseTool):
    ...
    def execute(self, input: Dict[str, Any]) -> Dict[str, Any]:
        ...
        The execution plan is generated by the LLM. This version automatically inserts
        a UI-labeling step immediately after the first navigation task so that the UI of the
        loaded website is labeled before further interactions.
        """
        driver = None
        ...
        try:
            ...
            # Insert the UI-labeling step after the first "navigate" task (if one exists)
            nav_index = None
            ...
            if nav_index is not None:
                # Check if any label_ui task exists after the navigation task
...
"""
    ...
    def _handle_label_ui(self, driver: webdriver.Chrome, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            """
            result = driver.execute_script(script)
            # If the script returns None, interpret that as an empty mapping.
            if result is None:
