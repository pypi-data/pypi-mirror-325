...
from DLMSCommunicationProfile import communication_profile as c_pf
...
class Client:
    ...
    def __init__(self,
                 ...
                 addr_size: int = -1,
                 media: base.Media = Serial(port="COM3"),
                 id_: str | int = None,
                 m_id: int = 0,
                 universal: bool = False,
                 del_cb: Callable[[str], bool] = None,
                 response_timeout=120,
                 com_profile=c_pf.HDLC()):
        self.com_profile = com_profile
        ...
        self.response_timeout = response_timeout  # todo: temporary, in future is HDLC(or other) parameters
