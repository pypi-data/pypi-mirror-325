...
"""Base decorator for creating peeps classes with configuration and function management."""


def PeepsBase(cls: T) -> T:
    """Wraps a class with peeps functionality and configuration management."""

    class WrappedClass(cls):  # type: ignore
        is_peeps_class: bool = True  # type: ignore
    ...
    WrappedClass.__name__ = PeepsBase.__name__ + "(" + cls.__name__ + ")"
    WrappedClass.__qualname__ = PeepsBase.__qualname__ + "(" + cls.__name__ + ")"
