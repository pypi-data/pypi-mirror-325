...
from peepsai.flow.flow_events import (
    FlowFinishedEvent,
    FlowStartedEvent,
    MethodExecutionFinishedEvent,
    MethodExecutionStartedEvent,
)
from peepsai.flow.flow_visualizer import plot_flow
from peepsai.flow.persistence.base import FlowPersistence
from peepsai.flow.utils import get_possible_return_constants
...
class Flow(Generic[T], metaclass=FlowMeta):
    ...
    def plot(self, filename: str = "peepsai_flow") -> None:
