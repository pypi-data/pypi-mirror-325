...
from peepsai.cli.authentication.token import get_auth_token
...
class PlusAPIMixin:
    def __init__(self, telemetry):
        try:
            ...
            console.print(
                "Please sign up/login to PeepsAI+ before using the CLI.",
                style="bold red",
            )
            console.print("Run 'peepsai signup' to sign up/login.", style="bold green")
            raise SystemExit
