...
class BaseTool(BaseModel, ABC):
    ...
    def to_structured_tool(self) -> PeepsStructuredTool:
        """Convert this tool to a PeepsStructuredTool instance."""
        self._set_args_schema()
        return PeepsStructuredTool(
            name=self.name,
    ...
    def from_langchain(cls, tool: Any) -> "BaseTool":
        """Create a Tool instance from a PeepsStructuredTool.

        This method takes a PeepsStructuredTool object and converts it into a
...
class Tool(BaseTool):
    ...
    def from_langchain(cls, tool: Any) -> "Tool":
        ...
        Args:
            tool (Any): The PeepsStructuredTool object to be converted.

        Returns:
            Tool: A new Tool instance created from the provided PeepsStructuredTool.
...
def to_langchain(
    tools: list[BaseTool | PeepsStructuredTool],
) -> list[PeepsStructuredTool]:
