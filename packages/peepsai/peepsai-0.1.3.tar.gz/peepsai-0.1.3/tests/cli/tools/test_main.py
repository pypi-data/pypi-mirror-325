...
from peepsai.cli.tools.main import ToolCommand
...
@patch("peepsai.cli.tools.main.subprocess.run")
...
@patch("peepsai.cli.tools.main.subprocess.run")
@patch("peepsai.cli.plus_api.PlusAPI.get_tool")
...
@patch("peepsai.cli.tools.main.git.Repository.is_synced", return_value=False)
...
@patch("peepsai.cli.tools.main.get_project_name", return_value="sample-tool")
@patch("peepsai.cli.tools.main.get_project_version", return_value="1.0.0")
@patch("peepsai.cli.tools.main.get_project_description", return_value="A sample tool")
@patch("peepsai.cli.tools.main.subprocess.run")
@patch("peepsai.cli.tools.main.os.listdir", return_value=["sample-tool-1.0.0.tar.gz"])
@patch(
    "peepsai.cli.tools.main.open",
    new_callable=unittest.mock.mock_open,
    read_data=b"sample tarball content",
)
@patch("peepsai.cli.plus_api.PlusAPI.publish_tool")
@patch("peepsai.cli.tools.main.git.Repository.is_synced", return_value=False)
...
@patch("peepsai.cli.plus_api.PlusAPI.publish_tool")
@patch("peepsai.cli.tools.main.git.Repository.is_synced", return_value=True)
