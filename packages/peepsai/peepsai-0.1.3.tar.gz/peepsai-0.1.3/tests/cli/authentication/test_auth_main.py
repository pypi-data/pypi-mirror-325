...
from peepsai.cli.authentication.main import AuthenticationCommand
...
class TestAuthenticationCommand(unittest.TestCase):
    ...
    @patch("peepsai.cli.authentication.main.requests.post")
    ...
    @patch("peepsai.cli.authentication.main.console.print")
    @patch("peepsai.cli.authentication.main.webbrowser.open")
    ...
    @patch("peepsai.cli.authentication.main.ToolCommand")
    @patch("peepsai.cli.authentication.main.requests.post")
    @patch("peepsai.cli.authentication.main.validate_token")
    @patch("peepsai.cli.authentication.main.console.print")
    def test_poll_for_token_success(
        ...
        mock_print.assert_called_once_with(
            "\n[bold green]Welcome to PeepsAI Enterprise![/bold green]\n"
        )
