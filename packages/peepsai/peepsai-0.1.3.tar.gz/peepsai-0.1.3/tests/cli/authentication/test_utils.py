...
from peepsai.cli.authentication.utils import TokenManager, validate_token


class TestValidateToken(unittest.TestCase):
    @patch("peepsai.cli.authentication.utils.AsymmetricSignatureVerifier")
    @patch("peepsai.cli.authentication.utils.TokenVerifier")
...
class TestTokenManager(unittest.TestCase):
    ...
    @patch("peepsai.cli.authentication.utils.TokenManager.read_secure_file")
    @patch("peepsai.cli.authentication.utils.TokenManager.save_secure_file")
    @patch("peepsai.cli.authentication.utils.TokenManager._get_or_create_key")
    ...
    @patch("peepsai.cli.authentication.utils.Fernet.generate_key")
    @patch("peepsai.cli.authentication.utils.TokenManager.read_secure_file")
    @patch("peepsai.cli.authentication.utils.TokenManager.save_secure_file")
    ...
    @patch("peepsai.cli.authentication.utils.TokenManager.get_secure_storage_path")
    @patch("builtins.open", new_callable=unittest.mock.mock_open)
    @patch("peepsai.cli.authentication.utils.os.chmod")
