...
from peepsai.flow.config import COLORS, NODE_STYLES
from peepsai.flow.html_template_handler import HTMLTemplateHandler
from peepsai.flow.legend_generator import generate_legend_items_html, get_legend_items
from peepsai.flow.path_utils import safe_path_join, validate_path_exists
from peepsai.flow.utils import calculate_node_levels
from peepsai.flow.visualization_utils import (
    add_edges,
...
class FlowPlot:
    ...
    def _generate_final_html(self, network_html):
        ...
        try:
            ...
            template_path = safe_path_join("assets", "peepsai_flow_visual_template.html", root=current_dir)
            logo_path = safe_path_join("assets", "peepsai_logo.svg", root=current_dir)
