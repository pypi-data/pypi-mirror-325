...
from peepsai.agents.agent_builder.utilities.base_output_converter import OutputConverter
...
class Converter(OutputConverter):
    ...
    def _create_instructor(self):
        ...
        from peepsai.utilities import InternalInstructor
    ...
    def _convert_with_instructions(self):
        """Create a chain."""
        from peepsai.utilities.peeps_pydantic_output_parser import (
            PeepsPydanticOutputParser,
        )

        parser = PeepsPydanticOutputParser(pydantic_object=self.model)
