...
class PeepsStructuredTool:
    ...
    that integrates better with PeepsAI's ecosystem.
    """
    ...
    def from_function(
        ...
        **kwargs: Any,
        ...
        Returns:
            A PeepsStructuredTool instance

        Example:
            >>> def add(a: int, b: int) -> int:
            ...     '''Add two numbers'''
            ...     return a + b
            >>> tool = PeepsStructuredTool.from_function(add)
        """
    ...
    def __repr__(self) -> str:
        return (
            f"PeepsStructuredTool(name='{self.name}', description='{self.description}')"
        )
