...
Refer to the Terraform Registry for docs: [`data_pagerduty_standards_resource_scores`](https://registry.terraform.io/providers/pagerduty/pagerduty/3.20.0/docs/data-sources/standards_resource_scores).
'''
...
class DataPagerdutyStandardsResourceScores(
    ...
    def __init__(
        ...
        *,
        ...
        :param resource_type: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.20.0/docs/data-sources/standards_resource_scores#resource_type DataPagerdutyStandardsResourceScores#resource_type}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
