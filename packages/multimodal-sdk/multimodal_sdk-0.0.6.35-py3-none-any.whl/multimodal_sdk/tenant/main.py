...
async def main():
    ...
    response = await kb.retrieve_data(
        kb_resource_id="0740c06d-ea75-4f84-bd36-4f55b9b6a04e",
        query="Tell me about Oda Nobunaga",
        access_token=access_token_123,
        refresh_token=refresh_token_123,
        thread_id="a12115",
        create_thread="false",
        namespace="test-masoom",
        inject=""
    )
    ...
    #     kb_resource_id="21d30808-6f00-43bc-baeb-9233d95a5fc6",
    #     record_id="123-123-123-1233",
    #     access_token=access_token_123,
    #     refresh_token=refresh_token_123
    # )
