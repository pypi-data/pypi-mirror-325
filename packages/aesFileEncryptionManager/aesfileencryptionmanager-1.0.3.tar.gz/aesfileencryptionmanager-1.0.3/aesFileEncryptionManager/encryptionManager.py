...
from file_encrypt import encrypt_file as fileEncrypt, get_password as getEncryptionPassword
from file_decrypt import file_decrypt as fileDecrypt, read_encrypted_file as readEncryptedFile, get_key as getDecryptionPassword
        ...
        if os.path.exists(file_input):
            ...
            if os.path.exists(file_output):
                ...
                if answer.lower() == "yes" or answer.lower() == "y":
                    ...
                    fileEncrypt(file_input, file_output, password)
        else:
    ...
    def decrypt_file(self):
        ...
        if os.path.exists(file_input):
            ...
            if output_path == "" or not output_path:
                ...
                key: bytes = getDecryptionPassword()
                iv_base64, encrypted_file_name_base64, encrypted_content_base64 = readEncryptedFile(file_input)
                decrypted_results: tuple[str, str] = fileDecrypt(key, iv_base64, encrypted_file_name_base64,
