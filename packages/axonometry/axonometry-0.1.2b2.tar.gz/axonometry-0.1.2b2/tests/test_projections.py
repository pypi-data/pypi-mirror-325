...
class TestAxonometryProjections(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p1_axo.project(ref_plane_key="yz")
    ...
    def test_plane_collections(self):
        self.assertEqual(len(self.axo.objects), 4)
        self.assertEqual(len(self.axo.reference_planes['xy'].objects), 4)
        self.assertEqual(len(self.axo.reference_planes['yz'].objects), 4)
        self.assertEqual(len(self.axo.reference_planes['zx'].objects), 4)
