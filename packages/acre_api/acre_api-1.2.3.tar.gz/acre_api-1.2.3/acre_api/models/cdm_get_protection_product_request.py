...
class CdmGetProtectionProductRequest(BaseModel):
    """
    Get a stored protection product.
    """ # noqa: E501
    protection_product_details: Optional[StrictBool] = Field(default=None, description="Return the entire protection product details. By default this value is false and ProtectionProductDetails are returned as null.")
    protection_ids: Optional[List[StrictStr]] = Field(default=None, description="Protection product IDs (optional, default wildcard for all protection products that the user can access).")
    filter_client_ids: Optional[List[StrictStr]] = Field(default=None, description="Filter by client IDs. Intersection/AND/conjunction filter; only return protection products which are linked to all clients provided. Cannot be used with protection_ids.")
    filter_case_ids: Optional[List[StrictStr]] = Field(default=None, description="Filter by case IDs. **IMPORTANT:** misleading plural naming, only a single case_id filter value is accepted. Cannot be used with protection_ids.")
    ...
    filter_ext_ids: Optional[List[StrictStr]] = Field(default=None, description="Only include protection products with the specified external IDs. This filter must be used in conjunction with filter_ext_source. Cannot be used with protection_ids. When multiple filters are specified, they all apply to return only results that match all the criteria.")
    filter_ext_source: Optional[SourceName] = SourceName.INVALID_SOURCE_NAME
    skip_source_response: Optional[StrictBool] = Field(default=None, description="Option to indicate if you wan to avoid returning the source response for the protection products. It will be returned by default.")
    __properties: ClassVar[List[str]] = ["protection_product_details", "protection_ids", "filter_client_ids", "filter_case_ids", "bookmark", "page_size", "filter_ext_ids", "filter_ext_source", "skip_source_response"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetProtectionProductRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetProtectionProductRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "protection_product_details": obj.get("protection_product_details"),
            "protection_ids": obj.get("protection_ids"),
            "filter_client_ids": obj.get("filter_client_ids"),
            "filter_case_ids": obj.get("filter_case_ids"),
