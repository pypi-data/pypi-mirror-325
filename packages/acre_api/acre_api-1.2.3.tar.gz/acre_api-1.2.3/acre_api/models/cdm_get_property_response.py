...
class CdmGetPropertyResponse(BaseModel):
    """
    Response to a get document request.
    """ # noqa: E501
    properties: Optional[List[CdmProperty]] = Field(default=None, description="The properties.")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetPropertyRequest] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetPropertyResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetPropertyResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "next_page": CdmGetPropertyRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
