...
class PropertyDetailsPropertyValuationSource(str, Enum):
    """
    PropertyDetailsPropertyValuationSource
    """

    """
    allowed enum values
    """
    INVALID_PROPERTY_VALUATION_SOURCE = 'INVALID_PROPERTY_VALUATION_SOURCE'
    CLIENT = 'CLIENT'
    LOCAL_AUTHORITY = 'LOCAL_AUTHORITY'
    BANK = 'BANK'
    SURVEY = 'SURVEY'
    SALE = 'SALE'
    ACRE_ESTIMATE = 'ACRE_ESTIMATE'
    AVM = 'AVM'
    ROLL_UP = 'ROLL_UP'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PropertyDetailsPropertyValuationSource from a JSON string"""
