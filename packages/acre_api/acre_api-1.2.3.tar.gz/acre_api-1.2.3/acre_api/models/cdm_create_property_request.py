...
class CdmCreatePropertyRequest(BaseModel):
    """
    Create property request.
    """ # noqa: E501
    var_property: CdmProperty = Field(alias="property")
    show_protected: Optional[StrictBool] = Field(default=None, description="If true, show protected fields.")
    __properties: ClassVar[List[str]] = ["property", "show_protected"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreatePropertyRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreatePropertyRequest from a dict"""
        if obj is None:
            return None
