...
class PanelManagementPanel(str, Enum):
    """
    Lender Panels.   - INVALID_LENDER_PANEL_TYPE: Invalid panel type.  - COMPREHENSIVE: A comprehensive selection of lenders.  - WHOLE_EXC_DIRECT: Whole of market excluding direct to lender products.  - WHOLE_INC_DIRECT: Whole of market including direct to lender products.  - NO_MORTGAGE_ADVICE: No mortgage advice.
    """

    """
    allowed enum values
    """
    INVALID_LENDER_PANEL_TYPE = 'INVALID_LENDER_PANEL_TYPE'
    COMPREHENSIVE = 'COMPREHENSIVE'
    WHOLE_EXC_DIRECT = 'WHOLE_EXC_DIRECT'
    WHOLE_INC_DIRECT = 'WHOLE_INC_DIRECT'
    NO_MORTGAGE_ADVICE = 'NO_MORTGAGE_ADVICE'
    LIMITED = 'LIMITED'
    REFER = 'REFER'
    WHOLE = 'WHOLE'
    ONE = 'ONE'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PanelManagementPanel from a JSON string"""
