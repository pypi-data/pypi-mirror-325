...
class PropertyDetailsEnergyRating(str, Enum):
    """
    PropertyDetailsEnergyRating
    """

    """
    allowed enum values
    """
    INVALID_ENERGY_RATING = 'INVALID_ENERGY_RATING'
    A = 'A'
    B = 'B'
    C = 'C'
    D = 'D'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PropertyDetailsEnergyRating from a JSON string"""
