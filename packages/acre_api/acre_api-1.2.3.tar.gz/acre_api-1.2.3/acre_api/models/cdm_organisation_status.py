...
class CdmOrganisationStatus(str, Enum):
    """
    Types of statuses.   - INVALID_STATUS: Invalid organisation status.  - ACTIVE: Active organisation.  - PENDING: Organisation pending activation.  - DISABLED: Disabled organisation.  - STARTER: Acre Lite / Starter edition.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmOrganisationStatus from a JSON string"""
