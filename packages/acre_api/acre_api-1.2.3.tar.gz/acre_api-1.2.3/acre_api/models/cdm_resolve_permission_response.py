...
class CdmResolvePermissionResponse(BaseModel):
    """
    Response to the permission resolution request.
    """ # noqa: E501
    permission_resolution_response: Optional[List[CdmPermissionResolutionResult]] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["permission_resolution_response", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmResolvePermissionResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in permission_resolution_response (list)
        _items = []
        if self.permission_resolution_response:
            for _item_permission_resolution_response in self.permission_resolution_response:
                if _item_permission_resolution_response:
                    _items.append(_item_permission_resolution_response.to_dict())
            _dict['permission_resolution_response'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmResolvePermissionResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "permission_resolution_response": [CdmPermissionResolutionResult.from_dict(_item) for _item in obj["permission_resolution_response"]] if obj.get("permission_resolution_response") is not None else None,
