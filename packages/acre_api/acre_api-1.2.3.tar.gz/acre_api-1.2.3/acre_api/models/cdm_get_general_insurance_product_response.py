...
class CdmGetGeneralInsuranceProductResponse(BaseModel):
    """
    Get general insurance product response.
    """ # noqa: E501
    general_insurance_products: Optional[List[CdmGeneralInsuranceProduct]] = Field(default=None, description="The products.")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetGeneralInsuranceProductRequest] = None
    __properties: ClassVar[List[str]] = ["general_insurance_products", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetGeneralInsuranceProductResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in general_insurance_products (list)
        _items = []
        if self.general_insurance_products:
            for _item_general_insurance_products in self.general_insurance_products:
                if _item_general_insurance_products:
                    _items.append(_item_general_insurance_products.to_dict())
            _dict['general_insurance_products'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetGeneralInsuranceProductResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "general_insurance_products": [CdmGeneralInsuranceProduct.from_dict(_item) for _item in obj["general_insurance_products"]] if obj.get("general_insurance_products") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmGetGeneralInsuranceProductRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
