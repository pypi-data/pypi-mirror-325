...
class CdmAffordability(BaseModel):
    """
    Details related to the affordability search that was done during the sourcing of this mortgage product.
    """ # noqa: E501
    lenders: Optional[List[CdmAffordabilityLenders]] = Field(default=None, description="List of lenders done in this affordability search.")
    hash: Optional[StrictStr] = Field(default=None, description="Affordability hash for this case/mortgage/clients combination that references the results in S3.")
    signature: Optional[StrictStr] = Field(default=None, description="Cryptographic hash of signed complete result set of the affordability search, used to verify the result set.")
    __properties: ClassVar[List[str]] = ["lenders", "hash", "signature"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAffordability from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lenders (list)
        _items = []
        if self.lenders:
            for _item_lenders in self.lenders:
                if _item_lenders:
                    _items.append(_item_lenders.to_dict())
            _dict['lenders'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAffordability from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "lenders": [CdmAffordabilityLenders.from_dict(_item) for _item in obj["lenders"]] if obj.get("lenders") is not None else None,
            "hash": obj.get("hash"),
