...
class CdmExtendedDeviceDetails(BaseModel):
    """
    Holds Additional device information (required by Equifax).
    """ # noqa: E501
    extended_device_identity_fingerprint: Optional[StrictStr] = Field(default=None, description="A unique device fingerprint that is submitted to 3rd Party when completing device checks. **IMPORTANT** This field cannot be updated, and is populated by the Client.")
    extended_device_identity_reference: Optional[StrictStr] = Field(default=None, description="A verification reference provided by 3rd Party as the result of device verification. **IMPORTANT** This field cannot be set directly, and only updated by the Checks Service.")
    extended_device_identity_full_details: Optional[StrictStr] = Field(default=None, description="The extended result of device verification. **IMPORTANT** This field cannot be set directly, and only updated by the Checks Service.")
    __properties: ClassVar[List[str]] = ["extended_device_identity_fingerprint", "extended_device_identity_reference", "extended_device_identity_full_details"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmExtendedDeviceDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmExtendedDeviceDetails from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "extended_device_identity_fingerprint": obj.get("extended_device_identity_fingerprint"),
            "extended_device_identity_reference": obj.get("extended_device_identity_reference"),
            "extended_device_identity_full_details": obj.get("extended_device_identity_full_details")
        })
        return _obj
