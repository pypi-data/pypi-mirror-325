...
class CdmGetDocumentVerificationResponse(BaseModel):
    """
    Retrieved document verification details.
    """ # noqa: E501
    verifications: Optional[List[CdmDocumentVerification]] = Field(default=None, description="Information about the requested verifications. If the request was a wildcard, then the verifications are returned in the order that they were created. Otherwise, the verifications are returned in the order that their IDs were specified in the request.")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetDocumentVerificationRequest] = None
    __properties: ClassVar[List[str]] = ["verifications", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetDocumentVerificationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetDocumentVerificationResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "verifications": [CdmDocumentVerification.from_dict(_item) for _item in obj["verifications"]] if obj.get("verifications") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmGetDocumentVerificationRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
