...
class CdmListCaseVersionResponse(BaseModel):
    """
    Response to list case versions.
    """ # noqa: E501
    cases: Optional[List[CdmCase]] = Field(default=None, description="Case versions (in each Case object, details will be null).")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmListCaseVersionRequest] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmListCaseVersionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmListCaseVersionResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "next_page": CdmListCaseVersionRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
