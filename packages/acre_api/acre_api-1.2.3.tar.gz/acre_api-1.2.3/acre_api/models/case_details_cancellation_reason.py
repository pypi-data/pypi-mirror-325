...
class CaseDetailsCancellationReason(str, Enum):
    """
    This field will capture the reason why the case has been cancelled.
    """

    """
    allowed enum values
    """
    INVALID_CANCELLATION_REASON = 'INVALID_CANCELLATION_REASON'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CaseDetailsCancellationReason from a JSON string"""
