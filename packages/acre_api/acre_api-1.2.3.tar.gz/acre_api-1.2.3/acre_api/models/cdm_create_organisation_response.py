...
class CdmCreateOrganisationResponse(BaseModel):
    """
    Response to the creation of an organisation.
    """ # noqa: E501
    organisation: Optional[CdmOrganisation] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["organisation", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateOrganisationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateOrganisationResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "organisation": CdmOrganisation.from_dict(obj["organisation"]) if obj.get("organisation") is not None else None,
