...
class CdmManualCaseFlag(BaseModel):
    """
    Minimal flag details required.
    """ # noqa: E501
    case_id: Optional[StrictStr] = Field(default=None, description="Case ID. Required.")
    flag_type: Optional[CdmCaseDetailsFlagType] = CdmCaseDetailsFlagType.INVALID_FLAG_TYPE
    __properties: ClassVar[List[str]] = ["case_id", "flag_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmManualCaseFlag from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmManualCaseFlag from a dict"""
        if obj is None:
            return None
