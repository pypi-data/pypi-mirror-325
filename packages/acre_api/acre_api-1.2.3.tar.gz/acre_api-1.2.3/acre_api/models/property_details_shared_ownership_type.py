...
class PropertyDetailsSharedOwnershipType(str, Enum):
    """
    The type of shared ownership.
    """

    """
    allowed enum values
    """
    INVALID_SHARED_OWNERSHIP_TYPE = 'INVALID_SHARED_OWNERSHIP_TYPE'
    HELP_TO_BUY = 'HELP_TO_BUY'
    RIGHT_TO_BUY = 'RIGHT_TO_BUY'
    SHARE_DOWNERSHIP = 'SHARE_DOWNERSHIP'
    PRIVATE_SHARED_EQUITY = 'PRIVATE_SHARED_EQUITY'
    FAMILY_ASSIST_SCHEME = 'FAMILY_ASSIST_SCHEME'
    NEW_BUY_SCHEME = 'NEW_BUY_SCHEME'
    MORTGAGE_GUARANTEE_SCHEME = 'MORTGAGE_GUARANTEE_SCHEME'
    FIRST_HOMES_SCHEME = 'FIRST_HOMES_SCHEME'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PropertyDetailsSharedOwnershipType from a JSON string"""
