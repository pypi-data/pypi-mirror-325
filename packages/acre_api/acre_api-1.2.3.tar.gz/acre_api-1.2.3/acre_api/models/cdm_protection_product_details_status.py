...
class CdmProtectionProductDetailsStatus(str, Enum):
    """
    CdmProtectionProductDetailsStatus
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmProtectionProductDetailsStatus from a JSON string"""
