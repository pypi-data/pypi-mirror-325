...
class CdmSupplementaryInformation(str, Enum):
    """
    CdmSupplementaryInformation
    """

    """
    allowed enum values
    """
    INVALID_SUPPLEMENTARY_INFORMATION = 'INVALID_SUPPLEMENTARY_INFORMATION'
    DECEASED = 'DECEASED'
    GONE_AWAY = 'GONE_AWAY'
    DEBT_MANAGEMENT = 'DEBT_MANAGEMENT'
    ACCOUNT_PAID_BY_A_3_RD_PARTY = 'ACCOUNT_PAID_BY_A_3RD_PARTY'
    VOLUNTARY_TERMINATION = 'VOLUNTARY_TERMINATION'
    PARTIAL = 'PARTIAL'
    DEBT_ASSIGNED = 'DEBT_ASSIGNED'
    SOLD_TO_INSIGHT_MEMBER = 'SOLD_TO_INSIGHT_MEMBER'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmSupplementaryInformation from a JSON string"""
