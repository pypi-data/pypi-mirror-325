...
class CdmAutoSatisfy(BaseModel):
    """
    A list of document types alongside the number of required documents.
    """ # noqa: E501
    document_types: Optional[List[DocumentDocumentType]] = Field(default=None, description="Array of document types.")
    count: Optional[StrictInt] = Field(default=None, description="The desired count.")
    broker_verification_required: Optional[StrictBool] = Field(default=None, description="Whether a broker is needed to satisfy the requirement.")
    __properties: ClassVar[List[str]] = ["document_types", "count", "broker_verification_required"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAutoSatisfy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAutoSatisfy from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "broker_verification_required": obj.get("broker_verification_required")
        })
        return _obj
