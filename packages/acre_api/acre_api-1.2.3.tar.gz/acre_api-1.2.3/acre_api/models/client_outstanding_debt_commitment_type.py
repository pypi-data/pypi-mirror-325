...
class ClientOutstandingDebtCommitmentType(str, Enum):
    """
    ...
    LOAN = 'LOAN'
    HIRED_PURCHASE = 'HIRED_PURCHASE'
    SECURED_EXCHANGE = 'SECURED_EXCHANGE'
    OVERDRAFT = 'OVERDRAFT'
    UTILITIES = 'UTILITIES'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientOutstandingDebtCommitmentType from a JSON string"""
