...
class ClientOrganisationRelationshipRelationshipTypes(str, Enum):
    """
    RelationshipTypes is the type of relationship an org has with a client.
    """
    ...
    REFERRED_ADVICE = 'REFERRED_ADVICE'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientOrganisationRelationshipRelationshipTypes from a JSON string"""
