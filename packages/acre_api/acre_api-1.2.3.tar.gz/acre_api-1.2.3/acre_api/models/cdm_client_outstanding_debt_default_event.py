...
class CdmClientOutstandingDebtDefaultEvent(BaseModel):
    """
    DefaultEvent contains the date a default is registered, and satisfied.
    """ # noqa: E501
    date_registered: Optional[StrictStr] = Field(default=None, description="The date (YYYY-MM-DD) the default was registered.")
    date_satisfied: Optional[StrictStr] = Field(default=None, description="The date (YYYY-MM-DD) the default was satisfied.")
    balance: Optional[StrictStr] = Field(default=None, description="The balance on the account when the client defaulted on repayments (in pence).")
    __properties: ClassVar[List[str]] = ["date_registered", "date_satisfied", "balance"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmClientOutstandingDebtDefaultEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmClientOutstandingDebtDefaultEvent from a dict"""
        if obj is None:
            return None
