...
class CdmUpdateCommissionStructureResponse(BaseModel):
    """
    CdmUpdateCommissionStructureResponse
    """ # noqa: E501
    commission_structure: Optional[CdmCommissionStructure] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["commission_structure", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmUpdateCommissionStructureResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of commission_structure
        if self.commission_structure:
            _dict['commission_structure'] = self.commission_structure.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmUpdateCommissionStructureResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "commission_structure": CdmCommissionStructure.from_dict(obj["commission_structure"]) if obj.get("commission_structure") is not None else None,
