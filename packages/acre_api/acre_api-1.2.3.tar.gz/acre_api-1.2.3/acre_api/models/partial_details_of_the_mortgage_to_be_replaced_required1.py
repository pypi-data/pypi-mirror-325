...
class PartialDetailsOfTheMortgageToBeReplacedRequired1(BaseModel):
    """
    Partial details of the mortgage to be replaced. Required.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PartialDetailsOfTheMortgageToBeReplacedRequired1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PartialDetailsOfTheMortgageToBeReplacedRequired1 from a dict"""
        if obj is None:
            return None
