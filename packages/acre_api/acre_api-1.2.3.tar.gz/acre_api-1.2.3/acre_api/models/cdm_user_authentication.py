...
class CdmUserAuthentication(BaseModel):
    """
    UserAuthentication manages authentication provider metadata for users.
    """ # noqa: E501
    provider_name: Optional[StrictStr] = Field(default=None, description="Authentication provider name. This name must match the \"authentication_name\" of an existing AuthenticationProvider. It also must match the \"iss\" claim in the JWT.")
    provider_subject: Optional[StrictStr] = Field(default=None, description="Subject ID as provided by authentication provider. This is looked up from the \"sub\" (or for example \"oid\") claim on the JWT.")
    __properties: ClassVar[List[str]] = ["provider_name", "provider_subject"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmUserAuthentication from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmUserAuthentication from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "provider_subject": obj.get("provider_subject")
        })
        return _obj
