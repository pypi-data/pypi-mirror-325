...
class CdmAsu(BaseModel):
    """
    Asu holds information about asu providers of this insurance and advice offered.
    """ # noqa: E501
    asu_advice: Optional[StrictBool] = Field(default=None, description="Whether the organisation offers asu advice.")
    type: Optional[PanelManagementPanel] = PanelManagementPanel.INVALID_LENDER_PANEL_TYPE
    providers: Optional[List[StrictStr]] = Field(default=None, description="List of asu providers.")
    __properties: ClassVar[List[str]] = ["asu_advice", "type", "providers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAsu from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAsu from a dict"""
        if obj is None:
            return None
