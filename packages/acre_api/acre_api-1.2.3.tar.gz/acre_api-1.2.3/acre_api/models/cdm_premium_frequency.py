...
class CdmPremiumFrequency(str, Enum):
    """
    CdmPremiumFrequency
    """
    ...
    allowed enum values
    """
    INVALID_PREMIUM_FREQUENCY = 'INVALID_PREMIUM_FREQUENCY'
    PREMIUM_FREQUENCY_MONTHLY = 'PREMIUM_FREQUENCY_MONTHLY'
    PREMIUM_FREQUENCY_ANNUAL = 'PREMIUM_FREQUENCY_ANNUAL'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmPremiumFrequency from a JSON string"""
