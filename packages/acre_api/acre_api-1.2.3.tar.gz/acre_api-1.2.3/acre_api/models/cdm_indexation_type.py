...
class CdmIndexationType(str, Enum):
    """
    How cover amount rises with time.
    """

    """
    allowed enum values
    """
    INDEXATION_TYPE_INVALID = 'INDEXATION_TYPE_INVALID'
    INDEXATION_TYPE_LEVEL = 'INDEXATION_TYPE_LEVEL'
    INDEXATION_TYPE_RPI = 'INDEXATION_TYPE_RPI'
    INDEXATION_TYPE_AWEI = 'INDEXATION_TYPE_AWEI'
    INDEXATION_TYPE_FIXED = 'INDEXATION_TYPE_FIXED'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmIndexationType from a JSON string"""
