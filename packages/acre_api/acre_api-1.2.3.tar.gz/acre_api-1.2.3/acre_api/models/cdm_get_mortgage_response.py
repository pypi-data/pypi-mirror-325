...
class CdmGetMortgageResponse(BaseModel):
    """
    Get mortgage response.
    """ # noqa: E501
    mortgages: Optional[List[CdmMortgage]] = Field(default=None, description="The mortgages.")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetMortgageRequest] = None
    __properties: ClassVar[List[str]] = ["mortgages", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetMortgageResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetMortgageResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mortgages": [CdmMortgage.from_dict(_item) for _item in obj["mortgages"]] if obj.get("mortgages") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmGetMortgageRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
