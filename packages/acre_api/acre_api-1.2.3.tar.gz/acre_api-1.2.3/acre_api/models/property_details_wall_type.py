...
class PropertyDetailsWallType(str, Enum):
    """
     - INVALID_WALL_TYPE: option allow_alias = true;  - WIMPY_NO_FINES: DEPRECATED: this field is invalid and has been replaced by \"WIMPEY_NO_FINES\".
    """

    """
    allowed enum values
    """
    INVALID_WALL_TYPE = 'INVALID_WALL_TYPE'
    STEEL = 'STEEL'
    COBB = 'COBB'
    STANDARD_BRICK = 'STANDARD_BRICK'
    SINGLE_SKIN_BRICK = 'SINGLE_SKIN_BRICK'
    WOOLAWAY = 'WOOLAWAY'
    CORNISH_TYPE_1 = 'CORNISH_TYPE_1'
    CORNISH_TYPE_2 = 'CORNISH_TYPE_2'
    OTHER_CONCRETE = 'OTHER_CONCRETE'
    WIMPY_NO_FINES = 'WIMPY_NO_FINES'
    WIMPEY_NO_FINES = 'WIMPEY_NO_FINES'
    LAING_EASIFORM = 'LAING_EASIFORM'
    STONE = 'STONE'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PropertyDetailsWallType from a JSON string"""
