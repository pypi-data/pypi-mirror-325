...
class CdmDeleteGeneralInsuranceProductCaseResponse(BaseModel):
    """
    Response to delete a general insurance product from a case.
    """ # noqa: E501
    case_id: Optional[StrictStr] = Field(default=None, description="ID of the case to remove the protection product from.")
    general_insurance_product_id: Optional[StrictStr] = Field(default=None, description="ID of the general insurance product to remove the case.")
    general_insurance_product: Optional[CdmGeneralInsuranceProduct] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["case_id", "general_insurance_product_id", "general_insurance_product", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmDeleteGeneralInsuranceProductCaseResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of general_insurance_product
        if self.general_insurance_product:
            _dict['general_insurance_product'] = self.general_insurance_product.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmDeleteGeneralInsuranceProductCaseResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "general_insurance_product": CdmGeneralInsuranceProduct.from_dict(obj["general_insurance_product"]) if obj.get("general_insurance_product") is not None else None,
