...
class CdmEarlyRepaymentChargePeriods(BaseModel):
    """
    CdmEarlyRepaymentChargePeriods
    """ # noqa: E501
    erc_charge: Optional[StrictInt] = Field(default=None, description="The percentage of the loan amount charged for repayment during this period, represented as 1/100000 of a percent (precision for up to 5 decimal places).")
    period_fixed_length_months: Optional[StrictInt] = Field(default=None, description="If the period is for a fixed length, this represents the number of months.  An unbounded period (one that lasts until the end of mortgage) is represented with a value of -1 for this field and no value for period_fixed_end_date. There may be at most 1 unbounded period.")
    period_fixed_end_date: Optional[StrictStr] = Field(default=None, description="If the period is until a fixed date, this represents the end date (YYYY-MM-DD).  An unbounded period (one that lasts until the end of mortgage) is represented without a value in this field and a value of -1 for period_fixed_length_months. There may be at most 1 unbounded period.")
    __properties: ClassVar[List[str]] = ["erc_charge", "period_fixed_length_months", "period_fixed_end_date"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmEarlyRepaymentChargePeriods from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmEarlyRepaymentChargePeriods from a dict"""
        if obj is None:
            return None
