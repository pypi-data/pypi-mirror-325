...
class CdmConditionalOnIntroducer(BaseModel):
    """
    CdmConditionalOnIntroducer
    """ # noqa: E501
    condition: Optional[CdmCommissionPaidOnCondition] = CdmCommissionPaidOnCondition.INVALID_COMMISSION_PAID_ON_CONDITION
    introducer_company: Optional[List[StrictStr]] = Field(default=None, description="Commission paid when this value satisfies \"condition\".")
    __properties: ClassVar[List[str]] = ["condition", "introducer_company"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmConditionalOnIntroducer from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmConditionalOnIntroducer from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "introducer_company": obj.get("introducer_company")
        })
        return _obj
