...
class CdmCaseDetailsFlagType(str, Enum):
    """
    CdmCaseDetailsFlagType
    """
    ...
    FLAG_FINANCIAL_CRIME = 'FLAG_FINANCIAL_CRIME'
    FLAG_PEP = 'FLAG_PEP'
    FLAG_PROVISIONAL_COMPETENCY = 'FLAG_PROVISIONAL_COMPETENCY'
    FLAG_PROTECTION_PROVISIONAL_COMPETENCY = 'FLAG_PROTECTION_PROVISIONAL_COMPETENCY'
    FLAG_VULNERABLE = 'FLAG_VULNERABLE'
    FLAG_NATIONALITY = 'FLAG_NATIONALITY'
    FLAG_HIGH_COMMISSION = 'FLAG_HIGH_COMMISSION'
    FLAG_DEBT_CONSOLIDATION = 'FLAG_DEBT_CONSOLIDATION'
    FLAG_AML = 'FLAG_AML'
    FLAG_RIGHT_TO_BUY = 'FLAG_RIGHT_TO_BUY'
    FLAG_LENDING_INTO_RETIREMENT = 'FLAG_LENDING_INTO_RETIREMENT'
    FLAG_REDEMPTION_PENALTY = 'FLAG_REDEMPTION_PENALTY'
    FLAG_EQUITY_RELEASE = 'FLAG_EQUITY_RELEASE'
    FLAG_RESIDENTIAL_INTEREST_ONLY = 'FLAG_RESIDENTIAL_INTEREST_ONLY'
    FLAG_SECOND_JOB = 'FLAG_SECOND_JOB'
    FLAG_GIFTED_DEPOSIT = 'FLAG_GIFTED_DEPOSIT'
    FLAG_MANUAL_REVIEW = 'FLAG_MANUAL_REVIEW'
    FLAG_THIRD_PARTY_REVIEW = 'FLAG_THIRD_PARTY_REVIEW'
    FLAG_AUTOMATED_SAMPLE = 'FLAG_AUTOMATED_SAMPLE'
    FLAG_COMPLAINT = 'FLAG_COMPLAINT'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmCaseDetailsFlagType from a JSON string"""
