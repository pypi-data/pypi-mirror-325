...
class ClientIncomeDetailIncomeType(str, Enum):
    """
    Income type.
    """
    ...
    allowed enum values
    """
    INVALID_INCOME_TYPE = 'INVALID_INCOME_TYPE'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientIncomeDetailIncomeType from a JSON string"""
