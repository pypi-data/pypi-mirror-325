...
class ClientDetailsBankruptcyEvent(BaseModel):
    """
    ClientDetailsBankruptcyEvent
    """ # noqa: E501
    bankruptcy_date: Optional[StrictStr] = Field(default=None, description="The date of bankruptcy (YYYY-MM-DD).")
    discharge_date: Optional[StrictStr] = Field(default=None, description="The bankruptcy discharge date.")
    court: Optional[StrictStr] = Field(default=None, description="The court in which the bankruptcy was declared.")
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for this entry.")
    __properties: ClassVar[List[str]] = ["bankruptcy_date", "discharge_date", "court", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClientDetailsBankruptcyEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClientDetailsBankruptcyEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "bankruptcy_date": obj.get("bankruptcy_date"),
            "discharge_date": obj.get("discharge_date"),
            "court": obj.get("court"),
            "id": obj.get("id")
        })
        return _obj
