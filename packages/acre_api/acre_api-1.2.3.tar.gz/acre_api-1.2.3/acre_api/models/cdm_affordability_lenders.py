...
class CdmAffordabilityLenders(BaseModel):
    """
    Details of the affordability lender and their signature.
    """ # noqa: E501
    lender_id: Optional[StrictStr] = Field(default=None, description="Lender identifier. This is the normalised name with underscores instead of spaces.")
    signature: Optional[StrictStr] = Field(default=None, description="Cryptographic hash of the lender result of the affordability search.")
    __properties: ClassVar[List[str]] = ["lender_id", "signature"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAffordabilityLenders from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAffordabilityLenders from a dict"""
        if obj is None:
            return None
