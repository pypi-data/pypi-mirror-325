...
class CdmPermissionResolutionResult(BaseModel):
    """
    Result of the permission resolution.
    """ # noqa: E501
    permission_name: Optional[StrictStr] = None
    scope: Optional[CdmPermissionScope] = None
    has_permission: Optional[StrictBool] = None
    assignee: Optional[CdmPermissionAssignee] = None
    __properties: ClassVar[List[str]] = ["permission_name", "scope", "has_permission", "assignee"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmPermissionResolutionResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmPermissionResolutionResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "scope": CdmPermissionScope.from_dict(obj["scope"]) if obj.get("scope") is not None else None,
            "has_permission": obj.get("has_permission"),
            "assignee": CdmPermissionAssignee.from_dict(obj["assignee"]) if obj.get("assignee") is not None else None
        })
        return _obj
