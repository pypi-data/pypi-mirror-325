...
class CdmAddMortgageProductResponse(BaseModel):
    """
    Response to adding a product to a mortgage.
    """ # noqa: E501
    mortgage_id: Optional[StrictStr] = Field(default=None, description="ID of the mortgage that added the product.")
    product_id: Optional[StrictStr] = Field(default=None, description="ID of the product added to the mortgage.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAddMortgageProductResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAddMortgageProductResponse from a dict"""
        if obj is None:
            return None
