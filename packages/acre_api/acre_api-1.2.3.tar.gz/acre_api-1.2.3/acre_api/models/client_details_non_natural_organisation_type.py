...
class ClientDetailsNonNaturalOrganisationType(str, Enum):
    """
    ClientDetailsNonNaturalOrganisationType
    """

    """
    allowed enum values
    """
    INVALID_NON_NATURAL_ORGANISATION_TYPE = 'INVALID_NON_NATURAL_ORGANISATION_TYPE'
    LIMITED = 'LIMITED'
    PLC = 'PLC'
    LLP = 'LLP'
    INCORPORATED_TRUST = 'INCORPORATED_TRUST'
    GOVERNMENTAL_BODY = 'GOVERNMENTAL_BODY'
    CHARTERED_BODY = 'CHARTERED_BODY'
    NON_NATURAL_ORGANISATION_TYPE_OTHER = 'NON_NATURAL_ORGANISATION_TYPE_OTHER'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientDetailsNonNaturalOrganisationType from a JSON string"""
