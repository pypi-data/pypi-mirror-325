...
class CdmRelatedCaseRelationshipType(str, Enum):
    """
    Types of relationships to the related case.   - REFERRAL_TARGET: Denotes that the related case was referred from the case that this object is on.  - REFERRAL_SOURCE: Denotes that the case that this object is on was created from the related case.  - REMORTGAGE_OF: Denotes that the case that this object is on is a remortgage of the related case.  - REMORTGAGE_LEAD: Denotes that the case this this object is on is the predecessor of a remortgage case.
    """
    ...
    REMORTGAGE_OF = 'REMORTGAGE_OF'
    REMORTGAGE_LEAD = 'REMORTGAGE_LEAD'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmRelatedCaseRelationshipType from a JSON string"""
