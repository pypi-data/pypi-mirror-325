...
class CdmClient(BaseModel):
    """
    Client maintains information about a client.
    """ # noqa: E501
    client_id: Optional[StrictStr] = Field(default=None, description="Client reference. Populated automatically; cannot be set.")
    created_at: Optional[StrictStr] = Field(default=None, description="Creation date (RFC3339) of the client. Populated automatically; cannot be set.")
    ...
    details: Optional[CdmClientDetails] = None
    versions: Optional[List[CdmVersionDetails]] = Field(default=None, description="Change details of previous versions.")
    __properties: ClassVar[List[str]] = ["client_id", "created_at", "version", "version_created_at", "details", "versions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmClient from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmClient from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "details": CdmClientDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,
