...
class UiReferenceSection(str, Enum):
    """
    UiReferenceSection
    """
    ...
    SOURCING_PREFERENCES = 'SOURCING_PREFERENCES'
    PROTECTION = 'PROTECTION'
    PROTECTION_PRE_QUALIFICATION = 'PROTECTION_PRE_QUALIFICATION'
    EXISTING_PROTECTION = 'EXISTING_PROTECTION'
    PROTECTION_REQUIREMENTS = 'PROTECTION_REQUIREMENTS'
    PROTECTION_RECOMMENDATION = 'PROTECTION_RECOMMENDATION'
    PROTECTION_PRODUCTS = 'PROTECTION_PRODUCTS'
    SOURCING_PRODUCTS = 'SOURCING_PRODUCTS'
    GI_PRODUCTS = 'GI_PRODUCTS'
    GI_SOURCING = 'GI_SOURCING'
    DOCUMENTS = 'DOCUMENTS'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UiReferenceSection from a JSON string"""
