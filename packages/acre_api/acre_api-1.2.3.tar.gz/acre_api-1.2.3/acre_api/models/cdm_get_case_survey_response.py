...
class CdmGetCaseSurveyResponse(BaseModel):
    """
    GetCaseSurveyResponse response type for the client survey.
    """ # noqa: E501
    questions: Optional[List[CdmQuestion]] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["questions", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetCaseSurveyResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetCaseSurveyResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "questions": [CdmQuestion.from_dict(_item) for _item in obj["questions"]] if obj.get("questions") is not None else None,
