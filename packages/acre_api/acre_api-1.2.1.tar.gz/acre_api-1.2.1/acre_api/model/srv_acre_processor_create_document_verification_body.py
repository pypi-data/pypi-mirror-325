...
class SrvAcreProcessorCreateDocumentVerificationBody(BaseModel):
    """
    Create a document verification record.
    """ # noqa: E501
    document_signature: Optional[StrictStr] = Field(default=None, description="Signature as received from Render Template / Retrieve Document API.")
    verification_type: Optional[CdmVerificationType] = CdmVerificationType.INVALID_VERIFICATION_TYPE
    verification_fingerprint_ip: Optional[StrictStr] = None
    verification_fingerprint_user_agent: Optional[StrictStr] = None
    verification_fingerprint_referer: Optional[StrictStr] = None
    verification_fingerprint_browser_id: Optional[StrictStr] = None
    ...
    provider_reference: Optional[StrictStr] = Field(default=None, description="If verification is automated, provider UID for this verification. **IMPORTANT** This field cannot be set when source is manual (USER, USER_ON_BEHALF_OF_CLIENT, CLIENT).")
    source_response: Optional[StrictStr] = Field(default=None, description="If verification is automated, raw response from verification provider. **IMPORTANT** This field cannot be set when source is manual (USER, USER_ON_BEHALF_OF_CLIENT, CLIENT).")
    extended_device_details: Optional[CdmExtendedDeviceDetails] = None
    __properties: ClassVar[List[str]] = ["document_signature", "verification_type", "verification_fingerprint_ip", "verification_fingerprint_user_agent", "verification_fingerprint_referer", "verification_fingerprint_browser_id", "source", "client_id", "result", "result_justification", "extended_result", "provider_reference", "source_response", "extended_device_details"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SrvAcreProcessorCreateDocumentVerificationBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SrvAcreProcessorCreateDocumentVerificationBody from a dict"""
        if obj is None:
            return None
