...
class CdmGetGroupResponse(BaseModel):
    """
    Response to a get group request.
    """ # noqa: E501
    groups: Optional[List[CdmGroup]] = None
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetGroupRequest] = None
    __properties: ClassVar[List[str]] = ["groups", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetGroupResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetGroupResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "groups": [CdmGroup.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmGetGroupRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
