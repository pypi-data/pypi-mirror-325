...
class GeneralInsuranceProductDetailsGIProductType(str, Enum):
    """
    GeneralInsuranceProductDetailsGIProductType
    """

    """
    allowed enum values
    """
    INVALID_GI_PRODUCT_TYPE = 'INVALID_GI_PRODUCT_TYPE'
    BUILDINGS = 'BUILDINGS'
    CONTENTS_ONLY = 'CONTENTS_ONLY'
    BUILDINGS_AND_CONTENTS = 'BUILDINGS_AND_CONTENTS'
    LANDLORDS_CONTENTS = 'LANDLORDS_CONTENTS'
    BUILDINGS_AND_LANDLORDS_CONTENTS = 'BUILDINGS_AND_LANDLORDS_CONTENTS'
    TERRORISM = 'TERRORISM'
    FLOOD = 'FLOOD'
    OTHER = 'OTHER'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GeneralInsuranceProductDetailsGIProductType from a JSON string"""
