...
class CaseDetailsConveyancer(BaseModel):
    """
    Holds details of a conveyancer.
    """ # noqa: E501
    firm_name: Optional[StrictStr] = Field(default=None, description="The name of the firm used.")
    contact_name: Optional[StrictStr] = Field(default=None, description="Contact name at the conveyancer.")
    ...
    dx_number: Optional[StrictStr] = Field(default=None, description="DX Number of firm.")
    dx_town: Optional[StrictStr] = Field(default=None, description="DX Town of firm.")
    case_reference: Optional[StrictStr] = Field(default=None, description="Conveyancer's case reference.")
    __properties: ClassVar[List[str]] = ["firm_name", "contact_name", "email_address", "phone_number", "dx_number", "dx_town", "case_reference"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CaseDetailsConveyancer from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CaseDetailsConveyancer from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "dx_number": obj.get("dx_number"),
            "dx_town": obj.get("dx_town"),
