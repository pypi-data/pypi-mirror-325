...
class ClientOutstandingDebtRepaymentStatusType(str, Enum):
    """
    A summary of the payment history.   - SETTLED: DEPRECATED: Use field account_status instead.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientOutstandingDebtRepaymentStatusType from a JSON string"""
