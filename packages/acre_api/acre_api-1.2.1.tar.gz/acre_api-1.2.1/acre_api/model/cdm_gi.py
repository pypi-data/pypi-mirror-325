...
class CdmGi(BaseModel):
    """
    Gi holds information about gi providers of this insurance, payment shield branch number, uinsure auto refer and advice offered.
    """ # noqa: E501
    gi_advice: Optional[StrictBool] = Field(default=None, description="Whether the organisation offers gi advice.")
    type: Optional[PanelManagementPanel] = PanelManagementPanel.INVALID_LENDER_PANEL_TYPE
    uinsure_auto_refer: Optional[StrictBool] = Field(default=None, description="Whether to auto refer to UInsure.")
    paymentshield_branch_number: Optional[StrictStr] = Field(default=None, description="The payment shield branch number.")
    providers: Optional[List[StrictStr]] = Field(default=None, description="List of gi providers.")
    __properties: ClassVar[List[str]] = ["gi_advice", "type", "uinsure_auto_refer", "paymentshield_branch_number", "providers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGi from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGi from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "gi_advice": obj.get("gi_advice"),
            "type": obj.get("type") if obj.get("type") is not None else PanelManagementPanel.INVALID_LENDER_PANEL_TYPE,
            "uinsure_auto_refer": obj.get("uinsure_auto_refer"),
            "paymentshield_branch_number": obj.get("paymentshield_branch_number"),
