...
class MortgageProductDetailsStressTestPayment(BaseModel):
    """
    Calculated stress test monthly payments.
    """ # noqa: E501
    rate_increment_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The percentage rate increase that applies to these calculations.")
    initial_monthly_payment: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The initial monthly payment, given the rate change listed in the RateIncrementPercent field.")
    monthly_payment_after_initial_period: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The monthly payment for the product after the initial rate period has ended (reversionary rate), given the rate change listed in the RateIncrementPercent field.")
    __properties: ClassVar[List[str]] = ["rate_increment_percent", "initial_monthly_payment", "monthly_payment_after_initial_period"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MortgageProductDetailsStressTestPayment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MortgageProductDetailsStressTestPayment from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "rate_increment_percent": obj.get("rate_increment_percent"),
            "initial_monthly_payment": obj.get("initial_monthly_payment"),
            "monthly_payment_after_initial_period": obj.get("monthly_payment_after_initial_period")
        })
        return _obj
