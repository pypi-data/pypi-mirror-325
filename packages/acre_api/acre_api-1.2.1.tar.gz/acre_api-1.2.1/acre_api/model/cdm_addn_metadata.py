...
class CdmAddnMetadata(BaseModel):
    """
    CdmAddnMetadata
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name (key) of the key:value pair.")
    string_value: Optional[StrictStr] = Field(default=None, description="A string value for the key:value pair.")
    __properties: ClassVar[List[str]] = ["name", "string_value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAddnMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAddnMetadata from a dict"""
        if obj is None:
            return None
