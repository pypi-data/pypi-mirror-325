...
class CommissionDetailsCommissionPaymentDue(str, Enum):
    """
    Case stage at which the payment is due. Note that this extends the case status options.
    """

    """
    allowed enum values
    """
    INVALID_PAYMENT_DUE = 'INVALID_PAYMENT_DUE'
    PRE_RECOMMENDATION = 'PRE_RECOMMENDATION'
    REVIEW = 'REVIEW'
    POST_RECOMMENDATION_REVIEW = 'POST_RECOMMENDATION_REVIEW'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CommissionDetailsCommissionPaymentDue from a JSON string"""
