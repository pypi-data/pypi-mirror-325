...
class SourceDetailsTenantStatus(str, Enum):
    """
    SourceDetailsTenantStatus
    """
    ...
    TENANT_DSS = 'TENANT_DSS'
    TENANT_STUDENT = 'TENANT_STUDENT'
    TENANT_UNSPECIFIED = 'TENANT_UNSPECIFIED'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SourceDetailsTenantStatus from a JSON string"""
