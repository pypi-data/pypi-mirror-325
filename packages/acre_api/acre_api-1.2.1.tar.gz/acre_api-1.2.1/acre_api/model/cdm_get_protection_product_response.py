...
class CdmGetProtectionProductResponse(BaseModel):
    """
    Response to a get protection product request.
    """ # noqa: E501
    protection_products: Optional[List[CdmProtectionProduct]] = Field(default=None, description="The protection product.")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetProtectionProductRequest] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetProtectionProductResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetProtectionProductResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "next_page": CdmGetProtectionProductRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
