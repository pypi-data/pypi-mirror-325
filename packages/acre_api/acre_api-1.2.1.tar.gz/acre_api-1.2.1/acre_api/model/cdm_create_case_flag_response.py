...
class CdmCreateCaseFlagResponse(BaseModel):
    """
    Response to case flag creation.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["documents", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateCaseFlagResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateCaseFlagResponse from a dict"""
        if obj is None:
            return None
