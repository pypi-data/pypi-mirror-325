...
class V1Exception(BaseModel):
    """
    General message for exceptions.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="UUID for exception.")
    type: Optional[V1ExceptionType] = V1ExceptionType.INVALID_TYPE
    timestamp: Optional[StrictStr] = Field(default=None, description="Timestamp for when the exception occurred (RFC3339).")
    description: Optional[StrictStr] = Field(default=None, description="Human readable description of exception.")
    exception_metadata: Optional[Dict[str, StrictStr]] = Field(default=None, description="Additional metadata about the exception.")
    __properties: ClassVar[List[str]] = ["id", "type", "timestamp", "description", "exception_metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1Exception from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1Exception from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else V1ExceptionType.INVALID_TYPE,
            "timestamp": obj.get("timestamp"),
            "description": obj.get("description"),
            "exception_metadata": obj.get("exception_metadata")
        })
        return _obj
