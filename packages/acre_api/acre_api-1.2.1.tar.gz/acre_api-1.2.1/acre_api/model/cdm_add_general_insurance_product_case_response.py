...
class CdmAddGeneralInsuranceProductCaseResponse(BaseModel):
    """
    Response to adding a general insurance product to a case.
    """ # noqa: E501
    case_id: Optional[StrictStr] = Field(default=None, description="ID of the case added.")
    general_insurance_product_id: Optional[StrictStr] = Field(default=None, description="ID of the general insurance product to be added to the case.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAddGeneralInsuranceProductCaseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAddGeneralInsuranceProductCaseResponse from a dict"""
        if obj is None:
            return None
