...
class CdmVerificationClass(str, Enum):
    """
    VerificationClass groups the verification and indicates the intent of the verification.   - VERIFICATION_CLASS_STANDARD: Standard class indicates the verification is always ran. Data verified is required by downstream services. Not Configurable by Org.  - VERIFICATION_CLASS_ENHANCED: Enhanced class indicates the verification is additional and provide an enhanced level of check, more in line with a Network model. Configurable by Org.  - VERIFICATION_CLASS_BETA: Beta class indicates the verification requires additional testing. Configurable by Org.  - VERIFICATION_CLASS_OPTIONAL: Optional class indicates the verification isn't required to run core Acre functionality and are additional checks to those specified in ENHANCED. Configurable by Org.  - VERIFICATION_CLASS_INFORMATIONAL: Informational class indicates the verification is beyond the control of the organisation, this could be information given by Acre.
    """

    """
    allowed enum values
    """
    INVALID_VERIFICATION_CLASS = 'INVALID_VERIFICATION_CLASS'
    VERIFICATION_CLASS_STANDARD = 'VERIFICATION_CLASS_STANDARD'
    VERIFICATION_CLASS_ENHANCED = 'VERIFICATION_CLASS_ENHANCED'
    VERIFICATION_CLASS_BETA = 'VERIFICATION_CLASS_BETA'
    VERIFICATION_CLASS_OPTIONAL = 'VERIFICATION_CLASS_OPTIONAL'
    VERIFICATION_CLASS_INFORMATIONAL = 'VERIFICATION_CLASS_INFORMATIONAL'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmVerificationClass from a JSON string"""
