...
class CaseDetailsMortgageReason(str, Enum):
    """
    CaseDetailsMortgageReason
    """

    """
    allowed enum values
    """
    INVALID_MORTGAGE_REASON = 'INVALID_MORTGAGE_REASON'
    ...
    REASON_FURTHER_ADVANCE = 'REASON_FURTHER_ADVANCE'
    REASON_BTL_REMORTGAGE = 'REASON_BTL_REMORTGAGE'
    REASON_PROTECTION = 'REASON_PROTECTION'
    REASON_COMMERCIAL = 'REASON_COMMERCIAL'
    REASON_BRIDGING = 'REASON_BRIDGING'
    REASON_BUSINESS_PROTECTION = 'REASON_BUSINESS_PROTECTION'
    REASON_GENERAL_INSURANCE = 'REASON_GENERAL_INSURANCE'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CaseDetailsMortgageReason from a JSON string"""
