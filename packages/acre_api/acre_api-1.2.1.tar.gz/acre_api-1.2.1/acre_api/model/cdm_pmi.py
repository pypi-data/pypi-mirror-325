...
class CdmPmi(BaseModel):
    """
    Pmi holds information about pmi providers of this insurance and advice offered.
    """ # noqa: E501
    pmi_advice: Optional[StrictBool] = Field(default=None, description="Whether the organisation offers pmi advice.")
    type: Optional[PanelManagementPanel] = PanelManagementPanel.INVALID_LENDER_PANEL_TYPE
    providers: Optional[List[StrictStr]] = Field(default=None, description="List of pmi providers.")
    __properties: ClassVar[List[str]] = ["pmi_advice", "type", "providers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmPmi from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmPmi from a dict"""
        if obj is None:
            return None
