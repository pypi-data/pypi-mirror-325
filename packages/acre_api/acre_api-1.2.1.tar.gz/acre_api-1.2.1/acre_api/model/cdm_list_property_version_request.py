...
class CdmListPropertyVersionRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["property_id", "bookmark", "page_size", "show_history"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmListPropertyVersionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmListPropertyVersionRequest from a dict"""
        if obj is None:
            return None
