...
class CdmNonNatural(BaseModel):
    """
    CdmNonNatural
    """ # noqa: E501
    number_of_employees: Optional[StrictStr] = Field(default=None, description="The number of employees of non-natural clients for the purpose of quoting business protection.")
    turnover: Optional[StrictStr] = Field(default=None, description="The turnover (in pence) for non-natural client.")
    __properties: ClassVar[List[str]] = ["number_of_employees", "turnover"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmNonNatural from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmNonNatural from a dict"""
        if obj is None:
            return None
