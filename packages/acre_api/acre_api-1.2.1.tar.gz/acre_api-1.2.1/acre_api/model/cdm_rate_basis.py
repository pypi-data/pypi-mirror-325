...
class CdmRateBasis(str, Enum):
    """
    Rate types which a mortgage may be tracking.
    """

    """
    allowed enum values
    """
    INVALID_RATE_BASIS = 'INVALID_RATE_BASIS'
    BOE_BASE_RATE = 'BOE_BASE_RATE'
    LENDER_SVR = 'LENDER_SVR'
    LENDER_SVR_2 = 'LENDER_SVR_2'
    LENDER_SVR_3 = 'LENDER_SVR_3'
    LENDER_SVR_4 = 'LENDER_SVR_4'
    LENDER_SVR_5 = 'LENDER_SVR_5'
    LENDER_SVR_6 = 'LENDER_SVR_6'
    LENDER_SVR_7 = 'LENDER_SVR_7'
    LIBOR = 'LIBOR'
    LIBOR_1_M = 'LIBOR_1M'
    LIBOR_3_M = 'LIBOR_3M'
    LIBOR_6_M = 'LIBOR_6M'
    LIBOR_1_YR = 'LIBOR_1YR'
    SONIA = 'SONIA'
    SONIA_1_M = 'SONIA_1M'
    SONIA_3_M = 'SONIA_3M'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmRateBasis from a JSON string"""
