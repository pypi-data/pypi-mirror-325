...
class CdmSourceDetailsPropertyTenure(str, Enum):
    """
    CdmSourceDetailsPropertyTenure
    """

    """
    allowed enum values
    """
    INVALID_PROPERTY_TENURE = 'INVALID_PROPERTY_TENURE'
    PROPERTY_TENURE_FREEHOLD = 'PROPERTY_TENURE_FREEHOLD'
    PROPERTY_TENURE_FLYING_FREEHOLD = 'PROPERTY_TENURE_FLYING_FREEHOLD'
    PROPERTY_TENURE_LEASEHOLD = 'PROPERTY_TENURE_LEASEHOLD'
    PROPERTY_TENURE_COMMONHOLD = 'PROPERTY_TENURE_COMMONHOLD'
    PROPERTY_TENURE_FEUDAL = 'PROPERTY_TENURE_FEUDAL'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmSourceDetailsPropertyTenure from a JSON string"""
