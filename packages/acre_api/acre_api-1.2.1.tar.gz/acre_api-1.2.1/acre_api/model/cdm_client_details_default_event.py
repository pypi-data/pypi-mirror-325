...
class CdmClientDetailsDefaultEvent(BaseModel):
    """
    DEPRECATED - use default event on a commitment instead.
    """ # noqa: E501
    date_registered: Optional[StrictStr] = Field(default=None, description="The date the default was registered (YYYY-MM-DD).")
    date_satisfied: Optional[StrictStr] = Field(default=None, description="The date the default was satisfied (YYYY-MM-DD).")
    amount: Optional[StrictStr] = Field(default=None, description="The amount of the default (in pence, not GBP).")
    creditor_name: Optional[StrictStr] = Field(default=None, description="The name of the Creditor if applicable.  DEPRECATED: due to GBP to pence conversion.  string amount = 3;")
    __properties: ClassVar[List[str]] = ["date_registered", "date_satisfied", "amount", "creditor_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmClientDetailsDefaultEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmClientDetailsDefaultEvent from a dict"""
        if obj is None:
            return None
