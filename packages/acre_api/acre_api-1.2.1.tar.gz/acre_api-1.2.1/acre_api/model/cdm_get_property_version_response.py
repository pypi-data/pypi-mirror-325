...
class CdmGetPropertyVersionResponse(BaseModel):
    """
    Response to get a property with version.
    """ # noqa: E501
    var_property: Optional[CdmProperty] = Field(default=None, alias="property")
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["property", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetPropertyVersionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetPropertyVersionResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "property": CdmProperty.from_dict(obj["property"]) if obj.get("property") is not None else None,
