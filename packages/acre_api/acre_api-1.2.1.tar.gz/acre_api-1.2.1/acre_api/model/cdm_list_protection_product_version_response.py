...
class CdmListProtectionProductVersionResponse(BaseModel):
    """
    Response to list protection product versions.
    """ # noqa: E501
    protection_products: Optional[List[CdmProtectionProduct]] = Field(default=None, description="Protection product versions (in each protection product object, details will be null).")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmListProtectionProductVersionRequest] = None
    __properties: ClassVar[List[str]] = ["protection_products", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmListProtectionProductVersionResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in protection_products (list)
        _items = []
        if self.protection_products:
            for _item_protection_products in self.protection_products:
                if _item_protection_products:
                    _items.append(_item_protection_products.to_dict())
            _dict['protection_products'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmListProtectionProductVersionResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "protection_products": [CdmProtectionProduct.from_dict(_item) for _item in obj["protection_products"]] if obj.get("protection_products") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmListProtectionProductVersionRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
