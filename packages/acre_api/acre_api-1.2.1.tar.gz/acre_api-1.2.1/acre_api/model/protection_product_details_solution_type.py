...
class ProtectionProductDetailsSolutionType(str, Enum):
    """
    SolutionType describes the type of the solution that product belongs to.   - INVALID_SOLUTION_TYPE: Invalid solution type  - MULTIPLE_BENEFITS_IN_ONE_PRODUCT: Solution contains products, with each product covering all requested product benefits.  - ONE_BENEFIT_PER_PRODUCT: Solution contains separated products per benefit & per client.  - MULTIPLE_BENEFITS_IN_MULTIPLE_PRODUCTS: Benefits are grouped into multiple products (e.g. joint life or earlier CIC, with first life IP as a separate policy). This essentially tries to join Life & CIC where possible and separates out the IP.
    """
    ...
    MULTIPLE_BENEFITS_IN_ONE_PRODUCT = 'MULTIPLE_BENEFITS_IN_ONE_PRODUCT'
    ONE_BENEFIT_PER_PRODUCT = 'ONE_BENEFIT_PER_PRODUCT'
    MULTIPLE_BENEFITS_IN_MULTIPLE_PRODUCTS = 'MULTIPLE_BENEFITS_IN_MULTIPLE_PRODUCTS'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProtectionProductDetailsSolutionType from a JSON string"""
