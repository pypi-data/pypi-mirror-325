...
class CdmOrganisationVerificationClass(BaseModel):
    """
    VerificationClass contains the enforcement level for each Verification Class.
    """ # noqa: E501
    enhanced: Optional[CdmEnforcementLevel] = CdmEnforcementLevel.INVALID_ENFORCEMENT_LEVEL
    optional: Optional[CdmEnforcementLevel] = CdmEnforcementLevel.INVALID_ENFORCEMENT_LEVEL
    beta: Optional[CdmEnforcementLevel] = CdmEnforcementLevel.INVALID_ENFORCEMENT_LEVEL
    __properties: ClassVar[List[str]] = ["enhanced", "optional", "beta"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmOrganisationVerificationClass from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmOrganisationVerificationClass from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "enhanced": obj.get("enhanced") if obj.get("enhanced") is not None else CdmEnforcementLevel.INVALID_ENFORCEMENT_LEVEL,
            "optional": obj.get("optional") if obj.get("optional") is not None else CdmEnforcementLevel.INVALID_ENFORCEMENT_LEVEL,
            "beta": obj.get("beta") if obj.get("beta") is not None else CdmEnforcementLevel.INVALID_ENFORCEMENT_LEVEL
        })
        return _obj
