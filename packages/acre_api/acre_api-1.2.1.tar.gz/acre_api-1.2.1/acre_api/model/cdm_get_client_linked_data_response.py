...
class CdmGetClientLinkedDataResponse(BaseModel):
    """
    Response to get the data that will be removed from a client if DeleteClientData would be called.
    """ # noqa: E501
    client_data: Optional[StrictStr] = Field(default=None, description="The client data that will be removed.")
    health_data: Optional[StrictStr] = Field(default=None, description="The health client data that will be removed.")
    hash: Optional[StrictStr] = Field(default=None, description="Hash that should be given to DeleteClientData, to confirm the data that will be removed.")
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["client_data", "health_data", "hash", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetClientLinkedDataResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetClientLinkedDataResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "health_data": obj.get("health_data"),
            "hash": obj.get("hash"),
