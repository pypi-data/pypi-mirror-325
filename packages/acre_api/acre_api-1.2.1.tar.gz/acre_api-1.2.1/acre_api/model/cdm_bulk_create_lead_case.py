...
class CdmBulkCreateLeadCase(BaseModel):
    """
    Case ID and auto assign bool for bulk lead case creation from complete cases.
    """ # noqa: E501
    case_id: Optional[StrictStr] = Field(default=None, description="Case ID to be create lead case from.")
    auto_assign: Optional[StrictBool] = Field(default=None, description="Auto assign owner user ID from complete case.")
    __properties: ClassVar[List[str]] = ["case_id", "auto_assign"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmBulkCreateLeadCase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmBulkCreateLeadCase from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "auto_assign": obj.get("auto_assign")
        })
        return _obj
