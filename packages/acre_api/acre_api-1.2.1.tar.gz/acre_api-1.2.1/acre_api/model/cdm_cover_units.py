...
class CdmCoverUnits(str, Enum):
    ...
    allowed enum values
    """
    COVER_UNITS_INVALID = 'COVER_UNITS_INVALID'
    COVER_UNITS_UNIT_1 = 'COVER_UNITS_UNIT_1'
    COVER_UNITS_UNIT_2 = 'COVER_UNITS_UNIT_2'
    COVER_UNITS_UNIT_3 = 'COVER_UNITS_UNIT_3'
    COVER_UNITS_UNIT_4 = 'COVER_UNITS_UNIT_4'
    COVER_UNITS_UNIT_5 = 'COVER_UNITS_UNIT_5'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmCoverUnits from a JSON string"""
