...
class CdmSourceDetailsTermUnit(str, Enum):
    """
     - TERM_MONTHS: Months (default).
    """

    """
    allowed enum values
    """
    INVALID_TERM_UNIT = 'INVALID_TERM_UNIT'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmSourceDetailsTermUnit from a JSON string"""
