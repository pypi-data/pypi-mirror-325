...
class CdmOrgTemplateConfig(BaseModel):
    """
    CdmOrgTemplateConfig
    """ # noqa: E501
    template_name: Optional[CdmTemplateName] = CdmTemplateName.INVALID_TEMPLATE_NAME
    document_name_prefix: Optional[StrictStr] = Field(default=None, description="The custom document name when rendering this template.")
    __properties: ClassVar[List[str]] = ["template_name", "document_name_prefix"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmOrgTemplateConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmOrgTemplateConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "document_name_prefix": obj.get("document_name_prefix")
        })
        return _obj
