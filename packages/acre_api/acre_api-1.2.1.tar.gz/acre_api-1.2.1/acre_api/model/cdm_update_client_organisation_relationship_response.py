...
class CdmUpdateClientOrganisationRelationshipResponse(BaseModel):
    """
    Response to the update of a client's client organisation relationship.
    """ # noqa: E501
    client_organisation_relationship: Optional[CdmClientOrganisationRelationship] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["client_organisation_relationship", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmUpdateClientOrganisationRelationshipResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmUpdateClientOrganisationRelationshipResponse from a dict"""
        if obj is None:
            return None
