...
class CdmCreateGeneralInsuranceProductRequest(BaseModel):
    """
    Create a new general insurance product.
    """ # noqa: E501
    general_insurance_product: CdmGeneralInsuranceProduct
    __properties: ClassVar[List[str]] = ["general_insurance_product"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateGeneralInsuranceProductRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateGeneralInsuranceProductRequest from a dict"""
        if obj is None:
            return None
