...
class CdmGetOrganisationResponse(BaseModel):
    """
    Response to a request for details of organisations.
    """ # noqa: E501
    organisations: Optional[List[CdmOrganisation]] = None
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetOrganisationRequest] = None
    __properties: ClassVar[List[str]] = ["organisations", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetOrganisationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetOrganisationResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "organisations": [CdmOrganisation.from_dict(_item) for _item in obj["organisations"]] if obj.get("organisations") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmGetOrganisationRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
