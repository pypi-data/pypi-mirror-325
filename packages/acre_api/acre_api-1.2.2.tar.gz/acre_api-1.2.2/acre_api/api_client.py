...
from acre_api.api_response import ApiResponse, T as ApiResponseT
import acre_api.models
from acre_api import rest
from acre_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(acre_api.models, klass)
