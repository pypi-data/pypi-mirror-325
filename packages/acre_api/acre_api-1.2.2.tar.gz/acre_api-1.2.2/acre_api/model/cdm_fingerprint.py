...
class CdmFingerprint(BaseModel):
    """
    Generic fingerprint filed used when obtaining consent, verifications etc.
    """ # noqa: E501
    ip: Optional[StrictStr] = Field(default=None, description="This field cannot be updated/set directly, and is populated by the backend automatically.")
    user_agent: Optional[StrictStr] = Field(default=None, description="This field cannot be updated/set directly, and is populated by the backend automatically.")
    referer: Optional[StrictStr] = Field(default=None, description="This field cannot be updated/set directly, and is populated by the backend automatically.")
    browser_id: Optional[StrictStr] = Field(default=None, description="This field is set by the client.")
    __properties: ClassVar[List[str]] = ["ip", "user_agent", "referer", "browser_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmFingerprint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmFingerprint from a dict"""
        if obj is None:
            return None
