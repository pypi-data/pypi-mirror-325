...
class CdmPremiumType(str, Enum):
    ...
    allowed enum values
    """
    PREMIUM_TYPE_INVALID = 'PREMIUM_TYPE_INVALID'
    PREMIUM_TYPE_REVIEWABLE = 'PREMIUM_TYPE_REVIEWABLE'
    PREMIUM_TYPE_GUARANTEED = 'PREMIUM_TYPE_GUARANTEED'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmPremiumType from a JSON string"""
