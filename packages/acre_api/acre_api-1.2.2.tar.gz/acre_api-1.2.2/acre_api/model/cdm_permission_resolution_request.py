...
class CdmPermissionResolutionRequest(BaseModel):
    """
    Request to resolve a single permission with specified scope and assignee.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["permission_name", "scope", "assignee"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmPermissionResolutionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmPermissionResolutionRequest from a dict"""
        if obj is None:
            return None
