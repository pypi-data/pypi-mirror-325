...
class PropertyDetailsPropertyUse(str, Enum):
    """
     - HOLIDAY_HOME: Personal use holiday home.
    """

    """
    allowed enum values
    """
    INVALID_PROPERTY_USE = 'INVALID_PROPERTY_USE'
    PRIMARY_RESIDENCE = 'PRIMARY_RESIDENCE'
    SECOND_HOME = 'SECOND_HOME'
    HOLIDAY_HOME = 'HOLIDAY_HOME'
    TENANTED = 'TENANTED'
    LET_HOLIDAY_HOME = 'LET_HOLIDAY_HOME'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PropertyDetailsPropertyUse from a JSON string"""
