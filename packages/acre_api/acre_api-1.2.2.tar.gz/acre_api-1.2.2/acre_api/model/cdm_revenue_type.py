...
class CdmRevenueType(str, Enum):
    ...
    MORTGAGE_PROC_FEE = 'MORTGAGE_PROC_FEE'
    PROTECTION_COMMISSION = 'PROTECTION_COMMISSION'
    GI_COMMISSION = 'GI_COMMISSION'
    CASE_FEES = 'CASE_FEES'
    REFERRALS = 'REFERRALS'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmRevenueType from a JSON string"""
