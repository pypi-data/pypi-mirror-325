...
class CdmKBAStatus(str, Enum):
    """
     - INVALID_STATE: The KBA process hasn't been started.  - SESSION_ONE: The first questionnaire has been retrieved.  - SESSION_TWO: The first questionnaire has been answered with low accuracy. The second questionnaire is needed.  - PASS: The first/second questionnaire has been answered with high accuracy. The attempt is passed.  - FAIL: The first/second questionnaire has been answered with low accuracy. The attempt is failed.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmKBAStatus from a JSON string"""
