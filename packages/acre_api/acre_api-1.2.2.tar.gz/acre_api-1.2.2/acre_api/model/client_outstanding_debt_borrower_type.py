...
class ClientOutstandingDebtBorrowerType(str, Enum):
    """
    ClientOutstandingDebtBorrowerType
    """

    """
    allowed enum values
    """
    INVALID_BORROWER_TYPE = 'INVALID_BORROWER_TYPE'
    APPLICANT = 'APPLICANT'
    GUARANTOR = 'GUARANTOR'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientOutstandingDebtBorrowerType from a JSON string"""
