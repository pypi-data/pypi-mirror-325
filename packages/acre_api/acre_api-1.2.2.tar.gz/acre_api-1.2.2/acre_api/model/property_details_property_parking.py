...
class PropertyDetailsPropertyParking(str, Enum):
    """
    ...
    allowed enum values
    """
    INVALID_PROPERTY_PARKING = 'INVALID_PROPERTY_PARKING'
    NONE = 'NONE'
    DRIVEWAY = 'DRIVEWAY'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PropertyDetailsPropertyParking from a JSON string"""
