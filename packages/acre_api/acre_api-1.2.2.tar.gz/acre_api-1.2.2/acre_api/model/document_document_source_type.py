...
class DocumentDocumentSourceType(str, Enum):
    """
    Types of sources of the document.   - INVALID_DOCUMENT_SOURCE_TYPE: Invalid source type.  - GENERATED: Generated source type.  - TWENTY_7_TEC: Twenty7tec source type.  - ONFIDO: Onfido source type.  - TRUELAYER: TrueLayer source type.  - CLIENT: Client source type.  - USER: User source type.  - PAYMENTSHIELD: Paymentshield source type.  - UINSURE: Uinsure source type.  - KEY: The key source type.  - IPIPELINE: iPipeline source type.  - LAND_REGISTRY: Land Registry source type.  - LENDER: Lender.  - CALL_RECORDER: Call recorder.  - SMOOVE: Smoove conveyancing docs.  - SIMPLIFY: Simplify/PPL conveyacing docs.  - LV: LV=.  - OTHER_SOURCE: Other.
    """

    """
    allowed enum values
    """
    INVALID_DOCUMENT_SOURCE_TYPE = 'INVALID_DOCUMENT_SOURCE_TYPE'
    GENERATED = 'GENERATED'
    TWENTY_7_TEC = 'TWENTY_7_TEC'
    ONFIDO = 'ONFIDO'
    TRUELAYER = 'TRUELAYER'
    CLIENT = 'CLIENT'
    USER = 'USER'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DocumentDocumentSourceType from a JSON string"""
