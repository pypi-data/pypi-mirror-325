...
class CdmClientCalculatedValues(BaseModel):
    """
    CdmClientCalculatedValues
    """ # noqa: E501
    current_eidv_hash: Optional[StrictStr] = Field(default=None, description="This hash is calculated every time a field related to eidv is modified. It's used to check the validity of the latest EIDV result.")
    current_eidv_hash_version: Optional[StrictInt] = Field(default=None, description="The version of the hash that it was calculated with.")
    previous_eidv_hash: Optional[StrictStr] = Field(default=None, description="This hash is calculated every time a field related to eidv is modified. It's used to check the validity of the EIDV result with the most recent previous address.")
    previous_eidv_hash_version: Optional[StrictInt] = Field(default=None, description="The version of the hash that the previous_eidv_hash was calculated with.")
    age: Optional[StrictInt] = Field(default=None, description="The age of client.")
    has_adverse: Optional[StrictBool] = Field(default=None, description="Whether the client has adverse.")
    __properties: ClassVar[List[str]] = ["current_eidv_hash", "current_eidv_hash_version", "previous_eidv_hash", "previous_eidv_hash_version", "age", "has_adverse"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmClientCalculatedValues from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmClientCalculatedValues from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "current_eidv_hash": obj.get("current_eidv_hash"),
            "current_eidv_hash_version": obj.get("current_eidv_hash_version"),
            "previous_eidv_hash": obj.get("previous_eidv_hash"),
            "previous_eidv_hash_version": obj.get("previous_eidv_hash_version"),
            "age": obj.get("age"),
            "has_adverse": obj.get("has_adverse")
        })
        return _obj
