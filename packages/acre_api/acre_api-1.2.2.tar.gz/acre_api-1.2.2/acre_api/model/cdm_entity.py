...
class CdmEntity(BaseModel):
    """
    Entity represents an Acre entity.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the entity.")
    type: Optional[CdmEntityType] = CdmEntityType.INVALID_ENTITY_TYPE
    document_type: Optional[DocumentDocumentType] = DocumentDocumentType.INVALID_DOCUMENT_TYPE
    __properties: ClassVar[List[str]] = ["id", "type", "document_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmEntity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmEntity from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else CdmEntityType.INVALID_ENTITY_TYPE,
            "document_type": obj.get("document_type") if obj.get("document_type") is not None else DocumentDocumentType.INVALID_DOCUMENT_TYPE
        })
        return _obj
