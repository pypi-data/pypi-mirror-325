...
class EventNoteEventNoteType(str, Enum):
    """
    EventNoteEventNoteType
    """

    """
    allowed enum values
    """
    INVALID_EVENT_NOTE_TYPE = 'INVALID_EVENT_NOTE_TYPE'
    MICROSOFT = 'MICROSOFT'
    NYLAS = 'NYLAS'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EventNoteEventNoteType from a JSON string"""
