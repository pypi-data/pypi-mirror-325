...
class MortgageLoanPurpose(str, Enum):
    """
    MortgageLoanPurpose
    """
    ...
    allowed enum values
    """
    INVALID_LOAN_PURPOSE = 'INVALID_LOAN_PURPOSE'
    PURPOSE_DEBT_CONSOLIDATION = 'PURPOSE_DEBT_CONSOLIDATION'
    PURPOSE_BUSINESS = 'PURPOSE_BUSINESS'
    PURPOSE_OTHER_PROPERTY = 'PURPOSE_OTHER_PROPERTY'
    PURPOSE_HOME_IMPROVEMENTS = 'PURPOSE_HOME_IMPROVEMENTS'
    PURPOSE_LIFESTYLE = 'PURPOSE_LIFESTYLE'
    PURPOSE_OTHER = 'PURPOSE_OTHER'
    PURPOSE_STAIRCASING = 'PURPOSE_STAIRCASING'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of MortgageLoanPurpose from a JSON string"""
