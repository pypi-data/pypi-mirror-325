...
class CdmGetDocumentSummariesResponse(BaseModel):
    """
    Response to a get document summaries request.
    """ # noqa: E501
    documents: Optional[List[CdmDocument]] = Field(default=None, description="Summaries (no details) about the requested documents.")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetDocumentSummariesRequest] = None
    __properties: ClassVar[List[str]] = ["documents", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetDocumentSummariesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetDocumentSummariesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "next_page": CdmGetDocumentSummariesRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
