...
class CdmPreviousName(BaseModel):
    """
    The applicant's maiden or previous names.
    """ # noqa: E501
    previous_first_name: Optional[StrictStr] = Field(default=None, description="The applicant's previous first name.")
    previous_surname: Optional[StrictStr] = Field(default=None, description="The applicant's previous surname.")
    date_of_name_change: Optional[StrictStr] = Field(default=None, description="The date that the applicant changed their name (YYYY-MM-DD).")
    reason_for_name_change: Optional[StrictStr] = Field(default=None, description="The reason the applicant changed their name.")
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for this entry.")
    __properties: ClassVar[List[str]] = ["previous_first_name", "previous_surname", "date_of_name_change", "reason_for_name_change", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmPreviousName from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmPreviousName from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "previous_first_name": obj.get("previous_first_name"),
            "previous_surname": obj.get("previous_surname"),
            "date_of_name_change": obj.get("date_of_name_change"),
            "reason_for_name_change": obj.get("reason_for_name_change"),
            "id": obj.get("id")
        })
        return _obj
