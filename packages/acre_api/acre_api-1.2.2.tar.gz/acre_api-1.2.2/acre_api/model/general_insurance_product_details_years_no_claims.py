...
class GeneralInsuranceProductDetailsYearsNoClaims(str, Enum):
    """
    GeneralInsuranceProductDetailsYearsNoClaims
    """

    """
    allowed enum values
    """
    INVALID_YEARS_NO_CLAIMS = 'INVALID_YEARS_NO_CLAIMS'
    ZERO = 'ZERO'
    ONE = 'ONE'
    TWO = 'TWO'
    THREE = 'THREE'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GeneralInsuranceProductDetailsYearsNoClaims from a JSON string"""
