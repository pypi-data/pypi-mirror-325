...
class CdmRequirementsIPCoverAmountType(str, Enum):
    """
    Income protection cover amount type.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmRequirementsIPCoverAmountType from a JSON string"""
