...
class CaseDetailsConveyancingUpdateProperty(str, Enum):
    """
    The property to which the update applies.
    """

    """
    allowed enum values
    """
    INVALID_CONVEYANCING_UPDATE_PROPERTY = 'INVALID_CONVEYANCING_UPDATE_PROPERTY'
    PURCHASE_OR_REMORTGAGE_PROPERTY = 'PURCHASE_OR_REMORTGAGE_PROPERTY'
    SALE_PROPERTY = 'SALE_PROPERTY'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CaseDetailsConveyancingUpdateProperty from a JSON string"""
