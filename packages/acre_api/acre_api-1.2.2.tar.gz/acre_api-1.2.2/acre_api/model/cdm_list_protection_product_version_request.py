...
class CdmListProtectionProductVersionRequest(BaseModel):
    """
    List protection product versions. Only versions that the caller is allowed to access are returned, all others are omitted.
    """ # noqa: E501
    protection_id: StrictStr = Field(description="Protection product ID. Required.")
    ...
    __properties: ClassVar[List[str]] = ["protection_id", "bookmark", "page_size"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmListProtectionProductVersionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmListProtectionProductVersionRequest from a dict"""
        if obj is None:
            return None
