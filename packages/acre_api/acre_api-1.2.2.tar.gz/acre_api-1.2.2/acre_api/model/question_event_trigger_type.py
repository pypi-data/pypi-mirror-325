...
class QuestionEventTriggerType(str, Enum):
    """
    Type represents the type of event.   - INVALID_EVENT_TRIGGER: INVALID_EVENT_TRIGGER empty zero value.  - EMAIL: EMAIL means that we should send the email to the DA representative.
    """

    """
    allowed enum values
    """
    INVALID_EVENT_TRIGGER = 'INVALID_EVENT_TRIGGER'
    EMAIL = 'EMAIL'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of QuestionEventTriggerType from a JSON string"""
