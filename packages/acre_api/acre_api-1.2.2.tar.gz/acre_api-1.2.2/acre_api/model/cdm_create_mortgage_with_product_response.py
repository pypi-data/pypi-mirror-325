...
class CdmCreateMortgageWithProductResponse(BaseModel):
    """
    Response to a mortgage with product creation.
    """ # noqa: E501
    case_id: Optional[StrictStr] = Field(default=None, description="ID of the case the mortgage was linked to.")
    mortgage_id: Optional[StrictStr] = Field(default=None, description="ID of the created mortgage.")
    mortgage: Optional[CdmMortgage] = None
    product_id: Optional[StrictStr] = Field(default=None, description="ID of the created mortgage product.")
    product_details: Optional[CdmMortgageProductDetails] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["case_id", "mortgage_id", "mortgage", "product_id", "product_details", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateMortgageWithProductResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateMortgageWithProductResponse from a dict"""
        if obj is None:
            return None
