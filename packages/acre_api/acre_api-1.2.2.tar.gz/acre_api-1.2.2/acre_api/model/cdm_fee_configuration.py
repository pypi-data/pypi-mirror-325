...
class CdmFeeConfiguration(BaseModel):
    """
    FeeConfiguration holds configuration to generate certain fees in the management panel.
    """ # noqa: E501
    club_id: Optional[StrictStr] = Field(default=None, description="Targeted club id to generate for.")
    generations: Optional[List[CdmGeneration]] = Field(default=None, description="Generations holds information about fee generation.")
    __properties: ClassVar[List[str]] = ["club_id", "generations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmFeeConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmFeeConfiguration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "generations": [CdmGeneration.from_dict(_item) for _item in obj["generations"]] if obj.get("generations") is not None else None
        })
        return _obj
