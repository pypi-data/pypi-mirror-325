...
class ClientEmploymentIncomeEmploymentType(str, Enum):
    """
    ClientEmploymentIncomeEmploymentType
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientEmploymentIncomeEmploymentType from a JSON string"""
