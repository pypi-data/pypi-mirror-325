...
class CdmDocumentRequest(BaseModel):
    """
    DocumentRequest wraps a document ID for a requested document.
    """ # noqa: E501
    document_id: Optional[StrictStr] = Field(default=None, description="Requested document ID. Required.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmDocumentRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmDocumentRequest from a dict"""
        if obj is None:
            return None
