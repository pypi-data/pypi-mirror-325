...
class CdmUpdatePermissionAssignmentsResponse(BaseModel):
    """
    Response to the update of multiple permission assignments.
    """ # noqa: E501
    permission_assignments: Optional[List[CdmPermissionAssignment]] = Field(default=None, description="The updated permission assignments.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmUpdatePermissionAssignmentsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmUpdatePermissionAssignmentsResponse from a dict"""
        if obj is None:
            return None
