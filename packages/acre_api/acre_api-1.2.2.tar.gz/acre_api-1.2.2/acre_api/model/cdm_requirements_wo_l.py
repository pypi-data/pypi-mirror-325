...
class CdmRequirementsWoL(BaseModel):
    """
    Protection requirements for whole of life benefits.
    """ # noqa: E501
    client_ids: Optional[List[StrictStr]] = Field(default=None, description="The clients involved in this set of requirements.")
    existing_policy: Optional[StrictBool] = Field(default=None, description="Are these requirements met by pre-existing policies? Replaces legacy protection field: funeral_needs_met_by_preexisting.")
    cover_amount: Optional[StrictStr] = Field(default=None, description="The lump-sum cover amount (GBP). Replaces legacy protection field: funeral_needs_lump_sum_amount.")
    cover_frequency: Optional[CdmFrequency] = CdmFrequency.INVALID
    cover_reason: Optional[StrictStr] = Field(default=None, description="Details of the reason for the cover. Replaces legacy protection field: funeral_needs_justification.")
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for this entry.")
    __properties: ClassVar[List[str]] = ["client_ids", "existing_policy", "cover_amount", "cover_frequency", "cover_reason", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmRequirementsWoL from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmRequirementsWoL from a dict"""
        if obj is None:
            return None
