...
class PropertyDetailsPropertySubType(str, Enum):
    """
    What is the sub-type of the Property? (Detached, Semi-detached...).
    """
    ...
    MID_TERRACED = 'MID_TERRACED'
    END_TERRACED = 'END_TERRACED'
    DETACHED = 'DETACHED'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PropertyDetailsPropertySubType from a JSON string"""
