...
class CdmRelatedCase(BaseModel):
    """
    CdmRelatedCase
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for this entry.")
    case_id: Optional[StrictStr] = Field(default=None, description="ID of the related case.")
    relationship_type: Optional[CdmRelatedCaseRelationshipType] = CdmRelatedCaseRelationshipType.INVALID_RELATIONSHIP_TYPE
    __properties: ClassVar[List[str]] = ["id", "case_id", "relationship_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmRelatedCase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmRelatedCase from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "relationship_type": obj.get("relationship_type") if obj.get("relationship_type") is not None else CdmRelatedCaseRelationshipType.INVALID_RELATIONSHIP_TYPE
        })
        return _obj
