...
class CdmUpdatePermissionAssignmentsRequest(BaseModel):
    """
    Update multiple permission assignments. If one fails the call, none will be applied.
    """ # noqa: E501
    permission_assignments: Optional[List[CdmPermissionAssignment]] = Field(default=None, description="Partial details of the permission assignments to be patched. Currently, only the disabled field can be set (and it must be set).")
    __properties: ClassVar[List[str]] = ["permission_assignments"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmUpdatePermissionAssignmentsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmUpdatePermissionAssignmentsRequest from a dict"""
        if obj is None:
            return None
