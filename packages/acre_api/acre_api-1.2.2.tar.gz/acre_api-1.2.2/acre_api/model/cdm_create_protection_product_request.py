...
class CdmCreateProtectionProductRequest(BaseModel):
    """
    Create protection product request.
    """ # noqa: E501
    protection_product: CdmProtectionProduct
    __properties: ClassVar[List[str]] = ["protection_product"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateProtectionProductRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateProtectionProductRequest from a dict"""
        if obj is None:
            return None
