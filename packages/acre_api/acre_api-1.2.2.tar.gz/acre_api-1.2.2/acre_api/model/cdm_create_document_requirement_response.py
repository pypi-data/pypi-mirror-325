...
class CdmCreateDocumentRequirementResponse(BaseModel):
    """
    CdmCreateDocumentRequirementResponse
    """ # noqa: E501
    document_requirement: Optional[CdmDocumentRequirement] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["document_requirement", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateDocumentRequirementResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of document_requirement
        if self.document_requirement:
            _dict['document_requirement'] = self.document_requirement.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateDocumentRequirementResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "document_requirement": CdmDocumentRequirement.from_dict(obj["document_requirement"]) if obj.get("document_requirement") is not None else None,
