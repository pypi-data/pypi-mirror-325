...
class CdmGetRoleResponse(BaseModel):
    """
    Response to a get role request.
    """ # noqa: E501
    roles: Optional[List[CdmRole]] = None
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetRoleRequest] = None
    __properties: ClassVar[List[str]] = ["roles", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetRoleResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetRoleResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "roles": [CdmRole.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmGetRoleRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
