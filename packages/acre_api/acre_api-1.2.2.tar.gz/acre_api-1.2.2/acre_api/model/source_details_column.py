...
class SourceDetailsColumn(str, Enum):
    """
    SourceDetailsColumn
    """
    ...
    COLUMN_INITIAL_PAY_RATE = 'COLUMN_INITIAL_PAY_RATE'
    COLUMN_INITIAL_MONTHLY_PAYMENT = 'COLUMN_INITIAL_MONTHLY_PAYMENT'
    COLUMN_TRUE_COST = 'COLUMN_TRUE_COST'
    COLUMN_TRUE_COST_OVER_INITIAL_PERIOD = 'COLUMN_TRUE_COST_OVER_INITIAL_PERIOD'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SourceDetailsColumn from a JSON string"""
