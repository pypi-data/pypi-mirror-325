...
class PropertyDetailsPropertyWork(str, Enum):
    """
    Details of the work planned on the property.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PropertyDetailsPropertyWork from a JSON string"""
