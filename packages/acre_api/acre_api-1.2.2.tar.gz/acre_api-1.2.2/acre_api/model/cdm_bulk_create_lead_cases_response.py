...
class CdmBulkCreateLeadCasesResponse(BaseModel):
    """
    Response from bulk lead case creation endpoint.
    """ # noqa: E501
    linked_lead_cases: Optional[List[CdmLinkedLeadCase]] = Field(default=None, description="Array of complete case IDs and new lead case IDs.")
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["linked_lead_cases", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmBulkCreateLeadCasesResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in linked_lead_cases (list)
        _items = []
        if self.linked_lead_cases:
            for _item_linked_lead_cases in self.linked_lead_cases:
                if _item_linked_lead_cases:
                    _items.append(_item_linked_lead_cases.to_dict())
            _dict['linked_lead_cases'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmBulkCreateLeadCasesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "linked_lead_cases": [CdmLinkedLeadCase.from_dict(_item) for _item in obj["linked_lead_cases"]] if obj.get("linked_lead_cases") is not None else None,
