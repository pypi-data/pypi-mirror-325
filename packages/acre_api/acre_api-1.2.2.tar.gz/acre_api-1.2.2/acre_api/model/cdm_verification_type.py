...
class CdmVerificationType(str, Enum):
    """
    Types of verifications.   - INVALID_VERIFICATION_TYPE: Invalid verification type.  - VERBAL_ACCEPTANCE: Verbal acceptance verification type.  - PRINTED: Printed verification type.  - PORTAL_VIEW: Portal view verification type.  - PORTAL_ACCEPTANCE: Portal acceptance verification type.  - EMAIL_ACCEPTANCE: Email acceptance verification type.  - ADVISOR_VALIDATION: Advisor validation verification type.  - LIVENESS_PHOTO: Biometric verification with photo.  - ID_VERIFICATION: ID verification type.  - DEVICE_VERIFICATION: Equifax Device verification type.  - ACRE_OVERRIDE: Type of verification manually created by the Acre Support Org to override an automated Onfido verification.
    """
    ...
    PORTAL_ACCEPTANCE = 'PORTAL_ACCEPTANCE'
    EMAIL_ACCEPTANCE = 'EMAIL_ACCEPTANCE'
    ADVISOR_VALIDATION = 'ADVISOR_VALIDATION'
    LIVENESS_PHOTO = 'LIVENESS_PHOTO'
    ID_VERIFICATION = 'ID_VERIFICATION'
    DEVICE_VERIFICATION = 'DEVICE_VERIFICATION'
    ACRE_OVERRIDE = 'ACRE_OVERRIDE'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmVerificationType from a JSON string"""
