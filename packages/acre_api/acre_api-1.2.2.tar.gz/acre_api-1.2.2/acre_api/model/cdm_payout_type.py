...
class CdmPayoutType(str, Enum):
    ...
    allowed enum values
    """
    PAYOUT_TYPE_INVALID = 'PAYOUT_TYPE_INVALID'
    PAYOUT_TYPE_LIFE = 'PAYOUT_TYPE_LIFE'
    PAYOUT_TYPE_CIC = 'PAYOUT_TYPE_CIC'
    PAYOUT_TYPE_LIFE_OR_EARLIER_CIC = 'PAYOUT_TYPE_LIFE_OR_EARLIER_CIC'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmPayoutType from a JSON string"""
