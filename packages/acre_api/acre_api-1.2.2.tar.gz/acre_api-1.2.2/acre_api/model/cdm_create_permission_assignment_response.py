...
class CdmCreatePermissionAssignmentResponse(BaseModel):
    """
    Response to the creation of a permission assignment.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreatePermissionAssignmentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreatePermissionAssignmentResponse from a dict"""
        if obj is None:
            return None
