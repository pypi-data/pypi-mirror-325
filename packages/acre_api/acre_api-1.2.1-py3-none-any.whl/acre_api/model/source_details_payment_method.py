...
class SourceDetailsPaymentMethod(str, Enum):
    """
     - PAYMENT_METHOD_REPAYMENT: Repayment (default).
    """
    ...
    PAYMENT_METHOD_REPAYMENT = 'PAYMENT_METHOD_REPAYMENT'
    PAYMENT_METHOD_ENDOWMENT = 'PAYMENT_METHOD_ENDOWMENT'
    PAYMENT_METHOD_INDIVIDUAL_SAVINGS_ACCOUNT = 'PAYMENT_METHOD_INDIVIDUAL_SAVINGS_ACCOUNT'
    PAYMENT_METHOD_INTEREST_ONLY = 'PAYMENT_METHOD_INTEREST_ONLY'
    PAYMENT_METHOD_PART_INVESTMENT = 'PAYMENT_METHOD_PART_INVESTMENT'
    PAYMENT_METHOD_PENSION = 'PAYMENT_METHOD_PENSION'
    PAYMENT_METHOD_SALE_OF_PROPERTY = 'PAYMENT_METHOD_SALE_OF_PROPERTY'
    PAYMENT_METHOD_SALE_OF_OTHER_PROPERTY = 'PAYMENT_METHOD_SALE_OF_OTHER_PROPERTY'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SourceDetailsPaymentMethod from a JSON string"""
