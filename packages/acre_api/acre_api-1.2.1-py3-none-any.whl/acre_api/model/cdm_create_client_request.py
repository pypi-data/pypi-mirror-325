...
class CdmCreateClientRequest(BaseModel):
    """
    Create a new client. This creates version 1, mutable.
    """ # noqa: E501
    client: CdmClient
    show_protected: Optional[StrictBool] = Field(default=None, description="Show protected fields when echoing the client details back to the caller (default false).")
    __properties: ClassVar[List[str]] = ["client", "show_protected"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateClientRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateClientRequest from a dict"""
        if obj is None:
            return None
