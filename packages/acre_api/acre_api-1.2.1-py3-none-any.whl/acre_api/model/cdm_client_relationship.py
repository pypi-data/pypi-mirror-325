...
class CdmClientRelationship(BaseModel):
    """
    CdmClientRelationship
    """ # noqa: E501
    relationship_reference: Optional[StrictStr] = Field(default=None, description="Client to whom this client has a relationship.")
    relationship_type: Optional[CdmClientRelationshipRelationshipType] = CdmClientRelationshipRelationshipType.INVALID_RELATIONSHIP_TYPE
    relationship_data_access_permitted: Optional[StrictBool] = Field(default=None, description="Can this person access this individuals data.")
    __properties: ClassVar[List[str]] = ["relationship_reference", "relationship_type", "relationship_data_access_permitted"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmClientRelationship from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmClientRelationship from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "relationship_reference": obj.get("relationship_reference"),
            "relationship_type": obj.get("relationship_type") if obj.get("relationship_type") is not None else CdmClientRelationshipRelationshipType.INVALID_RELATIONSHIP_TYPE,
            "relationship_data_access_permitted": obj.get("relationship_data_access_permitted")
        })
        return _obj
