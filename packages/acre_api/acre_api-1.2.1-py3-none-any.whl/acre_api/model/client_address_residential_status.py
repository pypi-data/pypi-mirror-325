...
class ClientAddressResidentialStatus(str, Enum):
    """
    ClientAddressResidentialStatus
    """

    """
    allowed enum values
    """
    INVALID_RESIDENTIAL_STATUS = 'INVALID_RESIDENTIAL_STATUS'
    TENANT = 'TENANT'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientAddressResidentialStatus from a JSON string"""
