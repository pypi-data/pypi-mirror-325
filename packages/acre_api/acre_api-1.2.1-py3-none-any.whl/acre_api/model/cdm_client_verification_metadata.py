...
class CdmClientVerificationMetadata(BaseModel):
    """
    CdmClientVerificationMetadata
    """ # noqa: E501
    identity: Optional[CdmIdentity] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmClientVerificationMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmClientVerificationMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "identity": CdmIdentity.from_dict(obj["identity"]) if obj.get("identity") is not None else None
        })
        return _obj
