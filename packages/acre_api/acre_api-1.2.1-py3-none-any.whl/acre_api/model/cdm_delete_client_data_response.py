...
class CdmDeleteClientDataResponse(BaseModel):
    """
    Response to purge all given client's data, including health data.
    """ # noqa: E501
    client: Optional[CdmClient] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["client", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmDeleteClientDataResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmDeleteClientDataResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "client": CdmClient.from_dict(obj["client"]) if obj.get("client") is not None else None,
