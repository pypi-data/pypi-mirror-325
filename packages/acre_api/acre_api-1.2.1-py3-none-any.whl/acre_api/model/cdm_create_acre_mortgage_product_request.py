...
class CdmCreateAcreMortgageProductRequest(BaseModel):
    """
    Create a mortgage product within Acre.
    """ # noqa: E501
    product_code: Optional[StrictStr] = Field(default=None, description="Product code of the mortgage product. This code is used to lookup the product details via the sourcing API. Must not be used with \"product_details\".")
    product_details: Optional[CdmMortgageProductDetails] = None
    __properties: ClassVar[List[str]] = ["product_code", "product_details"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateAcreMortgageProductRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateAcreMortgageProductRequest from a dict"""
        if obj is None:
            return None
