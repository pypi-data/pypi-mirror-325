...
class MinimalDetailsOfFlagToAddRequired(BaseModel):
    """
    MinimalDetailsOfFlagToAddRequired
    """ # noqa: E501
    flag_type: Optional[CdmCaseDetailsFlagType] = CdmCaseDetailsFlagType.INVALID_FLAG_TYPE
    __properties: ClassVar[List[str]] = ["flag_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MinimalDetailsOfFlagToAddRequired from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MinimalDetailsOfFlagToAddRequired from a dict"""
        if obj is None:
            return None
