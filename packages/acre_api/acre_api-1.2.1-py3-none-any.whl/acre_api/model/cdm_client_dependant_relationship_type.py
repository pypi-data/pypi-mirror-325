...
class CdmClientDependantRelationshipType(str, Enum):
    """
    CdmClientDependantRelationshipType
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmClientDependantRelationshipType from a JSON string"""
