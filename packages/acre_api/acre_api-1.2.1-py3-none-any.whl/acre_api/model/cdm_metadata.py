...
class CdmMetadata(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of this item of metadata.")
    string_value: Optional[StrictStr] = Field(default=None, description="String value of metadata.")
    int_value: Optional[StrictInt] = Field(default=None, description="Int value of metadata.")
    bool_value: Optional[StrictBool] = Field(default=None, description="Boolean value of metadata.")
    user_editable: Optional[StrictBool] = Field(default=None, description="Whether this metadata item is user editable. (See permissions). An omitted value defaults to true.")
    __properties: ClassVar[List[str]] = ["name", "string_value", "int_value", "bool_value", "user_editable"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "user_editable": obj.get("user_editable")
        })
        return _obj
