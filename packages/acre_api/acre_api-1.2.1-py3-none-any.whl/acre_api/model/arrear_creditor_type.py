...
class ArrearCreditorType(str, Enum):
    """
    ArrearCreditorType
    """
    ...
    allowed enum values
    """
    INVALID_CREDITOR_TYPE = 'INVALID_CREDITOR_TYPE'
    CREDITOR_TYPE_COMMUNICATIONS = 'CREDITOR_TYPE_COMMUNICATIONS'
    CREDITOR_TYPE_CREDIT_CREDIT = 'CREDITOR_TYPE_CREDIT_CREDIT'
    CREDITOR_TYPE_HP = 'CREDITOR_TYPE_HP'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ArrearCreditorType from a JSON string"""
