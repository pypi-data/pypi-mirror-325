...
class OccupantTenancyType(str, Enum):
    """
    OccupantTenancyType
    """
    ...
    allowed enum values
    """
    INVALID_TENANCY_TYPE = 'INVALID_TENANCY_TYPE'
    AST = 'AST'
    ASSURED_TENANCY = 'ASSURED_TENANCY'
    NON_ASSURED_TENANCY = 'NON_ASSURED_TENANCY'
    EXCLUDED_TENANCY = 'EXCLUDED_TENANCY'
    REGULATED_TENANCY = 'REGULATED_TENANCY'
    COMPANY_LET = 'COMPANY_LET'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OccupantTenancyType from a JSON string"""
