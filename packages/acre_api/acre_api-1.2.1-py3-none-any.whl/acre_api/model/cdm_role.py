...
class CdmRole(BaseModel):
    """
    Roles are assigned to users and govern access and authorisation.
    """ # noqa: E501
    role_id: Optional[StrictStr] = Field(default=None, description="Acre UUID for Role. **IMPORTANT:** This field cannot be updated and is populated automatically.")
    role_name: Optional[StrictStr] = Field(default=None, description="Unique human readable name for the role.")
    disabled: Optional[StrictBool] = Field(default=None, description="Set if the role is disabled. A role cannot be created disabled. A role cannot be re-enabled after being disabled.")
    __properties: ClassVar[List[str]] = ["role_id", "role_name", "disabled"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmRole from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmRole from a dict"""
        if obj is None:
            return None
