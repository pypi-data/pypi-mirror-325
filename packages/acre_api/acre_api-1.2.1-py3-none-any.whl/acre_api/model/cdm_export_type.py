...
class CdmExportType(str, Enum):
    """
    Valid export file types for the template.   - INVALID_EXPORT_TYPE: Unknown file type.  - EXPORT_TYPE_HTML: HTML.  - EXPORT_TYPE_PDF: PDF.  - EXPORT_TYPE_EMAIL: E-mail.
    """

    """
    allowed enum values
    """
    INVALID_EXPORT_TYPE = 'INVALID_EXPORT_TYPE'
    EXPORT_TYPE_HTML = 'EXPORT_TYPE_HTML'
    EXPORT_TYPE_PDF = 'EXPORT_TYPE_PDF'
    EXPORT_TYPE_EMAIL = 'EXPORT_TYPE_EMAIL'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmExportType from a JSON string"""
