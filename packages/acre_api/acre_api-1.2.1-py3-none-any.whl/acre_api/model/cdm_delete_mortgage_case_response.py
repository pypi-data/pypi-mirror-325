...
class CdmDeleteMortgageCaseResponse(BaseModel):
    """
    Response to removing a mortgage from a case.
    """ # noqa: E501
    case_id: Optional[StrictStr] = Field(default=None, description="Case to remove the mortgage.")
    mortgage_id: Optional[StrictStr] = Field(default=None, description="ID of the removed mortgage.")
    mortgage: Optional[CdmMortgage] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["case_id", "mortgage_id", "mortgage", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmDeleteMortgageCaseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmDeleteMortgageCaseResponse from a dict"""
        if obj is None:
            return None
