...
class CdmMortgageIDAndVersion(BaseModel):
    """
    Mortgage ID and a version of that mortgage.
    """ # noqa: E501
    mortgage_id: Optional[StrictStr] = None
    version: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["mortgage_id", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmMortgageIDAndVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmMortgageIDAndVersion from a dict"""
        if obj is None:
            return None
