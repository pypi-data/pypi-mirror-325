...
class CdmGetDocumentVerificationRequest(BaseModel):
    """
    Get document verification details.
    """ # noqa: E501
    document_id: StrictStr = Field(description="Filter to only include verifications for the specified document. Required.")
    verification_details: Optional[StrictBool] = Field(default=None, description="Return the entire document verification details. By default this value is false, and only the IDs are returned.")
    verification_ids: Optional[List[StrictStr]] = Field(default=None, description="Verification IDs (optional, default wildcard for all IDs user can access).")
    ...
    __properties: ClassVar[List[str]] = ["document_id", "verification_details", "verification_ids", "bookmark", "page_size"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetDocumentVerificationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetDocumentVerificationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "verification_ids": obj.get("verification_ids"),
