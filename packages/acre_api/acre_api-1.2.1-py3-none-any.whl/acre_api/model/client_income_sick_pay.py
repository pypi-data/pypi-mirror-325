...
class ClientIncomeSickPay(BaseModel):
    """
    Contains details about sick pay.
    """ # noqa: E501
    sick_pay_type: Optional[SickPaySickPayType] = SickPaySickPayType.INVALID_SICK_PAY_TYPE
    sick_pay_amount_monthly: Optional[StrictStr] = Field(default=None, description="Amount of sick pay the client would receive from this income or employment in the event of long-term sickness in pence.")
    sick_pay_period_months: Optional[StrictInt] = Field(default=None, description="Length of time in months that client would receive sick_pay_amount_monthly in the event of long-term sickness.")
    sick_pay_details: Optional[StrictStr] = Field(default=None, description="Additional details relating to client sick pay from this income or employment.")
    __properties: ClassVar[List[str]] = ["sick_pay_type", "sick_pay_amount_monthly", "sick_pay_period_months", "sick_pay_details"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClientIncomeSickPay from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClientIncomeSickPay from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "sick_pay_type": obj.get("sick_pay_type") if obj.get("sick_pay_type") is not None else SickPaySickPayType.INVALID_SICK_PAY_TYPE,
            "sick_pay_amount_monthly": obj.get("sick_pay_amount_monthly"),
            "sick_pay_period_months": obj.get("sick_pay_period_months"),
            "sick_pay_details": obj.get("sick_pay_details")
        })
        return _obj
