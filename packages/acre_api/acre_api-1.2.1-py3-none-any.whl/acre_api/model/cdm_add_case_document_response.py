...
class CdmAddCaseDocumentResponse(BaseModel):
    """
    Response to adding a document to a case.
    """ # noqa: E501
    case_id: Optional[StrictStr] = Field(default=None, description="ID of the case added.")
    document_id: Optional[StrictStr] = Field(default=None, description="ID of the document adding the case.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAddCaseDocumentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAddCaseDocumentResponse from a dict"""
        if obj is None:
            return None
