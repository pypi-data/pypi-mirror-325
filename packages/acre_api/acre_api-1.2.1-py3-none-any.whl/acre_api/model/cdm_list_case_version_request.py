...
class CdmListCaseVersionRequest(BaseModel):
    """
    List case versions.
    """ # noqa: E501
    case_id: StrictStr = Field(description="Case ID. Required.")
    ...
    __properties: ClassVar[List[str]] = ["case_id", "bookmark", "page_size", "show_history"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmListCaseVersionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmListCaseVersionRequest from a dict"""
        if obj is None:
            return None
