...
class V1ExceptionType(str, Enum):
    """
    Type of exception.   - INVALID_TYPE: Default for no exception.  - BUSINESS: Business logic error.  - SERVICE_NOT_AVAILABLE: A service was unavailable.  - INFRASTRUCTURE: Infrastructure was down.  - UNEXPECTED: Catch-all for all other types.  - SECURITY_VIOLATION: Security related error.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of V1ExceptionType from a JSON string"""
