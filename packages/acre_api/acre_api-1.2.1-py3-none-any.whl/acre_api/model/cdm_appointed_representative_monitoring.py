...
class CdmAppointedRepresentativeMonitoring(BaseModel):
    """
    AppointedRepresentativeMonitoring contains the details used for the RMA H report.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for this entry.")
    start_date: Optional[StrictStr] = Field(default=None, description="Start date for when the related report was generated (YYYY-MM-DD). This field is mandatory.")
    end_date: Optional[StrictStr] = Field(default=None, description="End date for when the related report was generated (YYYY-MM-DD). This field is mandatory.")
    subject_to_monitoring: Optional[StrictInt] = Field(default=None, description="Number of ARs that have been subject to monitoring visits during the period indicated.")
    subject_to_financial_checks: Optional[StrictInt] = Field(default=None, description="Number of ARs that have been subject to financial checks by the firm during the period indicated.")
    has_other_monitoring_occurred: Optional[StrictBool] = Field(default=None, description="Indicate if any other monitoring of ARs by the firm has taken place during the period indicated.")
    __properties: ClassVar[List[str]] = ["id", "start_date", "end_date", "subject_to_monitoring", "subject_to_financial_checks", "has_other_monitoring_occurred"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAppointedRepresentativeMonitoring from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAppointedRepresentativeMonitoring from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "subject_to_monitoring": obj.get("subject_to_monitoring"),
            "subject_to_financial_checks": obj.get("subject_to_financial_checks"),
            "has_other_monitoring_occurred": obj.get("has_other_monitoring_occurred")
        })
        return _obj
