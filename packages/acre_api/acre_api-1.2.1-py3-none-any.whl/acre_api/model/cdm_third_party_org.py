...
class CdmThirdPartyOrg(BaseModel):
    """
    Details of third party organisations such as estate agent and solicitor.
    """ # noqa: E501
    type: Optional[ThirdPartyOrgThirdPartyType] = ThirdPartyOrgThirdPartyType.INVALID_TYPE
    firm_name: Optional[StrictStr] = Field(default=None, description="The name of the company.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the advisor.")
    work_phone: Optional[StrictStr] = Field(default=None, description="Work phone number.")
    ...
    __properties: ClassVar[List[str]] = ["type", "firm_name", "name", "work_phone", "email_address", "address", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmThirdPartyOrg from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmThirdPartyOrg from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else ThirdPartyOrgThirdPartyType.INVALID_TYPE,
