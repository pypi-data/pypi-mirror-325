...
class TrainingAndCompetencyMortgageQualification(str, Enum):
    """
     - CERTIFICATE_IN_ADVANCED_MORTGAGE_ADVICE: Certificate in Advanced Mortgage Advice.  - CERTIFICATE_IN_MORTGAGE_ADVICE: Certificate in Mortgage Advice.  - MORTGAGE_ADVICE_AND_PRACTICE_CERTIFICATE: Mortgage Advice and Practice Certificate.  - DIPLOMA_FOR_MORTGAGE_ADVICE_AND_PRACTICE: Diploma for Mortgage Advice and Practice (DipMAP).  - CERTIFICATE_IN_MORTGAGE_ADVICE_AND_PRACTICE: Certificate in Mortgage Advice and Practice.  - FLSP_LEVEL_3_ADVANCED_APPRENTICESHIP_IN_ADVISING_ON_FINANCIAL_PRODUCTS: FLSP Level 3 Advanced Apprenticeship in Advising on Financial Products (Mortgage Advice Pathway) or Level 3 Advanced Apprenticeship in Providing Mortgage Advice.
    """

    """
    allowed enum values
    """
    INVALID_MORTGAGE_QUALIFICATION = 'INVALID_MORTGAGE_QUALIFICATION'
    CERTIFICATE_IN_ADVANCED_MORTGAGE_ADVICE = 'CERTIFICATE_IN_ADVANCED_MORTGAGE_ADVICE'
    CERTIFICATE_IN_MORTGAGE_ADVICE = 'CERTIFICATE_IN_MORTGAGE_ADVICE'
    MORTGAGE_ADVICE_AND_PRACTICE_CERTIFICATE = 'MORTGAGE_ADVICE_AND_PRACTICE_CERTIFICATE'
    DIPLOMA_FOR_MORTGAGE_ADVICE_AND_PRACTICE = 'DIPLOMA_FOR_MORTGAGE_ADVICE_AND_PRACTICE'
    CERTIFICATE_IN_MORTGAGE_ADVICE_AND_PRACTICE = 'CERTIFICATE_IN_MORTGAGE_ADVICE_AND_PRACTICE'
    FLSP_LEVEL_3_ADVANCED_APPRENTICESHIP_IN_ADVISING_ON_FINANCIAL_PRODUCTS = 'FLSP_LEVEL_3_ADVANCED_APPRENTICESHIP_IN_ADVISING_ON_FINANCIAL_PRODUCTS'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TrainingAndCompetencyMortgageQualification from a JSON string"""
