...
class SickPaySickPayType(str, Enum):
    """
    SickPaySickPayType
    """
    ...
    allowed enum values
    """
    INVALID_SICK_PAY_TYPE = 'INVALID_SICK_PAY_TYPE'
    STATUTORY_SICK_PAY = 'STATUTORY_SICK_PAY'
    EMPLOYER_SICK_PAY = 'EMPLOYER_SICK_PAY'
    EXTERNAL_POLICY = 'EXTERNAL_POLICY'
    NONE = 'NONE'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SickPaySickPayType from a JSON string"""
