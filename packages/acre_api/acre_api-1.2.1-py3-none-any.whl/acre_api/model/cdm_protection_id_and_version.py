...
class CdmProtectionIDAndVersion(BaseModel):
    """
    Protection ID and a version of that mortgage.
    """ # noqa: E501
    protection_id: Optional[StrictStr] = None
    version: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["protection_id", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmProtectionIDAndVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmProtectionIDAndVersion from a dict"""
        if obj is None:
            return None
