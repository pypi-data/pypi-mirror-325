...
class ClientDetailsCountyCourtJudgement(BaseModel):
    """
    ClientDetailsCountyCourtJudgement
    """ # noqa: E501
    date_registered: Optional[StrictStr] = Field(default=None, description="The date the CCJ was registered (YYYY-MM-DD).")
    date_satisfied: Optional[StrictStr] = Field(default=None, description="The date the CCJ was satisfied (YYYY-MM-DD).")
    amount: Optional[StrictStr] = Field(default=None, description="The amount of the CCJ (in pence, not GBP).")
    creditor_name: Optional[StrictStr] = Field(default=None, description="The name of the Creditor if applicable.")
    court_name: Optional[StrictStr] = Field(default=None, description="The name of the court if applicable.")
    id: Optional[StrictStr] = Field(default=None, description="DEPRECATED: due to GBP to pence conversion. string amount = 3; A unique identifier for this entry.")
    case_number: Optional[StrictStr] = Field(default=None, description="Reference number relating to the Court and Insolvency Information 'case'.")
    court_code: Optional[StrictStr] = Field(default=None, description="Reference identifier for the County Court.")
    __properties: ClassVar[List[str]] = ["date_registered", "date_satisfied", "amount", "creditor_name", "court_name", "id", "case_number", "court_code"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClientDetailsCountyCourtJudgement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClientDetailsCountyCourtJudgement from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "date_registered": obj.get("date_registered"),
            "date_satisfied": obj.get("date_satisfied"),
            "amount": obj.get("amount"),
            "creditor_name": obj.get("creditor_name"),
            "court_name": obj.get("court_name"),
            "id": obj.get("id"),
            "case_number": obj.get("case_number"),
            "court_code": obj.get("court_code")
        })
        return _obj
