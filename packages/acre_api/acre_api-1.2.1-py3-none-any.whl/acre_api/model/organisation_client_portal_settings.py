...
class OrganisationClientPortalSettings(BaseModel):
    """
    ClientPortalSettings contains configuration for the Client Portal.
    """ # noqa: E501
    primary_colour: Optional[StrictStr] = Field(default=None, description="Colour of the Client Portal. Note: No validation on the colour format is performed.")
    __properties: ClassVar[List[str]] = ["primary_colour"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganisationClientPortalSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganisationClientPortalSettings from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "primary_colour": obj.get("primary_colour")
        })
        return _obj
