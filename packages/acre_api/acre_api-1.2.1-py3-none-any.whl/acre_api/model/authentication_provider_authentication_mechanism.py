...
class AuthenticationProviderAuthenticationMechanism(str, Enum):
    """
     - INVALID: Invalid authentication mechanism.  - OIDC: OpenID Connect. When type OIDC, metadata key \"jwks_url\" is required.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AuthenticationProviderAuthenticationMechanism from a JSON string"""
