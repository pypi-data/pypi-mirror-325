...
class CdmCreditSearchConsentType(str, Enum):
    """
    Types of credit search consent providers.   - CONSENTED_BY_INVALID: Invalid option.  - CONSENTED_BY_USER_ON_BEHALF_OF_CLIENT: Broker consented on behalf of client.  - CONSENTED_BY_CLIENT: Consented by the client.
    """

    """
    allowed enum values
    """
    CONSENTED_BY_INVALID = 'CONSENTED_BY_INVALID'
    CONSENTED_BY_USER_ON_BEHALF_OF_CLIENT = 'CONSENTED_BY_USER_ON_BEHALF_OF_CLIENT'
    CONSENTED_BY_CLIENT = 'CONSENTED_BY_CLIENT'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmCreditSearchConsentType from a JSON string"""
