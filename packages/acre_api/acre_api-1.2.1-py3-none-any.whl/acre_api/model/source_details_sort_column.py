...
class SourceDetailsSortColumn(BaseModel):
    """
    SourceDetailsSortColumn
    """ # noqa: E501
    column: Optional[SourceDetailsColumn] = SourceDetailsColumn.INVALID_COLUMN
    direction: Optional[SourceDetailsDirection] = SourceDetailsDirection.INVALID_DIRECTION
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SourceDetailsSortColumn from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SourceDetailsSortColumn from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "column": obj.get("column") if obj.get("column") is not None else SourceDetailsColumn.INVALID_COLUMN,
            "direction": obj.get("direction") if obj.get("direction") is not None else SourceDetailsDirection.INVALID_DIRECTION
        })
        return _obj
