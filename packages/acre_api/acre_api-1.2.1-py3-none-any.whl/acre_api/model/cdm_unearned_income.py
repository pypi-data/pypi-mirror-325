...
class CdmUnearnedIncome(BaseModel):
    """
    CdmUnearnedIncome
    """ # noqa: E501
    type: Optional[UnearnedIncomeUnearnedIncomeType] = UnearnedIncomeUnearnedIncomeType.INVALID_UNEARNED_INCOME_TYPE
    amount: Optional[StrictStr] = Field(default=None, description="The amount of this unearned income (in pence, not GBP).")
    frequency: Optional[UnearnedIncomeUnearnedIncomeFrequency] = UnearnedIncomeUnearnedIncomeFrequency.INVALID_FREQUENCY
    other_type: Optional[StrictStr] = Field(default=None, description="Free text field where Broker can record more details about the 'Other' additional income type.")
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for this entry.")
    __properties: ClassVar[List[str]] = ["type", "amount", "frequency", "other_type", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmUnearnedIncome from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmUnearnedIncome from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else UnearnedIncomeUnearnedIncomeType.INVALID_UNEARNED_INCOME_TYPE,
            "amount": obj.get("amount"),
            "frequency": obj.get("frequency") if obj.get("frequency") is not None else UnearnedIncomeUnearnedIncomeFrequency.INVALID_FREQUENCY,
