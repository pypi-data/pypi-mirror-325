...
class CdmAdditionalLoan(BaseModel):
    """
    The additional loans required.
    """ # noqa: E501
    loan_amount: Optional[StrictStr] = Field(default=None, description="The amount of the additional loan required (in pence, not GBP).")
    loan_purpose: Optional[AdditionalLoanPurpose] = AdditionalLoanPurpose.INVALID_LOAN_PURPOSE
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for this entry.")
    __properties: ClassVar[List[str]] = ["loan_amount", "loan_purpose", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAdditionalLoan from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAdditionalLoan from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "loan_purpose": obj.get("loan_purpose") if obj.get("loan_purpose") is not None else AdditionalLoanPurpose.INVALID_LOAN_PURPOSE,
            "id": obj.get("id")
        })
        return _obj
