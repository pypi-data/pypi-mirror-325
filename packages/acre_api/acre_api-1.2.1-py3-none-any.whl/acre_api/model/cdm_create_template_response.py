...
class CdmCreateTemplateResponse(BaseModel):
    """
    Response to the creation of a template.
    """ # noqa: E501
    template: Optional[CdmTemplate] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["template", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateTemplateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateTemplateResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "template": CdmTemplate.from_dict(obj["template"]) if obj.get("template") is not None else None,
