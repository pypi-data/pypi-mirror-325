...
class CdmCreatePermissionAssignmentsRequest(BaseModel):
    """
    Create multiple new permission assignments. If one fails the call, none will be applied.
    """ # noqa: E501
    permission_assignments: Optional[List[CdmPermissionAssignment]] = Field(default=None, description="Details of the new permission assignments to be created.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreatePermissionAssignmentsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreatePermissionAssignmentsRequest from a dict"""
        if obj is None:
            return None
