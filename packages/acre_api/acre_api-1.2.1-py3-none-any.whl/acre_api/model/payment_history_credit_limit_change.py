...
class PaymentHistoryCreditLimitChange(str, Enum):
    """
    PaymentHistoryCreditLimitChange
    """

    """
    allowed enum values
    """
    INVALID_CREDIT_LIMIT_CHANGE = 'INVALID_CREDIT_LIMIT_CHANGE'
    NO_CHANGE = 'NO_CHANGE'
    DECREASE = 'DECREASE'
    INCREASE = 'INCREASE'
    UNKNOWN = 'UNKNOWN'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentHistoryCreditLimitChange from a JSON string"""
