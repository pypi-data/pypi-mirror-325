...
class CdmVerificationScope(str, Enum):
    """
    CdmVerificationScope
    """

    """
    allowed enum values
    """
    INVALID_VERIFICATION_SCOPE = 'INVALID_VERIFICATION_SCOPE'
    VERIFICATION_SCOPE_CRM = 'VERIFICATION_SCOPE_CRM'
    VERIFICATION_SCOPE_CP = 'VERIFICATION_SCOPE_CP'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmVerificationScope from a JSON string"""
