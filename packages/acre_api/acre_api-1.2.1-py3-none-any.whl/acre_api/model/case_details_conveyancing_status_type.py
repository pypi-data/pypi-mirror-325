...
class CaseDetailsConveyancingStatusType(str, Enum):
    """
    Status for Acre provided conveyancing.
    """

    """
    allowed enum values
    """
    INVALID_CONVEYANCING_STATUS = 'INVALID_CONVEYANCING_STATUS'
    QUOTED = 'QUOTED'
    ACCEPTED = 'ACCEPTED'
    DECLINED = 'DECLINED'
    AWAITING_CLIENT = 'AWAITING_CLIENT'
    AWAITING_SOLICITOR = 'AWAITING_SOLICITOR'
    AWAITING_SEARCHES = 'AWAITING_SEARCHES'
    EXCHANGED = 'EXCHANGED'
    COMPLETED = 'COMPLETED'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CaseDetailsConveyancingStatusType from a JSON string"""
