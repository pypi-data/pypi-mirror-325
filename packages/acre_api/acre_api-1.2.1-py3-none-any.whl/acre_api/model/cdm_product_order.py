...
class CdmProductOrder(BaseModel):
    """
    CdmProductOrder
    """ # noqa: E501
    raw_results_reference: Optional[StrictStr] = Field(default=None, description="A reference to the raw response from sourcing providers.")
    type: Optional[CdmProductOrderProductType] = CdmProductOrderProductType.INVALID_TYPE
    product_id: Optional[StrictStr] = Field(default=None, description="Id of the sourced product, the unique identifier for each product within the engine.  For example, for a product coming from the sourcing ms, this will be iress-pms-3297328, which contains the iress code 3297328 with some prefixes.")
    continuing_mortgages: Optional[List[StrictStr]] = Field(default=None, description="Contains the CURRENT mortgages' ids that will be continuing in combination with this product.")
    __properties: ClassVar[List[str]] = ["raw_results_reference", "type", "product_id", "continuing_mortgages"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmProductOrder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmProductOrder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else CdmProductOrderProductType.INVALID_TYPE,
            "product_id": obj.get("product_id"),
            "continuing_mortgages": obj.get("continuing_mortgages")
        })
        return _obj
