...
class CdmEnforcementLevel(str, Enum):
    """
    Types of Verification Enforcements.   - INVALID_ENFORCEMENT_LEVEL: Invalid enforcement level.  - ENFORCED: Enforced indicates verifications in class must run and required to be satisfied before a case is able to transition status.  - OPTIONAL: Optional indicates verification in class must run and not required to be satisfied before a case is able to transition status.  - DISABLED: Disabled indicates verifications in class must not run not required to be satisfied before a case is able to transition status.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmEnforcementLevel from a JSON string"""
