...
class CdmRequirementsObjectives(BaseModel):
    """
    The protection requirements objectives.
    """ # noqa: E501
    advice_limit: Optional[StrictBool] = Field(default=None, description="If the clients choose to limit the scope of protection advice. Replaces legacy protection field: client_advice_limit.")
    advice_limit_details: Optional[StrictStr] = Field(default=None, description="Details concerning the limit of the scope of the protection advice. Replaces legacy protection field: client_advice_limit_details.")
    protection_objectives_circumstances: Optional[StrictStr] = Field(default=None, description="Details of the circumstances that limit the scope of the protection advice. Replaces legacy protection field: client_protection_objectives_circumstances.")
    __properties: ClassVar[List[str]] = ["advice_limit", "advice_limit_details", "protection_objectives_circumstances"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmRequirementsObjectives from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmRequirementsObjectives from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "advice_limit": obj.get("advice_limit"),
            "advice_limit_details": obj.get("advice_limit_details"),
            "protection_objectives_circumstances": obj.get("protection_objectives_circumstances")
        })
        return _obj
