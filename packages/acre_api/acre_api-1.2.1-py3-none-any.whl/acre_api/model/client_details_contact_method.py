...
class ClientDetailsContactMethod(str, Enum):
    """
    ClientDetailsContactMethod
    """

    """
    allowed enum values
    """
    INVALID_CONTACT_METHOD = 'INVALID_CONTACT_METHOD'
    CONTACT_METHOD_EMAIL = 'CONTACT_METHOD_EMAIL'
    CONTACT_METHOD_PHONE = 'CONTACT_METHOD_PHONE'
    CONTACT_METHOD_SMS = 'CONTACT_METHOD_SMS'
    CONTACT_METHOD_MAIL = 'CONTACT_METHOD_MAIL'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientDetailsContactMethod from a JSON string"""
