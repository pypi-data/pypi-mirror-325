...
class CdmProtectionSource(BaseModel):
    """
    ProtectionSource contains source information for product details.
    """ # noqa: E501
    integrator_name: Optional[StrictStr] = None
    product_reference: Optional[StrictStr] = None
    quote_reference: Optional[StrictStr] = None
    provider_reference: Optional[StrictStr] = None
    comparison_reference: Optional[StrictStr] = Field(default=None, description="Integrator's reference for the sourcing transaction which retrieved the parent product (comparison ID).")
    __properties: ClassVar[List[str]] = ["integrator_name", "product_reference", "quote_reference", "provider_reference", "comparison_reference"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmProtectionSource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmProtectionSource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "integrator_name": obj.get("integrator_name"),
            ...
            "comparison_reference": obj.get("comparison_reference")
        })
        return _obj
