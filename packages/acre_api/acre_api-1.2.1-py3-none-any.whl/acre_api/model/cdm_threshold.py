...
class CdmThreshold(BaseModel):
    """
    CdmThreshold
    """ # noqa: E501
    percentage: Optional[StrictInt] = Field(default=None, description="The percentage applicable to the sum of all ledgers that fell into this tier threshold. This value must be in our standard 5dp percentage format.")
    var_from: Optional[StrictStr] = Field(default=None, description="From represents the lower bound value in pence of the threshold that will be taken into account for the commission calculation.", alias="from")
    to: Optional[StrictStr] = Field(default=None, description="To represents the higher bound value in pence of the threshold that will be taken into account for the commission calculation.")
    __properties: ClassVar[List[str]] = ["percentage", "from", "to"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmThreshold from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmThreshold from a dict"""
        if obj is None:
            return None
