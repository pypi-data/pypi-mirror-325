...
class CdmHealthCheckReport(BaseModel):
    """
    Health check status of an individual service.
    """ # noqa: E501
    timestamp: Optional[StrictStr] = Field(default=None, description="Timestamp of when the report was generated (RFC3339).")
    status: Optional[StrictStr] = Field(default=None, description="Status of the service.")
    service_name: Optional[StrictStr] = Field(default=None, description="Name of the service.")
    service_version: Optional[StrictStr] = Field(default=None, description="Version of the service.")
    __properties: ClassVar[List[str]] = ["timestamp", "status", "service_name", "service_version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmHealthCheckReport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmHealthCheckReport from a dict"""
        if obj is None:
            return None
