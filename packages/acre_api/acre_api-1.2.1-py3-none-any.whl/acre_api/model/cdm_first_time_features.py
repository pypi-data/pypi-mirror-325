...
class CdmFirstTimeFeatures(BaseModel):
    """
    FirstTimeFeatures allows Acre Applications to store which individual feature tours are complete.
    """ # noqa: E501
    feature: Optional[StrictStr] = Field(default=None, description="The name of the feature.")
    complete: Optional[StrictBool] = Field(default=None, description="Whether this feature has been completed.")
    __properties: ClassVar[List[str]] = ["feature", "complete"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmFirstTimeFeatures from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmFirstTimeFeatures from a dict"""
        if obj is None:
            return None
