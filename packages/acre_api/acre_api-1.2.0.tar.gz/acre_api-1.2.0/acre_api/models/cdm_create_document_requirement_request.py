...
class CdmCreateDocumentRequirementRequest(BaseModel):
    """
    CdmCreateDocumentRequirementRequest
    """ # noqa: E501
    document_requirement: CdmDocumentRequirement
    __properties: ClassVar[List[str]] = ["document_requirement"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateDocumentRequirementRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateDocumentRequirementRequest from a dict"""
        if obj is None:
            return None
