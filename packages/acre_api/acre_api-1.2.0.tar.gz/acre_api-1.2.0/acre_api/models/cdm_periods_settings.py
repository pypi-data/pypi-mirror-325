...
class CdmPeriodsSettings(BaseModel):
    """
    CdmPeriodsSettings
    """ # noqa: E501
    periods: Optional[List[CdmPeriod]] = Field(default=None, description="List of periods defining each of the name and dates.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmPeriodsSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmPeriodsSettings from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "periods": [CdmPeriod.from_dict(_item) for _item in obj["periods"]] if obj.get("periods") is not None else None
        })
        return _obj
