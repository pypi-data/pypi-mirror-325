...
class CdmMortgageProductDetailsMortgageType(str, Enum):
    """
    CdmMortgageProductDetailsMortgageType
    """
    ...
    BTL = 'BTL'
    REGULATED_BTL = 'REGULATED_BTL'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmMortgageProductDetailsMortgageType from a JSON string"""
