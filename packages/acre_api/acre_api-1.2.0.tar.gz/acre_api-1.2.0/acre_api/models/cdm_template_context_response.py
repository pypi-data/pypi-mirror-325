...
class CdmTemplateContextResponse(BaseModel):
    """
    Response to a template context request.
    """ # noqa: E501
    ctx: Optional[StrictStr] = Field(default=None, description="Rendered document.")
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["ctx", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmTemplateContextResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmTemplateContextResponse from a dict"""
        if obj is None:
            return None
