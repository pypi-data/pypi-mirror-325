...
class CdmReplaceClientResponse(BaseModel):
    """
    Response to the replacement of a client.
    """ # noqa: E501
    client: CdmClient
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmReplaceClientResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmReplaceClientResponse from a dict"""
        if obj is None:
            return None
