...
class NoteEventNote(BaseModel):
    """
    EventNote contains the data for notes representing an event.
    """ # noqa: E501
    event_id: Optional[StrictStr] = Field(default=None, description="ID of the event that note relates to.")
    user_ids: Optional[List[StrictStr]] = Field(default=None, description="IDs of users involved in the event.")
    event_type: Optional[EventNoteEventNoteType] = EventNoteEventNoteType.INVALID_EVENT_NOTE_TYPE
    start_time: Optional[StrictStr] = Field(default=None, description="The start date-time of the event (ISO 8601).")
    end_time: Optional[StrictStr] = Field(default=None, description="The end date-time of the event (ISO 8601).")
    __properties: ClassVar[List[str]] = ["event_id", "user_ids", "event_type", "start_time", "end_time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NoteEventNote from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NoteEventNote from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "event_type": obj.get("event_type") if obj.get("event_type") is not None else EventNoteEventNoteType.INVALID_EVENT_NOTE_TYPE,
