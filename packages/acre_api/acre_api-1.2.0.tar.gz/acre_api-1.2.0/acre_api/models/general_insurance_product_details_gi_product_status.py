...
class GeneralInsuranceProductDetailsGIProductStatus(str, Enum):
    """
    Valid status for General insurance products.   - SELECTED: The product the Broker has selected for recommendation.  - PROPOSED: A product option under consideration.  - APPLICATION_IN_PROGRESS: A SELECTED product for which an application has been started.  - CURRENT: An in-force insurance policy.  - EXPIRED: A policy that was previously in-force, but that is no longer.
    """

    """
    allowed enum values
    """
    GI_PRODUCT_STATUS_INVALID = 'GI_PRODUCT_STATUS_INVALID'
    SELECTED = 'SELECTED'
    PROPOSED = 'PROPOSED'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GeneralInsuranceProductDetailsGIProductStatus from a JSON string"""
