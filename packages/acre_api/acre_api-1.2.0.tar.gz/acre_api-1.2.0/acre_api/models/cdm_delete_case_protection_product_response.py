...
class CdmDeleteCaseProtectionProductResponse(BaseModel):
    """
    Response to removing a protection product from a case.
    """ # noqa: E501
    case_id: Optional[StrictStr] = Field(default=None, description="Case to remove the product.")
    protection_id: Optional[StrictStr] = Field(default=None, description="ID of the removed product.")
    protection_product: Optional[CdmProtectionProduct] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["case_id", "protection_id", "protection_product", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmDeleteCaseProtectionProductResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of protection_product
        if self.protection_product:
            _dict['protection_product'] = self.protection_product.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmDeleteCaseProtectionProductResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "protection_product": CdmProtectionProduct.from_dict(obj["protection_product"]) if obj.get("protection_product") is not None else None,
