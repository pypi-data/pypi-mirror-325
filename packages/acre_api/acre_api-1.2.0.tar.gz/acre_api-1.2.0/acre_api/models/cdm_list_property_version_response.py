...
class CdmListPropertyVersionResponse(BaseModel):
    """
    Response to list property versions.
    """ # noqa: E501
    properties: Optional[List[CdmProperty]] = Field(default=None, description="Property versions (in each Property object, details will be null).")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmListPropertyVersionRequest] = None
    __properties: ClassVar[List[str]] = ["properties", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmListPropertyVersionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmListPropertyVersionResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "properties": [CdmProperty.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmListPropertyVersionRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
