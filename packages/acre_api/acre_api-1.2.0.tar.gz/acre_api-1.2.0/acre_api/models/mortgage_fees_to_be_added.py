...
class MortgageFeesToBeAdded(str, Enum):
    """
    MortgageFeesToBeAdded
    """

    """
    allowed enum values
    """
    INVALID_FEES_TO_BE_ADDED_TYPE = 'INVALID_FEES_TO_BE_ADDED_TYPE'
    VALUATION_FEE = 'VALUATION_FEE'
    ARRANGEMENT_FEE = 'ARRANGEMENT_FEE'
    BOOKING_FEE = 'BOOKING_FEE'
    HIGHER_LENDING_CHARGE = 'HIGHER_LENDING_CHARGE'
    CHAPS_FEE = 'CHAPS_FEE'
    HOMEBUYERS_FEE = 'HOMEBUYERS_FEE'
    LEGAL_FEE = 'LEGAL_FEE'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of MortgageFeesToBeAdded from a JSON string"""
