...
class HydratedCaseMortgagePair(BaseModel):
    """
    HydratedCaseMortgagePair
    """ # noqa: E501
    mortgage_id: Optional[StrictStr] = None
    mortgage: Optional[CdmMortgage] = None
    mortgage_product: Optional[CdmMortgageProductDetails] = None
    product_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["mortgage_id", "mortgage", "mortgage_product", "product_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HydratedCaseMortgagePair from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of mortgage_product
        if self.mortgage_product:
            _dict['mortgage_product'] = self.mortgage_product.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HydratedCaseMortgagePair from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "mortgage_product": CdmMortgageProductDetails.from_dict(obj["mortgage_product"]) if obj.get("mortgage_product") is not None else None,
