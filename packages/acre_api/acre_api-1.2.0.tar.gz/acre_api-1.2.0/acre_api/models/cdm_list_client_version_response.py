...
class CdmListClientVersionResponse(BaseModel):
    """
    Response to list client versions.
    """ # noqa: E501
    clients: Optional[List[CdmClient]] = Field(default=None, description="Client versions (in each Client object, details will be null).")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmListClientVersionRequest] = None
    __properties: ClassVar[List[str]] = ["clients", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmListClientVersionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmListClientVersionResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "clients": [CdmClient.from_dict(_item) for _item in obj["clients"]] if obj.get("clients") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmListClientVersionRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
