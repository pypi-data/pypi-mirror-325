...
class CdmUnderwritingLevel(str, Enum):
    """
    Underwriting level of PMI policies.
    """

    """
    allowed enum values
    """
    UNDERWRITING_LEVEL_INVALID = 'UNDERWRITING_LEVEL_INVALID'
    UNDERWRITING_LEVEL_FULL_MEDICAL_UNDERWRITING = 'UNDERWRITING_LEVEL_FULL_MEDICAL_UNDERWRITING'
    UNDERWRITING_LEVEL_MORATORIUM = 'UNDERWRITING_LEVEL_MORATORIUM'
    UNDERWRITING_LEVEL_MEDICAL_HISTORY_DISREGARDED = 'UNDERWRITING_LEVEL_MEDICAL_HISTORY_DISREGARDED'
    UNDERWRITING_LEVEL_CONTINUED_PERSONAL_MEDICAL_EXCLUSIONS = 'UNDERWRITING_LEVEL_CONTINUED_PERSONAL_MEDICAL_EXCLUSIONS'
    UNDERWRITING_LEVEL_CONTINUED_MORATORIUM = 'UNDERWRITING_LEVEL_CONTINUED_MORATORIUM'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmUnderwritingLevel from a JSON string"""
