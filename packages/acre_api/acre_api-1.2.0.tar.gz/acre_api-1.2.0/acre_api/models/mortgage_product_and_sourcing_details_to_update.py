...
class MortgageProductAndSourcingDetailsToUpdate(BaseModel):
    """
    MortgageProductAndSourcingDetailsToUpdate
    """ # noqa: E501
    mortgage: Optional[PartialDetailsOfTheMortgageToBeReplacedRequired1] = None
    ...
    __properties: ClassVar[List[str]] = ["mortgage", "product_details", "source_response", "product_source_rank", "product_select_reason"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MortgageProductAndSourcingDetailsToUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MortgageProductAndSourcingDetailsToUpdate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mortgage": PartialDetailsOfTheMortgageToBeReplacedRequired1.from_dict(obj["mortgage"]) if obj.get("mortgage") is not None else None,
