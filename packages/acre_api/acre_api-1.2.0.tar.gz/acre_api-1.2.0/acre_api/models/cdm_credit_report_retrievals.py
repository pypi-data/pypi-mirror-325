...
class CdmCreditReportRetrievals(BaseModel):
    """
    Credit Report retrieval details.
    """ # noqa: E501
    raw_result_reference: Optional[StrictStr] = Field(default=None, description="Reference to the raw results received from the credit agency.")
    raw_result_signature: Optional[StrictStr] = Field(default=None, description="A base64 encoded cryptographic signature of the raw results.")
    retrieval_time: Optional[StrictStr] = Field(default=None, description="An RFC3339 timestamp of when the credit report was retrieved.")
    pdf_document_id: Optional[StrictStr] = Field(default=None, description="A reference to a PDF document stored in Phylum that is a human accessible version of the credit report.")
    credit_search_consent_id: Optional[StrictStr] = Field(default=None, description="ID of credit search consent used to run the search.")
    matches: Optional[CreditReportRetrievalsMatches] = None
    __properties: ClassVar[List[str]] = ["raw_result_reference", "raw_result_signature", "retrieval_time", "pdf_document_id", "credit_search_consent_id", "matches"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreditReportRetrievals from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreditReportRetrievals from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "raw_result_reference": obj.get("raw_result_reference"),
            "raw_result_signature": obj.get("raw_result_signature"),
            "retrieval_time": obj.get("retrieval_time"),
            "pdf_document_id": obj.get("pdf_document_id"),
            "credit_search_consent_id": obj.get("credit_search_consent_id"),
            "matches": CreditReportRetrievalsMatches.from_dict(obj["matches"]) if obj.get("matches") is not None else None
        })
        return _obj
