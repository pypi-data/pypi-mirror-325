...
class CdmCreateCaseReferralRequest(BaseModel):
    """
    Creates a new case from an existing case.
    """ # noqa: E501
    case_id: StrictStr = Field(description="Case ID to create the referral from.")
    client_ids: List[StrictStr] = Field(description="Client IDs to set on the new case being created. Have to be a subset of client IDs on the case that the referral is being created from.")
    preference_mortgage_reason: CaseDetailsMortgageReason
    target_user_id: StrictStr = Field(description="User ID to assign the new case to.")
    fee_option_title: Optional[StrictStr] = Field(default=None, description="Set of fee options chosen for the case.")
    __properties: ClassVar[List[str]] = ["case_id", "client_ids", "preference_mortgage_reason", "target_user_id", "fee_option_title"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateCaseReferralRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateCaseReferralRequest from a dict"""
        if obj is None:
            return None
