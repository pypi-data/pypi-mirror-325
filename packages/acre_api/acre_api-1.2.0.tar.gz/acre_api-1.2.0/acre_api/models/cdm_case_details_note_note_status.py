...
class CdmCaseDetailsNoteNoteStatus(str, Enum):
    """
    CdmCaseDetailsNoteNoteStatus
    """

    """
    allowed enum values
    """
    INVALID_NOTE_STATUS = 'INVALID_NOTE_STATUS'
    COMPLETE = 'COMPLETE'
    ARCHIVED = 'ARCHIVED'
    UNREAD = 'UNREAD'
    READ = 'READ'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmCaseDetailsNoteNoteStatus from a JSON string"""
