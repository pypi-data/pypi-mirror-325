...
class CdmBulkAssignCaseResponse(BaseModel):
    """
    CdmBulkAssignCaseResponse
    """ # noqa: E501
    cases: Optional[List[CdmBulkAssignCase]] = Field(default=None, description="Information about the bulk assigned cases.")
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["cases", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmBulkAssignCaseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmBulkAssignCaseResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "cases": [CdmBulkAssignCase.from_dict(_item) for _item in obj["cases"]] if obj.get("cases") is not None else None,
