...
class CdmGetGeneralInsuranceProductRequest(BaseModel):
    """
    Get general insurance products. Request must specify either IDs or one or more filters. Filters are combined using logical conjunction.
    """ # noqa: E501
    general_insurance_product_ids: Optional[List[StrictStr]] = Field(default=None, description="Return products by IDs. Incompatible with filters.")
    filter_property_ids: Optional[List[StrictStr]] = Field(default=None, description="Return products that are associated with all of the property IDs.")
    filter_client_ids: Optional[List[StrictStr]] = Field(default=None, description="Return products that are associated with all of the client IDs.")
    filter_case_ids: Optional[List[StrictStr]] = Field(default=None, description="Return products that are associated with all of the case IDs.")
    ...
    page_size: Optional[StrictInt] = Field(default=None, description="Specify a limit on the number of items returned in a page. Values that are too large will be rejected. All requests are subject to the page size, which is 25 if not specified and can be specified up to 50.")
    __properties: ClassVar[List[str]] = ["general_insurance_product_ids", "filter_property_ids", "filter_client_ids", "filter_case_ids", "bookmark", "page_size"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetGeneralInsuranceProductRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetGeneralInsuranceProductRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "general_insurance_product_ids": obj.get("general_insurance_product_ids"),
            "filter_property_ids": obj.get("filter_property_ids"),
