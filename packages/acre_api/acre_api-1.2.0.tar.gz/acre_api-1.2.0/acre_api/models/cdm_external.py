...
class CdmExternal(BaseModel):
    """
    Identifying info about a given resource in an external system (ExternalID will be eventually replaced by External).
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Acre internal identifier.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmExternal from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmExternal from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "source": ExternalSource.from_dict(obj["source"]) if obj.get("source") is not None else None
        })
        return _obj
