...
class CdmClientDepositType(str, Enum):
    """
    CdmClientDepositType
    """
    ...
    GIFT = 'GIFT'
    OTHER = 'OTHER'
    VENDOR_INDUCEMENT = 'VENDOR_INDUCEMENT'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmClientDepositType from a JSON string"""
