...
class CdmProductBenefitTypeUnits(BaseModel):
    """
    CdmProductBenefitTypeUnits
    """ # noqa: E501
    client_ids: Optional[List[StrictStr]] = Field(default=None, description="The client(s) to whom the product benefit is tied.")
    units_of_cover: Optional[CdmCoverUnits] = CdmCoverUnits.COVER_UNITS_INVALID
    cost_amount: Optional[StrictStr] = Field(default=None, description="The cost of the cover.")
    cost_amount_frequency: Optional[CdmFrequency] = CdmFrequency.INVALID
    __properties: ClassVar[List[str]] = ["client_ids", "units_of_cover", "cost_amount", "cost_amount_frequency"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmProductBenefitTypeUnits from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmProductBenefitTypeUnits from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "units_of_cover": obj.get("units_of_cover") if obj.get("units_of_cover") is not None else CdmCoverUnits.COVER_UNITS_INVALID,
            "cost_amount": obj.get("cost_amount"),
            "cost_amount_frequency": obj.get("cost_amount_frequency") if obj.get("cost_amount_frequency") is not None else CdmFrequency.INVALID
        })
        return _obj
