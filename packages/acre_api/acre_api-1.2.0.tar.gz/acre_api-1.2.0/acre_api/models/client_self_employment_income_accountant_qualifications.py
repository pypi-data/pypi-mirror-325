...
class ClientSelfEmploymentIncomeAccountantQualifications(str, Enum):
    """
    ClientSelfEmploymentIncomeAccountantQualifications
    """

    """
    allowed enum values
    """
    INVALID_ACCOUNTANT_QUALIFICATION = 'INVALID_ACCOUNTANT_QUALIFICATION'
    ACA = 'ACA'
    ACCA = 'ACCA'
    FCA = 'FCA'
    FCCA = 'FCCA'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientSelfEmploymentIncomeAccountantQualifications from a JSON string"""
