...
class MortgageApplicationRefusedApplicationRefusedType(str, Enum):
    """
    MortgageApplicationRefusedApplicationRefusedType
    """

    """
    allowed enum values
    """
    INVALID_APPLICATION_REFUSED_TYPE = 'INVALID_APPLICATION_REFUSED_TYPE'
    CREDIT_CARD = 'CREDIT_CARD'
    HIRE_PURCHASE_AGREEMENT = 'HIRE_PURCHASE_AGREEMENT'
    MORTGAGE = 'MORTGAGE'
    UNSECURED_LOAN = 'UNSECURED_LOAN'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of MortgageApplicationRefusedApplicationRefusedType from a JSON string"""
