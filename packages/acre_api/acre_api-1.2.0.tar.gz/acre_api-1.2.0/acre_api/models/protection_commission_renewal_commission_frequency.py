...
class ProtectionCommissionRenewalCommissionFrequency(str, Enum):
    """
    How often the commission is renewed.   - MONTHLY: Monthly renewal commission frequency.  - ANNUAL: Annual renewal commission frequency.
    """

    """
    allowed enum values
    """
    INVALID_COMMISSION_FREQUENCY = 'INVALID_COMMISSION_FREQUENCY'
    MONTHLY = 'MONTHLY'
    ANNUAL = 'ANNUAL'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProtectionCommissionRenewalCommissionFrequency from a JSON string"""
