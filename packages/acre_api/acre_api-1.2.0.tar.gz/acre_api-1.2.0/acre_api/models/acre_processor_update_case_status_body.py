...
class AcreProcessorUpdateCaseStatusBody(BaseModel):
    """
    Update a case's status.
    """ # noqa: E501
    update: Optional[CdmCaseStatusUpdateType] = CdmCaseStatusUpdateType.INVALID_UPDATE_TYPE
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AcreProcessorUpdateCaseStatusBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AcreProcessorUpdateCaseStatusBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "update": obj.get("update") if obj.get("update") is not None else CdmCaseStatusUpdateType.INVALID_UPDATE_TYPE
        })
        return _obj
