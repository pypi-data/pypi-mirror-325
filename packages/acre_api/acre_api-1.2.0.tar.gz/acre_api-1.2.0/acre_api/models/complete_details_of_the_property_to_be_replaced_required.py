...
class CompleteDetailsOfThePropertyToBeReplacedRequired(BaseModel):
    """
    CompleteDetailsOfThePropertyToBeReplacedRequired
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["created_at", "version", "version_created_at", "details", "versions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompleteDetailsOfThePropertyToBeReplacedRequired from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompleteDetailsOfThePropertyToBeReplacedRequired from a dict"""
        if obj is None:
            return None
