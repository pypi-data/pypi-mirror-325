...
class CdmClientDependant(BaseModel):
    """
    CdmClientDependant
    """ # noqa: E501
    date_of_birth: Optional[StrictStr] = Field(default=None, description="The dependant's date of birth (YYYY-MM).")
    relationship: Optional[CdmClientDependantRelationshipType] = CdmClientDependantRelationshipType.INVALID_RELATIONSHIP_TYPE
    relationship_other: Optional[StrictStr] = Field(default=None, description="Description of the relationship when the relationship field is OTHER.")
    name: Optional[StrictStr] = Field(default=None, description="Name of dependant.")
    title: Optional[CdmTitle] = CdmTitle.INVALID_TITLE
    dependency_end_date: Optional[StrictStr] = Field(default=None, description="The date the individual will no longer be a dependant (YYYY-MM-DD).")
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for this entry.")
    __properties: ClassVar[List[str]] = ["date_of_birth", "relationship", "relationship_other", "name", "title", "dependency_end_date", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmClientDependant from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmClientDependant from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "relationship": obj.get("relationship") if obj.get("relationship") is not None else CdmClientDependantRelationshipType.INVALID_RELATIONSHIP_TYPE,
            "relationship_other": obj.get("relationship_other"),
            "name": obj.get("name"),
            "title": obj.get("title") if obj.get("title") is not None else CdmTitle.INVALID_TITLE,
            "dependency_end_date": obj.get("dependency_end_date"),
            "id": obj.get("id")
        })
        return _obj
