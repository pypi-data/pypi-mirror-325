...
class CdmProductBenefitTypePmi(BaseModel):
    """
    CdmProductBenefitTypePmi
    """ # noqa: E501
    ...
    term_years: Optional[StrictInt] = Field(default=None, description="The premium type on the product.")
    ...
    __properties: ClassVar[List[str]] = ["client_ids", "cover_amount", "cover_amount_frequency", "term_years", "excess_amount", "underwriting_level"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmProductBenefitTypePmi from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmProductBenefitTypePmi from a dict"""
        if obj is None:
            return None
