...
class PropertyDetailsPropertyLocation(str, Enum):
    """
    ...
    allowed enum values
    """
    INVALID_PROPERTY_LOCATION = 'INVALID_PROPERTY_LOCATION'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PropertyDetailsPropertyLocation from a JSON string"""
