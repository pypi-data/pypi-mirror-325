...
class CdmDocumentMetadata(BaseModel):
    """
    Metadata for a document.
    """ # noqa: E501
    fees: Optional[List[CdmFee]] = Field(default=None, description="Fees associated with this document. **IMPORTANT:** This field cannot be set directly, populated on IDD render.")
    url: Optional[StrictStr] = Field(default=None, description="A URL parameter to be used in the template.")
    __properties: ClassVar[List[str]] = ["fees", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmDocumentMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmDocumentMetadata from a dict"""
        if obj is None:
            return None
