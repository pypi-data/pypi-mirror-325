...
class CdmMortgageType(str, Enum):
    """
     - MORTGAGE_STANDARD: Standard (default).
    """

    """
    allowed enum values
    """
    INVALID_MORTGAGE_TYPE = 'INVALID_MORTGAGE_TYPE'
    MORTGAGE_STANDARD = 'MORTGAGE_STANDARD'
    MORTGAGE_BUY_TO_LET = 'MORTGAGE_BUY_TO_LET'
    MORTGAGE_RIGHT_TO_BUY = 'MORTGAGE_RIGHT_TO_BUY'
    MORTGAGE_SHARED_OWNERSHIP = 'MORTGAGE_SHARED_OWNERSHIP'
    MORTGAGE_SELF_BUILD = 'MORTGAGE_SELF_BUILD'
    MORTGAGE_SHARED_EQUITY = 'MORTGAGE_SHARED_EQUITY'
    MORTGAGE_SECURED_LOAN = 'MORTGAGE_SECURED_LOAN'
    MORTGAGE_SECURED_LOAN_BTL = 'MORTGAGE_SECURED_LOAN_BTL'
    MORTGAGE_BRIDGING_LOAN = 'MORTGAGE_BRIDGING_LOAN'
    MORTGAGE_COMMERCIAL = 'MORTGAGE_COMMERCIAL'
    MORTGAGE_LET_TO_BUY = 'MORTGAGE_LET_TO_BUY'
    MORTGAGE_STANDARD_OR_SHARED_EQUITY = 'MORTGAGE_STANDARD_OR_SHARED_EQUITY'
    MORTGAGE_SECURED_LOAN_LET_TO_BUY = 'MORTGAGE_SECURED_LOAN_LET_TO_BUY'
    MORTGAGE_SECURED_LOAN_SHARED_OWNERSHIP = 'MORTGAGE_SECURED_LOAN_SHARED_OWNERSHIP'
    MORTGAGE_EQUITY_RELEASE = 'MORTGAGE_EQUITY_RELEASE'
    NEW_TEST = 'NEW_TEST'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmMortgageType from a JSON string"""
