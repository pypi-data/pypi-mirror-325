...
class VerificationFlagStatus(str, Enum):
    """
     - FLAG_CRITICAL: Critical flag that does not allow proceeding through gate (e.g., fraud).  - FLAG_WARNING: Warning is for \"soft\" indicators. Soft warning flag that does not prevent recommendation, but is displayed.  - FLAG_CLEARED: Cleared indicates that an authority has approved the critical flag to proceed. E.g., provisional competency/pre-sales check cleared.
    """

    """
    allowed enum values
    """
    INVALID_FLAG_STATUS = 'INVALID_FLAG_STATUS'
    FLAG_NONE = 'FLAG_NONE'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of VerificationFlagStatus from a JSON string"""
