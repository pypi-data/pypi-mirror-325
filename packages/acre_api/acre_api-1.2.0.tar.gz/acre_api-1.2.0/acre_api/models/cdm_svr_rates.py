...
class CdmSVRRates(BaseModel):
    """
    CdmSVRRates
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The lenders name for this rate.")
    current_rate: Optional[StrictInt] = Field(default=None, description="The current rate.")
    twenty_year: Optional[StrictInt] = Field(default=None, description="The twenty year maximum of this rate. (Used for ESIS generation).")
    resi_default: Optional[StrictBool] = Field(default=None, description="Whether this is the default SVR rate for residential mortgages.")
    btl_default: Optional[StrictBool] = Field(default=None, description="Whether this is the default SVR rate for BTL mortgages.")
    __properties: ClassVar[List[str]] = ["name", "current_rate", "twenty_year", "resi_default", "btl_default"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmSVRRates from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmSVRRates from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "twenty_year": obj.get("twenty_year"),
            "resi_default": obj.get("resi_default"),
            "btl_default": obj.get("btl_default")
        })
        return _obj
