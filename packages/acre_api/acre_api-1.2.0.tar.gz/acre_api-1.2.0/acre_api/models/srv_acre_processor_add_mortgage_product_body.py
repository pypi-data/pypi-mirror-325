...
class SrvAcreProcessorAddMortgageProductBody(BaseModel):
    """
    Add a mortgage product to a mortgage.
    """ # noqa: E501
    product_id: Optional[StrictStr] = Field(default=None, description="Acre ID of an existing product.")
    product_code: Optional[StrictStr] = Field(default=None, description="Sourced code of the product to be added (requires `source_response` set).")
    source_response: Optional[CdmRunSourceResponse] = None
    product_source_rank: Optional[StrictInt] = Field(default=None, description="Rank of the product in the source response (first element is rank 0).")
    product_select_reason: Optional[StrictStr] = Field(default=None, description="Reason for selecting the mortgage.")
    __properties: ClassVar[List[str]] = ["product_id", "product_code", "source_response", "product_source_rank", "product_select_reason"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SrvAcreProcessorAddMortgageProductBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SrvAcreProcessorAddMortgageProductBody from a dict"""
        if obj is None:
            return None
