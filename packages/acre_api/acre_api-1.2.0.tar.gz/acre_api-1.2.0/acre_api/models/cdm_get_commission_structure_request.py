...
class CdmGetCommissionStructureRequest(BaseModel):
    """
    CdmGetCommissionStructureRequest
    """ # noqa: E501
    commission_structure_ids: Optional[List[StrictStr]] = Field(default=None, description="Return commission structure by IDs. Incompatible with \"filter_paying_organisation_id\", \"filter_receiving_organisation_id\" and \"filter_receiving_user_id\".")
    filter_paying_organisation_id: Optional[StrictStr] = Field(default=None, description="Return all commission structure by paying organisation. Incompatible with \"commission_structure_ids\".")
    filter_receiving_organisation_id: Optional[StrictStr] = Field(default=None, description="Return all commission structure by receiving organisation. Incompatible with \"commission_structure_ids\" and \"filter_receiving_user_id\".")
    filter_receiving_user_id: Optional[StrictStr] = Field(default=None, description="Return all commission structure by receiving user. Incompatible with \"commission_structure_ids\" and \"filter_receiving_organisation_id\".")
    ...
    __properties: ClassVar[List[str]] = ["commission_structure_ids", "filter_paying_organisation_id", "filter_receiving_organisation_id", "filter_receiving_user_id", "bookmark", "page_size"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetCommissionStructureRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetCommissionStructureRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "commission_structure_ids": obj.get("commission_structure_ids"),
            "filter_paying_organisation_id": obj.get("filter_paying_organisation_id"),
            "filter_receiving_organisation_id": obj.get("filter_receiving_organisation_id"),
            "filter_receiving_user_id": obj.get("filter_receiving_user_id"),
