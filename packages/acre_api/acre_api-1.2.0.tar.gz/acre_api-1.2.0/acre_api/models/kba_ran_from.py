...
class KBARanFrom(str, Enum):
    """
     - INVALID: KBA execution platform is not set.  - CRM: Indicating that this KBA was executed via CRM. This should be the default.  - CP: Indicating that this KBA was executed via Client Portal.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of KBARanFrom from a JSON string"""
