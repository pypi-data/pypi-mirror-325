...
class CdmGetUserResponse(BaseModel):
    """
    Response to a request for details of users.
    """ # noqa: E501
    users: Optional[List[CdmUser]] = None
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetUserRequest] = None
    __properties: ClassVar[List[str]] = ["users", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetUserResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetUserResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "users": [CdmUser.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmGetUserRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
