...
class ProtectionProductNotProceedingEntityType(str, Enum):
    """
    EntityType describes the entities which can choose to stop the product from proceeding.   - CLIENT: The client chose not to proceed with the product.  - PROVIDER: The product provider chose not to proceed with the product.  - SYSTEM: The case was marked as not proceeding and so the product was automatically marked as not proceeding.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProtectionProductNotProceedingEntityType from a JSON string"""
