...
class CdmCreateNoteResponse(BaseModel):
    """
    Response to note creation.
    """ # noqa: E501
    note: Optional[CdmNote] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["note", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateNoteResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateNoteResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "note": CdmNote.from_dict(obj["note"]) if obj.get("note") is not None else None,
