...
class CdmProtectionProductNotProceeding(BaseModel):
    """
    CdmProtectionProductNotProceeding
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="The justification for the product not proceeding.")
    reason_entity: Optional[ProtectionProductNotProceedingEntityType] = ProtectionProductNotProceedingEntityType.INVALID
    __properties: ClassVar[List[str]] = ["reason", "reason_entity"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmProtectionProductNotProceeding from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmProtectionProductNotProceeding from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "reason_entity": obj.get("reason_entity") if obj.get("reason_entity") is not None else ProtectionProductNotProceedingEntityType.INVALID
        })
        return _obj
