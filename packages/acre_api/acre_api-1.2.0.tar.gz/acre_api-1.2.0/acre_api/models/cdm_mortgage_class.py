...
class CdmMortgageClass(str, Enum):
    """
    CdmMortgageClass
    """
    ...
    allowed enum values
    """
    INVALID_MORTGAGE_CLASS = 'INVALID_MORTGAGE_CLASS'
    CLASS_FIXED = 'CLASS_FIXED'
    CLASS_DISCOUNT = 'CLASS_DISCOUNT'
    CLASS_VARIABLE = 'CLASS_VARIABLE'
    CLASS_CAPPED = 'CLASS_CAPPED'
    CLASS_LIBOR = 'CLASS_LIBOR'
    CLASS_TRACKER = 'CLASS_TRACKER'
    CLASS_STEPPED = 'CLASS_STEPPED'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmMortgageClass from a JSON string"""
