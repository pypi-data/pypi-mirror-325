...
class TrainingAndCompetencyEquityReleaseQualification(str, Enum):
    """
     - CERTIFICATE_IN_INVESTMENT_AND_FINANCIAL_ADVICE: Certificate in Investment and Financial Advice - Paper 1 (ER).  - CERTIFICATE_IN_EQUITY_RELEASE: Certificate in Equity Release.  - CERTIFICATE_IN_REGULATED_EQUITY_RELEASE: Certificate in Regulated Equity Release (Formerly known as Certificate in Lifetime Mortgages).  - INVESTMENT_ADVICE_CERTIFICATE: Investment Advice Certificate.
    """

    """
    allowed enum values
    """
    INVALID_EQUITY_RELEASE_QUALIFICATION = 'INVALID_EQUITY_RELEASE_QUALIFICATION'
    CERTIFICATE_IN_INVESTMENT_AND_FINANCIAL_ADVICE = 'CERTIFICATE_IN_INVESTMENT_AND_FINANCIAL_ADVICE'
    CERTIFICATE_IN_EQUITY_RELEASE = 'CERTIFICATE_IN_EQUITY_RELEASE'
    CERTIFICATE_IN_REGULATED_EQUITY_RELEASE = 'CERTIFICATE_IN_REGULATED_EQUITY_RELEASE'
    INVESTMENT_ADVICE_CERTIFICATE = 'INVESTMENT_ADVICE_CERTIFICATE'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TrainingAndCompetencyEquityReleaseQualification from a JSON string"""
