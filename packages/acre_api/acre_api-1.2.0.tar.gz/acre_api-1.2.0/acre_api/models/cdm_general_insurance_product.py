...
class CdmGeneralInsuranceProduct(BaseModel):
    """
    GeneralInsuranceProduct captures insurance products on the case.
    """ # noqa: E501
    general_insurance_product_id: Optional[StrictStr] = Field(default=None, description="Case insurance product reference. Populated automatically; cannot be set.")
    client_ids: Optional[List[StrictStr]] = Field(default=None, description="Client IDs associated with the product.")
    case_ids: Optional[List[StrictStr]] = Field(default=None, description="Case IDs associated with the product. **IMPORTANT:** This field cannot be updated directly, only through the general_insurace_product/case APIs.")
    details: Optional[CdmGeneralInsuranceProductDetails] = None
    property_ids: Optional[List[StrictStr]] = Field(default=None, description="Property IDs associated with the insurance product.")
    created_at: Optional[StrictStr] = Field(default=None, description="Creation date (RFC3339) of the GI product. Populated automatically; cannot be set.")
    __properties: ClassVar[List[str]] = ["general_insurance_product_id", "client_ids", "case_ids", "details", "property_ids", "created_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGeneralInsuranceProduct from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGeneralInsuranceProduct from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "details": CdmGeneralInsuranceProductDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,
