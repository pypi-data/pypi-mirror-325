...
class CdmGetTemplateResponse(BaseModel):
    """
    Response to a request for details of a template.
    """ # noqa: E501
    templates: Optional[List[CdmTemplate]] = Field(default=None, description="Information about the requested templates. If the request was a wildcard, then the templates are returned in the order that they were created. Otherwise, the templates are returned in the order that their IDs were specified in the request.")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetTemplateRequest] = None
    __properties: ClassVar[List[str]] = ["templates", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetTemplateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetTemplateResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "templates": [CdmTemplate.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmGetTemplateRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
