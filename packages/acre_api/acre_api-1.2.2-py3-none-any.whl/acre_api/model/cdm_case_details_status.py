...
class CdmCaseDetailsStatus(str, Enum):
    """
    IMPORTANT: Status values match those defined for GetCaseRequest.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmCaseDetailsStatus from a JSON string"""
