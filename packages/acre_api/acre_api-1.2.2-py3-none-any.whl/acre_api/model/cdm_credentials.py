...
class CdmCredentials(BaseModel):
    ...
    username: Optional[StrictStr] = Field(default=None, description="Username/email for the credentials.")
    password: Optional[StrictStr] = Field(default=None, description="Encrypted password or access token for the credentials.")
    provider: Optional[StrictStr] = Field(default=None, description="Credentials provider.")
    username_provider: Optional[StrictStr] = Field(default=None, description="Username/email provider.")
    metadata: Optional[Dict[str, StrictStr]] = Field(default=None, description="Additional metadata.")
    intelliflo_creds: Optional[CdmIntellifloCreds] = None
    __properties: ClassVar[List[str]] = ["id", "username", "password", "provider", "username_provider", "metadata", "intelliflo_creds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCredentials from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of intelliflo_creds
        if self.intelliflo_creds:
            _dict['intelliflo_creds'] = self.intelliflo_creds.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCredentials from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "username_provider": obj.get("username_provider"),
            "metadata": obj.get("metadata"),
            "intelliflo_creds": CdmIntellifloCreds.from_dict(obj["intelliflo_creds"]) if obj.get("intelliflo_creds") is not None else None
        })
        return _obj
