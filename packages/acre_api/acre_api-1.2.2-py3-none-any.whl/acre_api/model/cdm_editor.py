...
class CdmEditor(BaseModel):
    """
    Details of who/what edited the entity.
    """ # noqa: E501
    type: Optional[EditorEditorTypes] = EditorEditorTypes.INVALID_EDITOR
    id: Optional[StrictStr] = Field(default=None, description="ID/Service name of the user/client/service that was responsible for the last edits.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmEditor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmEditor from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else EditorEditorTypes.INVALID_EDITOR,
            "id": obj.get("id")
        })
        return _obj
