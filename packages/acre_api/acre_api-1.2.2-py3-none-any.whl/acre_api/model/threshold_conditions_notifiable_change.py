...
class ThresholdConditionsNotifiableChange(BaseModel):
    """
    NotifiableChange defines any notifiable changes in the firm.
    """ # noqa: E501
    notifiable_change_occurred: Optional[StrictBool] = None
    fca_notified: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["notifiable_change_occurred", "fca_notified"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ThresholdConditionsNotifiableChange from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ThresholdConditionsNotifiableChange from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "notifiable_change_occurred": obj.get("notifiable_change_occurred"),
            "fca_notified": obj.get("fca_notified")
        })
        return _obj
