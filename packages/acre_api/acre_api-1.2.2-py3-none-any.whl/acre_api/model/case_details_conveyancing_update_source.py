...
class CaseDetailsConveyancingUpdateSource(str, Enum):
    """
    Conveyancing updates. Source of the conveyancing update.
    """

    """
    allowed enum values
    """
    INVALID_CONVEYANCING_UPDATE_SOURCE = 'INVALID_CONVEYANCING_UPDATE_SOURCE'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CaseDetailsConveyancingUpdateSource from a JSON string"""
