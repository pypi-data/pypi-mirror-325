...
class CdmGetCommissionStructureResponse(BaseModel):
    """
    CdmGetCommissionStructureResponse
    """ # noqa: E501
    commission_structures: Optional[List[CdmCommissionStructure]] = Field(default=None, description="Information about the requested commission structures.")
    next_page: Optional[CdmGetCommissionStructureRequest] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["commission_structures", "next_page", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetCommissionStructureResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in commission_structures (list)
        _items = []
        if self.commission_structures:
            for _item_commission_structures in self.commission_structures:
                if _item_commission_structures:
                    _items.append(_item_commission_structures.to_dict())
            _dict['commission_structures'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetCommissionStructureResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "commission_structures": [CdmCommissionStructure.from_dict(_item) for _item in obj["commission_structures"]] if obj.get("commission_structures") is not None else None,
            "next_page": CdmGetCommissionStructureRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None,
