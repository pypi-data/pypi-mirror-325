...
class CdmGetNoteResponse(BaseModel):
    """
    Get notes response.
    """ # noqa: E501
    notes: Optional[List[CdmNote]] = Field(default=None, description="Notes retrieved.")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetNoteRequest] = None
    __properties: ClassVar[List[str]] = ["notes", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetNoteResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetNoteResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "notes": [CdmNote.from_dict(_item) for _item in obj["notes"]] if obj.get("notes") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmGetNoteRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
