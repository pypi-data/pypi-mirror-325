...
class CdmReplaceUserResponse(BaseModel):
    """
    Response to the replacement of a user.
    """ # noqa: E501
    user: Optional[CdmUser] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["user", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmReplaceUserResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmReplaceUserResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "user": CdmUser.from_dict(obj["user"]) if obj.get("user") is not None else None,
