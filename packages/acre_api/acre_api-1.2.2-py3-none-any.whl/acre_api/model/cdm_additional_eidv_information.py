...
class CdmAdditionalEidvInformation(BaseModel):
    """
    Additional field to save additional results or any extra information needed.
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Description of what the data contains.")
    data: Optional[StrictStr] = Field(default=None, description="Additional data to save. It's expected that this field will contain private information, so the value will be obfuscated on the way out unless you have permissions.")
    __properties: ClassVar[List[str]] = ["description", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAdditionalEidvInformation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAdditionalEidvInformation from a dict"""
        if obj is None:
            return None
