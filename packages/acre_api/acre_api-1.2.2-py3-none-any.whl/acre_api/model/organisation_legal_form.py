...
class OrganisationLegalForm(str, Enum):
    """
    Type of organisation legal forms.   - INVALID_LEGAL_FORM: Invalid legal form type.  - LLP: Limited liability partnership organisation.  - LIMITED: Limited organisation.  - PLC: Public limited company organisation.  - SOLE_TRADER: Sole trader organisation.  - PARTNERSHIP: Partnership organisation.  - DIVISION: Division of an organisation.  - GOVERNMENTAL: Government organisation.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OrganisationLegalForm from a JSON string"""
