...
class CaseDetailsLeadMetadata(BaseModel):
    """
    Lead Segmentation.
    """ # noqa: E501
    source: Optional[StrictStr] = Field(default=None, description="The source of a lead e.g. website; telephone; print.")
    campaign: Optional[StrictStr] = Field(default=None, description="A particular advertising campaign.")
    content: Optional[StrictStr] = Field(default=None, description="A particular piece of content or link / CTA.")
    __properties: ClassVar[List[str]] = ["source", "campaign", "content"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CaseDetailsLeadMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CaseDetailsLeadMetadata from a dict"""
        if obj is None:
            return None
