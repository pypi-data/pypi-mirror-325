...
class OrganisationOrganisationType(str, Enum):
    """
    Types of Organisations.   - DA: Must be self-referential.  - AR: Must not be self-referential.
    """

    """
    allowed enum values
    """
    INVALID_ORGANISATION_TYPE = 'INVALID_ORGANISATION_TYPE'
    INSURANCE = 'INSURANCE'
    CLUB = 'CLUB'
    ACRE = 'ACRE'
    DA = 'DA'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OrganisationOrganisationType from a JSON string"""
