...
class PaymentHistoryPaymentHistoryStatusType(str, Enum):
    """
    The status of the account in any one month.
    """
    ...
    ONE_PAYMENT_IN_ARREARS = 'ONE_PAYMENT_IN_ARREARS'
    TWO_PAYMENT_IN_ARREARS = 'TWO_PAYMENT_IN_ARREARS'
    THREE_PAYMENT_IN_ARREARS = 'THREE_PAYMENT_IN_ARREARS'
    FOUR_PAYMENT_IN_ARREARS = 'FOUR_PAYMENT_IN_ARREARS'
    FIVE_PAYMENT_IN_ARREARS = 'FIVE_PAYMENT_IN_ARREARS'
    SIX_PAYMENT_IN_ARREARS = 'SIX_PAYMENT_IN_ARREARS'
    MORE_THAN_6_PAYMENT_IN_ARREARS = 'MORE_THAN_6_PAYMENT_IN_ARREARS'
    SPECIAL_ARRANGEMENT = 'SPECIAL_ARRANGEMENT'
    SETTLED = 'SETTLED'
    DEFAULT = 'DEFAULT'
    NO_STATUS_PROVIDED = 'NO_STATUS_PROVIDED'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentHistoryPaymentHistoryStatusType from a JSON string"""
