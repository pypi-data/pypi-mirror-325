...
class CdmProductBenefitTypeEmployeeBenefit(BaseModel):
    """
    CdmProductBenefitTypeEmployeeBenefit
    """ # noqa: E501
    ...
    additional_notes: Optional[StrictStr] = Field(default=None, description="Free text field for any additional notes.")
    __properties: ClassVar[List[str]] = ["client_ids", "product_type", "additional_notes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmProductBenefitTypeEmployeeBenefit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmProductBenefitTypeEmployeeBenefit from a dict"""
        if obj is None:
            return None
