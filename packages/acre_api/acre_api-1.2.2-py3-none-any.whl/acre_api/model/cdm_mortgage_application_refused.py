...
class CdmMortgageApplicationRefused(BaseModel):
    """
    CdmMortgageApplicationRefused
    """ # noqa: E501
    application_refused_date: Optional[StrictStr] = Field(default=None, description="The date that the application was denied/refused (YYYY-MM-DD).")
    application_refused_creditor: Optional[StrictStr] = Field(default=None, description="The company that refused the application.")
    application_refused_type: Optional[MortgageApplicationRefusedApplicationRefusedType] = MortgageApplicationRefusedApplicationRefusedType.INVALID_APPLICATION_REFUSED_TYPE
    application_refused_details: Optional[StrictStr] = Field(default=None, description="Any futher details about the refused credit application.")
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for this entry.")
    __properties: ClassVar[List[str]] = ["application_refused_date", "application_refused_creditor", "application_refused_type", "application_refused_details", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmMortgageApplicationRefused from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmMortgageApplicationRefused from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "application_refused_date": obj.get("application_refused_date"),
            "application_refused_creditor": obj.get("application_refused_creditor"),
            "application_refused_type": obj.get("application_refused_type") if obj.get("application_refused_type") is not None else MortgageApplicationRefusedApplicationRefusedType.INVALID_APPLICATION_REFUSED_TYPE,
            "application_refused_details": obj.get("application_refused_details"),
            "id": obj.get("id")
        })
        return _obj
