...
class CdmCommissionStructureStatus(str, Enum):
    """
    Commission structure status. Required.   - INVALID_STATUS: Invalid commission structure status.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmCommissionStructureStatus from a JSON string"""
