...
class MortgageDipStatusType(str, Enum):
    """
    MortgageDipStatusType
    """

    """
    allowed enum values
    """
    INVALID_DIP_STATUS = 'INVALID_DIP_STATUS'
    PENDING = 'PENDING'
    DECLINED = 'DECLINED'
    ACCEPTED = 'ACCEPTED'
    REFER = 'REFER'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of MortgageDipStatusType from a JSON string"""
