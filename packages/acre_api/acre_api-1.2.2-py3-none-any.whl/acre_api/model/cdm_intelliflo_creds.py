...
class CdmIntellifloCreds(BaseModel):
    """
    Credentials used to integrate with Intelliflo third-party.
    """ # noqa: E501
    tenant_id: Optional[StrictStr] = Field(default=None, description="An external id that represents a particular firm in Intelliflo expressed as an int.")
    import_sa_subject: Optional[StrictStr] = Field(default=None, description="An internal id (UUID) that represents the firm in Intelliflo used for JWT claims to authenticate with phylum.")
    api_key: Optional[StrictStr] = Field(default=None, description="API key for Intelliflo API. Asymmetrically encrypted.")
    filter_advisors: Optional[List[StrictStr]] = Field(default=None, description="Array of advisors to filter to; if empty / nil, then no filtering.")
    __properties: ClassVar[List[str]] = ["tenant_id", "import_sa_subject", "api_key", "filter_advisors"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmIntellifloCreds from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmIntellifloCreds from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "import_sa_subject": obj.get("import_sa_subject"),
            "api_key": obj.get("api_key"),
            "filter_advisors": obj.get("filter_advisors")
        })
        return _obj
