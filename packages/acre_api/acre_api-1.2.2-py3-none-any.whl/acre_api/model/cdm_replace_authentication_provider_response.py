...
class CdmReplaceAuthenticationProviderResponse(BaseModel):
    """
    Response to the replacement of an authentication provider.
    """ # noqa: E501
    authentication_provider: Optional[CdmAuthenticationProvider] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["authentication_provider", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmReplaceAuthenticationProviderResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.authentication_provider:
            _dict['authentication_provider'] = self.authentication_provider.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmReplaceAuthenticationProviderResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "authentication_provider": CdmAuthenticationProvider.from_dict(obj["authentication_provider"]) if obj.get("authentication_provider") is not None else None,
