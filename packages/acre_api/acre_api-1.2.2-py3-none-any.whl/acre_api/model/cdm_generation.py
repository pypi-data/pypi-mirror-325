...
class CdmGeneration(BaseModel):
    """
    Generation holds information about type of fees to generate.
    """ # noqa: E501
    fee_type: Optional[CdmRevenueType] = CdmRevenueType.INVALID_REVENUE_TYPE
    payment_due: Optional[CommissionDetailsCommissionPaymentDue] = CommissionDetailsCommissionPaymentDue.INVALID_PAYMENT_DUE
    __properties: ClassVar[List[str]] = ["fee_type", "payment_due"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGeneration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGeneration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "fee_type": obj.get("fee_type") if obj.get("fee_type") is not None else CdmRevenueType.INVALID_REVENUE_TYPE,
