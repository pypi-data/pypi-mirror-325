...
class CdmGetClientResponse(BaseModel):
    """
    Get client response.
    """ # noqa: E501
    clients: Optional[List[CdmClient]] = Field(default=None, description="The clients.")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetClientRequest] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetClientResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetClientResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "next_page": CdmGetClientRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
