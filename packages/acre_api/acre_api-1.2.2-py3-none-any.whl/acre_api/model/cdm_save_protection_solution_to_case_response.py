...
class CdmSaveProtectionSolutionToCaseResponse(BaseModel):
    """
    CdmSaveProtectionSolutionToCaseResponse
    """ # noqa: E501
    protection_products: Optional[List[CdmProtectionProduct]] = Field(default=None, description="The protection products created and added to case.")
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["protection_products", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmSaveProtectionSolutionToCaseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmSaveProtectionSolutionToCaseResponse from a dict"""
        if obj is None:
            return None
