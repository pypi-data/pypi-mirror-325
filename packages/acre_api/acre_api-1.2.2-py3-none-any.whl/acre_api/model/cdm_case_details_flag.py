...
class CdmCaseDetailsFlag(BaseModel):
    """
    CaseDetailsFlag is a flag which must be reviewed for a case to continue the sourcing journey.
    """ # noqa: E501
    flag_id: Optional[StrictStr] = None
    flag_type: Optional[CdmCaseDetailsFlagType] = CdmCaseDetailsFlagType.INVALID_FLAG_TYPE
    created_at: Optional[StrictStr] = Field(default=None, description="Timestamp when the flag was detected/raised.")
    reviews: Optional[List[CdmCaseDetailsFlagReview]] = Field(default=None, description="Reviews which may contain resolution of the flag.")
    ...
    __properties: ClassVar[List[str]] = ["flag_id", "flag_type", "created_at", "reviews", "skip_future_reviews"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCaseDetailsFlag from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCaseDetailsFlag from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "flag_id": obj.get("flag_id"),
            "flag_type": obj.get("flag_type") if obj.get("flag_type") is not None else CdmCaseDetailsFlagType.INVALID_FLAG_TYPE,
            "created_at": obj.get("created_at"),
            "reviews": [CdmCaseDetailsFlagReview.from_dict(_item) for _item in obj["reviews"]] if obj.get("reviews") is not None else None,
