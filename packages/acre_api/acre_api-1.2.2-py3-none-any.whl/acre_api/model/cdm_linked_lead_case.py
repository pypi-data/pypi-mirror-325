...
class CdmLinkedLeadCase(BaseModel):
    """
    Completed case alongside the lead case created in the bulk create endpoint.
    """ # noqa: E501
    complete_case_id: Optional[StrictStr] = Field(default=None, description="Case ID lead case was created from.")
    lead_case_id: Optional[StrictStr] = Field(default=None, description="New lead case ID.")
    __properties: ClassVar[List[str]] = ["complete_case_id", "lead_case_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmLinkedLeadCase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmLinkedLeadCase from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "complete_case_id": obj.get("complete_case_id"),
            "lead_case_id": obj.get("lead_case_id")
        })
        return _obj
