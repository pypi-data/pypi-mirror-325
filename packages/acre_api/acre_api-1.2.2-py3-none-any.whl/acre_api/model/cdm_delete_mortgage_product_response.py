...
class CdmDeleteMortgageProductResponse(BaseModel):
    """
    Response to removing a product from a mortgage.
    """ # noqa: E501
    mortgage_id: Optional[StrictStr] = Field(default=None, description="ID of the mortgage that deleted the product.")
    product_id: Optional[StrictStr] = Field(default=None, description="ID of the product deleted from the mortgage.")
    mortgage: Optional[CdmMortgage] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["mortgage_id", "product_id", "mortgage", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmDeleteMortgageProductResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmDeleteMortgageProductResponse from a dict"""
        if obj is None:
            return None
