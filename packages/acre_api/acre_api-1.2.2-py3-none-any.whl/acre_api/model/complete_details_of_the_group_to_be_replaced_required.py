...
class CompleteDetailsOfTheGroupToBeReplacedRequired(BaseModel):
    """
    CompleteDetailsOfTheGroupToBeReplacedRequired
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["group_name", "organisation_id", "disabled", "accept_reminders", "user_ids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompleteDetailsOfTheGroupToBeReplacedRequired from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompleteDetailsOfTheGroupToBeReplacedRequired from a dict"""
        if obj is None:
            return None
