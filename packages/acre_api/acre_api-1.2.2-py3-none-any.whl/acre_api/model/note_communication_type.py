...
class NoteCommunicationType(str, Enum):
    """
    Type of CommunicationType (SMS, Email, Call, Push notification, Secure client communication). This can only be set if primary_type is COMMUNICATION.
    """
    ...
    SECURE_CLIENT_COMMUNICATION = 'SECURE_CLIENT_COMMUNICATION'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NoteCommunicationType from a JSON string"""
