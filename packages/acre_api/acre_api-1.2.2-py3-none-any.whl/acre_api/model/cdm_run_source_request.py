...
class CdmRunSourceRequest(BaseModel):
    """
    RunSourceRequest runs sourcing for mortgage products.
    """ # noqa: E501
    client_ids: Optional[List[StrictStr]] = Field(default=None, description="Optional list of client IDs to populate the source details.")
    property_id: Optional[StrictStr] = Field(default=None, description="Optional property ID to populate the source details. The latest version of the property is used. Not yet implemented.")
    case_id: Optional[StrictStr] = Field(default=None, description="Optional ID of case to populate the source details. The latest version of the case is used. Presently only client IDs and mortgage type is extracted from the case and used for sourcing.")
    source_details: Optional[CdmSourceDetails] = None
    __properties: ClassVar[List[str]] = ["client_ids", "property_id", "case_id", "source_details"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmRunSourceRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmRunSourceRequest from a dict"""
        if obj is None:
            return None
