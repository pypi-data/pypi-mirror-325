...
class CdmGetPermissionAssignmentResponse(BaseModel):
    """
    Response to a request for details of a permission assignment.
    """ # noqa: E501
    permission_assignments: Optional[List[CdmPermissionAssignment]] = None
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetPermissionAssignmentRequest] = None
    __properties: ClassVar[List[str]] = ["permission_assignments", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetPermissionAssignmentResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in permission_assignments (list)
        _items = []
        if self.permission_assignments:
            for _item_permission_assignments in self.permission_assignments:
                if _item_permission_assignments:
                    _items.append(_item_permission_assignments.to_dict())
            _dict['permission_assignments'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetPermissionAssignmentResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "permission_assignments": [CdmPermissionAssignment.from_dict(_item) for _item in obj["permission_assignments"]] if obj.get("permission_assignments") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmGetPermissionAssignmentRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
