...
class CdmDescribeCaseVerificationResponse(BaseModel):
    """
    Response to describe all the installed case verifications.
    """ # noqa: E501
    verifications: Optional[List[CdmVerificationDescription]] = Field(default=None, description="Descriptions of case verifications.")
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["verifications", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmDescribeCaseVerificationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmDescribeCaseVerificationResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "verifications": [CdmVerificationDescription.from_dict(_item) for _item in obj["verifications"]] if obj.get("verifications") is not None else None,
