...
class CdmCreateAcreMortgageProductResponse(BaseModel):
    """
    Response to creation of an acre mortgage product.
    """ # noqa: E501
    product_id: Optional[StrictStr] = Field(default=None, description="Acre ID of the mortgage product.")
    product_details: Optional[CdmMortgageProductDetails] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["product_id", "product_details", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateAcreMortgageProductResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateAcreMortgageProductResponse from a dict"""
        if obj is None:
            return None
