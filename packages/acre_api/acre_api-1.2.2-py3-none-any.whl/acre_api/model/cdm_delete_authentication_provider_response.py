...
class CdmDeleteAuthenticationProviderResponse(BaseModel):
    """
    Response to a deletion of an authentication provider.
    """ # noqa: E501
    exception: Optional[V1Exception] = None
    authentication_provider_id: Optional[StrictStr] = Field(default=None, description="ID of the deleted auth provider.")
    __properties: ClassVar[List[str]] = ["exception", "authentication_provider_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmDeleteAuthenticationProviderResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmDeleteAuthenticationProviderResponse from a dict"""
        if obj is None:
            return None
