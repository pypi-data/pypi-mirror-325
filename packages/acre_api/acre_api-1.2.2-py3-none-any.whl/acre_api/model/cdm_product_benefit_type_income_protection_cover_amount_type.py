...
class CdmProductBenefitTypeIncomeProtectionCoverAmountType(str, Enum):
    """
    Type of product benefit cover amount sourcing strategy.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmProductBenefitTypeIncomeProtectionCoverAmountType from a JSON string"""
