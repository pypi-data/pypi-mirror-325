...
class ClientDetailsDebtManagementPlan(BaseModel):
    """
    ClientDetailsDebtManagementPlan
    """ # noqa: E501
    date_registered: Optional[StrictStr] = Field(default=None, description="The date the debt management plan was registered (YYYY-MM-DD).")
    date_completed: Optional[StrictStr] = Field(default=None, description="The date the debt management plan was completed (YYYY-MM-DD).")
    monthly_payment_amount: Optional[StrictStr] = Field(default=None, description="The monthly payment amount of the debt management plan (in pence, not GBP).")
    satisfactory_conduct: Optional[StrictBool] = Field(default=None, description="Flag indicating whether the conduct was satisfactory on the debt management plam.  DEPRECATED: due to GBP to pence conversion.  string monthly_payment_amount = 3;")
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for this entry.")
    __properties: ClassVar[List[str]] = ["date_registered", "date_completed", "monthly_payment_amount", "satisfactory_conduct", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClientDetailsDebtManagementPlan from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClientDetailsDebtManagementPlan from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "monthly_payment_amount": obj.get("monthly_payment_amount"),
            "satisfactory_conduct": obj.get("satisfactory_conduct"),
            "id": obj.get("id")
        })
        return _obj
