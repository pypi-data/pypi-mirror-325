...
class PropertyDetailsBuilderRegistrationScheme(str, Enum):
    """
    PropertyDetailsBuilderRegistrationScheme
    """

    """
    allowed enum values
    """
    INVALID_BUILDER_REGISTRATION_SCHEME = 'INVALID_BUILDER_REGISTRATION_SCHEME'
    NATIONAL_HOUSE_BUILDING_COUNCIL = 'NATIONAL_HOUSE_BUILDING_COUNCIL'
    ZURICH_NEW_BUILD = 'ZURICH_NEW_BUILD'
    PREMIER_GUARANTEE_NEW_HOME_WARRANTY = 'PREMIER_GUARANTEE_NEW_HOME_WARRANTY'
    LOCAL_AUTHORITY_BUILDING_CONTROL_HOME_WARRANTY = 'LOCAL_AUTHORITY_BUILDING_CONTROL_HOME_WARRANTY'
    BUILDING_LIFE_PLANS_INSURANCE = 'BUILDING_LIFE_PLANS_INSURANCE'
    BUILD_ZONE_NEW_HOME_WARRANTY_SELF_BUILD = 'BUILD_ZONE_NEW_HOME_WARRANTY_SELF_BUILD'
    CASTLE10_NEW_HOME_WARRANTY = 'CASTLE10_NEW_HOME_WARRANTY'
    OTHER_BUILDER_REGISTRATION_SCHEME = 'OTHER_BUILDER_REGISTRATION_SCHEME'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PropertyDetailsBuilderRegistrationScheme from a JSON string"""
