...
class CdmCreatePermissionAssignmentsResponse(BaseModel):
    """
    Response to the creation of multiple permission assignments.
    """ # noqa: E501
    permission_assignments: Optional[List[CdmPermissionAssignment]] = Field(default=None, description="The newly created permission assignments.")
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["permission_assignments", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreatePermissionAssignmentsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreatePermissionAssignmentsResponse from a dict"""
        if obj is None:
            return None
