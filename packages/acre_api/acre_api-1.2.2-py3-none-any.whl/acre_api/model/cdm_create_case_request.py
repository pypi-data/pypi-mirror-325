...
class CdmCreateCaseRequest(BaseModel):
    """
    Create a new case.
    """ # noqa: E501
    case: CdmCase
    __properties: ClassVar[List[str]] = ["case"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateCaseRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateCaseRequest from a dict"""
        if obj is None:
            return None
