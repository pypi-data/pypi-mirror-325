...
class CdmRequirementsPMI(BaseModel):
    """
    CdmRequirementsPMI
    """ # noqa: E501
    client_ids: Optional[List[StrictStr]] = Field(default=None, description="The clients involved in this set of requirements.")
    cover_reason: Optional[StrictStr] = Field(default=None, description="Details of the reason for the cover.")
    existing_policy: Optional[StrictBool] = None
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for this entry.")
    __properties: ClassVar[List[str]] = ["client_ids", "cover_reason", "existing_policy", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmRequirementsPMI from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmRequirementsPMI from a dict"""
        if obj is None:
            return None
