...
class CdmPeriod(BaseModel):
    """
    Individual period defining the name and dates.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for this entry.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the period. This field is mandatory and needs to be unique.")
    start_date: Optional[StrictStr] = Field(default=None, description="First day of the calendar period (YYYY-MM-DD). This field is mandatory.")
    end_date: Optional[StrictStr] = Field(default=None, description="Last day of the calendar period (YYYY-MM-DD). This field is mandatory.")
    disabled: Optional[StrictBool] = Field(default=None, description="Whether the period is disabled. Set to false by default.")
    __properties: ClassVar[List[str]] = ["id", "name", "start_date", "end_date", "disabled"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmPeriod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmPeriod from a dict"""
        if obj is None:
            return None
