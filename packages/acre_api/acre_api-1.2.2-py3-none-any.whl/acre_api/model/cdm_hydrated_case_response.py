...
class CdmHydratedCaseResponse(BaseModel):
    """
    HydratedCaseResponse wraps a HydratedCase.
    """ # noqa: E501
    case: Optional[CdmHydratedCase] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["case", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmHydratedCaseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmHydratedCaseResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "case": CdmHydratedCase.from_dict(obj["case"]) if obj.get("case") is not None else None,
