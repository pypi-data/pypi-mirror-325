...
class CdmGetCaseResponse(BaseModel):
    """
    Response to a request for details of cases.
    """ # noqa: E501
    cases: Optional[List[CdmCase]] = Field(default=None, description="Information about the requested cases. If the request was a wildcard, then the cases are returned in the order that they were created. Otherwise, the cases are returned in the order that their IDs were specified in the request.")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetCaseRequest] = None
    __properties: ClassVar[List[str]] = ["cases", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetCaseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetCaseResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "cases": [CdmCase.from_dict(_item) for _item in obj["cases"]] if obj.get("cases") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmGetCaseRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
