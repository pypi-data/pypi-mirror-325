...
class CdmClientRelationshipRelationshipType(str, Enum):
    """
    CdmClientRelationshipRelationshipType
    """
    ...
    SPOUSE = 'SPOUSE'
    COHABITATING_PARTNER = 'COHABITATING_PARTNER'
    PSC = 'PSC'
    DIRECTOR_TRUSTEE = 'DIRECTOR_TRUSTEE'
    PARENT = 'PARENT'
    SIBLING = 'SIBLING'
    CHILD = 'CHILD'
    OTHER = 'OTHER'
    DIRECTOR_TRUSTEE_AND_PSC = 'DIRECTOR_TRUSTEE_AND_PSC'
    DIRECTOR_TRUSTEE_OF = 'DIRECTOR_TRUSTEE_OF'
    DIRECTOR_TRUSTEE_AND_PSC_OF = 'DIRECTOR_TRUSTEE_AND_PSC_OF'
    PSC_OF = 'PSC_OF'
    DUPLICATE = 'DUPLICATE'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmClientRelationshipRelationshipType from a JSON string"""
