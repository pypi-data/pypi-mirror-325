...
class CdmSurveyAnswer(BaseModel):
    """
    SurveyAnswer defines how a client has filled the answer for a survey question.
    """ # noqa: E501
    client_id: Optional[StrictStr] = Field(default=None, description="client_id points to the uuidv4 of the client entity.")
    answers: Optional[List[CdmAnswer]] = Field(default=None, description="answers contains a list of client_id answers for the survey.")
    __properties: ClassVar[List[str]] = ["client_id", "answers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmSurveyAnswer from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmSurveyAnswer from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "answers": [CdmAnswer.from_dict(_item) for _item in obj["answers"]] if obj.get("answers") is not None else None
        })
        return _obj
