...
class CaseDetailsConveyancingType(str, Enum):
    """
    The next fields are to help us handle conveyancing integrations.   - NO_SELECTION: The user has not yet selected a solicitor.  - LENDER_PROVIDED: The lender will be providing a conveyancer.  - ACRE_REFERRAL: Acre has referred the client to a solicitor.  - OWN_SOLICITOR: The user is providing their own solicitor.  - NOT_NEEDED: No solicitor is needed, eg same lender no additional borrowing.
    """
    ...
    LENDER_PROVIDED = 'LENDER_PROVIDED'
    ACRE_REFERRAL = 'ACRE_REFERRAL'
    OWN_SOLICITOR = 'OWN_SOLICITOR'
    NOT_NEEDED = 'NOT_NEEDED'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CaseDetailsConveyancingType from a JSON string"""
