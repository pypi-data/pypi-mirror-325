...
class ClientOutstandingDebtAccountStatus(str, Enum):
    """
    ...
    ACCOUNT_STATUS_SETTLED = 'ACCOUNT_STATUS_SETTLED'
    ACCOUNT_STATUS_OPEN = 'ACCOUNT_STATUS_OPEN'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientOutstandingDebtAccountStatus from a JSON string"""
