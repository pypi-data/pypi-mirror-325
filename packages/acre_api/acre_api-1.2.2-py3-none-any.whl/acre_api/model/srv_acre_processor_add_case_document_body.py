...
class SrvAcreProcessorAddCaseDocumentBody(BaseModel):
    """
    Add a document to a case.
    """ # noqa: E501
    case_id: StrictStr = Field(description="ID of the case to add a document to. Required.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SrvAcreProcessorAddCaseDocumentBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SrvAcreProcessorAddCaseDocumentBody from a dict"""
        if obj is None:
            return None
