...
class MortgageCalculatedValuesCalculatedClubProcFee(BaseModel):
    """
    Calculated proc fee for a mortgage club.
    """ # noqa: E501
    ...
    proc_fee: Optional[StrictStr] = Field(default=None, description="The calculated procuration fee for this mortgage club.")
    net_proc_fee: Optional[StrictStr] = Field(default=None, description="The calculated net procuration fee for this mortgage club.")
    __properties: ClassVar[List[str]] = ["mortgage_club_code", "mortgage_club_name", "proc_fee", "net_proc_fee"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MortgageCalculatedValuesCalculatedClubProcFee from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MortgageCalculatedValuesCalculatedClubProcFee from a dict"""
        if obj is None:
            return None
