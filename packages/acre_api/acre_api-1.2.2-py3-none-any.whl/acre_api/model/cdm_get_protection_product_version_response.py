...
class CdmGetProtectionProductVersionResponse(BaseModel):
    """
    Response to get a protection with version.
    """ # noqa: E501
    protection_product: Optional[CdmProtectionProduct] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["protection_product", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetProtectionProductVersionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetProtectionProductVersionResponse from a dict"""
        if obj is None:
            return None
