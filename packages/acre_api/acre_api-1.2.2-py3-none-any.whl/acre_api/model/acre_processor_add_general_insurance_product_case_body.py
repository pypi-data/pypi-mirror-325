...
class AcreProcessorAddGeneralInsuranceProductCaseBody(BaseModel):
    """
    Add a general insurance product to a case.
    """ # noqa: E501
    case_id: StrictStr = Field(description="ID of the case to add a protection product to. Required.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AcreProcessorAddGeneralInsuranceProductCaseBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AcreProcessorAddGeneralInsuranceProductCaseBody from a dict"""
        if obj is None:
            return None
