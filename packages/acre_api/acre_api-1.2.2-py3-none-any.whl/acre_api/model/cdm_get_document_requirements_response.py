...
class CdmGetDocumentRequirementsResponse(BaseModel):
    """
    CdmGetDocumentRequirementsResponse
    """ # noqa: E501
    document_requirements: Optional[List[CdmDocumentRequirement]] = Field(default=None, description="The document requirements.")
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["document_requirements", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetDocumentRequirementsResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in document_requirements (list)
        _items = []
        if self.document_requirements:
            for _item_document_requirements in self.document_requirements:
                if _item_document_requirements:
                    _items.append(_item_document_requirements.to_dict())
            _dict['document_requirements'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetDocumentRequirementsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "document_requirements": [CdmDocumentRequirement.from_dict(_item) for _item in obj["document_requirements"]] if obj.get("document_requirements") is not None else None,
