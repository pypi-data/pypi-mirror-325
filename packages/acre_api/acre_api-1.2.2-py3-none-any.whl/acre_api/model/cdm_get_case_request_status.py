...
class CdmGetCaseRequestStatus(str, Enum):
    """
    IMPORTANT: Status values match those defined for CaseDetails.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmGetCaseRequestStatus from a JSON string"""
