...
class CdmCreateClientOrganisationRelationshipResponse(BaseModel):
    """
    CdmCreateClientOrganisationRelationshipResponse
    """ # noqa: E501
    client_organisation_relationship: Optional[CdmClientOrganisationRelationship] = None
    documents: Optional[List[CdmDocument]] = Field(default=None, description="The documents generated while processing the request.")
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["client_organisation_relationship", "documents", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateClientOrganisationRelationshipResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of client_organisation_relationship
        if self.client_organisation_relationship:
            _dict['client_organisation_relationship'] = self.client_organisation_relationship.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateClientOrganisationRelationshipResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "client_organisation_relationship": CdmClientOrganisationRelationship.from_dict(obj["client_organisation_relationship"]) if obj.get("client_organisation_relationship") is not None else None,
