...
class CdmGetAuthenticationProviderRequest(BaseModel):
    """
    Get details of authentication provider.
    """ # noqa: E501
    authentication_provider_details: Optional[StrictBool] = Field(default=None, description="Return the entire authentication providers details. By default this value is false, and only the IDs are returned.")
    authentication_names: Optional[List[StrictStr]] = Field(default=None, description="authentication_provider_names only returns providers with the specified name.")
    authentication_provider_ids: Optional[List[StrictStr]] = Field(default=None, description="Authentication provider IDs (optional, default wildcard for all IDs user can access).")
    ...
    show_disabled: Optional[StrictBool] = Field(default=None, description="Specify to show disabled authentication providers. By default they are not shown on a wildcard query. This only has effect for a wildcard query.")
    __properties: ClassVar[List[str]] = ["authentication_provider_details", "authentication_names", "authentication_provider_ids", "bookmark", "page_size", "show_disabled"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetAuthenticationProviderRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetAuthenticationProviderRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "authentication_provider_details": obj.get("authentication_provider_details"),
            "authentication_names": obj.get("authentication_names"),
            "authentication_provider_ids": obj.get("authentication_provider_ids"),
