...
class CdmStandardFeeOptions(BaseModel):
    """
    CdmStandardFeeOptions
    """ # noqa: E501
    fee_option_title: Optional[StrictStr] = Field(default=None, description="Description of what the set of fees are for.")
    fees: Optional[List[CdmFee]] = Field(default=None, description="Fees associated with the title given.")
    default: Optional[StrictBool] = Field(default=None, description="Flag identifying whether these fees will be used as the default for case.")
    __properties: ClassVar[List[str]] = ["fee_option_title", "fees", "default"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmStandardFeeOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmStandardFeeOptions from a dict"""
        if obj is None:
            return None
