...
class CompleteDetailsOfTheRoleToBeReplacedRequired(BaseModel):
    """
    CompleteDetailsOfTheRoleToBeReplacedRequired
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["role_name", "disabled"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompleteDetailsOfTheRoleToBeReplacedRequired from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompleteDetailsOfTheRoleToBeReplacedRequired from a dict"""
        if obj is None:
            return None
