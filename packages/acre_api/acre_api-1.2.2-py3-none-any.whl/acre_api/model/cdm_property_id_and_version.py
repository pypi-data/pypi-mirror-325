...
class CdmPropertyIDAndVersion(BaseModel):
    """
    Property ID and a version of that property.
    """ # noqa: E501
    property_id: Optional[StrictStr] = None
    version: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["property_id", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmPropertyIDAndVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmPropertyIDAndVersion from a dict"""
        if obj is None:
            return None
