...
class SrvAcreProcessorAddMortgageCaseBody(BaseModel):
    """
    Add a mortgage to a case.
    """ # noqa: E501
    case_id: StrictStr = Field(description="ID of the case to add a mortgage to.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SrvAcreProcessorAddMortgageCaseBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SrvAcreProcessorAddMortgageCaseBody from a dict"""
        if obj is None:
            return None
