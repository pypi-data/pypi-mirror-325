...
class CdmProductBenefitTypeGeneral(BaseModel):
    """
    CdmProductBenefitTypeGeneral
    """ # noqa: E501
    ...
    term_years: Optional[StrictStr] = Field(default=None, description="The duration of the policy in years.")
    __properties: ClassVar[List[str]] = ["client_ids", "cover_amount", "cover_amount_frequency", "premium_type", "term_years"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmProductBenefitTypeGeneral from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmProductBenefitTypeGeneral from a dict"""
        if obj is None:
            return None
