...
class CdmNoteTemplateAssignee(BaseModel):
    """
    Note template assignee contains the data needed to populate note assignee on creation.
    """ # noqa: E501
    type: Optional[CdmNoteTemplateAssigneeType] = CdmNoteTemplateAssigneeType.INVALID
    id: Optional[StrictStr] = Field(default=None, description="Id of assignee (can not be provided for type CREATOR).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmNoteTemplateAssignee from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmNoteTemplateAssignee from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else CdmNoteTemplateAssigneeType.INVALID,
            "id": obj.get("id")
        })
        return _obj
