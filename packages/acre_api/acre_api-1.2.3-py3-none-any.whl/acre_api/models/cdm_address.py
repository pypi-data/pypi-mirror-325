...
class CdmAddress(BaseModel):
    """
    Address represents addresses in Acre.
    """ # noqa: E501
    address1: Optional[StrictStr] = None
    address2: Optional[StrictStr] = None
    address3: Optional[StrictStr] = None
    posttown: Optional[StrictStr] = None
    county: Optional[StrictStr] = None
    postcode: Optional[StrictStr] = None
    country: Optional[StrictStr] = None
    acre_property_id: Optional[StrictStr] = Field(default=None, description="The acre property id related to the address.")
    __properties: ClassVar[List[str]] = ["address1", "address2", "address3", "posttown", "county", "postcode", "country", "acre_property_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAddress from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAddress from a dict"""
        if obj is None:
            return None
