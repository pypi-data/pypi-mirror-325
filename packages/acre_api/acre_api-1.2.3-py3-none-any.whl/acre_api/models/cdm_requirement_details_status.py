...
class CdmRequirementDetailsStatus(str, Enum):
    """
    Enums for the status field.   - OPTIONAL: The requirement is optional. Default.  - REQUIRED: The requirement is required.  - DISABLED: The requirement is disabled.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmRequirementDetailsStatus from a JSON string"""
