...
class CdmAvailability(BaseModel):
    """
    Availability represents the available time slots for a given day. Either both or neither of start_time and end_time have to be provided. Note: leaving both start_time and end_time as empty represent that a day is unavailable (applicable to day = ALL).
    """ # noqa: E501
    day: Optional[CdmDay] = CdmDay.INVALID_DAY
    start_time: Optional[StrictStr] = Field(default=None, description="StartTime is the start time for availability - GMT (HH:MM).")
    end_time: Optional[StrictStr] = Field(default=None, description="EndTime is the end time for availability - GMT (HH:MM).")
    __properties: ClassVar[List[str]] = ["day", "start_time", "end_time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAvailability from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAvailability from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "day": obj.get("day") if obj.get("day") is not None else CdmDay.INVALID_DAY,
