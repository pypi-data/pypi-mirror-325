...
class CdmVerificationSourceType(str, Enum):
    """
    Sources of the verification.   - INVALID_VERIFICATION_SOURCE_TYPE: Invalid source type.  - USER: User source type.  - USER_ON_BEHALF_OF_CLIENT: User on behalf of client source type.  - CLIENT: Client source type.  - AUTOMATED: DEPRECATED: Is inferred from \"provider_reference\". Automated source type.  - ONFIDO: Onfido (https://onfido.com/) source type.  - EQUIFAX: Equifax (https://www.equifax.co.uk) source type.
    """

    """
    allowed enum values
    """
    INVALID_VERIFICATION_SOURCE_TYPE = 'INVALID_VERIFICATION_SOURCE_TYPE'
    USER = 'USER'
    USER_ON_BEHALF_OF_CLIENT = 'USER_ON_BEHALF_OF_CLIENT'
    CLIENT = 'CLIENT'
    AUTOMATED = 'AUTOMATED'
    ONFIDO = 'ONFIDO'
    EQUIFAX = 'EQUIFAX'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmVerificationSourceType from a JSON string"""
