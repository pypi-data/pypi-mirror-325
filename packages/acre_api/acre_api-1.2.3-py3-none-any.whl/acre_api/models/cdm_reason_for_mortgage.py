...
class CdmReasonForMortgage(str, Enum):
    """
    CdmReasonForMortgage
    """

    """
    allowed enum values
    """
    INVALID_REASON_FOR_MORTGAGE = 'INVALID_REASON_FOR_MORTGAGE'
    REASON_PURCHASE = 'REASON_PURCHASE'
    REASON_REMORTGAGE = 'REASON_REMORTGAGE'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmReasonForMortgage from a JSON string"""
