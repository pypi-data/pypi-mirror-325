...
class CdmRelatedUser(BaseModel):
    """
    A user related to a given case, their relation to the case and commission share.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for this entry.")
    user_id: Optional[StrictStr] = Field(default=None, description="ID of the related user.")
    relationship_type: Optional[CdmRelatedUserRelationshipType] = CdmRelatedUserRelationshipType.INVALID_RELATIONSHIP_TYPE
    commission_share_basis_points: Optional[StrictStr] = Field(default=None, description="Commission share represented as 1/100000 of a percent (precision for up to 5 decimal places). 1% = 100000.")
    __properties: ClassVar[List[str]] = ["id", "user_id", "relationship_type", "commission_share_basis_points"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmRelatedUser from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmRelatedUser from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "relationship_type": obj.get("relationship_type") if obj.get("relationship_type") is not None else CdmRelatedUserRelationshipType.INVALID_RELATIONSHIP_TYPE,
            "commission_share_basis_points": obj.get("commission_share_basis_points")
        })
        return _obj
