...
class CdmAddMortgageCaseResponse(BaseModel):
    """
    Response to adding a mortgage to a case.
    """ # noqa: E501
    case_id: Optional[StrictStr] = Field(default=None, description="ID of the case added.")
    mortgage_id: Optional[StrictStr] = Field(default=None, description="ID of the mortgage adding the case.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAddMortgageCaseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAddMortgageCaseResponse from a dict"""
        if obj is None:
            return None
