...
class CdmHospitalList(str, Enum):
    """
    CdmHospitalList
    """
    ...
    allowed enum values
    """
    HOSPITAL_LIST_INVALID = 'HOSPITAL_LIST_INVALID'
    HOSPITAL_LIST_REDUCED = 'HOSPITAL_LIST_REDUCED'
    HOSPITAL_LIST_STANDARD = 'HOSPITAL_LIST_STANDARD'
    HOSPITAL_LIST_EXTENDED = 'HOSPITAL_LIST_EXTENDED'
    HOSPITAL_LIST_GUIDED = 'HOSPITAL_LIST_GUIDED'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmHospitalList from a JSON string"""
