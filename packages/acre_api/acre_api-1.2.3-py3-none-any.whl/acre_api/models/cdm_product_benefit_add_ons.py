...
class CdmProductBenefitAddOns(BaseModel):
    """
    CdmProductBenefitAddOns
    """ # noqa: E501
    fracture_cover_client_ids: Optional[List[StrictStr]] = Field(default=None, description="Clients for which fracture cover is included.")
    waiver_of_premium_client_ids: Optional[List[StrictStr]] = Field(default=None, description="Clients for which waiver of premium is included.")
    include_total_permanent_disability: Optional[StrictBool] = Field(default=None, description="Whether to include permanent disability.")
    __properties: ClassVar[List[str]] = ["fracture_cover_client_ids", "waiver_of_premium_client_ids", "include_total_permanent_disability"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmProductBenefitAddOns from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmProductBenefitAddOns from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "fracture_cover_client_ids": obj.get("fracture_cover_client_ids"),
            "waiver_of_premium_client_ids": obj.get("waiver_of_premium_client_ids"),
            "include_total_permanent_disability": obj.get("include_total_permanent_disability")
        })
        return _obj
