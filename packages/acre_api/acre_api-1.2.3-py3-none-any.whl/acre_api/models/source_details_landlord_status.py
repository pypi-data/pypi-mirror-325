...
class SourceDetailsLandlordStatus(str, Enum):
    """
    SourceDetailsLandlordStatus
    """

    """
    allowed enum values
    """
    INVALID_LANDLORD_STATUS = 'INVALID_LANDLORD_STATUS'
    LANDLORD_FIRST_TIME_WITHOUT_RESIDENTIAL_PROPERTY = 'LANDLORD_FIRST_TIME_WITHOUT_RESIDENTIAL_PROPERTY'
    LANDLORD_FIRST_TIME_WITH_RESIDENTIAL_PROPERTY = 'LANDLORD_FIRST_TIME_WITH_RESIDENTIAL_PROPERTY'
    LANDLORD_EXISTING_WITHOUT_RESIDENTIAL_PROPERTY = 'LANDLORD_EXISTING_WITHOUT_RESIDENTIAL_PROPERTY'
    LANDLORD_EXISTING_WITH_RESIDENTIAL_PROPERTY = 'LANDLORD_EXISTING_WITH_RESIDENTIAL_PROPERTY'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SourceDetailsLandlordStatus from a JSON string"""
