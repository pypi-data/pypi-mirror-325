...
class CdmDeductionType(str, Enum):
    """
    CdmDeductionType
    """
    ...
    allowed enum values
    """
    INVALID_DEDUCTION_TYPE = 'INVALID_DEDUCTION_TYPE'
    NETWORK_FEE = 'NETWORK_FEE'
    MORTGAGE_CLUB_FEE = 'MORTGAGE_CLUB_FEE'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmDeductionType from a JSON string"""
