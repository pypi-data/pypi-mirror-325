...
class CdmGetUserAuthURLResponse(BaseModel):
    """
    The response to a request to get the user authentication URL.
    """ # noqa: E501
    auth_urls: Optional[List[StrictStr]] = Field(default=None, description="Authentication URL for the user to log in.")
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["auth_urls", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetUserAuthURLResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetUserAuthURLResponse from a dict"""
        if obj is None:
            return None
