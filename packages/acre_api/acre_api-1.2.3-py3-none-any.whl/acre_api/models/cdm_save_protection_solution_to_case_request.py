...
class CdmSaveProtectionSolutionToCaseRequest(BaseModel):
    """
    CdmSaveProtectionSolutionToCaseRequest
    """ # noqa: E501
    case_id: StrictStr
    protection_products: List[CdmProtectionProduct] = Field(description="The protection products to be created and added to case. Required.")
    source_response: Optional[StrictStr] = Field(default=None, description="The response from the sourcing API on which basis these products were chosen. Will be set on all products.")
    __properties: ClassVar[List[str]] = ["case_id", "protection_products", "source_response"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmSaveProtectionSolutionToCaseRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmSaveProtectionSolutionToCaseRequest from a dict"""
        if obj is None:
            return None
