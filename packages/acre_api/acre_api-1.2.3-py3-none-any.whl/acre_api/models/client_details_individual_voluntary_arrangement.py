...
class ClientDetailsIndividualVoluntaryArrangement(BaseModel):
    """
    ClientDetailsIndividualVoluntaryArrangement
    """ # noqa: E501
    date_registered: Optional[StrictStr] = Field(default=None, description="The date the IVA was registered (YYYY-MM-DD).")
    date_completed: Optional[StrictStr] = Field(default=None, description="The date the IVA was completed (YYYY-MM-DD).")
    monthly_payment_amount: Optional[StrictStr] = Field(default=None, description="The monthly payment amount of the IVA (in pence, not GBP).")
    satisfactory_conduct: Optional[StrictBool] = Field(default=None, description="Flag indicating whether the conduct was satisfactory on the IVA.  DEPRECATED: due to GBP to pence conversion.  string monthly_payment_amount = 3;")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClientDetailsIndividualVoluntaryArrangement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClientDetailsIndividualVoluntaryArrangement from a dict"""
        if obj is None:
            return None
