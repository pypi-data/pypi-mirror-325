...
class CdmCase(BaseModel):
    """
    Case is the umbrella for the sourcing journey that a Client has, and is intended to hold more transient information such as Client preferences.
    """ # noqa: E501
    case_id: Optional[StrictStr] = Field(default=None, description="Case reference. Populated automatically; cannot be set.")
    created_at: Optional[StrictStr] = Field(default=None, description="Creation date (RFC3339) of the case. Populated automatically; cannot be set.")
    ...
    details: Optional[CdmCaseDetails] = None
    versions: Optional[List[CdmVersionDetails]] = Field(default=None, description="Change details of previous versions.")
    __properties: ClassVar[List[str]] = ["case_id", "created_at", "version", "version_created_at", "details", "versions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCase from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "details": CdmCaseDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,
