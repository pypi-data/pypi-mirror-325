...
class QuestionEventTrigger(BaseModel):
    """
    EventTrigger type defines rules and what type of event should be triggered on what type of answer the client has filled up.
    """ # noqa: E501
    type: Optional[QuestionEventTriggerType] = QuestionEventTriggerType.INVALID_EVENT_TRIGGER
    gt: Optional[StrictStr] = Field(default=None, description="gt means if the answer string value is greater than this value.")
    lt: Optional[StrictStr] = Field(default=None, description="lt means if the answer string value is lesser than this value.")
    choice_trigger: Optional[List[StrictStr]] = Field(default=None, description="choice_trigger holds answers from the list of choices that the trigger should react.")
    __properties: ClassVar[List[str]] = ["type", "gt", "lt", "choice_trigger"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QuestionEventTrigger from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QuestionEventTrigger from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else QuestionEventTriggerType.INVALID_EVENT_TRIGGER,
            "gt": obj.get("gt"),
            "lt": obj.get("lt"),
            "choice_trigger": obj.get("choice_trigger")
        })
        return _obj
