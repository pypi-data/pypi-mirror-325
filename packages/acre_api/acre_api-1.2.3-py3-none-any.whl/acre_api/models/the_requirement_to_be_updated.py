...
class TheRequirementToBeUpdated(BaseModel):
    """
    TheRequirementToBeUpdated
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["created_at", "created_by", "modified_at", "disabled_at", "details"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TheRequirementToBeUpdated from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TheRequirementToBeUpdated from a dict"""
        if obj is None:
            return None
