...
class UnearnedIncomeUnearnedIncomeFrequency(str, Enum):
    """
    The unearned income frequency.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UnearnedIncomeUnearnedIncomeFrequency from a JSON string"""
