...
class CdmClientEmploymentIncomeEmploymentBasis(str, Enum):
    """
    ...
    allowed enum values
    """
    INVALID_EMPLOYED_BASIS = 'INVALID_EMPLOYED_BASIS'
    FULL_TIME = 'FULL_TIME'
    PART_TIME = 'PART_TIME'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmClientEmploymentIncomeEmploymentBasis from a JSON string"""
