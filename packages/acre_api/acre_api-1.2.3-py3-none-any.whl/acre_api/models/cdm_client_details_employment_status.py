...
class CdmClientDetailsEmploymentStatus(str, Enum):
    """
    CdmClientDetailsEmploymentStatus
    """
    ...
    EMPLOYED = 'EMPLOYED'
    FIXED_TERM_CONTRACTOR = 'FIXED_TERM_CONTRACTOR'
    FIXED_TERM_CONTRACTOR_PAYE = 'FIXED_TERM_CONTRACTOR_PAYE'
    HOMEMAKER = 'HOMEMAKER'
    RETIRED = 'RETIRED'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmClientDetailsEmploymentStatus from a JSON string"""
