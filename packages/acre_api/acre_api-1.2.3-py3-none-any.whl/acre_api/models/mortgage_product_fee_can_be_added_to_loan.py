...
class MortgageProductFeeCanBeAddedToLoan(str, Enum):
    """
    MortgageProductFeeCanBeAddedToLoan
    """

    """
    allowed enum values
    """
    INVALID_CAN_BE_ADDED_TO_LOAN = 'INVALID_CAN_BE_ADDED_TO_LOAN'
    MUST_BE_ADDED = 'MUST_BE_ADDED'
    OPTION_TO_BE_ADDED = 'OPTION_TO_BE_ADDED'
    PAY_SEPARATELY = 'PAY_SEPARATELY'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of MortgageProductFeeCanBeAddedToLoan from a JSON string"""
