...
class CdmSpecifiedItem(BaseModel):
    """
    CdmSpecifiedItem
    """ # noqa: E501
    type: Optional[CdmSpecifiedItemType] = CdmSpecifiedItemType.INVALID_SPECIFIED_ITEM_TYPE
    description: Optional[StrictStr] = Field(default=None, description="Description of the specified item.")
    value: Optional[StrictInt] = Field(default=None, description="Value of the specified item in pence.")
    include_at_home: Optional[StrictBool] = Field(default=None, description="True if the cover is included at home.")
    include_away_from_home: Optional[StrictBool] = Field(default=None, description="True if the cover is included away from home.")
    __properties: ClassVar[List[str]] = ["type", "description", "value", "include_at_home", "include_away_from_home"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmSpecifiedItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmSpecifiedItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else CdmSpecifiedItemType.INVALID_SPECIFIED_ITEM_TYPE,
            "description": obj.get("description"),
            "value": obj.get("value"),
            "include_at_home": obj.get("include_at_home"),
            "include_away_from_home": obj.get("include_away_from_home")
        })
        return _obj
