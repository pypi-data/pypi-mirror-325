...
class CdmMortgagePanelLimitReason(BaseModel):
    """
    MortgagePanelLimitReason holds values regarding the reasoning for why sourcing was limited.
    """ # noqa: E501
    user_id: Optional[StrictStr] = Field(default=None, description="The ID of the user limiting sourcing. **IMPORTANT:** This field cannot be updated and is populated automatically.")
    timestamp: Optional[StrictStr] = Field(default=None, description="The timestamp at which the user limited sourcing (RFC3339). **IMPORTANT:** This field cannot be updated and is populated automatically.")
    reason: Optional[StrictStr] = Field(default=None, description="The reason for limiting.")
    __properties: ClassVar[List[str]] = ["user_id", "timestamp", "reason"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmMortgagePanelLimitReason from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmMortgagePanelLimitReason from a dict"""
        if obj is None:
            return None
