...
class CdmSBGProviderID(str, Enum):
    """
    CdmSBGProviderID
    """
    ...
    allowed enum values
    """
    SBG_PROVIDER_ID_INVALID = 'SBG_PROVIDER_ID_INVALID'
    SBG_PROVIDER_ID_CETA = 'SBG_PROVIDER_ID_CETA'
    SBG_PROVIDER_ID_PAYM = 'SBG_PROVIDER_ID_PAYM'
    SBG_PROVIDER_ID_UINS = 'SBG_PROVIDER_ID_UINS'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmSBGProviderID from a JSON string"""
