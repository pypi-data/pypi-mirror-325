...
class CdmEquityReleaseLifetime(BaseModel):
    """
    EquityReleaseLifetime holds information about equity release providers, type of base panel and advice.
    """ # noqa: E501
    lifetime_advice: Optional[StrictBool] = Field(default=None, description="Whether the organisation offers lifetime advice.")
    type: Optional[PanelManagementPanel] = PanelManagementPanel.INVALID_LENDER_PANEL_TYPE
    providers: Optional[List[StrictStr]] = Field(default=None, description="List of equity release providers.")
    __properties: ClassVar[List[str]] = ["lifetime_advice", "type", "providers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmEquityReleaseLifetime from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmEquityReleaseLifetime from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "lifetime_advice": obj.get("lifetime_advice"),
