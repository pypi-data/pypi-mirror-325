...
class CdmFirstTimeAccess(BaseModel):
    """
    FirstTimeAccess stores details around accessing Acre for the first time.
    """ # noqa: E501
    complete: Optional[StrictBool] = Field(default=None, description="Complete is a flag to indicate whether first time access flow has been completed.")
    features: Optional[List[CdmFirstTimeFeatures]] = Field(default=None, description="Tracking of individual feature first time completion.")
    __properties: ClassVar[List[str]] = ["complete", "features"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmFirstTimeAccess from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmFirstTimeAccess from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "features": [CdmFirstTimeFeatures.from_dict(_item) for _item in obj["features"]] if obj.get("features") is not None else None
        })
        return _obj
