...
class CdmThresholdConditions(BaseModel):
    """
    ThresholdConditions contains the details used for the RMA F report.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="A unique identifier for this entry.")
    close_links: Optional[ThresholdConditionsNotifiableChange] = None
    controller: Optional[ThresholdConditionsNotifiableChange] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "close_links", "controller", "start_date", "end_date"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmThresholdConditions from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of close_links
        if self.close_links:
            _dict['close_links'] = self.close_links.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmThresholdConditions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "close_links": ThresholdConditionsNotifiableChange.from_dict(obj["close_links"]) if obj.get("close_links") is not None else None,
            "controller": ThresholdConditionsNotifiableChange.from_dict(obj["controller"]) if obj.get("controller") is not None else None,
