...
class CdmProductType(str, Enum):
    ...
    PRODUCT_TYPE_INCOME_PROTECTION = 'PRODUCT_TYPE_INCOME_PROTECTION'
    PRODUCT_TYPE_FAMILY_INCOME_BENEFIT = 'PRODUCT_TYPE_FAMILY_INCOME_BENEFIT'
    PRODUCT_TYPE_WHOLE_OF_LIFE = 'PRODUCT_TYPE_WHOLE_OF_LIFE'
    PRODUCT_TYPE_MORTGAGE_PROTECTION = 'PRODUCT_TYPE_MORTGAGE_PROTECTION'
    PRODUCT_TYPE_MORTGAGE_PAYMENT_PROTECTION = 'PRODUCT_TYPE_MORTGAGE_PAYMENT_PROTECTION'
    PRODUCT_TYPE_SICK_PAY = 'PRODUCT_TYPE_SICK_PAY'
    PRODUCT_TYPE_PRIVATE_MEDICAL_INSURANCE = 'PRODUCT_TYPE_PRIVATE_MEDICAL_INSURANCE'
    PRODUCT_TYPE_OTHER = 'PRODUCT_TYPE_OTHER'
    PRODUCT_TYPE_GROUP_LIFE = 'PRODUCT_TYPE_GROUP_LIFE'
    PRODUCT_TYPE_GROUP_PMI = 'PRODUCT_TYPE_GROUP_PMI'
    PRODUCT_TYPE_GROUP_ASU = 'PRODUCT_TYPE_GROUP_ASU'
    PRODUCT_TYPE_GROUP_CIC = 'PRODUCT_TYPE_GROUP_CIC'
    PRODUCT_TYPE_GROUP_IP = 'PRODUCT_TYPE_GROUP_IP'
    PRODUCT_TYPE_RELEVANT_LIFE = 'PRODUCT_TYPE_RELEVANT_LIFE'
    PRODUCT_KEY_MAN = 'PRODUCT_KEY_MAN'
    PRODUCT_TYPE_SHAREHOLDER_PROTECTION = 'PRODUCT_TYPE_SHAREHOLDER_PROTECTION'
    PRODUCT_TYPE_CORE_ACCIDENT_SICKNESS = 'PRODUCT_TYPE_CORE_ACCIDENT_SICKNESS'
    PRODUCT_TYPE_CHILD_ACCIDENT_SICKNESS = 'PRODUCT_TYPE_CHILD_ACCIDENT_SICKNESS'
    PRODUCT_TYPE_SPORTS_LIFESTYLE = 'PRODUCT_TYPE_SPORTS_LIFESTYLE'
    PRODUCT_TYPE_SPECIALIST_HEALTHCARE_COVER = 'PRODUCT_TYPE_SPECIALIST_HEALTHCARE_COVER'
    PRODUCT_TYPE_EMPLOYEE_BENEFIT = 'PRODUCT_TYPE_EMPLOYEE_BENEFIT'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmProductType from a JSON string"""
