...
class CdmReplacePermissionAssignmentResponse(BaseModel):
    """
    Response to the replacement of a permission assignment.
    """ # noqa: E501
    permission_assignment: Optional[CdmPermissionAssignment] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["permission_assignment", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmReplacePermissionAssignmentResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of permission_assignment
        if self.permission_assignment:
            _dict['permission_assignment'] = self.permission_assignment.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmReplacePermissionAssignmentResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "permission_assignment": CdmPermissionAssignment.from_dict(obj["permission_assignment"]) if obj.get("permission_assignment") is not None else None,
