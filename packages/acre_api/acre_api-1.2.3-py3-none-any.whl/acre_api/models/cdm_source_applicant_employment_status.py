...
class CdmSourceApplicantEmploymentStatus(str, Enum):
    """
    CdmSourceApplicantEmploymentStatus
    """
    ...
    EMPLOYMENT_FIXED_TERM_CONTRACTOR = 'EMPLOYMENT_FIXED_TERM_CONTRACTOR'
    EMPLOYMENT_FIXED_TERM_CONTRACTOR_PAYE = 'EMPLOYMENT_FIXED_TERM_CONTRACTOR_PAYE'
    EMPLOYMENT_HOMEMAKER = 'EMPLOYMENT_HOMEMAKER'
    EMPLOYMENT_RETIRED = 'EMPLOYMENT_RETIRED'
    EMPLOYMENT_SELF_EMPLOYED = 'EMPLOYMENT_SELF_EMPLOYED'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmSourceApplicantEmploymentStatus from a JSON string"""
