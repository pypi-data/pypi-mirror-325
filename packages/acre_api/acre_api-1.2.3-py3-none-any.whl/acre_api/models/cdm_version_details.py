...
class CdmVersionDetails(BaseModel):
    """
    Details of who and what has changed in a version.
    """ # noqa: E501
    version: Optional[StrictInt] = None
    editor: Optional[CdmEditor] = None
    changed_fields: Optional[List[StrictStr]] = Field(default=None, description="Field's changed in last event.")
    __properties: ClassVar[List[str]] = ["version", "editor", "changed_fields"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmVersionDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmVersionDetails from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "editor": CdmEditor.from_dict(obj["editor"]) if obj.get("editor") is not None else None,
