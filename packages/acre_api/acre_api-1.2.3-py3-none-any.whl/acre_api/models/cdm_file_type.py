...
class CdmFileType(str, Enum):
    """
    Valid formats for the template.   - INVALID_FILE_TYPE: Unknown file type.  - HTML: HTML.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmFileType from a JSON string"""
