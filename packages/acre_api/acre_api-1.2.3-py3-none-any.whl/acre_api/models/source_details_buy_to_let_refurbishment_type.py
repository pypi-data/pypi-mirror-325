...
class SourceDetailsBuyToLetRefurbishmentType(str, Enum):
    """
    SourceDetailsBuyToLetRefurbishmentType
    """

    """
    allowed enum values
    """
    INVALID_BTL_REFURBISHMENT_TYPE = 'INVALID_BTL_REFURBISHMENT_TYPE'
    BTL_REFURBISHMENT_LIGHT = 'BTL_REFURBISHMENT_LIGHT'
    BTL_REFURBISHMENT_HEAVY = 'BTL_REFURBISHMENT_HEAVY'
    BTL_REFURBISHMENT_NEW_BUILD = 'BTL_REFURBISHMENT_NEW_BUILD'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SourceDetailsBuyToLetRefurbishmentType from a JSON string"""
