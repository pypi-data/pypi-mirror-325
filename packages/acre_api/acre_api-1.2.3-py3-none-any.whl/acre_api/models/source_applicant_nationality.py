...
class SourceApplicantNationality(str, Enum):
    """
    SourceApplicantNationality
    """
    ...
    NATIONALITY_BRITISH = 'NATIONALITY_BRITISH'
    NATIONALITY_EU_CITIZEN = 'NATIONALITY_EU_CITIZEN'
    NATIONALITY_NON_EU_CITIZEN = 'NATIONALITY_NON_EU_CITIZEN'
    NATIONALITY_EX_PATRIATE = 'NATIONALITY_EX_PATRIATE'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SourceApplicantNationality from a JSON string"""
