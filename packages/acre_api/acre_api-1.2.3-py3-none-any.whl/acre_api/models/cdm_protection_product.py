...
class CdmProtectionProduct(BaseModel):
    """
    ProtectionProduct maintains information about a protection product.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["protection_id", "created_at", "version", "version_created_at", "details"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmProtectionProduct from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmProtectionProduct from a dict"""
        if obj is None:
            return None
