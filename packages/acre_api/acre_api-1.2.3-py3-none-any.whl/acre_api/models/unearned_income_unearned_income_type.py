...
class UnearnedIncomeUnearnedIncomeType(str, Enum):
    """
    ...
    allowed enum values
    """
    INVALID_UNEARNED_INCOME_TYPE = 'INVALID_UNEARNED_INCOME_TYPE'
    ...
    PENSION_CREDITS = 'PENSION_CREDITS'
    ...
    ARMED_FORCES_INDEPENDENCE_PAYMENT = 'ARMED_FORCES_INDEPENDENCE_PAYMENT'
    ALIMONY_OR_SPOUSAL_MAINTENANCE = 'ALIMONY_OR_SPOUSAL_MAINTENANCE'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UnearnedIncomeUnearnedIncomeType from a JSON string"""
