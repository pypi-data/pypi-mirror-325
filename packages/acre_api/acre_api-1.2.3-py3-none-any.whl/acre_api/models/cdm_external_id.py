...
class CdmExternalID(BaseModel):
    """
    Identifying info about a given resource in an external system.
    """ # noqa: E501
    name: Optional[ExternalIDSourceName] = ExternalIDSourceName.INVALID_SOURCE_NAME
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the resource in the external system.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmExternalID from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmExternalID from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name") if obj.get("name") is not None else ExternalIDSourceName.INVALID_SOURCE_NAME,
            "id": obj.get("id")
        })
        return _obj
