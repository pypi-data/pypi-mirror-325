...
class CaseDetailsClientIDAndVersion(BaseModel):
    """
    ID and a version of that client.
    """ # noqa: E501
    client_id: Optional[StrictStr] = None
    version: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["client_id", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CaseDetailsClientIDAndVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CaseDetailsClientIDAndVersion from a dict"""
        if obj is None:
            return None
