...
class CdmGetMortgageVersionResponse(BaseModel):
    """
    Response to get a mortgage with version.
    """ # noqa: E501
    mortgage: Optional[CdmMortgage] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["mortgage", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetMortgageVersionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetMortgageVersionResponse from a dict"""
        if obj is None:
            return None
