...
class MortgageValuationType(str, Enum):
    """
     - HOME_REPORT: Home Report is for Scotland -provided by the seller (HomeBuyer Report is purchased by the buyer).
    """

    """
    allowed enum values
    """
    INVALID_VALUATION_TYPE = 'INVALID_VALUATION_TYPE'
    STANDARD_VALUATION = 'STANDARD_VALUATION'
    HOMEBUYERS_REPORT = 'HOMEBUYERS_REPORT'
    FULL_BUILDING_SURVEY = 'FULL_BUILDING_SURVEY'
    DRIVE_BY_VALUATION = 'DRIVE_BY_VALUATION'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of MortgageValuationType from a JSON string"""
