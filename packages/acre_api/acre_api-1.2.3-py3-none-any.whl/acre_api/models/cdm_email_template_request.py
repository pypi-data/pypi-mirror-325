...
class CdmEmailTemplateRequest(BaseModel):
    """
    Request to email a template.
    """ # noqa: E501
    template: Optional[CdmRenderTemplateRequest] = None
    subject: Optional[StrictStr] = Field(default=None, description="Subject line of the email.")
    client_recipient_ids: Optional[List[StrictStr]] = Field(default=None, description="Client object references to who the email will be sent.")
    __properties: ClassVar[List[str]] = ["template", "subject", "client_recipient_ids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmEmailTemplateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmEmailTemplateRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "template": CdmRenderTemplateRequest.from_dict(obj["template"]) if obj.get("template") is not None else None,
