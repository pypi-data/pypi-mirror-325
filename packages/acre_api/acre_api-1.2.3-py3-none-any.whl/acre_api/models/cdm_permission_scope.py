...
class CdmPermissionScope(BaseModel):
    """
    Permission scope, clarify an aspect of the permission it is associated with.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmPermissionScope from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmPermissionScope from a dict"""
        if obj is None:
            return None
