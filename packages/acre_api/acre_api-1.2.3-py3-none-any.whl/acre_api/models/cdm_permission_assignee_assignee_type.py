...
class CdmPermissionAssigneeAssigneeType(str, Enum):
    """
    CdmPermissionAssigneeAssigneeType
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmPermissionAssigneeAssigneeType from a JSON string"""
