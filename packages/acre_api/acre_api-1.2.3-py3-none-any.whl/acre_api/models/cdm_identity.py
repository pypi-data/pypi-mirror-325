...
class CdmIdentity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["eidv_check_status", "eidv_check_completed", "eidv_close_associate", "eidv_pep", "eidv_sanction", "eidv_special_interest_person"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmIdentity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmIdentity from a dict"""
        if obj is None:
            return None
