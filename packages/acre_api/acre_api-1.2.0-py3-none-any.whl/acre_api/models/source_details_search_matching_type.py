...
class SourceDetailsSearchMatchingType(str, Enum):
    """
     - SEARCH_MATCHING_STANDARD: Standard (default).
    """

    """
    allowed enum values
    """
    INVALID_SEARCH_MATCHING_TYPE = 'INVALID_SEARCH_MATCHING_TYPE'
    SEARCH_MATCHING_STANDARD = 'SEARCH_MATCHING_STANDARD'
    SEARCH_MATCHING_INCLUDE_NEAR_MISSES = 'SEARCH_MATCHING_INCLUDE_NEAR_MISSES'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SourceDetailsSearchMatchingType from a JSON string"""
