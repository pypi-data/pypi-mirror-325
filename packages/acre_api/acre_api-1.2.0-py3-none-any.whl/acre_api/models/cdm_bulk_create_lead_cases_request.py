...
class CdmBulkCreateLeadCasesRequest(BaseModel):
    """
    Bulk create lead cases from completed cases.
    """ # noqa: E501
    cases: List[CdmBulkCreateLeadCase] = Field(description="Array of complete case IDs to create lead cases from.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmBulkCreateLeadCasesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmBulkCreateLeadCasesRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "cases": [CdmBulkCreateLeadCase.from_dict(_item) for _item in obj["cases"]] if obj.get("cases") is not None else None
        })
        return _obj
