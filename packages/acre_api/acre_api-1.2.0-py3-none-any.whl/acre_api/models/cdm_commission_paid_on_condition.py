...
class CdmCommissionPaidOnCondition(str, Enum):
    """
    Relation conditions for commission payout.
    """

    """
    allowed enum values
    """
    INVALID_COMMISSION_PAID_ON_CONDITION = 'INVALID_COMMISSION_PAID_ON_CONDITION'
    IS_ONE_OF_THE_FOLLOWING = 'IS_ONE_OF_THE_FOLLOWING'
    IS_NOT_ONE_OF_THE_FOLLOWING = 'IS_NOT_ONE_OF_THE_FOLLOWING'
    CAN_BE_ANY_RELATED_USER = 'CAN_BE_ANY_RELATED_USER'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmCommissionPaidOnCondition from a JSON string"""
