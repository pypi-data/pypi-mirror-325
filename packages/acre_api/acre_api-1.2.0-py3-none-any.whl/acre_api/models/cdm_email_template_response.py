...
class CdmEmailTemplateResponse(BaseModel):
    """
    Response to a email template request.
    """ # noqa: E501
    document: Optional[CdmDocument] = None
    subject: Optional[StrictStr] = None
    client_recipient_ids: Optional[List[StrictStr]] = Field(default=None, description="Client object references to whom the email will be sent.")
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["document", "subject", "client_recipient_ids", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmEmailTemplateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmEmailTemplateResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "client_recipient_ids": obj.get("client_recipient_ids"),
