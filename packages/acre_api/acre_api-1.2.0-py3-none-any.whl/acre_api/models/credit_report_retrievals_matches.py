...
class CreditReportRetrievalsMatches(BaseModel):
    """
    CreditReportRetrievalsMatches
    """ # noqa: E501
    electoral_roll_count: Optional[StrictInt] = Field(default=None, description="The number of Electoral Roll matches for an individual.")
    insight_count: Optional[StrictInt] = Field(default=None, description="The number of Insight (i.e. credit) matches for an individual.")
    __properties: ClassVar[List[str]] = ["electoral_roll_count", "insight_count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreditReportRetrievalsMatches from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreditReportRetrievalsMatches from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "electoral_roll_count": obj.get("electoral_roll_count"),
            "insight_count": obj.get("insight_count")
        })
        return _obj
