...
class ReferralReferralPartner(str, Enum):
    """
    ReferralReferralPartner
    """

    """
    allowed enum values
    """
    INVALID_REFERRAL_PARTNER = 'INVALID_REFERRAL_PARTNER'
    SIMPLIFY_MHM = 'SIMPLIFY_MHM'
    UINSURE = 'UINSURE'
    SBVS = 'SBVS'
    SDL = 'SDL'
    DECLINED_REFERRAL = 'DECLINED_REFERRAL'
    HONEY_LEGAL = 'HONEY_LEGAL'
    SMOOVE = 'SMOOVE'
    FP_SURVEYING = 'FP_SURVEYING'
    BENNETT_ALEXANDER = 'BENNETT_ALEXANDER'
    TOWERGATE = 'TOWERGATE'
    HIGOS = 'HIGOS'
    GALLAGHER = 'GALLAGHER'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ReferralReferralPartner from a JSON string"""
