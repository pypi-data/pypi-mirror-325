...
class PartialDetailsOfTheProductToBeUpdatedRequired(BaseModel):
    """
    PartialDetailsOfTheProductToBeUpdatedRequired
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["client_ids", "case_ids", "details", "property_ids", "created_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PartialDetailsOfTheProductToBeUpdatedRequired from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PartialDetailsOfTheProductToBeUpdatedRequired from a dict"""
        if obj is None:
            return None
