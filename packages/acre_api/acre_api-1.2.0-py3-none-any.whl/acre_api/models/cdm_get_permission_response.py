...
class CdmGetPermissionResponse(BaseModel):
    """
    Details of permissions.
    """ # noqa: E501
    permissions: Optional[List[CdmPermission]] = Field(default=None, description="Details of the requested permissions.")
    exception: Optional[V1Exception] = None
    next_page: Optional[CdmGetPermissionRequest] = None
    __properties: ClassVar[List[str]] = ["permissions", "exception", "next_page"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetPermissionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetPermissionResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "permissions": [CdmPermission.from_dict(_item) for _item in obj["permissions"]] if obj.get("permissions") is not None else None,
            "exception": V1Exception.from_dict(obj["exception"]) if obj.get("exception") is not None else None,
            "next_page": CdmGetPermissionRequest.from_dict(obj["next_page"]) if obj.get("next_page") is not None else None
        })
        return _obj
