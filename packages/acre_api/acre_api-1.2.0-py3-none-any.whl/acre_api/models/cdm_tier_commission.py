...
class CdmTierCommission(BaseModel):
    """
    CdmTierCommission
    """ # noqa: E501
    period_id: Optional[StrictStr] = Field(default=None, description="ID of the period in the organisation that this commission refers to. Cannot be set with all_periods.")
    all_periods: Optional[StrictBool] = Field(default=None, description="Indicates this tier setup applies to all periods in the organisation. Cannot be set with period_id.")
    thresholds: Optional[List[CdmThreshold]] = Field(default=None, description="Thresholds holds the threshold values that will be taken into account for tier commission calculations.")
    __properties: ClassVar[List[str]] = ["period_id", "all_periods", "thresholds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmTierCommission from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmTierCommission from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "thresholds": [CdmThreshold.from_dict(_item) for _item in obj["thresholds"]] if obj.get("thresholds") is not None else None
        })
        return _obj
