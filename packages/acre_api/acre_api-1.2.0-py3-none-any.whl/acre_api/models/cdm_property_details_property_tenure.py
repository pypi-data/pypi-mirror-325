...
class CdmPropertyDetailsPropertyTenure(str, Enum):
    """
    CdmPropertyDetailsPropertyTenure
    """
    ...
    FEUDAL = 'FEUDAL'
    FEUHOLD = 'FEUHOLD'
    CROSSOVER_LEASE = 'CROSSOVER_LEASE'
    ABSOLUTE_OWNERSHIP = 'ABSOLUTE_OWNERSHIP'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmPropertyDetailsPropertyTenure from a JSON string"""
