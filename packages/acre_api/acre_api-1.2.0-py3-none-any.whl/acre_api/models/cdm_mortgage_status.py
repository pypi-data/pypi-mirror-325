...
class CdmMortgageStatus(str, Enum):
    """
     - STATUS_LENDER_PROPOSED: Lender has proposed transfer.  - STATUS_CREDIT_REPORT_CURRENT: Items we have imported from Equifax, but not linked to a property.
    """
    ...
    STATUS_REPAID = 'STATUS_REPAID'
    STATUS_CURRENT = 'STATUS_CURRENT'
    STATUS_PROPOSED = 'STATUS_PROPOSED'
    STATUS_SELECTED = 'STATUS_SELECTED'
    STATUS_LENDER_PROPOSED = 'STATUS_LENDER_PROPOSED'
    STATUS_CREDIT_REPORT_CURRENT = 'STATUS_CREDIT_REPORT_CURRENT'
    STATUS_CREDIT_REPORT_SETTLED = 'STATUS_CREDIT_REPORT_SETTLED'
    STATUS_DUPLICATE = 'STATUS_DUPLICATE'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmMortgageStatus from a JSON string"""
