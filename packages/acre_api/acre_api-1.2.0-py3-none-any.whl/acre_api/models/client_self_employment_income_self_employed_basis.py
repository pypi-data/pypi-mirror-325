...
class ClientSelfEmploymentIncomeSelfEmployedBasis(str, Enum):
    """
    On what basis the individual is self-employer (sole trader, partner, etc.).
    """

    """
    allowed enum values
    """
    INVALID_SELF_EMPLOYED_BASIS = 'INVALID_SELF_EMPLOYED_BASIS'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientSelfEmploymentIncomeSelfEmployedBasis from a JSON string"""
