...
class CdmConditionalOnRelatedUser(BaseModel):
    """
    CdmConditionalOnRelatedUser
    """ # noqa: E501
    condition: Optional[CdmCommissionPaidOnCondition] = CdmCommissionPaidOnCondition.INVALID_COMMISSION_PAID_ON_CONDITION
    related_user: Optional[List[StrictStr]] = Field(default=None, description="Commission paid when this/these value(s) satisfy \"condition\".")
    related_user_relationship_type: Optional[CdmRelatedUserRelationshipType] = CdmRelatedUserRelationshipType.INVALID_RELATIONSHIP_TYPE
    __properties: ClassVar[List[str]] = ["condition", "related_user", "related_user_relationship_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmConditionalOnRelatedUser from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmConditionalOnRelatedUser from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "condition": obj.get("condition") if obj.get("condition") is not None else CdmCommissionPaidOnCondition.INVALID_COMMISSION_PAID_ON_CONDITION,
            "related_user": obj.get("related_user"),
            "related_user_relationship_type": obj.get("related_user_relationship_type") if obj.get("related_user_relationship_type") is not None else CdmRelatedUserRelationshipType.INVALID_RELATIONSHIP_TYPE
        })
        return _obj
