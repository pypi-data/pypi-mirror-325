...
class RequirementsLCIAndFIBBenefitType(str, Enum):
    """
    RequirementsLCIAndFIBBenefitType
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RequirementsLCIAndFIBBenefitType from a JSON string"""
