...
class CdmAdditionalSupplementaryInformation(str, Enum):
    """
    CdmAdditionalSupplementaryInformation
    """

    """
    allowed enum values
    """
    INVALID_ADDITIONAL_SUPPLEMENTARY_INFORMATION = 'INVALID_ADDITIONAL_SUPPLEMENTARY_INFORMATION'
    JOINT = 'JOINT'
    SOLE_ACCOUNT = 'SOLE_ACCOUNT'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmAdditionalSupplementaryInformation from a JSON string"""
