...
class AcreProcessorCreateClientOrganisationRelationshipBody(BaseModel):
    """
    Create client organisation relationship request.
    """ # noqa: E501
    client_organisation_relationship: CdmClientOrganisationRelationship
    receiving_organisation_override: Optional[StrictStr] = Field(default=None, description="If I am calling as a SA, the organisation from whom this relationship is being created. It is the receiving org as it receives any commission.")
    __properties: ClassVar[List[str]] = ["client_organisation_relationship", "receiving_organisation_override"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AcreProcessorCreateClientOrganisationRelationshipBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AcreProcessorCreateClientOrganisationRelationshipBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "receiving_organisation_override": obj.get("receiving_organisation_override")
        })
        return _obj
