...
class SourceName(str, Enum):
    """
    Remember to update the above ExternalID.SourceName if updating this array or the oracle *will* break.   - ONFIDO: Onfido (https://onfido.com/).
    """
    ...
    ONFIDO = 'ONFIDO'
    ACRE_DATA_IMPORTER = 'ACRE_DATA_IMPORTER'
    MORTGAGES_360 = 'MORTGAGES_360'
    INTELLIFLO = 'INTELLIFLO'
    PIPEDRIVE = 'PIPEDRIVE'
    SMARTR_365 = 'SMARTR_365'
    THE_KEY = 'THE_KEY'
    XPLAN = 'XPLAN'
    EQUIFAX = 'EQUIFAX'
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SourceName from a JSON string"""
