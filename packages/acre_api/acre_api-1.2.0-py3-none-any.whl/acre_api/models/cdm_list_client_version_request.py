...
class CdmListClientVersionRequest(BaseModel):
    """
    List client versions. Only versions that the caller is allowed to access are returned, all others are omitted.
    """ # noqa: E501
    client_id: StrictStr = Field(description="Client ID. Required.")
    ...
    show_history: Optional[StrictInt] = Field(default=None, description="Specify the number of previous versions to show change_details for against each returned client, recommend 1 to show editor details of returned version, 0 will show all versions.")
    __properties: ClassVar[List[str]] = ["client_id", "bookmark", "page_size", "show_history"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmListClientVersionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmListClientVersionRequest from a dict"""
        if obj is None:
            return None
