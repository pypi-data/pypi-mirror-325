...
class NoteUiReference(BaseModel):
    """
    NoteUiReference
    """ # noqa: E501
    section: Optional[UiReferenceSection] = UiReferenceSection.INVALID_SECTION
    entity_id: Optional[StrictStr] = Field(default=None, description="The entity that the note is linked to. Note: this field can be empty.")
    __properties: ClassVar[List[str]] = ["section", "entity_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NoteUiReference from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NoteUiReference from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "section": obj.get("section") if obj.get("section") is not None else UiReferenceSection.INVALID_SECTION,
