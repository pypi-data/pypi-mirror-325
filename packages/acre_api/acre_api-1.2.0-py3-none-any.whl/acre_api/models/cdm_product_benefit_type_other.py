...
class CdmProductBenefitTypeOther(BaseModel):
    """
    CdmProductBenefitTypeOther
    """ # noqa: E501
    ...
    product_type_other_name: Optional[StrictStr] = Field(default=None, description="If product_type=PRODUCT_TYPE_OTHER, give a name.")
    ...
    __properties: ClassVar[List[str]] = ["client_ids", "product_type", "product_type_other_name", "cover_amount", "cover_amount_frequency"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmProductBenefitTypeOther from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmProductBenefitTypeOther from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "product_type_other_name": obj.get("product_type_other_name"),
