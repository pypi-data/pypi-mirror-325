...
class CdmComplianceProcessConfig(BaseModel):
    """
    CdmComplianceProcessConfig
    """ # noqa: E501
    separated_recommendation_reasons: Optional[StrictBool] = Field(default=None, description="Enable Separated Recommendation Reasons in SR.")
    third_party_notification_address: Optional[StrictStr] = Field(default=None, description="E-mail address for notifications when a third-party flag is added.")
    aml_notification_address: Optional[StrictStr] = Field(default=None, description="E-mail address for notifications when a AML flag is added.")
    __properties: ClassVar[List[str]] = ["separated_recommendation_reasons", "third_party_notification_address", "aml_notification_address"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmComplianceProcessConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmComplianceProcessConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "separated_recommendation_reasons": obj.get("separated_recommendation_reasons"),
            "third_party_notification_address": obj.get("third_party_notification_address"),
            "aml_notification_address": obj.get("aml_notification_address")
        })
        return _obj
