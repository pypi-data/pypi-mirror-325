...
class CdmCreateProtectionProductVersionResponse(BaseModel):
    """
    Response to create a protection product version.
    """ # noqa: E501
    mutable_version: Optional[StrictInt] = Field(default=None, description="The currently mutable (i.e., \"next\") version. This minus one is the immutable version just created.")
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["mutable_version", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateProtectionProductVersionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateProtectionProductVersionResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mutable_version": obj.get("mutable_version"),
