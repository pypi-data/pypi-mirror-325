...
class CdmGetMortgageProductDetailsResponse(BaseModel):
    """
    GetMortgageProductDetailsResponse returns details of a mortgage product.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["product_details", "exception", "generated_at", "generated_for", "signature"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGetMortgageProductDetailsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGetMortgageProductDetailsResponse from a dict"""
        if obj is None:
            return None
