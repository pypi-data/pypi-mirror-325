...
class CdmTestRenderTemplateResponse(BaseModel):
    """
    Response to a render template request.
    """ # noqa: E501
    document: Optional[CdmDocument] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["document", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmTestRenderTemplateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmTestRenderTemplateResponse from a dict"""
        if obj is None:
            return None
