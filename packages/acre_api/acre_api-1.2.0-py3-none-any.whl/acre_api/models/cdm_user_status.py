...
class CdmUserStatus(str, Enum):
    """
     - INVALID_STATUS: Invalid user status.  - ACTIVE: Active user status.  - PENDING: Pending user status.  - DISABLED: Disabled user status.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmUserStatus from a JSON string"""
