...
class CdmCreateDocumentVerificationResponse(BaseModel):
    """
    Response to a create document verification.
    """ # noqa: E501
    verification: Optional[CdmDocumentVerification] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["verification", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateDocumentVerificationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateDocumentVerificationResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "verification": CdmDocumentVerification.from_dict(obj["verification"]) if obj.get("verification") is not None else None,
