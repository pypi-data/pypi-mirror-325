...
class CdmDocumentRequirement(BaseModel):
    """
    CdmDocumentRequirement
    """ # noqa: E501
    requirement_id: Optional[StrictStr] = Field(default=None, description="Identifier for this requirement. **IMPORTANT:** This field cannot be updated and is populated automatically.")
    created_at: Optional[StrictStr] = Field(default=None, description="The datetime on which the requirement was created (RFC3339). **IMPORTANT:** This field cannot be updated and is populated automatically.")
    created_by: Optional[StrictStr] = Field(default=None, description="The ID of the user that created the requirement. **IMPORTANT:** This field cannot be updated and is populated automatically.")
    modified_at: Optional[StrictStr] = Field(default=None, description="The datetime on which the requirement was modified (RFC3339). **IMPORTANT:** This field cannot be updated and is populated automatically.")
    disabled_at: Optional[StrictStr] = Field(default=None, description="The datetime on which the requirement was marked as disabled (RFC3339). **IMPORTANT:** This field cannot be updated and is populated automatically.")
    details: Optional[CdmRequirementDetails] = None
    __properties: ClassVar[List[str]] = ["requirement_id", "created_at", "created_by", "modified_at", "disabled_at", "details"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmDocumentRequirement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmDocumentRequirement from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "details": CdmRequirementDetails.from_dict(obj["details"]) if obj.get("details") is not None else None
        })
        return _obj
