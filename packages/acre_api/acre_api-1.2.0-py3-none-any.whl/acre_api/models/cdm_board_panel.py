...
class CdmBoardPanel(BaseModel):
    """
    CdmBoardPanel
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="String name displayed at the top of the panel.")
    statuses: Optional[List[CdmCaseDetailsStatus]] = Field(default=None, description="Case status for panel to display. Can have multiple statuses in a single panel.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmBoardPanel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmBoardPanel from a dict"""
        if obj is None:
            return None
