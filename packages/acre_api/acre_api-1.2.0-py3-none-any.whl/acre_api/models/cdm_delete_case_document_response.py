...
class CdmDeleteCaseDocumentResponse(BaseModel):
    """
    Response to removing a document from a case.
    """ # noqa: E501
    case_id: Optional[StrictStr] = Field(default=None, description="Case to remove the mortgage.")
    document_id: Optional[StrictStr] = Field(default=None, description="ID of the removed document.")
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["case_id", "document_id", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmDeleteCaseDocumentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmDeleteCaseDocumentResponse from a dict"""
        if obj is None:
            return None
