...
class ClientOrganisationRelationshipProductTypes(str, Enum):
    """
    ProductTypes are the types of products an org provides a client.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientOrganisationRelationshipProductTypes from a JSON string"""
