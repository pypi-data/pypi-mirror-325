...
class RequirementsLCIAndFIBScenario(str, Enum):
    """
    The scenario that related to the protection requirement.
    """
    ...
    DEATH_OR_EARLIER_CRITICAL_ILLNESS = 'DEATH_OR_EARLIER_CRITICAL_ILLNESS'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RequirementsLCIAndFIBScenario from a JSON string"""
