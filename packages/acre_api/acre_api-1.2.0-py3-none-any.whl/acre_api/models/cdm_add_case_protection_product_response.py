...
class CdmAddCaseProtectionProductResponse(BaseModel):
    """
    Response to adding a product to a case.
    """ # noqa: E501
    case_id: Optional[StrictStr] = Field(default=None, description="ID of the case added.")
    protection_id: Optional[StrictStr] = Field(default=None, description="ID of the protection product to be added to the case.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmAddCaseProtectionProductResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmAddCaseProtectionProductResponse from a dict"""
        if obj is None:
            return None
