...
class CdmReplaceRoleResponse(BaseModel):
    """
    Response to the replacement of a role.
    """ # noqa: E501
    role: Optional[CdmRole] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["role", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmReplaceRoleResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmReplaceRoleResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "role": CdmRole.from_dict(obj["role"]) if obj.get("role") is not None else None,
