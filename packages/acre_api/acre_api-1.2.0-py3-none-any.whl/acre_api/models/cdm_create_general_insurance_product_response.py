...
class CdmCreateGeneralInsuranceProductResponse(BaseModel):
    """
    Response to the creation of a general insurance product.
    """ # noqa: E501
    general_insurance_product: Optional[CdmGeneralInsuranceProduct] = None
    exception: Optional[V1Exception] = None
    __properties: ClassVar[List[str]] = ["general_insurance_product", "exception"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmCreateGeneralInsuranceProductResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmCreateGeneralInsuranceProductResponse from a dict"""
        if obj is None:
            return None
