...
class CdmGroup(BaseModel):
    """
    Groups are assigned to users and govern access and authorisation. All fields can be updated / set via the API unless otherwise stated.
    """ # noqa: E501
    group_id: Optional[StrictStr] = Field(default=None, description="Acre UUID for Group. **IMPORTANT:** This field cannot be updated and is populated automatically.")
    group_name: Optional[StrictStr] = Field(default=None, description="Possible group value. **IMPORTANT:** This field cannot be updated.")
    organisation_id: Optional[StrictStr] = Field(default=None, description="Organisation associated with the group. **IMPORTANT:** This field cannot be updated.")
    disabled: Optional[StrictBool] = Field(default=None, description="Set if the group is disabled. A group cannot be created disabled. A group can be re-enabled after being disabled.")
    accept_reminders: Optional[StrictBool] = Field(default=None, description="Whether this group can be assigned reminders.")
    user_ids: Optional[List[StrictStr]] = Field(default=None, description="List of users that belong to that group. **IMPORTANT:** This field cannot be updated and is populated automatically based on the users that belong to this group.")
    __properties: ClassVar[List[str]] = ["group_id", "group_name", "organisation_id", "disabled", "accept_reminders", "user_ids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmGroup from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "accept_reminders": obj.get("accept_reminders"),
