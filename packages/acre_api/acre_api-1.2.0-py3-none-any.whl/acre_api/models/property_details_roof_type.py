...
class PropertyDetailsRoofType(str, Enum):
    """
    PropertyDetailsRoofType
    """

    """
    allowed enum values
    """
    INVALID_ROOF_TYPE = 'INVALID_ROOF_TYPE'
    FLAT_ROOF = 'FLAT_ROOF'
    THATCHED_ROOF = 'THATCHED_ROOF'
    TILE_ROOF = 'TILE_ROOF'
    SLATE_ROOF = 'SLATE_ROOF'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PropertyDetailsRoofType from a JSON string"""
