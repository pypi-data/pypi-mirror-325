...
class CaseDetailsEidvResultOverride(BaseModel):
    """
    This field indicates the client for which the eidv result should be ignored and it should be understood as a valid result.
    """ # noqa: E501
    client_id: Optional[StrictStr] = Field(default=None, description="Client id for which the result should be overridden.")
    override_result: Optional[StrictBool] = Field(default=None, description="Indicate if the result should be overridden or not.")
    __properties: ClassVar[List[str]] = ["client_id", "override_result"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CaseDetailsEidvResultOverride from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CaseDetailsEidvResultOverride from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "override_result": obj.get("override_result")
        })
        return _obj
