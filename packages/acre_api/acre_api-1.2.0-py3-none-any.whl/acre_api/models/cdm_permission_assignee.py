...
class CdmPermissionAssignee(BaseModel):
    """
    CdmPermissionAssignee
    """ # noqa: E501
    type: Optional[CdmPermissionAssigneeAssigneeType] = CdmPermissionAssigneeAssigneeType.INVALID
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmPermissionAssignee from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmPermissionAssignee from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else CdmPermissionAssigneeAssigneeType.INVALID,
            "id": obj.get("id")
        })
        return _obj
