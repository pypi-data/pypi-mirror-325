...
class PartialDetailsOfTheProtectionProductToBeUpdatedRequired(BaseModel):
    """
    PartialDetailsOfTheProtectionProductToBeUpdatedRequired
    """ # noqa: E501
    created_at: Optional[StrictStr] = Field(default=None, description="Creation date (RFC3339) of the protection product. Populated automatically; cannot be set.")
    ...
    details: Optional[CdmProtectionProductDetails] = None
    __properties: ClassVar[List[str]] = ["created_at", "version", "version_created_at", "details"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PartialDetailsOfTheProtectionProductToBeUpdatedRequired from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PartialDetailsOfTheProtectionProductToBeUpdatedRequired from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "details": CdmProtectionProductDetails.from_dict(obj["details"]) if obj.get("details") is not None else None
        })
        return _obj
