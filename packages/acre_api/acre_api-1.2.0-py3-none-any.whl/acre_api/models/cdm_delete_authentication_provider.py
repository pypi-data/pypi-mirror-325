...
class CdmDeleteAuthenticationProvider(BaseModel):
    """
    Delete an authentication provider.
    """ # noqa: E501
    authentication_provider_id: StrictStr = Field(description="ID of the authentication provider. Required.")
    __properties: ClassVar[List[str]] = ["authentication_provider_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmDeleteAuthenticationProvider from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmDeleteAuthenticationProvider from a dict"""
        if obj is None:
            return None
