...
class ClientPensionIncomePensionType(str, Enum):
    """
    ClientPensionIncomePensionType
    """

    """
    allowed enum values
    """
    INVALID_PENSION_TYPE = 'INVALID_PENSION_TYPE'
    INDUSTRIAL_INJURIES_DISABLEMENT = 'INDUSTRIAL_INJURIES_DISABLEMENT'
    PRIVATE_RETIREMENT = 'PRIVATE_RETIREMENT'
    STATE_RETIREMENT = 'STATE_RETIREMENT'
    WAR_DISABILITY = 'WAR_DISABILITY'
    WIDOWS = 'WIDOWS'
    OTHER = 'OTHER'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientPensionIncomePensionType from a JSON string"""
