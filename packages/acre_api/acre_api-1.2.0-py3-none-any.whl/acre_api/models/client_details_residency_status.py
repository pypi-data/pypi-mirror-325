...
class ClientDetailsResidencyStatus(str, Enum):
    """
    ClientDetailsResidencyStatus
    """

    """
    allowed enum values
    """
    INVALID_RESIDENCY_STATUS = 'INVALID_RESIDENCY_STATUS'
    UK_CITIZEN = 'UK_CITIZEN'
    EU_CITIZEN = 'EU_CITIZEN'
    IRISH_CITIZEN = 'IRISH_CITIZEN'
    VISA = 'VISA'
    VISA_2_YRS_PLUS = 'VISA_2YRS_PLUS'
    LEAVE_TO_REMAIN = 'LEAVE_TO_REMAIN'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClientDetailsResidencyStatus from a JSON string"""
