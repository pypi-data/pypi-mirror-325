...
class CdmProductOrderProductType(str, Enum):
    """
    Type of product that was chosen. Top up indicates a product is for Porting or Further Advance.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmProductOrderProductType from a JSON string"""
