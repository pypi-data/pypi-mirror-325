...
class CdmFeeFeeType(str, Enum):
    """
     - INVALID_FEE_TYPE: Invalid fee type.  - PREADVICE_FIXED: Pre Mortgage Advice (Fixed).  - PRERECOMMENDATION_FIXED: Pre Mortgage Recommendation (Fixed).  - PRERECOMMENDATION_PERCENT: Pre Mortgage Recommendation (Percentage of Loan).  - PREAPPLICATION_FIXED: Pre Mortgage Application (Fixed).  - PREAPPLICATION_PERCENT: Pre Mortgage Application (Percentage of Loan).  - OFFER_FIXED: Mortgage Offer (Fixed).  - OFFER_PERCENT: Mortgage Offer (Percentage of Loan).  - LEGAL_COMPLETION_FIXED: Mortgage Legal Completion (Fixed).  - LEGAL_COMPLETION_PERCENT: Mortgage Legal Completion (Percentage of Loan).  - LEGAL_EXCHANGE_FIXED: Mortgage Legal Exchange or Drawdown (Fixed).  - LEGAL_EXCHANGE_PERCENT: Mortgage Legal Exchange or Drawdown (Percentage of Loan).
    """
    ...
    PREADVICE_FIXED = 'PREADVICE_FIXED'
    PRERECOMMENDATION_FIXED = 'PRERECOMMENDATION_FIXED'
    PRERECOMMENDATION_PERCENT = 'PRERECOMMENDATION_PERCENT'
    PREAPPLICATION_FIXED = 'PREAPPLICATION_FIXED'
    PREAPPLICATION_PERCENT = 'PREAPPLICATION_PERCENT'
    OFFER_FIXED = 'OFFER_FIXED'
    OFFER_PERCENT = 'OFFER_PERCENT'
    LEGAL_COMPLETION_FIXED = 'LEGAL_COMPLETION_FIXED'
    LEGAL_COMPLETION_PERCENT = 'LEGAL_COMPLETION_PERCENT'
    LEGAL_EXCHANGE_FIXED = 'LEGAL_EXCHANGE_FIXED'
    LEGAL_EXCHANGE_PERCENT = 'LEGAL_EXCHANGE_PERCENT'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CdmFeeFeeType from a JSON string"""
