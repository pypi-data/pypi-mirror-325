...
class CdmVerifiedDisclosureIDs(BaseModel):
    """
    VerifiedDisclosureIDs contains the latest verified disclosure document id for some document types.
    """ # noqa: E501
    full_disclosure_document_id: Optional[StrictStr] = None
    client_portal_document_id: Optional[StrictStr] = None
    privacy_policy_document_id: Optional[StrictStr] = None
    verbal_disclosure_document_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["full_disclosure_document_id", "client_portal_document_id", "privacy_policy_document_id", "verbal_disclosure_document_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CdmVerifiedDisclosureIDs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CdmVerifiedDisclosureIDs from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "full_disclosure_document_id": obj.get("full_disclosure_document_id"),
            "client_portal_document_id": obj.get("client_portal_document_id"),
            "privacy_policy_document_id": obj.get("privacy_policy_document_id"),
            "verbal_disclosure_document_id": obj.get("verbal_disclosure_document_id")
        })
        return _obj
