...
class GraphServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPythonFeaturesFromGraph = channel.unary_unary(
            "/chalk.server.v1.GraphService/GetPythonFeaturesFromGraph",
            request_serializer=chalk_dot_server_dot_v1_dot_graph__pb2.GetPythonFeaturesFromGraphRequest.SerializeToString,
            response_deserializer=chalk_dot_server_dot_v1_dot_graph__pb2.GetPythonFeaturesFromGraphResponse.FromString,
        )
...
class GraphServiceServicer(object):
    ...
    def GetPythonFeaturesFromGraph(self, request, context):
...
def add_GraphServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "GetPythonFeaturesFromGraph": grpc.unary_unary_rpc_method_handler(
            servicer.GetPythonFeaturesFromGraph,
            request_deserializer=chalk_dot_server_dot_v1_dot_graph__pb2.GetPythonFeaturesFromGraphRequest.FromString,
            response_serializer=chalk_dot_server_dot_v1_dot_graph__pb2.GetPythonFeaturesFromGraphResponse.SerializeToString,
        ),
    }
...
class GraphService(object):
    ...
    @staticmethod
    def GetPythonFeaturesFromGraph(
        request,
        target,
        options=(),
        channel_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/chalk.server.v1.GraphService/GetPythonFeaturesFromGraph",
            chalk_dot_server_dot_v1_dot_graph__pb2.GetPythonFeaturesFromGraphRequest.SerializeToString,
            chalk_dot_server_dot_v1_dot_graph__pb2.GetPythonFeaturesFromGraphResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
