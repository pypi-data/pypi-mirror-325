...
class GetPythonFeaturesFromGraphRequest(_message.Message):
...
class GetPythonFeaturesFromGraphResponse(_message.Message):
    __slots__ = ("python_features", "errors")
    PYTHON_FEATURES_FIELD_NUMBER: _ClassVar[int]
    ERRORS_FIELD_NUMBER: _ClassVar[int]
    python_features: bytes
    errors: _containers.RepeatedCompositeFieldContainer[_chalk_error_pb2.ChalkError]
    def __init__(
        self,
        python_features: _Optional[bytes] = ...,
