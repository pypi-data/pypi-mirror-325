...
"""
    ...
    def query(
        ...
        request = OnlineQueryRequest(
            ...
            outputs=outputs,
            expression_outputs=encoded_outputs.feature_expressions,
            now=now_str,
    ...
    def offline_query(
        ...
        optional_output_expressions = optional_encoded_outputs.feature_expressions
        required_encoded_outputs = encode_outputs(required_output)
        required_output_root_fqns = required_encoded_outputs.string_outputs
        required_output_expressions = required_encoded_outputs.feature_expressions
