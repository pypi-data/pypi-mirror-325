...
from chalk._gen.chalk.server.v1.graph_pb2 import (
    ...
    GetGraphRequest,
    GetGraphResponse,
    GetPythonFeaturesFromGraphRequest,
    GetPythonFeaturesFromGraphResponse,
    UpdateGraphRequest,
    UpdateGraphResponse,
)
from grpc import (
...
class GraphServiceStub:
    ...
    GetPythonFeaturesFromGraph: UnaryUnaryMultiCallable[
        GetPythonFeaturesFromGraphRequest,
        GetPythonFeaturesFromGraphResponse,
    ]
...
class GraphServiceServicer(metaclass=ABCMeta):
    ...
    def GetPythonFeaturesFromGraph(
        self,
        request: GetPythonFeaturesFromGraphRequest,
        context: ServicerContext,
    ) -> GetPythonFeaturesFromGraphResponse:
        """GetPythonFeaturesFromGraph returns chalk python features generated from the protograph"""
