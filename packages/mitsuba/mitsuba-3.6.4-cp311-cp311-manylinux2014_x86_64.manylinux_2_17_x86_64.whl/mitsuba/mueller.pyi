...
@overload
def absorber(value: mitsuba.UnpolarizedSpectrum) -> mitsuba.Spectrum: ...
...
@overload
def depolarizer(value: mitsuba.UnpolarizedSpectrum = 1.0) -> mitsuba.Spectrum: ...
...
@overload
def diattenuator(x: mitsuba.UnpolarizedSpectrum, y: mitsuba.UnpolarizedSpectrum) -> mitsuba.Spectrum: ...
...
@overload
def left_circular_polarizer() -> mitsuba.Spectrum: ...
...
@overload
def linear_polarizer(value: mitsuba.UnpolarizedSpectrum = 1.0) -> mitsuba.Spectrum: ...
...
@overload
def linear_retarder(phase: mitsuba.UnpolarizedSpectrum) -> mitsuba.Spectrum: ...
...
@overload
def right_circular_polarizer() -> mitsuba.Spectrum: ...
...
@overload
def rotate_mueller_basis(M: mitsuba.Spectrum, in_forward: mitsuba.Vector3f, in_basis_current: mitsuba.Vector3f, in_basis_target: mitsuba.Vector3f, out_forward: mitsuba.Vector3f, out_basis_current: mitsuba.Vector3f, out_basis_target: mitsuba.Vector3f) -> mitsuba.Spectrum: ...
...
@overload
def rotate_mueller_basis_collinear(M: mitsuba.Spectrum, forward: mitsuba.Vector3f, basis_current: mitsuba.Vector3f, basis_target: mitsuba.Vector3f) -> mitsuba.Spectrum: ...
...
def rotate_stokes_basis_m(wi: mitsuba.Vector3f, basis_current: mitsuba.Vector3f, basis_target: mitsuba.Vector3f) -> mitsuba.Spectrum:
    """
    Gives the Mueller matrix that aligns the reference frames (defined by
    their respective basis vectors) of two collinear stokes vectors.
...
@overload
def rotated_element(theta: mitsuba.UnpolarizedSpectrum, M: mitsuba.Spectrum) -> mitsuba.Spectrum: ...
...
@overload
def rotator(theta: mitsuba.UnpolarizedSpectrum) -> mitsuba.Spectrum: ...
...
@overload
def specular_reflection(cos_theta_i: mitsuba.UnpolarizedSpectrum, eta: "drjit::Complex<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul> >") -> mitsuba.Spectrum: ...
...
@overload
def specular_transmission(cos_theta_i: mitsuba.UnpolarizedSpectrum, eta: mitsuba.UnpolarizedSpectrum) -> mitsuba.Spectrum: ...
