...
@overload
def absorber(value: mitsuba.Spectrum) -> "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>": ...
...
@overload
def depolarizer(value: mitsuba.Spectrum = 1.0) -> "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>": ...
...
@overload
def diattenuator(x: mitsuba.Spectrum, y: mitsuba.Spectrum) -> "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>": ...
...
@overload
def left_circular_polarizer() -> "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>": ...
...
@overload
def linear_polarizer(value: mitsuba.Spectrum = 1.0) -> "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>": ...
...
@overload
def linear_retarder(phase: mitsuba.Spectrum) -> "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>": ...
...
@overload
def right_circular_polarizer() -> "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>": ...
...
@overload
def rotate_mueller_basis(M: "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>", in_forward: mitsuba.Vector3f, in_basis_current: mitsuba.Vector3f, in_basis_target: mitsuba.Vector3f, out_forward: mitsuba.Vector3f, out_basis_current: mitsuba.Vector3f, out_basis_target: mitsuba.Vector3f) -> "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>": ...
...
@overload
def rotate_mueller_basis_collinear(M: "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>", forward: mitsuba.Vector3f, basis_current: mitsuba.Vector3f, basis_target: mitsuba.Vector3f) -> "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>": ...
...
def rotate_stokes_basis_m(wi: mitsuba.Vector3f, basis_current: mitsuba.Vector3f, basis_target: mitsuba.Vector3f) -> "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>":
    """
    Gives the Mueller matrix that aligns the reference frames (defined by
    their respective basis vectors) of two collinear stokes vectors.
...
@overload
def rotated_element(theta: mitsuba.Spectrum, M: "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>") -> "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>": ...
...
@overload
def rotator(theta: mitsuba.Spectrum) -> "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>": ...
...
@overload
def specular_reflection(cos_theta_i: mitsuba.Spectrum, eta: "drjit::Complex<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul> >") -> "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>": ...
...
@overload
def specular_transmission(cos_theta_i: mitsuba.Spectrum, eta: mitsuba.Spectrum) -> "drjit::Matrix<mitsuba::Spectrum<drjit::DiffArray<(JitBackend)2, float>, 4ul>, 4ul>": ...
