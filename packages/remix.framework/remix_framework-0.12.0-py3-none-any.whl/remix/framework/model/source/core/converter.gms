  ...
  $(sum(years_a$converter_usedTech(nodesModel,years_a,converter_techs,vintage), 1)
    and sum(yearsToCalc
      $(sameas(years, yearsToCalc)
        and yearsToCalc.val >= smin(years_a$converter_availTech(nodesModel,years_a,converter_techs,vintage), years_a.val)
...
$iftheni.fcfgdx not %fixedcapsfromgdx%==None
converter_capacityParam(nodesModel,years,converter_techs,"unitsUpperLimit")
  = sum(vintage,converter_unitsTotal.l(nodesModel,years,converter_techs,vintage));
converter_capacityParam(nodesModel,years,converter_techs,"unitsLowerLimit")
  = converter_capacityParam(nodesModel,years,converter_techs,"unitsUpperLimit");
$endif.fcfgdx
...
parameter converter_unitsDelta(nodesModel,years,converter_techs);
...
* // ### Converter Units Forced Decommission
* // Restricts the forced decommissioning of units to after the end of their life time.
