  ...
  $(sum(years_a$transfer_usedTech(linksModel,years_a,transfer_techs,vintage), 1)
    and sum(yearsToCalc
      $(sameas(years, yearsToCalc)
        and yearsToCalc.val >= smin(years_a$transfer_availTech(linksModel,years_a,transfer_techs,vintage), years_a.val)
...
transfer_linksParam(linksModel,years,transfer_techs,"linksUpperLimit")
  = sum(vintage,transfer_linksTotal.l(linksModel,years,transfer_techs,vintage));
...
parameter transfer_linksDelta(linksModel,years,transfer_techs);
