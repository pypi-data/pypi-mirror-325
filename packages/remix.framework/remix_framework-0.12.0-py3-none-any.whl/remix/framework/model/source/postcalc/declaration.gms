...
parameter converter_caps_novintage_ext(%scenidx%accNodesModel,nodesModel,accYears,years,techs,commodity,capType);
...
parameter storage_caps_novintage_ext(%scenidx%accNodesModel,nodesModel,accYears,years,techs,commodity,capType);
