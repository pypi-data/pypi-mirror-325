...
converter_caps_novintage_ext(%selscen%map_accNodesPostCalc(accNodesModel,nodesModelToCalc),map_accYearsPostCalc(accYears,years),converter_techs(techs),commodity,capType)
    $(sum(vintage$converter_usedTech(nodesModelToCalc,years,converter_techs,vintage),1))
    = sum(vintage$(converter_usedTech(nodesModelToCalc,years,converter_techs,vintage)),
...
converter_caps_novintage_ext(%selscen%map_accNodesPostCalc(accNodesModel,nodesModelToCalc),map_accYearsPostCalc(accYears,years),converter_techs(techs),commodity,"lowerLimit")
    $(sum(vintage$converter_usedTech(nodesModelToCalc,years,converter_techs,vintage),1)
...
converter_caps_novintage_ext(%selscen%map_accNodesPostCalc(accNodesModel,nodesModelToCalc),map_accYearsPostCalc(accYears,years),converter_techs(techs),commodity,"upperLimit")
    $(sum(vintage$converter_usedTech(nodesModelToCalc,years,converter_techs,vintage),1)
...
converter_caps(%selscen%accNodesModel,accYears,converter_techs(techs),commodity,capType)
    = sum((nodesModelToCalc,years)
        ...
        converter_caps_novintage_ext(%selscen%accNodesModel,nodesModelToCalc,accYears,years,converter_techs,commodity,capType));
option clear = converter_caps_novintage_ext;
...
storage_caps_novintage_ext(%selscen%map_accNodesPostCalc(accNodesModel,nodesModelToCalc),map_accYearsPostCalc(accYears,years),storage_techs(techs),commodity,capType)
    $(sum(vintage$storage_usedTech(nodesModelToCalc,years,storage_techs,vintage),1))
    = sum(vintage$(storage_usedTech(nodesModelToCalc,years,storage_techs,vintage)),
...
storage_caps_novintage_ext(%selscen%map_accNodesPostCalc(accNodesModel,nodesModelToCalc),map_accYearsPostCalc(accYears,years),storage_techs(techs),commodity,"lowerLimit")
    $(sum(vintage$storage_usedTech(nodesModelToCalc,years,storage_techs,vintage),1)
...
storage_caps_novintage_ext(%selscen%map_accNodesPostCalc(accNodesModel,nodesModelToCalc),map_accYearsPostCalc(accYears,years),storage_techs(techs),commodity,"upperLimit")
    $(sum(vintage$storage_usedTech(nodesModelToCalc,years,storage_techs,vintage),1)
...
storage_caps(%selscen%accNodesModel,accYears,storage_techs(techs),commodity,capType)
    = sum((nodesModelToCalc,years)
            $(map_accNodesPostCalc(accNodesModel,nodesModelToCalc)
                and map_accYearsPostCalc(accYears,years)),
        storage_caps_novintage_ext(%selscen%accNodesModel,nodesModelToCalc,accYears,years,storage_techs,commodity,capType));
option clear = storage_caps_novintage_ext;
...
storage_flows_ext(%selscen%timeModelToCalc,map_accNodesPostCalc(accNodesModel,nodesModelToCalc),map_accYearsPostCalc(accYears,yearsToCalc),storage_techs(techs),vintage,commodity)
    ...
    - storage_level.l(timeModelToCalc--1,nodesModelToCalc,yearsToCalc,storage_techs,vintage,commodity)
        $(not storage_reservoirParam(nodesModelToCalc,yearsToCalc,storage_techs,"nonCircular"))
    - storage_level.l(timeModelToCalc-1,nodesModelToCalc,yearsToCalc,storage_techs,vintage,commodity)
        $(storage_reservoirParam(nodesModelToCalc,yearsToCalc,storage_techs,"nonCircular"))
    - (storage_reservoirParam(nodesModelToCalc,yearsToCalc,storage_techs,"initialLevel")
        * storage_sizeParam(storage_techs,vintage,commodity,"size")
        * storage_unitsTotal.l(nodesModelToCalc,yearsToCalc,storage_techs,vintage))
        $(storage_reservoirParam(nodesModelToCalc,yearsToCalc,storage_techs,"nonCircular")
            and ord(timeModelToCalc)=1)
