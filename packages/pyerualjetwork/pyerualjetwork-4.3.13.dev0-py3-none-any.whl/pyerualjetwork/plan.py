...
def learner(x_train, y_train, optimizer, fit_start=True, gen=None, batch_size=1, pop_size=None,
    ...
    Args:
        ...
        weight_evolve (bool, optional): Activation combinations already optimizes by planeat genetic search algorithm. Should the weight parameters also evolve or should the weights be determined according to the aggregating learning principle of the PLAN algorithm? Default: False (PLAN)
