...
def generate_qa_from_named_files(
    ...
    :param fraction: (float) - Fraction of most viewed Twikis to use for generation (ie 0.05 for top 5%). Will always start from the most viewed Twiki and work down.
    :param model: (str) - What model to use for qa pair generation. **MUST BE A VALID OPENAI MODEL** and **OPENAI_API_KEY** environment variable must be set!
