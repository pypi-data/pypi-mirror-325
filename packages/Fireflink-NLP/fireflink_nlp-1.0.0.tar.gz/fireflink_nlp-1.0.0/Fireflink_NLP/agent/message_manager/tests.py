...
from Fireflink_NLP.agent.prompts import SystemPrompt
from Fireflink_NLP.agent.views import ActionResult
from Fireflink_NLP.browser.views import BrowserState, TabInfo
from Fireflink_NLP.dom.views import DOMElementNode, DOMTextNode
...
def test_token_overflow_handling_with_real_flow(message_manager: MessageManager, max_tokens):
	...
	for i in range(200):  # Simulate 40 steps of interaction
		...
		from Fireflink_NLP.agent.views import AgentBrain, AgentOutput
