...
from ..environments import runtime_env, NotebookRuntimeEnvironment, SnowbookEnvironment, HexEnvironment, IPythonEnvironment
...
class Spinner:
    ...
    def __init__(
        ...
        self.is_jupyter = isinstance(runtime_env, IPythonEnvironment)
    ...
    def update(self, message:str|None=None, color:str|None=None, file:TextIO|None=None, starting=False):
        ...
        if self.is_jupyter:
            ...
            if (file or sys.stdout).isatty() or self.in_notebook:
