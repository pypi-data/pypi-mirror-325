...
class AVFProcessorTestCase(unittest.TestCase):
    ...
    def test_processor_vcf_writer(self):
        ...
        print(bframe.data)
        print(bframe.data["chr7:21784210insG"])
        self.assertEqual(str(bframe.data["chr7:21784210insG"]["variant_data"]["POS_hg19"]), '21784210', "")
        ...
        self.assertEqual(str(bframe.data["chr7:21744592insG"]["info_features"]["POS_hg38"]), '21744592', "")
        self.assertEqual(len(bframe.data),97,"")
