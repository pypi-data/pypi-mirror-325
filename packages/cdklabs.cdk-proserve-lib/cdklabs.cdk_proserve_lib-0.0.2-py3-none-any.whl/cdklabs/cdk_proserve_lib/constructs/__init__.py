...
from ..interfaces import (
    AwsCustomResourceLambdaConfiguration as _AwsCustomResourceLambdaConfiguration_64fb0e80,
    LambdaConfiguration as _LambdaConfiguration_618c7638,
)
...
class Ec2ImageBuilderGetImage(
    ...
    def __init__(
        ...
        *,
        ...
        lambda_configuration: typing.Optional[typing.Union[_AwsCustomResourceLambdaConfiguration_64fb0e80, typing.Dict[builtins.str, typing.Any]]] = None,
    ) -> None:
        '''(experimental) Retrieves an EC2 Image Builder image build version.
...
class Ec2ImageBuilderGetImageProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(lambda_configuration, dict):
            lambda_configuration = _AwsCustomResourceLambdaConfiguration_64fb0e80(**lambda_configuration)
        if __debug__:
    ...
    def lambda_configuration(
        self,
    ) -> typing.Optional[_AwsCustomResourceLambdaConfiguration_64fb0e80]:
        '''(experimental) Optional Lambda configuration settings.

        :stability: experimental
        '''
        result = self._values.get("lambda_configuration")
        return typing.cast(typing.Optional[_AwsCustomResourceLambdaConfiguration_64fb0e80], result)
...
class Ec2ImageBuilderStart(
    ...
    def __init__(
        ...
        *,
        ...
        lambda_configuration: typing.Optional[typing.Union[_LambdaConfiguration_618c7638, typing.Dict[builtins.str, typing.Any]]] = None,
...
class Ec2ImageBuilderStartProps:
    def __init__(
        ...
        *,
        ...
        '''
        if isinstance(lambda_configuration, dict):
            lambda_configuration = _LambdaConfiguration_618c7638(**lambda_configuration)
    ...
    @builtins.property
    def lambda_configuration(self) -> typing.Optional[_LambdaConfiguration_618c7638]:
        '''(experimental) Optional Lambda configuration settings.

        :stability: experimental
        '''
        result = self._values.get("lambda_configuration")
        return typing.cast(typing.Optional[_LambdaConfiguration_618c7638], result)
...
class Ec2ImagePipeline(
    ...
    class Component(enum.Enum):
        ...
        '''(experimental) Installs Amazon EKS-optimized Windows artifacts for Amazon EKS version 1.30. This includes kubelet version 1.30.2, containerd version 1.7.14, and CSI Proxy version 1.1.2.
