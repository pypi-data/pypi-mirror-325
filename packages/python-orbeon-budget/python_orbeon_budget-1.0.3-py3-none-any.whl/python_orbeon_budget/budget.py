...
class Budget(canvas.Canvas):
    ...
    def watermark(self):
        ...
        x_position = (self.largura - watermark_width) / 2
        y_position = (self.altura - watermark_height) / 2
    ...
    def header(self):
        ...
        self.drawImage(ImageReader(BytesIO(logo)), x_logo, y_logo, width=width_target, height=height_target)
    ...
    def customer(self):
        ...
        if customer:
            company = customer.get('company', None)
            if company:
    ...
    def customer_company(self, company):
        max_length = 45
        ...
        if responsible:
            self.customer_company_responsible(responsible)

    def customer_company_responsible(self, responsible):
        max_length = 45
        self.current_height = self.current_height - 20
    ...
    def customer_person(self, person):
        ...
        self.current_height = self.current_height - 10
        self.line(50, self.current_height, self.width - 50, self.current_height)
        responsible = person.get('responsible', None)
        if responsible:
            self.customer_company_responsible(responsible)
    ...
    def product_total(self):
        ...
        self.drawRightString(self.largura - 50, self.current_height, total)
        self.current_height = self.current_height - 10
        self.line(50, self.current_height, self.largura - 50, self.current_height)

    def condition_title(self):
        self.current_height -= 35
        self.setFont(self.main_font, 18)
