# Generated by Django 4.2.17 on 2025-01-06 21:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(blank=True, db_index=True, default=uuid.uuid4, null=True, unique=True, verbose_name='UUID')),
                ('user_id', models.BigIntegerField(db_column='user_id', db_index=True, verbose_name='用户ID')),
                ('user_uuid', models.UUIDField(blank=True, db_index=True, null=True, unique=True, verbose_name='用户UUID')),
                ...
                ('ip', models.GenericIPAddressField(blank=True, default='192.168.0.100', null=True, verbose_name='网络IP')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=255, null=True, verbose_name='类别名称')),
                ...
                ('need_auth', models.BooleanField(blank=True, help_text='类别是否登录后才能查看', null=True, verbose_name='需要登录可见')),
                ('sort', models.IntegerField(blank=True, help_text='默认排序为升序', null=True, verbose_name='排序')),
                ('disable', models.BooleanField(blank=True, null=True, verbose_name='是否禁用')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.IntegerField(blank=True, default=0, help_text='如果是私人标签则不为空，如果为0代表公域标签。', null=True, verbose_name='用户ID')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, verbose_name='ID')),
                ('tag', models.ForeignKey(blank=True, db_column='tag_id', db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='xj_thread.threadtag', verbose_name='标签ID')),
                ('thread', models.ForeignKey(blank=True, db_column='thread_id', db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='thread', to='xj_thread.thread', verbose_name='信息ID')),
                ('statistic', models.ForeignKey(blank=True, db_column='statistic_id', db_constraint=False, help_text='统计关联', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='thread_statistic', to='xj_thread.threadstatistic', verbose_name='统计ID')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(max_length=50, unique=True, verbose_name='分类标识值')),
                ('name', models.CharField(blank=True, max_length=255, null=True, verbose_name='分类名称')),
                ('icon', models.CharField(blank=True, max_length=255, null=True, verbose_name='图标')),
                ('config', models.JSONField(blank=True, default=dict, null=True, verbose_name='前端配置')),
                ('description', models.CharField(blank=True, max_length=255, null=True, verbose_name='描述')),
                ('sort', models.IntegerField(blank=True, help_text='默认排序为升序', null=True, verbose_name='排序')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(blank=True, max_length=255, null=True, verbose_name='字段标签')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_1', models.FloatField(blank=True, null=True, verbose_name='自定义字段_1 (数字)')),
                ('field_2', models.FloatField(blank=True, null=True, verbose_name='自定义字段_2 (数字)')),
                ('field_3', models.FloatField(blank=True, null=True, verbose_name='自定义字段_3 (数字)')),
                ('field_4', models.FloatField(blank=True, null=True, verbose_name='自定义字段_4 (数字)')),
                ('field_5', models.FloatField(blank=True, null=True, verbose_name='自定义字段_5 (数字)')),
                ('field_6', models.FloatField(blank=True, null=True, verbose_name='自定义字段_6 (数字)')),
                ('field_7', models.FloatField(blank=True, null=True, verbose_name='自定义字段_7 (数字)')),
                ('field_8', models.FloatField(blank=True, null=True, verbose_name='自定义字段_8 (数字)')),
                ('field_9', models.FloatField(blank=True, null=True, verbose_name='自定义字段_9 (数字)')),
                ('field_10', models.FloatField(blank=True, null=True, verbose_name='自定义字段_10 (数字)')),
                ('field_11', models.CharField(blank=True, max_length=1024, null=True, verbose_name='自定义字段_11 (文本)')),
                ('field_12', models.CharField(blank=True, max_length=1024, null=True, verbose_name='自定义字段_12 (文本)')),
                ('field_13', models.CharField(blank=True, max_length=1024, null=True, verbose_name='自定义字段_13 (文本)')),
                ('field_14', models.CharField(blank=True, max_length=1024, null=True, verbose_name='自定义字段_14 (文本)')),
                ('field_15', models.CharField(blank=True, max_length=1024, null=True, verbose_name='自定义字段_15 (文本)')),
                ('field_16', models.CharField(blank=True, max_length=1024, null=True, verbose_name='自定义字段_16 (文本)')),
                ('field_17', models.CharField(blank=True, max_length=1024, null=True, verbose_name='自定义字段_17 (文本)')),
                ('field_18', models.CharField(blank=True, max_length=1024, null=True, verbose_name='自定义字段_18 (文本)')),
                ('field_19', models.CharField(blank=True, max_length=1024, null=True, verbose_name='自定义字段_19 (文本)')),
                ('field_20', models.CharField(blank=True, max_length=1024, null=True, verbose_name='自定义字段_20 (文本)')),
