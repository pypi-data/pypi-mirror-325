...
class WordToText(BaseObj):
    """
    A class used to convert Word documents (.docx) to plain text.
    ...
    Methods:
    -------
    convert(filename: str, data_bytes: bytes) -> str
    ...
    def __init__(self) -> None:
        ...
        None
        """
        super(WordToText, self).__init__()

    def convert(self, filename: str, data_bytes: bytes) -> str:
        """
        Converts a Word document to plain text.
