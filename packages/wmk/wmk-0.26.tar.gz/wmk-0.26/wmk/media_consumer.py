...
class MediaConsumer(EventDispatcher):
            ...
            with cls._init_lock:
                if not cls._gst_initialized:  # Double-check pattern
                    try:
                        ...
                        raise RuntimeError("GStreamer dependencies not found. Please install gstreamer and gi packages.") from e

    def __init__(
        self,
        audio_node_id: Optional[int] = None,
        video_node_id: Optional[int] = None,
    ...
    def _find_defualt_audio_node(self, name: str) -> Optional[int]:
        """
