...
_UiActionuiElement = Literal['actionBar'] | Literal['logo'] | Literal['social'] | Literal['infocard'] | Literal['language'] | Literal['settings'] | Literal['map'] | Literal['popup'] | Literal['profile'] | Literal['cinematicView'] | Literal['photo'] | Literal['videoCapture'] | Literal['mediaShare'] | Literal['ending'] | Literal['screenSharing'] | Literal['videoAvatars'] | Literal['hint'] | Literal['questHint'] | Literal['stats'] | Literal['report'] | Literal['devOptions'] | Literal['presentationBar'] | Literal['fullscreenVideo'] | Literal['forceLandscape'] | Literal['startButton'] | Literal['poll'] | Literal['textChatPreview'] | Literal['walletConnect'] | Literal['quest'] | Literal['mobileController'] | Literal['actionElements'] | Literal['actionBar/social'] | Literal['actionBar/emojis'] | Literal['actionBar/reactionsBar'] | Literal['actionBar/movements'] | Literal['actionBar/map'] | Literal['actionBar/settings'] | Literal['actionBar/photo'] | Literal['cinematicView/skip'] | Literal['fullscreenVideo/skip'] | Literal['social/assistant'] | Literal['social/chat'] | Literal['social/players'] | Literal['social/playerProfile/:playerId'] | Literal['settings/home'] | Literal['settings/about'] | Literal['settings/video'] | Literal['settings/controls'] | Literal['settings/streamDiffusion'] | Literal['settings/walletconnect']
""" The panel to target """
...
"""The values for the 'The panel to target' enum"""
_UIACTIONUIELEMENT_SETTINGS_SOLIDUS_STREAMDIFFUSION: Literal['settings/streamDiffusion'] = "settings/streamDiffusion"
"""The values for the 'The panel to target' enum"""
