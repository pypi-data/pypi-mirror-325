...
class AWSStorage:
    ...
    def save_file_to_storage(self, df, bucket_name, key, file_type='parquet', compression=None):
        """
        Saves a given DataFrame to an S3 destination in the specified format.
        ...
        Parameters:
            ...
            file_type (str, optional): The type of file to save ('parquet', 'csv', 'excel', 'json'). Defaults to 'parquet'.
        ...
        Example Usage:
            aws_service.save_file_to_s3(df, 'my-bucket', 'path/to/file.parquet', file_type='parquet', compression='GZIP')
        """
        supported_file_types = ['parquet', 'csv', 'excel', 'json']
