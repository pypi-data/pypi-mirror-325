...
class BCH(galois.BCH):
    ...
    def parity_decode_2chase(self, parity, list_dec=False, chase_depth=None, valid_k=None, **kwargs):
        ...
        valid_k (callable, optional): A function to validate the decoded codeword. 
            Must return a tuple with first element indicating if k is a valid singleton. Defaults to None.
