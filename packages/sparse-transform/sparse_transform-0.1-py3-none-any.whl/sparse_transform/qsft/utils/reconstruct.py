...
def singleton_detection_noiseless(U_slice: np.ndarray, **kwargs: Any) -> np.ndarray:
    ...
    Parameters:
    U_slice (np.ndarray): The WHT component of a subsampled bin, with element i corresponding to delay i.
    kwargs (Any): Additional keyword arguments.

    Returns:
    np.ndarray: Index of the corresponding right node, in binary form.
    """
    q = kwargs.get('q')
...
def singleton_detection_coded(k: np.ndarray, **kwargs: Any) -> Union[np.ndarray, List[np.ndarray]]:
    ...
    Parameters:
    k (np.ndarray): The WHT component of a subsampled bin, with element i corresponding to delay i.
    kwargs (Any): Additional keyword arguments.

    Returns:
    Union[np.ndarray, List[np.ndarray]]: Index of the corresponding right node, in binary form, if list decoding
    """
...
def singleton_detection_mle(U_slice: np.ndarray, **kwargs: Any) -> Tuple[np.ndarray, np.ndarray]:
    ...
    Returns:
    Tuple[np.ndarray, np.ndarray]: The index of the singleton and the set of signatures under the delays matrix D.
    """
...
def singleton_detection_nso(U_slice: np.ndarray, **kwargs: Any) -> np.ndarray:
    """
    ...
    Returns:
    np.ndarray: The index of the singleton.
    """
...
def singleton_detection_nso1(U_slice: np.ndarray, **kwargs: Any) -> np.ndarray:
    """
...
def singleton_detection_nso2(U_slice: np.ndarray, **kwargs: Any) -> np.ndarray:
    """
...
def singleton_detection(U_slice: np.ndarray, method_source: str = "identity", method_channel: str = "identity", **kwargs: Any) -> Union[np.ndarray, List[np.ndarray]]:
    ...
    Parameters:
    U_slice (np.ndarray): The relevant subsampled Fourier transform to be considered.
    method_source (str): Method of reconstruction for source coding.
    method_channel (str): Method of reconstruction for channel coding.
    kwargs (Any): Additional keyword arguments.

    Returns:
    Union[np.ndarray, List[np.ndarray]]: Value of the computed singleton index k.
    """
