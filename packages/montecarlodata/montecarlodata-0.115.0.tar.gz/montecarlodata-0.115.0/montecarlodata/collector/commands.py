...
def list_collectors(ctx, active_only):
    CollectorManagementService(
        ...
        command_name="collectors list_collectors",
        aws_wrapper=None,
...
def add_collector(ctx, no_prompt):
    CollectorManagementService(
        config=ctx["config"],
        mc_client=create_mc_client(ctx),
        command_name="collectors add_collector",
...
def get_template(ctx, aws_region, **kwargs):
    ...
    CollectorManagementService(
        config=ctx["config"],
        mc_client=create_mc_client(ctx),
        command_name="collectors get_template",
...
def open_link(ctx, aws_region, **kwargs):
    ...
    CollectorManagementService(
        config=ctx["config"],
        mc_client=create_mc_client(ctx),
        command_name="collectors open_link",
        aws_region_override=aws_region,
...
def deploy(ctx, aws_profile, aws_region, params, **kwargs):
    ...
    CollectorManagementService(
        config=ctx["config"],
        mc_client=create_mc_client(ctx),
        command_name="collectors deploy",
...
def upgrade(ctx, aws_profile, aws_region, params, update_infra, **kwargs):
    ...
    CollectorManagementService(
        config=ctx["config"],
        mc_client=create_mc_client(ctx),
        command_name="collectors upgrade",
        aws_profile_override=aws_profile,
        aws_region_override=aws_region,
...
def test_telnet(ctx, **kwargs):
    ...
    CollectorNetworkTestService(
        config=ctx["config"],
        command_name="collectors test_telnet",
...
def test_tcp_open(ctx, **kwargs):
    ...
    CollectorNetworkTestService(
        config=ctx["config"],
        command_name="collectors test_tcp_open",
...
def run_validations(ctx, **kwargs):
    failures = CollectorValidationService(
        config=ctx["config"],
        mc_client=create_mc_client(ctx),
        command_name="collectors run_validations",
