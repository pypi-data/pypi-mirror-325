...
class CommandParameter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "type", "required", "default"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommandParameter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommandParameter from a dict"""
        if obj is None:
            return None
