...
class CommandStep(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["step_id", "action", "parameters", "next_step", "condition"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommandStep from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommandStep from a dict"""
        if obj is None:
            return None
