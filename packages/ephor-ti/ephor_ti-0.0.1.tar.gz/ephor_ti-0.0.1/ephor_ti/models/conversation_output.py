...
class ConversationOutput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["conversation_id", "account_id", "project_id", "messages"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConversationOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConversationOutput from a dict"""
        if obj is None:
            return None
