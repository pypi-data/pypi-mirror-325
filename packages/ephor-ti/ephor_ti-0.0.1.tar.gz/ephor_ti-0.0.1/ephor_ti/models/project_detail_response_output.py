...
class ProjectDetailResponseOutput(BaseModel):
    """
    ProjectDetailResponseOutput
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectDetailResponseOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectDetailResponseOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "library": LibraryOutput.from_dict(obj["library"]) if obj.get("library") is not None else None,
            "users": obj.get("users"),
            ...
            "conversations": [ConversationOutput.from_dict(_item) for _item in obj["conversations"]] if obj.get("conversations") is not None else None,
