    ...
    def make_instance(self, include_optional) -> GetGifsById200Response:
        ...
        if include_optional:
            return GetGifsById200Response(
                data = [
                    testing_compose_deployment_v0_ti.models.gif.Gif(
                ...
                meta = testing_compose_deployment_v0_ti.models.meta.Meta(
                    msg = 'OK', 
                    response_id = '57eea03c72381f86e05c35d2', 
                    status = 200, ),
                pagination = testing_compose_deployment_v0_ti.models.pagination.Pagination(
                    count = 25, 
                    offset = 75, 
                    total_count = 250, )
            )
