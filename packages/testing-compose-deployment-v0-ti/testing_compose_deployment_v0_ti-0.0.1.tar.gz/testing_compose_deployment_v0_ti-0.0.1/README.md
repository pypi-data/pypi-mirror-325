# testing-compose-deployment-v0-ti
Giphy API
...
```python
import testing_compose_deployment_v0_ti
```
...
import testing_compose_deployment_v0_ti
from testing_compose_deployment_v0_ti.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to https://api.giphy.com/v1
# See configuration.py for a list of all supported configuration parameters.
configuration = testing_compose_deployment_v0_ti.Configuration(
...
with testing_compose_deployment_v0_ti.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = testing_compose_deployment_v0_ti.GifsApi(api_client)
