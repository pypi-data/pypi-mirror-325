        ...
        if (typeof target[prop] === 'function') {
            return new Proxy(target[prop], {
                apply: (methodTarget, _, args) => {
                    ...
                    const isPromiseLike = typeof (callResult === null || callResult === void 0 ? void 0 : callResult.then) === 'function' &&
                        typeof (callResult === null || callResult === void 0 ? void 0 : callResult.catch) === 'function';
...
window.addEventListener('message', event => {
    var _a;
    if (((_a = event.data) === null || _a === void 0 ? void 0 : _a.type) === 'SET_CHANNEL_ID') {
        window.octostarChannelId = event.data.channelId;
        console.log('PostRobot: received channelId', event.data.channelId);
    }
});
export const createRemoteApiHandle = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield retry(() => postRobot.send(octostarWindow, topic, params), {
            maxAttempts: 5,
            retryInterval: 2000,
        });
