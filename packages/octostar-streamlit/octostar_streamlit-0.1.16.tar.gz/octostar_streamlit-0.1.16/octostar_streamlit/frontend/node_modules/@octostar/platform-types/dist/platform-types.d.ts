 ...
 */
export declare type ContextMenuGroup = 'add' | 'addto' | 'copy' | 'edit' | 'transform' | 'general' | 'open' | 'danger' | 'tags' | 'relations' | 'search';
...
export declare interface Desktop extends DesktopSettings, WorkspaceChangeEmitter {
     ...
     * Opens a workspace.
     */
    openWorkspace: (ws: WorkspaceIdentifier, showTab?: boolean) => Promise<void>;
    /**
     ...
     */
    failedWorkspaceModal: Promise<OS_CONFIRM_MODAL_RESPONSE> | undefined;
    /**
 ...
 */
export declare type FilterDefinition = ProvidedFilterDefinition | PythonFilterDefinition | JavascriptFilterDefinition | SemanticallyBoundFilterDefinition;
...
/**
 * @beta
 * Type representing a Python file styler definition.
 */
export declare type PythonFileStylerDefinition = PythonType & FileCode;

/**
 * @beta
 * Type representing a Python file transform definition. Not yet supported.
 */
export declare type PythonFileTransformDefinition = PythonType & FileCode;

/**
 * @beta
 * Type representing a Python filter definition.
 */
export declare type PythonFilterDefinition = {
...
/**
 * @beta
 * Type representing an inline Python styler definition.
 */
export declare type PythonInlineStylerDefinition = PythonType & InlineCode;

/**
 * @beta
 * Type representing an inline Python transform definition.
 */
export declare type PythonInlineTransformDefinition = PythonType & InlineCode;

/**
 * @beta
 * Type representing a Python file transform definition.
 */
export declare type PythonType = {
 ...
 */
export declare type StylerDefinition = PythonFileStylerDefinition | PythonInlineStylerDefinition | JavascriptFileStylerDefinition | JavascriptInlineStylerDefinition;
 ...
 */
export declare type TransformDefinition = ProvidedTransformDefinition | HttpTransformDefinition | IframeTransformDefinition | PythonFileTransformDefinition | PythonInlineTransformDefinition | JavascriptFileTransformDefinition | JavascriptInlineTransformDefinition | NunjucksFileTransformDefinition | NunjucksInlineTransformDefinition | EmitEventTransformDefinition;
