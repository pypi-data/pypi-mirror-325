...
class PatchedmavenMavenRepository(object):
    ...
    def retain_repo_versions(self):
        """Gets the retain_repo_versions of this PatchedmavenMavenRepository.  # noqa: E501

        Retain X versions of the repository. Default is null which retains all versions.  # noqa: E501

        :return: The retain_repo_versions of this PatchedmavenMavenRepository.  # noqa: E501
        :rtype: int
        """
    ...
    def retain_repo_versions(self, retain_repo_versions):
        """Sets the retain_repo_versions of this PatchedmavenMavenRepository.

        Retain X versions of the repository. Default is null which retains all versions.  # noqa: E501

        :param retain_repo_versions: The retain_repo_versions of this PatchedmavenMavenRepository.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
