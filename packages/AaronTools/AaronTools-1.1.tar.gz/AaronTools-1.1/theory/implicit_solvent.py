...
KNOWN_GAUSSIAN_SOLVENTS = {
    ...
    "ONIOMPCM": _KNOWN_GAUSSIAN_SOLVENTS,
    "ONIOMPCM=X": _KNOWN_GAUSSIAN_SOLVENTS,
    "ONIOMPCM=A": _KNOWN_GAUSSIAN_SOLVENTS,
    "ONIOMPCM=B": _KNOWN_GAUSSIAN_SOLVENTS,
    "ONIOMPCM=C": _KNOWN_GAUSSIAN_SOLVENTS,
}
