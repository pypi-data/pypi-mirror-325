...
class BaseClient(AioThing):
    ...
    async def delete(self, url: str = "", *args, **kwargs) -> typing.Any:
        return await self.request("delete", url, *args, **kwargs)

    async def get(self, url: str = "", *args, **kwargs) -> typing.Any:
        return await self.request("get", url, *args, **kwargs)

    async def head(self, url: str = "", *args, **kwargs) -> typing.Any:
        return await self.request("head", url, *args, **kwargs)

    async def post(self, url: str = "", *args, **kwargs) -> typing.Any:
        return await self.request("post", url, *args, **kwargs)

    async def put(self, url: str = "", *args, **kwargs) -> typing.Any:
