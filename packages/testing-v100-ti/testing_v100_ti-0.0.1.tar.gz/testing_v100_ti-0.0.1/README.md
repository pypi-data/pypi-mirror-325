...
import testing_v100_ti
from testing_v100_ti.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to https://api.giphy.com/v1
# See configuration.py for a list of all supported configuration parameters.
configuration = testing_v100_ti.Configuration(
...
with testing_v100_ti.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = testing_v100_ti.GifsApi(api_client)
