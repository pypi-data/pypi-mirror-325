...
class VariableStatistics(object):
    ...
    def init(self, df: dataframe.DataFrame):
        ...
        for stats_name in stats_pd_df.columns:
        ...
        self.high_cardinality_pairs = get_pairs(list(temp_pd_df[stats_tbl_id]), list(temp_pd_df[target_column_name]))
        ...
        self.highly_skewed_pairs = get_pairs(list(temp_pd_df[stats_tbl_id]), list(temp_pd_df[target_column_name]))
...
class DatasetReportBuilder(object):
    ...
    def generate_html_report(self, filename):
        ...
        filename : str
            Html file name.
        """
        EmbeddedUI.generate_file('{}_dataset_report.html'.format(filename), self.get_report_html())
