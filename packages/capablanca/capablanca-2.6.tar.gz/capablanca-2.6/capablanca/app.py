...
def main():
    ...
    helper = argparse.ArgumentParser(prog="cover", description='Estimating the Minimum Vertex Cover with an approximation factor of 3/2 for an undirected graph encoded as a Boolean adjacency matrix stored in a file.')
    ...
    helper.add_argument('--version', action='version', version='%(prog)s 2.6')
