...
class ClientconfigFrontendConfigResponse(object):
    ...
    def __init__(self, cluster_create_enabled=None, google_client_id=None, google_recaptcha_site_key=None, model_enabled=None, serverless_service_enabled=None, vessl_storage_enabled=None, local_vars_configuration=None):  # noqa: E501
