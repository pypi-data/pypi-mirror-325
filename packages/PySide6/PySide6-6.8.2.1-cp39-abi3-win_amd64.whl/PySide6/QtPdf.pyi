...
class QPdfLink(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, other: PySide6.QtPdf.QPdfLink, /, *, valid: bool | None= ..., page: int | None= ..., location: PySide6.QtCore.QPointF | None= ..., zoom: float | None= ..., url: PySide6.QtCore.QUrl | None= ..., contextBefore: str | None= ..., contextAfter: str | None= ..., rectangles: typing.Sequence[PySide6.QtCore.QRectF] | None= ...) -> None: ...
    @typing.overload
    def __init__(self, /, *, valid: bool | None= ..., page: int | None= ..., location: PySide6.QtCore.QPointF | None= ..., zoom: float | None= ..., url: PySide6.QtCore.QUrl | None= ..., contextBefore: str | None= ..., contextAfter: str | None= ..., rectangles: typing.Sequence[PySide6.QtCore.QRectF] | None= ...) -> None: ...
...
class QPdfSelection(Shiboken.Object):
    ...
    def __init__(self, other: PySide6.QtPdf.QPdfSelection, /, *, valid: bool | None= ..., bounds: typing.Sequence[PySide6.QtGui.QPolygonF] | None= ..., boundingRectangle: PySide6.QtCore.QRectF | None= ..., text: str | None= ..., startIndex: int | None= ..., endIndex: int | None= ...) -> None: ...
