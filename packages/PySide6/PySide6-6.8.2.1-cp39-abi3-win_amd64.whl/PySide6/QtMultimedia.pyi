...
class QCameraDevice(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, other: PySide6.QtMultimedia.QCameraDevice, /, *, id: PySide6.QtCore.QByteArray | None= ..., description: str | None= ..., isDefault: bool | None= ..., position: PySide6.QtMultimedia.QCameraDevice.Position | None= ..., videoFormats: typing.Sequence[PySide6.QtMultimedia.QCameraFormat] | None= ..., correctionAngle: PySide6.QtMultimedia.QtVideo.Rotation | None= ...) -> None: ...
    @typing.overload
    def __init__(self, /, *, id: PySide6.QtCore.QByteArray | None= ..., description: str | None= ..., isDefault: bool | None= ..., position: PySide6.QtMultimedia.QCameraDevice.Position | None= ..., videoFormats: typing.Sequence[PySide6.QtMultimedia.QCameraFormat] | None= ..., correctionAngle: PySide6.QtMultimedia.QtVideo.Rotation | None= ...) -> None: ...
...
class QMediaDevices(PySide6.QtCore.QObject):
    ...
    def __init__(self, /, parent: PySide6.QtCore.QObject | None= ..., *, audioInputs: typing.Sequence[PySide6.QtMultimedia.QAudioDevice] | None= ..., audioOutputs: typing.Sequence[PySide6.QtMultimedia.QAudioDevice] | None= ..., videoInputs: typing.Sequence[PySide6.QtMultimedia.QCameraDevice] | None= ..., defaultAudioInput: PySide6.QtMultimedia.QAudioDevice | None= ..., defaultAudioOutput: PySide6.QtMultimedia.QAudioDevice | None= ..., defaultVideoInput: PySide6.QtMultimedia.QCameraDevice | None= ...) -> None: ...
