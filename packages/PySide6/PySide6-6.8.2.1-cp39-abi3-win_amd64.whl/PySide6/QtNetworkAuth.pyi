...
class QAbstractOAuth2(PySide6.QtNetworkAuth.QAbstractOAuth):
    ...
    @typing.overload
    def __init__(self, manager: PySide6.QtNetwork.QNetworkAccessManager, /, parent: PySide6.QtCore.QObject | None= ..., *, scope: str | None= ..., userAgent: str | None= ..., clientIdentifierSharedKey: str | None= ..., state: str | None= ..., expiration: PySide6.QtCore.QDateTime | None= ..., refreshToken: str | None= ...) -> None: ...
    @typing.overload
    def __init__(self, /, parent: PySide6.QtCore.QObject | None= ..., *, scope: str | None= ..., userAgent: str | None= ..., clientIdentifierSharedKey: str | None= ..., state: str | None= ..., expiration: PySide6.QtCore.QDateTime | None= ..., refreshToken: str | None= ...) -> None: ...
