...
class QGeoRoute(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, other: PySide6.QtLocation.QGeoRoute, /, *, routeId: str | None= ..., bounds: PySide6.QtPositioning.QGeoRectangle | None= ..., travelTime: int | None= ..., distance: float | None= ..., path: typing.Sequence[PySide6.QtPositioning.QGeoCoordinate] | None= ..., routeLegs: typing.Sequence[PySide6.QtLocation.QGeoRoute] | None= ..., extendedAttributes: typing.Dict[str, typing.Any] | None= ..., legIndex: int | None= ..., overallRoute: PySide6.QtLocation.QGeoRoute | None= ..., segmentsCount: int | None= ..., segments: typing.Sequence[PySide6.QtLocation.QGeoRouteSegment] | None= ...) -> None: ...
    @typing.overload
    def __init__(self, /, *, routeId: str | None= ..., bounds: PySide6.QtPositioning.QGeoRectangle | None= ..., travelTime: int | None= ..., distance: float | None= ..., path: typing.Sequence[PySide6.QtPositioning.QGeoCoordinate] | None= ..., routeLegs: typing.Sequence[PySide6.QtLocation.QGeoRoute] | None= ..., extendedAttributes: typing.Dict[str, typing.Any] | None= ..., legIndex: int | None= ..., overallRoute: PySide6.QtLocation.QGeoRoute | None= ..., segmentsCount: int | None= ..., segments: typing.Sequence[PySide6.QtLocation.QGeoRouteSegment] | None= ...) -> None: ...
...
class QGeoRouteSegment(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, other: PySide6.QtLocation.QGeoRouteSegment, /, *, travelTime: int | None= ..., distance: float | None= ..., path: typing.Sequence[PySide6.QtPositioning.QGeoCoordinate] | None= ..., maneuver: PySide6.QtLocation.QGeoManeuver | None= ...) -> None: ...
    @typing.overload
    def __init__(self, /, *, travelTime: int | None= ..., distance: float | None= ..., path: typing.Sequence[PySide6.QtPositioning.QGeoCoordinate] | None= ..., maneuver: PySide6.QtLocation.QGeoManeuver | None= ...) -> None: ...
...
class QPlaceIcon(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, other: PySide6.QtLocation.QPlaceIcon, /, *, parameters: typing.Dict[str, typing.Any] | None= ..., manager: PySide6.QtLocation.QPlaceManager | None= ...) -> None: ...
    @typing.overload
    def __init__(self, /, *, parameters: typing.Dict[str, typing.Any] | None= ..., manager: PySide6.QtLocation.QPlaceManager | None= ...) -> None: ...
