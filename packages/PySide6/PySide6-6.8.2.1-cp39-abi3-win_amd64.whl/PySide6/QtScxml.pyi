...
class QScxmlStateMachine(PySide6.QtCore.QObject):
    ...
    def __init__(self, metaObject: PySide6.QtCore.QMetaObject, /, parent: PySide6.QtCore.QObject | None= ..., *, running: bool | None= ..., initialized: bool | None= ..., dataModel: PySide6.QtScxml.QScxmlDataModel | None= ..., initialValues: typing.Dict[str, typing.Any] | None= ..., invokedServices: typing.Sequence[PySide6.QtScxml.QScxmlInvokableService] | None= ..., sessionId: str | None= ..., name: str | None= ..., invoked: bool | None= ..., parseErrors: typing.Sequence[PySide6.QtScxml.QScxmlError] | None= ..., loader: PySide6.QtScxml.QScxmlCompiler.Loader | None= ..., tableData: PySide6.QtScxml.QScxmlTableData | None= ...) -> None: ...
