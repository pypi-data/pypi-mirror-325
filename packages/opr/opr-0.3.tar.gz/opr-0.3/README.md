...
- Run `pip install opr==0.3`
### Source code
- Download [Version 0.3](https://github.com/openscilab/opr/archive/v0.3.zip) or [Latest Source](https://github.com/openscilab/opr/archive/dev.zip)
- Run `pip install .`
