...
import giphy_alpha_testing_ti
from giphy_alpha_testing_ti.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to https://api.giphy.com/v1
# See configuration.py for a list of all supported configuration parameters.
configuration = giphy_alpha_testing_ti.Configuration(
...
with giphy_alpha_testing_ti.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = giphy_alpha_testing_ti.GifsApi(api_client)
