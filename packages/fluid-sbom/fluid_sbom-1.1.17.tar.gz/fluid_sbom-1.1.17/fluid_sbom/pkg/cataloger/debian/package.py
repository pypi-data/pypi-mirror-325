...
from fluid_sbom.pkg.cataloger.debian.model import DpkgDBEntry, DpkgFileRecord
...
def _set_health_metadata(
    ...
    authors = package.metadata.maintainer if hasattr(package.metadata, "maintainer") else None
