import requests
from quikdb.utils.constants import SERVER_URL
from quikdb.file_types import LogStatus, StatusCode

def deactivate_project(project_id: str, payload: str, access_token: str):
    """
    Function to encrypt user data by making a POST request to /v/p/projectId/activate.
    """
    try:
        url = f"{SERVER_URL}/v/p/{project_id}/activate"  # Same endpoint as activate
        headers = {
