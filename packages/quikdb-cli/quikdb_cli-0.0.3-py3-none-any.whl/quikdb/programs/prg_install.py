...
# import readline
from quikdb.utils.toolbox import Tools
from quikdb.controllers import (
    authenticate_principal,
    deploy_to_local,
    get_principal,
    install_dfx
)
from quikdb.http import authenticate_cli, encrypt_user_data, upload_project_code, activate_project  # Adjust module names as needed
