// Serialization with "back-references" of an incrementally built KLVM structure
...
/// The state to allow incrementally serializing KLVM structures with back-refs
