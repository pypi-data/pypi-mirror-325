...
class ValueLex:
    ...
    def __init__(self, symbols, osname="'nt'"): pass
...
class EnvLex:
    ...
    def t_INITIAL_error(self, t): pass
...
def parse(text, environ={'PROXY_FOR': 'os.environ'}, osname="'nt'"): pass
