...
def py2melCmd(pyObj, commandName='None', register='True', includeFlags='None', excludeFlags='[]',
              includeFlagArgs='None', excludeFlagArgs='{}', nonUniqueName="'warn'", invalidName="'warn'"):
    """
