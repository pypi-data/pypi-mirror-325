...
class Parser(object):
    ...
    def p_error(self, p): pass

    def parse(self, data, **kwargs): pass

    def t_error(self, t): pass
...
class Parsed(ProxyUni):
    ...
    @classmethod
    def classparse(cls, data, **kwargs): pass
    ...
    @classmethod
    def getParserClass(cls, parsername): pass
...
def _printClassTree(cls): pass


def isParserClass(x): pass


def _getTokenPatterns(parsercls): pass
