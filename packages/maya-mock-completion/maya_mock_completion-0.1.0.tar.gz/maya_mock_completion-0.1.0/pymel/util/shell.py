...
def executableOutput(exeAndArgs, convertNewlines='True', stripTrailingNewline='True', returnCode='False', input='None',
                     **kwargs):
    """
...
def shellOutput(shellCommand, convertNewlines='True', stripTrailingNewline='True', returnCode='False', input='None',
                **kwargs):
    """
