...
class CollectionStaticSelectionWidget(QListWidget):
    ...
    def __init__(self, selector, parent='None'): pass
    ...
    def onDoubleClick(self, item): pass
    ...
    def removeFilteredObjects(self): pass

    def removeMissingObjects(self): pass
    ...
    def selectFilteredObjects(self): pass

    def selectMembers(self): pass

    def selectMissingObjects(self): pass

    def setSortingEnabled(self, enabled): pass

    def sizeHintForRow(self, row): pass
