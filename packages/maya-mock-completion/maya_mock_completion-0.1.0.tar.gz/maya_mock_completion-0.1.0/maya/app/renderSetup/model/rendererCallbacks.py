...
class NodeExporter(object):
    ...
    def decode(self, encodedData): pass

    def encode(self): pass

    def setPlugsToIgnore(self, plugsToIgnore): pass

    def warnPlugsToIgnore(self, value): pass
...
class BasicNodeExporter(NodeExporter):
    ...
    def getNodes(self): pass

    def setNodes(self, nodes): pass


def getCallbacks(*args): pass


def unregisterCallbacks(renderer, callbacksType='None'): pass


def registerCallbacks(renderer, callbacksType, callbacks): pass
