...
class ConnectionOverride(override.AbsOverride):
    ...
    def setSource(*args, **kwargs): pass
...
class ApplyConnectionOverride(applyOverride.LeafClass, applyOverride.ApplyOverride):
    ...
    def finalize(self, ovrValuePlug): pass

    def getNextPlug(self): pass

    def getOriginalPlug(self): pass

    def getPrevPlug(self): pass
...
class MaterialOverride(ConnectionOverride):
    ...
    def setMaterial(*args, **kwargs): pass
...
class ShaderOverride(ConnectionOverride):
    ...
    def setShader(*args, **kwargs): pass
...
def setRestoringOriginal(restoringOriginal): pass


def isRestoringOriginal(): pass
