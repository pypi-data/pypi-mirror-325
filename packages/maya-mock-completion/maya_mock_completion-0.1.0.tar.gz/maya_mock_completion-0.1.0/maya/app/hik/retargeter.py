...
class RetargUtils:
    ...
    @staticmethod
    def disconnectIfConnected(src, dest): pass
    ...
    @staticmethod
    def eulerValToComposeMat(euler, rotateOrder): pass

    @staticmethod
    def getAttr(plug): pass
    ...
    @staticmethod
    def getWorldPositionUsingRP(nodeName): pass
    ...
    @staticmethod
    def inverseQuat(quat): pass

    @staticmethod
    def isAnimCurve(object): pass

    @staticmethod
    def isLocked(node, attr): pass
    ...
    @staticmethod
    def matrixToList(matrixVal): pass
    ...
    @staticmethod
    def multQuatConnection(quat1, quat2): pass
    ...
    @staticmethod
    def quatToEuler(quat, rotateOrder): pass
    ...
    @staticmethod
    def removeAllConnections(nodes): pass

    @staticmethod
    def setAttr(plug, val): pass

    @staticmethod
    def setAttrIfNotNone(attr, val): pass
...
class HIKRetargeter:
    ...
    def destinationAttrs(self): pass
    ...
    def getDestination(self): pass

    def getMapping(self, bodyPart, type, linkNum='0'): pass

    def getMappingIds(self): pass

    def getMappingKey(self, bodyPart, type, linkNum='0'): pass
    ...
    def removeMapping(self, bodyPart, type, linkNum='0'): pass

    def setDestination(self, destination): pass

    def setMapping(self, bodyPart, destRig, type, retargeter, id, linkNum='0'): pass
    ...
    @staticmethod
    def createDefaultMapping(source, dest, bodyPart, destRig, type, id, linkNum='0'): pass
...
class DefaultRetargeter:
    ...
    def __init__(self, matSource='None', destRig='None', destSkel='None', type='None', id='-1', body='None'): pass
    ...
    def getDestinationRig(self): pass
...
class MappedRetargeter:
    ...
    def getRetargeter(self): pass

    def setRetargeter(self, retargeter): pass
