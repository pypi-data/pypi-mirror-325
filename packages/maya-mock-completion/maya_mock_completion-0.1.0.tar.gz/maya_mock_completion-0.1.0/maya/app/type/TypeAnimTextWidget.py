...
class AnimTextQTreeWidgetExtend(QtWidgets.QTreeWidget):
    def __init__(self, node, parent='None'): pass

    def addItem(self, frame, name): pass

    def addItemAction(self): pass

    def deleteItems(self): pass

    def eventFilter(self, source, event): pass

    def mousePressEvent(self, event): pass

    def onChanged(self): pass

    def openMenu(self, point): pass
...
def build_qt_widget(lay, node): pass


def update_qt_widget(layout, node): pass
