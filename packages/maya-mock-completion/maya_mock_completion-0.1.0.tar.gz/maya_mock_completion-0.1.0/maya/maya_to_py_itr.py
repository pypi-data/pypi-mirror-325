...
class PyDagItr(MayaToPyItr):
    ...
    def __init__(self,
                 mit_dag='"<maya.OpenMaya.MItDag; proxy of <Swig Object of type \'MItDag *\' at 0x000002422C126B70> >"'): pass
...
class PyDepNodesItr(PyDepGraphItr):
    ...
    def __init__(self,
                 mit_dependency_nodes='"<maya.OpenMaya.MItDependencyNodes; proxy of <Swig Object of type \'MItDependencyNodes *\' at 0x000002422C126D20> >"',
                 filter='0', miterator_type='None'):
        """
