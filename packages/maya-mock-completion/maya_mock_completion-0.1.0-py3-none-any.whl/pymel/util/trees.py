...
class MetaTree(type):
    ...
    def __repr__(cls): pass

    def __str__(cls): pass

    def __unicode__(cls): pass
...
class IndexedFrozenTree(object):
    ...
    def elementKey(self, element): pass
    ...
    def isElement(self): pass

    def issubtree(self, other): pass
...
class IndexedTree(object):
    ...
    def __delitem__(self, element): pass
...
def isSequence(x): pass


def isMutableTree(x): pass
