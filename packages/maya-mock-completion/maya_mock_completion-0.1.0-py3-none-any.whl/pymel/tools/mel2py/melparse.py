...
class Token(str):
    ...
    def __getslice__(self, start, end): pass

    @staticmethod
    def __new__(cls, val, type, lineno='None', **kwargs): pass
...
class MelParser(object):
    ...
    def build(self, rootModule='None', pymelNamespace="''", verbosity='0', addPymelImport='True',
              expressionsOnly='False', forceCompatibility='True', parentData='None'): pass
...
class Comment(object):
    ...
    def leadingSpace(self): pass

    def withLeadingSpace(self): pass

    @classmethod
    def join(cls, comments, stripCommonSpace='False'): pass
...
class ArrayToken(Token):
    @staticmethod
    def __new__(cls, val, type, size, lineno='None', **kwargs): pass
...
def merge_assignment_spillover(t, curr_lineno, title="''"): pass
...
def format_singleline_comments(comments): pass
...
def store_assignment_spillover(token, t): pass
...
def fileInlist(file, fileList): pass
...
def format_command(command, args, t): pass
...
def append_comments(t, funcname="''"): pass
...
def getModuleBasename(script): pass
...
def format_multiline_string_comment(comments): pass
...
def format_held_comments(t, funcname="''"): pass
...
def findModule(moduleName): pass
...
def assemble(t, funcname, separator="''", tokens='None', matchFormatting='False'): pass
...
def format_comments(comments): pass
...
_outputdir = r'c:\users\paulm\appdata\local\temp'
