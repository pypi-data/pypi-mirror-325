...
class MergePolicy(object):
    ...
    def __init__(self, getFn, createFn, mergeType, prependToName): pass

    def create(self, dict, typeName): pass
...
def isRenderSetupTemplate(encodedData): pass
...
def _isRenderSetup(encodedData): pass
