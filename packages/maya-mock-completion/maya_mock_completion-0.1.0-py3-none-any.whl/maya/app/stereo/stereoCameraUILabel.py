...
class UILabel:
    ...
    def __init__(self, label='None', annotation='None', image='None', command='None',
                 command_pack="'<function pack_cmd>'", command_args='[]', command_keywords='{}', option_box='False',
                 check_box="''", disabled='False', radio_cb='[]', enable_cb='[]', divider_label='None'): pass

    def annotation(self): pass

    def check_box(self): pass

    def command(self): pass

    def command_option(self): pass

    def divider_label(self): pass
...
class UILabelGroup(UILabel):
    def __init__(self, label, items, radioGroup='False'): pass

    def items(self): pass

    def postMenuCommand(self): pass

    def radioGroup(self): pass
