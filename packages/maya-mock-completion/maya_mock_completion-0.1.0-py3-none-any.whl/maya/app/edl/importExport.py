...
class Importer(ImportExport):
    ...
    def setStartFrameOverride(self, frame): pass


def getTimeCode(): pass
...
def videoClipCompare(a, b): pass


def audioClipCompare(a, b): pass


def _getValidClipObjectName(clipName, isVideo): pass
...
def _nameToNode(name): pass


def _setTimeCode(timecode): pass
