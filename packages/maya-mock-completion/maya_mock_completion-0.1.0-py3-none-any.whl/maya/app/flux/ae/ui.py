...
class LayoutInterface(object):
    ...
    def addWidget(self, widget, stretchFactor='0', alignment='0'): pass

    def getFullName(self): pass

    def resizeDownstream(self): pass

    def resizeUpstream(self): pass

    def setAsMelParent(self): pass

    @staticmethod
    def addMethod(obj, methodName): pass

    @staticmethod
    def wrap(obj, layoutType): pass
...
class IndentLayout(QtWidgets.QWidget):
    def __init__(self, name="''", parent='None', autoStretch='True'): pass
...
class ToolButton(fui.ImageButton):
    def __init__(self, imageName, **kwargs): pass

    staticMetaObject = None


class VerticalLayout(QtWidgets.QWidget):
    def __init__(self, offset='0', height='None', parent='None'): pass
...
class TabLayout(QtWidgets.QTabWidget):
    ...
    def addTabNamed(self, widget, name): pass

    def currentTabChanged(self, index): pass
...
class RadioImageGroup(QtWidgets.QWidget):
    def __init__(self, icons, currentIndex='0', parent='None'): pass

    def radioClicked(self, index): pass
...
class Layout(QtWidgets.QWidget):
    ...
    def addWidgetToParent(self, parentName, widget): pass
    ...
    def updateHeight(self, childHeight='None'): pass
...
class IconButton(QtWidgets.QPushButton):
    def __init__(self, buttonName, iconName, parent='None'): pass

    staticMetaObject = None


class FrameLayout(fui.FrameWidget):
    def __init__(self, text, expanded='False'): pass
