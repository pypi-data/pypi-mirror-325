...
class PushValueOntoStack:
    ...
    def __init__(self, stackItem, value): pass
...
class CreaseSetTreeWidget(QTreeWidget):
    ...
    def hideCreaseValueColorSetCB(self): pass
    ...
    def setDefaultCreaseSetNameCB(self): pass

    def setItemValues(self, item='None', name='None', colorIndex='None', creaseLevel='None', members='None',
                      numSelectedMembers='None', showSetMembers='False'):
        """
    ...
    def showCreaseValueColorSetCB(self): pass
    ...
    def toggleCreaseValueColorSetCB(self): pass
...
class MayaUndoChunk:
    ...
    def __init__(self, name="'unnamedChunk'"): pass
