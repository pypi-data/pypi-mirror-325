...
class NodeEditorBookmarksWindow(object):
    ...
    def selectLastLoadedInfo(self): pass
...
def _getInstance(): pass


def _getBookmarkName(name): pass
...
def _deleteBookmarks(infos): pass


def _getNextBookmark(ned, incr): pass


def _naturalKey(str_): pass
...
def _getBookmarkInfos(): pass


def _refreshWindow(): pass
...
def _getDescriptionForInfo(bookmarkInfo): pass
...
def _renameBookmark(info, name): pass
