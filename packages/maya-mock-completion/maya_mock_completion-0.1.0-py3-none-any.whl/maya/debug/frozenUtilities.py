...
class FrozenOptionsManager(object):
    ...
    def set_options(self, displayLayers='None', downstream='None', explicitPropagation='None', invisible='None',
                    referencedNodes='None', runtimePropagation='None', upstream='None'):
        """
