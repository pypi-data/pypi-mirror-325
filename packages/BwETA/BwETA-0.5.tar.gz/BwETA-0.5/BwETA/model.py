...
class TransformerModel(tf.keras.Model):
    ...
    def sample_top_k(self, logits, top_k=50, temperature=1.0):
    ...
    def generate(self, input, max_len, mask=None, top_k=50, temperature=1.0):
        try:
        ...
        for _ in range(max_len):
            ...
            predicted_id = self.sample_top_k(output.logits, top_k=top_k, temperature=temperature)
