...
Refer to the Terraform Registry for docs: [`cloudflare_dns_firewall`](https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall).
'''
...
class DnsFirewall(
    ...
    def __init__(
        ...
        *,
        ...
        upstream_ips: typing.Optional[typing.Sequence[builtins.str]] = None,
        ...
        :param account_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall#account_id DnsFirewall#account_id}
        :param attack_mitigation: Attack mitigation settings. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall#attack_mitigation DnsFirewall#attack_mitigation}
        :param deprecate_any_requests: Whether to refuse to answer queries for the ANY type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall#deprecate_any_requests DnsFirewall#deprecate_any_requests}
        :param ecs_fallback: Whether to forward client IP (resolver) subnet if no EDNS Client Subnet is sent. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall#ecs_fallback DnsFirewall#ecs_fallback}
        :param maximum_cache_ttl: Maximum DNS cache TTL This setting sets an upper bound on DNS TTLs for purposes of caching between DNS Firewall and the upstream servers. Higher TTLs will be decreased to the maximum defined here for caching purposes. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall#maximum_cache_ttl DnsFirewall#maximum_cache_ttl}
        :param minimum_cache_ttl: Minimum DNS cache TTL This setting sets a lower bound on DNS TTLs for purposes of caching between DNS Firewall and the upstream servers. Lower TTLs will be increased to the minimum defined here for caching purposes. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall#minimum_cache_ttl DnsFirewall#minimum_cache_ttl}
        :param name: DNS Firewall cluster name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall#name DnsFirewall#name}
        :param negative_cache_ttl: Negative DNS cache TTL This setting controls how long DNS Firewall should cache negative responses (e.g., NXDOMAIN) from the upstream servers. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall#negative_cache_ttl DnsFirewall#negative_cache_ttl}
        :param ratelimit: Ratelimit in queries per second per datacenter (applies to DNS queries sent to the upstream nameservers configured on the cluster). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall#ratelimit DnsFirewall#ratelimit}
        :param retries: Number of retries for fetching DNS responses from upstream nameservers (not counting the initial attempt). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall#retries DnsFirewall#retries}
        :param upstream_ips: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall#upstream_ips DnsFirewall#upstream_ips}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DnsFirewall that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall#import import section} in the documentation of this resource for the id to use
    ...
    def put_attack_mitigation(
        ...
        *,
        ...
        '''
        :param enabled: When enabled, automatically mitigate random-prefix attacks to protect upstream DNS servers. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall#enabled DnsFirewall#enabled}
        :param only_when_upstream_unhealthy: Only mitigate attacks when upstream servers seem unhealthy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/dns_firewall#only_when_upstream_unhealthy DnsFirewall#only_when_upstream_unhealthy}
        '''
    ...
    @jsii.member(jsii_name="resetUpstreamIps")
    def reset_upstream_ips(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetUpstreamIps", []))
...
class DnsFirewallConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if upstream_ips is not None:
            self._values["upstream_ips"] = upstream_ips
    ...
    @builtins.property
    def upstream_ips(self) -> typing.Optional[typing.List[builtins.str]]:
