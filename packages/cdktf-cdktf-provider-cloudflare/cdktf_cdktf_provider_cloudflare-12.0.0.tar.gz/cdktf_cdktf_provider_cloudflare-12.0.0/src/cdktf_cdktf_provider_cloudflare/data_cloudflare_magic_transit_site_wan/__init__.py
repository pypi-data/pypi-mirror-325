...
class DataCloudflareMagicTransitSiteWan(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/data-sources/magic_transit_site_wan#account_id DataCloudflareMagicTransitSiteWan#account_id}
        :param wan_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/data-sources/magic_transit_site_wan#wan_id DataCloudflareMagicTransitSiteWan#wan_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class DataCloudflareMagicTransitSiteWanConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def wan_id(self) -> builtins.str:
        ...
        assert result is not None, "Required property 'wan_id' is missing"
        return typing.cast(builtins.str, result)
