...
class CloudforceOneRequestAsset(
    ...
    def __init__(
        ...
        *,
        ...
        asset_identifer: typing.Optional[builtins.str] = None,
        ...
        :param account_identifier: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/cloudforce_one_request_asset#account_identifier CloudforceOneRequestAsset#account_identifier}
        :param page: Page number of results. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/cloudforce_one_request_asset#page CloudforceOneRequestAsset#page}
        :param per_page: Number of results per page. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/cloudforce_one_request_asset#per_page CloudforceOneRequestAsset#per_page}
        :param request_identifier: UUID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/cloudforce_one_request_asset#request_identifier CloudforceOneRequestAsset#request_identifier}
        :param asset_identifer: UUID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/cloudforce_one_request_asset#asset_identifer CloudforceOneRequestAsset#asset_identifer}
        :param source: Asset file to upload. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/cloudforce_one_request_asset#source CloudforceOneRequestAsset#source}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing CloudforceOneRequestAsset that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/cloudforce_one_request_asset#import import section} in the documentation of this resource for the id to use
    ...
    @jsii.member(jsii_name="resetAssetIdentifer")
    def reset_asset_identifer(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetAssetIdentifer", []))
    ...
    def asset_identifer(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c01acad4ddc6f861b3defc4c6653882dfaf097d2c5fdbaf1306090b691673efe)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CloudforceOneRequestAssetConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if asset_identifer is not None:
            self._values["asset_identifer"] = asset_identifer
    ...
    @builtins.property
    def asset_identifer(self) -> typing.Optional[builtins.str]:
        '''UUID.
...
def _typecheckingstub__c01acad4ddc6f861b3defc4c6653882dfaf097d2c5fdbaf1306090b691673efe(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
