...
Refer to the Terraform Registry for docs: [`data_cloudflare_magic_transit_site`](https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/data-sources/magic_transit_site).
'''
...
class DataCloudflareMagicTransitSite(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/data-sources/magic_transit_site#account_id DataCloudflareMagicTransitSite#account_id}
        :param filter: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/data-sources/magic_transit_site#filter DataCloudflareMagicTransitSite#filter}.
        :param site_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/data-sources/magic_transit_site#site_id DataCloudflareMagicTransitSite#site_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataCloudflareMagicTransitSite that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/data-sources/magic_transit_site#import import section} in the documentation of this resource for the id to use
    ...
    def put_filter(
        self,
        *,
        connector_identifier: typing.Optional[builtins.str] = None,
    ) -> None:
        '''
        :param connector_identifier: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/data-sources/magic_transit_site#connector_identifier DataCloudflareMagicTransitSite#connector_identifier}
        '''
        value = DataCloudflareMagicTransitSiteFilter(
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"connector_identifier": "connectorIdentifier"},
)
    ...
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument connector_identifier", value=connector_identifier, expected_type=type_hints["connector_identifier"])
        self._values: typing.Dict[builtins.str, typing.Any] = {}
        if connector_identifier is not None:
            self._values["connector_identifier"] = connector_identifier

    @builtins.property
    def connector_identifier(self) -> typing.Optional[builtins.str]:
        '''Identifier.
        ...
        '''
        result = self._values.get("connector_identifier")
        return typing.cast(typing.Optional[builtins.str], result)
...
class DataCloudflareMagicTransitSiteFilterOutputReference(
    ...
    @jsii.member(jsii_name="resetConnectorIdentifier")
    def reset_connector_identifier(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetConnectorIdentifier", []))

    @builtins.property
    @jsii.member(jsii_name="connectorIdentifierInput")
    def connector_identifier_input(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "connectorIdentifierInput"))

    @builtins.property
    @jsii.member(jsii_name="connectorIdentifier")
    def connector_identifier(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "connectorIdentifier"))

    @connector_identifier.setter
    def connector_identifier(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__26bfce97addd3303e5de312fae8fd4731d34d4767b82568b2434923d6f7a6785)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "connectorIdentifier", value) # pyright: ignore[reportArgumentType]
...
def _typecheckingstub__26bfce97addd3303e5de312fae8fd4731d34d4767b82568b2434923d6f7a6785(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
