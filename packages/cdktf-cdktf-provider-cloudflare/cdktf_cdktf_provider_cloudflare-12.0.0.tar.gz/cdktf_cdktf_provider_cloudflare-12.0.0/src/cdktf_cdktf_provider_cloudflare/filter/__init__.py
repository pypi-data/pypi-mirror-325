...
class Filter(
    ...
    def __init__(
        ...
        *,
        ...
        :param expression: The filter expression. For more information, refer to `Expressions <https://developers.cloudflare.com/ruleset-engine/rules-language/expressions/>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/filter#expression Filter#expression}
        :param zone_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/filter#zone_id Filter#zone_id}
        :param filter_id: The unique identifier of the filter. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/filter#filter_id Filter#filter_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Filter that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.0.0/docs/resources/filter#import import section} in the documentation of this resource for the id to use
    ...
    def filter_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__eb1317a7a61b905de323300c436ed7595defc69a1d4e44e3be26291b7ea4b18d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
def _typecheckingstub__eb1317a7a61b905de323300c436ed7595defc69a1d4e44e3be26291b7ea4b18d(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
