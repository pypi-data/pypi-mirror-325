...
from module_qc_analysis_tools.analysis.quad_pcb_metrology import analyze
...
def main(
    ...
    """
    Performs analysis of quad pcb metrology.

    """

    log.info("")
    log.info(" ===============================================")
    log.info(" \tPerforming Quad PCB METROLOGY analysis")
    log.info(" ===============================================")
    log.info("")
