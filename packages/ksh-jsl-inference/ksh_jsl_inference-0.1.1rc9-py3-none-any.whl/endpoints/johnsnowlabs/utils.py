...
def download_healthcare_model(
    ...
    """
    Downloads the specified healthcare model from John Snow Labs and store it in /opt/ml/model/
...
def download_chromadb_resolver_model(concept):
