...
class AlertsConfig(AppConfig):
    ...
    def register(self, app, cls):
        ...
        try:
            # TODO: this causes the database to be accessed during app initialization 
            # Currently, it results in a warning but it's likely it'll change in the future,
            # so a better solution should be implemented
