...
You should never be importing ``nitrate`` directly, because it isn't
really a single package -- it's more a collection of different packages
distributed as one library.
