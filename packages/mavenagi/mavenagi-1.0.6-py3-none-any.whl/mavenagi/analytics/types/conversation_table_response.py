...
class ConversationTableResponse(UniversalBaseModel):
    """
    Examples
    --------
    import datetime

    from mavenagi.analytics import ConversationRow, ConversationTableResponse
    from mavenagi.analytics_commons import (
        CellData_Double,
        ...
        rows=[
            ConversationRow(
                ...
                data={
                    ...
                    "percentile_handle_time": CellData_PercentileMap(
                        value={"25": 100.0, "75": 250.0}
                    ),
                },
            ),
            ConversationRow(
