...
class ModelMapper:
    ...
    @classmethod
    def map_to_llm_settings(cls, data: dict):
        return LlmSettings(
            provider_name=data.get("providerName"),
            model_name=data.get("modelName"),
            ...
            llm_output_guardrail=data.get("llmOutputGuardrail"),
            input_moderation_guardrail=data.get("inputModerationGuardrail"),
            prompt_injection_guardrail=data.get("promptInjectionGuardrail")
        )
