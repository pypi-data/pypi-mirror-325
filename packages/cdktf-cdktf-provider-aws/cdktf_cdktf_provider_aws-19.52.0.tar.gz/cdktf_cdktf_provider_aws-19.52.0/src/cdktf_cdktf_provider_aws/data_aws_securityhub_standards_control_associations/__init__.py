...
class DataAwsSecurityhubStandardsControlAssociations(
    ...
    def __init__(
        ...
        *,
        ...
        :param security_control_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/data-sources/securityhub_standards_control_associations#security_control_id DataAwsSecurityhubStandardsControlAssociations#security_control_id}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
