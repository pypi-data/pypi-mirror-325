...
from .account import account_with_username_password, list_permissions
...
@pytest.mark.skip("broken due to file closed exception")
...
async def test_new_account():
    ...
    account = await account_with_username_password("user", "pass")
