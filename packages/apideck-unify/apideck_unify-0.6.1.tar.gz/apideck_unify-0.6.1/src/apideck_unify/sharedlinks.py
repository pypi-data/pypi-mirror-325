...
class SharedLinks(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.FileStorageSharedLinksAllResponse(
                get_shared_links_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetSharedLinksResponse]
                ),
        ...
        *,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.shared_link, False, False, "json", models.SharedLinkInput
            ),
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return models.FileStorageSharedLinksAddResponse(
                create_shared_link_response=utils.unmarshal_json(
                    http_res.text, Optional[models.CreateSharedLinkResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
    ...
    def get(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.FileStorageSharedLinksOneResponse(
                get_shared_link_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetSharedLinkResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
    ...
    def update(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.FileStorageSharedLinksUpdateResponse(
                update_shared_link_response=utils.unmarshal_json(
                    http_res.text, Optional[models.UpdateSharedLinkResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
    ...
    def delete(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.FileStorageSharedLinksDeleteResponse(
                delete_shared_link_response=utils.unmarshal_json(
                    http_res.text, Optional[models.DeleteSharedLinkResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
