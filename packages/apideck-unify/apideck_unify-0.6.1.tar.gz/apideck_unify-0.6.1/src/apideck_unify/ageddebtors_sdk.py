    ...
    def get(
        ...
        *,
        ...
        req = self._build_request(
            ...
            _globals=models.AccountingAgedDebtorsOneGlobals(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.AccountingAgedDebtorsOneResponse(
                get_aged_debtors_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetAgedDebtorsResponse]
                ),
