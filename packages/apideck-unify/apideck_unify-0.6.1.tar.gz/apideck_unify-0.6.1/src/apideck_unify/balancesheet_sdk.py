    ...
    def get(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.AccountingBalanceSheetOneResponse(
                get_balance_sheet_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetBalanceSheetResponse]
                ),
