...
class EmployeeSchedulesSDK(BaseSDK):
    def list(
        self,
        *,
        employee_id: str,
        ...
        req = self._build_request(
            ...
            _globals=models.HrisEmployeeSchedulesAllGlobals(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="hris.employeeSchedulesAll",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.HrisEmployeeSchedulesAllResponse(
                get_employee_schedules_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetEmployeeSchedulesResponse]
                ),
