        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.CrmOpportunitiesAllResponse(
                get_opportunities_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetOpportunitiesResponse]
                ),
        ...
        *,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return models.CrmOpportunitiesAddResponse(
                create_opportunity_response=utils.unmarshal_json(
                    http_res.text, Optional[models.CreateOpportunityResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.CrmOpportunitiesOneResponse(
                get_opportunity_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetOpportunityResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.CrmOpportunitiesUpdateResponse(
                update_opportunity_response=utils.unmarshal_json(
                    http_res.text, Optional[models.UpdateOpportunityResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.CrmOpportunitiesDeleteResponse(
                delete_opportunity_response=utils.unmarshal_json(
                    http_res.text, Optional[models.DeleteOpportunityResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
