...
class EmployeePayrolls(BaseSDK):
    def list(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.HrisEmployeePayrollsAllResponse(
                get_employee_payrolls_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetEmployeePayrollsResponse]
                ),
    ...
    def get(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.HrisEmployeePayrollsOneResponse(
                get_employee_payroll_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetEmployeePayrollResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
