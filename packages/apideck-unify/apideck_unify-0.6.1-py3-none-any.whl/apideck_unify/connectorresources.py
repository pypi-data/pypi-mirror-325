    ...
    def get(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ConnectorConnectorResourcesOneResponse(
                get_connector_resource_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetConnectorResourceResponse]
                ),
