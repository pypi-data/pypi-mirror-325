        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.HrisPayrollsAllResponse(
                get_payrolls_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetPayrollsResponse]
                ),
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.HrisPayrollsOneResponse(
                get_payroll_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetPayrollResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
