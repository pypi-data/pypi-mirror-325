...
class CollectionUsers(BaseSDK):
    def list(
        ...
        *,
    ...
    ) -> Optional[models.IssueTrackingCollectionUsersAllResponse]:
        r"""List Users
        ...
        request = models.IssueTrackingCollectionUsersAllRequest(
        ...
        req = self._build_request(
            method="GET",
            path="/issue-tracking/collections/{collection_id}/users",
            base_url=base_url,
            ...
            _globals=models.IssueTrackingCollectionUsersAllGlobals(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="issueTracking.collectionUsersAll",
                oauth2_scopes=[],
    ...
    def get(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.IssueTrackingCollectionUsersOneResponse:
        r"""Get user
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.IssueTrackingCollectionUsersOneGlobals(
                consumer_id=self.sdk_configuration.globals.consumer_id,
                app_id=self.sdk_configuration.globals.app_id,
            ),
            security=self.sdk_configuration.security,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="issueTracking.collectionUsersOne",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
