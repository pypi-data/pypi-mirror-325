...
class CandidateAttachmentsApi(object):
    ...
    def delete_candidate_attachments(self, body, x_ph_user_id, candidate_id, **kwargs):  # noqa: E501
        ...
        :param DeleteAttachmentRequest body: Delete candidate attachments (required)
    ...
    def update_candidate_attachments(self, attachment, is_parsable, x_ph_userid, candidate_id, **kwargs):  # noqa: E501
        """Update Attachments  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_candidate_attachments(attachment, is_parsable, x_ph_userid, candidate_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str attachment: (required)
        :param bool is_parsable: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_candidate_attachments_with_http_info(attachment, is_parsable, x_ph_userid, candidate_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_candidate_attachments_with_http_info(attachment, is_parsable, x_ph_userid, candidate_id, **kwargs)  # noqa: E501
            return data

    def update_candidate_attachments_with_http_info(self, attachment, is_parsable, x_ph_userid, candidate_id, **kwargs):  # noqa: E501
        """Update Attachments  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_candidate_attachments_with_http_info(attachment, is_parsable, x_ph_userid, candidate_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['attachment', 'is_parsable', 'x_ph_userid', 'candidate_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'is_parsable' is set
        if ('is_parsable' not in params or
                params['is_parsable'] is None):
            raise ValueError("Missing the required parameter `is_parsable` when calling `update_candidate_attachments`")  # noqa: E501
        ...
        if 'is_parsable' in params:
            form_params.append(('isParsable', params['is_parsable']))  # noqa: E501
