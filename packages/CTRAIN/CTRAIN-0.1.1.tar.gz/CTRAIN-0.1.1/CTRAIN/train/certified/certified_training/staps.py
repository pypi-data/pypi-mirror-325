...
def staps_train_model(original_model, hardened_model, train_loader, val_loader=None, num_epochs=None, eps=0.3, eps_std=.3, eps_schedule=(0, 20, 50), eps_schedule_unit='epoch', eps_scheduler_args=dict(), optimizer=None,
                    subselection_ratio=.4, lr_decay_schedule=(15, 25), lr_decay_factor=10, lr_decay_schedule_unit='epoch', 
                    n_classes=10, gradient_clip=None, l1_regularisation_weight=0.00001,
                    shi_regularisation_weight=.5, shi_reg_decay=True, gradient_expansion_alpha=5., sabr_pgd_steps=8, sabr_pgd_step_size=.5, sabr_pgd_restarts=1, 
                    sabr_pgd_early_stopping=True, sabr_pgd_decay_factor=.1, sabr_pgd_decay_checkpoints=(4,7), taps_pgd_steps=20, taps_pgd_step_size=None, taps_pgd_restarts=1, 
