...
def text_to_sql(
    ...
    @param api_key: The Anthropic API key. Recommended to use the environment variable.
    @param table_names: The table names to give structures to ai.
    @param model: The Anthropic model to use. Default is "claude-3-5-haiku-latest".
    @param max_tokens: The maximum number of tokens to generate. Default is 1024.
