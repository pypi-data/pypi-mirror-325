...
from triggercalib.utils import helpers, io, typing
...
class HltEff:
    ...
    def __init__(  # <- TODO: order the arguments!
        ...
        observable: typing.observable = None,
        pdf: typing.pdf = None,
    ...
    def _fit_count(self, prefix=""):
        ...
        for category in self._categories:
            ...
            for midpoint_coords in it.product(*self.midpoints):
                ...
                if self.weight:
                    observables_list.append(self.weight)
    ...
    def _calculate_sweights(self, rdf, prefix=""):
        ...
        if self.weight:
            observables.append(helpers.construct_variable(self.weight, self.backend))
    ...
    def _calc_eff(self, numerator: float, denominator: float, confidence: float = 0.68):
        ...
        if denominator > 0:
            ...
            eff_low = abs(
                eff_value
                - R.TEfficiency.Wilson(denominator, numerator, confidence, False)
            )
            eff_up = abs(
    ...
    def _trigger_efficiency(
        ...
        for midpoint_coords in it.product(*self.midpoints):
            ...
            denominator_hist.SetBinError(n_bin, abs(bin_error))
