...
class Group(object):
    ...
    def __init__(
        self, name=None, org_perm=None, created_at=None, id=None, updated_at=None
    ):  # noqa: E501
    ...
    @property
    def org_perm(self):
        """Gets the org_perm of this Group.  # noqa: E501


        :return: The org_perm of this Group.  # noqa: E501
        :rtype: str
        """
    ...
    def org_perm(self, org_perm):
        """Sets the org_perm of this Group.


        :param org_perm: The org_perm of this Group.  # noqa: E501
        :type: str
        """
        if org_perm is None:
            raise ValueError(
