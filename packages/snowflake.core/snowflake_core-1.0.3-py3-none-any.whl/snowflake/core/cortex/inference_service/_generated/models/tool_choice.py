...
class ToolChoice(BaseModel):
    ...
    __________
    type : str, optional
        The type of choice you would like the model to follow. Values are auto, any, and tool
    name : str, optional
        The name of the tool you would like the model to use. Only relevant if the tool is set to tool
    """
