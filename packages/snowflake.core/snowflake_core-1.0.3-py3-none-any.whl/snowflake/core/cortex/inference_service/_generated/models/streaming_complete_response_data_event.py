...
class StreamingCompleteResponseDataEvent(BaseModel):
    ...
    tool_use : List[StreamingCompleteResponseDataEventToolUseInner], optional
    """

    choices: Optional[
        List[StreamingCompleteResponseDataEventChoicesInner]] = None

    tool_use: Optional[
        List[StreamingCompleteResponseDataEventToolUseInner]] = Field(
            default=None, alias="toolUse")

    __properties = ["choices", "toolUse"]
    ...
    def to_dict(
        ...
        _items = []
        if self.tool_use:
            for _item in self.tool_use:
                if _item:
                    _items.append(_item.to_dict())
            _dict['toolUse'] = _items
    ...
    def from_dict(cls, obj: dict) -> StreamingCompleteResponseDataEvent:
        ...
        _obj = StreamingCompleteResponseDataEvent.parse_obj({
            "choices": [
                StreamingCompleteResponseDataEventChoicesInner.from_dict(_item)
                for _item in obj.get("choices")
            ] if obj.get("choices") is not None else None,
            "tool_use": [
                StreamingCompleteResponseDataEventToolUseInner.from_dict(_item)
                for _item in obj.get("toolUse")
            ] if obj.get("toolUse") is not None else None,
        })
...
class StreamingCompleteResponseDataEventModel():
    ...
    def __init__(
        ...
        choices: Optional[
            List[StreamingCompleteResponseDataEventChoicesInner]] = None,
        tool_use: Optional[
            List[StreamingCompleteResponseDataEventToolUseInner]] = None,
    ):
        """A model object representing the StreamingCompleteResponseDataEvent resource.
    ...
    def _to_model(self):
        return StreamingCompleteResponseDataEvent(
            ...
            tool_use=[x._to_model() for x in self.tool_use]
    ...
    def _from_model(cls, model) -> StreamingCompleteResponseDataEventModel:
        return StreamingCompleteResponseDataEventModel(
            choices=[
                ...
                _from_model(x) for x in model.choices
            ] if model.choices is not None else None,
            tool_use=[
                StreamingCompleteResponseDataEventToolUseInnerModel.
                _from_model(x) for x in model.tool_use
            ] if model.tool_use is not None else None,
        )

    def to_dict(self):
        """Creates a dictionary of the properties from a StreamingCompleteResponseDataEvent.
    ...
    def from_dict(cls, obj: dict) -> StreamingCompleteResponseDataEventModel:
        """Creates an instance of StreamingCompleteResponseDataEvent from a dict.
        ...
        return cls._from_model(
            StreamingCompleteResponseDataEvent.from_dict(obj))
