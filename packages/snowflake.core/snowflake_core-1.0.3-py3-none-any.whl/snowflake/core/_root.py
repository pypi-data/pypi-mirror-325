...
class Root:
    ...
    def _refresh_parameters(self) -> None:
        parameters = {
            "PARAM_USE_CLIENT_RETRY": os.getenv("_SNOWFLAKE_ENABLE_RETRY_REQUEST_QUERY"),
            "PARAM_PRINT_VERBOSE_STACK_TRACE": os.getenv("_SNOWFLAKE_PRINT_VERBOSE_STACK_TRACE"),
            "PARAM_FIX_HOSTNAME": os.getenv("_SNOWFLAKE_FIX_HOSTNAME", "true"),
        }
