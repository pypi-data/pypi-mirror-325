...
class CompleteRequest(BaseModel):
    ...
    tools : List[Tool], optional
        List of tools to be used in the process
    tool_choice : ToolChoice, optional

    tool_results : List[ToolResult], optional
        The results from tools executed by the client.
    ...
    tool_choice: Optional[ToolChoice] = Field(default=None, alias="toolChoice")
    ...
    __properties = [
        ...
        "toolChoice", "toolResults", "provisioned_throughput_id",
    ...
    def from_dict(cls, obj: dict) -> CompleteRequest:
        ...
        _obj = CompleteRequest.parse_obj({
            ...
            "tool_choice":
            ToolChoice.from_dict(obj.get("toolChoice"))
            if obj.get("toolChoice") is not None else None,
            "tool_results":
            [ToolResult.from_dict(_item) for _item in obj.get("toolResults")]
            if obj.get("toolResults") is not None else None,
...
class CompleteRequestModel():
    ...
    def _to_model(self):
        return CompleteRequest(
            ...
            tool_results=[x._to_model() for x in self.tool_results]
    ...
    def _from_model(cls, model) -> CompleteRequestModel:
        return CompleteRequestModel(
            ...
            tool_results=[
                ToolResultModel._from_model(x) for x in model.tool_results
