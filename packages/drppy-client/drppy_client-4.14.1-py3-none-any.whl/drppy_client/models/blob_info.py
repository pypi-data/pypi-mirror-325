...
class BlobInfo(object):
    ...
    @property
    def path(self):
        """Gets the path of this BlobInfo.  # noqa: E501


        :return: The path of this BlobInfo.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this BlobInfo.


        :param path: The path of this BlobInfo.  # noqa: E501
        :type: str
        """
