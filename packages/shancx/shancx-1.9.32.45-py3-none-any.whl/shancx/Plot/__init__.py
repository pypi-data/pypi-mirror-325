...
def plot_data(datasets, title=None, save_dir="plots", filename=None, epoch=0):
    ...
    for i, (data, t) in enumerate(zip(datasets, title)):
        im = axes[i].matshow(data, cmap='viridis')
...
class TrainingVisualizer2:
    ...
    def draw_curve(self, epoch=None, train_loss=None, train_psnr=None, val_loss=None, val_psnr=None):
        ...
        plt.close(fig)
        """
        visualizer3 = TrainingVisualizer2(root_path="./Rec3")
        visualizer4 = TrainingVisualizer2(root_path="./Rec4")
        visualizer5 = TrainingVisualizer2(root_path="./Rec5")
