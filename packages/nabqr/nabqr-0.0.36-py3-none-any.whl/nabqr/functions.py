...
def calculate_scores(
    ...
    table = pd.DataFrame({
        "Quantiles": quantiles_taqr,
        "QSS NABQR": qs_corrected_taqr
    })
    print(table)
...
def pipeline(
    ...
    **kwargs : dict
    ...
    if n_init < 1000: # TODO: should actually be 5000 for optimal results... for wind power production.
        print("25% of the data is less than 1000 timesteps, thus, setting n_init to 50% of the data length or 1000, whichever is larger")
        n_init = max(int(0.5*n_full), 1000)
