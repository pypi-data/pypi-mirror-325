...
var ye = D(S, "DataView"), me = D(S, "Promise"), ve = D(S, "Set"), et = "[object Map]", qi = "[object Object]", tt = "[object Promise]", nt = "[object Set]", rt = "[object WeakMap]", it = "[object DataView]", Yi = N(ye), Xi = N(X), Ji = N(me), Zi = N(ve), Wi = N(be), $ = R;
...
var Ia = 1, ft = "[object Arguments]", ct = "[object Array]", k = "[object Object]", Ma = Object.prototype, pt = Ma.hasOwnProperty;
function Fa(e, t, n, r, i, o) {
  var a = P(e), s = P(t), u = a ? ct : $(e), l = s ? ct : $(t);
...
function Zs(e, t, n) {
  ...
  const g = us(() => import("./bubble.list-BGmDHzfy.js"));
  let {
    gradio: p
  } = t, {
    props: c = {}
  ...
  return de(e, De, (b) => n(1, s = b)), e.$$set = (b) => {
    t = Te(Te({}, t), Ms(b)), n(18, i = bt(t, r)), "gradio" in b && n(6, p = b.gradio), "props" in b && n(7, c = b.props), "_internal" in b && n(8, y = b._internal), "as_item" in b && n(9, _ = b.as_item), "visible" in b && n(10, f = b.visible), "elem_id" in b && n(11, v = b.elem_id), "elem_classes" in b && n(12, w = b.elem_classes), "elem_style" in b && n(13, M = b.elem_style), "$$scope" in b && n(16, l = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && d.update((b) => ({
      ...b,
  ...
  }, [a, s, g, d, F, De, p, c, y, _, f, v, w, M, o, u, l];
}
class Vs extends Ss {
  constructor(t) {
