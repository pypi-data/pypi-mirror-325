import { a as b } from "./XProvider-BCUhPu_l.js";
import { i as o } from "./interopRequireDefault-BJV_i6Nz.js";
import { o as g, c as x } from "./common-DBXquc-F.js";
function h(p, f) {
    ...
    if (typeof l != "string" && !Array.isArray(l)) {
      for (const a in l)
        if (a !== "default" && !(a in p)) {
          ...
          m && Object.defineProperty(p, a, m.get ? m : {
            enumerable: !0,
            get: () => l[a]
          });
        }
...
n.default = void 0;
var k = u(i), S = u(c), Y = u(t), w = u(r);
const e = "Το ${label} δεν είναι έγκυρο ${type}", F = {
  locale: "el",
...
n.default = F;
var v = n;
const q = /* @__PURE__ */ b(v), U = /* @__PURE__ */ h({
  __proto__: null,
  default: q
}, [v]);
export {
