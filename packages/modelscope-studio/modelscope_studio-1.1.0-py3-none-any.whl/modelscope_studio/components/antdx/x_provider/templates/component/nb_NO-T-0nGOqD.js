import { a as _ } from "./XProvider-BCUhPu_l.js";
import { i as n } from "./interopRequireDefault-BJV_i6Nz.js";
import { o as $, c as k } from "./common-DBXquc-F.js";
function y(u, v) {
    ...
    if (typeof t != "string" && !Array.isArray(t)) {
      for (const r in t)
        if (r !== "default" && !(r in u)) {
          ...
          c && Object.defineProperty(u, r, c.get ? c : {
            enumerable: !0,
            get: () => t[r]
          });
        }
...
o.default = void 0;
var D = m(i), T = m(d), Y = m(l), A = m(a);
const e = "${label} er ikke et gyldig ${type}", C = {
  locale: "nb",
...
o.default = C;
var b = o;
const w = /* @__PURE__ */ _(b), R = /* @__PURE__ */ y({
  __proto__: null,
  default: w
}, [b]);
export {
