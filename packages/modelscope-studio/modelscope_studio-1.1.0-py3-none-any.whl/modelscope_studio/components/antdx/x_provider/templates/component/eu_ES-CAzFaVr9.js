...
import { o as $, c as v } from "./common-DBXquc-F.js";
function z(k, s) {
  for (var c = 0; c < s.length; c++) {
    ...
    if (typeof a != "string" && !Array.isArray(a)) {
      for (const r in a)
        if (r !== "default" && !(r in k)) {
          const b = Object.getOwnPropertyDescriptor(a, r);
          b && Object.defineProperty(k, r, b.get ? b : {
            enumerable: !0,
            get: () => a[r]
          });
        }
...
u.default = U;
var g = u;
const F = /* @__PURE__ */ _(g), I = /* @__PURE__ */ z({
  __proto__: null,
  default: F
}, [g]);
export {
