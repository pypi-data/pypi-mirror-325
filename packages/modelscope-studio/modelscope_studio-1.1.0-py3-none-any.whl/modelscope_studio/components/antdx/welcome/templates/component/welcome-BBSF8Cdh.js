import { i as Rt, a as we, r as Lt, g as Ht, w as J, c as V } from "./Index-De4S8X5N.js";
...
function Zt(e, t, n) {
  ...
  t = Ne(t) || 0, we(n) && (f = !!n.leading, u = "maxWait" in n, i = u ? Qt(Ne(n.maxWait) || 0, t) : i, d = "trailing" in n ? !!n.trailing : d);
  function v(m) {
    var S = o, O = r;
    return o = r = void 0, l = m, s = e.apply(O, S), s;
  }
  function _(m) {
    return l = m, a = setTimeout(C, t), f ? v(m) : s;
  }
  function h(m) {
    var S = m - c, O = m - l, E = t - S;
    return u ? Jt(E, i - O) : E;
  }
  function p(m) {
    var S = m - c, O = m - l;
    return c === void 0 || S >= t || S < 0 || u && O >= i;
  }
  function C() {
    var m = ye();
    if (p(m))
  ...
  function g() {
    return a === void 0 ? s : T(ye());
  }
  function x() {
    var m = ye(), S = p(m);
    if (o = arguments, r = this, c = m, S) {
      if (a === void 0)
        return _(c);
      if (u)
        return clearTimeout(a), a = setTimeout(C, t), v(c);
    }
    return a === void 0 && (a = setTimeout(C, t)), s;
  }
  return x.cancel = P, x.flush = g, x;
}
var st = {
  exports: {}
}, re = {};
...
function _r(e, t, n) {
  ...
  const u = J();
  Ue(e, u, (g) => n(1, r = g));
  const d = [], v = yr("$$ms-gr-react-wrapper"), {
    slotKey: _,
    slotIndex: h,
    subSlotIndex: p
  } = Ht() || {}, C = c({
...
const K = Et(({
  ...
  return kt(() => {
    ...
    function d() {
      let h = u;
      if (u.tagName.toLowerCase() === "svelte-slot" && u.children.length === 1 && u.children[0] && (h = u.children[0], h.tagName.toLowerCase() === "react-portal-target" && h.children[0] && (h = h.children[0])), Pr(i, h), n && h.classList.add(...n.split(" ")), o) {
        const p = Or(o);
    ...
    if (f && window.MutationObserver) {
      let h = function() {
        var P, g, x;
        (P = s.current) != null && P.contains(u) && ((g = s.current) == null || g.removeChild(u));
        const {
          portals: C,
          clonedElement: T
        } = Me(e);
        u = T, c(C), u.style.display = "contents", d(), (x = s.current) == null || x.appendChild(u);
      };
      h();
      const p = Zt(() => {
      ...
      v = new window.MutationObserver(p), v.observe(e, {
        attributes: !0,
        childList: !0,
        subtree: !0
      });
    ...
    return () => {
      var h, p;
      u.style.display = "", (h = s.current) != null && h.contains(u) && ((p = s.current) == null || p.removeChild(u)), v == null || v.disconnect();
    };
...
var Nr = /* @__PURE__ */ function(e) {
  ...
  function n(o, r) {
    var i;
    de(this, n), i = t.call(this), w(U(i), "result", ""), w(U(i), "unitlessCssVar", void 0), w(U(i), "lowPriority", void 0);
    var s = H(o);
  ...
  function n(o) {
    var r;
    return de(this, n), r = t.call(this), w(U(r), "result", 0), o instanceof n ? r.result = o.result : typeof o == "number" && (r.result = o), r;
  }
  return ge(n, [{
    key: "add",
    value: function(r) {
...
function Yr(e) {
  ...
  function c(d, v, _, h) {
    ...
    var T = (h == null ? void 0 : h.unitless) || {}, P = typeof a == "function" ? a(d) : {}, g = I(I({}, P), {}, w({}, C("zIndexPopup"), !0));
    ...
    var x = I(I({}, h), {}, {
      unitless: g,
      prefixToken: C
    }), m = f(d, v, _, x), S = l(p, _, x);
    return function(O) {
      var E = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : O, L = m(O, E), D = ee(L, 2), j = D[1], X = S(E), k = ee(X, 2), z = k[0], G = k[1];
      return [z, j, G];
    };
  }
  function l(d, v, _) {
    var h = _.unitless, p = _.injectStyle, C = p === void 0 ? !0 : p, T = _.prefixToken, P = _.ignore, g = function(S) {
      var O = S.rootCls, E = S.cssVar, L = E === void 0 ? {} : E, D = o(), j = D.realToken;
      return Bt({
        path: [d],
        prefix: L.prefix,
        key: L.key,
        ...
        var X = nt(d, j, v), k = tt(d, j, X, {
          deprecatedTokens: _ == null ? void 0 : _.deprecatedTokens
        });
        return Object.keys(X).forEach(function(z) {
          k[T(z)] = k[z], delete k[z];
        }), k;
      }), null;
    }, x = function(S) {
      var O = o(), E = O.cssVar;
      return [function(L) {
        return C && E ? /* @__PURE__ */ b.createElement(b.Fragment, null, /* @__PURE__ */ b.createElement(g, {
          rootCls: S,
          cssVar: E,
          component: d
        }), L) : L;
  ...
  function f(d, v, _) {
    var h = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, p = Array.isArray(d) ? d : [d, d], C = ee(p, 1), T = C[0], P = p.join("-"), g = e.layer || {
      name: "antd"
    };
    return function(x) {
      var m = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : x, S = o(), O = S.theme, E = S.realToken, L = S.hashId, D = S.token, j = S.cssVar, X = r(), k = X.rootPrefixCls, z = X.iconPrefixCls, G = n(), pe = j ? "css" : "js", St = Jr(function() {
        var $ = /* @__PURE__ */ new Set();
        return j && Object.keys(h.unitless || {}).forEach(function(q) {
          $.add(be(q, j.prefix)), $.add(be(q, et(T, j.prefix)));
        }), Wr(pe, $);
      }, [pe, T, j == null ? void 0 : j.prefix]), Le = qr(pe), _t = Le.max, Ct = Le.min, He = {
        theme: O,
        token: D,
        hashId: L,
        nonce: function() {
      ...
      var wt = $e(I(I({}, He), {}, {
        ...
        if (h.injectStyle === !1)
          return [];
        var $ = Gr(D), q = $.token, Tt = $.flush, F = nt(T, E, _), Ot = ".".concat(x), ze = tt(T, E, F, {
          deprecatedTokens: h.deprecatedTokens
        });
        j && F && H(F) === "object" && Object.keys(F).forEach(function(Be) {
          F[Be] = "var(".concat(be(Be, et(T, j.prefix)), ")");
        });
        var Ae = Re(q, {
          componentCls: Ot,
          prefixCls: x,
        ...
        Tt(T, ze);
        var Pt = typeof s == "function" ? s(Ae, x, m, h.resetFont) : null;
        return [h.resetStyle === !1 ? null : Pt, Mt];
      });
      return [wt, L];
    };
  }
  function u(d, v, _) {
    var h = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, p = f(d, v, _, I({
      resetStyle: !1,
      // Sub Style should default after root one
      order: -998
    }, h)), C = function(P) {
      var g = P.prefixCls, x = P.rootCls, m = x === void 0 ? g : x;
      return p(g, m), null;
    };
    return C;
  }
...
function pn(e, t) {
  const {
    ...
    direction: v,
    getPrefixCls: _
  } = Pe(), h = _("welcome", n), p = kr("welcome"), [C, T, P] = gn(h), g = b.useMemo(() => {
    if (!l)
      return null;
    let S = l;
    return typeof l == "string" && l.startsWith("http") && (S = /* @__PURE__ */ b.createElement("img", {
      src: l,
      alt: "icon"
    })), /* @__PURE__ */ b.createElement("div", {
      className: V(`${h}-icon`, p.classNames.icon, a.icon),
      style: c.icon
    }, S);
  }, [l]), x = b.useMemo(() => f ? /* @__PURE__ */ b.createElement(De.Title, {
    level: 4,
    className: V(`${h}-title`, p.classNames.title, a.title),
    style: c.title
  }, f) : null, [f]), m = b.useMemo(() => d ? /* @__PURE__ */ b.createElement("div", {
    className: V(`${h}-extra`, p.classNames.extra, a.extra),
    style: c.extra
  }, d) : null, [d]);
  return C(/* @__PURE__ */ b.createElement(me, {
    ref: t,
    className: V(h, p.className, r, o, T, P, `${h}-${s}`, {
      [`${h}-rtl`]: v === "rtl"
    }),
    style: i
  ...
  }, d ? /* @__PURE__ */ b.createElement(me, {
    align: "flex-start",
    className: `${h}-title-wrapper`
  }, x, m) : x, u && /* @__PURE__ */ b.createElement(De.Text, {
    className: V(`${h}-description`, p.classNames.description, a.description),
    style: c.description
  }, u))));
}
