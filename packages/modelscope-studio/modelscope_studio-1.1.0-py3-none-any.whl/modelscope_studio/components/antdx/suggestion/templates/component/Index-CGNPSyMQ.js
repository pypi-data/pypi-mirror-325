...
var Me = It(Object.getPrototypeOf, Object), wi = "[object Object]", Pi = Function.prototype, Ai = Object.prototype, Ft = Pi.toString, $i = Ai.hasOwnProperty, Si = Ft.call(Object);
function Ci(e) {
  if (!E(e) || N(e) != wi)
    return !1;
  var t = Me(e);
...
function Zs(e) {
  ...
  return {
    ...
    p(i, [o]) {
      ...
      2 && G(r, 1)) : (r = bt(i), r.c(), G(r, 1), r.m(t.parentNode, t)) : r && (Ds(), J(r, 1, 1, () => {
        r = null;
      }), xs());
    },
    i(i) {
...
function Ws(e, t, n) {
  ...
  const g = ls(() => import("./suggestion-DZqw1Bmk.js"));
  let {
    gradio: p
  } = t, {
    props: c = {}
  ...
  de(e, L, (h) => n(1, a = h));
  const De = ys();
  return de(e, De, (h) => n(2, s = h)), e.$$set = (h) => {
    t = Te(Te({}, t), Ms(h)), n(19, i = ht(t, r)), "gradio" in h && n(7, p = h.gradio), "props" in h && n(8, c = h.props), "_internal" in h && n(9, y = h._internal), "items" in h && n(0, _ = h.items), "as_item" in h && n(10, f = h.as_item), "visible" in h && n(11, v = h.visible), "elem_id" in h && n(12, O = h.elem_id), "elem_classes" in h && n(13, M = h.elem_classes), "elem_style" in h && n(14, C = h.elem_style), "$$scope" in h && n(17, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && d.update((h) => ({
      ...h,
  ...
  }, [_, a, s, g, d, L, De, p, c, y, f, v, O, M, C, o, u, l];
}
class ks extends Cs {
  constructor(t) {
