import { g as Y, w as m, d as H, a as _ } from "./Index-DV7FKQ4f.js";
...
function ye(o, t, l) {
  ...
  return o.$$set = (a) => {
    l(17, t = S(S({}, t), E(a))), "svelteInit" in a && l(5, c = a.svelteInit), "$$scope" in a && l(6, s = a.$$scope);
      ...
      props: {
        svelteInit(s) {
          ...
          return c.nodes = [...c.nodes, u], P({
            ...
            c.nodes = c.nodes.filter((f) => f.svelteInstance !== r), P({
              createPortal: h,
              node: I
            });
          }), u;
...
function Re(o, t) {
  const l = j(() => C.Children.toArray(o.originalChildren || o).filter((e) => e.props.node && !e.props.node.ignore && (!e.props.nodeSlotKey || t)).sort((e, s) => {
