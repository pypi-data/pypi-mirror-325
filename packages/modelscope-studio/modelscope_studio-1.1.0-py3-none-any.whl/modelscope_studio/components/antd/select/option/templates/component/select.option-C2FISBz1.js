import { g as G, w as p } from "./Index-DUsJatPq.js";
...
function me(l) {
  ...
  return {
    c() {
      e = L("react-portal-target"), r = ce(), t && t.c(), n = S(), this.h();
    },
    l(o) {
      e = D(o, "REACT-PORTAL-TARGET", {
        class: !0
      }), j(e).forEach(_), r = te(o), t && t.l(o), n = S(), this.h();
    },
    h() {
      A(e, "class", "svelte-1rt0kpf");
    },
    ...
    p(o, [a]) {
      ...
      16 && g(t, 1)) : (t = E(o), t.c(), g(t, 1), t.m(n.parentNode, n)) : t && (re(), b(t, 1, 1, () => {
        t = null;
      }), ee());
    },
    i(o) {
...
function ge(l, e, r) {
  ...
  return l.$$set = (i) => {
    r(17, e = I(I({}, e), C(i))), "svelteInit" in i && r(5, c = i.svelteInit), "$$scope" in i && r(6, o = i.$$scope);
  }, e = C(e), [n, s, f, d, a, c, o, t, W, z];
}
class he extends $ {
  constructor(e) {
...
const {
  ...
  useItems: Ie,
  ItemHandler: be
} = H("antd-select-options"), xe = we((l) => /* @__PURE__ */ Z.jsx(be, {
  ...l,
