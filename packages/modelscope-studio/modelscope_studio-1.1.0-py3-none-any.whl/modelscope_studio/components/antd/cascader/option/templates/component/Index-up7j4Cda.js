...
function eu(e, t, n) {
  let r;
  const i = ["gradio", "props", "_internal", "value", "label", "as_item", "visible", "elem_id", "elem_classes", "elem_style"];
  let o = ht(t, i), a, s, u, l, {
    $$slots: d = {},
    $$scope: _
  } = t;
  const f = fs(() => import("./cascader.option-DUYzCfn-.js"));
  let {
    gradio: p
  } = t, {
    props: y = {}
  ...
  return ne(e, Ge, (g) => n(18, a = g)), e.$$set = (g) => {
    ...
    262145 && n(1, r = {
      props: {
        style: s.elem_style,
        className: Es(s.elem_classes, "ms-gr-antd-cascader-option"),
        id: s.elem_id,
        label: s.label,
        value: s.value,
        ...s.restProps,
