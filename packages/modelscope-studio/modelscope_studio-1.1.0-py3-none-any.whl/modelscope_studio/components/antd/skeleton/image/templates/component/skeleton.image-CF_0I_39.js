import { g as N, w as m } from "./Index-BzPu4Sn-.js";
  ...
  return {
    ...
    l(t) {
      s = D(t, "REACT-PORTAL-TARGET", {
        class: !0
      }), R(s).forEach(_), n = j(t), e && e.l(t), l = S(), this.h();
    },
    h() {
      K(s, "class", "svelte-1rt0kpf");
    },
...
function le(r, s, n) {
  ...
  return r.$$set = (a) => {
    n(17, s = v(v({}, s), E(a))), "svelteInit" in a && n(5, i = a.svelteInit), "$$scope" in a && n(6, t = a.$$scope);
