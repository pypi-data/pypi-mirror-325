import { g as N, w as m } from "./Index-cCm72beo.js";
...
function ne(r) {
  ...
  return {
    c() {
      s = D("react-portal-target"), n = Z(), e && e.c(), l = S(), this.h();
    },
    l(t) {
      s = R(t, "REACT-PORTAL-TARGET", {
        class: !0
      }), A(s).forEach(_), n = j(t), e && e.l(t), l = S(), this.h();
    },
    h() {
      K(s, "class", "svelte-1rt0kpf");
    },
...
const ie = ae(U.Avatar);
export {
  ie as SkeletonAvatar,
  ie as default
};
