import { g as B, w as p } from "./Index-k_eOywWm.js";
...
function me(r) {
  ...
  return {
    ...
    p(s, [i]) {
      ...
      16 && g(e, 1)) : (e = C(s), e.c(), g(e, 1), e.m(n.parentNode, n)) : e && (le(), w(e, 1, 1, () => {
        e = null;
      }), ee());
    },
    i(s) {
...
const {
  ...
  useItems: ye,
  ItemHandler: we
} = H("antd-checkbox-group-options"), xe = he((r) => /* @__PURE__ */ Z.jsx(we, {
  ...r
}));
export {
  xe as CheckboxGroupOption,
  xe as default
};
