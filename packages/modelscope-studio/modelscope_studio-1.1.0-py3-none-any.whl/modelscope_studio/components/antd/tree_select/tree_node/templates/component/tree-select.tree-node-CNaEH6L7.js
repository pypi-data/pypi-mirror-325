import { g as G, w as m } from "./Index-BPSXqogg.js";
...
function pe(r) {
  ...
  return {
    ...
    p(s, [i]) {
      ...
      16 && g(e, 1)) : (e = R(s), e.c(), g(e, 1), e.m(n.parentNode, n)) : e && (le(), h(e, 1, 1, () => {
        e = null;
      }), ee());
    },
    i(s) {
...
const {
  ...
  useItems: ye,
  ItemHandler: he
} = H("antd-tree-select-tree-nodes"), xe = be((r) => /* @__PURE__ */ Z.jsx(he, {
  ...r,
  allowedSlots: ["default"],
  itemChildren: (t) => t.default.length > 0 ? t.default : void 0
}));
export {
  xe as TreeSelectTreeNode,
  xe as default
};
