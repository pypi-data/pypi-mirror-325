...
function R(e) {
  return e == null ? e === void 0 ? pn : fn : Ke && Ke in Object(e) ? sn(e) : ln(e);
}
function C(e) {
...
var xt = typeof exports == "object" && exports && !exports.nodeType && exports, Ye = xt && typeof module == "object" && module && !module.nodeType && module, er = Ye && Ye.exports === xt, Xe = er ? S.Buffer : void 0, tr = Xe ? Xe.isBuffer : void 0, re = tr || kn, nr = "[object Arguments]", rr = "[object Array]", ir = "[object Boolean]", or = "[object Date]", ar = "[object Error]", sr = "[object Function]", ur = "[object Map]", cr = "[object Number]", lr = "[object Object]", fr = "[object RegExp]", pr = "[object Set]", gr = "[object String]", dr = "[object WeakMap]", _r = "[object ArrayBuffer]", br = "[object DataView]", hr = "[object Float32Array]", yr = "[object Float64Array]", mr = "[object Int8Array]", vr = "[object Int16Array]", Tr = "[object Int32Array]", wr = "[object Uint8Array]", Or = "[object Uint8ClampedArray]", Pr = "[object Uint16Array]", Ar = "[object Uint32Array]", m = {};
m[hr] = m[yr] = m[mr] = m[vr] = m[Tr] = m[wr] = m[Or] = m[Pr] = m[Ar] = !0;
m[nr] = m[rr] = m[_r] = m[ir] = m[br] = m[or] = m[ar] = m[sr] = m[ur] = m[cr] = m[lr] = m[fr] = m[pr] = m[gr] = m[dr] = !1;
function $r(e) {
...
var ao = "[object Boolean]", so = "[object Date]", uo = "[object Map]", co = "[object Number]", lo = "[object RegExp]", fo = "[object Set]", po = "[object String]", go = "[object Symbol]", _o = "[object ArrayBuffer]", bo = "[object DataView]", ho = "[object Float32Array]", yo = "[object Float64Array]", mo = "[object Int8Array]", vo = "[object Int16Array]", To = "[object Int32Array]", wo = "[object Uint8Array]", Oo = "[object Uint8ClampedArray]", Po = "[object Uint16Array]", Ao = "[object Uint32Array]";
function $o(e, t, n) {
  var r = e.constructor;
  switch (t) {
    case _o:
...
function te(e, t, n, r, i, o) {
  ...
  if (d)
    return d;
  o.set(e, a), Mo(e) ? e.forEach(function(l) {
    a.add(te(l, t, n, l, e, o));
  }) : Eo(e) && e.forEach(function(l, v) {
    a.set(v, te(l, t, n, v, e, o));
  });
  var b = c ? u ? Dt : he : u ? Ce : Q, _ = g ? void 0 : b(e);
  return Gn(_ || e, function(l, v) {
    _ && (v = l, l = e[v]), At(a, v, te(l, t, n, v, e, o));
  }), a;
}
...
function Bt(e, t, n, r, i, o) {
  ...
  for (o.set(e, t), o.set(t, e); ++p < s; ) {
    var b = e[p], _ = t[p];
    if (r)
      var l = a ? r(_, b, p, t, e, o) : r(b, _, p, e, t, o);
    if (l !== void 0) {
      if (l)
        continue;
      f = !1;
...
var _a = 1, ba = 2, ha = "[object Boolean]", ya = "[object Date]", ma = "[object Error]", va = "[object Map]", Ta = "[object Number]", wa = "[object RegExp]", Oa = "[object Set]", Pa = "[object String]", Aa = "[object Symbol]", $a = "[object ArrayBuffer]", Sa = "[object DataView]", ct = O ? O.prototype : void 0, ge = ct ? ct.valueOf : void 0;
...
function Ia(e, t, n, r, i, o) {
  var a = n & Ca, s = he(e), u = s.length, c = he(t), g = c.length;
  if (u != g && !a)
    return !1;
  for (var p = u; p--; ) {
    var f = s[p];
...
var Ma = 1, lt = "[object Arguments]", ft = "[object Array]", ee = "[object Object]", Fa = Object.prototype, pt = Fa.hasOwnProperty;
function La(e, t, n, r, i, o) {
  var a = A(e), s = A(t), u = a ? ft : P(e), c = s ? ft : P(t);
  u = u == lt ? ee : u, c = c == lt ? ee : c;
  var g = u == ee, p = c == ee, f = u == c;
  if (f && re(e)) {
    if (!re(t))
      return !1;
    a = !0, g = !1;
  ...
  if (!(n & Ma)) {
    ...
    if (d || b) {
      var _ = d ? e.value() : e, l = b ? t.value() : t;
      return o || (o = new $()), i(_, l, n, r, o);
    }
  }
...
function Da(e, t, n, r) {
  ...
  for (; ++i < o; ) {
    ...
    if (a[2]) {
      ...
      var g = new $(), p;
      if (!(p === void 0 ? Ne(c, u, Ra | Na, r, g) : p))
        return !1;
    }
  }
  return !0;
...
function gt(e, t) {
  ...
  return {
    ...Array.from(/* @__PURE__ */ new Set([...Object.keys(r).map((u) => {
      ...
      const g = c.split("_"), p = (...d) => {
        const b = d.map((l) => d && typeof l == "object" && (l.nativeEvent || l instanceof Event) ? {
          type: l.type,
          detail: l.detail,
        ...
        try {
          ...
          _ = b.map((l) => l && typeof l == "object" ? Object.fromEntries(Object.entries(l).filter(([, v]) => {
            try {
...
function x(e, t = G) {
  ...
  function a(s, u = G) {
    const c = [s, u];
    return r.add(c), r.size === 1 && (n = t(i, o) || G), s(e), () => {
...
function ks(e, t, n) {
  ...
  const g = cs(() => import("./space.compact-B3-ZL1F1.js"));
  let {
    gradio: p
  } = t, {
    props: f = {}
  ...
  return de(e, De, (h) => n(1, s = h)), e.$$set = (h) => {
    t = Te(Te({}, t), Ns(h)), n(18, i = bt(t, r)), "gradio" in h && n(6, p = h.gradio), "props" in h && n(7, f = h.props), "_internal" in h && n(8, b = h._internal), "as_item" in h && n(9, _ = h.as_item), "visible" in h && n(10, l = h.visible), "elem_id" in h && n(11, v = h.elem_id), "elem_classes" in h && n(12, w = h.elem_classes), "elem_style" in h && n(13, M = h.elem_style), "$$scope" in h && n(16, c = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && d.update((h) => ({
      ...h,
  ...
  }, [a, s, g, d, F, De, p, f, b, _, l, v, w, M, o, u, c];
}
class ru extends js {
  constructor(t) {
