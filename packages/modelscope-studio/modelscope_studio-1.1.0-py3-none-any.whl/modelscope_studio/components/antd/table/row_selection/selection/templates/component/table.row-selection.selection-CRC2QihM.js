import { g as G, w as m } from "./Index-DE-vD1wP.js";
const B = window.ms_globals.React, y = window.ms_globals.ReactDOM.createPortal, w = window.ms_globals.createItemsContext.createItemsContext;
var T = {
  exports: {}
}, g = {};
/**
...
function pe(l) {
  ...
  return {
    ...
    p(s, [i]) {
      ...
      16 && b(e, 1)) : (e = C(s), e.c(), b(e, 1), e.m(n.parentNode, n)) : e && (re(), I(e, 1, 1, () => {
        e = null;
      }), ee());
    },
    i(s) {
...
function be(l, t, r) {
  ...
  return l.$$set = (a) => {
    r(17, t = x(x({}, t), E(a))), "svelteInit" in a && r(5, c = a.svelteInit), "$$scope" in a && r(6, s = a.$$scope);
...
export {
  xe as TableRowSelectionSelection,
  xe as default
};
