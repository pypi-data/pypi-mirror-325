import { g as G, w as m } from "./Index-CUaeyypc.js";
...
const C = window.ms_globals.rerender, w = window.ms_globals.tree;
function we(r, t = {}) {
  function l(n) {
    const o = m(), e = new be({
      ...n,
...
const {
  ...
  useItems: ye,
  ItemHandler: he
} = H("antd-date-picker-presets"), ke = we((r) => /* @__PURE__ */ Z.jsx(he, {
  ...r
}));
export {
  ke as DatePickerPreset,
  ke as default
};
