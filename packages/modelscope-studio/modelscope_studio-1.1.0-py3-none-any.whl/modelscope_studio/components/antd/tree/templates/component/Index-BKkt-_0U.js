...
var $ = Array.isArray, dn = 1 / 0, Ue = O ? O.prototype : void 0, Ge = Ue ? Ue.toString : void 0;
function Tt(e) {
  if (typeof e == "string")
    return e;
  if ($(e))
...
var Pn = /[\\^$.*+?()[\]{}|]/g, On = /^\[object .+?Constructor\]$/, wn = Function.prototype, $n = Object.prototype, An = wn.toString, Sn = $n.hasOwnProperty, Cn = RegExp("^" + An.call(Sn).replace(Pn, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
function xn(e) {
  if (!z(e) || mn(e))
    return !1;
  var t = Ot(e) ? Cn : On;
...
var ye = D(S, "DataView"), me = D(S, "Promise"), ve = D(S, "Set"), et = "[object Map]", Yi = "[object Object]", tt = "[object Promise]", nt = "[object Set]", rt = "[object WeakMap]", it = "[object DataView]", Xi = N(ye), Ji = N(J), Zi = N(me), Wi = N(ve), Qi = N(he), w = R;
...
function La(e, t, n, r, i, o) {
  var a = $(e), s = $(t), u = a ? ct : w(e), l = s ? ct : w(t);
...
function Vs(e, t, n) {
  ...
  const g = ls(() => import("./tree-j5oTZHN0.js"));
  let {
    gradio: p
  } = t, {
    props: c = {}
  ...
  const tn = Ps();
  return e.$$set = (h) => {
    t = Te(Te({}, t), Rs(h)), n(19, i = ht(t, r)), "gradio" in h && n(7, p = h.gradio), "props" in h && n(8, c = h.props), "_internal" in h && n(9, y = h._internal), "as_item" in h && n(10, _ = h.as_item), "visible" in h && n(11, f = h.visible), "elem_id" in h && n(12, v = h.elem_id), "elem_classes" in h && n(13, P = h.elem_classes), "elem_style" in h && n(14, F = h.elem_style), "$$scope" in h && n(17, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && d.update((h) => ({
      ...h,
  ...
  }, [a, s, g, d, M, De, tn, p, c, y, _, f, v, P, F, o, u, l];
}
class tu extends Es {
  constructor(t) {
