import { a as P } from "./XProvider-BCUhPu_l.js";
import { i as o } from "./interopRequireDefault-BJV_i6Nz.js";
import { o as b, c as g } from "./common-DBXquc-F.js";
function j(s, f) {
...
n.default = void 0;
var D = u(i), S = u(c), F = u(t), w = u(r);
const e = "${label}は有効な${type}ではありません", A = {
  locale: "ja",
...
n.default = A;
var v = n;
const R = /* @__PURE__ */ P(v), K = /* @__PURE__ */ j({
  __proto__: null,
  default: R
}, [v]);
export {
