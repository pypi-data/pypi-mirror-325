import { a as g } from "./XProvider-BCUhPu_l.js";
import { i as o } from "./interopRequireDefault-BJV_i6Nz.js";
import { o as v, c as x } from "./common-DBXquc-F.js";
function y(m, p) {
    ...
    if (typeof a != "string" && !Array.isArray(a)) {
      for (const t in a)
        if (t !== "default" && !(t in m)) {
          ...
          b && Object.defineProperty(m, t, b.get ? b : {
            enumerable: !0,
            get: () => a[t]
          });
        }
...
n.default = void 0;
var Y = c(i), k = c(u), C = c(l), F = c(r);
const e = "${label} не е валиден ${type}", q = {
  locale: "bg",
...
n.default = q;
var $ = n;
const w = /* @__PURE__ */ g($), z = /* @__PURE__ */ y({
  __proto__: null,
  default: w
}, [$]);
export {
