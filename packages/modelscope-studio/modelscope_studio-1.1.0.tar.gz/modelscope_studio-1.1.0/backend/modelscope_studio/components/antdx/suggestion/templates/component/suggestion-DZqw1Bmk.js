import { i as Vt, a as Oe, r as Ft, b as Xt, g as Nt, w as Z, c as Ve, d as Ut } from "./Index-CGNPSyMQ.js";
...
function hr(t, e, n) {
  var o, r, s, i, a, c, l = 0, h = !1, u = !1, g = !0;
  if (typeof t != "function")
    throw new TypeError(lr);
  e = We(e) || 0, Oe(n) && (h = !!n.leading, u = "maxWait" in n, s = u ? ur(We(n.maxWait) || 0, e) : s, g = "trailing" in n ? !!n.trailing : g);
  function f(S) {
    var M = o, _ = r;
    return o = r = void 0, l = S, i = t.apply(_, M), i;
  }
  function b(S) {
    return l = S, a = setTimeout(m, e), h ? f(S) : i;
  }
  function d(S) {
    var M = S - c, _ = S - l, P = e - M;
    return u ? fr(P, s - _) : P;
  }
  function p(S) {
    var M = S - c, _ = S - l;
    return c === void 0 || M >= e || M < 0 || u && _ >= s;
  }
  function m() {
    var S = ve();
    if (p(S))
  ...
  function y(S) {
    return a = void 0, g && o ? f(S) : (o = r = void 0, i);
  }
  function C() {
...
function Ze(t) {
  ...
  return {
    ...
    h() {
      xt(e, "class", "svelte-1rt0kpf");
    },
    m(s, i) {
      Y(s, e, i), r && r.m(e, null), t[9](e), n = !0;
    },
    p(s, i) {
      r && r.p && (!n || i & /*$$scope*/
      64) && kr(
...
function Dr(t) {
  ...
  return {
    c() {
      e = St("react-portal-target"), n = Ir(), s && s.c(), o = Qe(), this.h();
    },
    l(i) {
      e = yt(i, "REACT-PORTAL-TARGET", {
        class: !0
      }), vt(e).forEach(G), n = Cr(i), s && s.l(i), o = Qe(), this.h();
    },
    h() {
      xt(e, "class", "svelte-1rt0kpf");
    },
    m(i, a) {
      Y(i, e, a), t[8](e), Y(i, n, a), s && s.m(i, a), Y(i, o, a), r = !0;
    },
    p(i, [a]) {
      /*$$slots*/
      i[4].default ? s ? (s.p(i, a), a & /*$$slots*/
      16 && ee(s, 1)) : (s = Ze(i), s.c(), ee(s, 1), s.m(o.parentNode, o)) : s && (Tr(), Te(s, 1, 1, () => {
        s = null;
      }), xr());
    },
    i(i) {
...
function Hr(t, e, n) {
  ...
  const u = Z();
  qe(t, u, (v) => n(1, r = v));
  const g = [], f = Rr("$$ms-gr-react-wrapper"), {
    slotKey: b,
    slotIndex: d,
    subSlotIndex: p
  } = Nt() || {}, m = c({
...
const $r = ["animationIterationCount", "borderImageOutset", "borderImageSlice", "borderImageWidth", "boxFlex", "boxFlexGroup", "boxOrdinalGroup", "columnCount", "columns", "flex", "flexGrow", "flexPositive", "flexShrink", "flexNegative", "flexOrder", "gridArea", "gridColumn", "gridColumnEnd", "gridColumnStart", "gridRow", "gridRowEnd", "gridRowStart", "lineClamp", "lineHeight", "opacity", "order", "orphans", "tabSize", "widows", "zIndex", "zoom", "fontWeight", "letterSpacing", "lineHeight"];
function Vr(t) {
...
function Fr(t, e) {
  return typeof e == "number" && !$r.includes(t) ? e + "px" : e;
}
function Ee(t) {
...
const Pe = dt(({
  ...
  return $t(() => {
    ...
    function g() {
      let d = u;
      if (u.tagName.toLowerCase() === "svelte-slot" && u.children.length === 1 && u.children[0] && (d = u.children[0], d.tagName.toLowerCase() === "react-portal-target" && d.children[0] && (d = d.children[0])), Xr(s, d), n && d.classList.add(...n.split(" ")), o) {
        const p = Vr(o);
    ...
    if (h && window.MutationObserver) {
      let d = function() {
        var C, v, O;
        (C = i.current) != null && C.contains(u) && ((v = i.current) == null || v.removeChild(u));
        const {
          portals: m,
          clonedElement: y
        } = Ee(t);
        u = y, c(m), u.style.display = "contents", g(), (O = i.current) == null || O.appendChild(u);
      };
      d();
      const p = hr(() => {
      ...
      u.style.display = "contents", g(), (b = i.current) == null || b.appendChild(u);
    return () => {
      var d, p;
      u.style.display = "", (d = i.current) != null && d.contains(u) && ((p = i.current) == null || p.removeChild(u)), f == null || f.disconnect();
    };
...
var rt = Zr() ? F.useLayoutEffect : F.useEffect, Yr = function(e, n) {
  var o = F.useRef(!0);
  rt(function() {
    return e(o.current);
  }, n), rt(function() {
...
function ot(t) {
  var e = F.useRef(!1), n = F.useState(t), o = N(n, 2), r = o[0], s = o[1];
...
function en(t, e) {
  ...
  }), c = N(a, 2), l = c[0], h = c[1], u = r !== void 0 ? r : l, g = i ? i(u) : u, f = te(s), b = ot([u]), d = N(b, 2), p = d[0], m = d[1];
  nt(function() {
    var C = p[0];
    l !== C && f(l, C);
  }, [p]), nt(function() {
...
x.isValidElementType = function(t) {
  return typeof t == "string" || typeof t == "function" || t === se || t === ae || t === ie || t === fe || t === he || t === rn || typeof t == "object" && t !== null && (t.$$typeof === ge || t.$$typeof === de || t.$$typeof === ce || t.$$typeof === le || t.$$typeof === ue || t.$$typeof === Ct || t.getModuleId !== void 0);
};
x.typeOf = D;
function nn(t, e) {
...
function on(t, e) {
  for (var n = 0; n < e.length; n++) {
    var o = e[n];
    o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(t, _t(o.key), o);
  }
}
function me(t, e, n) {
...
var cn = /* @__PURE__ */ function(t) {
  ...
  function n(o, r) {
    var s;
    pe(this, n), s = e.call(this), T(q(s), "result", ""), T(q(s), "unitlessCssVar", void 0), T(q(s), "lowPriority", void 0);
    var i = z(o);
...
}(Tt), ln = /* @__PURE__ */ function(t) {
  wt(n, t);
  var e = Mt(n);
  function n(o) {
    var r;
    return pe(this, n), r = e.call(this), T(q(r), "result", 0), o instanceof n ? r.result = o.result : typeof o == "number" && (r.result = o), r;
  }
  return me(n, [{
    key: "add",
    value: function(r) {
...
var Pt = typeof CSSINJS_STATISTIC < "u", je = !0;
function Ae() {
...
var hn = function(e) {
  var n, o = e, r = fn;
  return Pt && typeof Proxy < "u" && (n = /* @__PURE__ */ new Set(), o = new Proxy(e, {
    get: function(i, a) {
      if (je) {
        var c;
...
var gn = 1e3 * 60 * 10, pn = /* @__PURE__ */ function() {
  function t() {
    pe(this, t), T(this, "map", /* @__PURE__ */ new Map()), T(this, "objectIDMap", /* @__PURE__ */ new WeakMap()), T(this, "nextID", 0), T(this, "lastAccessBeat", /* @__PURE__ */ new Map()), T(this, "accessBeat", 0);
  }
  return me(t, [{
    key: "set",
    value: function(n, o) {
...
function vn(t) {
  ...
  function c(g, f, b, d) {
    var p = Array.isArray(g) ? g[0] : g;
    function m(_) {
      return "".concat(String(p)).concat(_.slice(0, 1).toUpperCase()).concat(_.slice(1));
    }
    var y = (d == null ? void 0 : d.unitless) || {}, C = typeof a == "function" ? a(g) : {}, v = L(L({}, C), {}, T({}, m("zIndexPopup"), !0));
    ...
    var O = L(L({}, d), {}, {
      unitless: v,
      prefixToken: m
    }), S = h(g, f, b, O), M = l(p, b, O);
    return function(_) {
      var P = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : _, j = S(_, P), B = N(j, 2), I = B[1], $ = M(P), R = N($, 2), A = R[0], U = R[1];
      return [A, I, U];
    };
  }
  function l(g, f, b) {
    var d = b.unitless, p = b.injectStyle, m = p === void 0 ? !0 : p, y = b.prefixToken, C = b.ignore, v = function(M) {
      var _ = M.rootCls, P = M.cssVar, j = P === void 0 ? {} : P, B = o(), I = B.realToken;
      return Zt({
        path: [g],
        prefix: j.prefix,
        key: j.key,
        ...
        var $ = lt(g, I, f), R = at(g, I, $, {
          deprecatedTokens: b == null ? void 0 : b.deprecatedTokens
        });
        return Object.keys($).forEach(function(A) {
          R[y(A)] = R[A], delete R[A];
        }), R;
      }), null;
    }, O = function(M) {
      var _ = o(), P = _.cssVar;
      return [function(j) {
        return m && P ? /* @__PURE__ */ w.createElement(w.Fragment, null, /* @__PURE__ */ w.createElement(v, {
          rootCls: M,
          cssVar: P,
          component: g
        }), j) : j;
  ...
  function h(g, f, b) {
    var d = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, p = Array.isArray(g) ? g : [g, g], m = N(p, 1), y = m[0], C = p.join("-"), v = t.layer || {
      name: "antd"
    };
    return function(O) {
      var S = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : O, M = o(), _ = M.theme, P = M.realToken, j = M.hashId, B = M.token, I = M.cssVar, $ = r(), R = $.rootPrefixCls, A = $.iconPrefixCls, U = n(), E = I ? "css" : "js", jt = mn(function() {
        var X = /* @__PURE__ */ new Set();
        return I && Object.keys(d.unitless || {}).forEach(function(Q) {
          X.add(be(Q, I.prefix)), X.add(be(Q, it(y, I.prefix)));
        }), un(E, X);
      }, [E, y, I == null ? void 0 : I.prefix]), De = dn(E), Rt = De.max, Lt = De.min, He = {
        theme: _,
        token: B,
        hashId: j,
        nonce: function() {
      ...
      var At = Ne(L(L({}, He), {}, {
        ...
        if (d.injectStyle === !1)
          return [];
        var X = hn(B), Q = X.token, Dt = X.flush, W = lt(y, P, b), Ht = ".".concat(O), ze = at(y, P, W, {
          deprecatedTokens: d.deprecatedTokens
        });
        I && W && z(W) === "object" && Object.keys(W).forEach(function($e) {
          W[$e] = "var(".concat(be($e, it(y, I.prefix)), ")");
        });
        var Be = Ae(Q, {
          componentCls: Ht,
          prefixCls: O,
        ...
        Dt(y, ze);
        var Bt = typeof i == "function" ? i(Be, O, S, d.resetFont) : null;
        return [d.resetStyle === !1 ? null : Bt, zt];
      });
      return [At, j];
    };
  }
  function u(g, f, b) {
    var d = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, p = h(g, f, b, L({
      resetStyle: !1,
      // Sub Style should default after root one
      order: -998
    }, d)), m = function(C) {
      var v = C.prefixCls, O = C.rootCls, S = O === void 0 ? v : O;
      return p(v, S), null;
    };
    return m;
  }
...
function J(t, e) {
  ...
  for (let l = 0.01; l <= 1; l += 0.01) {
    const h = Math.round((n - i * (1 - l)) / l), u = Math.round((o - a * (1 - l)) / l), g = Math.round((r - c * (1 - l)) / l);
    if (_e(h) && _e(u) && _e(g))
      return new V({
        r: h,
        g: u,
...
function Cn(t) {
  ...
  Object.keys(Sn).forEach((g) => {
    delete o[g];
  });
  const r = Object.assign(Object.assign({}, n), o), s = 480, i = 576, a = 768, c = 992, l = 1200, h = 1600;
  if (r.motion === !1) {
    const g = "0s";
    r.motionDurationFast = g, r.motionDurationMid = g, r.motionDurationSlow = g;
  }
...
function Tn() {
  const {
    ...
    override: o,
    cssVar: r
  } = w.useContext(Me._internalContext), [s, i, a] = er(n, [Me.defaultSeed, t], {
    salt: `${Nr}-${e || ""}`,
    override: o,
    getComputedToken: It,
    cssVar: r && {
...
const {
  genStyleHooks: En,
  genComponentStyleHook: Vn,
  genSubStyleComponent: Fn
} = vn({
  usePrefix: () => {
    const {
      getPrefixCls: t,
...
function jn(t, e, n, o, r) {
  const [s, i] = w.useState([]), a = (f, b = s) => {
    ...
    for (let p = 0; p < f - 1; p += 1) {
      const m = b[p], y = d.find((C) => C.value === m);
      if (!y)
        break;
      d = y.children || [];
    }
    ...
    const m = a(d + 1, f).find((y) => y.value === b);
    return m == null ? void 0 : m.value;
  }), l = (f) => {
    const b = s.length || 1, d = a(b), p = d.findIndex((C) => C.value === s[b - 1]), m = d.length, y = d[(p + f + m) % m];
...
function Rn(t) {
  const {
    ...
    direction: u,
    getPrefixCls: g
  } = Ie(), f = g("suggestion", e), b = `${f}-item`, d = u === "rtl", p = Gr("suggestion"), [m, y, C] = kn(f), [v, O] = en(!1, {
    value: i
  }), [S, M] = pt(), _ = (E) => {
    O(E), a == null || a(E);
  }, P = te((E) => {
    ...
    _(!1);
  }, B = w.useMemo(() => typeof c == "function" ? c(S) : c, [c, S]), I = (E) => /* @__PURE__ */ w.createElement(Jt, {
    className: b
    ...
    l && l(E[E.length - 1]), _(!1);
  }, [R, A] = jn(B, v, d, $, j), U = s == null ? void 0 : s({
    onTrigger: P,
    onKeyDown: A
  });
  return m(/* @__PURE__ */ w.createElement(Qt, {
    ...
    open: v,
    value: R,
    placement: d ? "topRight" : "topLeft",
    onDropdownVisibleChange: (E) => {
      E || j();
    },
    optionRender: I,
    rootClassName: Ve(o, f, y, C, {
      [`${f}-block`]: h
    }),
    onChange: $,
    dropdownMatchSelectWidth: h
  }, /* @__PURE__ */ w.createElement("div", {
    className: Ve(f, p.className, o, n, `${f}-wrapper`, y, C),
    style: {
      ...p.style,
      ...r
    }
...
function ht(t, e) {
  return ne(() => An(t, e), [t, e]);
}
function Dn(t) {
  const e = gt();
  return ne(() => dr(t, e.current) ? e.current : (e.current = t, t), [t]);
}
function kt(t, e, n) {
  ...
  if (o.length !== 0)
    return o.map((r, s) => {
      ...
      Object.keys(r.slots).forEach((h) => {
        ...
        const g = r.slots[h];
        let f, b, d = (e == null ? void 0 : e.clone) ?? !1, p = e == null ? void 0 : e.forceClone;
        g instanceof Element ? f = g : (f = g.el, b = g.callback, d = g.clone ?? d, p = g.forceClone ?? p), p = p ?? !!b, a[u[u.length - 1]] = f ? b ? (...m) => (b(u[u.length - 1], m), /* @__PURE__ */ H.jsx(Fe, {
          params: m,
          forceClone: p,
      ...
      return r[c] ? i[c] = kt(r[c], e, `${s}`) : e != null && e.children && (i[c] = void 0, Reflect.deleteProperty(i, c)), i;
    });
}
const {
  useItems: Hn,
  withItemsContextProvider: zn,
  ItemHandler: Xn
} = Kt("antdx-suggestion-chain-items"), Bn = dt(({
  children: t,
  props: e,
  shouldTrigger: n
}, o) => {
  const r = Dn(e);
  return /* @__PURE__ */ H.jsx(Gt.Provider, {
    value: ne(() => ({
      ...r,
      onKeyDown: (s) => {
        var i;
  ...
  const {
    items: s
  } = Hn(), i = s.items.length > 0 ? s.items : s.default, a = ht(e), c = ht(n);
