import { i as ae, a as B, r as ue, m as fe, b as de, c as me, d as _e } from "./Index-DYZRXVrm.js";
...
var G = NaN, ve = /^[-+]0x[0-9a-f]+$/i, Se = /^0b[01]+$/i, ke = /^0o[0-7]+$/i, we = parseInt;
function V(e) {
  if (typeof e == "number")
    return e;
  if (ae(e))
  ...
  e = Re(e);
  var n = Se.test(e);
  return n || ke.test(e) ? we(e.slice(2), n ? 2 : 8) : ve.test(e) ? G : +e;
}
var q = function() {
  return ue.Date.now();
}, Ie = "Expected a function", Oe = Math.max, Fe = Math.min;
function Te(e, t, n) {
  var s, o, r, i, l, p, d = 0, y = !1, u = !1, f = !0;
  if (typeof e != "function")
    throw new TypeError(Ie);
  t = V(t) || 0, B(n) && (y = !!n.leading, u = "maxWait" in n, r = u ? Oe(V(n.maxWait) || 0, t) : r, f = "trailing" in n ? !!n.trailing : f);
  function a(m) {
    var x = s, k = o;
    return s = o = void 0, d = m, i = e.apply(k, x), i;
  }
  function S(m) {
    return d = m, l = setTimeout(b, t), y ? a(m) : i;
  }
  function _(m) {
    var x = m - p, k = m - d, M = t - x;
    return u ? Fe(M, r - k) : M;
  }
  function g(m) {
    var x = m - p, k = m - d;
  ...
  function P(m) {
    return l = void 0, f && s ? a(m) : (s = o = void 0, i);
  }
  function C() {
    l !== void 0 && clearTimeout(l), d = 0, s = p = o = l = void 0;
  }
  function E() {
    return l === void 0 ? i : P(q());
  }
  function R() {
    var m = q(), x = g(m);
    if (s = arguments, o = this, p = m, x) {
      if (l === void 0)
        return S(p);
      if (u)
        return clearTimeout(l), l = setTimeout(b, t), a(p);
    }
    return l === void 0 && (l = setTimeout(b, t)), i;
  }
  return R.cancel = C, R.flush = E, R;
}
function L() {
}
function Me(e, t) {
...
function v(e, t = L) {
  ...
  function i(l, p = L) {
    const d = [l, p];
    return s.add(d), s.size === 1 && (n = t(o, r) || L), l(e), () => {
...
const lt = pe(({
  ...
  return he(() => {
    ...
    if (y && window.MutationObserver) {
      let _ = function() {
        var C, E, R;
        (C = i.current) != null && C.contains(u) && ((E = i.current) == null || E.removeChild(u));
        const {
          portals: b,
          clonedElement: P
        } = D(e);
        u = P, p(b), u.style.display = "contents", f(), (R = i.current) == null || R.appendChild(u);
      };
      _();
      const g = Te(() => {
      ...
      u.style.display = "contents", f(), (S = i.current) == null || S.appendChild(u);
    return () => {
      var _, g;
      u.style.display = "", (_ = i.current) != null && _.contains(u) && ((g = i.current) == null || g.removeChild(u)), a == null || a.disconnect();
    };
  }, [e, y, n, s, r, o]), I.createElement("react-child", {
    ref: i,
    style: {
      display: "contents"
    }
...
function Mt(e, t, n) {
  ...
  const u = me(() => import("./bubble.list.role-ImCyqQl6.js"));
  let {
    gradio: f
  } = t, {
    props: a = {}
  ...
  return e.$$set = (c) => {
    t = U(U({}, t), gt(c)), n(22, o = Y(t, s)), "gradio" in c && n(8, f = c.gradio), "props" in c && n(9, a = c.props), "_internal" in c && n(10, _ = c._internal), "as_item" in c && n(11, g = c.as_item), "visible" in c && n(12, b = c.visible), "elem_id" in c && n(13, P = c.elem_id), "elem_classes" in c && n(14, C = c.elem_classes), "elem_style" in c && n(15, E = c.elem_style), "$$scope" in c && n(19, y = c.$$scope);
  }, e.$$.update = () => {
    if (e.$$.dirty & /*props*/
    512 && S.update((c) => ({
      ...c,
    ...
    65537) {
      ...
      r.avatar ? c = z(r.avatar, {
        clone: !0
      }) : (r["avatar.icon"] || r["avatar.src"]) && (c = {
        ...c || {},
        icon: r["avatar.icon"] ? z(r["avatar.icon"], {
          clone: !0
        }) : c == null ? void 0 : c.icon,
        src: r["avatar.src"] ? z(r["avatar.src"], {
          clone: !0
        }) : c == null ? void 0 : c.src
      }), n(1, H = {
        props: {
  ...
  }, [i, H, p, u, S, R, m, M, f, a, _, g, b, P, C, E, r, l, d, y];
}
class jt extends ut {
  constructor(t) {
    super(), Et(this, t, Mt, Tt, vt, {
      gradio: 8,
      props: 9,
      _internal: 10,
      as_item: 11,
