...
import { o as b, c as k } from "./common-DBXquc-F.js";
function y(m, c) {
  for (var f = 0; f < c.length; f++) {
    ...
    if (typeof t != "string" && !Array.isArray(t)) {
      for (const a in t)
        if (a !== "default" && !(a in m)) {
          const g = Object.getOwnPropertyDescriptor(t, a);
          g && Object.defineProperty(m, a, g.get ? g : {
            enumerable: !0,
            get: () => t[a]
          });
        }
...
const e = "${label} er ikke en gyldig ${type}", R = {
  locale: "da",
