...
import { o as P, c as g } from "./common-DBXquc-F.js";
function x(m, f) {
    ...
    if (typeof a != "string" && !Array.isArray(a)) {
      for (const r in a)
        if (r !== "default" && !(r in m)) {
          ...
          s && Object.defineProperty(m, r, s.get ? s : {
            enumerable: !0,
            get: () => a[r]
          });
        }
...
n.default = A;
var v = n;
const F = /* @__PURE__ */ b(v), U = /* @__PURE__ */ x({
  __proto__: null,
  default: F
}, [v]);
export {
