...
import { o as j, c as k } from "./common-DBXquc-F.js";
function P(n, c) {
  for (var p = 0; p < c.length; p++) {
    ...
    if (typeof e != "string" && !Array.isArray(e)) {
      for (const a in e)
        if (a !== "default" && !(a in n)) {
          const v = Object.getOwnPropertyDescriptor(e, a);
          v && Object.defineProperty(n, a, v.get ? v : {
            enumerable: !0,
            get: () => e[a]
          });
        }
...
i.default = A;
var _ = i;
const N = /* @__PURE__ */ g(_), R = /* @__PURE__ */ P({
  __proto__: null,
  default: N
}, [_]);
export {
