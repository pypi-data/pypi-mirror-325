import { i as ae, a as B, r as ue, m as fe, b as de, c as me, d as _e } from "./Index-CenrW_9B.js";
  ...
  return he(() => {
    ...
    if (y && window.MutationObserver) {
      let _ = function() {
        ...
        u = P, p(b), u.style.display = "contents", f(), (v = i.current) == null || v.appendChild(u);
      };
      _();
      const g = Te(() => {
      ...
      u.style.display = "contents", f(), (R = i.current) == null || R.appendChild(u);
    return () => {
      var _, g;
...
function Mt(e, t, n) {
  ...
  const u = me(() => import("./bubble.list.item-C2rJxE3C.js"));
  let {
    gradio: f
  } = t, {
    props: a = {}
  ...
  }, [i, H, p, u, R, v, m, M, f, a, _, g, b, P, C, E, r, l, d, y];
}
class jt extends ut {
  constructor(t) {
