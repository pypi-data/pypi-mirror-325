import { i as le, a as W, r as ce, g as ae, w as k, c as ue } from "./Index-BrrbxHQk.js";
...
var j = function() {
  return ce.Date.now();
}, xe = "Expected a function", Ce = Math.max, ve = Math.min;
function Ie(e, t, s) {
  var i, o, n, r, l, u, p = 0, g = !1, c = !1, b = !0;
  if (typeof e != "function")
    throw new TypeError(xe);
  t = G(t) || 0, W(s) && (g = !!s.leading, c = "maxWait" in s, n = c ? Ce(G(s.maxWait) || 0, t) : n, b = "trailing" in s ? !!s.trailing : b);
  function m(d) {
    var w = i, R = o;
  ...
  return {
    ...
    l(r) {
      t = $(r, "REACT-PORTAL-TARGET", {
        class: !0
      }), Z(t).forEach(S), s = Ne(r), n && n.l(r), i = K(), this.h();
    },
    h() {
      te(t, "class", "svelte-1rt0kpf");
    },
...
function Xe(e, t, s) {
  ...
  const c = k();
  H(e, c, (a) => s(1, o = a));
  const b = [], m = Ke("$$ms-gr-react-wrapper"), {
    slotKey: x,
    slotIndex: f,
    subSlotIndex: _
  } = ae() || {}, h = u({
  ...
  return se(() => {
    ...
    if (g && window.MutationObserver) {
      let f = function() {
        ...
        c = C, u(h), c.style.display = "contents", b(), (I = r.current) == null || I.appendChild(c);
      };
      f();
      const _ = Ie(() => {
