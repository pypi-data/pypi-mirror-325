import { g as G, w as m } from "./Index-CjlijduD.js";
...
function pe(r) {
  ...
  return {
    ...
    p(s, [i]) {
      ...
      16 && g(e, 1)) : (e = C(s), e.c(), g(e, 1), e.m(n.parentNode, n)) : e && (le(), h(e, 1, 1, () => {
        e = null;
      }), ee());
    },
    i(s) {
...
function ge(r, t, l) {
  ...
  return r.$$set = (a) => {
    l(17, t = y(y({}, t), R(a))), "svelteInit" in a && l(5, c = a.svelteInit), "$$scope" in a && l(6, s = a.$$scope);
...
const S = window.ms_globals.rerender, w = window.ms_globals.tree;
function we(r, t = {}) {
  function l(n) {
    const o = m(), e = new be({
      ...n,
      props: {
        svelteInit(s) {
          ...
          return c.nodes = [...c.nodes, i], S({
            createPortal: I,
            node: w
          }), s.onDestroy(() => {
            c.nodes = c.nodes.filter((u) => u.svelteInstance !== o), S({
              createPortal: I,
              node: w
            });
          }), i;
...
const {
  ...
  useItems: ye,
  ItemHandler: he
} = H("antd-color-picker-presets"), ke = we((r) => /* @__PURE__ */ Z.jsx(he, {
  ...r
}));
export {
  ke as ColorPickerPreset,
  ke as default
};
