...
m[hr] = m[yr] = m[mr] = m[vr] = m[Tr] = m[wr] = m[Pr] = m[Or] = m[$r] = !0;
...
var Fe = It(Object.getPrototypeOf, Object), Pi = "[object Object]", Oi = Function.prototype, $i = Object.prototype, Mt = Oi.toString, Ai = $i.hasOwnProperty, Si = Mt.call(Object);
function Ci(e) {
  if (!x(e) || R(e) != Pi)
    return !1;
  var t = Fe(e);
...
var ye = D(S, "DataView"), me = D(S, "Promise"), ve = D(S, "Set"), et = "[object Map]", Yi = "[object Object]", tt = "[object Promise]", nt = "[object Set]", rt = "[object WeakMap]", it = "[object DataView]", Xi = N(ye), Ji = N(J), Zi = N(me), Wi = N(ve), Qi = N(be), O = R;
...
var _a = 1, ba = 2, ha = "[object Boolean]", ya = "[object Date]", ma = "[object Error]", va = "[object Map]", Ta = "[object Number]", wa = "[object RegExp]", Pa = "[object Set]", Oa = "[object String]", $a = "[object Symbol]", Aa = "[object ArrayBuffer]", Sa = "[object DataView]", lt = P ? P.prototype : void 0, ge = lt ? lt.valueOf : void 0;
...
function Vs(e, t, n) {
  ...
  const g = ls(() => import("./drawer-CMRvNcto.js"));
  let {
    gradio: p
  } = t, {
    props: c = {}
  ...
  return de(e, De, (b) => n(1, s = b)), e.$$set = (b) => {
    t = Te(Te({}, t), Rs(b)), n(19, i = bt(t, r)), "gradio" in b && n(7, p = b.gradio), "props" in b && n(8, c = b.props), "_internal" in b && n(9, y = b._internal), "as_item" in b && n(10, _ = b.as_item), "visible" in b && n(11, f = b.visible), "elem_id" in b && n(12, v = b.elem_id), "elem_classes" in b && n(13, w = b.elem_classes), "elem_style" in b && n(14, M = b.elem_style), "$$scope" in b && n(17, l = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && d.update((b) => ({
      ...b,
  ...
  }, [a, s, g, d, F, tn, De, p, c, y, _, f, v, w, M, o, u, l];
}
class tu extends Es {
  constructor(t) {
