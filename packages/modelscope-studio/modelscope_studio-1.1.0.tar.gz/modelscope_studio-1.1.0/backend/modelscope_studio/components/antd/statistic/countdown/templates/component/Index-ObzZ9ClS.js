...
var ye = K(S, "DataView"), me = K(S, "Promise"), ve = K(S, "Set"), et = "[object Map]", Yi = "[object Object]", tt = "[object Promise]", nt = "[object Set]", rt = "[object WeakMap]", it = "[object DataView]", Xi = D(ye), Ji = D(X), Zi = D(me), Wi = D(ve), Qi = D(he), P = N;
...
function ee(e, t, n, r, i, o) {
  ...
  var y = l ? u ? Dt : be : u ? xe : W, _ = d ? void 0 : y(e);
...
function Bt(e, t, n, r, i, o) {
  ...
  if (l && d)
    return l == t && d == e;
  var p = -1, f = !0, g = n & pa ? new oe() : void 0;
...
function Ia(e, t, n, r, i, o) {
  var a = n & xa, s = be(e), u = s.length, l = be(t), d = l.length;
  if (u != d && !a)
    return !1;
  for (var p = u; p--; ) {
    var f = s[p];
...
function Ws(e, t, n) {
  ...
  const d = ls(() => import("./statistic.countdown-DiM96-G9.js"));
  let {
    gradio: p
  } = t, {
    _internal: f = {}
  ...
  return de(e, De, (h) => n(0, a = h)), e.$$set = (h) => {
    t = Te(Te({}, t), Fs(h)), n(19, i = ht(t, r)), "gradio" in h && n(6, p = h.gradio), "_internal" in h && n(7, f = h._internal), "as_item" in h && n(8, g = h.as_item), "props" in h && n(9, y = h.props), "value" in h && n(10, _ = h.value), "elem_id" in h && n(11, v = h.elem_id), "elem_classes" in h && n(12, w = h.elem_classes), "elem_style" in h && n(13, F = h.elem_style), "visible" in h && n(14, C = h.visible), "$$scope" in h && n(17, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    512 && c.update((h) => ({
      ...h,
  ...
  }, [a, s, d, c, L, De, p, f, g, y, _, v, w, F, C, o, u, l];
}
class ks extends Cs {
  constructor(t) {
