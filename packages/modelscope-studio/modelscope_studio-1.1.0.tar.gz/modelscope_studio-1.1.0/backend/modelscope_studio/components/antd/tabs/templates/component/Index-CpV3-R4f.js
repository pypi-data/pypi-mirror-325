...
function Vs(e, t, n) {
  ...
  const g = ls(() => import("./tabs-dVbcH8WR.js"));
  let {
    gradio: p
  } = t, {
    props: f = {}
  ...
  return de(e, De, (b) => n(1, s = b)), e.$$set = (b) => {
    t = Te(Te({}, t), Rs(b)), n(19, i = bt(t, r)), "gradio" in b && n(7, p = b.gradio), "props" in b && n(8, f = b.props), "_internal" in b && n(9, y = b._internal), "as_item" in b && n(10, _ = b.as_item), "visible" in b && n(11, c = b.visible), "elem_id" in b && n(12, v = b.elem_id), "elem_classes" in b && n(13, P = b.elem_classes), "elem_style" in b && n(14, F = b.elem_style), "$$scope" in b && n(17, l = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && d.update((b) => ({
      ...b,
