import { i as ae, a as D, r as de, g as ue, w as R } from "./Index-CSmcBD5q.js";
...
var B = NaN, we = /^[-+]0x[0-9a-f]+$/i, xe = /^0b[01]+$/i, Ee = /^0o[0-7]+$/i, ye = parseInt;
function H(e) {
  if (typeof e == "number")
    return e;
  if (ae(e))
  ...
  e = be(e);
  var s = xe.test(e);
  return s || Ee.test(e) ? ye(e.slice(2), s ? 2 : 8) : we.test(e) ? B : +e;
}
var L = function() {
  return de.Date.now();
...
function Se(e, t, s) {
  ...
  t = H(t) || 0, D(s) && (h = !!s.leading, c = "maxWait" in s, n = c ? ve(H(s.maxWait) || 0, t) : n, g = "trailing" in s ? !!s.trailing : g);
  function u(p) {
    var y = l, O = o;
    return l = o = void 0, b = p, r = e.apply(O, y), r;
  }
  function w(p) {
    return b = p, i = setTimeout(_, t), h ? u(p) : r;
  }
  function f(p) {
    var y = p - a, O = p - b, F = t - y;
    return c ? Ie(F, n - O) : F;
  }
  function m(p) {
    var y = p - a, O = p - b;
    return a === void 0 || y >= t || y < 0 || c && O >= n;
  }
  function _() {
    var p = L();
    if (m(p))
 ...
 */
var Oe = C, Re = Symbol.for("react.element"), Te = Symbol.for("react.fragment"), ke = Object.prototype.hasOwnProperty, Pe = Oe.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, je = {
  key: !0,
  ref: !0,
  __self: !0,
  __source: !0
  ...
  return {
    ...
    l(r) {
      t = ee(r, "REACT-PORTAL-TARGET", {
        class: !0
      }), $(t).forEach(S), s = Ae(r), n && n.l(r), l = V(), this.h();
    },
    h() {
      ne(t, "class", "svelte-1rt0kpf");
    },
    ...
    p(r, [i]) {
      ...
      16 && k(n, 1)) : (n = X(r), n.c(), k(n, 1), n.m(l.parentNode, l)) : n && (Ue(), W(n, 1, 1, () => {
        n = null;
      }), Ne());
    },
    i(r) {
  ...
  if (l.length !== 0)
    return l.map((o, n) => {
      ...
      Object.keys(o.slots).forEach((h) => {
        ...
        g instanceof Element ? u = g : (u = g.el, w = g.callback, f = g.clone ?? f, m = g.forceClone ?? m), m = m ?? !!w, i[c[c.length - 1]] = u ? w ? (..._) => (w(c[c.length - 1], _), /* @__PURE__ */ x.jsx(U, {
          params: _,
          forceClone: m,
          children: /* @__PURE__ */ x.jsx(P, {
            slot: u,
            clone: f
          })
        })) : /* @__PURE__ */ x.jsx(U, {
...
const {
  ...
  useItems: ot,
  ItemHandler: lt
} = pe("antd-timeline-items"), it = Ze(rt(["items", "default"], ({
  slots: e,
  items: t,
  children: s,
  ...l
  ...
  const {
    items: o
  } = ot(), n = o.items.length > 0 ? o.items : o.default;
  return /* @__PURE__ */ x.jsxs(x.Fragment, {
    children: [/* @__PURE__ */ x.jsx("div", {
      ...
      ...l,
      items: ce(() => t || re(n), [t, n]),
      pending: e.pending ? /* @__PURE__ */ x.jsx(P, {
        slot: e.pending
      }) : l.pending,
      pendingDot: e.pendingDot ? /* @__PURE__ */ x.jsx(P, {
        slot: e.pendingDot
      }) : l.pendingDot
    })]
  });
