...
m[br] = m[yr] = m[mr] = m[vr] = m[Tr] = m[Pr] = m[wr] = m[Or] = m[$r] = !0;
...
var Me = It(Object.getPrototypeOf, Object), wi = "[object Object]", Oi = Function.prototype, $i = Object.prototype, Ft = Oi.toString, Ai = $i.hasOwnProperty, Si = Ft.call(Object);
function Ci(e) {
  if (!x(e) || R(e) != wi)
    return !1;
  var t = Me(e);
...
var _a = 1, ha = 2, ba = "[object Boolean]", ya = "[object Date]", ma = "[object Error]", va = "[object Map]", Ta = "[object Number]", Pa = "[object RegExp]", wa = "[object Set]", Oa = "[object String]", $a = "[object Symbol]", Aa = "[object ArrayBuffer]", Sa = "[object DataView]", lt = w ? w.prototype : void 0, ge = lt ? lt.valueOf : void 0;
...
function Vs(e, t, n) {
  ...
  const g = ls(() => import("./menu-BSC6LXGg.js"));
  let {
    gradio: p
  } = t, {
    props: c = {}
