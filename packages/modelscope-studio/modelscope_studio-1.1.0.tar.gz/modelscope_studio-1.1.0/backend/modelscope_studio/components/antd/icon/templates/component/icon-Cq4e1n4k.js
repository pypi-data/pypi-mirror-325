import { g as V, w as m } from "./Index-BgEDBeIN.js";
...
function we(l) {
  ...
  return {
    c() {
      t = A("react-portal-target"), r = ue(), e && e.c(), n = E(), this.h();
    },
    l(o) {
      t = L(o, "REACT-PORTAL-TARGET", {
        class: !0
      }), F(t).forEach(_), r = ne(o), e && e.l(o), n = E(), this.h();
    },
    h() {
      N(t, "class", "svelte-1rt0kpf");
    },
    ...
    p(o, [a]) {
      ...
      16 && g(e, 1)) : (e = S(o), e.c(), g(e, 1), e.m(n.parentNode, n)) : e && (ae(), y(e, 1, 1, () => {
        e = null;
      }), oe());
    },
    i(o) {
...
function be(l, t, r) {
  ...
  return l.$$set = (c) => {
    r(17, t = x(x({}, t), C(c))), "svelteInit" in c && r(5, i = c.svelteInit), "$$scope" in c && r(6, o = c.$$scope);
  }, t = C(t), [n, s, f, d, a, i, o, e, B, G];
}
class he extends te {
  constructor(t) {
