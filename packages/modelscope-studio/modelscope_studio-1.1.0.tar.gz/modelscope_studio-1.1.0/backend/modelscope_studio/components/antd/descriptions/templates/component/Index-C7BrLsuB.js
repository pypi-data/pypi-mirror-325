...
function Ws(e, t, n) {
  ...
  const g = ls(() => import("./descriptions-CJbcy-Wv.js"));
  let {
    gradio: p
  } = t, {
    props: c = {}
  ...
  return de(e, De, (h) => n(1, s = h)), e.$$set = (h) => {
    t = Te(Te({}, t), Fs(h)), n(19, i = ht(t, r)), "gradio" in h && n(6, p = h.gradio), "props" in h && n(7, c = h.props), "_internal" in h && n(8, y = h._internal), "title" in h && n(9, _ = h.title), "as_item" in h && n(10, f = h.as_item), "visible" in h && n(11, v = h.visible), "elem_id" in h && n(12, O = h.elem_id), "elem_classes" in h && n(13, F = h.elem_classes), "elem_style" in h && n(14, C = h.elem_style), "$$scope" in h && n(17, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && d.update((h) => ({
      ...h,
  ...
  }, [a, s, g, d, L, De, p, c, y, _, f, v, O, F, C, o, u, l];
}
class ks extends Cs {
  constructor(t) {
