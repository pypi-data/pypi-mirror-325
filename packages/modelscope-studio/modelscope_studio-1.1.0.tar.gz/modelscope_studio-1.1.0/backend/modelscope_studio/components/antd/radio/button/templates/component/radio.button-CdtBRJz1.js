import { g as G, w as m } from "./Index-CYCwHKIJ.js";
...
function ge(l) {
  ...
  return {
    c() {
      t = C("react-portal-target"), r = _e(), e && e.c(), n = E(), this.h();
    },
    l(s) {
      t = L(s, "REACT-PORTAL-TARGET", {
        class: !0
      }), D(t).forEach(_), r = se(s), e && e.l(s), n = E(), this.h();
    },
    h() {
      A(t, "class", "svelte-1rt0kpf");
    },
