import { i as ae, a as W, r as ce, g as ue, w as O, d as de, b as R } from "./Index-BoR2sEyG.js";
...
function Ce(e, t, o) {
  ...
  function p(d) {
    var y = s, S = i;
    return s = i = void 0, m = d, r = e.apply(S, y), r;
  }
  function w(d) {
 ...
 */
var Se = x, Te = Symbol.for("react.element"), Re = Symbol.for("react.fragment"), Oe = Object.prototype.hasOwnProperty, ke = Se.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, Le = {
  key: !0,
  ref: !0,
  __self: !0,
  __source: !0
  ...
  return {
    ...
    l(r) {
      t = re(r, "REACT-PORTAL-TARGET", {
        class: !0
      }), ne(t).forEach(C), o = Ne(r), n && n.l(r), s = K(), this.h();
    },
    h() {
      se(t, "class", "svelte-1rt0kpf");
    },
