...
function eu(e, t, n) {
  ...
  const f = fs(() => import("./date-picker.preset-RsKXtqxu.js"));
  let {
    gradio: p
  } = t, {
    props: y = {}
  ...
  return ne(e, Ge, (g) => n(18, a = g)), e.$$set = (g) => {
    ...
    262145 && n(1, r = {
      props: {
        style: s.elem_style,
        className: Es(s.elem_classes, "ms-gr-antd-date-picker-preset"),
        id: s.elem_id,
        label: s.label,
        value: s.value,
        ...s.restProps,
