...
class V1WorkflowNodeArtifacts(BaseModel):
    """
    V1WorkflowNodeArtifacts
    """ # noqa: E501
    artifacts: Optional[List[V1WorkflowNodeArtifact]] = Field(default=None, description="Output only. List of the WorkflowNodeArtifacts produced by the WorkflowNode.")
