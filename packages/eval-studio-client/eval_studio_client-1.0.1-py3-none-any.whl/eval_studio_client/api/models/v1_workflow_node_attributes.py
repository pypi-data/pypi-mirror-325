...
class V1WorkflowNodeAttributes(BaseModel):
    """
    WorkflowNodeAttributes represents additional attributes of a WorkflowNode.
    """ # noqa: E501
    can_delete: Optional[StrictBool] = Field(default=None, description="Whether the WorkflowNode can be deleted.", alias="canDelete")
    __properties: ClassVar[List[str]] = ["canDelete"]
