...
def get_compute_instance(filesystems: Optional[Sequence[Union['GetComputeInstanceFilesystemArgs', 'GetComputeInstanceFilesystemArgsDict']]] = None,
    ...
    :param Sequence[Union['GetComputeInstanceLocalDiskArgs', 'GetComputeInstanceLocalDiskArgsDict']] local_disks: List of local disks that are attached to the instance. Structure is documented below.
    :param str maintenance_grace_period: Time between notification via metadata service and maintenance. E.g., `60s`.
    :param str maintenance_policy: Behaviour on maintenance events. The default is `unspecified`. Values: `unspecified`, `migrate`, `restart`.
    :param Union['GetComputeInstanceMetadataOptionsArgs', 'GetComputeInstanceMetadataOptionsArgsDict'] metadata_options: Options allow user to configure access to instance's metadata
    :param str name: Name of the instance.
    :param Union['GetComputeInstancePlacementPolicyArgs', 'GetComputeInstancePlacementPolicyArgsDict'] placement_policy: The placement policy configuration. The structure is documented below.
    """
    __args__ = dict()
