...
class KubernetesClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] service_account_id: Service account to be used for provisioning Compute Cloud and VPC resources for Kubernetes cluster. Selected service account should have `edit` role on the folder where the Kubernetes cluster will be located and on the folder where selected network resides.
        :param pulumi.Input[str] cluster_ipv4_range: CIDR block. IP range for allocating pod addresses. It should not overlap with any subnet in the network the Kubernetes cluster located in. Static routes will be set up for this CIDR blocks in node subnets.
        ...
        :param pulumi.Input[str] service_ipv4_range: CIDR block. IP range Kubernetes service Kubernetes cluster IP addresses will be allocated from. It should not overlap with any subnet in the network the Kubernetes cluster located in.
...
class KubernetesCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: A set of key/value label pairs to assign to the Kubernetes cluster.
        :param pulumi.Input[Union['KubernetesClusterMasterArgs', 'KubernetesClusterMasterArgsDict']] master: Kubernetes master configuration options. The structure is documented below.
        :param pulumi.Input[str] name: Name of a specific Kubernetes cluster.
        :param pulumi.Input[str] network_id: The ID of the cluster network.
        :param pulumi.Input[Union['KubernetesClusterNetworkImplementationArgs', 'KubernetesClusterNetworkImplementationArgsDict']] network_implementation: (Optional) Network Implementation options. The structure is documented below.
        :param pulumi.Input[str] network_policy_provider: Network policy provider for the cluster. Possible values: `CALICO`.
        :param pulumi.Input[int] node_ipv4_cidr_mask_size: Size of the masks that are assigned to each node in the cluster. Effectively limits maximum number of pods for each node.
        :param pulumi.Input[str] release_channel: Cluster release channel.
        :param pulumi.Input[str] service_account_id: Service account to be used for provisioning Compute Cloud and VPC resources for Kubernetes cluster. Selected service account should have `edit` role on the folder where the Kubernetes cluster will be located and on the folder where selected network resides.
