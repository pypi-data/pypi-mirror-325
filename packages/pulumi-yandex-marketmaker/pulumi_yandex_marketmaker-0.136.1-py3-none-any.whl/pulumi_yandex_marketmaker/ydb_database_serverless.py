...
class YdbDatabaseServerlessArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] folder_id: ID of the folder that the Yandex Database serverless cluster belongs to. It will be deduced from provider configuration if not set explicitly.
...
class _YdbDatabaseServerlessState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] database_path: Full database path of the Yandex Database serverless cluster. Useful for SDK configuration.
        :param pulumi.Input[bool] deletion_protection: Inhibits deletion of the database. Can be either `true` or `false`
        :param pulumi.Input[str] description: A description for the Yandex Database serverless cluster.
        ...
        :param pulumi.Input[bool] tls_enabled: Whether TLS is enabled for the Yandex Database serverless cluster. Useful for SDK configuration.
        :param pulumi.Input[str] ydb_api_endpoint: API endpoint of the Yandex Database serverless cluster. Useful for SDK configuration.
