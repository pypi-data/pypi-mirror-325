...
class ResourcemanagerFolderIamPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] policy_data: The `get_iam_policy` data source that represents the IAM policy that will be applied to the folder. This policy overrides any existing policy applied to the folder.
        """
    ...
    def policy_data(self) -> pulumi.Input[str]:
        """
        The `get_iam_policy` data source that represents the IAM policy that will be applied to the folder. This policy overrides any existing policy applied to the folder.
        """
