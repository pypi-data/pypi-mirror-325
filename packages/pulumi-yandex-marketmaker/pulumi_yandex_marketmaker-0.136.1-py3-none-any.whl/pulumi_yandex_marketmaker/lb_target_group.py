...
class LbTargetGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: An optional description of the target group. Provide this property when you create the resource.
        ...
        :param pulumi.Input[str] region_id: ID of the availability zone where the target group resides. If omitted, default region is being used.
...
class LbTargetGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] name: Name of the target group. Provided by the client when the target group is created.
        :param pulumi.Input[str] region_id: ID of the availability zone where the target group resides. If omitted, default region is being used.
        :param pulumi.Input[Sequence[pulumi.Input[Union['LbTargetGroupTargetArgs', 'LbTargetGroupTargetArgsDict']]]] targets: A Target resource. The structure is documented below.
        """
        ...
    @overload
    def __init__(__self__,
