...
def get_function(concurrency: Optional[int] = None,
    ...
    :param int concurrency: The maximum number of requests processed by a function instance at the same time
    :param Union['GetFunctionConnectivityArgs', 'GetFunctionConnectivityArgsDict'] connectivity: Function version connectivity. If specified the version will be attached to specified network
    ...
    :param Sequence[Union['GetFunctionMountArgs', 'GetFunctionMountArgsDict']] mounts: Mounts for Yandex Cloud Function.
    :param str name: Yandex Cloud Function name used to define function
    :param Sequence[Union['GetFunctionSecretArgs', 'GetFunctionSecretArgsDict']] secrets: Secrets for Yandex Cloud Function.
    :param Sequence[Union['GetFunctionStorageMountArgs', 'GetFunctionStorageMountArgsDict']] storage_mounts: (**DEPRECATED**, use `mounts.0.object_storage` instead) Storage mounts for Yandex Cloud Function
    """
    __args__ = dict()
...
def get_function_output(concurrency: Optional[pulumi.Input[Optional[int]]] = None,
