...
class MdbGreenplumClusterArgs:
    def __init__(__self__, *,
                 ...
                 master_host_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 ...
                 segment_host_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] master_host_group_ids: A list of IDs of the host groups to place master subclusters' VMs of the cluster on.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] segment_host_group_ids: A list of IDs of the host groups to place segment subclusters' VMs of the cluster on.
        """
    ...
    def master_host_group_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def master_host_group_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
    ...
    def segment_host_group_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def segment_host_group_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
...
class MdbGreenplumCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['MdbGreenplumClusterAccessArgs', 'MdbGreenplumClusterAccessArgsDict']] access: Access policy to the Greenplum cluster. The structure is documented below.
        :param pulumi.Input[bool] assign_public_ip: Sets whether the master hosts should get a public IP address on creation. Changing this parameter for an existing host is not supported at the moment.
        :param pulumi.Input[Union['MdbGreenplumClusterBackupWindowStartArgs', 'MdbGreenplumClusterBackupWindowStartArgsDict']] backup_window_start: Time to start the daily backup, in the UTC timezone. The structure is documented below.
        :param pulumi.Input[Union['MdbGreenplumClusterCloudStorageArgs', 'MdbGreenplumClusterCloudStorageArgsDict']] cloud_storage: Cloud Storage settings of the Greenplum cluster. The structure is documented below.
        :param pulumi.Input[bool] deletion_protection: Inhibits deletion of the cluster. Can be either `true` or `false`.
        :param pulumi.Input[str] description: Description of the Greenplum cluster.
        :param pulumi.Input[str] environment: Deployment environment of the Greenplum cluster. (PRODUCTION, PRESTABLE)
        :param pulumi.Input[str] folder_id: The ID of the folder that the resource belongs to. If it is not provided, the default provider folder is used.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] greenplum_config: Greenplum cluster config. Detail info in "Greenplum cluster settings" section (documented below).
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: A set of key/value label pairs to assign to the Greenplum cluster.
        :param pulumi.Input[Union['MdbGreenplumClusterMaintenanceWindowArgs', 'MdbGreenplumClusterMaintenanceWindowArgsDict']] maintenance_window: Maintenance policy of the Greenplum cluster. The structure is documented below.
        :param pulumi.Input[int] master_host_count: Number of hosts in master subcluster (1 or 2).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] master_host_group_ids: A list of IDs of the host groups to place master subclusters' VMs of the cluster on.
        :param pulumi.Input[Union['MdbGreenplumClusterMasterSubclusterArgs', 'MdbGreenplumClusterMasterSubclusterArgsDict']] master_subcluster: Settings for master subcluster. The structure is documented below.
        :param pulumi.Input[str] name: Name of the Greenplum cluster. Provided by the client when the cluster is created.
        :param pulumi.Input[str] network_id: ID of the network, to which the Greenplum cluster uses.
        :param pulumi.Input[Union['MdbGreenplumClusterPoolerConfigArgs', 'MdbGreenplumClusterPoolerConfigArgsDict']] pooler_config: Configuration of the connection pooler. The structure is documented below.
        :param pulumi.Input[Union['MdbGreenplumClusterPxfConfigArgs', 'MdbGreenplumClusterPxfConfigArgsDict']] pxf_config: Configuration of the PXF daemon. The structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] security_group_ids: A set of ids of security groups assigned to hosts of the cluster.
        :param pulumi.Input[int] segment_host_count: Number of hosts in segment subcluster (from 1 to 32).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] segment_host_group_ids: A list of IDs of the host groups to place segment subclusters' VMs of the cluster on.
        :param pulumi.Input[int] segment_in_host: Number of segments on segment host (not more then 1 + RAM/8).
        :param pulumi.Input[Union['MdbGreenplumClusterSegmentSubclusterArgs', 'MdbGreenplumClusterSegmentSubclusterArgsDict']] segment_subcluster: Settings for segment subcluster. The structure is documented below.
        :param pulumi.Input[str] subnet_id: The ID of the subnet, to which the hosts belongs. The subnet must be a part of the network to which the cluster belongs.
        :param pulumi.Input[str] user_name: Greenplum cluster admin user name.
        :param pulumi.Input[str] user_password: Greenplum cluster admin password name.
        :param pulumi.Input[str] version: Version of the Greenplum cluster. (6.22 or 6.25)
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[int] master_host_count: Number of hosts in master subcluster (1 or 2).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] master_host_group_ids: A list of IDs of the host groups to place master subclusters' VMs of the cluster on.
        :param pulumi.Input[Sequence[pulumi.Input[Union['MdbGreenplumClusterMasterHostArgs', 'MdbGreenplumClusterMasterHostArgsDict']]]] master_hosts: (Computed) Info about hosts in master subcluster. The structure is documented below.
        :param pulumi.Input[Union['MdbGreenplumClusterMasterSubclusterArgs', 'MdbGreenplumClusterMasterSubclusterArgsDict']] master_subcluster: Settings for master subcluster. The structure is documented below.
        :param pulumi.Input[str] name: Name of the Greenplum cluster. Provided by the client when the cluster is created.
        :param pulumi.Input[str] network_id: ID of the network, to which the Greenplum cluster uses.
        :param pulumi.Input[Union['MdbGreenplumClusterPoolerConfigArgs', 'MdbGreenplumClusterPoolerConfigArgsDict']] pooler_config: Configuration of the connection pooler. The structure is documented below.
        ...
        :param pulumi.Input[int] segment_host_count: Number of hosts in segment subcluster (from 1 to 32).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] segment_host_group_ids: A list of IDs of the host groups to place segment subclusters' VMs of the cluster on.
        :param pulumi.Input[Sequence[pulumi.Input[Union['MdbGreenplumClusterSegmentHostArgs', 'MdbGreenplumClusterSegmentHostArgsDict']]]] segment_hosts: (Computed) Info about hosts in segment subcluster. The structure is documented below.
        :param pulumi.Input[int] segment_in_host: Number of segments on segment host (not more then 1 + RAM/8).
        :param pulumi.Input[Union['MdbGreenplumClusterSegmentSubclusterArgs', 'MdbGreenplumClusterSegmentSubclusterArgsDict']] segment_subcluster: Settings for segment subcluster. The structure is documented below.
        :param pulumi.Input[str] status: Status of the cluster.
        :param pulumi.Input[str] subnet_id: The ID of the subnet, to which the hosts belongs. The subnet must be a part of the network to which the cluster belongs.
    ...
    @property
    @pulumi.getter(name="masterHostGroupIds")
    def master_host_group_ids(self) -> pulumi.Output[Sequence[str]]:
        """
        A list of IDs of the host groups to place master subclusters' VMs of the cluster on.
        """
        return pulumi.get(self, "master_host_group_ids")
    ...
    @property
    @pulumi.getter(name="segmentHostGroupIds")
    def segment_host_group_ids(self) -> pulumi.Output[Sequence[str]]:
        """
        A list of IDs of the host groups to place segment subclusters' VMs of the cluster on.
        """
        return pulumi.get(self, "segment_host_group_ids")
