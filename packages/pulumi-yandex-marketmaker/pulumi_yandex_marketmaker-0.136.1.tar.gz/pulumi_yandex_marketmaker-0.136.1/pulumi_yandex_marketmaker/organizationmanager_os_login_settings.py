...
class OrganizationmanagerOsLoginSettings(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] organization_id: The organization to manage it's OsLogin Settings.
        :param pulumi.Input[Union['OrganizationmanagerOsLoginSettingsSshCertificateSettingsArgs', 'OrganizationmanagerOsLoginSettingsSshCertificateSettingsArgsDict']] ssh_certificate_settings: The structure is documented below.
        :param pulumi.Input[Union['OrganizationmanagerOsLoginSettingsUserSshKeySettingsArgs', 'OrganizationmanagerOsLoginSettingsUserSshKeySettingsArgsDict']] user_ssh_key_settings: The structure is documented below.
        """
        ...
    @overload
    def __init__(__self__,
