...
@cli.command(
    "create_ingest_sheet",
    help="Creates filesets and attachments sheets from a user generated ingest spreadsheet"
)
@click.option(
    "--csv",
    "-c",
    required=True,
    help="The filename for the CSV that will be used to generate the filesets and attachments"
)
@click.option(
    "--output",
    "-o",
    required=True,
    help="Folder name for where to put the output files"
)
def create_ingest_sheet(
    csv: str,
) -> None:
    print("creating ingest sheet")