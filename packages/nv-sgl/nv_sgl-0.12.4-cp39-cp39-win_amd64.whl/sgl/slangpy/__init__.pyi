...
class NativeTextureMarshall(NativeMarshall):
    def __init__(self, slang_type: NativeSlangType, element_type: NativeSlangType, resource_shape: sgl.TypeReflection.ResourceShape, format: sgl.Format, usage: sgl.ResourceUsage, dims: int) -> None:
        """N/A"""
