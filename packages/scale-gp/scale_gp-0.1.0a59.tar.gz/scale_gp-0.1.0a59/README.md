...
stream = client.models.chat_completions.create(
    model_deployment_id="model_deployment_id",
    chat_history=[{"content": "string"}],
    prompt="prompt",
    stream=True,
)
for completion_response in stream:
    print(completion_response.completions)
```
...
stream = await client.models.chat_completions.create(
    model_deployment_id="model_deployment_id",
    chat_history=[{"content": "string"}],
    prompt="prompt",
    stream=True,
)
async for completion_response in stream:
    print(completion_response.completions)
```
