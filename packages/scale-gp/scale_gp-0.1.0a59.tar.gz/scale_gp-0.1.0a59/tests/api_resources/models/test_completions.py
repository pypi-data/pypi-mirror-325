...
class TestCompletions:
    ...
    def test_method_create_overload_1(self, client: SGPClient) -> None:
        completion = client.models.completions.create(
    ...
    def test_raw_response_create_overload_1(self, client: SGPClient) -> None:
        response = client.models.completions.with_raw_response.create(
            model_deployment_id="model_deployment_id",
            prompt="prompt",
        )
    ...
    def test_streaming_response_create_overload_1(self, client: SGPClient) -> None:
        with client.models.completions.with_streaming_response.create(
            model_deployment_id="model_deployment_id",
            prompt="prompt",
        ) as response:
    ...
    def test_path_params_create_overload_1(self, client: SGPClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `model_deployment_id` but received ''"):
            client.models.completions.with_raw_response.create(
                model_deployment_id="",
                prompt="prompt",
            )
    ...
    def test_method_create_overload_2(self, client: SGPClient) -> None:
        completion_stream = client.models.completions.create(
            model_deployment_id="model_deployment_id",
            prompt="prompt",
            stream=True,
        )
...
class TestAsyncCompletions:
    ...
    async def test_method_create_overload_1(self, async_client: AsyncSGPClient) -> None:
        completion = await async_client.models.completions.create(
            model_deployment_id="model_deployment_id",
            prompt="prompt",
        )
        assert_matches_type(CompletionResponse, completion, path=["response"])
    ...
    async def test_raw_response_create_overload_1(self, async_client: AsyncSGPClient) -> None:
        response = await async_client.models.completions.with_raw_response.create(
            model_deployment_id="model_deployment_id",
            prompt="prompt",
        )
    ...
    async def test_streaming_response_create_overload_1(self, async_client: AsyncSGPClient) -> None:
        async with async_client.models.completions.with_streaming_response.create(
            model_deployment_id="model_deployment_id",
            prompt="prompt",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_create_overload_1(self, async_client: AsyncSGPClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `model_deployment_id` but received ''"):
            await async_client.models.completions.with_raw_response.create(
                model_deployment_id="",
                prompt="prompt",
            )
    ...
    async def test_method_create_overload_2(self, async_client: AsyncSGPClient) -> None:
        completion_stream = await async_client.models.completions.create(
            model_deployment_id="model_deployment_id",
            prompt="prompt",
            stream=True,
        )
