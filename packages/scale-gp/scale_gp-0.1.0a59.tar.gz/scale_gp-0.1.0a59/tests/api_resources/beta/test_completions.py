...
class TestCompletions:
    ...
    def test_method_create_overload_1(self, client: SGPClient) -> None:
        completion = client.beta.completions.create(
            model="model",
            prompt="string",
        )
    ...
    def test_raw_response_create_overload_1(self, client: SGPClient) -> None:
        response = client.beta.completions.with_raw_response.create(
            model="model",
            prompt="string",
        )
    ...
    def test_streaming_response_create_overload_1(self, client: SGPClient) -> None:
        with client.beta.completions.with_streaming_response.create(
            model="model",
            prompt="string",
        ) as response:
    ...
    def test_method_create_overload_2(self, client: SGPClient) -> None:
        completion_stream = client.beta.completions.create(
            model="model",
            prompt="string",
            stream=True,
        )
...
class TestAsyncCompletions:
    ...
    async def test_method_create_overload_1(self, async_client: AsyncSGPClient) -> None:
        completion = await async_client.beta.completions.create(
            model="model",
            prompt="string",
        )
        assert_matches_type(Completion, completion, path=["response"])
    ...
    async def test_raw_response_create_overload_1(self, async_client: AsyncSGPClient) -> None:
        response = await async_client.beta.completions.with_raw_response.create(
            model="model",
            prompt="string",
        )
    ...
    async def test_streaming_response_create_overload_1(self, async_client: AsyncSGPClient) -> None:
        async with async_client.beta.completions.with_streaming_response.create(
            model="model",
            prompt="string",
        ) as response:
            assert not response.is_closed
    ...
    async def test_method_create_overload_2(self, async_client: AsyncSGPClient) -> None:
        completion_stream = await async_client.beta.completions.create(
            model="model",
            prompt="string",
            stream=True,
        )
