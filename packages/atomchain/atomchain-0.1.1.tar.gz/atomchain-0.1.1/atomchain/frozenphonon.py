...
from phonopy.file_IO import parse_FORCE_SETS, write_disp_yaml, write_FORCE_CONSTANTS
...
def calculate_phonon(
    ...
    **func_args,
    ...
    phonon = Phonopy(
        bulk, ndim, primitive_matrix=primitive_matrix, factor=factor, symprec=symprec
    )
    ...
    if forces_set_file is not None:
        ...
        set_of_forces = parse_FORCE_SETS(
            is_translational_invariance=False, filename=forces_set_file
        )  # ['first_atoms']
