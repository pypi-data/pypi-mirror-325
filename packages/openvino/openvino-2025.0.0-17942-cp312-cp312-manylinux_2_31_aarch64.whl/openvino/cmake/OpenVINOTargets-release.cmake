...
set_target_properties(openvino::frontend::onnx PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libopenvino_onnx_frontend.so.2500"
  IMPORTED_SONAME_RELEASE "libopenvino_onnx_frontend.so.2500"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::frontend::onnx )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::frontend::onnx "${_IMPORT_PREFIX}/openvino/libs/libopenvino_onnx_frontend.so.2500" )
...
set_target_properties(openvino::frontend::pytorch PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libopenvino_pytorch_frontend.so.2500"
  IMPORTED_SONAME_RELEASE "libopenvino_pytorch_frontend.so.2500"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::frontend::pytorch )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::frontend::pytorch "${_IMPORT_PREFIX}/openvino/libs/libopenvino_pytorch_frontend.so.2500" )
...
set_target_properties(openvino::frontend::tensorflow PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libopenvino_tensorflow_frontend.so.2500"
  IMPORTED_SONAME_RELEASE "libopenvino_tensorflow_frontend.so.2500"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::frontend::tensorflow )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::frontend::tensorflow "${_IMPORT_PREFIX}/openvino/libs/libopenvino_tensorflow_frontend.so.2500" )
...
set_target_properties(openvino::frontend::tensorflow_lite PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libopenvino_tensorflow_lite_frontend.so.2500"
  IMPORTED_SONAME_RELEASE "libopenvino_tensorflow_lite_frontend.so.2500"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::frontend::tensorflow_lite )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::frontend::tensorflow_lite "${_IMPORT_PREFIX}/openvino/libs/libopenvino_tensorflow_lite_frontend.so.2500" )
...
set_target_properties(openvino::frontend::paddle PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libopenvino_paddle_frontend.so.2500"
  IMPORTED_SONAME_RELEASE "libopenvino_paddle_frontend.so.2500"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::frontend::paddle )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::frontend::paddle "${_IMPORT_PREFIX}/openvino/libs/libopenvino_paddle_frontend.so.2500" )
...
set_target_properties(openvino::runtime PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libopenvino.so.2500"
  IMPORTED_SONAME_RELEASE "libopenvino.so.2500"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::runtime )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::runtime "${_IMPORT_PREFIX}/openvino/libs/libopenvino.so.2500" )
...
set_target_properties(openvino::runtime::c PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libopenvino_c.so.2500"
  IMPORTED_SONAME_RELEASE "libopenvino_c.so.2500"
  )

list(APPEND _IMPORT_CHECK_TARGETS openvino::runtime::c )
list(APPEND _IMPORT_CHECK_FILES_FOR_openvino::runtime::c "${_IMPORT_PREFIX}/openvino/libs/libopenvino_c.so.2500" )
