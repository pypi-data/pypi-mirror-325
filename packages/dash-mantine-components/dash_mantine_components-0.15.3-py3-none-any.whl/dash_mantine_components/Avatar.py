...
class Avatar(Component):
    """An Avatar component.
 the Avatar component to display user profile image, initials or fallback icon
...
- allowedInitialsColors (list of boolean | number | string | dict | lists; optional):
