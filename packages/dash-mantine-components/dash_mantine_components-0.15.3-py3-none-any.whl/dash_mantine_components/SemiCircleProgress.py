...
class SemiCircleProgress(Component):
 ...
 to represent progress with semi circle diagram
...
- emptySegmentColor (boolean | number | string | dict | list; optional):
...
- filledSegmentColor (boolean | number | string | dict | list; optional):
