...
- withTableBorder (boolean; optional):
    ...
    def __init__(
        ...
        borderColor: typing.Optional[typing.Any] = None,
        ...
        horizontalSpacing: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number]]] = None,
        verticalSpacing: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number]]] = None,
        striped: typing.Optional[typing.Any] = None,
        stripedColor: typing.Optional[typing.Any] = None,
        highlightOnHover: typing.Optional[bool] = None,
        highlightOnHoverColor: typing.Optional[typing.Any] = None,
        data: typing.Optional["Data"] = None,
        stickyHeader: typing.Optional[bool] = None,
        stickyHeaderOffset: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = None,
