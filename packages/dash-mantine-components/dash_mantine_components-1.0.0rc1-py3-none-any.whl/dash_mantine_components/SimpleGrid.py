...
- w (string | number; optional):
    ...
    def __init__(
        ...
        cols: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number]]] = None,
        spacing: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number]]] = None,
