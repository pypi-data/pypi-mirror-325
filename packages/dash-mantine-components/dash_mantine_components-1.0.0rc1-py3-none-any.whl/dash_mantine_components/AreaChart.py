...
- yAxisProps (dict; optional):
    ...
    Series = TypedDict(
        "Series",
            {
            "strokeDasharray": NotRequired[typing.Union[str, typing.Union[int, float, numbers.Number]]],
            "color": typing.Any,
            "name": str,
    ...
    def __init__(
        ...
        splitColors: typing.Optional[typing.Tuple[typing.Any, typing.Any]] = None,
        splitOffset: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
        ...
        strokeDasharray: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = None,
        ...
        textColor: typing.Optional[typing.Any] = None,
        gridColor: typing.Optional[typing.Any] = None,
