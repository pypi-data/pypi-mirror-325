...
- zIndex (string | number; optional):
    ...
    Navbar = TypedDict(
        "Navbar",
            {
            "width": typing.Union[typing.Union[int, float, numbers.Number]],
            "breakpoint": typing.Union[typing.Union[int, float, numbers.Number]],
    ...
    Header = TypedDict(
        "Header",
            {
            "height": typing.Union[typing.Union[int, float, numbers.Number]],
    ...
    def __init__(
        ...
        transitionTimingFunction: typing.Optional[typing.Any] = None,
