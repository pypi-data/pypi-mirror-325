...
- wrapperProps (dict with strings as keys and values of type boolean | number | string | dict | list; optional):
    ...
    _children_props = ['clearButtonProps.children', 'clearButtonProps.icon', 'scrollAreaProps.children', 'label', 'description', 'error', 'leftSection', 'rightSection', 'comboboxProps.children', 'comboboxProps.middlewares.flip.boundary']
    ...
    ScrollAreaProps = TypedDict(
        "ScrollAreaProps",
            {
            "scrollbarSize": NotRequired[typing.Union[str, typing.Union[int, float, numbers.Number]]],
            "type": NotRequired[Literal["auto", "always", "scroll", "hover", "never"]],
            "scrollHideDelay": NotRequired[typing.Union[int, float, numbers.Number]],
            "scrollbars": NotRequired[typing.Any],
            "offsetScrollbars": NotRequired[typing.Any],
            "children": NotRequired[typing.Union[str, int, float, ComponentType, typing.Sequence[typing.Union[str, int, float, ComponentType]]]],
    ...
    ComboboxPropsMiddlewaresFlip = TypedDict(
        "ComboboxPropsMiddlewaresFlip",
            {
            "padding": NotRequired[typing.Union[typing.Union[int, float, numbers.Number], "ComboboxPropsMiddlewaresFlipPadding"]],
            "mainAxis": NotRequired[bool],
            "crossAxis": NotRequired[bool],
            "rootBoundary": NotRequired[typing.Union["ComboboxPropsMiddlewaresFlipRootBoundary"]],
            ...
            "boundary": NotRequired[typing.Union["ComboboxPropsMiddlewaresFlipBoundary", typing.Sequence[typing.Union[str, int, float, ComponentType, typing.Sequence[typing.Union[str, int, float, ComponentType]]]]]]
        }
    )
    ...
    ComboboxProps = TypedDict(
        "ComboboxProps",
            ...
            "children": NotRequired[typing.Union[str, int, float, ComponentType, typing.Sequence[typing.Union[str, int, float, ComponentType]]]],
            "size": NotRequired[typing.Any],
            "dropdownPadding": NotRequired[typing.Union[str, typing.Union[int, float, numbers.Number]]],
    ...
    def __init__(
        ...
        maxTags: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
        ...
        maxDropdownHeight: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = None,
