...
- zIndex (boolean | number | string | dict | list; optional):
    ...
    def __init__(
        self,
        initialProgress: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
        color: typing.Optional[typing.Any] = None,
        size: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
        stepInterval: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
        withinPortal: typing.Optional[bool] = None,
        zIndex: typing.Optional[typing.Any] = None,
