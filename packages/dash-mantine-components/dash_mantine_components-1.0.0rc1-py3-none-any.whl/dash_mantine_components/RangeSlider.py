...
- w (string | number; optional):
    ...
    def __init__(
        ...
        value: typing.Optional[typing.Tuple[typing.Union[int, float, numbers.Number], typing.Union[int, float, numbers.Number]]] = None,
        ...
        minRange: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
        maxRange: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
