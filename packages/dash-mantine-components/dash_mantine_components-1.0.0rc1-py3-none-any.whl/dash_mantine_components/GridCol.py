...
- w (string | number; optional):
    ...
    def __init__(
        ...
        span: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number]]] = None,
        order: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number]]] = None,
