...
- w (string | number; optional):
    ...
    def __init__(
        ...
        scrollbarSize: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = None,
        type: typing.Optional[Literal["auto", "scroll", "always", "hover", "never"]] = None,
        scrollHideDelay: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
        scrollbars: typing.Optional[typing.Any] = None,
        offsetScrollbars: typing.Optional[typing.Any] = None,
