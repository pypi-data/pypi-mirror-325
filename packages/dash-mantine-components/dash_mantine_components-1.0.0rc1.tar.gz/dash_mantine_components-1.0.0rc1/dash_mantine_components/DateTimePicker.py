...
- yearsListFormat (string; optional):
    ...
    TimeInputProps = TypedDict(
        "TimeInputProps",
            ...
            "leftSectionWidth": NotRequired[typing.Union[str, typing.Union[int, float, numbers.Number]]],
            ...
            "rightSectionWidth": NotRequired[typing.Union[str, typing.Union[int, float, numbers.Number]]],
    ...
    def __init__(
        ...
        debounce: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
