...
- w (string | number; optional):
    ...
    def __init__(
        ...
        bulletSize: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = None,
        align: typing.Optional[Literal["left", "right"]] = None,
        lineWidth: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = None,
