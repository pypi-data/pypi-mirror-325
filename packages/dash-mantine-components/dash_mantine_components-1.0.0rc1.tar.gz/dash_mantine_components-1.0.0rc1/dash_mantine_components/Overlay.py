...
- zIndex (string | number; optional):
    ...
    def __init__(
        ...
        backgroundOpacity: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
        color: typing.Optional[typing.Any] = None,
        blur: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = None,
