...
- wrap (boolean | number | string | dict | list; optional):
    ...
    def __init__(
        ...
        rowGap: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number]]] = None,
        columnGap: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number]]] = None,
        align: typing.Optional[typing.Any] = None,
        justify: typing.Optional[typing.Any] = None,
        wrap: typing.Optional[typing.Any] = None,
