...
- wrap (boolean; optional):
    ...
    def __init__(
        ...
        iconSize: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = None,
        contentPadding: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number]]] = None,
