...
- withHeader (boolean; optional):
    ...
    def __init__(
        ...
        activeTab: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
        withHeader: typing.Optional[bool] = None,
        copyLabel: typing.Optional[str] = None,
        copiedLabel: typing.Optional[str] = None,
        maxCollapsedHeight: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = None,
