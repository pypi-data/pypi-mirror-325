...
- zIndex (string | number; optional):
    ...
    def __init__(
        ...
        autoClose: typing.Optional[typing.Union[typing.Union[int, float, numbers.Number]]] = None,
        transitionDuration: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
        containerWidth: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = None,
        notificationMaxHeight: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = None,
