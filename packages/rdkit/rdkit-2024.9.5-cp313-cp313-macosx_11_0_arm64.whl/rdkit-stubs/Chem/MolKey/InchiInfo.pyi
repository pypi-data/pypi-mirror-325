...
import re as re
import typing
__all__ = ['Chem', 'InchiInfo', 'UPD_APP', 'all_stereo_re', 'console', 'defined_stereo_re', 'fixed_h_re', 'h_layer_re', 'inchi', 'isotope_re', 'logging', 'mobile_h_atoms_re', 'mobile_h_group_re', 're', 'reconnected_re', 'stereo_all_re', 'stereo_re', 'undef_stereo_re', 'version_re']
class InchiInfo:
    __firstlineno__: typing.ClassVar[int] = 73
    __static_attributes__: typing.ClassVar[tuple] = ('parsed_inchi')
