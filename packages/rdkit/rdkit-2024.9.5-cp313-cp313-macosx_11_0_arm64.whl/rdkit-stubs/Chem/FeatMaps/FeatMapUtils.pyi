...
import typing
__all__ = ['CombineFeatMaps', 'DirMergeMode', 'FeatMaps', 'GetFeatFeatDistMatrix', 'MergeFeatPoints', 'MergeMethod', 'MergeMetric', 'copy', 'familiesMatch', 'feq']
class DirMergeMode:
    NoMerge: typing.ClassVar[int] = 0
    Sum: typing.ClassVar[int] = 1
    __firstlineno__: typing.ClassVar[int] = 46
...
class MergeMetric:
    ...
    __firstlineno__: typing.ClassVar[int] = 31
    __static_attributes__: typing.ClassVar[tuple] = tuple()
    @classmethod
