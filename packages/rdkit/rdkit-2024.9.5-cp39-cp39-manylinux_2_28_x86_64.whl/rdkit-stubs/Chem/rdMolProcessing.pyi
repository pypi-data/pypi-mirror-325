...
def GetFingerprintsForMolsInFile(filename: str, generator: typing.Any = None, options: SupplierOptions = ...) -> tuple:
    """
        ...
        C++ signature :
            boost::python::tuple GetFingerprintsForMolsInFile(std::string [,boost::python::api::object=None [,RDKit::GeneralMolSupplier::SupplierOptions=<rdkit.Chem.rdMolProcessing.SupplierOptions object at 0x7f19cab482c0>]])
    """
@typing.overload
def GetFingerprintsForMolsInFile(filename: str, generator: typing.Any = None, options: SupplierOptions = ...) -> tuple:
    """
        ...
        C++ signature :
            boost::python::tuple GetFingerprintsForMolsInFile(std::string [,boost::python::api::object=None [,RDKit::GeneralMolSupplier::SupplierOptions=<rdkit.Chem.rdMolProcessing.SupplierOptions object at 0x7f19cab48400>]])
    """
