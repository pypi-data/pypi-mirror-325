...
class InputFormat:
    ...
    __firstlineno__: typing.ClassVar[int] = 42
    __static_attributes__: typing.ClassVar[tuple] = tuple()
class SaltRemover:
    __firstlineno__: typing.ClassVar[int] = 83
    __static_attributes__: typing.ClassVar[tuple] = ('defnData', 'defnFilename', 'defnFormat', 'salts', 'useChirality')
    defnFilename: typing.ClassVar[str] = '/Users/runner/work/rdkit-pypi/rdkit-pypi/build/temp.macosx-10.9-x86_64-cpython-313/rdkit_install/share/RDKit/Data/Salts.txt'
