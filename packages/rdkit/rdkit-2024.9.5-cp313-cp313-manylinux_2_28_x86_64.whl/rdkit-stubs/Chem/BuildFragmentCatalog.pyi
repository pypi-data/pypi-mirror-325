...
import sys as sys
import typing
__all__ = ['BuildCatalog', 'CalcGains', 'CalcGainsFromFps', 'DbConnect', 'FragmentCatalog', 'InfoTheory', 'OutputGainsData', 'ParseArgs', 'ProcessGainsData', 'RDConfig', 'RunDetails', 'ScoreFromLists', 'ScoreMolecules', 'ShowDetails', 'SupplierFromDetails', 'Usage', 'message', 'numpy', 'os', 'pickle', 'sys']
class RunDetails:
    __firstlineno__: typing.ClassVar[int] = 434
