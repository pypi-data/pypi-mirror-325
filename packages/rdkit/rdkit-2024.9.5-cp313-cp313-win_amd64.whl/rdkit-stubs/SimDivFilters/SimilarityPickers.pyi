...
import typing
__all__ = ['DataStructs', 'GenericPicker', 'SpreadPicker', 'TopNContainer', 'TopNOverallPicker', 'bisect']
class GenericPicker:
...
class SpreadPicker(GenericPicker):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_picks', 'data', 'expectPickles', 'numToPick', 'onlyNames', 'probes', 'simMetric')
...
class TopNOverallPicker(GenericPicker):
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 30
    __static_attributes__: typing.ClassVar[tuple] = ('_picks', 'data', 'numToPick', 'probes', 'simMetric')
    def MakePicks(self, force = False):
        ...
