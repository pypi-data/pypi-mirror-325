...
import typing
__all__ = ['IntSparseIntVect', 'LongSparseIntVect', 'SigFactory', 'SparseBitVect', 'Utils', 'copy', 'numpy']
class SigFactory:
    """
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_bins', '_nFeats', '_scaffolds', '_sigSize', '_starts', 'featFactory', 'includeBondOrder', 'maxPointCount', 'minPointCount', 'shortestPathsOnly', 'sigKlass', 'skipFeats', 'trianglePruneBins', 'useCounts')
    def GetBins(self):
        ...
