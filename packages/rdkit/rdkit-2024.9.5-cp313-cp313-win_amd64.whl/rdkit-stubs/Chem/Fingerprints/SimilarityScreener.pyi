...
import typing
__all__ = ['DataStructs', 'SimilarityScreener', 'ThresholdScreener', 'TopNContainer', 'TopNScreener']
class SimilarityScreener:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dataSource', 'fingerprinter', 'metric', 'probe')
...
class ThresholdScreener(SimilarityScreener):
    ...
    **Notes**:
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 66
    __static_attributes__: typing.ClassVar[tuple] = ('dataIter', 'threshold')
    def Reset(self):
        """
...
class TopNScreener(SimilarityScreener):
    ...
    **Notes**
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_pos', 'numToGet', 'topN')
    def Reset(self):
        ...
