...
class StereoEnumerationOptions:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('maxIsomers', 'onlyStereoGroups', 'onlyUnassigned', 'rand', 'tryEmbedding', 'unique')
    def __init__(self, tryEmbedding = False, onlyUnassigned = True, maxIsomers = 1024, rand = None, unique = True, onlyStereoGroups = False):
        ...
class _AtomFlipper:
    __firstlineno__: typing.ClassVar[int] = 52
    __static_attributes__: typing.ClassVar[tuple] = ('atom')
...
class _BondFlipper:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('bond')
    def __init__(self, bond):
        ...
    def flip(self, flag):
        ...
class _RangeBitsGenerator:
    __firstlineno__: typing.ClassVar[int] = 110
    __static_attributes__: typing.ClassVar[tuple] = ('nCenters')
    def __init__(self, nCenters):
        ...
    def __iter__(self):
        ...
class _StereoGroupFlipper:
    __firstlineno__: typing.ClassVar[int] = 64
    __static_attributes__: typing.ClassVar[tuple] = ('_original_parities')
...
class _UniqueRandomBitsGenerator:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('already_seen', 'maxIsomers', 'nCenters', 'rand')
