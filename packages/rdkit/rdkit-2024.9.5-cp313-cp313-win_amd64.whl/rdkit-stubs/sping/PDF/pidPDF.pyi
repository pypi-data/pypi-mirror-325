...
class PDFCanvas(rdkit.sping.pid.Canvas):
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 80
    __static_attributes__: typing.ClassVar[tuple] = ('defaultFillColor', 'defaultFont', 'defaultLineColor', 'defaultLineWidth', 'drawingsize', 'filename', 'pageNumber', 'pageTransitionString', 'pagesize', 'pdf')
