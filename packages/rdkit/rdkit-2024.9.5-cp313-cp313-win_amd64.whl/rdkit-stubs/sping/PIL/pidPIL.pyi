...
class PILCanvas(rdkit.sping.pid.Canvas):
    __firstlineno__: typing.ClassVar[int] = 144
    __static_attributes__: typing.ClassVar[tuple] = ('_color', '_font', '_image', '_pen')
...
_ascents: dict = {}
_descents: dict = {}
_fontprefix: str = 'C:\\rdkit\\build\\temp.win-amd64-cpython-313\\Release\\rdkit_install\\Lib\\site-packages\\rdkit\\sping\\PIL\\pilfonts'
_widthmaps: dict = {}
...
f: _io.BufferedReader  # value = <_io.BufferedReader name='C:\\rdkit\\build\\temp.win-amd64-cpython-313\\Release\\rdkit_install\\Lib\\site-packages\\rdkit\\sping\\PIL\\pilfonts\\metrics.dat'>
figureArc: int = 2
figureCurve: int = 3
figureLine: int = 1
