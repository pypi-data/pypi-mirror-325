...
import typing
__all__ = ['DescriptorCalculator', 'pickle']
class DescriptorCalculator:
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 11
    __static_attributes__: typing.ClassVar[tuple] = ('compoundList', 'descriptorNames', 'simpleList')
