...
class Font:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('face', 'name', 'size', 'weight')
    def __init__(self, face = None, size = None, name = None, weight = None):
        ...
class MolDrawing:
    __firstlineno__: typing.ClassVar[int] = 82
    __static_attributes__: typing.ClassVar[tuple] = ('activeMol', 'atomPs', 'bondRings', 'boundingBoxes', 'canvas', 'canvasSize', 'currAtomLabelFontSize', 'currDotsPerAngstrom', 'drawingOptions', 'drawingTrans', 'molTrans')
