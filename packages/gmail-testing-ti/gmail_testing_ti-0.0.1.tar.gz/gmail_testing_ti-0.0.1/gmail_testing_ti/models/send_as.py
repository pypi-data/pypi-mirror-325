...
class SendAs(BaseModel):
    ...
    signature: Optional[StrictStr] = Field(default=None, description="An optional HTML signature that is included in messages composed with this alias in the Gmail web UI.")
