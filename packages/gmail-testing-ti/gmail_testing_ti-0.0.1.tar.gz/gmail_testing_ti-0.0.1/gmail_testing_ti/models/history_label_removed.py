...
class HistoryLabelRemoved(BaseModel):
    ...
    HistoryLabelRemoved
    """ # noqa: E501
    label_ids: Optional[List[StrictStr]] = Field(default=None, description="Label IDs removed from the message.", alias="labelIds")
    message: Optional[Message] = None
    __properties: ClassVar[List[str]] = ["labelIds", "message"]
