    ...
    def make_instance(self, include_optional) -> ListFiltersResponse:
        ...
        if include_optional:
            return ListFiltersResponse(
                filter = [
                    gmail_testing_ti.models.filter.Filter(
                        action = gmail_testing_ti.models.filter_action.FilterAction(
                            add_label_ids = [
                                ''
                                ], 
                            forward = '', 
                        ...
                        criteria = gmail_testing_ti.models.filter_criteria.FilterCriteria(
                            exclude_chats = True, 
                            from = '', 
                            has_attachment = True, 
                            negated_query = '', 
