            ...
            return GetGifsById200Response(
                data = [
                    giphy_ti.models.gif.Gif(
                        ...
                        id = 'YsTs5ltWtEhnq', 
                        images = giphy_ti.models.gif_images.Gif_images(
                            downsized = null, 
                        ...
                        user = giphy_ti.models.user.User(
                ...
                meta = giphy_ti.models.meta.Meta(
                    msg = 'OK', 
                    response_id = '57eea03c72381f86e05c35d2', 
                    status = 200, ),
                pagination = giphy_ti.models.pagination.Pagination(
                    count = 25, 
                    offset = 75, 
                    total_count = 250, )
            )
