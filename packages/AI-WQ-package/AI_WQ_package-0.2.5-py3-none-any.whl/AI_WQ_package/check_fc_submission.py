...
def check_registered_teamname(teamname,url='https://aiweatherquest.ecmwf.int/wp-load.php?security_token=c305491d9ed409cf&export_id=2&action=get_data'):
...
def check_registered_modelname(modelname,url='https://aiweatherquest.ecmwf.int/wp-load.php?security_token=c305491d9ed409cf&export_id=2&action=get_data'):
    # read data within the url # saved webpage with team and model names
    df = pd.read_csv(url)
