...
class PI_E712(pi_gcs.Communication, pi_gcs.Recorder, Controller):
    ...
    def initialize_hardware(self):
        """
        Check if controller has been switched off/on.
    ...
    def initialize_axis(self, axis):
        ...
        log_info(self, "initialize_axis(%r) ended." % axis.name)
    ...
    def prepare_trajectory(self, *trajectories):
        ...
        calc_servo_cycle = (last_time * len(trajectories) + 1) / number_of_points
    ...
    def _get_tns(self, axis):
        ...
        if accu == 0:
            log_info(self, "##########################################################")
            log_info(self, "PIEZO READ TNS, accu is zero, resetting socket connection!")
            log_info(self, "##########################################################")
            self.finalize()
        return accu
