...
class ScanDisplay(ParametersWardrobe):
    ...
    def __init__(self, session_name=None):
        ...
        super().__init__(
            ...
            default_values={
                ...
                "flint_python_bin": "",
                "umv_show_start_positions": False,
            },
            property_attributes=("session", "extra_args"),
            not_removable=(
                "auto",
                "motor_position",
                "displayed_channels",
    ...
    @property
    def next_scan_displayed_channels(self) -> typing.Optional[list[str]]:
    ...
    def next_scan_displayed_channels(self, values: typing.Optional[list[str]]):
    ...
    def _pop_next_scan_displayed_channels(self) -> typing.Optional[list[str]]:
