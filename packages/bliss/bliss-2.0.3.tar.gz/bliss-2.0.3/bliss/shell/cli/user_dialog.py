...
class UserChoice(Widget):
    ...
    name: str | None = None
    label: str = ""
    values: list[tuple[object, str]] = dataclasses.field(
...
class UserSelect(Widget):
    ...
    defval: object | None = dataclasses.field(default=None, hash=False)
    text_align: TextAlignment = "LEFT"
    text_expand: bool = True
...
class UserCheckBoxList(Widget):
    ...
    defval: list[object] = dataclasses.field(default_factory=list, hash=False)
