...
class IJunction(Shiboken.Object):
    ...
    def getAllTurnningInfo(self) -> typing.List: ...
    def getId(self) -> int: ...
    def getJunctionConnectors(self) -> typing.List: ...
    def getJunctionLinks(self) -> typing.List: ...
    def getTurnningInfo(self, turningId:int) -> Tessng.Online.Junction.TurnningBaseInfo: ...
    def name(self) -> str: ...
...
class ITrafficController(Shiboken.Object):
...
class NetInterface(Shiboken.Object):
    ...
    def createCrossWalkSignalLamp(self, pTrafficLight:Tessng.ITrafficController, name:str, crosswalkId:int, scenePos:PySide2.QtCore.QPointF, isPositive:bool) -> Tessng.ICrosswalkSignalLamp: ...
    ...
    def createSignalPlan(self, pITrafficLight:Tessng.ITrafficController, name:str, cycle:int, offset:int, startTime:int, endTime:int) -> Tessng.ISignalPlan: ...
    ...
    def createTrafficController(self, name:str) -> Tessng.ITrafficController: ...
    def createTrafficSignalLamp(self, pTrafficLight:Tessng.ITrafficController, name:str, laneId:int, toLaneId:int, distance:float) -> Tessng.ISignalLamp: ...
    ...
    def findTrafficControllerById(self, id:int) -> Tessng.ITrafficController: ...
    def findTrafficControllerByName(self, name:str) -> Tessng.ITrafficController: ...
    ...
    def trafficControllerIds(self) -> typing.List: ...
    def trafficControllers(self) -> typing.List: ...
