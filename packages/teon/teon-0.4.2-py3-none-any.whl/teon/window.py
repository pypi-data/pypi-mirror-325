...
from teon.functions import _repair_vec2,load_image
    ...
    def _init(self,core,**kwargs):
        ...
        if self._fullscreen:
            if self._resizable:
                ...
                self.display = pygame.display.set_mode(pygame.display.get_desktop_sizes()[0],pygame.FULLSCREEN)
        ...
        self._icon = kwargs.get("icon", load_image("teon/icon.png"))
        ...
        self._last_position = self._get_window_position()
