...
class ShellCommandGenerator:
    """Shell command generator that can output only the generated command."""
    ...
    def run(self) -> None:
        ...
        if self.output_command_only:
            # Minimal mode: Only output the generated command
            ...
            # Existing interactive mode with banners and extra text
