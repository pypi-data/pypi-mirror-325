...
class SetupSedovTaylor(setup_base.Setup):
    ...
    scale and evolves in time as a power-law. The exact solution is adapted from the Gandalf 
    code by Hubber et al. (2018).

    In this setup, the energy is distributed in a Gaussian with a radius of ~1 cell. This avoids
    grid artifacts that can arise to the square nature of the grid cells. This setup demonstrates
