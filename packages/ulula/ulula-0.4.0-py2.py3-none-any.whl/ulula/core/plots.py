...
def plot1d(sim, q_plot = ['DN', 'VX', 'VY', 'PR'], 
        ...
        plot_type = 'line', invert_direction = False, radial_bins_per_cell = 4.0, plot_ghost_cells = False,
        vminmax_func = None, true_solution_func = None):
    """
    ...
    plot_ghost_cells: bool
        ...
        vertical line. This option is useful for debugging. Ignored if ``plot_type == 'radius'``.
