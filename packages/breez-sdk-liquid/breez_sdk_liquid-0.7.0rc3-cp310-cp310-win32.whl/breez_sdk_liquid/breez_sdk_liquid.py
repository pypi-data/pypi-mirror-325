...
class PrepareLnUrlPayRequest:
    data: "LnUrlPayRequestData";amount: "PayAmount";comment: "typing.Optional[str]";validate_success_action_url: "typing.Optional[bool]";

    @typing.no_type_check
    def __init__(self, data: "LnUrlPayRequestData", amount: "PayAmount", comment: "typing.Optional[str]" = _DEFAULT, validate_success_action_url: "typing.Optional[bool]" = _DEFAULT):
        self.data = data
        self.amount = amount
    ...
    def __str__(self):
        return "PrepareLnUrlPayRequest(data={}, amount={}, comment={}, validate_success_action_url={})".format(self.data, self.amount, self.comment, self.validate_success_action_url)
...
class PaymentDetails:
    ...
    # Each enum variant is a nested class of the enum itself.
    class LIGHTNING:
        swap_id: "str";description: "str";liquid_expiration_blockheight: "int";preimage: "typing.Optional[str]";invoice: "typing.Optional[str]";bolt12_offer: "typing.Optional[str]";payment_hash: "typing.Optional[str]";destination_pubkey: "typing.Optional[str]";lnurl_info: "typing.Optional[LnUrlInfo]";refund_tx_id: "typing.Optional[str]";refund_tx_amount_sat: "typing.Optional[int]";
        ...
        def __str__(self):
            return "PaymentDetails.LIGHTNING(swap_id={}, description={}, liquid_expiration_blockheight={}, preimage={}, invoice={}, bolt12_offer={}, payment_hash={}, destination_pubkey={}, lnurl_info={}, refund_tx_id={}, refund_tx_amount_sat={})".format(self.swap_id, self.description, self.liquid_expiration_blockheight, self.preimage, self.invoice, self.bolt12_offer, self.payment_hash, self.destination_pubkey, self.lnurl_info, self.refund_tx_id, self.refund_tx_amount_sat)
    ...
    class LIQUID:
        ...
        def __eq__(self, other):
            ...
            return True
    class BITCOIN:
        swap_id: "str";description: "str";auto_accepted_fees: "bool";bitcoin_expiration_blockheight: "typing.Optional[int]";liquid_expiration_blockheight: "typing.Optional[int]";refund_tx_id: "typing.Optional[str]";refund_tx_amount_sat: "typing.Optional[int]";

        @typing.no_type_check
        def __init__(self,swap_id: "str", description: "str", auto_accepted_fees: "bool", bitcoin_expiration_blockheight: "typing.Optional[int]", liquid_expiration_blockheight: "typing.Optional[int]", refund_tx_id: "typing.Optional[str]", refund_tx_amount_sat: "typing.Optional[int]"):
