...
class ConnectRequest:
    config: "Config";mnemonic: "str";passphrase: "typing.Optional[str]";

    @typing.no_type_check
    def __init__(self, config: "Config", mnemonic: "str", passphrase: "typing.Optional[str]" = _DEFAULT):
        self.config = config
    ...
    def __str__(self):
        return "ConnectRequest(config={}, mnemonic={}, passphrase={})".format(self.config, self.mnemonic, self.passphrase)
...
class PaymentDetails:
    ...
    # Each enum variant is a nested class of the enum itself.
    class LIGHTNING:
        swap_id: "str";description: "str";liquid_expiration_blockheight: "int";preimage: "typing.Optional[str]";invoice: "typing.Optional[str]";bolt12_offer: "typing.Optional[str]";payment_hash: "typing.Optional[str]";destination_pubkey: "typing.Optional[str]";lnurl_info: "typing.Optional[LnUrlInfo]";claim_tx_id: "typing.Optional[str]";refund_tx_id: "typing.Optional[str]";refund_tx_amount_sat: "typing.Optional[int]";
        ...
        def __str__(self):
            return "PaymentDetails.LIGHTNING(swap_id={}, description={}, liquid_expiration_blockheight={}, preimage={}, invoice={}, bolt12_offer={}, payment_hash={}, destination_pubkey={}, lnurl_info={}, claim_tx_id={}, refund_tx_id={}, refund_tx_amount_sat={})".format(self.swap_id, self.description, self.liquid_expiration_blockheight, self.preimage, self.invoice, self.bolt12_offer, self.payment_hash, self.destination_pubkey, self.lnurl_info, self.claim_tx_id, self.refund_tx_id, self.refund_tx_amount_sat)
