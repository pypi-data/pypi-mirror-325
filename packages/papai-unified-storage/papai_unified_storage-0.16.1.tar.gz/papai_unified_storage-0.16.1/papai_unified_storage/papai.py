...
def list_bucket_objects(
    ...
    return fs.list_files(
        full_path, recursive, remove_prefix=bucket_name_with_path_prefix
    )
...
def write_file_in_bucket(
    ...
    if file_path is not None:
        ...
        put_to_bucket(bucket_name, file_name, file_path, list_buckets, papai_fs)
    ...
    if data is not None:
        ...
        write_to_file_in_bucket(bucket_name, file_name, data, list_buckets, papai_fs)
