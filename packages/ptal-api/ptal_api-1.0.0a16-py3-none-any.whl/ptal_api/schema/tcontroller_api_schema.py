...
class ExporterFilter(sgqlc.types.Input):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('can_export_concept', 'can_export_concept_type_ids', 'can_export_document', 'can_export_multiple_entities', 'can_export_one_entity', 'creator_id', 'last_updater_id', 'menu_title', 'title')
...
class KafkaTopicFilter(sgqlc.types.Input):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('creator_id', 'description', 'has_pipeline_config', 'last_updater_id', 'name', 'name_only', 'pipeline_config', 'pipeline_config_description', 'pipeline_is_active', 'stopped', 'system_registration_date', 'system_update_date')
    creator_id = sgqlc.types.Field(ID, graphql_name='creatorId')
    description = sgqlc.types.Field(String, graphql_name='description')
...
class MessageFilter(sgqlc.types.Input):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('batch_reprocess_id', 'created_interval', 'id', 'input_text', 'job_id_filter', 'parent_id', 'parent_or_self_id', 'pipeline_topic_is_active')
...
class PipelineConfigInput(sgqlc.types.Input):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('description', 'id', 'transforms')
    description = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='description')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
...
class UserServiceInput(sgqlc.types.Input):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('cpu_limit', 'cpu_request', 'environment', 'max_pods', 'mem_limit', 'mem_request')
...
class KafkaTopicMetrics(sgqlc.types.Type):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('active_messages', 'cancelled', 'duplicate', 'failed', 'lag', 'messages', 'ok', 'ok_cumulative', 'pending', 'pipeline_is_active')
...
class MessageDuplicate(sgqlc.types.Type):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('create_time', 'deleted', 'finish_time', 'job_ids', 'message', 'original_id', 'pipeline_topic', 'priority', 'reprocessed', 'reprocessed_from_kb', 'result', 'start_time', 'topic')
...
class MessageFailed(sgqlc.types.Type):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('create_time', 'deleted', 'duplicate_of', 'error', 'finish_time', 'job_ids', 'message', 'pipeline_topic', 'priority', 'reprocessed', 'reprocessed_from_kb', 'result', 'stage', 'start_time', 'topic')
    create_time = sgqlc.types.Field(sgqlc.types.non_null(UnixTime), graphql_name='createTime')
    deleted = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='deleted')
...
class MessageInProgress(sgqlc.types.Type):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('create_time', 'job_ids', 'message', 'pipeline_topic', 'priority', 'reprocessed', 'reprocessed_from_kb', 'result', 'stage', 'start_time', 'topic')
    create_time = sgqlc.types.Field(sgqlc.types.non_null(UnixTime), graphql_name='createTime')
    job_ids = sgqlc.types.Field(sgqlc.types.non_null(JobIds), graphql_name='jobIds')
    message = sgqlc.types.Field(sgqlc.types.non_null(JSON), graphql_name='message')
    pipeline_topic = sgqlc.types.Field(sgqlc.types.non_null('KafkaTopic'), graphql_name='pipelineTopic')
...
class MessageMetrics(sgqlc.types.Type):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('active', 'duplicate', 'failed', 'ok', 'pending')
    active = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='active')
    duplicate = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='duplicate')
    failed = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='failed')
    ok = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='ok')
...
class MessageNotHandled(sgqlc.types.Type):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('create_time', 'job_ids', 'message', 'not_handled', 'pipeline_topic', 'priority', 'reprocessed', 'reprocessed_from_kb', 'result', 'topic')
    create_time = sgqlc.types.Field(sgqlc.types.non_null(UnixTime), graphql_name='createTime')
    job_ids = sgqlc.types.Field(sgqlc.types.non_null(JobIds), graphql_name='jobIds')
    message = sgqlc.types.Field(sgqlc.types.non_null(JSON), graphql_name='message')
...
class MessageOk(sgqlc.types.Type):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('create_time', 'deleted', 'finish_time', 'job_ids', 'message', 'pipeline_topic', 'priority', 'reprocessed', 'reprocessed_from_kb', 'result', 'start_time', 'topic')
    create_time = sgqlc.types.Field(sgqlc.types.non_null(UnixTime), graphql_name='createTime')
    deleted = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='deleted')
    finish_time = sgqlc.types.Field(sgqlc.types.non_null(UnixTime), graphql_name='finishTime')
    job_ids = sgqlc.types.Field(sgqlc.types.non_null(JobIds), graphql_name='jobIds')
...
class Mutation(sgqlc.types.Type):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('add_concept_transform_config', 'add_concept_transform_task', 'add_exporter', 'add_exporter_task', 'add_message', 'add_pipeline_config', 'add_user_pipeline_transform', 'cancel_concept_transform_task', 'cancel_export_task', 'copy_concept_transform_config', 'copy_pending_to_kafka', 'copy_pipeline_config', 'delete_concept_transform_config', 'delete_export_task', 'delete_exporter', 'delete_kafka_topic', 'delete_pipeline_config', 'delete_user_pipeline_transform', 'fix_other_message_metrics', 'fix_pipeline_topic_metrics', 'import_pipeline_config', 'put_kafka_topic', 'reprocess_documents', 'reprocess_message', 'reprocess_messages', 'retry_failed_in_topic', 'retry_failed_message', 'service_stats', 'update_concept_transform_config', 'update_concept_transform_config_transforms', 'update_exporter', 'update_kafka_topics', 'update_pipeline_config', 'update_user_pipeline_transform')
...
class PipelineTransform(sgqlc.types.Type):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('description', 'id', 'in_type', 'out_type', 'params_schema', 'repeatable', 'version')
    description = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='description')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
...
class Query(sgqlc.types.Type):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('active_messages', 'batch_reprocess', 'batch_reprocess_get_message_id_tasks', 'completed_ok_messages', 'concept_transform_config', 'concept_transform_configs', 'concept_transform_message_type', 'concept_transform_task', 'concept_transform_tasks', 'debug_db_load_wait', 'debug_dump_extensions', 'debug_tcontroller_info', 'duplicate_messages', 'export_pipeline_config', 'export_task', 'export_tasks', 'exporter', 'exporters', 'failed_messages', 'job_ids_by_message_uuid2', 'job_items2', 'job_metrics2', 'kafka_pipeline_start_type', 'kafka_topic', 'kafka_topics', 'message_count', 'message_source_available', 'message_status', 'message_statuses', 'message_topic', 'messages_by_parent_id', 'pending_messages', 'periodic_job_items2', 'periodic_job_metrics2', 'periodic_task_items2', 'periodic_task_metrics2', 'pipeline_config', 'pipeline_configs', 'pipeline_transform', 'pipeline_transforms', 'task_items2', 'task_metrics2', 'user_pipeline_transform', 'user_pipeline_transforms')
...
class ServiceStats(sgqlc.types.Type):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('active_slots', 'cancelled_requests', 'duration', 'failed_request_max_duration', 'failed_requests', 'free_servers', 'in_progress', 'load', 'name', 'ok_request_max_duration', 'ok_requests', 'prepared_requests', 'queue', 'ready_servers', 'responses', 'servers', 'waiting_slots')
...
class UserService(sgqlc.types.Type):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('cpu_limit', 'cpu_request', 'environment', 'max_pods', 'mem_limit', 'mem_request', 'state')
    cpu_limit = sgqlc.types.Field(Int, graphql_name='cpuLimit')
    cpu_request = sgqlc.types.Field(Int, graphql_name='cpuRequest')
...
class Exporter(sgqlc.types.Type, RecordInterface):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('can_export_concept', 'can_export_document', 'can_export_multiple_entities', 'can_export_one_entity', 'concept_type_ids', 'default_params', 'default_params_schema', 'description', 'id', 'last_task_time', 'menu_title', 'metrics', 'params_schema', 'service', 'title')
...
class KafkaTopic(sgqlc.types.Type, RecordInterface):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('description', 'metrics', 'move_to_on_timeout', 'pipeline', 'priority', 'request_timeout_ms', 'stopped', 'sub_topic_metrics', 'system_topic', 'topic')
    description = sgqlc.types.Field(String, graphql_name='description')
    metrics = sgqlc.types.Field(sgqlc.types.non_null(KafkaTopicMetrics), graphql_name='metrics')
    move_to_on_timeout = sgqlc.types.Field(String, graphql_name='moveToOnTimeout')
...
class PipelineConfig(sgqlc.types.Type, RecordInterface):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('description', 'error', 'id', 'transform_count', 'transforms', 'used_in_topics')
    description = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='description')
...
class UserPipelineTransform(sgqlc.types.Type, RecordInterface):
    __schema__ = tcontroller_api_schema
    __field_names__ = ('description', 'id', 'in_type', 'out_type', 'service', 'used_in_pipeline_configs', 'version')
    description = sgqlc.types.Field(String, graphql_name='description')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    in_type = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='inType')
    out_type = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='outType')
