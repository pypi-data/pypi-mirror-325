...
class TestDatecalculatorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = DatecalculatorAPIClient(self.api_key)

    @patch('apiverve_datecalculator.apiClient.requests.get')
