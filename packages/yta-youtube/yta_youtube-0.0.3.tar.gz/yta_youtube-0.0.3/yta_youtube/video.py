...
class YoutubeVideo:
    ...
    def audio_formats(self) -> any:
        ...
        """
        if not hasattr(self, '_audio_formats') or self._audio_formats is None:
            self._audio_formats = {}
    ...
    def get_audio_format(
        ...
        with_language = get_audio_format_from_language(self.audio_formats, language)
        ...
        def get_audio_format_from_quality(
            ...
            if quality in AudioFormatQuality.special_values():
                ...
                formats_ordered_by_quality = (
                    ...
                    if quality == AudioFormatQuality.HIGHEST
    ...
    def get_video_format(
        ...
        def get_video_format_from_quality(
            ...
            if quality in VideoFormatQuality.special_values():
                ...
                formats_ordered_by_quality = (
                    ...
                    if quality == VideoFormatQuality.HIGHEST
        ...
        with_quality = get_video_format_from_quality(self.video_formats, quality)
    ...
    def __init__(
        ...
        """
        # TODO: Maybe accept also URLs and parse dynamically (?)
