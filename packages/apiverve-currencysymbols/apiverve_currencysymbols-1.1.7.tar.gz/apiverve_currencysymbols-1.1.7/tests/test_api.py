...
class TestCurrencysymbolsAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = CurrencysymbolsAPIClient(self.api_key)

    @patch('apiverve_currencysymbols.apiClient.requests.get')
