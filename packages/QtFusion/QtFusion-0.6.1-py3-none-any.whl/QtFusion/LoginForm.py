...
"}")
        ...
        self.checkBox_remenber.setGeometry(QRect(40, 270, 115, 35))
...
"}")
        ...
        self.label_pic.setStyleSheet(u"border-image: url(:/default_icons/skins/skin_color.png);\n"
"background-color: transparent;\n"
"border-radius:40px;")
        ...
        self.toolButton_go2reg.setGeometry(QRect(2, 408, 121, 41))
...
"border-radius:40px;")
        ...
        self.toolButton_go2login.setGeometry(QRect(2, 408, 119, 39))
