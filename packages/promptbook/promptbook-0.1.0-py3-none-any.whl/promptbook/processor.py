...
import uuid
import os
from promptlib.loader import find_prompt, load_prompt
from promptlib.utils import get_variable_values, replace_variables

CONFIG_PATH = "src/promptlib/config.yaml"
...
def load_config():
    ...
    try:
        ...
        print(f"⚠️ Warning: Failed to load config.yaml. Using default model. Error: {e}")
        return {
            "ollama": {
                "model": "llama3:2b",
                "stream": True,
