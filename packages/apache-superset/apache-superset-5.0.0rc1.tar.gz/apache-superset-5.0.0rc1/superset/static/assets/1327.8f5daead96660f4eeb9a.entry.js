...
`,u=({name:e,label:t,description:l,validationErrors:u=[],renderTrigger:m=!1,rightNode:v,leftNode:f,onClick:g,hovered:b=!1,tooltipOnClick:y=()=>{},warning:x,danger:z})=>{const{gridUnit:C,colors:w}=(0,a.DP)(),F=(0,r.useRef)(!1),k=(0,r.useMemo)((()=>(u.length||(F.current=!0),F.current?u.length?w.error.base:"unset":w.warning.base)),[w.error.base,w.warning.base,u.length]);return t?(0,h.FD)("div",{className:"ControlHeader",children:[(0,h.Y)("div",{className:"pull-left",children:(0,h.FD)(c.lR,{css:e=>i.AH`
            ...
            position: relative;
          `,children:[f&&(0,h.Y)("span",{children:f}),(0,h.Y)("span",{role:"button",tabIndex:0,onClick:g,style:{cursor:g?"pointer":""},children:t})," ",x&&(0,h.FD)("span",{children:[(0,h.Y)(s.m,{id:"error-tooltip",placement:"top",title:x,children:(0,h.Y)(d.A.AlertSolid,{iconColor:w.warning.base,iconSize:"s"})})," "]}),z&&(0,h.FD)("span",{children:[(0,h.Y)(s.m,{id:"error-tooltip",placement:"top",title:z,children:(0,h.Y)(d.A.ErrorSolid,{iconColor:w.error.base,iconSize:"s"})})," "]}),(null==u?void 0:u.length)>0&&(0,h.FD)("span",{children:[(0,h.Y)(s.m,{id:"error-tooltip",placement:"top",title:null==u?void 0:u.join(" "),children:(0,h.Y)(d.A.ExclamationCircleOutlined,{css:i.AH`
                    ${p};
                    color: ${k};
