...
EVENT_API_VERSION_DICT = {
    "play1": 1,
    "dvlp1": 1
}

# TODO Please also add SMARTLINK_API_VERSION_DICT
SMARTLINK_API_VERSION_DICT = {
    "play1": 1,
    "dvlp1": 1
}

USER_REGISTRATION_API_VERSION_DICT = {
    "play1": 1,
    "dvlp1": 1
}

GROUP_API_VERSION_DICT = {
    "play1": 1,
    "dvlp1": 1
}

GENDER_API_VERSION_DICT = {
    "play1": 1,
    "dvlp1": 1
}

LOGGER_API_VERSION_DICT = {
    "play1": 1,
    "dvlp1": 1
}
