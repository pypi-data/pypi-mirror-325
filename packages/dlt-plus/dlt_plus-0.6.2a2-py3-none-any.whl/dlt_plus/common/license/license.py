...
from dlt_plus.project.run_context import list_dlt_packages
import jwt
import time
...
If you are new to dlt+ and would like to receive a free trial license, please visit
https://platform.scalevector.ai/license.
"""
        )
...
def get_known_scopes() -> List[str]:
    ...
    Scopes are stored in package entry points so package must be pip installed in order
    for scopes to be visible
    """
