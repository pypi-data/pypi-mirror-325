...
class FilevantagePolicyScheduledExclusionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] name: Name of the scheduled exclusion.
        :param pulumi.Input[str] start_date: The start date of the scheduled exclusion. Format: YYYY-MM-DD
        :param pulumi.Input[str] start_time: The start time of the scheduled exclusion in 24 hour format. Format: HH:MM
        :param pulumi.Input[str] timezone: The timezone to use for the time fields. See https://en.wikipedia.org/wiki/List*of*tz*database*time_zones.
        :param pulumi.Input[str] description: Description of the scheduled exclusion.
        :param pulumi.Input[str] end_date: The end date of the scheduled exclusion. Format: YYYY-MM-DD
        :param pulumi.Input[str] end_time: The end time of the scheduled exclusion in 24 hour format. Format: HH:MM
        :param pulumi.Input[str] id: Identifier for the scheduled exclusion.
        :param pulumi.Input[str] processes: A comma separated list of processes to exclude changes from. Example: **/run*me.sh excludes changes made by run*me.sh in any location
        :param pulumi.Input['FilevantagePolicyScheduledExclusionRepeatedArgs'] repeated: Repeated scheduled exclusion
        :param pulumi.Input[str] users: A comma separated list of users to exclude changes from. Example: user1,user2,admin* excludes changes made by user1, user2, and any user starting with admin
        """
...
class FilevantagePolicyScheduledExclusionRepeatedArgs:
    def __init__(__self__, *,
                 ...
                 end_time: Optional[pulumi.Input[str]] = None,
                 monthly_occurrence: Optional[pulumi.Input[str]] = None,
                 start_time: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[bool] all_day: If the exclusion is all day.
        :param pulumi.Input[str] frequency: The frequency of the exclusion. Options: daily, weekly, monthly
        :param pulumi.Input[Sequence[pulumi.Input[int]]] days_of_months: The days of the month to allow the exclusion. Required if frequency is set to monthly and monthly_occurrence is set to days. Options: 1-31
        :param pulumi.Input[Sequence[pulumi.Input[str]]] days_of_weeks: The days of the week to allow the exclusion. Required if frequency is set to weekly or set to monthly and monthly_occurrence is set to a week. Options: Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday
        :param pulumi.Input[str] end_time: The end time to end the scheduled exclusion in 24 hour format. Format: HH:MM required if all_day is false
        :param pulumi.Input[str] monthly_occurrence: The monthly occurrence of the exclusion. Either specify a week (first, second, third, fourth) or set to days to specify days of the month. Options: first, second, third, fourth, days. Required if frequency is set to monthly
        :param pulumi.Input[str] start_time: The start time to allow the scheduled exclusion in 24 hour format. Format: HH:MM required if all_day is false
        """
    ...
    def all_day(self) -> pulumi.Input[bool]:
        """
        If the exclusion is all day.
        """
    ...
    @all_day.setter
    def all_day(self, value: pulumi.Input[bool]):
    ...
    def monthly_occurrence(self) -> Optional[pulumi.Input[str]]:
        """
        The monthly occurrence of the exclusion. Either specify a week (first, second, third, fourth) or set to days to specify days of the month. Options: first, second, third, fourth, days. Required if frequency is set to monthly
        """
    ...
    def monthly_occurrence(self, value: Optional[pulumi.Input[str]]):
...
class FilevantageRuleGroupRuleArgs:
    def __init__(__self__, *,
                 ...
                 path: pulumi.Input[str],
                 severity: pulumi.Input[str],
                 depth: Optional[pulumi.Input[str]] = None,
                 enable_content_capture: Optional[pulumi.Input[bool]] = None,
                 exclude: Optional[pulumi.Input[str]] = None,
                 exclude_processes: Optional[pulumi.Input[str]] = None,
                 exclude_users: Optional[pulumi.Input[str]] = None,
                 file_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 id: Optional[pulumi.Input[str]] = None,
                 include: Optional[pulumi.Input[str]] = None,
                 include_processes: Optional[pulumi.Input[str]] = None,
                 include_users: Optional[pulumi.Input[str]] = None,
                 precedence: Optional[pulumi.Input[int]] = None,
                 registry_values: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 watch_directory_attribute_changes: Optional[pulumi.Input[bool]] = None,
                 watch_directory_create_changes: Optional[pulumi.Input[bool]] = None,
                 watch_directory_delete_changes: Optional[pulumi.Input[bool]] = None,
                 watch_directory_permission_changes: Optional[pulumi.Input[bool]] = None,
                 watch_directory_rename_changes: Optional[pulumi.Input[bool]] = None,
                 watch_file_attribute_changes: Optional[pulumi.Input[bool]] = None,
                 watch_file_create_changes: Optional[pulumi.Input[bool]] = None,
                 watch_file_delete_changes: Optional[pulumi.Input[bool]] = None,
                 watch_file_permission_changes: Optional[pulumi.Input[bool]] = None,
                 watch_file_rename_changes: Optional[pulumi.Input[bool]] = None,
                 watch_file_write_changes: Optional[pulumi.Input[bool]] = None,
                 watch_key_create_changes: Optional[pulumi.Input[bool]] = None,
                 watch_key_delete_changes: Optional[pulumi.Input[bool]] = None,
                 watch_key_permissions_changes: Optional[pulumi.Input[bool]] = None,
                 watch_key_rename_changes: Optional[pulumi.Input[bool]] = None,
                 watch_key_value_delete_changes: Optional[pulumi.Input[bool]] = None,
                 watch_key_value_set_changes: Optional[pulumi.Input[bool]] = None):
        """
        :param pulumi.Input[str] description: Description of the filevantage rule.
        :param pulumi.Input[str] path: Representing the file system or registry path to monitor. All paths must end with the path separator, e.g. c:\\windows\\ for windows and /usr/bin/ for linux/mac.
        :param pulumi.Input[str] severity: Severity to categorize change events produced by this rule.
        :param pulumi.Input[str] depth: Depth below the base path to monitor.
        :param pulumi.Input[bool] enable_content_capture: Enable content capture for the rule. Requires watch*file*write*changes or watch*key*value*set_changes to be enabled.
        :param pulumi.Input[str] exclude: Represents the files, directories, registry keys, or registry values that will be excluded from monitoring.
        :param pulumi.Input[str] exclude_processes: Represents the changes performed by specific processes that will be excluded from monitoring.
        :param pulumi.Input[str] exclude_users: Represents the changes performed by specific users that will be excluded from monitoring.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] file_names: List of file names whose content will be monitored. Listed files must match the file include pattern and not match the file exclude pattern.
        :param pulumi.Input[str] id: Identifier for the filevantage rule.
        :param pulumi.Input[str] include: Represents the files, directories, registry keys, or registry values that will be monitored. Defaults to all (*)
        :param pulumi.Input[str] include_processes: Represents the changes performed by specific processes that will be monitored.
        :param pulumi.Input[str] include_users: Represents the changes performed by specific users that will be monitored.
        :param pulumi.Input[int] precedence: Precedence of the rule in the rule group.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] registry_values: List of registry values whose content will be monitored. Listed registry values must match the registry include pattern and not match the registry exclude pattern.
        :param pulumi.Input[bool] watch_directory_attribute_changes: Monitor directory attribute change events.
        :param pulumi.Input[bool] watch_directory_create_changes: Monitor directory creation events.
        :param pulumi.Input[bool] watch_directory_delete_changes: Monitor directory deletion events.
        :param pulumi.Input[bool] watch_directory_permission_changes: Monitor directory permission change events.
        :param pulumi.Input[bool] watch_directory_rename_changes: Monitor directory rename events.
        :param pulumi.Input[bool] watch_file_attribute_changes: Monitor file attribute change events.
        :param pulumi.Input[bool] watch_file_create_changes: Monitor file creation events.
        :param pulumi.Input[bool] watch_file_delete_changes: Monitor file deletion events.
        :param pulumi.Input[bool] watch_file_permission_changes: Monitor file permission change events.
        :param pulumi.Input[bool] watch_file_rename_changes: Monitor file rename events.
        :param pulumi.Input[bool] watch_file_write_changes: Monitor file write events.
        :param pulumi.Input[bool] watch_key_create_changes: Monitor registry key creation events.
        :param pulumi.Input[bool] watch_key_delete_changes: Monitor registry key deletion events.
        :param pulumi.Input[bool] watch_key_permissions_changes: Monitor registry key permission change events.
        :param pulumi.Input[bool] watch_key_rename_changes: Monitor registry key rename events.
        :param pulumi.Input[bool] watch_key_value_delete_changes: Monitor registry value deletion events.
        :param pulumi.Input[bool] watch_key_value_set_changes: Monitor registry value set events.
        """
        pulumi.set(__self__, "description", description)
    ...
    @property
    @pulumi.getter
    def depth(self) -> Optional[pulumi.Input[str]]:
        """
        Depth below the base path to monitor.
        """
    ...
    @depth.setter
    def depth(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "depth", value)

    @property
    @pulumi.getter(name="enableContentCapture")
    def enable_content_capture(self) -> Optional[pulumi.Input[bool]]:
        """
        Enable content capture for the rule. Requires watch*file*write*changes or watch*key*value*set_changes to be enabled.
        """
    ...
    def enable_content_capture(self, value: Optional[pulumi.Input[bool]]):
    ...
    def exclude_processes(self) -> Optional[pulumi.Input[str]]:
        """
        Represents the changes performed by specific processes that will be excluded from monitoring.
        """
    ...
    def exclude_processes(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "exclude_processes", value)

    @property
    @pulumi.getter(name="excludeUsers")
    def exclude_users(self) -> Optional[pulumi.Input[str]]:
        """
        Represents the changes performed by specific users that will be excluded from monitoring.
        """
    ...
    def exclude_users(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "exclude_users", value)

    @property
    @pulumi.getter(name="fileNames")
    def file_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
        List of file names whose content will be monitored. Listed files must match the file include pattern and not match the file exclude pattern.
        """
    ...
    @file_names.setter
    def file_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
    ...
    def include_processes(self) -> Optional[pulumi.Input[str]]:
        """
        Represents the changes performed by specific processes that will be monitored.
        """
    ...
    def include_processes(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "include_processes", value)

    @property
    @pulumi.getter(name="includeUsers")
    def include_users(self) -> Optional[pulumi.Input[str]]:
        """
        Represents the changes performed by specific users that will be monitored.
        """
    ...
    def include_users(self, value: Optional[pulumi.Input[str]]):
    ...
    def registry_values(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
        List of registry values whose content will be monitored. Listed registry values must match the registry include pattern and not match the registry exclude pattern.
        """
    ...
    def registry_values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "registry_values", value)

    @property
    @pulumi.getter(name="watchDirectoryAttributeChanges")
    def watch_directory_attribute_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor directory attribute change events.
        """
    ...
    def watch_directory_attribute_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_directory_attribute_changes", value)

    @property
    @pulumi.getter(name="watchDirectoryCreateChanges")
    def watch_directory_create_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor directory creation events.
        """
    ...
    def watch_directory_create_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_directory_create_changes", value)

    @property
    @pulumi.getter(name="watchDirectoryDeleteChanges")
    def watch_directory_delete_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor directory deletion events.
        """
    ...
    def watch_directory_delete_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_directory_delete_changes", value)

    @property
    @pulumi.getter(name="watchDirectoryPermissionChanges")
    def watch_directory_permission_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor directory permission change events.
        """
    ...
    def watch_directory_permission_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_directory_permission_changes", value)

    @property
    @pulumi.getter(name="watchDirectoryRenameChanges")
    def watch_directory_rename_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor directory rename events.
        """
    ...
    def watch_directory_rename_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_directory_rename_changes", value)

    @property
    @pulumi.getter(name="watchFileAttributeChanges")
    def watch_file_attribute_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor file attribute change events.
        """
    ...
    def watch_file_attribute_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_file_attribute_changes", value)

    @property
    @pulumi.getter(name="watchFileCreateChanges")
    def watch_file_create_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor file creation events.
        """
    ...
    def watch_file_create_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_file_create_changes", value)

    @property
    @pulumi.getter(name="watchFileDeleteChanges")
    def watch_file_delete_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor file deletion events.
        """
    ...
    def watch_file_delete_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_file_delete_changes", value)

    @property
    @pulumi.getter(name="watchFilePermissionChanges")
    def watch_file_permission_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor file permission change events.
        """
    ...
    def watch_file_permission_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_file_permission_changes", value)

    @property
    @pulumi.getter(name="watchFileRenameChanges")
    def watch_file_rename_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor file rename events.
        """
    ...
    def watch_file_rename_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_file_rename_changes", value)

    @property
    @pulumi.getter(name="watchFileWriteChanges")
    def watch_file_write_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor file write events.
        """
    ...
    def watch_file_write_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_file_write_changes", value)

    @property
    @pulumi.getter(name="watchKeyCreateChanges")
    def watch_key_create_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor registry key creation events.
        """
    ...
    def watch_key_create_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_key_create_changes", value)

    @property
    @pulumi.getter(name="watchKeyDeleteChanges")
    def watch_key_delete_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor registry key deletion events.
        """
    ...
    def watch_key_delete_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_key_delete_changes", value)

    @property
    @pulumi.getter(name="watchKeyPermissionsChanges")
    def watch_key_permissions_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor registry key permission change events.
        """
    ...
    def watch_key_permissions_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_key_permissions_changes", value)

    @property
    @pulumi.getter(name="watchKeyRenameChanges")
    def watch_key_rename_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor registry key rename events.
        """
    ...
    def watch_key_rename_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_key_rename_changes", value)

    @property
    @pulumi.getter(name="watchKeyValueDeleteChanges")
    def watch_key_value_delete_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor registry value deletion events.
        """
    ...
    def watch_key_value_delete_changes(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "watch_key_value_delete_changes", value)

    @property
    @pulumi.getter(name="watchKeyValueSetChanges")
    def watch_key_value_set_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Monitor registry value set events.
        """
    ...
    def watch_key_value_set_changes(self, value: Optional[pulumi.Input[bool]]):
