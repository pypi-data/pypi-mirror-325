...
class QCM {
    ...
    createInnerLayoutButtonsAndCounter(no_admo){
        ...
        const checkBtn   = makeIdeJqButton('check', {tipWidth: CONFIG.lang.qcmCheckTip.em, tipText: CONFIG.lang.qcmCheckTip.msg})
        const restartBtn = makeIdeJqButton('restart', {tipWidth:CONFIG.lang.qcmRedoTip.em, tipText: CONFIG.lang.qcmRedoTip.msg})
