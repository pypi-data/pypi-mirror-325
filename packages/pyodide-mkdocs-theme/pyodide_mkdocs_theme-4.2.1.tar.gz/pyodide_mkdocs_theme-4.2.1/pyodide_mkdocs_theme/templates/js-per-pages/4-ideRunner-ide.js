...
class IdeRunnerLogic extends IdeFeedbackManager {
   ...
   * */
  validateCorrFactory(){
    const validationRunner = this.validateFactory(CONFIG.runningMode.validateCorr)
    return async (e)=>{
...
export class IdeRunner extends IdeRunnerLogic {
  ...
  handleResize(obsEntry){
    const width = obsEntry.contentRect.width - 2  // -2px because border
