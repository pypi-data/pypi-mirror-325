...
def _hack_io_stuff():
    ...
    def terminal_message(key, msg:Any, *_:Any, format:str="none", new_line=True, **__):
        ...
        # NOTE: keep the following information outside of PMT public documentation...
        # _ and __ arguments are used as sinks when using terminal_message as a replacement
        # for print in p5 codes converted from Basthon.
        # This is also the reason why the automatic conversion to string + join has been added.
        # (the use of end=... is just ignored, on the other hand).
