...
class TestDistancecalculatorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = DistancecalculatorAPIClient(self.api_key)

    @patch('apiverve_distancecalculator.apiClient.requests.get')
