...
class CutTubs(_SolidBase):
    ...
    def mesh(self):
        ...
        for i in range(0, self.nslice, 1):
            ...
            zLowRMinP1 = (
                -pLowNorm[2] * pDz - pLowNorm[0] * xRMinP1 - pLowNorm[1] * yRMinP1
            ) / pLowNorm[2]
            zLowRMaxP1 = (
                -pLowNorm[2] * pDz - pLowNorm[0] * xRMaxP1 - pLowNorm[1] * yRMaxP1
            ) / pLowNorm[2]
            zHighRMinP1 = (
                pHighNorm[2] * pDz - pHighNorm[0] * xRMinP1 - pHighNorm[1] * yRMinP1
            ) / pHighNorm[2]
            zHighRMaxP1 = (
                pHighNorm[2] * pDz - pHighNorm[0] * xRMaxP1 - pHighNorm[1] * yRMaxP1
            ) / pHighNorm[2]

            zLowRMinP2 = (
                -pLowNorm[2] * pDz - pLowNorm[0] * xRMinP2 - pLowNorm[1] * yRMinP2
            ) / pLowNorm[2]
            zLowRMaxP2 = (
                -pLowNorm[2] * pDz - pLowNorm[0] * xRMaxP2 - pLowNorm[1] * yRMaxP2
            ) / pLowNorm[2]
            zHighRMinP2 = (
                pHighNorm[2] * pDz - pHighNorm[0] * xRMinP2 - pHighNorm[1] * yRMinP2
            ) / pHighNorm[2]
            zHighRMaxP2 = (
                pHighNorm[2] * pDz - pHighNorm[0] * xRMaxP2 - pHighNorm[1] * yRMaxP2
            ) / pHighNorm[2]
