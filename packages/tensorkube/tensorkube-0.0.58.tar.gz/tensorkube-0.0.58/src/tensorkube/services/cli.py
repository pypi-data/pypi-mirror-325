...
@tensorkube.command()
@click.option('--vpc-public-subnets', type=str, help='List of public subnets for the VPC.')
@click.option('--vpc-private-subnets', type=str, help='List of private subnets for the VPC.')
