...
class App:
    ...
    :param allow_anonymous: Public URL does not require any authentication
    """
    ...
    def _get_image(self, container_image: str, settings: AppSerializationSettings) -> str:
    ...
    def _to_union_idl(self, settings: AppSerializationSettings) -> AppIDL:
        ...
        if self.allow_anonymous:
            security_context_kwargs["allow_anonymous"] = self.allow_anonymous
