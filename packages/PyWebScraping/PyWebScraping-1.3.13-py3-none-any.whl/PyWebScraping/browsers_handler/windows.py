...
import pathlib
import subprocess
from PyWebScraping.browsers_handler.data import Browser
...
def get_webdriver_version(driver_path: typing.Union[pathlib.Path, str]) -> typing.Optional[str]:
	"""
    Retrieves the version of a given webdriver executable.

    Args:
        driver_path (typing.Union[pathlib.Path, str]): The path to the webdriver executable. It can be a string or a pathlib.Path object.

    Returns:
        typing.Optional[str]: The version of the webdriver as a string, or None if the version cannot be determined.
...
def get_browser_version(browser_path: typing.Union[pathlib.Path, str]) -> str:
	"""
