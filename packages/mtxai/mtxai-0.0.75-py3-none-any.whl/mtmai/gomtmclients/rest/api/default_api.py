...
class DefaultApi:
    ...
    async def mtmai_stream_demo1(
        ...
        _param = self._mtmai_stream_demo1_serialize(
    ...
    @validate_call
    async def mtmai_stream_demo1_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def mtmai_stream_demo1_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _mtmai_stream_demo1_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/mtmai/streamdemo1',
