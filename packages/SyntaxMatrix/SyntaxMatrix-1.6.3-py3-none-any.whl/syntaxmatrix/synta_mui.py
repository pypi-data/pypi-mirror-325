...
from syntaxmatrix import db  # our database module
...
class SyntaxMUI:
    def __init__(self, title="SyntaxMatrix", host="127.0.0.1", port=5000):
        ...
        # Initialize the database and load persisted pages.
        db.init_db()
    ...
    def setup_routes(self):
        ...
        def home():
            ...
            # Refresh pages from the DB for up-to-date navigation.
            self.pages = db.get_pages()
            ...
            # Auto-scroll script (automatically scrolls chat container to bottom).
            scroll_js = """
            <script>
