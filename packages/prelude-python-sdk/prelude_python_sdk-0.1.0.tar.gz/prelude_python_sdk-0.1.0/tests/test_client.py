...
def _get_open_connections(client: Prelude | AsyncPrelude) -> int:
...
class TestPrelude:
    ...
    def test_multipart_repeating_array(self, client: Prelude) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: Prelude) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Prelude) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Prelude) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
...
class TestAsyncPrelude:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncPrelude) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncPrelude) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncPrelude) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncPrelude) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncPrelude, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
