...
working_directory=os.path.join(os.getcwd(),workdir)
...
def sensor_routing(total_number_of_classes,segments_number_per_class, max_distance, working_directory,time_limit,optimization_objective,max_aco_iteration,ant_no, is_reversed):
