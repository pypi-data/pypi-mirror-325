...
class SubtitlesParser:
    ...
    def parse_from_filename(
        ...
        return self.parse_from_content(content, extension)
    ...
    def parse_from_content(
        ...
        return {
            SubtitleFileExtension.SRV1: parse_srv1(text),
            SubtitleFileExtension.SRV2: parse_srv2(text),
            SubtitleFileExtension.SRV3: parse_srv3(text),
            SubtitleFileExtension.JSON3: parse_json3(text),
            SubtitleFileExtension.VTT: parse_vtt(text),
            SubtitleFileExtension.TTML: parse_ttml(text)
        }[extension]
