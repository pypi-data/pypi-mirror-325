...
description: Integrating CropioAI with human input during execution in complex decision-making processes and leveraging the full capabilities of the agent's attributes and tools.
icon: user-check
---
...
## Using human input with CropioAI
...
cropio = Cropio(
    ...
    verbose=True,
    memory=True,
    planning=True  # Enable planning feature for the cropio
)

# Get your cropio to work!
