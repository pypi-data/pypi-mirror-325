...
[Spider](https://spider.cloud/?ref=cropioai) is the [fastest](https://github.com/spider-rs/spider/blob/main/benches/BENCHMARKS.md#benchmark-results) 
...
and the `cropioai[tools]` SDK too:
