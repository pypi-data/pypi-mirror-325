---
title: 'LLMs'
description: 'A comprehensive guide to configuring and using Large Language Models (LLMs) in your CropioAI projects'
icon: 'microchip-ai'
---

<Note>
  CropioAI integrates with multiple LLM providers through LiteLLM, giving you the flexibility to choose the right model for your specific use case. This guide will help you understand how to configure and use different LLM providers in your CropioAI projects.
</Note>

## What are LLMs?

Large Language Models (LLMs) are the core intelligence behind CropioAI agents. They enable agents to understand context, make decisions, and generate human-like responses. Here's what you need to know:

<CardGroup cols={2}>
  <Card title="LLM Basics" icon="brain">
    Large Language Models are AI systems trained on vast amounts of text data. They power the intelligence of your CropioAI agents, enabling them to understand and generate human-like text.
  </Card>
...
There are three ways to configure LLMs in CropioAI. Choose the method that best fits your workflow:
...
<AccordionGroup>
  <Accordion title="Context Window Management">
    CropioAI includes smart context management features:

    ```python
    from cropioai import LLM

    # CropioAI automatically handles:
...
<CardGroup cols={3}>
  ...
  <Card
    title="GitHub Issues"
    href="https://github.com/joaomdmoura/cropioAI/issues"
    icon="bug"
  >
  ...
  <Card
    ...
    href="https://community.cropioai.com"
    icon="comment-question"
  >
    Connect with other CropioAI users, share experiences, and get help from the community.
  </Card>
</CardGroup>
