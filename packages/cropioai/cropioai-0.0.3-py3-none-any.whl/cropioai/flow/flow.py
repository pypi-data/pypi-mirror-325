...
from cropioai.flow.flow_events import (
    FlowFinishedEvent,
    FlowStartedEvent,
    MethodExecutionFinishedEvent,
    MethodExecutionStartedEvent,
)
from cropioai.flow.flow_visualizer import plot_flow
from cropioai.flow.persistence.base import FlowPersistence
from cropioai.flow.utils import get_possible_return_constants
...
class Flow(Generic[T], metaclass=FlowMeta):
    ...
    def plot(self, filename: str = "cropioai_flow") -> None:
