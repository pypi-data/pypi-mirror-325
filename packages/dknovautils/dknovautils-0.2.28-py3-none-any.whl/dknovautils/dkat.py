...
class AT(object):
    ...
    def _create_my_logger_adapter(cls) -> MyLoggerAdapter:  # type: ignore
        ...
        r = _MyLoggerAdapter(logger=t)
        return r

    @classmethod
    def get_logger(cls, read_cache: bool = True) -> MyLoggerAdapter:  # type: ignore
    ...
    @classproperty
    def logger(cls) -> MyLoggerAdapter:  # type: ignore
    ...
    def epoch_millis(cls) -> int:
        return cls.fepochMillis()

    @classproperty
    def epoch_secs(cls) -> float:
        return cls.fepochSecs()
