...
def load_dataset(api_key, dataset_id, save_path='downloads', node_id='valyu'):
    try:
        ...
        response = requests.get(f"{intermediary_url}/training/datasets/{encoded_dataset_id}", headers=headers)
