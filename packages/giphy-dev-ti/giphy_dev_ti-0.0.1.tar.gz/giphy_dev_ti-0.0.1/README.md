...
with giphy_dev_ti.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = giphy_dev_ti.GifsApi(api_client)
