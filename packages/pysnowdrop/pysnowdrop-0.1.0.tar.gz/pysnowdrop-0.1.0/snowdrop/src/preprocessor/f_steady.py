...
def f_steady(x,p,exog=[0]):
    ...
    function = list()
    function.append(-PDOT__*p_pdot1 - PDOT__*(1 - p_pdot1) + PDOT__ - epdot__ - p_pdot2*(g**2/(-Y__ + g) - g) - p_pdot3*(g**2/(-Y__ + g) - g))
    function.append(PDOT__*p_pdot1 + PDOT__*(1 - p_pdot1) + RR__ - RS__ - err__)
    function.append(-PDOT__*p_rs1 + RS__ - Y__ - ers__ - exo__)
    function.append(RR__*p_y2 + RR__*p_y3 - Y__*p_y1 + Y__ - ey__)
