...
if __name__ == '__main__':
    ...
    """
    from snowdrop.src.driver import importModel, run as simulate
    ...
    if ESTIMATE:
        ...
        yy,dates,epsilonhat,etahat = simulate(model=model,meas=meas,Plot=True,Output=True,sample=False,estimate=True,output_variables=output_variables,decomp_variables=decomp)
