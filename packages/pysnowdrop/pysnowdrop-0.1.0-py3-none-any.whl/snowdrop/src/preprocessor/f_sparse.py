...
def f_sparse(x, p, exog=[0], order=1, ind=None):
    ...
    # Function:
    function = np.zeros(4)
    function[0] = PDOT__ - PDOT__m1_*(1 - p_pdot1) - PDOT__p1_*p_pdot1 - epdot__ - p_pdot2*(g**2/(-Y__ + g) - g) - p_pdot3*(g**2/(-Y__m1_ + g) - g)
    function[1] = PDOT__m1_*(1 - p_pdot1) + PDOT__p1_*p_pdot1 + RR__ - RS__ - err__
    function[2] = -PDOT__*p_rs1 + RS__ - Y__ - ers__ - exo__
    function[3] = RR__*p_y2 + RR__m1_*p_y3 + Y__ - Y__m1_*p_y1 - ey__
    ...
    row_ind.append(0); col_ind.append(8); jacobian.append(p_pdot1 - 1)
