...
set_target_properties(cblas PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcblas.3.12.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libcblas.3.dylib"
  )

list(APPEND _cmake_import_check_targets cblas )
list(APPEND _cmake_import_check_files_for_cblas "${_IMPORT_PREFIX}/lib/libcblas.3.12.0.dylib" )
