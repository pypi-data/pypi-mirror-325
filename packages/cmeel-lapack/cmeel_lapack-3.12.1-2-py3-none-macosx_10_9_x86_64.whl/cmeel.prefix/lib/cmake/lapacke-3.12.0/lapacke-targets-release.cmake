...
set_target_properties(lapacke PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liblapacke.3.12.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/liblapacke.3.dylib"
  )

list(APPEND _cmake_import_check_targets lapacke )
list(APPEND _cmake_import_check_files_for_lapacke "${_IMPORT_PREFIX}/lib/liblapacke.3.12.0.dylib" )
