...
class Engine(ABC):
    ...
    def __init__(self, reverse_vocabulary: dict[int, str], strict: bool = False, multi_token_sampling: bool = True) -> None: ...
    ...
    def sample(self, log_probs: Array_Type, sampler: Callable[[Array_Type], Array_Type]) -> list[int]: ...
    """
    ...
    def consume_text(self, input: str, token_healing: bool = True) -> None: ...
    """
