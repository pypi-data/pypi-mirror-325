...
DEFAULT_HB_CONTAINS_PIPELINES = environ.get(HB_CONTAINS_PIPELINES_ENV_KEY, True)
DEFAULT_HB_CONTAINS_ACTIVE_PLUGINS = environ.get(HB_CONTAINS_ACTIVE_PLUGINS_ENV_KEY, True)
