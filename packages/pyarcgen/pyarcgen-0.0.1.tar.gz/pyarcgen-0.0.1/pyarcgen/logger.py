...
class HandlerLoggerAfterAction(logging.Handler):
    ...
    def post_log_action(self, record):
        ...
        # print("[pyarcgen->logger.py] HandlerLoggerAfterAction - log_entry:: ", log_entry)
...
def LoggerArchive(
    ...
    try:
        ...
        print("[ERROR][pyarcgen -> logger.py] LoggerArchive | stack:: ", stack)
...
def GetLogger(filename: str, logsFolder: str = 'logs', debug: bool = DEBUG):
    ...
    if(debug == True):
        print("[pyarcgen->logger.py] GetLogger - filename:: ", filename)
