...
def teams_notification(
    ...
    environment_keys = list(task_environment.keys())
    environment = str(environment_keys) if len(environment_keys) > 0 else "N/A"
        ...
        "body": [
            ...
            },
            {
                ...
                "facts": [
                    ...
                    {"title": "Environment:", "value": str(environment)},
                    {"title": "Command:", "value": str(command)},
                ],
            },
        ],
        "actions": [
