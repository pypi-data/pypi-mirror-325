...
class NifiContextManager(object):
    ...
    def sync_entities(self):
        ...
        if fetch_relationships_entities:
            ...
            expanded_entities = safe_async_run(expand_entities(
            ...
            for entity in entities:
                ...
                if found_entities:
                    for _, (rel, target) in found_entities:
                        is_mtm = rel.get('os_entity_uid_from') and rel.get('os_entity_uid_to')
                        child_entity, child_rel = entity.add_child_entity(
                            target['os_workspace'], target['entity_type'], target,
                            os_relationship_name=rel['os_relationship_name'], os_relationship_type=is_mtm
                        )
                        ...
                        if is_mtm:
                            ...
                            child_rel.request['is_temporary'] = rel.get('os_entity_uid')
