...
async def expand_entities(entities, ontology, relationship_mappings_info, client, relationship_names=None, batch_size = 10000, avg_limit_per_entity = 20, timeout=10.0):
    ...
    for batch in entity_batches:
        new_entities = await expand_entities_batch(batch, ontology, relationship_mappings_info, relationship_names, metrics, client, avg_limit_per_entity, timeout)
...
async def expand_entities_batch(entities, ontology, relationship_mappings, relationship_names, metrics, client, avg_limit_per_entity = 20, timeout=10.0):
