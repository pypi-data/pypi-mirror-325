...
def plot_clusters(clusters, clusters_avg, clusters_max, clusters_min, ch_names, ch_pos, correlation_values):
    figs = []
    ...
    legend_elements = []
    for idx, (avg_corr, max_corr, min_corr) in enumerate(zip(clusters_avg, clusters_max, clusters_min)):
