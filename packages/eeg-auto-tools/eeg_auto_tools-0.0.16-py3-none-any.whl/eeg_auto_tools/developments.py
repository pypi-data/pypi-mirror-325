...
class AutoCleaner():
    def __init__(self, scenarious_name, reref, n_components, l_freq, h_freq, 
                 notch_freq, down_sfreq, excluded_channels, stimulus, output_path=None):
    ...
    def clean(self, file_path, elc_file, bad_channels, progress_bar=None):
        ...
        self.prep_pipe = Sequence(
                        ...
                        ffilter = FilterBandpass(l_freq=self.l_freq, h_freq=self.h_freq, notch_freq=self.notch_freq, report=True),
...
class QualityChecker():
    def __init__(self, excluded_channels, l_freq, h_freq, notch_freq, noise_detector, stimulus):
        self.excluded_channels = excluded_channels
        self.l_freq = l_freq
        self.h_freq = h_freq
        self.notch_freq = notch_freq
