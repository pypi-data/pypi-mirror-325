...
class TestResult(BaseModel):
    ...
    type: Union[FindingType, TestBasicResultType] = Field(description="The type of the finding")
...
class Finding(BaseModel):
    ...
    data: TestResult | list[TestResult]
    ...
    def subtype(self) -> FindingType:
        if isinstance(self.data, list):
            for data in self.data:
                if data.type == FindingType.FINDING:
                    return FindingType.FINDING
            return FindingType.ADDITIONAL_INFORMATION
        else:
