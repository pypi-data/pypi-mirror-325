...
class EnvMap:
    def __init__(
        ...
        *,
        ...
        self.filtered_env_map.setup_cube_map(
            1, p3d.Texture.T_float, p3d.Texture.F_rgba16
        )
    ...
    def _from_bam(cls, path: p3d.Filename) -> Self:
        ...
        for idx, _ in enumerate(envmap.sh_coefficients):
            envmap.sh_coefficients[idx] = p3d.LVector3(
                scan.get_stdfloat(), scan.get_stdfloat(), scan.get_stdfloat()
            )
    ...
    def create_empty(cls) -> Self:
        ...
        cubemap.setup_cube_map(2, p3d.Texture.T_unsigned_byte, p3d.Texture.F_rgb)
