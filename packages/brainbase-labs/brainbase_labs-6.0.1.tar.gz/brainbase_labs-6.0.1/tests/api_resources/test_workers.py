...
from brainbase_labs.types import WorkerAllResponse
...
class TestWorkers:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_all(self, client: BrainbaseLabs) -> None:
        worker = client.workers.all()
        assert_matches_type(WorkerAllResponse, worker, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_all(self, client: BrainbaseLabs) -> None:
        response = client.workers.with_raw_response.all()
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_all(self, client: BrainbaseLabs) -> None:
        with client.workers.with_streaming_response.all() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncWorkers:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_all(self, async_client: AsyncBrainbaseLabs) -> None:
        worker = await async_client.workers.all()
        assert_matches_type(WorkerAllResponse, worker, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_all(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.workers.with_raw_response.all()
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_all(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.workers.with_streaming_response.all() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
