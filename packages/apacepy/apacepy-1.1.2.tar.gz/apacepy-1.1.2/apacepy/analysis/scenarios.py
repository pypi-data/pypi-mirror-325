...
class SetOfScenarios:
    ...
    def __init__(self,
        ...
        assert regression_type in ('linear', 'quadratic', 'exponential', 'power')
        ...
        for i, ser in enumerate(list_of_scenario_sets):
            ...
            if show_only_on_frontier:
                ...
                if ser.ifShowFittedCurve:
                    ...
                    if ser.regressionType in ('linear', 'quadratic'):
                        poly_degree = 2 if ser.regressionType == 'quadratic' else 1
