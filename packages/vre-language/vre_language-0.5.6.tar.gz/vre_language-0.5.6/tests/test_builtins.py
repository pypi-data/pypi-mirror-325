...
def test_builtin_type_function_callable_import(meta_model, model_kwargs):
    """test the built-in type function with callable import"""
    prog_inp = "use random from numpy.random; print(type(random))"
    prog = meta_model.model_from_str(prog_inp, **model_kwargs)
