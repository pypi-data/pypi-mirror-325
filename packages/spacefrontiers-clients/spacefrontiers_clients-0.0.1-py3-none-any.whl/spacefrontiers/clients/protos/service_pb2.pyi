...
class EmbedRequest(_message.Message):
    ...
    task: str
    def __init__(self, texts: _Optional[_Iterable[str]] = ..., task: _Optional[str] = ...) -> None: ...
...
class EmbedResponse(_message.Message):
    ...
    def __init__(self, embeddings: _Optional[_Iterable[_Union[Embedding, _Mapping]]] = ..., processed_tokens: _Optional[int] = ...) -> None: ...
...
class RerankRequest(_message.Message):
    ...
    query: str
    texts: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, query: _Optional[str] = ..., texts: _Optional[_Iterable[str]] = ...) -> None: ...
...
class RerankItem(_message.Message):
    ...
    score: float
    index: int
    def __init__(self, score: _Optional[float] = ..., index: _Optional[int] = ...) -> None: ...
...
class RerankResponse(_message.Message):
    ...
    processed_tokens: int
    def __init__(self, scores: _Optional[_Iterable[_Union[RerankItem, _Mapping]]] = ..., processed_tokens: _Optional[int] = ...) -> None: ...
