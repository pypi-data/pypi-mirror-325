"""ksycopg extensions to the DBAPI-2.0

This module holds all the extensions to the DBAPI-2.0 provided by ksycopg.

- `connection` -- the new-type inheritable connection class
- `cursor` -- the new-type inheritable cursor class
- `lobject` -- the new-type inheritable large object class
- `adapt()` -- exposes the PEP-246_ compatible adapting mechanism used
  by ksycopg to adapt Python types to Kingbase ones

.. _PEP-246: https://www.python.org/dev/peps/pep-0246/
"""
# ksycopg/extensions.py - DBAPI-2.0 extensions specific to ksycopg
...
from ksycopg2._ksycopg import (                             # noqa
    ...
    lobject, Xid, libkci_version, parse_dsn, quote_ident,
...
"""ksycopg connection status values."""
STATUS_SETUP = 0
STATUS_READY = 1
STATUS_BEGIN = 2
...
"""ksycopg asynchronous connection polling values"""
POLL_OK = 0
POLL_READ = 1
POLL_WRITE = 2
POLL_ERROR = 3
...
# Create default json typecasters for Kingbase 9.2 oids
from ksycopg2._json import register_default_json, register_default_jsonb    # noqa
...
from ksycopg2. _range import Range                              # noqa
del Range
