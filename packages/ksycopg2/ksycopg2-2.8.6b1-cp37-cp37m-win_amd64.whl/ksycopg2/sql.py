...
# ksycopg/sql.py - SQL composition utility module
#
...
from ksycopg2 import extensions as ext
from ksycopg2.compat import PY3, string_types
...
class Identifier(Composable):
    ...
    fields. Kingbase identifiers follow `different rules`__ than SQL string
