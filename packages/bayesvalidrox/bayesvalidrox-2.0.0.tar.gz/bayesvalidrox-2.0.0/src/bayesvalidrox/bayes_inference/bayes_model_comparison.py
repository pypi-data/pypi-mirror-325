...
class BayesModelComparison:
    ...
    def calc_justifiability_analysis(self) -> dict:
        ...
        if self.use_emulator:
            print(f"Correct for surrogates")
    ...
    def plot_confusion_matrix(self, confusion_matrix):
        ...
        g.figure.savefig(f"{self.out_dir}confusionMatrix_full.pdf", bbox_inches="tight")
        plt.close()
    ...
    def plot_model_weights(self, model_weights):
        ...
        # Save the figure
        fig.savefig(f"./{self.out_dir}model_weights.pdf", bbox_inches="tight")
    ...
    def plot_bayes_factor(self, bme_dict):
        ...
        plt.savefig(f"./{self.out_dir}Bayes_Factor_kde_plot.pdf", bbox_inches="tight")
        plt.close()
