...
from pydantic import BaseModel, Field, ConfigDict, validator, ValidationError, root_validator
...
class ZScoreWindow(BaseModel):
    window: Optional[Union[int, str]] = 14  # window can be int, or a string
