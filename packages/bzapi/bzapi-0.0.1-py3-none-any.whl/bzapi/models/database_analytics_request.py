...
class DatabaseAnalyticsRequest(BaseModel):
    ...
    sql_query: Optional[StrictStr] = Field(default=None, description="an explicit sql query to execute directly instead", alias="sqlQuery")
    __properties: ClassVar[List[str]] = ["command", "sqlQuery"]
