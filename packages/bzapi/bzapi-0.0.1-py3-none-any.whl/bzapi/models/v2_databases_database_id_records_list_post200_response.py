...
class V2DatabasesDatabaseIdRecordsListPost200Response(BaseModel):
    """
    V2DatabasesDatabaseIdRecordsListPost200Response
    """ # noqa: E501
    has_more: StrictBool = Field(alias="hasMore")
    offset: StrictStr
    offset_id: StrictInt = Field(alias="offsetId")
    count: StrictInt
    items: List[DatabaseRecord]
    __properties: ClassVar[List[str]] = ["hasMore", "offset", "offsetId", "count", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "offsetId": obj.get("offsetId"),
            "count": obj.get("count"),
            "items": [DatabaseRecord.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
