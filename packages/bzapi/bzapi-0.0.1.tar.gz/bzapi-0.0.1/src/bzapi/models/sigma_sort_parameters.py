...
class SigmaSortParameters(BaseModel):
    """
    SigmaSortParameters
    """ # noqa: E501
    limit: Optional[StrictInt] = None
    direction: Optional[StrictStr] = None
    sort_column: Optional[StrictStr] = Field(default=None, alias="sortColumn")
    offset_id: Optional[StrictInt] = Field(default=None, alias="offsetId")
    offset: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["limit", "direction", "sortColumn", "offsetId", "offset"]
