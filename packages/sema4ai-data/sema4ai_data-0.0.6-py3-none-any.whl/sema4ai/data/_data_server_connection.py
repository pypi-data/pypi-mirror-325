...
from sema4ai.data._models import ColumInfo, SourceInfo, TableInfo
...
class DataServerConnection:
    ...
    def list_columns(self, database_name: str, table_name: str) -> list[ColumInfo]:
        """
        ...
        return result.build_list(ColumInfo)

    def list_knowledge_bases(self) -> Table:
        """
