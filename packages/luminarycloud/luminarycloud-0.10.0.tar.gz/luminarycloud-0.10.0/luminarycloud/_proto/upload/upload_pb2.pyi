...
class ResourceParams(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["c81_params", b"c81_params", "geometry_params", b"geometry_params", "mesh_params", b"mesh_params", "params", b"params"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["c81_params", b"c81_params", "geometry_params", b"geometry_params", "mesh_params", b"mesh_params", "params", b"params"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["params", b"params"]) -> typing_extensions.Literal["mesh_params", "geometry_params", "c81_params"] | None: ...
