...
class Simulation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "description", b"description", "id", b"id", "mesh_id", b"mesh_id", "name", b"name", "status", b"status", "update_time", b"update_time"]) -> None: ...
