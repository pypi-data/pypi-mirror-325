...
from src.hydrolib.type_func import get_type_name
...
class EnvironmentManager:
    ...
    def __init__(self, env_mapping=None):
        if env_mapping is not None:
            self._env: dict[str, _ManagerEnvironmentItem] = {
                k: _ManagerEnvironmentItem(k, v) for k, v in env_mapping.items()}
        else:
            self._env = {}
    ...
    def env(self, key: str = None, k=None, v=None) -> Union[dict[str, _ManagerEnvironmentItem], _ManagerEnvironmentItem]:
