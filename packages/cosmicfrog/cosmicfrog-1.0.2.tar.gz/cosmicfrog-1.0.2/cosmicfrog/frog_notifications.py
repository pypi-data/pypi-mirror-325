...
CF_ACTIVITY_URL = os.getenv("CF_ACTIVITY_URL_NEW", "https://service.optilogic.app/websocket/message")
CF_NOTIFICATION_URL = os.getenv("CF_NOTIFICATION_URL", "https://api.optilogic.app").strip("/")
