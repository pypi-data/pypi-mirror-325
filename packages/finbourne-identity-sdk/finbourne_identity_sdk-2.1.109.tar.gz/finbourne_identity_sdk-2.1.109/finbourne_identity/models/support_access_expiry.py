...
class SupportAccessExpiry(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupportAccessExpiry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SupportAccessExpiry:
        """Create an instance of SupportAccessExpiry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SupportAccessExpiry.parse_obj(obj)

        _obj = SupportAccessExpiry.parse_obj({
