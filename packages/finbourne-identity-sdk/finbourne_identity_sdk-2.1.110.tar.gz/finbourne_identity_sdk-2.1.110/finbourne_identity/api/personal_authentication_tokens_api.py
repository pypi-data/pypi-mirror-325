...
class PersonalAuthenticationTokensApi:
    ...
    @overload
    async def delete_api_key(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The id of the Personal Access Token to delete")], **kwargs) -> ApiKey:  # noqa: E501
        ...
