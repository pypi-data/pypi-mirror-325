...
class UsersApi:
    ...
    @overload
    async def expire_password(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the User having its password reset")], **kwargs) -> TemporaryPassword:  # noqa: E501
        ...
    ...
    @overload
    async def reset_factors(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the User having their MFA factors reset")], **kwargs) -> None:  # noqa: E501
        ...
    ...
    @overload
    async def reset_password(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the User having their password reset")], **kwargs) -> None:  # noqa: E501
        ...
    ...
    @overload
    async def send_activation_email(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the User to be activated")], **kwargs) -> None:  # noqa: E501
        ...
    ...
    @overload
    async def unlock_user(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the User to be unlocked")], **kwargs) -> None:  # noqa: E501
        ...
    ...
    @overload
    async def unsuspend_user(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the User to Unsuspend")], **kwargs) -> None:  # noqa: E501
        ...

    @overload
    def unsuspend_user(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the User to Unsuspend")], async_req: Optional[bool]=True, **kwargs) -> None:  # noqa: E501
        ...

    @validate_arguments
    def unsuspend_user(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the User to Unsuspend")], async_req: Optional[bool]=None, **kwargs) -> Union[None, Awaitable[None]]:  # noqa: E501
    ...
    @validate_arguments
    def unsuspend_user_with_http_info(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the User to Unsuspend")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] UnsuspendUser: Unsuspend user  # noqa: E501
    ...
    @overload
    async def update_user(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the User to be updated")], update_user_request : Annotated[UpdateUserRequest, Field(..., description="The new definition of the User")], **kwargs) -> UserResponse:  # noqa: E501
        ...
