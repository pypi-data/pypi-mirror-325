...
class CreateRoleRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateRoleRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateRoleRequest:
        """Create an instance of CreateRoleRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateRoleRequest.parse_obj(obj)

        _obj = CreateRoleRequest.parse_obj({
            "name": obj.get("name"),
