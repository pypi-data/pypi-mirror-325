...
class AuthenticationInformation(BaseModel):
    ...
    def to_dict(self):
        ...
        if self.fallback_issuer_urls is None and "fallback_issuer_urls" in self.__fields_set__:
            _dict['fallbackIssuerUrls'] = None

        # set to None if saml_identity_provider_id (nullable) is None
        # and __fields_set__ contains the field
        if self.saml_identity_provider_id is None and "saml_identity_provider_id" in self.__fields_set__:
    ...
    def from_dict(cls, obj: dict) -> AuthenticationInformation:
        ...
        if not isinstance(obj, dict):
            return AuthenticationInformation.parse_obj(obj)

        _obj = AuthenticationInformation.parse_obj({
