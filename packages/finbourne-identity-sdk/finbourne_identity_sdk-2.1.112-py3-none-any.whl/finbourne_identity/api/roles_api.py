...
class RolesApi:
    ...
    @overload
    async def add_user_to_role(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the Role")], user_id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the User")], **kwargs) -> None:  # noqa: E501
        ...
    ...
    @overload
    async def delete_role(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the role")], **kwargs) -> None:  # noqa: E501
        ...
    ...
    @overload
    async def get_role(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the role")], **kwargs) -> RoleResponse:  # noqa: E501
        ...
    ...
    @overload
    async def list_users_in_role(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the Role")], **kwargs) -> List[UserResponse]:  # noqa: E501
        ...
    ...
    @overload
    async def remove_user_from_role(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the Role")], user_id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the User")], **kwargs) -> None:  # noqa: E501
        ...
    ...
    @overload
    async def update_role(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The unique identifier for the role to be updated")], update_role_request : Annotated[Optional[UpdateRoleRequest], Field(description="The new definition of the role")] = None, **kwargs) -> RoleResponse:  # noqa: E501
        ...
