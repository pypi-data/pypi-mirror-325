...
class Waveform:
    ...
    def _calculate_signal_envelope(self):
        ...
        self._normal_signal_envelope = (self.signal_envelope - self.signal_envelope.min()) / np.ptp(self.signal_envelope)
    ...
    def _scale_waveform(self, scale_factor: float = 1.0, inplace: bool = False):
        ...
        if inplace:
            ...
            return Waveform(self._samples * scale_factor, self.sample_rate, self.start_time, remove_dc_offset=False)
    ...
    def resample(self, new_sample_rate: int):
        ...
        return Waveform(
            ...
            new_sample_rate, self.start_time, remove_dc_offset=False
        )
    ...
    def get_features(self, include_temporal_features:bool = True,
    ...
    def __add__(self, other):
        ...
        return Waveform(self.samples[s0:s1] + other.samples, self.sample_rate, self.start_time, remove_dc_offset=False)
...
class FrameBuilder:
    ...
    def __init__(self, wfm: Waveform, overlap_pct: float = 0, frame_width_sec: float = 0.25):
        """
        ...
        :param wfm: The object that contains the audio data
        :type wfm: Waveform
    ...
    def get_next_waveform_subset(self):
        """
        ...
        wfm = self._waveform.trim(self._s0, self._s1, method=TrimmingMethods.samples)
