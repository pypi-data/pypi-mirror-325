...
def test_capex_per_kg(salt_cavern_storage):
    salt_cavern_storage_capex_per_kg, _installed_capex, _compressor_capex = (
...
def test_capex(salt_cavern_storage):
    _salt_cavern_storage_capex_per_kg, installed_capex, _compressor_capex = (
        salt_cavern_storage.salt_cavern_capex()
    )
...
def test_opex(salt_cavern_storage):
    _salt_cavern_storage_capex_per_kg, _installed_capex, _compressor_capex = (
        salt_cavern_storage.salt_cavern_capex()
    )
