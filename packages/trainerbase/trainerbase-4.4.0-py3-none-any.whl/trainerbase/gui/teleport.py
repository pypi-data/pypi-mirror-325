...
class TeleportUI(AbstractUIComponent):
    ...
    def _tp_add_save_set_position_hotkeys_if_needed(self):
        ...
        add_hotkey(self.hotkey_save_position, partial(self.on_hotkey_save_position_press, 0))
        add_hotkey(self.hotkey_set_saved_position, partial(self.on_hotkey_set_saved_position_press, 0))
        ...
        if self.hotkey_secondary_position_modifier:
            ...
            add_hotkey(hotkey_save_secondary_position, partial(self.on_hotkey_save_position_press, 1))
            add_hotkey(hotkey_set_secondary_saved_position, partial(self.on_hotkey_set_saved_position_press, 1))
