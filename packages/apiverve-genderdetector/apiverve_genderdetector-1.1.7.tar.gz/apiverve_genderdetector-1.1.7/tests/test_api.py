...
class TestGenderdetectorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = GenderdetectorAPIClient(self.api_key)

    @patch('apiverve_genderdetector.apiClient.requests.get')
