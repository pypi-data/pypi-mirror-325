...
from datarobot._experimental.models.notebooks.enums import (
...
from datarobot._experimental.models.notebooks.revision import (
...
from datarobot._experimental.models.notebooks.settings import (
    notebook_settings_trafaret,
    NotebookSettings,
)
from datarobot._experimental.models.notebooks.user import (
    notebook_activity_trafaret,
    NotebookActivity,
)
