...
class ContactextractorAPIClient:
    def __init__(self, api_key, secure=True):
        """
        Initialize the ContactextractorAPIClient with the API key and secure flag
        ...
        self.secure = secure
        self.base_url = 'https://api.apiverve.com/v1/contactextractor'
        self.headers = {
