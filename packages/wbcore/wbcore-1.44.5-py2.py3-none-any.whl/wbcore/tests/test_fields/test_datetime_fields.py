...
from wbcore.serializers import DateField, DateTimeField, TimeField
...
class TestDateTimeField:
    ...
    def test_field_type(self):
        assert self.field.field_type == WBCoreType.DATETIME.value
...
class TestDateField:
    ...
    def test_field_type(self):
        assert self.field.field_type == WBCoreType.DATE.value
...
class TestTimeField:
    ...
    def test_field_type(self):
        assert self.field.field_type == WBCoreType.TIME.value
