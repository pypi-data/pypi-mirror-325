...
class RequestEnsDetails(BaseModel):
    """
    RequestEnsDetails
    """ # noqa: E501
    ens_name: StrictStr = Field(description="The ENS address of the user.")
    __properties: ClassVar[List[str]] = ["ens_name"]
