...
class BaseTransactionRequestIncreaseErc20AllowanceCallData(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "call_data": IncreaseErc20AllowanceCallData.from_dict(obj["call_data"]) if obj.get("call_data") is not None else None
        })
        return _obj
