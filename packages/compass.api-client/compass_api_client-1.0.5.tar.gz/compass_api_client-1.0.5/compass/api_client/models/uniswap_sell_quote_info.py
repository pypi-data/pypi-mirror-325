...
class UniswapSellQuoteInfo(BaseModel):
    """
    UniswapSellQuoteInfo
    """ # noqa: E501
    amount_out: StrictStr = Field(description="The amount of token_out you would receive from the pool.")
    ...
    __properties: ClassVar[List[str]] = ["amount_out", "price_after"]
