...
class LPPositionsInfo(BaseModel):
    """
    LPPositionsInfo
    """ # noqa: E501
    positions: Dict[str, Position] = Field(description="Liquidity provision positions belonging to a particular user. The key is a tuple of the token0, token1, fee, tick_lower, and tick_upper of the position.")
