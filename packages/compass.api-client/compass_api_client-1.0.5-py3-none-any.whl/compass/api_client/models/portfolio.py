...
class Portfolio(BaseModel):
    ...
    Portfolio
    """ # noqa: E501
    total_value_in_usd: StrictStr = Field(description="Total value of the portfolio in USD")
    token_balances: List[TokenBalance] = Field(description="List of token balances in the portfolio")
    __properties: ClassVar[List[str]] = ["total_value_in_usd", "token_balances"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.token_balances:
            for _item_token_balances in self.token_balances:
                if _item_token_balances:
                    _items.append(_item_token_balances.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total_value_in_usd": obj.get("total_value_in_usd"),
            "token_balances": [TokenBalance.from_dict(_item) for _item in obj["token_balances"]] if obj.get("token_balances") is not None else None
        })
        return _obj
