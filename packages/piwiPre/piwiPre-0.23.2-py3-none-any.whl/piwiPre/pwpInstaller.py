...
class PwpInstallerUi(PwpGui):
    def __init__(self, args, installer):
        ...
        row += 1
        ttk.Label(self.frm, text="piwiPre installer", anchor="w", padding=4, font=PwpGui.label_font,
        ...
        row += 1
        ttk.Label(self.frm, text="piwiPre + doc", anchor="w", padding=4, font=PwpGui.label_font,
                  ).grid(column=0, row=row, sticky="W")
