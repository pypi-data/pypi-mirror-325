...
class SimilarItemRequest(BaseModel):
    ...
    SimilarItemRequest
    """ # noqa: E501
    item_id: StrictStr = Field(description="The query item to find similar results for.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SimilarItemRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SimilarItemRequest from a dict"""
        if obj is None:
            return None
