...
class ComplementItemsResponse(BaseModel):
    """
    ComplementItemsResponse
    """ # noqa: E501
    ids: List[StrictStr]
    metadata: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["ids", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ComplementItemsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ComplementItemsResponse from a dict"""
        if obj is None:
            return None
