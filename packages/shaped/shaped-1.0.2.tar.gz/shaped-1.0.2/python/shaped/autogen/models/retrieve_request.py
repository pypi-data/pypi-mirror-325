...
class RetrieveRequest(BaseModel):
    ...
    RetrieveRequest
    """ # noqa: E501
    user_id_query: Optional[StrictStr] = Field(default=None, description="If provided return items that are relevant the to the given user.")
    text_query: Optional[StrictStr] = Field(default=None, description="If provided return items that are relevant the to the given text query.")
    ...
    __properties: ClassVar[List[str]] = ["user_id_query", "text_query", "filter_predicate", "flush_paginations", "return_metadata", "config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user_id_query": obj.get("user_id_query"),
