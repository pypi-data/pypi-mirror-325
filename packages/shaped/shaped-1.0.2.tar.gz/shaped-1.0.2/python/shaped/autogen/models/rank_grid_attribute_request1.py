...
class RankGridAttributeRequest1(BaseModel):
    """
    RankGridAttributeRequest1
    """ # noqa: E501
    attribute_name: StrictStr
    user_id: Optional[StrictStr] = None
    row_limit: Optional[Union[StrictFloat, StrictInt]] = 10
    col_limit: Optional[Union[StrictFloat, StrictInt]] = 10
    __properties: ClassVar[List[str]] = ["attribute_name", "user_id", "row_limit", "col_limit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RankGridAttributeRequest1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RankGridAttributeRequest1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "row_limit": obj.get("row_limit") if obj.get("row_limit") is not None else 10,
            "col_limit": obj.get("col_limit") if obj.get("col_limit") is not None else 10
        })
        return _obj
