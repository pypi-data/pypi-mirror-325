...
class SegmentDatasetConfig(BaseModel):
    """
    SegmentDatasetConfig
    """ # noqa: E501
    name: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SegmentDatasetConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SegmentDatasetConfig from a dict"""
        if obj is None:
            return None
