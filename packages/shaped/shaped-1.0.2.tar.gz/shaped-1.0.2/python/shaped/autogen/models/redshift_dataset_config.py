...
class RedshiftDatasetConfig(BaseModel):
    """
    RedshiftDatasetConfig
    """ # noqa: E501
    name: StrictStr
    host: StrictStr
    port: StrictInt
    ...
    __properties: ClassVar[List[str]] = ["name", "host", "port", "user", "password", "table", "database", "replication_key", "columns", "database_schema", "start_date", "schedule_interval", "schema_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RedshiftDatasetConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RedshiftDatasetConfig from a dict"""
        if obj is None:
            return None
