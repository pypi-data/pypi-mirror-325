...
class CreateModelArguments(BaseModel):
    ...
    """ # noqa: E501
    model: ModelConfig
    connectors: List[ConnectorsInner]
    fetch: FetchConfig
    __properties: ClassVar[List[str]] = ["model", "connectors", "fetch"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateModelArguments from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.fetch:
            _dict['fetch'] = self.fetch.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateModelArguments from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "connectors": [ConnectorsInner.from_dict(_item) for _item in obj["connectors"]] if obj.get("connectors") is not None else None,
            "fetch": FetchConfig.from_dict(obj["fetch"]) if obj.get("fetch") is not None else None
        })
        return _obj
