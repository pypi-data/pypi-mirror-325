...
from shaped.autogen.api_response import ApiResponse, T as ApiResponseT
import shaped.autogen.models
from shaped.autogen import rest
from shaped.autogen.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(shaped.autogen.models, klass)
