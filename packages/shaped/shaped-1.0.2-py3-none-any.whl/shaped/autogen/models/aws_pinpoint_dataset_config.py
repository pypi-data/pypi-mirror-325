...
class AWSPinpointDatasetConfig(BaseModel):
    """
    AWSPinpointDatasetConfig
    """ # noqa: E501
    tenant_aws_account_id: StrictStr
    schema_type: StrictStr
    __properties: ClassVar[List[str]] = ["tenant_aws_account_id", "schema_type"]

    @field_validator('schema_type')
    def schema_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AWS_PINPOINT']):
            raise ValueError("must be one of enum values ('AWS_PINPOINT')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AWSPinpointDatasetConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AWSPinpointDatasetConfig from a dict"""
        if obj is None:
            return None
