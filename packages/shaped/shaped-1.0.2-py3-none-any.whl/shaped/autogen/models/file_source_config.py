...
class FileSourceConfig(BaseModel):
    ...
    """ # noqa: E501
    path: StrictStr
    day_lookback: Optional[StrictInt] = 0
    __properties: ClassVar[List[str]] = ["path", "day_lookback"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileSourceConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileSourceConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "path": obj.get("path"),
            "day_lookback": obj.get("day_lookback") if obj.get("day_lookback") is not None else 0
        })
        return _obj
