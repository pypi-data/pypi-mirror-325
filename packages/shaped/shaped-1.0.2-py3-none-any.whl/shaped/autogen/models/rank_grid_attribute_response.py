...
class RankGridAttributeResponse(BaseModel):
    """
    RankGridAttributeResponse
    """ # noqa: E501
    id_grid: Optional[List[List[StrictStr]]] = None
    scoregrid: Optional[List[List[Union[StrictFloat, StrictInt]]]] = None
    attributes: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["id_grid", "scoregrid", "attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RankGridAttributeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RankGridAttributeResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id_grid": obj.get("id_grid"),
            "scoregrid": obj.get("scoregrid"),
