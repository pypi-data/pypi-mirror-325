...
class AmplitudeDatasetConfig(BaseModel):
    """
    AmplitudeDatasetConfig
    """ # noqa: E501
    name: StrictStr
    ...
    def schema_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AMPLITUDE']):
            raise ValueError("must be one of enum values ('AMPLITUDE')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AmplitudeDatasetConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AmplitudeDatasetConfig from a dict"""
        if obj is None:
            return None
