...
class FileConfig(BaseModel):
    """
    Creates a file source that can be used in the fetch queries.
    """ # noqa: E501
    type: Optional[StrictStr] = 'File'
    id: StrictStr
    path: Optional[Path] = None
    __properties: ClassVar[List[str]] = ["type", "id", "path"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileConfig from a dict"""
        if obj is None:
            return None
