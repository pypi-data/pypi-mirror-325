...
class CreateItemEmbeddingRequest(BaseModel):
    """
    CreateItemEmbeddingRequest
    """ # noqa: E501
    item_ids: List[StrictStr]
    dimension: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["item_ids", "dimension"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateItemEmbeddingRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateItemEmbeddingRequest from a dict"""
        if obj is None:
            return None
