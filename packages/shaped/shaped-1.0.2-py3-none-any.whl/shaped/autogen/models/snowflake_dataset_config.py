...
class SnowflakeDatasetConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "replication_key", "account", "user", "password", "table", "columns", "database", "database_schema", "warehouse", "role", "schedule_interval", "schema_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SnowflakeDatasetConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SnowflakeDatasetConfig from a dict"""
        if obj is None:
            return None
