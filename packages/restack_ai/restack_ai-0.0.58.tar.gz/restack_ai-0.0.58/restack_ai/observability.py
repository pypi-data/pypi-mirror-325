...
BLACK_LIST_META = ['sdk_component', 'is_local', 'attempt', 'namespace', 'task_token', 'activity_id', 'restack', 'client_log']
...
class ColoredFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        if (record.levelname == 'DEBUG' or record.levelname == 'WARNING' and not getattr(record, 'extra_fields', {}).get('restack') and not getattr(record, 'extra_fields', {}).get('client_log')):
