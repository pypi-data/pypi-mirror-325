...
if(NOT cmeel-example_FOUND)
  set(skip_this_file FALSE)
endif()
if(skip_this_file)
  foreach(component ${cmeel-example_FIND_COMPONENTS})
    if(NOT "cmeel-example_${component}_FOUND")
      set(skip_this_file FALSE)
    endif()
  endforeach()
endif()
...
set("cmeel-example_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("CMEEL_EXAMPLE_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("cmeel-example_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/cmeel-example/doxygen-html")
set("CMEEL_EXAMPLE_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/cmeel-example/doxygen-html")
set("cmeel-example_DEPENDENCIES" "")
set("cmeel-example_PKG_CONFIG_DEPENDENCIES" "")
...
set("_cmeel-example_PKG_CONFIG_LIBDIR" "${pcfiledir}/../../lib")
set("_cmeel-example_PKG_CONFIG_LIBS_LIST" "")
if(_cmeel-example_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_cmeel-example_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _cmeel-example_PKG_CONFIG_LIBS_LIST "${_cmeel-example_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_cmeel-example_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _cmeel-example_PKG_CONFIG_LIBS_LIST "${_cmeel-example_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_cmeel-example_PKG_CONFIG_LIBDIR})
  foreach(component ${_cmeel-example_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_cmeel-example_PKG_CONFIG_LIBS_LIST)

set("cmeel-example_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("CMEEL_EXAMPLE_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${cmeel-example_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/cmeel-exampleTargets.cmake")
...
foreach(component ${cmeel-example_FIND_COMPONENTS})
  ...
  if(EXISTS ${comp_file})
    ...
    set(cmeel-example_${component}_FOUND FALSE)
  endif()
  if(cmeel-example_${component}_FOUND)
    message(STATUS "cmeel-example: ${component} found.")
  else()
    if(cmeel-example_FIND_REQUIRED_${component})
      message(FATAL_ERROR "cmeel-example: ${component} not found.")
    else()
      message(STATUS "cmeel-example: ${component} not found.")
    endif()
  endif()
endforeach()
check_required_components("cmeel-example")
