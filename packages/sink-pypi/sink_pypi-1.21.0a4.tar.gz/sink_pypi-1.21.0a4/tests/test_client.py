...
from sink.api.sdk._constants import RAW_RESPONSE_HEADER
...
class TestSink:
    ...
    def test_base_url_env(self) -> None:
        with update_env(SINK_BASE_URL="http://localhost:5000/from/env"):
            client = Sink(
                user_token=user_token,
                username=username,
                some_number_arg_required_no_default=some_number_arg_required_no_default,
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            self.client.post(
                "/cards",
                body=cast(object, dict(type="SINGLE_USE", not_="TEST")),
                cast_to=httpx.Response,
