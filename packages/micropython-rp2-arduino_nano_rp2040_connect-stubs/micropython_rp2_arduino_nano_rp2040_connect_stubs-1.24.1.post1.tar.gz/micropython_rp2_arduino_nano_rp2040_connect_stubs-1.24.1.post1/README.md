...
Included stubs:
* Merged stubs from `stubs/micropython-v1_24_1-rp2-ARDUINO_NANO_RP2040_CONNECT-merged`
* Frozen stubs from `stubs/micropython-v1_24_1-frozen/rp2/ARDUINO_NANO_RP2040_CONNECT`
