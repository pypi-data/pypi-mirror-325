...
---
Module: 'machine' on micropython-v1.24.1-rp2-ARDUINO_NANO_RP2040_CONNECT
"""
...
class Pin:
    ...
    class board:
        ...
        D17: Pin  ## = Pin(GPIO29, mode=ALT, pull=PULL_DOWN, alt=31)
        ...
        D16: Pin  ## = Pin(GPIO28, mode=ALT, pull=PULL_DOWN, alt=31)
        D14: Pin  ## = Pin(GPIO26, mode=ALT, pull=PULL_DOWN, alt=31)
        D15: Pin  ## = Pin(GPIO27, mode=ALT, pull=PULL_DOWN, alt=31)
        def __init__(self, *argv, **kwargs) -> None: ...
...
class USBDevice:
    ...
    class BUILTIN_CDC_MSC:
        ep_max: int = 4
        itf_max: int = 3
        str_max: int = 6
        desc_dev: bytes = b"\x12\x01\x00\x02\xef\x02\x01@A#^\x02\x00\x01\x01\x02\x03\x01"
        desc_cfg: bytes = (
            b"\t\x02b\x00\x03\x01\x00\x80}\x08\x0b\x00\x02\x02\x02\x00\x00\t\x04\x00\x00\x01\x02\x02\x00\x04\x05$\x00 \x01\x05$\x01\x00\x01\x04$\x02\x06\x05$\x06\x00\x01\x07\x05\x81\x03\x08\x00\x10\t\x04\x01\x00\x02\n\x00\x00\x00\x07\x05\x02\x02@\x00\x00\x07\x05\x82\x02@\x00\x00\t\x04\x02\x00\x02\x08\x06P\x05\x07\x05\x03\x02@\x00\x00\x07\x05\x83\x02@\x00\x00"
        )
        def __init__(self, *argv, **kwargs) -> None: ...
