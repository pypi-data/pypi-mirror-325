...
class TestDomainexpirationAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = DomainexpirationAPIClient(self.api_key)

    @patch('apiverve_domainexpiration.apiClient.requests.get')
