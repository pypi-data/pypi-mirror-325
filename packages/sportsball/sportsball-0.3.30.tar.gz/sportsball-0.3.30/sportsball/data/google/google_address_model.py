...
_CACHED_GEOCODES: dict[str, Any] = {
    ...
    "Salt Lake City, Utah": SportsballGeocodeTuple(
        city="Salt Lake City",
        state="UT",
        postal="",
        lat=40.760833,
    ...
    "Austin, Texas": SportsballGeocodeTuple(
        city="Austin",
        state="TX",
        postal="",
        lat=30.267222,
    ...
    "Harrah's Cherokee Center, Asheville, North Carolina": SportsballGeocodeTuple(
        city="Asheville",
        state="NC",
        postal="",
        lat=35.597547,
    ...
    "Addition Financial Arena, Orlando, Florida": SportsballGeocodeTuple(
        city="Orlando",
        state="FL",
        postal="",
        lat=28.6068,
    ...
    "Coral Gables, Florida": SportsballGeocodeTuple(
        city="Coral Gables",
        state="FL",
        postal="",
        lat=25.716667,
    ...
    "Cleveland, Ohio": SportsballGeocodeTuple(
        city="Cleveland",
        state="OH",
        postal="",
        lat=41.499167,
    ...
    "KSU Convocation Center, Kennesaw, Georgia": KSU_CONVOCATION_CENTER,
    "Fredrick C. Hobdy Assembly Center, Grambling, Louisiana": SportsballGeocodeTuple(
        city="Grambling",
        state="LA",
        postal="",
        lat=32.520284,
    ...
    "Ross E. Templeton Center, Clinton, South Carolina": ROSS_E_TEMPLETON_CENTER,
    "PPG Paints Arena, Pittsburgh, Pennsylvania": SportsballGeocodeTuple(
        city="Pittsburgh",
        state="PA",
        postal="",
        lat=40.439444,
    ...
    "Jersey Mike's Arena, New Brunswick, New Jersey": SportsballGeocodeTuple(
        city="New Brunswick",
        state="NJ",
        postal="08854",
        lat=40.525278,
    ...
    "Ocean Bank Convocation Center, Miami, Florida": SportsballGeocodeTuple(
        city="Miami",
        state="FL",
        postal="33199",
        lat=25.756667,
    ...
    "Atlanta, Georgia": SportsballGeocodeTuple(
        city="Atlanta",
        state="GA",
        postal="",
        lat=33.748889,
    ...
    "Wellness and Events Center, Newark, New Jersey": SportsballGeocodeTuple(
        city="Newark",
        state="NJ",
        postal="07102",
        lat=40.7453,
    ...
    "Buccaneer Field House, Charleston, South Carolina": SportsballGeocodeTuple(
        city="Charleston",
        state="SC",
        postal="29406",
        lat=32.980822,
    ...
    "Truist Arena, Highland Heights, Kentucky": SportsballGeocodeTuple(
        city="Highland Heights",
        state="KT",
        postal="41099",
        lat=39.032273,
    ...
    "Louisville, Kentucky": SportsballGeocodeTuple(
        city="Louisville",
        state="KT",
        postal="",
        lat=38.256111,
    ...
    "Chicago, Illinois": SportsballGeocodeTuple(
        city="Chicago",
        state="IL",
        postal="",
        lat=41.881944,
