...
class TestIters(unittest.TestCase):
    ...
    def test_string_types(self):
        self.assertTrue(isinstance("abc", iters.string_types))
        self.assertTrue(isinstance(u"abc", iters.string_types))
        self.assertTrue(isinstance(b"abc", iters.string_types))
        self.assertFalse(isinstance(17, iters.string_types))
        self.assertFalse(isinstance([], iters.string_types))

    def test_iterable(self):
        self.assertTrue(not iters.iterable("abc"))
        self.assertTrue(not iters.iterable(u"abc"))
        self.assertTrue(not iters.iterable(17))
        self.assertTrue(not iters.iterable(3.14))
        self.assertTrue(iters.iterable((0, 1)))
        self.assertTrue(iters.iterable([0, 1]))
        self.assertTrue(iters.iterable(x for x in range(2)))
    ...
    def test_empty(self):
        ...
        self.assertTrue(iters.empty(""))
        self.assertTrue(iters.empty(ltr for ltr in ""))
