...
class TestReraise(unittest.TestCase):
    ...
    def test_plain_raise(self):
        ...
        try:                            # this is outer code
            ...
            raise AssertionError("'raise' did not reraise an exception")
    ...
    def test_reraise(self):
        ...
        try:                            # this is outer code
            ...
            raise AssertionError('reraise() raised wrong exception')
        else:
            raise AssertionError('reraise() did not raise an exception')
    ...
    def test_cleanup_exc(self):
        ...
        try:                            # this is outer code
            ...
            raise AssertionError('reraise() discarded cleanup exception')
        except ValueError as err:
            pass
        else:
            raise AssertionError('reraise did not raise an exception')
    ...
    def test_no_current_exc(self):
        ...
        try:                            # this is outer code
            with exc.reraise():
                pass
        except (FooError, ValueError, TypeError) as err:
            raise AssertionError('reraise() raised spurious exception') from err
...
class TestRetry(unittest.TestCase):
    ...
    def test_three(self):
        ...
        try:
            ...
            # We expect FooError.
            raise AssertionError('retry_func() did not propagate exception')
