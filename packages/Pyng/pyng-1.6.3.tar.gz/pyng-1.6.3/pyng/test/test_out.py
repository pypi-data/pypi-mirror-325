...
class TestOut(unittest.TestCase):
    ...
    def test_maybe_adapt(self):
        ...
        self.assertTrue(out.ofilter(write_flush).sink is write_flush)
    ...
    def check_adapter_write(self, sink, write):
        self.assertTrue(isinstance(sink, out.adapter))
        self.assertTrue(self.same_bound_method(sink.write, write))

    def check_adapter_write_flush(self, sink, write, flush):
        self.check_adapter_write(sink, write)
        self.assertTrue(self.same_bound_method(sink.flush, flush))
