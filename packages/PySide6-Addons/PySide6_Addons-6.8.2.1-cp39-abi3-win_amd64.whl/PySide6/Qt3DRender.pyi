...
class Qt3DRender(Shiboken.Object):
    ...
    class QAbstractRayCaster(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None= ..., *, runMode: PySide6.Qt3DRender.Qt3DRender.QAbstractRayCaster.RunMode | None= ..., filterMode: PySide6.Qt3DRender.Qt3DRender.QAbstractRayCaster.FilterMode | None= ..., hits: typing.Sequence[PySide6.Qt3DRender.Qt3DRender.QRayCasterHit] | None= ...) -> None: ...
    ...
    class QGraphicsApiFilter(PySide6.QtCore.QObject):
        ...
        def __init__(self, /, parent: PySide6.QtCore.QObject | None= ..., *, api: PySide6.Qt3DRender.Qt3DRender.QGraphicsApiFilter.Api | None= ..., profile: PySide6.Qt3DRender.Qt3DRender.QGraphicsApiFilter.OpenGLProfile | None= ..., minorVersion: int | None= ..., majorVersion: int | None= ..., extensions: typing.Sequence[str] | None= ..., vendor: str | None= ...) -> None: ...
    ...
    class QLevelOfDetail(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None= ..., *, camera: PySide6.Qt3DRender.Qt3DRender.QCamera | None= ..., currentIndex: int | None= ..., thresholdType: PySide6.Qt3DRender.Qt3DRender.QLevelOfDetail.ThresholdType | None= ..., thresholds: typing.Sequence[float] | None= ..., volumeOverride: PySide6.Qt3DRender.Qt3DRender.QLevelOfDetailBoundingSphere | None= ...) -> None: ...
    ...
    class QRenderCapabilities(PySide6.QtCore.QObject):
        ...
        def __init__(self, /, parent: PySide6.QtCore.QObject | None= ..., *, valid: bool | None= ..., api: PySide6.Qt3DRender.Qt3DRender.QRenderCapabilities.API | None= ..., profile: PySide6.Qt3DRender.Qt3DRender.QRenderCapabilities.Profile | None= ..., majorVersion: int | None= ..., minorVersion: int | None= ..., extensions: typing.Sequence[str] | None= ..., vendor: str | None= ..., renderer: str | None= ..., driverVersion: str | None= ..., glslVersion: str | None= ..., maxSamples: int | None= ..., maxTextureSize: int | None= ..., maxTextureUnits: int | None= ..., maxTextureLayers: int | None= ..., supportsUBO: bool | None= ..., maxUBOSize: int | None= ..., maxUBOBindings: int | None= ..., supportsSSBO: bool | None= ..., maxSSBOSize: int | None= ..., maxSSBOBindings: int | None= ..., supportsImageStore: bool | None= ..., maxImageUnits: int | None= ..., supportsCompute: bool | None= ..., maxWorkGroupCountX: int | None= ..., maxWorkGroupCountY: int | None= ..., maxWorkGroupCountZ: int | None= ..., maxWorkGroupSizeX: int | None= ..., maxWorkGroupSizeY: int | None= ..., maxWorkGroupSizeZ: int | None= ..., maxComputeInvocations: int | None= ..., maxComputeSharedMemorySize: int | None= ...) -> None: ...
    ...
    class QSortPolicy(PySide6.Qt3DRender.Qt3DRender.QFrameGraphNode):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None= ..., *, sortTypes: typing.Sequence[int] | None= ...) -> None: ...
