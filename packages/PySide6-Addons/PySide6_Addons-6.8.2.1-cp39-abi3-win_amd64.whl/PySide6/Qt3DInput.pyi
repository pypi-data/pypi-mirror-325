...
class Qt3DInput(Shiboken.Object):
    ...
    class QActionInput(PySide6.Qt3DInput.Qt3DInput.QAbstractActionInput):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None= ..., *, sourceDevice: PySide6.Qt3DInput.Qt3DInput.QAbstractPhysicalDevice | None= ..., buttons: typing.Sequence[int] | None= ...) -> None: ...
    ...
    class QAxisSetting(PySide6.Qt3DCore.Qt3DCore.QNode):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None= ..., *, deadZoneRadius: float | None= ..., axes: typing.Sequence[int] | None= ..., smooth: bool | None= ...) -> None: ...
    ...
    class QButtonAxisInput(PySide6.Qt3DInput.Qt3DInput.QAbstractAxisInput):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None= ..., *, scale: float | None= ..., buttons: typing.Sequence[int] | None= ..., acceleration: float | None= ..., deceleration: float | None= ...) -> None: ...
