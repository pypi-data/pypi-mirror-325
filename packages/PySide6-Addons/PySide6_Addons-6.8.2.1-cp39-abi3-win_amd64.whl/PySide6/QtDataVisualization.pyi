...
class Q3DTheme(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, themeType: PySide6.QtDataVisualization.Q3DTheme.Theme, /, parent: PySide6.QtCore.QObject | None= ..., *, type: PySide6.QtDataVisualization.Q3DTheme.Theme | None= ..., baseColors: typing.Sequence[PySide6.QtGui.QColor] | None= ..., backgroundColor: PySide6.QtGui.QColor | None= ..., windowColor: PySide6.QtGui.QColor | None= ..., labelTextColor: PySide6.QtGui.QColor | None= ..., labelBackgroundColor: PySide6.QtGui.QColor | None= ..., gridLineColor: PySide6.QtGui.QColor | None= ..., singleHighlightColor: PySide6.QtGui.QColor | None= ..., multiHighlightColor: PySide6.QtGui.QColor | None= ..., lightColor: PySide6.QtGui.QColor | None= ..., baseGradients: typing.Sequence[PySide6.QtGui.QLinearGradient] | None= ..., singleHighlightGradient: PySide6.QtGui.QLinearGradient | None= ..., multiHighlightGradient: PySide6.QtGui.QLinearGradient | None= ..., lightStrength: float | None= ..., ambientLightStrength: float | None= ..., highlightLightStrength: float | None= ..., labelBorderEnabled: bool | None= ..., font: PySide6.QtGui.QFont | None= ..., backgroundEnabled: bool | None= ..., gridEnabled: bool | None= ..., labelBackgroundEnabled: bool | None= ..., colorStyle: PySide6.QtDataVisualization.Q3DTheme.ColorStyle | None= ...) -> None: ...
    @typing.overload
...
class QBar3DSeries(PySide6.QtDataVisualization.QAbstract3DSeries):
    ...
    @typing.overload
    def __init__(self, dataProxy: PySide6.QtDataVisualization.QBarDataProxy, /, parent: PySide6.QtCore.QObject | None= ..., *, selectedBar: PySide6.QtCore.QPoint | None= ..., meshAngle: float | None= ..., rowColors: typing.Sequence[PySide6.QtGui.QColor] | None= ...) -> None: ...
    @typing.overload
    def __init__(self, /, parent: PySide6.QtCore.QObject | None= ..., *, dataProxy: PySide6.QtDataVisualization.QBarDataProxy | None= ..., selectedBar: PySide6.QtCore.QPoint | None= ..., meshAngle: float | None= ..., rowColors: typing.Sequence[PySide6.QtGui.QColor] | None= ...) -> None: ...
...
class QBarDataProxy(PySide6.QtDataVisualization.QAbstractDataProxy):
    ...
    def __init__(self, /, parent: PySide6.QtCore.QObject | None= ..., *, rowCount: int | None= ..., rowLabels: typing.Sequence[str] | None= ..., columnLabels: typing.Sequence[str] | None= ..., series: PySide6.QtDataVisualization.QBar3DSeries | None= ...) -> None: ...
