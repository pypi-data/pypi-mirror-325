...
from SimplerLLM.agents.sql_agent_exp import SQLAgent
...
db_config = {
    'host': '89.117.22.145',
    'user': 'db_agent_user',
    'password': '3anka270821',
    'database': 'lwh_db_clone_test'
}


user_simple_query_2 = "how many inactive users are there in the database?"


sql_agent = SQLAgent(llm_instance=llm_instance, db_config=db_config,verbose=False)

user_simple_query_3 = "what is the size of the database in GB?"

# # Generate a response
response = sql_agent.generate_response(user_simple_query_3)
print(response)
