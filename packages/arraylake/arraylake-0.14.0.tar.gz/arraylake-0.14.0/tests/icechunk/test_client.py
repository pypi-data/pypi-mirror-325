...
async def test_create_repo_with_duplicate_prefix(isolated_org_with_bucket, token, helpers):
    ...
    with pytest.raises(IcechunkError, match="repository error: repositories can only be created in clean prefixes"):
