...
class AsyncClient:
        ...
        *,
        ...
        Args:
            ...
            virtual_container_nicknames:
                ...
                and used for the virtual containers. Used for Icechunk repos only.
        ...
        if repo_model.kind == RepoKind.V1:
            ...
            container_creds = (
                await self.containers_credentials_for_buckets(org=repo_model.org, containers_to_buckets_map=virtual_container_nicknames)
                if virtual_container_nicknames
                else None
            )
        ...
        *,
        ...
        if repos:
            ...
            return await self.get_repo(
                ...
                checkout=checkout,
                config=config,
                virtual_container_nicknames=virtual_container_nicknames,
            )
        else:
    ...
    async def create_repo(
        ...
        *,
        ...
        repo_model = await mstore.create_database(repo_name, bucket_config_nickname, kind=kind, prefix=prefix)
        ...
        if kind == RepoKind.V1:
            ...
            try:
                ...
                return IcechunkRepository.create(
                    icechunk_storage, config=config, virtual_chunk_credentials=container_creds  # gets stored upon repo creation
                )
    ...
    async def get_icechunk_storage(
    ...
    async def get_icechunk_container_credentials_from_bucket(self, org: str, bucket_config_nickname: str):
        ...
        return get_icechunk_container_credentials(
            bucket_platform=bucket.platform, s3_credentials=credentials, credential_refresh_func=credential_refresh_func
        )
