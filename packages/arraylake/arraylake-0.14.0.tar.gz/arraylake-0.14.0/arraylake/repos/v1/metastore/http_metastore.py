...
class HttpMetastore(ArraylakeHttpClient, Metastore):
    ...
    async def create_database(self, name: str, bucket_nickname: str | None = None, kind: RepoKind = RepoKind.V1, prefix: str | None = None):
        """
        Params:
        ...
        """
        body = RepoCreateBody(name=name, bucket_nickname=bucket_nickname, kind=kind, prefix=prefix)
