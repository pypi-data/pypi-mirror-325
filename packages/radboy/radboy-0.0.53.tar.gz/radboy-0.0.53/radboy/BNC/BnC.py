...
class BnCUi:
	...
	def ssxq(self,fieldname='Name',delete=False):
		try:
			while True:
				searchName=Prompt.__init2__(None,func=self.mkText,ptext=f"{self.cashpoolTotal()}{fieldname} Search",helpText="search for CashPool Item using Name field",data=self)
