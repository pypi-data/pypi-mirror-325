...
class WizataDSAPIClient(ApiInterface):
    ...
    def query(self,
              ...
              group: dict = None,
              field: str = None,
              bucket: str = None) -> pandas.DataFrame:
        """
        ...
        :param group: can be use to set group system and event retrieving instructions.
    ...
    def upsert_experiment(self, key: str, name: str, pipeline=None):
        """
