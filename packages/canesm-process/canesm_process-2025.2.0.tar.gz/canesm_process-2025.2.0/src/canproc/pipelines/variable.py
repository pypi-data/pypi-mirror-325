...
class Variable:
    ...
    def write(self, output_dir: str, **kwargs):
        ...
        if "encoding" not in kwargs:
            kwargs["encoding"] = {"_FillValue": 1.0e20}
    ...
    def rename(self, new_name: str, reuse_from_tag: str | list[str] | None = None):
        ...
        self._add_op("rename", args=[new_name], short_name="rename", reuse_from_tag=reuse_from_tag)
        self.var_name = new_name

    def shift(self, shift: float | int, reuse_from_tag: str | list[str] | None = None):
        self._add_op("xr.add", args=[shift], short_name="shift", reuse_from_tag=reuse_from_tag)

    def scale(self, scale: float | int, reuse_from_tag: str | list[str] | None = None):
        self._add_op("xr.mul", args=[scale], short_name="scale", reuse_from_tag=reuse_from_tag)
    ...
    def divide(self, div: float | int, reuse_from_tag: str | list[str] | None = None):
        ...
        self._add_op(op, args=[div], short_name="divide", reuse_from_tag=reuse_from_tag)
    ...
    def persist(self, reuse_from_tag: str | list[str] | None = None):
        self._add_op("xr.self.persist", short_name="persist", reuse_from_tag=reuse_from_tag)
