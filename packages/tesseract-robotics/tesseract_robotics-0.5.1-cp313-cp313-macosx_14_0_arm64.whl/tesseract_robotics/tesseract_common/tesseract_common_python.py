...
class XMLNode(object):
    ...
    def Parent(self, *args):
        r"""Get the parent of this node on the DOM."""
    ...
    def FirstChild(self, *args):
        r"""Get the first child node, or null if none exists."""
    ...
    def LastChild(self, *args):
        r"""Get the last child node, or null if none exists."""
...
class XMLPrinter(XMLVisitor):
    ...
    def PushAttribute(self, *args):
        r"""If streaming, add an attribute to an open element."""
...
class GeneralResourceLocator(ResourceLocator):
    ...
    def __init__(self, *args):
        ...
        *Overload 1:*
        ...
        :type environment_variables: std::vector< std::string,std::allocator< std::string > >, optional
        ...
        *Overload 2:*
        ...
        Construct a new General Resource Locator object using the provided paths and/or the TESSERACT_RESOURCE_PATH
        environment variable

        :type paths: std::vector< boost::filesystem::path,std::allocator< boost::filesystem::path > >
...
class SimpleLocatedResource(Resource):
    ...
    def __init__(self, *args):
        ...
        *Overload 2:*
        ...
        :type parent: :py:class:`ResourceLocator`, optional
...
class BytesResource(Resource):
    ...
    def __init__(self, *args):
        r"""This is for boost serialization do not use directly"""
