...
from cvv.nmi import nmi_api
from cvv.paypalpro import paypalpro_api
from cvv.paypal_pro_payflow import paypal_pro_payflow_api
from cvv.stripe_cc import stripe_cc_api
from cvv.cybersource1 import cybersource_api1
from ccn.ppcp import ppcp_api
from ccn.cybersource2 import cybersource_api2
from woocommmerce.domaintoip import domaintoip_api
from woocommmerce.ipranger import ipranger_api
from woocommmerce.ipschecker import ipschecker_api
from woocommmerce.revereseip import revereseip_api
from woocommmerce.woocommercepm import woocommercepm_api
from testing.lookup import lookup_api
...
def main():
    ...
    display_logo()
    print()
    display_menu(["Generate Credit Card", "Check Credit Card", "Woocommerce Tools"])
    ...
    try:
        if choice == "1":
            ...
            clear_screen()
            display_logo()
            display_menu(["Cvv Gateway", "Cnn Gateway", "Testing Gateway"])
