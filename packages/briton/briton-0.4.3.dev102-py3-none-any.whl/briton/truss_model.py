...
class Model:
    def __init__(self, **kwargs):
        ...
        self._lookahead_decoding_config = _lookahead_decoding_config(model_metadata)
...
def _lookahead_decoding_config(model_metadata: dict) -> Optional[LookaheadDecodingConfig]:
    if "lookahead_decoding_config" in model_metadata:
        return LookaheadDecodingConfig(**model_metadata["lookahead_decoding_config"])
    return None
