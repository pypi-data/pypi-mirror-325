...
class UsersStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateCustomer = channel.unary_unary(
                ...
                request_serializer=tarot_dot_tarot_dot_users__pb2.CreateCustomerRequest.SerializeToString,
                response_deserializer=tarot_dot_tarot_dot_users__pb2.CustomerProfile.FromString,
                )
        self.GetCustomer = channel.unary_unary(
                '/tarot.Users/GetCustomer',
                request_serializer=tarot_dot_tarot_dot_users__pb2.GetCustomerRequest.SerializeToString,
                response_deserializer=tarot_dot_tarot_dot_users__pb2.CustomerProfile.FromString,
                )
        ...
        self.GetCustomerBalance = channel.unary_unary(
                ...
                request_serializer=tarot_dot_tarot_dot_users__pb2.GetCustomerRequest.SerializeToString,
                response_deserializer=tarot_dot_tarot_dot_users__pb2.CustomerBalance.FromString,
                )
        self.GetCustomerTransactions = channel.unary_unary(
                '/tarot.Users/GetCustomerTransactions',
                request_serializer=tarot_dot_tarot_dot_users__pb2.GetCustomerRequest.SerializeToString,
                response_deserializer=tarot_dot_tarot_dot_users__pb2.CustomerTransactions.FromString,
                )
        self.TopUpBalance = channel.unary_unary(
                '/tarot.Users/TopUpBalance',
                request_serializer=tarot_dot_tarot_dot_users__pb2.TopUpBalanceRequest.SerializeToString,
                response_deserializer=tarot_dot_tarot_dot_users__pb2.CustomerBalance.FromString,
                )
        self.InitiateInternalPurchase = channel.unary_unary(
                '/tarot.Users/InitiateInternalPurchase',
                request_serializer=tarot_dot_tarot_dot_users__pb2.InternalPurchaseRequest.SerializeToString,
                response_deserializer=tarot_dot_tarot_dot_users__pb2.CustomerTransaction.FromString,
                )
        self.CommitInternalPurchase = channel.unary_unary(
                '/tarot.Users/CommitInternalPurchase',
                request_serializer=tarot_dot_tarot_dot_users__pb2.CommitInternalPurchaseRequest.SerializeToString,
                response_deserializer=tarot_dot_tarot_dot_users__pb2.CustomerTransaction.FromString,
                )
...
def add_UsersServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateCustomer': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=tarot_dot_tarot_dot_users__pb2.CreateCustomerRequest.FromString,
                    response_serializer=tarot_dot_tarot_dot_users__pb2.CustomerProfile.SerializeToString,
            ),
            'GetCustomer': grpc.unary_unary_rpc_method_handler(
                    servicer.GetCustomer,
                    request_deserializer=tarot_dot_tarot_dot_users__pb2.GetCustomerRequest.FromString,
                    response_serializer=tarot_dot_tarot_dot_users__pb2.CustomerProfile.SerializeToString,
            ),
            ...
            'GetCustomerBalance': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=tarot_dot_tarot_dot_users__pb2.GetCustomerRequest.FromString,
                    response_serializer=tarot_dot_tarot_dot_users__pb2.CustomerBalance.SerializeToString,
            ),
            'GetCustomerTransactions': grpc.unary_unary_rpc_method_handler(
                    servicer.GetCustomerTransactions,
                    request_deserializer=tarot_dot_tarot_dot_users__pb2.GetCustomerRequest.FromString,
                    response_serializer=tarot_dot_tarot_dot_users__pb2.CustomerTransactions.SerializeToString,
            ),
            'TopUpBalance': grpc.unary_unary_rpc_method_handler(
                    servicer.TopUpBalance,
                    request_deserializer=tarot_dot_tarot_dot_users__pb2.TopUpBalanceRequest.FromString,
                    response_serializer=tarot_dot_tarot_dot_users__pb2.CustomerBalance.SerializeToString,
            ),
            'InitiateInternalPurchase': grpc.unary_unary_rpc_method_handler(
                    servicer.InitiateInternalPurchase,
                    request_deserializer=tarot_dot_tarot_dot_users__pb2.InternalPurchaseRequest.FromString,
                    response_serializer=tarot_dot_tarot_dot_users__pb2.CustomerTransaction.SerializeToString,
            ),
            'CommitInternalPurchase': grpc.unary_unary_rpc_method_handler(
                    servicer.CommitInternalPurchase,
                    request_deserializer=tarot_dot_tarot_dot_users__pb2.CommitInternalPurchaseRequest.FromString,
                    response_serializer=tarot_dot_tarot_dot_users__pb2.CustomerTransaction.SerializeToString,
            ),
...
class Users(object):
    ...
    def CreateCustomer(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/tarot.Users/CreateCustomer',
            tarot_dot_tarot_dot_users__pb2.CreateCustomerRequest.SerializeToString,
            tarot_dot_tarot_dot_users__pb2.CustomerProfile.FromString,
    ...
    def GetCustomer(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/tarot.Users/GetCustomer',
            tarot_dot_tarot_dot_users__pb2.GetCustomerRequest.SerializeToString,
            tarot_dot_tarot_dot_users__pb2.CustomerProfile.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetCustomerBalance(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/tarot.Users/GetCustomerBalance',
            tarot_dot_tarot_dot_users__pb2.GetCustomerRequest.SerializeToString,
            tarot_dot_tarot_dot_users__pb2.CustomerBalance.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetCustomerTransactions(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/tarot.Users/GetCustomerTransactions',
            tarot_dot_tarot_dot_users__pb2.GetCustomerRequest.SerializeToString,
            tarot_dot_tarot_dot_users__pb2.CustomerTransactions.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def TopUpBalance(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/tarot.Users/TopUpBalance',
            tarot_dot_tarot_dot_users__pb2.TopUpBalanceRequest.SerializeToString,
            tarot_dot_tarot_dot_users__pb2.CustomerBalance.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def InitiateInternalPurchase(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/tarot.Users/InitiateInternalPurchase',
            tarot_dot_tarot_dot_users__pb2.InternalPurchaseRequest.SerializeToString,
            tarot_dot_tarot_dot_users__pb2.CustomerTransaction.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CommitInternalPurchase(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/tarot.Users/CommitInternalPurchase',
            tarot_dot_tarot_dot_users__pb2.CommitInternalPurchaseRequest.SerializeToString,
            tarot_dot_tarot_dot_users__pb2.CustomerTransaction.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
