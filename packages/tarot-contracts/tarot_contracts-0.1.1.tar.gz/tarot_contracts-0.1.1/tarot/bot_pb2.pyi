...
class SendMessageRequest(_message.Message):
    __slots__ = ["message", "actions", "recipient_ids", "category_tag"]
    ...
    category_tag: str
    def __init__(self, message: _Optional[str] = ..., actions: _Optional[_Iterable[_Union[MessageAction, _Mapping]]] = ..., recipient_ids: _Optional[_Iterable[int]] = ..., category_tag: _Optional[str] = ...) -> None: ...
