...
class SendMessagePayload(_message.Message):
    __slots__ = ["message", "recipient_id", "actions", "category_tag"]
    MESSAGE_FIELD_NUMBER: _ClassVar[int]
    RECIPIENT_ID_FIELD_NUMBER: _ClassVar[int]
    ACTIONS_FIELD_NUMBER: _ClassVar[int]
    CATEGORY_TAG_FIELD_NUMBER: _ClassVar[int]
    message: str
    recipient_id: int
    actions: _containers.RepeatedCompositeFieldContainer[_bot_pb2.MessageAction]
    category_tag: str
    def __init__(self, message: _Optional[str] = ..., recipient_id: _Optional[int] = ..., actions: _Optional[_Iterable[_Union[_bot_pb2.MessageAction, _Mapping]]] = ..., category_tag: _Optional[str] = ...) -> None: ...

class SendMessageBatchPayload(_message.Message):
    __slots__ = ["message", "recipient_ids", "actions", "category_tag"]
    MESSAGE_FIELD_NUMBER: _ClassVar[int]
    ...
    actions: _containers.RepeatedCompositeFieldContainer[_bot_pb2.MessageAction]
    category_tag: str
    def __init__(self, message: _Optional[str] = ..., recipient_ids: _Optional[_Iterable[int]] = ..., actions: _Optional[_Iterable[_Union[_bot_pb2.MessageAction, _Mapping]]] = ..., category_tag: _Optional[str] = ...) -> None: ...
