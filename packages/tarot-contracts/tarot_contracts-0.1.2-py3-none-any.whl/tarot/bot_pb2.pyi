...
class SendMessageRequest(_message.Message):
    __slots__ = ["message", "actions", "recipient_ids", "hook_tag"]
    ...
    hook_tag: str
    def __init__(self, message: _Optional[str] = ..., actions: _Optional[_Iterable[_Union[MessageAction, _Mapping]]] = ..., recipient_ids: _Optional[_Iterable[int]] = ..., hook_tag: _Optional[str] = ...) -> None: ...
