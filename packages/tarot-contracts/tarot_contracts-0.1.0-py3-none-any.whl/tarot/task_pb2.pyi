...
class SendMessagePayload(_message.Message):
    __slots__ = ["message", "recipient_id", "action", "category_tag"]
    ...
    category_tag: str
    def __init__(self, message: _Optional[str] = ..., recipient_id: _Optional[int] = ..., action: _Optional[_Union[_bot_pb2.MessageAction, _Mapping]] = ..., category_tag: _Optional[str] = ...) -> None: ...

class SendMessageBatchPayload(_message.Message):
    __slots__ = ["message", "recipient_ids", "action", "category_tag"]
    MESSAGE_FIELD_NUMBER: _ClassVar[int]
    ...
    action: _bot_pb2.MessageAction
    category_tag: str
    def __init__(self, message: _Optional[str] = ..., recipient_ids: _Optional[_Iterable[int]] = ..., action: _Optional[_Union[_bot_pb2.MessageAction, _Mapping]] = ..., category_tag: _Optional[str] = ...) -> None: ...
