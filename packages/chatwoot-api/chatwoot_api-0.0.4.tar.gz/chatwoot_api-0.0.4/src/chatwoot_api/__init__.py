...
def get_chat_history(
    ...
    url = f"{settings.frontend_url}/api/v1/accounts/{account_id}/conversations/{conversation_id}/messages"
...
def get_teams_list(api_access_token: str, account_id: int) -> list[Team]:
    ...
    url = f"{settings.frontend_url}/api/v1/accounts/{account_id}/teams"
    response = httpx.get(url, headers=headers)
    print_response(response)
...
def assign_conversation_to_team(
    ...
    url = f"{settings.frontend_url}/api/v1/accounts/{account_id}/conversations/{conversation_id}/assignments"
...
def update_conversation_status(
    ...
    url = f"{settings.frontend_url}/api/v1/accounts/{account_id}/conversations/{conversation_id}/toggle_status"
    body = {"status": "open"}
    response = httpx.post(url, headers=headers, json=body)
    print_response(response)
...
def send_conversation_response(
    ...
    url = f"{settings.frontend_url}/api/v1/accounts/{account}/conversations/{conversation}/messages"
